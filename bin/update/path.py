...
class UpdaterPath(object):
    ...
    def ensure_dir_exist(self):
        os.makedirs(self.get_update_dir())
        os.makedirs(self.get_current_build_dir())
        os.makedirs(self.get_mar_dir())
        os.makedirs(self.get_previous_build_dir())
        os.makedirs(self.get_language_dir())
