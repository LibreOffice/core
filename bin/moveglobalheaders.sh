...
topdirs=`find . -mindepth 1 -maxdepth 1 -type d -not -name sal -not -name xmlscript`
mkdir -p include/
for dir in $topdirs
do
...
sed -ie 's/\/sfx2\/inc\/sfx2/\/include\/sfx2\//' sfx2/Library_qstart.mk
git add svtools/Library_svt.mk sfx2/Library_sfx.mk sfx2/Library_qstart.mk
