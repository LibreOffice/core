...
void SdImportTestSmartArt::testFlowchart()
{
    ...
    uno::Reference<text::XText> xText4(xShapeGroup->getByIndex(4), uno::UNO_QUERY_THROW);
    CPPUNIT_ASSERT_EQUAL(OUString("c"), xText4->getString());

    uno::Reference<beans::XPropertySet> xShape0(xShapeGroup->getByIndex(0), uno::UNO_QUERY_THROW);

    sal_Int32 nFillColor1 = 0;
    xShape0->getPropertyValue("FillColor") >>= nFillColor1;
    CPPUNIT_ASSERT_EQUAL(sal_Int32(0x4472c4), nFillColor1);

    uno::Reference<beans::XPropertySet> xShape1(xShapeGroup->getByIndex(1), uno::UNO_QUERY_THROW);

    sal_Int32 nFillColor = 0;
    xShape1->getPropertyValue("FillColor") >>= nFillColor;
    CPPUNIT_ASSERT_EQUAL(sal_Int32(0xb0bbde), nFillColor);
