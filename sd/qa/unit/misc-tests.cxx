...
void SdMiscTest::testTdf136956()
{
    ...
    CPPUNIT_ASSERT_EQUAL(long(4), xTable->getColumnCount());
    CPPUNIT_ASSERT_EQUAL(long(3), xTable->getRowCount());

    xRange->merge();

    // 1x1 Table after merge.
    CPPUNIT_ASSERT_EQUAL(long(1), xTable->getColumnCount());
    CPPUNIT_ASSERT_EQUAL(long(1), xTable->getRowCount());
