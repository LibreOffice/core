...
// To get original value of LineWidth need to multiple by 2.
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0x00b0f0), Color(aBorderLine.Color));
    ...
    CPPUNIT_ASSERT_EQUAL(COL_WHITE, Color(aBorderLine.Color));
...
void SdOOXMLExportTest1::testTdf128345GradientAxial()
{
    ...
    CPPUNIT_ASSERT_EQUAL(COL_WHITE, Color(aTransparenceGradient.StartColor));
    CPPUNIT_ASSERT_EQUAL(COL_BLACK, Color(aTransparenceGradient.EndColor));
