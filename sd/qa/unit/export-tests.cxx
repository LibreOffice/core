...
{
    ::sd::DrawDocShellRef xDocShRef = loadURL(getURLFromSrc("/sd/qa/unit/data/pptx/numfmtpptx.pptx"), PPTX);
    ...
    {
        // get TextShape i
        uno::Reference< beans::XPropertySet > xShape( getShapeFromPage( 2, i, xDocShRef ) );
