...
void SdExportTest::testBnc480256()
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0x5597d3), Color(aBorderLine.Color));
    ...
    xCell->getPropertyValue("LeftBorder") >>= aBorderLine;
    CPPUNIT_ASSERT_EQUAL(Color(0xbecfe6), Color(aBorderLine.Color));
    ...
    CPPUNIT_ASSERT_EQUAL(COL_AUTO, Color(aBorderLine.Color));
