...
void SdOOXMLExportTest2::testClosingShapes()
{
    ...
    xDocShRef->DoClose();
    xmlDocPtr pXmlDocContent = parseExport(tempFile, "ppt/slides/slide1.xml");
    assertXPath(pXmlDocContent, "/p:sld/p:cSld/p:spTree/p:sp[1]/p:spPr/a:custGeom/a:pathLst/a:path/:close", 1);
    assertXPath(pXmlDocContent, "/p:sld/p:cSld/p:spTree/p:sp[2]/p:spPr/a:custGeom/a:pathLst/a:path/:close", 0);
}
...
void SdOOXMLExportTest2::testRotateFlip()
{
    ...
    for (size_t nShapeIndex = 0; nShapeIndex < SAL_N_ELEMENTS(data); nShapeIndex++)
    {
        ...
        assertXPath(pXmlDocContent, sSpPr + "/a:custGeom/a:pathLst/a:path/:close", 1);
    }
}
