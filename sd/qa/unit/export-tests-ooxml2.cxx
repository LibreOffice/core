...
public:
    ...
    void testDocmContentType();
    void testDocmVBAStream();
    ...
    CPPUNIT_TEST(testDocmContentType);
    CPPUNIT_TEST(testDocmVBAStream);
...
void SdOOXMLExportTest2::testDocmContentType()
{
...
void SdOOXMLExportTest2::testDocmVBAStream()
{
    ::sd::DrawDocShellRef xDocShRef = loadURL(m_directories.getURLFromSrc("sd/qa/unit/data/pptm/macro.pptm"), PPTM);
    utl::TempFile tempFile;
    xDocShRef = saveAndReload(xDocShRef.get(), PPTM, &tempFile);
