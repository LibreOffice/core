...
void SdOOXMLExportTest2::testAccentColor()
{
    ...
    xmlDocPtr pXmlDocContent = parseExport(tempFile, "ppt/theme/theme1.xml");
    assertXPath(pXmlDocContent, "/a:theme/a:themeElements/a:clrScheme/a:accent6/a:srgbClr", "val", "70ad47");
}
