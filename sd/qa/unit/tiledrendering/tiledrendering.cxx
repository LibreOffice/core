...
xmlDocPtr SdTiledRenderingTest::parseXmlDump()
{
    ...
    pImpressDocument->GetDoc()->dumpAsXml(nullptr);
...
// check that the first cell has acquired the resulting vertical style
    ...
    OString aPrefix = "/SdDrawDocument/SdrModel/SdPage/SdrObjList/SdrTableObj/SdrTableObjImpl"
                      "/TableModel/Cell[0]/DefaultProperties/SfxItemSet/SfxPoolItem[@whichId='1072']";
    // the following name has a compiler-dependant part
    CPPUNIT_ASSERT( getXPath(pXmlDoc, aPrefix, "typeName").indexOf("SdrTextVertAdjustItem") != -1 );
    xmlFreeDoc(pXmlDoc);
