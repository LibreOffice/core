...
void SdTiledRenderingTest::testSetGraphicSelection()
{
    ...
    CPPUNIT_ASSERT_EQUAL(aShapeBefore.getHalfOpenWidth(), aShapeAfter.getHalfOpenWidth());
    CPPUNIT_ASSERT(aShapeBefore.getHalfOpenHeight() < aShapeAfter.getHalfOpenHeight());
}
...
void SdTiledRenderingTest::testCursorVisibility_SingleClick()
{
    ...
    const auto cornerX = o3tl::toTwips(aRect.Left() + (aRect.getHalfOpenWidth() / 4), o3tl::Length::mm100);
    const auto cornerY = o3tl::toTwips(aRect.Top() + (aRect.getHalfOpenHeight() / 4), o3tl::Length::mm100);
    pXImpressDocument->postMouseEvent(LOK_MOUSEEVENT_MOUSEBUTTONDOWN,
                                      cornerX, cornerY,
                                      1, MOUSE_LEFT, 0);
    pXImpressDocument->postMouseEvent(LOK_MOUSEEVENT_MOUSEBUTTONUP,
    ...
    const auto centerX = o3tl::toTwips(aRect.Left() + (aRect.getHalfOpenWidth() / 2), o3tl::Length::mm100);
    const auto centerY = o3tl::toTwips(aRect.Top() + (aRect.getHalfOpenHeight() / 2), o3tl::Length::mm100);
    pXImpressDocument->postMouseEvent(LOK_MOUSEEVENT_MOUSEBUTTONDOWN,
                                      centerX, centerY,
                                      1, MOUSE_LEFT, 0);
    pXImpressDocument->postMouseEvent(LOK_MOUSEEVENT_MOUSEBUTTONUP,
