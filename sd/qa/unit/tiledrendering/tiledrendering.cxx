...
void SdTiledRenderingTest::testRegenerateDiagram()
{
    ...
    tools::Rectangle aRect = pActualPage->GetObj(0)->GetLogicRect();
    ...
    // diagram size and content (child shape count) should be the same as in the beginning
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(4), pActualPage->GetObj(0)->GetSubList()->GetObjCount());
    CPPUNIT_ASSERT_EQUAL(aRect, pActualPage->GetObj(0)->GetLogicRect());
