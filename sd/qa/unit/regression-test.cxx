...
void SdFiltersTest::testFdo47434()
{
    ...
    ::sd::DrawDocShellRef xDocShRef = loadURL(getURLFromSrc("/sd/qa/unit/data/fdo47434.pptx"));
    testStuff(xDocShRef, rtl::OUStringToOString(getPathFromSrc("/sd/qa/unit/data/xml/fdo47434_page"), RTL_TEXTENCODING_UTF8));
}
