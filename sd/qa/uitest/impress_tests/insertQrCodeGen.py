...
class insertQrCode(UITestCase):
   ...
   def test_insert_qr_code(self):
        ...
        print(document.DrawPages.getCount())
        with self.assertRaises(IndexOutOfBoundsException):
            document.DrawPages.getByIndex(0)
        ...
        self.assertEqual(document.DrawPages.getByIndex(0).QRCodeProperties.Payload, "www.libreoffice.org")
        self.assertEqual(document.DrawPages.getByIndex(0).QRCodeProperties.ErrorCorrection, 1)
        self.assertEqual(document.DrawPages.getByIndex(0).QRCodeProperties.Border, 1)
