    ...
    def test_customSlideShow(self):
        with guarded.create_doc_in_start_center(self, "impress"):
            ...
            with guarded.execute_dialog_through_command(self, ".uno:CustomShowDialog") as CustomSlideShows:
                with guarded.execute_blocking_action(self, CustomSlideShows.getChild("new").executeAction, args=('CLICK', ())) as DefineCustomSlideShow:
            ...
            with guarded.execute_dialog_through_command(self, ".uno:CustomShowDialog") as CustomSlideShows:
                ...
                with guarded.execute_blocking_action(self, CustomSlideShows.getChild("edit").executeAction, args=('CLICK', ()), close_button="cancel") as DefineCustomSlideShow:
                    customname = DefineCustomSlideShow.getChild("customname")
