...
setupBluez5Profile1(DBusConnection* pConnection, std::vector<Communicator*>* pCommunicators)
{
    ...
    {
        fprintf(stderr, "Failed to register Bluez 5 Profile1 callback, bluetooth won't work: '%s'\n", aError.message ? aError.message : "<null>");
        fprintf(stderr, "If the above error complains about \"security policies in the configuration file\", \n"
                        "please install %s which should be in the desktop-integration package\n",
