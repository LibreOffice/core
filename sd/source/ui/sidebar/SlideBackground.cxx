...
IMPL_LINK_NOARG(SlideBackground, FillStyleModifyHdl)
{
    ...
    Update();
    GetBindings()->GetDispatcher()->Execute(SID_ATTR_PAGE_FILLSTYLE, SfxCallMode::RECORD, &aXFillStyleItem, 0L);
    return 0;
}
IMPL_LINK_NOARG(SlideBackground, PaperSizeModifyHdl)
{
    ...
    GetBindings()->GetDispatcher()->Execute(SID_ATTR_PAGE_SIZE, SfxCallMode::RECORD,&aSizeItem,0L);
    return 0;
}
...
IMPL_LINK_NOARG(SlideBackground, FillColorHdl)
{
    ...
    switch(eXFS)
    {
        case drawing::FillStyle_SOLID:
        {
            ...
            GetBindings()->GetDispatcher()->Execute(SID_ATTR_PAGE_COLOR, SfxCallMode::RECORD, &aItem, 0L);
        }
        break;
        case drawing::FillStyle_GRADIENT:
        {
            ...
            GetBindings()->GetDispatcher()->Execute(SID_ATTR_PAGE_GRADIENT, SfxCallMode::RECORD, &aFillStyleItem ,&aItem, 0l);
        }
        break;
        default:
            break;
...
IMPL_LINK_NOARG(SlideBackground, FillBackgroundHdl)
{
    ...
    switch(eXFS)
    {
        ...
        case drawing::FillStyle_HATCH:
        {
            ...
            GetBindings()->GetDispatcher()->Execute(SID_ATTR_PAGE_HATCH, SfxCallMode::RECORD, &aItem, &aFillStyleItem, 0L);
        }
        break;
        ...
        case drawing::FillStyle_BITMAP:
        {
            ...
            GetBindings()->GetDispatcher()->Execute(SID_ATTR_PAGE_BITMAP, SfxCallMode::RECORD,&aFillStyleItem, &aItem, 0L);
        }
        break;
        default:
            break;
