...
SdXImpressDocument* SdUnoOutlineView::getModel() const throw()
{
...
sal_Char pImplSdUnoOutlineViewService[sizeof("com.sun.star.presentation.OutlineDocumentView")] = "com.sun.star.presentation.OutlineDocumentView";
...
void SdUnoOutlineView::fireVisAreaChanged( const Rectangle& rVisArea ) throw()
{
