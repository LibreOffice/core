...
gtv_main_toolbar_init(GtvMainToolbar* toolbar)
{
    ...
    GtkBuilder* builder = gtk_builder_new_from_file(uiFilePath.c_str());
...
static void setSensitiveIfEdit(GtvMainToolbar* toolbar, GtkToolItem* pItem, bool bEdit)
{
    ...
    {
        bool state = priv->m_aToolItemSensitivities.find(pItem) != priv->m_aToolItemSensitivities.end() ? priv->m_aToolItemSensitivities[pItem] : true;
