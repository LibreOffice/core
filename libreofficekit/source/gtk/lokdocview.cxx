...
openDocumentInThread (gpointer data)
{
    ...
    {
        priv->m_pDocument->pClass->initializeForRendering(priv->m_pDocument, 0);
...
postCommandInThread (gpointer data)
{
    ...
    priv->m_pDocument->pClass->postUnoCommand(priv->m_pDocument, pLOEvent->m_pCommand, pLOEvent->m_pArguments, false);
}
