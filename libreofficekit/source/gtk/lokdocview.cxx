...
{
    gboolean bWasEvent(FALSE);
    if (timeoutUs > 0)
    {
        guint aSource = g_timeout_add(timeoutUs / 1000, timeout_wakeup, nullptr);
        bWasEvent = g_main_context_iteration(nullptr, TRUE);
        g_source_remove(aSource);
    }
    else
    {
        if (timeoutUs < 0)
            ...
            bWasEvent = g_main_context_iteration(nullptr, FALSE);
    }
