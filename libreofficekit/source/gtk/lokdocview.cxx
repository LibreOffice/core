...
renderOverlay(LOKDocView* pDocView, cairo_t* pCairo)
{
    ...
    if (priv->m_bEdit && priv->m_bCursorVisible && !isEmptyRectangle(priv->m_aVisibleCursor) && priv->m_aTextSelectionRectangles.empty())
    {
        ...
        gchar* handleMiddlePath = g_strconcat (LOK_ASSETS, "handle_image_middle.png", nullptr);
    ...
    if (!priv->m_aTextSelectionRectangles.empty())
    {
        ...
        if (!isEmptyRectangle(priv->m_aTextSelectionStart))
        {
            ...
            gchar* handleStartPath = g_strconcat (LOK_ASSETS, "handle_image_start.png", nullptr);
        ...
        if (!isEmptyRectangle(priv->m_aTextSelectionEnd))
        {
            ...
            gchar* handleEndPath = g_strconcat (LOK_ASSETS, "handle_image_end.png", nullptr);
    ...
    {
        gchar* handleGraphicPath = g_strconcat (LOK_ASSETS, "handle_graphic.png", nullptr);
