                                           ...
                                           const OUString& sDocumentService)
{
    ...
    try
    {
        auto aDestinationList = COMReference<ICustomDestinationList>().CoCreateInstance(
        ...
        auto aCollection = COMReference<IObjectCollection>().CoCreateInstance(
        ...
        for (auto item : aJumpListItems)
        {
            ...
            try
            {
                auto pShellLinkItem = COMReference<IShellLinkW>().CoCreateInstance(
