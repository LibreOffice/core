...
class DifferentialEvolutionAlgorithm
{
    ...
    static constexpr double constAcceptedPercision = 0.000000001;
...
public:
    ...
    {
        return maBestCandidate.mVariables;
    }
    ...
    void initialize()
    {
        ...
        //Initialize population with individuals that have been initialized whit uniform random noise
    ...
    bool next()
    {
        ...
        for (size_t agentIndex = 0; agentIndex < mnPopulationSize; ++agentIndex)
        {
            ...
            if (fCandidateFitness > mrDataProvider.calculateFitness(rOriginal.mVariables))
            {
                ...
                {
                    if (std::abs(fCandidateFitness - mfBestFitness) > constAcceptedPercision)
                    {
                        bBestChanged = true;
