...
void SwarmSolverTest::testUnconstrained()
{
    ...
    xSolver.set(m_xContext->getServiceManager()->createInstanceWithContext(sSolverName, m_xContext), uno::UNO_QUERY_THROW);
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(3.0), aSolution[0], 1E-5);
}
...
void SwarmSolverTest::testVariableConstrained()
{
    ...
    CPPUNIT_ASSERT_EQUAL(aSolution.getLength(), aVariables.getLength());
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(-0.741657), aSolution[0], 1E-5);
}
...
void SwarmSolverTest::testTwoVariables()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(0.666667), aSolution[0], 1E-5);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(-1.666667), aSolution[1], 1E-5);
}
...
void SwarmSolverTest::testMultipleVariables()
{
    ...
    xPropSet->setPropertyValue("Integer", uno::makeAny(sal_True));
    ...
    CPPUNIT_ASSERT_EQUAL(aVariables.getLength(), aSolution.getLength());
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(0.0), aSolution[0], 1E-5);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(3.0), aSolution[1], 1E-5);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(1.0), aSolution[2], 1E-5);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(double(0.0), aSolution[3], 1E-5);
}
