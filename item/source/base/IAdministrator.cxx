...
namespace Item
{
    IAdministrator_sort::IAdministrator_sort(const IBase* pDefault)
    :   IAdministrator(pDefault),
        m_aEntries()
    {
    }

    IBase::SharedPtr IAdministrator_sort::Create(const IBase* pIBase)
    {
        assert(pIBase != nullptr && "nullptr not allowed (!)");
    ...
    void IAdministrator_sort::HintExpired(const IBase* pIBase)
    {
...
namespace Item
{
    IAdministrator_hash::IAdministrator_hash(const IBase* pDefault)
    :   IAdministrator(pDefault),
        m_aEntries()
    {
    }

    IBase::SharedPtr IAdministrator_hash::Create(const IBase* pIBase)
    {
        assert(pIBase != nullptr && "nullptr not allowed (!)");
    ...
    void IAdministrator_hash::HintExpired(const IBase* pIBase)
    {
        // called from ::~Item. This happens in two cases:
        // (1) a temporary Item instance gets deleted
        // (2) last shared_ptr was deleted
...
namespace Item
{
    std::vector<const IBase*>::iterator IAdministrator_unsortedList::find(const IBase* pIBase)
    {
    ...
    void IAdministrator_unsortedList::insert(const IBase* pIBase)
    {
    ...
    void IAdministrator_unsortedList::erase(std::vector<const IBase*>::iterator& rIter)
    {
    ...
    IAdministrator_unsortedList::IAdministrator_unsortedList(const IBase* pDefault)
    :   IAdministrator(pDefault),
        m_aEntries(),
        m_aFreeSlots()
    {
    ...
    IBase::SharedPtr IAdministrator_unsortedList::Create(const IBase* pIBase)
    {
        assert(pIBase != nullptr && "nullptr not allowed (!)");
    ...
    void IAdministrator_unsortedList::HintExpired(const IBase* pIBase)
    {
        // called from ::~Item. This happens in two cases:
        // (1) a temporary Item instance gets deleted
        // (2) last shared_ptr was deleted
