...
void VclAnimationTest::testFrameCount()
{
    ...
    aAnimation.Insert(AnimationFrame(BitmapEx(Size(3, 3), vcl::PixelFormat::N24_BPP), Point(0, 0),
                                      Size(10, 10)));
...
void VclAnimationTest::testDisplaySize()
{
    ...
    aAnimation.Insert(AnimationFrame(BitmapEx(Size(10, 10), vcl::PixelFormat::N24_BPP),
