...
void VclAnimationTest::testFrameCount()
{
    ...
    CPPUNIT_ASSERT_EQUAL(0UL, aAnimation.Count());

    aAnimation.Insert(AnimationBitmap(BitmapEx(Size(3, 4), 24), Point(0, 0), Size(3, 4)));
    CPPUNIT_ASSERT_EQUAL(1UL, aAnimation.Count());

    aAnimation.Insert(AnimationBitmap(BitmapEx(Size(3, 3), 24), Point(0, 0), Size(10, 10)));
    CPPUNIT_ASSERT_EQUAL(2UL, aAnimation.Count());
...
void VclAnimationTest::testDisplaySize()
{
    ...
    aAnimation.Insert(AnimationBitmap(BitmapEx(Size(10, 10), 24), Point(0, 0), Size(10, 10)));
