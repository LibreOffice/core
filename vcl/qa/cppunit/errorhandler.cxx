...
protected:
    virtual bool CreateString(const ErrorInfo *pErrInfo, OUString &rErrString) const
    {
...
void ErrorHandlerTest::testGetErrorString()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("GetErrorString(ERRCODE_ABORT, aErrStr) should return false", aErrHdlr.GetErrorString(ERRCODE_ABORT, aErrStr) == false);
    ...
    CPPUNIT_ASSERT_MESSAGE("GetErrorString(ERRCODE_NONE, aErrStr) should return false", aErrHdlr.GetErrorString(ERRCODE_NONE, aErrStr) == false);
