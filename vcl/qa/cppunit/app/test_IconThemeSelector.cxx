...
class IconThemeSelectorTest : public CppUnit::TestFixture
{
    ...
    void
    ElementaryIsReturnedForUnityDesktop();

    void
    SifrIsReturnedForMacOSDesktop();
    ...
    CPPUNIT_TEST(ElementaryIsReturnedForUnityDesktop);
    CPPUNIT_TEST(SifrIsReturnedForMacOSDesktop);
...
void
IconThemeSelectorTest::ElementaryIsReturnedForUnityDesktop()
{
    std::vector<vcl::IconThemeInfo> themes = GetFakeInstalledThemes();
    vcl::IconThemeSelector s;
    OUString r = s.SelectIconThemeForDesktopEnvironment(themes, "unity");
    CPPUNIT_ASSERT_EQUAL_MESSAGE("'elementary' theme is returned for unity desktop", OUString("elementary"), r);
}

void
IconThemeSelectorTest::SifrIsReturnedForMacOSDesktop()
{
    std::vector<vcl::IconThemeInfo> themes = GetFakeInstalledThemes();
    vcl::IconThemeSelector s;
    OUString r = s.SelectIconThemeForDesktopEnvironment(themes, "MacOSX");
    CPPUNIT_ASSERT_EQUAL_MESSAGE("'sifr' theme is returned for macOS desktop", OUString("sifr"), r);
}
...
IconThemeSelectorTest::ThemeIsOverriddenByPreferredTheme()
{
    ...
    std::vector<vcl::IconThemeInfo> themes = GetFakeInstalledThemes();
    OUString selected = s.SelectIconThemeForDesktopEnvironment(themes, "unity");
