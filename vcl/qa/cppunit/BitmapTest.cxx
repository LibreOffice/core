...
{
    {
        ...
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Wrong width", static_cast<sal_Int64>(0), aSize.Width());
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Wrong height", static_cast<sal_Int64>(0), aSize.Height());
...

    {
        ...
        Size aSize = aBmp.GetSizePixel();
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Wrong width", static_cast<sal_Int64>(10), aSize.Width());
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Wrong height", static_cast<sal_Int64>(10), aSize.Height());
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Wrong pref size", Size(), aBmp.GetPrefSize());
...
void BitmapTest::testScale()
{
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int64(10), aBitmap24Bit.GetSizePixel().Width());
    CPPUNIT_ASSERT_EQUAL(sal_Int64(10), aBitmap24Bit.GetSizePixel().Height());
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int64(20), aBitmap24Bit.GetSizePixel().Width());
    CPPUNIT_ASSERT_EQUAL(sal_Int64(20), aBitmap24Bit.GetSizePixel().Height());
