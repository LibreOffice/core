...
void BitmapTest::testScale()
{
    ...
    CPPUNIT_ASSERT_EQUAL(10, aBitmap24Bit.GetSizePixel().Width());
    CPPUNIT_ASSERT_EQUAL(10, aBitmap24Bit.GetSizePixel().Height());
    ...
    CPPUNIT_ASSERT_EQUAL(20, aBitmap24Bit.GetSizePixel().Width());
    CPPUNIT_ASSERT_EQUAL(20, aBitmap24Bit.GetSizePixel().Height());
