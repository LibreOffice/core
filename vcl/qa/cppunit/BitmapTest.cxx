...
void BitmapTest::testMonochrome()
{
    ...
    aBmpAccess.SetPixel(0, 3, BitmapColor(Color(COL_GREEN)));
    aBmpAccess.SetPixel(0, 4, BitmapColor(Color(COL_CYAN)));
