...

    {
        ...
        for (const auto& aElement : aDocument.GetElements())
        {
            ...
            if (pType && pType->GetValue() == "Font")
            {
                ...
                CPPUNIT_ASSERT_MESSAGE("Font name does not match", pName->GetValue().match("Amiri", 7));
...
void PdfExportTest::testTdf66597_2()
{
...

    {
        ...
        for (const auto& aElement : aDocument.GetElements())
        {
            ...
            {
                auto pName = dynamic_cast<vcl::filter::PDFNameElement*>(pObject->Lookup("BaseFont"));
                CPPUNIT_ASSERT_MESSAGE("Font name does not match", pName->GetValue().match("ReemKufi-Regular", 7));
