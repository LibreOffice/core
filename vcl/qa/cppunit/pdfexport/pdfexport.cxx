...
void PdfExportTest::testTdf108963()
{
    ...
    for (int i = 0; i < nPageObjectCount; ++i)
    {
        ...
        if (RGB_COLORDATA(nRed, nGreen, nBlue) == COL_YELLOW)
        {
            ...
            CPPUNIT_ASSERT_EQUAL(245395, static_cast<int>(fX * 1000));
            CPPUNIT_ASSERT_EQUAL(244233, static_cast<int>(fY * 1000));
            ...
            FPDFPathSegment_GetPoint(pSegment, &fX, &fY);
            CPPUNIT_ASSERT_EQUAL(275102, static_cast<int>(fX * 1000));
            CPPUNIT_ASSERT_EQUAL(267590, static_cast<int>(fY * 1000));
            CPPUNIT_ASSERT(!FPDFPathSegment_GetClose(pSegment));

            pSegment = FPDFPath_GetPathSegment(pPdfPageObject, 2);
            CPPUNIT_ASSERT_EQUAL(FPDF_SEGMENT_LINETO, FPDFPathSegment_GetType(pSegment));
            FPDFPathSegment_GetPoint(pSegment, &fX, &fY);
            CPPUNIT_ASSERT_EQUAL(287518, static_cast<int>(fX * 1000));
            CPPUNIT_ASSERT_EQUAL(251801, static_cast<int>(fY * 1000));
            CPPUNIT_ASSERT(!FPDFPathSegment_GetClose(pSegment));

            pSegment = FPDFPath_GetPathSegment(pPdfPageObject, 3);
            CPPUNIT_ASSERT_EQUAL(FPDF_SEGMENT_LINETO, FPDFPathSegment_GetType(pSegment));
            FPDFPathSegment_GetPoint(pSegment, &fX, &fY);
            CPPUNIT_ASSERT_EQUAL(257838, static_cast<int>(fX * 1000));
            CPPUNIT_ASSERT_EQUAL(228443, static_cast<int>(fY * 1000));
            CPPUNIT_ASSERT(!FPDFPathSegment_GetClose(pSegment));
