...
void VclPhysicalFontCollectionTest::testShouldFindSymboltypeFamily()
{
    ...
    AddNormalFontFace(pFontFamily, "testsymbolfamily");
...
void VclPhysicalFontCollectionTest::testShouldMatchFamilyName()
{
    ...
    AddNormalFontFace(pFontFamily, GetEnglishSearchFontName("Matching family name"));
...
{
    vcl::font::PhysicalFontCollection aFontCollection;
    vcl::font::PhysicalFontFamily* pFontFamily = aFontCollection.FindOrCreateFontFamily("testfont");
    AddNormalFontFace(pFontFamily, "testfont");
...
void VclPhysicalFontCollectionTest::testShouldMatchFixedFamily()
{
    ...
    // the font searches the family name and uses the search parameter of FindFontFamilyByAttributes()
    vcl::font::PhysicalFontFamily* pFontFamily
        = aFontCollection.FindOrCreateFontFamily(GetEnglishSearchFontName("Matching family name"));
    ...
    CPPUNIT_ASSERT_MESSAGE("No fixed family found",
                           aFontCollection.FindFontFamilyByAttributes(
                               ...
                               GetEnglishSearchFontName("Matching family name")));
}
...
void VclPhysicalFontCollectionTest::testShouldNotMatchDecorativeFamily()
{
    ...
    FontAttributes aFontAttr;
    aFontAttr.SetFamilyName("notdecoractive");
    aFontAttr.SetFamilyType(FAMILY_ROMAN);
    aFontAttr.SetWeight(WEIGHT_NORMAL);
    TestFontFace* pFontFace = new TestFontFace(aFontAttr, FONTID);
    pFontFamily->AddFontFace(pFontFace);
...
{
    vcl::font::PhysicalFontCollection aFontCollection;
    vcl::font::PhysicalFontFamily* pFontFamily = aFontCollection.FindOrCreateFontFamily("titling");
    AddNormalFontFace(pFontFamily, "titling");
...
{
    vcl::font::PhysicalFontCollection aFontCollection;
    vcl::font::PhysicalFontFamily* pFontFamily = aFontCollection.FindOrCreateFontFamily("caps");
    AddNormalFontFace(pFontFamily, "caps");
...
void VclPhysicalFontCollectionTest::testShouldFindFamilyName()
{
    ...
    AddNormalFontFace(pFontFamily, GetEnglishSearchFontName("Test font name"));
...
{
    vcl::font::PhysicalFontCollection aFontCollection;
    vcl::font::PhysicalFontFamily* pFontFamily = aFontCollection.FindOrCreateFontFamily("oldstyle");
    AddNormalFontFace(pFontFamily, "oldstyle");
...
void VclPhysicalFontCollectionTest::testShouldFindTypewriterFamily()
{
    vcl::font::PhysicalFontCollection aFontCollection;
    vcl::font::PhysicalFontFamily* pFontFamily
        = aFontCollection.FindOrCreateFontFamily("typewriter");
    AddNormalFontFace(pFontFamily, "typewriter");
...
void VclPhysicalFontCollectionTest::testShouldFindSchoolbookFamily()
{
    vcl::font::PhysicalFontCollection aFontCollection;
    vcl::font::PhysicalFontFamily* pFontFamily
        = aFontCollection.FindOrCreateFontFamily("schoolbook");
    AddNormalFontFace(pFontFamily, "schoolbook");
