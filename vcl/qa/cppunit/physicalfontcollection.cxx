...
public:
    ...
    void testShouldSearchDecorativeFamilyNoResults();
    ...
    CPPUNIT_TEST(testShouldSearchDecorativeFamilyNoResults);
...
void VclPhysicalFontCollectionTest::testShouldSearchDecorativeFamilyNoResults()
{
    vcl::font::PhysicalFontCollection aFontCollection;
    aFontCollection.FindOrCreateFontFamily("decorative");
