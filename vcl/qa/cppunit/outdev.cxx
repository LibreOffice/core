...
void VclOutdevTest::testVirtualDevice()
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(COL_WHITE), pVDev->GetPixel(Point(0,0)));
#if defined LINUX //TODO: various failures on Mac and Windows tinderboxes
    CPPUNIT_ASSERT_EQUAL(Color(COL_BLUE), pVDev->GetPixel(Point(2,1)));
    CPPUNIT_ASSERT_EQUAL(Color(COL_RED), pVDev->GetPixel(Point(30,31)));
#endif
    CPPUNIT_ASSERT_EQUAL(Color(COL_WHITE), pVDev->GetPixel(Point(31,30)));
