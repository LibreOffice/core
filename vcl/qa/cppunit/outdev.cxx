...
const size_t INITIAL_SETUP_ACTION_COUNT = 4;
...
{
    {
        ...
        MetaAction* pAction = aMtf.GetAction(INITIAL_SETUP_ACTION_COUNT + 2);
...
void VclOutdevTest::testDrawGradient_drawmode()
{
    ...
    pAction = aMtf.GetAction(INITIAL_SETUP_ACTION_COUNT + 5);
