...
void VclOutdevTest::testErase()
{
    ...
    MetaAction* pAction = aMtf.GetAction(1);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Not a line action", MetaActionType::LINE, pAction->GetType());

    pAction = aMtf.GetAction(2);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Not a fill action", MetaActionType::FILL, pAction->GetType());

    pAction = aMtf.GetAction(3);
    CPPUNIT_ASSERT_EQUAL_MESSGE("Not a rect action", MetaActionType::RECT, pAction->GetType());
