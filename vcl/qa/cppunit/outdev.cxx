...
void VclOutdevTest::testVirtualDevice()
{
    ...
    CPPUNIT_ASSERT_EQUAL(COL_WHITE, static_cast<Color>(pVDev->GetPixel(Point(0,0))));
#if defined LINUX //TODO: various failures on Mac and Windows tinderboxes
    CPPUNIT_ASSERT_EQUAL(COL_BLUE, static_cast<Color>(pVDev->GetPixel(Point(1,2))));
    CPPUNIT_ASSERT_EQUAL(COL_RED, static_cast<Color>(pVDev->GetPixel(Point(31,30))));
#endif
    CPPUNIT_ASSERT_EQUAL(COL_WHITE, static_cast<Color>(pVDev->GetPixel(Point(30,31))));
