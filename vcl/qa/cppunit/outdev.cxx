...
void VclOutdevTest::testVirtualDevice()
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(COL_WHITE), pAcc->GetPixel(Point(0,0)));
#if defined LINUX //TODO: various failures on Mac and Windows tinderboxes
    CPPUNIT_ASSERT_EQUAL(Color(COL_BLUE), pAcc->GetPixel(Point(2,1)));
    CPPUNIT_ASSERT_EQUAL(Color(COL_RED), pAcc->GetPixel(Point(30,31)));
#endif
    CPPUNIT_ASSERT_EQUAL(Color(COL_WHITE), pAcc->GetPixel(Point(31,30)));
