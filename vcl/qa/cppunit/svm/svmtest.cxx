...
GDIMetaFile readMetafile(OUString aUrl)
{
...
void writeMetaFile(GDIMetaFile& rInputMetafile, OUString aUrl)
{
    SvFileStream aFileStream(aUrl, StreamMode::WRITE);
    aFileStream.Seek(STREAM_SEEK_TO_BEGIN);
...
void SvmTest::checkBitmapExs(const GDIMetaFile& rMetaFile)
{
    ...
    assertXPathAttrs(pDoc, "/metafile/bmpex[1]", {
        {"x", "1"}, {"y", "2"},
        {"crc", "7932585a"}, {"transparenttype", "bitmap"}
    });
