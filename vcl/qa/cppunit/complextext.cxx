...
void VclComplexTextTest::testArabic()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(71, aBoundRect.getHalfOpenWidth(), 1); // This sometimes equals to 70
    CPPUNIT_ASSERT_DOUBLES_EQUAL(15, aBoundRect.getHalfOpenHeight(), 1);
