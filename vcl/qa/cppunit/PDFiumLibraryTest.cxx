...
{
    // Test convert PDF date to ISO8601
    OUString sInputString("D:20200612201322+02'00");

    OUString sConverted = vcl::pdf::convertPdfDateToISO8601(sInputString);
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Bool(false), aDateTime.IsUTC);
}
