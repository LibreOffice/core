...
{
    SvFileStream aFileStream(getFullUrl("sample.met"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.bmp"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.wmf"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.pcx"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.jpg"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.png"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.gif"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.psd"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.tga"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.tif"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.xbm"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.xpm"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.svg"), StreamMode::READ);
...
{
    SvFileStream aFileStream(getFullUrl("sample.svgz"), StreamMode::READ);
    vcl::GraphicFormatDetector aDetector(aFileStream, "SVG");
...
{
    SvFileStream aFileStream(getFullUrl("sample.pdf"), StreamMode::READ);
