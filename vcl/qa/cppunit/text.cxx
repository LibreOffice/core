...
public:
    ...
    void testImplLayoutArgs_PrepareFallback();
    ...
    CPPUNIT_TEST(testImplLayoutArgs_PrepareFallback);
...
void VclTextTest::testImplLayoutArgs_PrepareFallback()
{
    const OUString sTestString = "The quick\n jumped over";
    vcl::text::ImplLayoutArgs aArgs(sTestString, 0, sTestString.getLength(),
                                    SalLayoutFlags::BiDiRtl, LanguageTag(LANGUAGE_LATIN), nullptr);
    aArgs.NeedFallback(0, 22, false);

    aArgs.PrepareFallback(nullptr);
