...
static int getCharacterBaseWidth(VirtualDevice* device, const Point& start)
{
...
static int getCharacterTopWidth(VirtualDevice* device, const Point& start)
{
    Bitmap bitmap = device->GetBitmap(Point(), device->GetOutputSizePixel());
    Bitmap::ScopedReadAccess access(bitmap);
    int y = start.Y();
...
static int getCharacterLeftSideHeight(VirtualDevice* device, const Point& start)
{
    Bitmap bitmap = device->GetBitmap(Point(), device->GetOutputSizePixel());
    Bitmap::ScopedReadAccess access(bitmap);
    int x = start.X();
...
static int getCharacterRightSideHeight(VirtualDevice* device, const Point& start)
{
    Bitmap bitmap = device->GetBitmap(Point(), device->GetOutputSizePixel());
    Bitmap::ScopedReadAccess access(bitmap);
    int x = start.X();
...
void VclTextTest::testSimpleText()
{
    ...
    int height36 = getCharacterLeftSideHeight(device, Point(0, 30));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(28, height36, 4);
    int width36 = getCharacterBaseWidth(device, Point(20, 99));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(19, width36, 4);
    ...
    int height36Rotated = getCharacterLeftSideHeight(device, Point(0, 20));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(width36, height36Rotated, 2);
    int width36Rotated = getCharacterTopWidth(device, Point(70, 0));
    ...
    int height72 = getCharacterLeftSideHeight(device, Point(0, 30));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height36 * 2, height72, 4);
    int width72 = getCharacterBaseWidth(device, Point(20, 99));
    ...
    int height72Rotated = getCharacterLeftSideHeight(device, Point(0, 35));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(width72, height72Rotated, 2);
    int width72Rotated = getCharacterTopWidth(device, Point(50, 0));
    ...
    int height36pct200 = getCharacterLeftSideHeight(device, Point(0, 30));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height36, height36pct200, 2);
    int width36pct200 = getCharacterBaseWidth(device, Point(20, 99));
    ...
    int height36pct50 = getCharacterLeftSideHeight(device, Point(0, 30));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height36, height36pct50, 2);
    int width36pct50 = getCharacterBaseWidth(device, Point(15, 99));
...
void VclTextTest::testVerticalText()
{
    ...
    int height36 = getCharacterRightSideHeight(device, Point(99, 20));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(28, height36, 6);
    int width36 = getCharacterTopWidth(device, Point(65, 0));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(25, width36, 6);
    ...
    int height36Rotated = getCharacterRightSideHeight(device, Point(99, 35));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height36, height36Rotated, 1);
    int width36Rotated = getCharacterTopWidth(device, Point(25, 0));
    ...
    // Font size is doubled, so pixel sizes should also roughly double.
    int height72 = getCharacterRightSideHeight(device, Point(99, 35));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height36 * 2, height72, 4);
    int width72 = getCharacterTopWidth(device, Point(40, 0));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(width36 * 2, width72, 4);
    ...
    int height72Rotated = getCharacterRightSideHeight(device, Point(99, 60));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height72, height72Rotated, 1);
    int width72Rotated = getCharacterTopWidth(device, Point(45, 0));
    ...
    int height36pct200 = getCharacterRightSideHeight(device, Point(99, 35));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height36 * 2, height36pct200, 4);
    int width36pct200 = getCharacterTopWidth(device, Point(65, 0));
    ...
    int height36pct50 = getCharacterRightSideHeight(device, Point(99, 15));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(height36 / 2, height36pct50, 2);
    int width36pct50 = getCharacterTopWidth(device, Point(65, 0));
