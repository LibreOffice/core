...
public:
    ...
    void testDrawRectWithRectangle()
    {
        ...
        CPPUNIT_ASSERT_MESSAGE("Rectangle not drawn correctly",
                               eResult != vcl::test::TestResult::Failed);
    }
    ...
    void testDrawFilledRectWithRectangle()
    {
        ...
        CPPUNIT_ASSERT_MESSAGE("Filled rectangle not drawn correctly",
                               eResult != vcl::test::TestResult::Failed);
    }
    ...
    void testDrawDiamondWithPolygon()
    {
        ...
        CPPUNIT_ASSERT_MESSAGE("Diamond not drawn correctly",
                               eResult != vcl::test::TestResult::Failed);
    }
...
#define SKIP_BACKEND_TEST

#ifndef SKIP_BACKEND_TEST
