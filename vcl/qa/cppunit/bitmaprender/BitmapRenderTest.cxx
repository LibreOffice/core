...
void BitmapRenderTest::testTdf116888()
{
    ...
    CPPUNIT_ASSERT_EQUAL(BitmapColor(COL_WHITE), pAccess->GetColor(0, 0));
    CPPUNIT_ASSERT_EQUAL(BitmapColor(COL_WHITE), pAccess->GetColor(0, pAccess->Width() - 1));
    CPPUNIT_ASSERT_EQUAL(BitmapColor(COL_WHITE), pAccess->GetColor(pAccess->Height() - 1, 0));
