...
void XGraphicTest::testGraphicDescriptor()
{
    ...
    CPPUNIT_ASSERT_EQUAL(100, aSizePixel.Width);
    CPPUNIT_ASSERT_EQUAL(50, aSizePixel.Height);
    ...
    CPPUNIT_ASSERT_EQUAL(0, aSize100thMM.Width);
    CPPUNIT_ASSERT_EQUAL(0, aSize100thMM.Height);
...
void XGraphicTest::testGraphicProvider()
{
    ...
    { // Load lazy
        ...
        awt::Size aSizePixel;
        CPPUNIT_ASSERT(xGraphicDescriptor->getPropertyValue("SizePixel") >>= aSizePixel);
        CPPUNIT_ASSERT_EQUAL(8, aSizePixel.Width);
        CPPUNIT_ASSERT_EQUAL(8, aSizePixel.Height);
