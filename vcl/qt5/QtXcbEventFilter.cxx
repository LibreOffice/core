...
xcb_atom_t QtXcbEventFilter::m_nWindowGroupAtom = 0;
...
void QtXcbEventFilter::setApplicationID(const xcb_window_t nWinId, const OUString& rWMClass)
{
...
bool QtXcbEventFilter::fixICCCMwindowGroup(const xcb_window_t nWinId)
{
