...
#include <vcl/BitmapGaussianSeperableBlurFilter.hxx>

#include <bitmapwriteaccess.hxx>

BitmapEx BitmapGaussianSeperableBlurFilter::execute(BitmapEx const& rBitmapEx)
{
...
bool BitmapGaussianSeperableBlurFilter::convolutionPass(Bitmap& rBitmap, Bitmap& aNewBitmap,
...
double* BitmapGaussianSeperableBlurFilter::makeBlurKernel(const double radius, int& rows)
{
...
void BitmapGaussianSeperableBlurFilter::blurContributions(const int aSize,
