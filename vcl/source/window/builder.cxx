    ...
    stringmap &rMap)
{
    ...
    {
        NotebookBarAddonsMerger aNotebookBarAddonsMerger;
        aNotebookBarAddonsMerger.MergeNotebookBarAddons(pParent, m_xFrame, m_pNotebookBarAddonsItem);
        return nullptr;
    }
    ...
    stringmap &rProps, accelmap &rAccels)
{
    ...
    {
        NotebookBarAddonsMerger aNotebookBarAddonsMerger;
        aNotebookBarAddonsMerger.MergeNotebookBarMenuAddons(pParent, nNewId, rID, m_pNotebookBarAddonsItem);
