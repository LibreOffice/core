...
VclBuilder::VclBuilder(vcl::Window *pParent, const OUString& sUIDir, const OUString& sUIFile, const OString& sID,
                       const css::uno::Reference<css::frame::XFrame>& rFrame, bool bLegacy, const AddonsNotebookBarItems &aAddonsNotebookBarItems)
    : m_sID(sID)
    ...
    , m_xFrame(rFrame)
{
    m_pAddonsNotebookBarItems = aAddonsNotebookBarItems;
    ...
    stringmap &rMap)
{
    ...
    else if (name == "GtkExtensionToolButton")
    {
        NotebookBarAddons aNotebookBarAddons(pParent,m_xFrame,m_pAddonsNotebookBarItems);
        return nullptr;
    }
