...
std::vector<VclBuilder::ComboBoxTextItem> VclBuilder::handleItems(xmlreader::XmlReader &reader) const
{
    int nLevel = 1;
...
template<typename T> bool insertItems(vcl::Window *pWindow, VclBuilder::stringmap &rMap, const std::vector<VclBuilder::ComboBoxTextItem> &rItems)
{
...
VclPtr<vcl::Window> VclBuilder::handleObject(vcl::Window *pParent, xmlreader::XmlReader &reader)
{
    ...
    std::vector<VclBuilder::ComboBoxTextItem> aItems;
