...
Hackery::Builder* Application::CreateBuilder(const OUString &rUIFile)
{
    OUString sUri = VclBuilderContainer::getUIRootDir() + rUIFile;
    return ImplGetSVData()->mpDefInst->CreateBuilder(sUri);
}

Hackery::Dialog* Application::CreateMessageDialog(Hackery::Window* pParent, VclMessageType eMessageType,
