...
bool FileDefinitionWidgetDraw::updateSettings(AllSettings& rSettings)
{
    ...
    aStyleSet.SetDefaultActionButtonRolloverTextColor(pDefinitionStyle->maDefaultActionButtonRolloverTextColor);
    ...
    aStyleSet.SetDefaultButtonPressedRolloverTextColor(pDefinitionStyle->maDefaultButtonPressedRolloverTextColor);
    aStyleSet.SetButtonPressedRolloverTextColor(pDefinitionStyle->maButtonPressedRolloverTextColor);
    aStyleSet.SetDefaultActionButtonPressedRolloverTextColor(pDefinitionStyle->maDefaultActionButtonPressedRolloverTextColor);
    aStyleSet.SetActionButtonPressedRolloverTextColor(pDefinitionStyle->maActionButtonPressedRolloverTextColor);
    aStyleSet.SetFlatButtonPressedRolloverTextColor(pDefinitionStyle->maFlatButtonPressedRolloverTextColor);
