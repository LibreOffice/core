...
sal_Int32 PDFDocument::WriteAppearanceObject(tools::Rectangle& rSignatureRectangle)
{
    ...
    aEditBuffer.WriteOString(OString::number(rSignatureRectangle.getHalfOpenWidth()));
    aEditBuffer.WriteCharPtr(" ");
    aEditBuffer.WriteOString(OString::number(rSignatureRectangle.getHalfOpenHeight()));
    aEditBuffer.WriteCharPtr("]\n/Length ");
                                        ...
                                        const tools::Rectangle& rSignatureRectangle)
{
    ...
    m_aEditBuffer.WriteOString(OString::number(rSignatureRectangle.getHalfOpenWidth()));
    m_aEditBuffer.WriteCharPtr(" ");
    m_aEditBuffer.WriteOString(OString::number(rSignatureRectangle.getHalfOpenHeight()));
    m_aEditBuffer.WriteCharPtr("]\n");
