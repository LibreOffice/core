...
bool isDialogWindow(const vcl::Window* pWindow)
{
...
vcl::Window* findChild(const vcl::Window* pParent, const OUString& rID)
{
    if (!pParent)
        return nullptr;
...
void addChildren(const vcl::Window* pParent, std::set<OUString>& rChildren)
{
    if (!pParent)
        return;
