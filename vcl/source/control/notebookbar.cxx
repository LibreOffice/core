    ...
    : Control(pParent), m_pEventListener(new NotebookBarContextChangeEventListener(this))
{
    ...
    osl::FileBase::RC e = doesFileExist(getCustomizedUIRootDir(), rUIXMLDescription);
    OUString sUIDir = e == osl::FileBase::E_None ? getCustomizedUIRootDir() : getUIRootDir();
...
osl::FileBase::RC NotebookBar::doesFileExist(const OUString& sUIDir, const OUString& sUIFile)
{
    OUString sUri = sUIDir + sUIFile;
    osl::File file(sUri);
    sal_uInt32 flag = 0;
    osl::FileBase::RC e = file.open(flag);
    return e;
}
