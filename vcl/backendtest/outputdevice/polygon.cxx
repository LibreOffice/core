...
Bitmap OutputDeviceTestPolygon::setupBezier()
{
    ...
    std::vector<std::pair<tools::Long,tools::Long>> aDiamondPoints;
    Point aPoint1, aPoint2, aPoint3, aPoint4;
    OutputDeviceTestCommon::createAndAppendDiamondPoints(maVDRectangle, 8, aPoint1, aPoint2, aPoint3, aPoint4, aDiamondPoints);

    tools::Long distanceFromCoordinate = 4*(abs(aDiamondPoints[0].second-aDiamondPoints[2].second)/2)*((sqrt(2)-1)/3);
    tools::Long X,Y;
    int aPointNumber = 0;
    ...
    X=aDiamondPoints[aPointNumber].first,Y=aDiamondPoints[aPointNumber].second;
...
Bitmap OutputDeviceTestPolygon::setupHalfEllipse()
{
