...
GraphicsRenderTests::GraphicsRenderTests()
{
    ...
    //TODO: Why is this empty? Is this because of conversion to OString?
    OUString aBackendName = aOutDevTest.getRenderBackendName();
    OString aTemp = OUStringToOString(aBackendName, RTL_TEXTENCODING_ASCII_US);
...
bool GraphicsRenderTests::isVersionNewer(bool aUpdateVersion)
{
...
void GraphicsRenderTests::run()
{
    ...
    string atestResults = "Current Graphics Backend:" + m_aCurGraphicsBackend + "\n"
    ...
    logFile.WriteCharPtr(atestResults.c_str());
}
