...
void GraphicsRenderTests::run()
{
    ...
    string aCurGraphicsBackend = "Current Graphics Backend:" + m_aCurGraphicsBackend + "\n";
    string aPassedResults = "Passed tests : " + to_string(m_aPassed.size()) + "\n";
    string aQuirkyResults = "Quirky tests : " + to_string(m_aQuirky.size()) + "\n";
    string aFailedResults = "Failed tests : " + to_string(m_aFailed.size()) + "\n";
    logFile.WriteCharPtr(aCurGraphicsBackend.c_str());
    logFile.WriteCharPtr(aPassedResults.c_str());
    logFile.WriteCharPtr(aQuirkyResults.c_str());
    logFile.WriteCharPtr(aFailedResults.c_str());
    logFile.WriteChar('\n');
    /*
