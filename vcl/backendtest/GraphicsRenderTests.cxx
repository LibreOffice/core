...
void GraphicsRenderTests::testDrawRectWithRectangle()
{
    ...
    {
        appendTestResult(atestName, returnTestStatus(eResult), aBitmap);
    }
}
...
void GraphicsRenderTests::testDrawBlend()
{
    ...
    {
        appendTestResult(atestName, returnTestStatus(eResult), aBitmapEx.GetBitmap());
    }
}
...
void GraphicsRenderTests::appendTestResult(OUString aTestName, OUString aTestStatus,
                                           Bitmap aTestBitmap)
{
    VclTestResult aNewTestObject(aTestName, aTestStatus, aTestBitmap);
    m_aTestResult.push_back(aNewTestObject);
}
