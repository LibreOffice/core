...
{
    vcl::test::OutputDeviceTestCommon aOutDevTest;
    //TODO: Why is this empty? Is this because of conversion to OString?
    OString aTemp = OUStringToOString(aOutDevTest.getRenderBackendName(), RTL_TEXTENCODING_UTF8);
...
void GraphicsRenderTests::run()
{
    ...
    logFile.WriteOString("Current Graphics Backend:" + m_aCurGraphicsBackend + "\n"
