...
void JSInstanceBuilder::RememberWidget(OString sId, weld::Widget* pWidget)
{
    ...
    // excaption is builder where we base our full invalidation on that "Panel" id sharing
    if (m_sTypeOfJSON != "sidebar")
    {
        static unsigned long long int nNotRepeatIndex = 0;
