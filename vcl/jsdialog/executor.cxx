        ...
        else if (sControlType == "drawingarea")
        {
            ...
            if (pArea)
            {
                if (sAction == "click")
                {
                    ...
                    {
                        // x;y
                        OString clickPosX = OUStringToOString(rData["data"].subView(0, separatorPos),  RTL_TEXTENCODING_ASCII_US);
                        OString  clickPosY = OUStringToOString(rData["data"].subView(separatorPos + 1),  RTL_TEXTENCODING_ASCII_US);
