...
bool CustomWidgetDraw::updateSettings(AllSettings& rSettings)
{
    ...
    if (s_pWidgetImplementation->updateSettings(aStyle))
    {
        ...
        aStyleSet.SetDefaultActionButtonRolloverTextColor(aStyle.maDefaultActionButtonRolloverTextColor);
        ...
        aStyleSet.SetDefaultButtonPressedRolloverTextColor(aStyle.maDefaultButtonPressedRolloverTextColor);
        aStyleSet.SetButtonPressedRolloverTextColor(aStyle.maButtonPressedRolloverTextColor);
        aStyleSet.SetDefaultActionButtonPressedRolloverTextColor(aStyle.maDefaultActionButtonPressedRolloverTextColor);
        aStyleSet.SetActionButtonPressedRolloverTextColor(aStyle.maActionButtonPressedRolloverTextColor);
        aStyleSet.SetFlatButtonPressedRolloverTextColor(aStyle.maFlatButtonPressedRolloverTextColor);
