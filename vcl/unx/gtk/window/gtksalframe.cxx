    ...
    else if( keyval >= GDK_F1 && keyval <= GDK_F26 )
    {
...
#endif
        {
            switch( keyval )
            {
                ...
                case GDK_L6:            nCode = KEY_COPY;       break; 
                case GDK_L8:            nCode = KEY_PASTE;      break; 
                case GDK_L10:           nCode = KEY_CUT;        break; 
                default:
...
{
    if( nStyle & SAL_FRAME_STYLE_DEFAULT ) 
    {
