...
tools::Rectangle GtkSalGraphics::NWGetSpinButtonRect( ControlPart nPart, tools::Rectangle aAreaRect)
{
    ...
    tools::Rectangle buttonRect(Point(0, aAreaRect.Top()),
                                Size(buttonWidth, aAreaRect.GetHeight() + 1));
                                         ...
                                         ControlState nState )
{
    ...
    tools::Rectangle arrowRect(buttonRect.Center() - Size(iconWidth / 2, iconHeight / 2),
