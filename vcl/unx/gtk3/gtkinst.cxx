...
private:
    ...
    static gboolean signalDraw(GtkWidget* pWidget, cairo_t* cr, gpointer self)
    {
        ...
        cairo_set_source_rgba(cr, aColor.GetRed() / 255.0, aColor.GetGreen() / 255.0, aColor.GetBlue() / 255.0, 0.2);
...
public:
        ...
        , m_nFlashCount(1)
    {
        ...
        m_nFlashTimeout = g_timeout_add(150, reinterpret_cast<GSourceFunc>(FlashTimeout), this);
    }
