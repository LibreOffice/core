...
bool GtkSalGraphics::drawNativeControl( ControlType nType, ControlPart nPart, const Rectangle& rControlRegion,
                                            ...
                                            const OUString& )
{
    gint renderType = nPart == ControlPart::Focus ? RENDER_FOCUS : RENDER_BACKGROUND_AND_FRAME;
    ...
    case ControlType::Listbox:
        ...
        renderType = nPart == ControlPart::Focus ? RENDER_FOCUS : RENDER_COMBOBOX;
        break;
    ...
    case ControlType::Radiobutton:
        ...
        renderType = nPart == ControlPart::Focus ? RENDER_FOCUS : RENDER_RADIO;
        break;
    case ControlType::Checkbox:
        ...
        renderType = nPart == ControlPart::Focus ? RENDER_FOCUS : RENDER_CHECK;
        break;
...
bool GtkSalGraphics::IsNativeControlSupported( ControlType nType, ControlPart nPart )
{
    switch(nType)
    {
        ...
        case ControlType::Listbox:
            if (nPart==ControlPart::Entire || nPart==ControlPart::Window || nPart==ControlPart::HasBackgroundTexture || nPart == ControlPart::Focus)
                return true;
            break;
