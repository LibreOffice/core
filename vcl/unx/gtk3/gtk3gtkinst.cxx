...
void show_menu_older_gtk(GtkWidget* pMenuButton, GtkWindow* pMenu)
{
    ...
    tools::Rectangle aWorkArea(::get_monitor_workarea(GTK_WIDGET(pMenu)));
    gint endx = x + gtk_widget_get_allocated_width(GTK_WIDGET(pMenu));
    ...
    gint nMenuHeight = gtk_widget_get_allocated_height(GTK_WIDGET(pMenu));
...
bool show_menu_newer_gtk(GtkWidget* pComboBox, GtkWindow* pMenu)
{
    ...
    gint nPopupWidth = gtk_widget_get_allocated_width(GTK_WIDGET(pMenu));
