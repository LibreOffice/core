...
public:
    GtkInstanceNotebook(GtkNotebook* pNotebook, bool bTakeOwnership)
        ...
        , m_FocusSignalId(g_signal_connect(pNotebook, "focus", G_CALLBACK(signalFocus), this))
    ...
    virtual void disable_notify_events() override
    {
        ...
        g_signal_handler_block(m_pNotebook, m_FocusSignalId);
    ...
    virtual void enable_notify_events() override
    {
        ...
        g_signal_handler_unblock(m_pNotebook, m_FocusSignalId);
    }
    ...
    virtual ~GtkInstanceNotebook() override
    {
        ...
        g_signal_handler_disconnect(m_pNotebook, m_FocusSignalId);
