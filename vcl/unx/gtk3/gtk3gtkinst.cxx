...
private:
    ...
    static gboolean signalKeyPress(GtkWidget*, GdkEventKey* pEvent, gpointer widget)
    {
        ...
        gboolean ret;
        GtkWidget* pWidget = pThis->m_pTreeView->getWidget();
        gtk_widget_grab_focus(pWidget);
        g_signal_emit_by_name(pWidget, "key-press-event", pEvent, &ret);
        gtk_widget_grab_focus(pThis->m_pEntry->getWidget());
        gtk_editable_select_region(GTK_EDITABLE(pThis->m_pEntry->getWidget()), 0, -1);
        return true;
    }
