...
public:
    ...
    virtual void get_extents_relative_to(Window& rRelative, int& x, int &y, int& width, int &height)
    {
        gtk_widget_translate_coordinates(dynamic_cast<GtkInstanceWindow&>(rRelative).getWidget(), m_pWidget, 0, 0, &x, &y);
