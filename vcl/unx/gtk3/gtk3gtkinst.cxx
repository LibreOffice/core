...
public:
    ...
    virtual void connect_focus_out(const Link<Widget&, void>& rLink) override
    {
        ...
        m_nFocusOutSignalId = g_signal_connect(m_pWidget, "focus-out-event", G_CALLBACK(signalFocusIn), this);
...
static AtkObject* drawing_area_get_accessibity(GtkWidget *pWidget)
{
...
static void ensure_intercept_drawing_area_accessibility()
{
    static bool bDone;
    if (!bDone)
    {
