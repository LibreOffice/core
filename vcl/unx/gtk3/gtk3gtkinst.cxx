...
public:
        ...
        , m_pSidebar(nullptr)
    {
        ...
        m_pMouseEventBox = ::ensureEventWidget(m_pSidebar);
        m_nButtonPressSignalId = m_pMouseEventBox ? g_signal_connect(m_pMouseEventBox, "button-press-event", G_CALLBACK(signalButton), this) : 0;
    }
