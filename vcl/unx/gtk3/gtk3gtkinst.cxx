...
private:
    ...
    gulong m_nFocusOutEventSignalId;

    static gboolean signalFocusOutEvent(GtkComboBox*, GdkEvent*, gpointer widget)
    {
        GtkInstanceWidget* pThis = static_cast<GtkInstanceWidget*>(widget);
        pThis->signal_focus_out_event();
        return false;
    }
public:
    GtkInstanceWidget(GtkWidget* pWidget, bool bTakeOwnership)
        ...
        , m_nFocusOutEventSignalId(g_signal_connect(pWidget, "focus-out-event", G_CALLBACK(signalFocusOutEvent), this))
    {
    }
    ...
    OString get_buildable_name() const override
    {
        ...
        return OString(pStr, strlen(pStr));
    }

    virtual ~GtkInstanceWidget() override
    {
        g_signal_handler_disconnect(m_pWidget, m_nFocusOutEventSignalId);
        if (m_bTakeOwnership)
...
public:
    ...
    virtual Weld::Container* get_page(const OString& rIdent) const
    {
...
public:
    ...
    virtual void get_increments(double& step, double& page) const override
    {
        gtk_spin_button_get_increments(m_pButton, &step, &page);
    }
...
public:
    ...
    virtual Weld::Dialog* weld_dialog(const OString &id) override
    {
        ...
        return pDialog ? new GtkInstanceDialog(pDialog, true) : nullptr;
    }
