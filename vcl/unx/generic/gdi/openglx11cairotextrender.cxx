...
cairo_surface_t* OpenGLX11CairoTextRender::getCairoSurface()
{
    ...
    else
    {
        ...
        {
            if( maTextBoundRect.GetWidth() > aClipRect.GetWidth() )
                maTextBoundRect.setWidth( aClipRect.GetWidth() );

            if( maTextBoundRect.GetHeight() > aClipRect.GetHeight() )
                maTextBoundRect.setHeight( aClipRect.GetHeight() );
        }
    }
