                                  ...
                                  const RenderContext &rCtx) override
        {
            if (rCtx.meStyle == RENDER_EXPANDED)
            {
                ...
                for (size_t i = 0; i < aRegions.size(); i++)
                {
                    ...
                    aSmaller.Move(10,10);
                    aSmaller.setWidth(aSmaller.getHalfOpenWidth()-20);
                    aSmaller.setHeight(aSmaller.getHalfOpenHeight()-24);
                    switch (i) {
                    case 0:
...
public:
    ...
    {
        mrRenderer.SetSizePixel(GetSizePixel());
        fprintf(stderr, "DemoWin::Paint(%" SAL_PRIdINT64 ",%" SAL_PRIdINT64 ",%" SAL_PRIdINT64 ",%" SAL_PRIdINT64 ")\n", sal_Int64(rRect.Left()), sal_Int64(rRect.Top()), sal_Int64(rRect.getHalfOpenWidth()), sal_Int64(rRect.getHalfOpenHeight()));
