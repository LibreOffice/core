        ...
        static void drawText (OutputDevice &rDev, tools::Rectangle r, bool bClip, bool bArabicText, bool bRotate)
        {
            ...
            for (int i = 1; i < nPrintNumCopies+1; i++)
            {
                ...
                if (bRotate)
                {
                    ...
                    aFont.SetOrientation(DeciDegrees(450)); // 45 degrees
            ...
            if (rCtx.meStyle == RENDER_EXPANDED)
            {
                ...
                for (size_t i = 0; i < aRegions.size(); i++)
                {
                    ...
                    case 2:
                    {
                        ...
                        aPoly.Rotate(aSub.Center(), DeciDegrees(450));
                        aPoly.Clip(aSmaller);
                                  ...
                                  const RenderContext &rCtx) override
        {
            if (rCtx.meStyle == RENDER_EXPANDED)
            {
                ...
                for (size_t i = 0; i < aRegions.size(); i++)
                {
                    ...
                    aGradient.SetAngle(DeciDegrees(nAngles[i]));
                ...
                for (int j = 0; !bDone; ++j)
                {
                    ...
                    for (int i = 0; i < 4; ++i)
                    {
                        ...
                        case 0: // 45degree rectangle.
                            ...
                            aPoly.Rotate(aPieces[i].Center(), DeciDegrees(450));
                            break;
                        case 1: // arc
                            aPoly = tools::Polygon(aPieces[i],
                                                   aPieces[i].TopLeft(),
