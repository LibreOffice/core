...
public:
    ...
    void SetUniform1fv( const OString& rName, GLsizei nCount, const GLfloat* aValues );
    void SetUniform2fv( const OString& rName, GLsizei nCount, const GLfloat* aValues );
