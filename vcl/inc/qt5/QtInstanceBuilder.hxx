...
public:
    ...
    virtual std::unique_ptr<weld::Container> weld_container(const OUString&) override;
    ...
    virtual std::unique_ptr<weld::Notebook> weld_notebook(const OUString&) override;
    virtual std::unique_ptr<weld::Button> weld_button(const OUString&) override;
    ...
    virtual std::unique_ptr<weld::LinkButton> weld_link_button(const OUString&) override;
    virtual std::unique_ptr<weld::ToggleButton> weld_toggle_button(const OUString&) override;
    virtual std::unique_ptr<weld::RadioButton> weld_radio_button(const OUString&) override;
    virtual std::unique_ptr<weld::CheckButton> weld_check_button(const OUString&) override;
    ...
    virtual std::unique_ptr<weld::ComboBox> weld_combo_box(const OUString&) override;
    virtual std::unique_ptr<weld::EntryTreeView>
    weld_entry_tree_view(const OUString&, const OUString&, const OUString&) override;
    virtual std::unique_ptr<weld::TreeView> weld_tree_view(const OUString&) override;
    ...
    virtual std::unique_ptr<weld::TextView> weld_text_view(const OUString&) override;
