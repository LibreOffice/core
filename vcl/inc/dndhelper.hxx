...
OleDnDHelper(css::uno::Reference<css::lang::XInitialization>, sal_IntPtr pWin, DragOrDrop);

VCL_DLLPUBLIC css::uno::Reference<css::uno::XInterface>
X11DnDHelper(css::uno::Reference<css::lang::XInitialization>, const SystemEnvData*);
}
