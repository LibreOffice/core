...
public:
    ...
    static SAL_DLLPRIVATE void  ImplDrawText( OutputDevice& rTargetDevice, const Rectangle& rRect,
    ...
    static SAL_DLLPRIVATE long  ImplGetTextLines( OutputDevice& rTargetDevice, ImplMultiTextLineInfo& rLineInfo, long nWidth, const XubString& rStr, USHORT nStyle, const ::vcl::ITextLayout& _rLayout );
