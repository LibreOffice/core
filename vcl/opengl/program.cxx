...
void OpenGLProgram::SetUniform1fv( const OString& rName, GLsizei nCount, const GLfloat* aValues )
{
    GLuint nUniform = GetUniformLocation( rName );
...
void OpenGLProgram::SetUniform2fv( const OString& rName, GLsizei nCount, const GLfloat* aValues )
{
    GLuint nUniform = GetUniformLocation( rName );
