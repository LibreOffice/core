...
OString aCacheFolder = getCacheFolder();
...
bool WinOpenGLDeviceInfo::isDeviceBlocked()
{
    ...
    SvFileStream aOpenGLLogFile(aCacheFolder + OUString("/opengl_device.log"), StreamMode::WRITE);

    writeToLog(aOpenGLLogFile, "DriverVersion", maDriverVersion);
    writeToLog(aOpenGLLogFile, "DriverDate", maDriverData);
