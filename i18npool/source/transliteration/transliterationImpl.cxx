...
static struct TMlist {
  ...
  TmItem1 (IGNORE_CASE),            // (1<<8        256) (7)
  TmItem1 (IGNORE_WIDTH),           // (1<<9        512) (8)
  TmItem1 (IGNORE_KANA),            // (1<<10      1024) (9)
// No enum define for this trans. application has to use impl name to load it
//  TmItem1 (IGNORE_CASE_SIMPLE),           // (1<<11      1024) (66)

  TmItem1 (ignoreTraditionalKanji_ja_JP),   // (1<<12      4096) (10)
  TmItem1 (ignoreTraditionalKana_ja_JP),    // (1<<13      8192) (11)
  TmItem1 (ignoreMinusSign_ja_JP),      // (1<<13     16384) (12)
  TmItem1 (ignoreIterationMark_ja_JP),      // (1<<14     32768) (13)
  TmItem1 (ignoreSeparator_ja_JP),      // (1<<15     65536) (14)
  TmItem1 (ignoreZiZu_ja_JP),           // (1<<16    131072) (15)
  TmItem1 (ignoreBaFa_ja_JP),           // (1<<17    262144) (16)
  TmItem1 (ignoreTiJi_ja_JP),           // (1<<18    524288) (17)
  TmItem1 (ignoreHyuByu_ja_JP),         // (1<<19   1048576) (18)
  TmItem1 (ignoreSeZe_ja_JP),           // (1<<20   2097152) (19)
  TmItem1 (ignoreIandEfollowedByYa_ja_JP),  // (1<<21   4194304) (20)
  TmItem1 (ignoreKiKuFollowedBySa_ja_JP),   // (1<<22   8388608) (21)
  TmItem1 (ignoreSize_ja_JP),           // (1<<23  16777216) (22)
  TmItem1 (ignoreProlongedSoundMark_ja_JP), // (1<<24  33554432) (23)
  TmItem1 (ignoreMiddleDot_ja_JP),      // (1<<25  67108864) (24)
  TmItem1 (ignoreSpace_ja_JP),          // (1<<26 134217728) (25)
  TmItem1 (UPPERCASE_LOWERCASE),    // (1) (1)
  TmItem1 (LOWERCASE_UPPERCASE),    // (2) (2)
  TmItem1 (HALFWIDTH_FULLWIDTH),    // (3) (3)
  TmItem1 (FULLWIDTH_HALFWIDTH),    // (4) (4)
  TmItem1 (KATAKANA_HIRAGANA),      // (5) (5)
  TmItem1 (HIRAGANA_KATAKANA),      // (6) (6)

  TmItem1 (smallToLarge_ja_JP),     // (1<<27 268435456) (26)
  TmItem1 (largeToSmall_ja_JP),     // (1<<28 536870912) (27)
  TmItem2 (NumToTextLower_zh_CN),   // () (28)
  TmItem2 (NumToTextUpper_zh_CN),   // () (29)
  TmItem2 (NumToTextLower_zh_TW),   // () (30)
  TmItem2 (NumToTextUpper_zh_TW),   // () (31)
  TmItem2 (NumToTextFormalHangul_ko),   // () (32)
  TmItem2 (NumToTextFormalLower_ko),    // () (33)
  TmItem2 (NumToTextFormalUpper_ko),    // () (34)
  TmItem2 (NumToTextInformalHangul_ko), // () (35)
  TmItem2 (NumToTextInformalLower_ko),  // () (36)
  TmItem2 (NumToTextInformalUpper_ko),  // () (37)
  TmItem2 (NumToCharLower_zh_CN),   // () (38)
  TmItem2 (NumToCharUpper_zh_CN),   // () (39)
  TmItem2 (NumToCharLower_zh_TW),   // () (40)
  TmItem2 (NumToCharUpper_zh_TW),   // () (41)
  TmItem2 (NumToCharHangul_ko),     // () (42)
  TmItem2 (NumToCharLower_ko),      // () (43)
  TmItem2 (NumToCharUpper_ko),      // () (44)
  TmItem2 (NumToCharFullwidth),     // () (45)
  TmItem2 (NumToCharKanjiShort_ja_JP),  // () (46)
  TmItem2 (TextToNumLower_zh_CN),   // () (47)
  TmItem2 (TextToNumUpper_zh_CN),   // () (48)
  TmItem2 (TextToNumLower_zh_TW),   // () (49)
  TmItem2 (TextToNumUpper_zh_TW),   // () (50)
  TmItem2 (TextToNumFormalHangul_ko),   // () (51)
  TmItem2 (TextToNumFormalLower_ko),    // () (52)
  TmItem2 (TextToNumFormalUpper_ko),    // () (53)
  TmItem2 (TextToNumInformalHangul_ko), // () (54)
  TmItem2 (TextToNumInformalLower_ko),  // () (55)
  TmItem2 (TextToNumInformalUpper_ko),  // () (56)

  TmItem2 (CharToNumLower_zh_CN),   // () (59)
  TmItem2 (CharToNumUpper_zh_CN),   // () (60)
  TmItem2 (CharToNumLower_zh_TW),   // () (61)
  TmItem2 (CharToNumUpper_zh_TW),   // () (62)
  TmItem2 (CharToNumHangul_ko),     // () (63)
  TmItem2 (CharToNumLower_ko),      // () (64)
  TmItem2 (CharToNumUpper_ko),      // () (65)
...
{
    clear();
    for (sal_Int16 i = 0; i < modType.getLength(); i++) {
...
TransliterationImpl::getAvailableModules( const Locale& rLocale, sal_Int16 sType ) throw(RuntimeException)
{
    ...
    Reference<XTransliteration> body;
    sal_Int32 n = 0;
...
static void SAL_CALL loadBody( Reference<XMultiServiceFactory>& xSMgr, OUString &implName,
            Reference<XTransliteration>& body) throw(RuntimeException)
{
        ...
        if (implName.equals(xsInfo->getImplementationName())) {
            ...
            if (xI.is()) {
                a = xI->queryInterface(::getCppuType((
                    const Reference<XTransliteration>*)0));
                a >>= body;
                return;
            }
            }
...
TransliterationImpl::loadModuleByName( const OUString& implName,
    Reference<XTransliteration>& body, const Locale& rLocale) throw(RuntimeException)
{
