...
OUString SAL_CALL
largeToSmall_ja_JP::transliterate( const OUString& inStr, sal_Int32 startPos, sal_Int32 nCount, Sequence< sal_Int32 >& offset )
    throw(RuntimeException)
{
    // One to One mapping
    oneToOneMapping table(large2small, sizeof(large2small));
