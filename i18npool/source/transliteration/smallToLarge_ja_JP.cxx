...
OUString SAL_CALL
smallToLarge_ja_JP::transliterate( const OUString& inStr, sal_Int32 startPos, sal_Int32 nCount, Sequence< sal_Int32 >& offset )
    throw(RuntimeException)
{
    // One to One mapping
    oneToOneMapping table(small2large, sizeof(small2large));
    return transliteration_OneToOne::transliterate( inStr, startPos, nCount, offset, table );
}
