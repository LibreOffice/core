...
extern "C"
{
    static const sal_Unicode langID[] = { 0x61, 0x6d, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x41, 0x6d, 0x68, 0x61, 0x72, 0x69, 0x63, 0x0 };
    static const sal_Unicode countryID[] = { 0x45, 0x54, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x45, 0x74, 0x68, 0x69, 0x6f, 0x70, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_am_ET(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x1321, 0x12cb, 0x1275, 0x0 };
    static const sal_Unicode timePM[] = { 0x12a8, 0x1230, 0x12d3, 0x1275, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_am_ET(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCType);
        return (sal_Unicode**)LCType;
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x45, 0x54, 0x42, 0x2d, 0x34, 0x35, 0x45, 0x5d, 0x0 };
    ...
    getAllFormats0_am_ET(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_am_ET(sal_Int16& count)
    {
        return getDateAcceptancePatterns_en_GB(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_am_ET(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_am_ET(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_am_ET(sal_Int16& count)
    {
    ...
    static const sal_Unicode unicodeScript0[] = { 0x33, 0x30, 0x0 };
    static const sal_Unicode followPageWord0[] = { 0x1308, 0x12fd, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x1308, 0x12fe, 0x127d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_am_ET(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_am_ET(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_am_ET(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x12a5, 0x1211, 0x12f5, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x12a5, 0x1211, 0x12f5, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x12a5, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x1230, 0x129e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[] = { 0x1230, 0x129e, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x1230, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x121b, 0x12ad, 0x1230, 0x129e, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x121b, 0x12ad, 0x1230, 0x129e, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x121b, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x1228, 0x1261, 0x12d5, 0x0 };
    static const sal_Unicode dayDefaultFullName03[] = { 0x1228, 0x1261, 0x12d5, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x1228, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x1210, 0x1219, 0x1235, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x1210, 0x1219, 0x1235, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x1210, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x12d3, 0x122d, 0x1265, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x12d3, 0x122d, 0x1265, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x12d3, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x1245, 0x12f3, 0x121c, 0x0 };
    static const sal_Unicode dayDefaultFullName06[] = { 0x1245, 0x12f3, 0x121c, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x1245, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x1303, 0x1295, 0x12e9, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x1303, 0x1295, 0x12e9, 0x12c8, 0x122a, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x1303, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x134c, 0x1265, 0x1229, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x134c, 0x1265, 0x1229, 0x12c8, 0x122a, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x134c, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x121b, 0x122d, 0x127d, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0x121b, 0x122d, 0x127d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x121b, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x12a4, 0x1355, 0x1228, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x12a4, 0x1355, 0x1228, 0x120d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x12a4, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x121c, 0x12ed, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x121c, 0x12ed, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x121c, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x1301, 0x1295, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x1301, 0x1295, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x1301, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x1301, 0x120b, 0x12ed, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x1301, 0x120b, 0x12ed, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x1301, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x12a6, 0x1308, 0x1235, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x12a6, 0x1308, 0x1235, 0x1275, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x12a6, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x1234, 0x1355, 0x1274, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x1234, 0x1355, 0x1274, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x1234, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x12a6, 0x12ad, 0x1270, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x12a6, 0x12ad, 0x1270, 0x12cd, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x12a6, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x1296, 0x126c, 0x121d, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x1296, 0x126c, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x1296, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x12f2, 0x1234, 0x121d, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x12f2, 0x1234, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x12f2, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x1303, 0x1295, 0x12e9, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x1303, 0x1295, 0x12e9, 0x12c8, 0x122a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x1303, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x134c, 0x1265, 0x1229, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x134c, 0x1265, 0x1229, 0x12c8, 0x122a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x134c, 0x0 };
    static const sal_Unicode genitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x121b, 0x122d, 0x127d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[] = { 0x121b, 0x122d, 0x127d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0x121b, 0x0 };
    static const sal_Unicode genitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x12a4, 0x1355, 0x1228, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x12a4, 0x1355, 0x1228, 0x120d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0x12a4, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x121c, 0x12ed, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x121c, 0x12ed, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0x121c, 0x0 };
    static const sal_Unicode genitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x1301, 0x1295, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x1301, 0x1295, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x1301, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x1301, 0x120b, 0x12ed, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x1301, 0x120b, 0x12ed, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x1301, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x12a6, 0x1308, 0x1235, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x12a6, 0x1308, 0x1235, 0x1275, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0x12a6, 0x0 };
    static const sal_Unicode genitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x1234, 0x1355, 0x1274, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x1234, 0x1355, 0x1274, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0x1234, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x12a6, 0x12ad, 0x1270, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x12a6, 0x12ad, 0x1270, 0x12cd, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0x12a6, 0x0 };
    static const sal_Unicode genitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x1296, 0x126c, 0x121d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x1296, 0x126c, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0x1296, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x12f2, 0x1234, 0x121d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x12f2, 0x1234, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0x12f2, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x1303, 0x1295, 0x12e9, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x1303, 0x1295, 0x12e9, 0x12c8, 0x122a, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x1303, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x134c, 0x1265, 0x1229, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x134c, 0x1265, 0x1229, 0x12c8, 0x122a, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x134c, 0x0 };
    static const sal_Unicode partitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x121b, 0x122d, 0x127d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[] = { 0x121b, 0x122d, 0x127d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0x121b, 0x0 };
    static const sal_Unicode partitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x12a4, 0x1355, 0x1228, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0x12a4, 0x1355, 0x1228, 0x120d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0x12a4, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x121c, 0x12ed, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x121c, 0x12ed, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0x121c, 0x0 };
    static const sal_Unicode partitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x1301, 0x1295, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x1301, 0x1295, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x1301, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x1301, 0x120b, 0x12ed, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x1301, 0x120b, 0x12ed, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x1301, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x12a6, 0x1308, 0x1235, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0x12a6, 0x1308, 0x1235, 0x1275, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0x12a6, 0x0 };
    static const sal_Unicode partitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x1234, 0x1355, 0x1274, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0x1234, 0x1355, 0x1274, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0x1234, 0x0 };
    static const sal_Unicode partitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x12a6, 0x12ad, 0x1270, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0x12a6, 0x12ad, 0x1270, 0x12cd, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0x12a6, 0x0 };
    static const sal_Unicode partitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x1296, 0x126c, 0x121d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0x1296, 0x126c, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0x1296, 0x0 };
    static const sal_Unicode partitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x12f2, 0x1234, 0x121d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0x12f2, 0x1234, 0x121d, 0x1260, 0x122d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0x12f2, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x12a0, 0x2e, 0x12a0, 0x1208, 0x121d, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x12a8, 0x12ad, 0x122d, 0x1235, 0x1276, 0x1235, 0x20, 0x120d,
            0x12f0, 0x1275, 0x20,   0x1260, 0x134a, 0x1275, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x12a0, 0x2e, 0x121d, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x12a0, 0x1218, 0x1270, 0x20, 0x121d, 0x1205, 0x1228, 0x1275, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_am_ET(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x45, 0x54, 0x42, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x45, 0x54, 0x42, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x45, 0x54, 0x42, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x45, 0x74, 0x68, 0x69, 0x6f, 0x70, 0x69, 0x61,
                                                 0x6e, 0x20, 0x42, 0x69, 0x72, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_am_ET(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_am_ET(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x12a0, 0x12cd, 0x1290, 0x1275, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x1214, 0x1230, 0x1275, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x12ad, 0x134d, 0x120d, 0x20, 0x12a0, 0x1295, 0x12f5, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x12ad, 0x134d, 0x120d, 0x20, 0x1201, 0x1208, 0x1275, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x12ad, 0x134d, 0x120d, 0x20, 0x1236, 0x1235, 0x1275, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x12ad, 0x134d, 0x120d, 0x20, 0x12a0, 0x122b, 0x1275, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x1260, 0x120b, 0x12ed, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x1260, 0x1273, 0x127d, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x12ad, 0x12a0, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x12ad, 0x1201, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x12ad, 0x1236, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x12ad, 0x12a0, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_am_ET(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_am_ET(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_am_ET(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_am_ET(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_am_ET(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
