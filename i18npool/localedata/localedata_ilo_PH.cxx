...
extern "C"
{
    static const sal_Unicode langID[] = { 0x69, 0x6c, 0x6f, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x49, 0x6c, 0x6f, 0x6b, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ilo_PH(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateDaySeparator[] = { 0x20, 0x74, 0x69, 0x20, 0x0 };
    static const sal_Unicode LongDateMonthSeparator[] = { 0x20, 0x69, 0x74, 0x69, 0x20, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ilo_PH(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x50, 0x68, 0x70, 0x2d, 0x36, 0x41, 0x33, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode0[]
        = { 0x4b, 0x61, 0x64, 0x61, 0x79, 0x77, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x20, 0x22, 0x74, 0x69, 0x22, 0x20, 0x4d, 0x4d, 0x4d,
            0x4d, 0x20, 0x22, 0x69, 0x74, 0x69, 0x22, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode25[]
        = { 0x44, 0x20, 0x22, 0x74, 0x69, 0x22, 0x20, 0x4d, 0x4d, 0x4d,
            0x20, 0x22, 0x69, 0x74, 0x69, 0x22, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x44, 0x20, 0x22, 0x74, 0x69, 0x22, 0x20, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x44, 0x20, 0x22, 0x74, 0x69, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20,
            0x22, 0x69, 0x74, 0x69, 0x22, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode30[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x44, 0x20, 0x22, 0x74, 0x69, 0x22,
    ...
    static const sal_Unicode FormatCode32[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x44, 0x20, 0x22, 0x74, 0x69, 0x22, 0x20,
    ...
    static const sal_Unicode FormatCode33[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x20, 0x22, 0x74, 0x69, 0x22, 0x20,
            0x4d, 0x4d, 0x4d, 0x4d, 0x2c, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_ilo_PH(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ilo_PH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ilo_PH(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ilo_PH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ilo_PH(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[] = { 0x41, 0x2d, 0x4e, 0x20, 0xd1, 0x20, 0x7b, 0x4e,
                                             0x47, 0x7d, 0x20, 0x4f, 0x2d, 0x5a, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ilo_PH(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ilo_PH(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ilo_PH(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x44, 0x6f, 0x6d, 0x69, 0x6e, 0x67, 0x67, 0x6f, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x4d, 0x69, 0x65, 0x72, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x4d, 0x69, 0x65, 0x72, 0x6b, 0x6f, 0x6c, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x42, 0x69, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x48, 0x75, 0x6e, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x48, 0x75, 0x6c, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x53, 0x65, 0x70, 0x74, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x4f, 0x6b, 0x74, 0x75, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x44, 0x69, 0x73, 0x69, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x53, 0x65, 0x70, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x53, 0x65, 0x70, 0x74, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ilo_PH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ilo_PH(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ilo_PH(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x70, 0x75, 0x64, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x75, 0x62, 0x62, 0x61, 0x77, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x75, 0x6d, 0x75, 0x6e, 0x61, 0x20, 0x61, 0x20,
                                                 0x6b, 0x61, 0x6b, 0x61, 0x70, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x6d, 0x61, 0x69, 0x6b, 0x61, 0x2d, 0x32, 0x20, 0x61,
            0x20, 0x6b, 0x61, 0x6b, 0x61, 0x70, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x6d, 0x61, 0x69, 0x6b, 0x61, 0x2d, 0x33, 0x20, 0x61,
            0x20, 0x6b, 0x61, 0x6b, 0x61, 0x70, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x6d, 0x61, 0x69, 0x6b, 0x61, 0x2d, 0x34, 0x20, 0x61,
            0x20, 0x6b, 0x61, 0x6b, 0x61, 0x70, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0x69, 0x74, 0x69, 0x20, 0x6e, 0x67, 0x61, 0x74, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord7[]
        = { 0x69, 0x74, 0x69, 0x20, 0x62, 0x61, 0x62, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ilo_PH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ilo_PH(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ilo_PH(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ilo_PH(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ilo_PH(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
