...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_fr_LU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_fr_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode17[]
        = { 0x4a, 0x4a, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode18[] = { 0x4e, 0x4e, 0x4e, 0x4e, 0x4a, 0x20, 0x4d, 0x4d,
                                                0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode19[]
        = { 0x4a, 0x4a, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x4a, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x4a, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode23[]
        = { 0x4a, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x4a, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode25[]
        = { 0x4a, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x20, 0x4a, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x4a, 0x4a, 0x2f, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode28[] = { 0x4e, 0x4e, 0x20, 0x4a, 0x20, 0x4d, 0x4d, 0x4d,
                                                0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode29[] = { 0x4e, 0x4e, 0x4e, 0x4e, 0x4a, 0x20, 0x4d, 0x4d,
                                                0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode30[] = { 0x4d, 0x4d, 0x2d, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode31[]
        = { 0x41, 0x41, 0x2d, 0x4d, 0x4d, 0x2d, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode32[]
        = { 0x41, 0x41, 0x41, 0x41, 0x2d, 0x4d, 0x4d, 0x2d, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode34[] = { 0x4a, 0x4a, 0x2f, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    static const sal_Unicode FormatCode45[] = { 0x4a, 0x4a, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x4a, 0x4a, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode47[]
        = { 0x4a, 0x4a, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41,
    ...
    getAllFormats0_fr_LU(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_fr_LU(sal_Int16& count)
    {
        count = DateAcceptancePatternsCount;
        return (sal_Unicode**)DateAcceptancePatternsArray;
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_fr_LU(sal_Int16& count)
    {
        return getCollatorImplementation_fr_FR(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_fr_LU(sal_Int16& count)
    {
        return getCollationOptions_fr_FR(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_fr_LU(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_fr_LU(sal_Int16& count)
    {
        return getIndexAlgorithm_fr_FR(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_fr_LU(sal_Int16& count)
    {
        return getUnicodeScripts_fr_FR(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_fr_LU(sal_Int16& count)
    {
        return getFollowPageWords_fr_FR(count);
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_fr_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0x65, 0x75, 0x72, 0x6f, 0x0 };
    ...
    static const sal_Unicode currencyName1[]
        = { 0x66, 0x72, 0x61, 0x6e, 0x63, 0x20, 0x6c, 0x75, 0x78, 0x65, 0x6d,
            0x62, 0x6f, 0x75, 0x72, 0x67, 0x65, 0x6f, 0x69, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_fr_LU(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_fr_LU(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getForbiddenCharacters_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_fr_LU(sal_Int16& count)
    {
        return getForbiddenCharacters_fr_FR(count);
    }
    extern sal_Unicode** SAL_CALL getBreakIteratorRules_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_fr_LU(sal_Int16& count)
    {
        return getBreakIteratorRules_fr_FR(count);
    }
    extern sal_Unicode** SAL_CALL getReservedWords_fr_FR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_fr_LU(sal_Int16& count)
    {
    ...
    getContinuousNumberingLevels_fr_LU(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_fr_LU(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
