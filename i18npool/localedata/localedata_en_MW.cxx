...
extern "C"
{
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x4d, 0x4b, 0x2d, 0x38, 0x38, 0x30, 0x39, 0x5d, 0x0 };
    ...
    getAllFormats0_en_MW(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    static const sal_Unicode currencyName0[] = { 0x4d, 0x61, 0x6c, 0x61, 0x77, 0x69, 0x61, 0x6e,
                                                 0x20, 0x6b, 0x77, 0x61, 0x63, 0x68, 0x61, 0x0 };
    ...
    getContinuousNumberingLevels_en_MW(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_GB(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_en_MW(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
