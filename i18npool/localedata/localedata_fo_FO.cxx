...
extern "C"
{
    static const sal_Unicode langID[] = { 0x66, 0x6f, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x46, 0x61, 0x72, 0x6f, 0x65, 0x73, 0x65, 0x0 };
    static const sal_Unicode countryID[] = { 0x46, 0x4f, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x46, 0x61, 0x72, 0x6f, 0x65, 0x20, 0x49, 0x73, 0x6c, 0x61, 0x6e, 0x64, 0x73, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_fo_FO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_fo_FO(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode13[] = { 0x4e, 0x4e, 0x20, 0x44, 0x2e, 0x20, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode28[] = { 0x44, 0x44, 0x2d, 0x4d, 0x4d, 0x2d, 0x59, 0x59,
    ...
    static const sal_Unicode FormatCode37[]
        = { 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x33, 0x38, 0x5d, 0x20, 0x23,
            0x2e, 0x23, 0x23, 0x30, 0x3b, 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34,
            0x33, 0x38, 0x5d, 0x20, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode38[]
        = { 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x33, 0x38, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            0x23, 0x30, 0x2c, 0x30, 0x30, 0x3b, 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x33,
            0x38, 0x5d, 0x20, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode39[]
        = { 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x33, 0x38, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            ...
            0x34, 0x33, 0x38, 0x5d, 0x20, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode40[]
        = { 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x33, 0x38, 0x5d, 0x20, 0x23,
            ...
            0x5d, 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x33, 0x38, 0x5d, 0x20,
    ...
    getAllFormats0_fo_FO(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_fo_FO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_fo_FO(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_fo_FO(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_fo_FO(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0xc1, 0x42, 0x43, 0x44, 0xd0, 0x45, 0x46, 0x47, 0x48, 0x49, 0xcd, 0x4a,
            0x4b, 0x4c, 0x4d, 0x4e, 0x4f, 0xd3, 0x50, 0x51, 0x52, 0x53, 0x54, 0xde, 0x55,
            0xda, 0x56, 0x57, 0x58, 0x59, 0xdd, 0x5a, 0xc6, 0xd8, 0xc5, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_fo_FO(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_fo_FO(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_fo_FO(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x61, 0x70, 0x72, 0xed, 0x6c, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x64, 0x65, 0x73, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x73, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x64, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x64, 0x65, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_fo_FO(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencySymbol0[] = { 0x6b, 0x72, 0x2e, 0x0 };
    ...
    static const sal_Unicode currencySymbol1[] = { 0x6b, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_fo_FO(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_fo_FO(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x73, 0x6f, 0x6e, 0x6e, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0xf3, 0x73, 0x6f, 0x6e, 0x6e, 0x0 };
    ...
    static const sal_Unicode ReservedWord6[] = { 0x79, 0x76, 0x69, 0x72, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x75, 0x6e, 0x64, 0x69, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_fo_FO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_fo_FO(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_fo_FO(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_fo_FO(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_fo_FO(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
