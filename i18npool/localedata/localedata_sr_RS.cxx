...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x52, 0x53, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sr_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x43f, 0x440, 0x435, 0x2e, 0x0 };
    static const sal_Unicode timePM[] = { 0x43f, 0x43e, 0x43f, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sr_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x420, 0x421, 0x414, 0x2d, 0x38, 0x43, 0x31, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_sr_RS(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_sr_RS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_sr_RS(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_sr_RS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_sr_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x410, 0x20, 0x411, 0x20, 0x412, 0x20, 0x413, 0x20, 0x414, 0x20, 0x402, 0x20,
            0x415, 0x20, 0x416, 0x20, 0x417, 0x20, 0x418, 0x20, 0x408, 0x20, 0x41a, 0x20,
            0x41b, 0x20, 0x409, 0x20, 0x41c, 0x20, 0x41d, 0x20, 0x40a, 0x20, 0x41e, 0x20,
            0x41f, 0x20, 0x420, 0x20, 0x421, 0x20, 0x422, 0x20, 0x40b, 0x20, 0x423, 0x20,
            0x424, 0x20, 0x425, 0x20, 0x426, 0x20, 0x427, 0x20, 0x40f, 0x20, 0x428, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_sr_RS(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_sr_RS(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_sr_RS(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x43d, 0x435, 0x434, 0x435, 0x459, 0x430, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x43f, 0x43e, 0x43d, 0x435, 0x434, 0x435, 0x459, 0x430, 0x43a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x43f, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x443, 0x442, 0x43e, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x443, 0x442, 0x43e, 0x440, 0x430, 0x43a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x443, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x447, 0x435, 0x442, 0x432, 0x440, 0x442, 0x430, 0x43a, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[] = { 0x43f, 0x435, 0x442, 0x430, 0x43a, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x458, 0x430, 0x43d, 0x443, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x458, 0x443, 0x43d, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x458, 0x443, 0x43b, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x441, 0x435, 0x43f, 0x442, 0x435, 0x43c, 0x431, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x43e, 0x43a, 0x442, 0x43e, 0x431, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x43d, 0x43e, 0x432, 0x435, 0x43c, 0x431, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x434, 0x435, 0x446, 0x435, 0x43c, 0x431, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x458, 0x443, 0x43d, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x458, 0x443, 0x43b, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x458, 0x443, 0x43d, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x458, 0x443, 0x43b, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x43f, 0x2e, 0x20, 0x43d, 0x2e, 0x20, 0x435, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x43f, 0x440, 0x435, 0x20, 0x43d, 0x43e, 0x432, 0x435, 0x20, 0x435, 0x440, 0x435, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x43d, 0x2e, 0x20, 0x435, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x43d, 0x43e, 0x432, 0x435, 0x20, 0x435, 0x440, 0x435, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_sr_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x420, 0x421, 0x414, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x421, 0x440, 0x43f, 0x441, 0x43a, 0x438, 0x20,
                                                 0x434, 0x438, 0x43d, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x434, 0x438, 0x43d, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x421, 0x440, 0x43f, 0x441, 0x43a, 0x438, 0x20,
                                                 0x434, 0x438, 0x43d, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode currencyID2[] = { 0x43, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencySymbol2[] = { 0x426, 0x421, 0x414, 0x0 };
    static const sal_Unicode bankSymbol2[] = { 0x43, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName2[] = { 0x421, 0x440, 0x43f, 0x441, 0x43a, 0x438, 0x20,
                                                 0x434, 0x438, 0x43d, 0x430, 0x440, 0x0 };
    ...
    static const sal_Unicode currencyID3[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencySymbol3[] = { 0x414, 0x418, 0x41d, 0x0 };
    static const sal_Unicode bankSymbol3[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName3[] = { 0x421, 0x440, 0x43f, 0x441, 0x43a, 0x438, 0x20,
                                                 0x434, 0x438, 0x43d, 0x430, 0x440, 0x0 };
    static const sal_Unicode currencyDecimalPlaces3[] = { 2 };

    static const sal_Unicode defaultCurrency4[] = { 0 };
    static const sal_Unicode defaultCurrencyUsedInCompatibleFormatCodes4[] = { 0 };
    static const sal_Unicode defaultCurrencyLegacyOnly4[] = { 1 };
    static const sal_Unicode currencyID4[] = { 0x43, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencySymbol4[] = { 0x414, 0x418, 0x41d, 0x0 };
    static const sal_Unicode bankSymbol4[] = { 0x43, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName4[] = { 0x421, 0x440, 0x43f, 0x441, 0x43a, 0x438, 0x20,
                                                 0x434, 0x438, 0x43d, 0x430, 0x440, 0x0 };
    static const sal_Unicode currencyDecimalPlaces4[] = { 2 };

    static const sal_Int16 currencyCount = 5;
    ...
    static const sal_Unicode* currencies[] = {
        ...
        currencyName4,
        defaultCurrency4,
        defaultCurrencyUsedInCompatibleFormatCodes4,
        currencyDecimalPlaces4,
        defaultCurrencyLegacyOnly4,
    };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sr_RS(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sr_RS(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x442, 0x430, 0x447, 0x43d, 0x43e, 0x0 };
    static const sal_Unicode ReservedWord1[]
        = { 0x43d, 0x435, 0x442, 0x430, 0x447, 0x43d, 0x43e, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x41f, 0x440, 0x432, 0x438, 0x20,  0x43a, 0x432, 0x430, 0x440, 0x442,
            0x430, 0x43b, 0x20,  0x433, 0x43e, 0x434, 0x438, 0x43d, 0x435, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x414, 0x440, 0x443, 0x433, 0x438, 0x20,  0x43a, 0x432, 0x430, 0x440, 0x442,
            0x430, 0x43b, 0x20,  0x433, 0x43e, 0x434, 0x438, 0x43d, 0x435, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x422, 0x440, 0x435, 0x45b, 0x438, 0x20,  0x43a, 0x432, 0x430, 0x440, 0x442,
            0x430, 0x43b, 0x20,  0x433, 0x43e, 0x434, 0x438, 0x43d, 0x435, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x427, 0x435, 0x442, 0x432, 0x440, 0x442, 0x438, 0x20,  0x43a, 0x432, 0x430, 0x440,
            0x442, 0x430, 0x43b, 0x20,  0x433, 0x43e, 0x434, 0x438, 0x43d, 0x435, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sr_RS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sr_RS(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sr_RS(sal_Int16& count)
    {
        count = 5;
    ...
    static const sal_Unicode continuousSuffix2[] = { 0x0 };
    ...
    static const sal_Unicode continuousNumType3[] = { 0x33, 0x0 };
    static const sal_Unicode continuousSuffix3[] = { 0x0 };
    ...
    static const sal_Unicode continuousNumType4[] = { 0x34, 0x38, 0x0 };
    ...
    static const sal_Unicode continuousNumType5[] = { 0x34, 0x39, 0x0 };
    ...
    getContinuousNumberingLevels_sr_RS(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    static const sal_Unicode outlineNumType02[] = { 0x34, 0x39, 0x0 };
    ...
    static const sal_Unicode outlineNumType11[] = { 0x34, 0x39, 0x0 };
    ...
    static const sal_Unicode outlineNumType21[] = { 0x34, 0x39, 0x0 };
    ...
    static const sal_Unicode outlineNumType23[] = { 0x34, 0x38, 0x0 };
    ...
    static const sal_Unicode outlineNumType41[] = { 0x34, 0x38, 0x0 };
    ...
    static const sal_Unicode outlineNumType43[] = { 0x34, 0x39, 0x0 };
    ...
    static const sal_Unicode outlineNumType50[] = { 0x34, 0x38, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_sr_RS(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
