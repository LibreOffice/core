...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x53, 0x56, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x45, 0x6c, 0x20, 0x53, 0x61, 0x6c, 0x76, 0x61, 0x64, 0x6f, 0x72, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_es_SV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_es_SV(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x43, 0x2d, 0x34, 0x34, 0x30, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_es_SV(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_es_SV(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x53, 0x56, 0x43, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x43, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x53, 0x56, 0x43, 0x0 };
    ...
    getContinuousNumberingLevels_es_SV(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_es_SV(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
