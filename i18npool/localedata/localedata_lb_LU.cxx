...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x62, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4c, 0x75, 0x78, 0x65, 0x6d, 0x62, 0x6f, 0x75, 0x72, 0x67, 0x69, 0x73, 0x68, 0x0 };
    static const sal_Unicode countryID[] = { 0x4c, 0x55, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4c, 0x75, 0x78, 0x65, 0x6d, 0x62, 0x75, 0x72, 0x67, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_lb_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x6d, 0x6f, 0x69, 0x65, 0x73, 0x0 };
    static const sal_Unicode timePM[] = { 0x6e, 0x6f, 0x6d, 0xeb, 0x74, 0x74, 0x65, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_lb_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x34, 0x36, 0x45, 0x5d, 0x0 };
    ...
    getAllFormats0_lb_LU(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_lb_LU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_lb_LU(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_lb_LU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_lb_LU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_lb_LU(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_lb_LU(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_lb_LU(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x44, 0x6f, 0x6e, 0x6e, 0x65, 0x73, 0x63, 0x68, 0x64, 0x65, 0x67, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x46, 0x72, 0x65, 0x69, 0x64, 0x65, 0x67, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x53, 0x61, 0x6d, 0x73, 0x63, 0x68, 0x64, 0x65, 0x67, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0xe4, 0x65, 0x72, 0x7a, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x62, 0x72, 0xeb, 0x6c, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x41, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x65, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x65, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x41, 0x62, 0x72, 0xeb, 0x6c, 0x6c, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x65, 0x65, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x65, 0x65, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x76, 0x69, 0x72, 0x75, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x6e, 0x6f, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_lb_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName1[]
        = { 0x4c, 0xeb, 0x74, 0x7a, 0x65, 0x62, 0x75, 0x65, 0x72, 0x67,
            0x65, 0x72, 0x20, 0x46, 0x72, 0x61, 0x6e, 0x67, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_lb_LU(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_lb_LU(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x77, 0x6f, 0x75, 0x65, 0x72, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x63, 0x68, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x2e, 0x20, 0x54, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x65, 0x72, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x2e, 0x20, 0x54, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x65, 0x72, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x2e, 0x20, 0x54, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x65, 0x72, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x2e, 0x20, 0x54, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x65, 0x72, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x75, 0x65, 0x77, 0x65, 0x6e, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0xeb, 0x6e, 0x6e, 0x65, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_lb_LU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_lb_LU(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_lb_LU(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_lb_LU(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_lb_LU(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
