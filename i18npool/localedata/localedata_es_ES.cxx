...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_es_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_es_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20a7, 0x2d, 0x34, 0x30, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_es_ES(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_es_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_es_ES(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_es_ES(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_es_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x2d, 0x4e, 0x20, 0xd1, 0x20, 0x4f, 0x20, 0xd3, 0x20, 0x50, 0x2d, 0x5a, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x20, 0x73, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x20, 0x73, 0x73, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_es_ES(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_es_ES(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_es_ES(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName01[] = { 0x6c, 0x75, 0x6e, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x6a, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x6a, 0x75, 0x65, 0x76, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x65, 0x6e, 0x65, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x65, 0x6e, 0x65, 0x72, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x70, 0x74, 0x69, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x6f, 0x63, 0x74, 0x75, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x69, 0x63, 0x69, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x64, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x65, 0x6e, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x65, 0x6e, 0x65, 0x72, 0x6f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x79, 0x6f, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x65, 0x6e, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x65, 0x6e, 0x65, 0x72, 0x6f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x65, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x79, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_es_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName1[] = { 0x70, 0x65, 0x73, 0x65, 0x74, 0x61, 0x20, 0x65,
                                                 0x73, 0x70, 0x61, 0xf1, 0x6f, 0x6c, 0x61, 0x0 };
    ...
    static const sal_Unicode currencyName2[] = { 0x70, 0x65, 0x73, 0x65, 0x74, 0x61, 0x20, 0x65,
                                                 0x73, 0x70, 0x61, 0xf1, 0x6f, 0x6c, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_es_ES(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_es_ES(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[]
        = { 0x76, 0x65, 0x72, 0x64, 0x61, 0x64, 0x65, 0x72, 0x6f, 0x0 };
    ...
    static const sal_Unicode ReservedWord7[] = { 0x61, 0x62, 0x61, 0x6a, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_es_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_es_ES(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_es_ES(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_es_ES(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_es_ES(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
