...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x61, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4c, 0x61, 0x74, 0x69, 0x6e, 0x0 };
    static const sal_Unicode countryID[] = { 0x56, 0x41, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x53, 0x74, 0x61, 0x74, 0x65, 0x20, 0x6f, 0x66, 0x20, 0x74, 0x68, 0x65, 0x20,
            0x56, 0x61, 0x74, 0x69, 0x63, 0x61, 0x6e, 0x20, 0x43, 0x69, 0x74, 0x79, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_la_VA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_la_VA(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x38, 0x30, 0x37, 0x36, 0x5d,   0x20, 0x23,
            0x2e, 0x23, 0x23,   0x30, 0x3b, 0x2d, 0x5b, 0x24, 0x20ac, 0x2d, 0x38,
            0x30, 0x37, 0x36,   0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23,   0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x38, 0x30, 0x37, 0x36, 0x5d, 0x20, 0x23, 0x2e,   0x23,
            0x23, 0x30, 0x3b,   0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x20ac, 0x2d,
            0x38, 0x30, 0x37,   0x36, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    getAllFormats0_la_VA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_la_VA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_la_VA(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_la_VA(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_la_VA(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[]
        = { 0x20, 0x65, 0x74, 0x20, 0x73, 0x65, 0x71, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[]
        = { 0x20, 0x65, 0x74, 0x20, 0x73, 0x65, 0x71, 0x71, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_la_VA(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_la_VA(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_la_VA(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[] = { 0x44, 0x6f, 0x6d, 0x69, 0x6e,
                                                        0x69, 0x63, 0x75, 0x73, 0x20,
                                                        0x64, 0x69, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4c, 0x75, 0x6e, 0x61, 0x65, 0x20, 0x64, 0x69, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x4d, 0x61, 0x72, 0x74, 0x69, 0x73, 0x20, 0x64, 0x69, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x4d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x69, 0x69, 0x20, 0x64, 0x69, 0x65, 0x73, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x4d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x49, 0x6f, 0x76, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x49, 0x6f, 0x76, 0x69, 0x73, 0x20, 0x64, 0x69, 0x65, 0x73, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x49, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x56, 0x65, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x56, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x73, 0x20, 0x64, 0x69, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x53, 0x61, 0x62, 0x62, 0x61, 0x74, 0x75, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x53, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x49, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x49, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[]
        = { 0x4d, 0x61, 0x72, 0x74, 0x69, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x41, 0x70, 0x72, 0x69, 0x6c, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x61, 0x69, 0x75, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x4d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x49, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x49, 0x75, 0x6e, 0x69, 0x75, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x49, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x49, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x49, 0x75, 0x6c, 0x69, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x49, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x49, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x4d, 0x61, 0x72, 0x74, 0x69, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x69, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x49, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x49, 0x75, 0x6e, 0x69, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x49, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x49, 0x75, 0x6c, 0x69, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x41, 0x75, 0x67, 0x75, 0x73, 0x74, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x53, 0x65, 0x70, 0x74, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x4f, 0x63, 0x74, 0x6f, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x4e, 0x6f, 0x76, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x44, 0x65, 0x63, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x49, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x69, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x49, 0x75, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x49, 0x75, 0x6c, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x61, 0x2e, 0x43, 0x2e, 0x6e, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x61, 0x6e, 0x74, 0x65, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73,
            0x74, 0x75, 0x6d, 0x20, 0x6e, 0x61, 0x74, 0x75, 0x6d, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x70, 0x2e, 0x43, 0x2e, 0x6e, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x70, 0x6f, 0x73, 0x74, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73,
            0x74, 0x75, 0x6d, 0x20, 0x6e, 0x61, 0x74, 0x75, 0x6d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_la_VA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_la_VA(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_la_VA(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x76, 0x65, 0x72, 0x75, 0x6d, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x75, 0x6d, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x70, 0x72, 0x69, 0x6d, 0x61, 0x20, 0x71, 0x75, 0x61,
            0x72, 0x74, 0x61, 0x20, 0x70, 0x61, 0x72, 0x73, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x73, 0x65, 0x63, 0x75, 0x6e, 0x64, 0x61, 0x20, 0x71, 0x75,
            0x61, 0x72, 0x74, 0x61, 0x20, 0x70, 0x61, 0x72, 0x73, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x74, 0x65, 0x72, 0x74, 0x69, 0x61, 0x20, 0x71, 0x75, 0x61,
            0x72, 0x74, 0x61, 0x20, 0x70, 0x61, 0x72, 0x73, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x71, 0x75, 0x61, 0x72, 0x74, 0x61, 0x20, 0x71, 0x75, 0x61,
            0x72, 0x74, 0x61, 0x20, 0x70, 0x61, 0x72, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_la_VA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_la_VA(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_la_VA(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_la_VA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_la_VA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
