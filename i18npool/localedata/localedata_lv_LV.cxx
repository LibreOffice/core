...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x76, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4c, 0x61, 0x74, 0x76, 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode countryID[] = { 0x4c, 0x56, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x4c, 0x61, 0x74, 0x76, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_lv_LV(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateYearSeparator[] = { 0x20, 0x67, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_lv_LV(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32, 0x36, 0x5d, 0x20, 0x23,
            0xa0, 0x23, 0x23, 0x30, 0x3b, 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34,
            0x32, 0x36, 0x5d, 0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32, 0x36, 0x5d, 0x20, 0x23, 0xa0, 0x23,
            0x23, 0x30, 0x2c, 0x30, 0x30, 0x3b, 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32,
            0x36, 0x5d, 0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32, 0x36, 0x5d, 0x20, 0x23, 0xa0, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x5b, 0x24, 0x4c, 0x73, 0x2d,
            0x34, 0x32, 0x36, 0x5d, 0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32, 0x36, 0x5d, 0x20, 0x23,
            ...
            0x44, 0x5d, 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32, 0x36, 0x5d,
            0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32, 0x36, 0x5d, 0x20, 0x23,
            ...
            0x44, 0x5d, 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x34, 0x32, 0x36, 0x5d,
            0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x59, 0x59, 0x59, 0x59, 0x2e, 0x20, 0x22, 0x67, 0x61, 0x64, 0x61, 0x22, 0x20, 0x44,
            0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x2c, 0x20, 0x4e, 0x4e, 0x4e, 0x4e, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x2c, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x2c, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x2c, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode26[] = { 0x4e, 0x4e, 0x2c, 0x20, 0x44, 0x2e, 0x20, 0x4d,
                                                0x4d, 0x4d, 0x4d, 0x2c, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x44, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode29[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x2c, 0x20, 0x59, 0x59, 0x59, 0x59, 0x2e, 0x20, 0x22, 0x67,
            0x61, 0x64, 0x61, 0x22, 0x20, 0x44, 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    static const sal_Unicode FormatCode30[] = { 0x44, 0x44, 0x2d, 0x4d, 0x4d, 0x0 };
    ...
    getAllFormats0_lv_LV(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_lv_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_lv_LV(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_lv_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_lv_LV(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x2d,  0x59, 0x20,  0x10c, 0x20,  0x122, 0x20,  0x136,
            0x20, 0x13b, 0x20, 0x145, 0x20,  0x160, 0x20,  0x17d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_lv_LV(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_lv_LV(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_lv_LV(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x73, 0x65, 0x73, 0x74, 0x64, 0x69, 0x65, 0x6e, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x6a, 0x61, 0x6e, 0x76, 0x101, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x75, 0x101, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x61, 0x70, 0x72, 0x12b, 0x6c, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x61, 0x75, 0x67, 0x75, 0x73, 0x74, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x70, 0x74, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x6f, 0x6b, 0x74, 0x6f, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x6e, 0x6f, 0x76, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x63, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x6a, 0x16b, 0x6e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x6a, 0x16b, 0x6c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x6a, 0x16b, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x6a, 0x16b, 0x6c, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x70, 0x6d, 0x113, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x70, 0x69, 0x72, 0x6d,  0x73, 0x20, 0x6d, 0x16b,
            0x73, 0x75, 0x20, 0x113, 0x72, 0x61, 0x73, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x6d, 0x113, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x6d, 0x16b, 0x73, 0x75, 0x20, 0x113, 0x72, 0x101, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_lv_LV(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID1[] = { 0x4c, 0x56, 0x4c, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x4c, 0x73, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x4c, 0x56, 0x4c, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x4c, 0x61, 0x74, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_lv_LV(sal_Int16& count)
    {
        count = currencyCount;
    ...
    static const sal_Int16 nbOfTransliterations = 5;

    static const sal_Unicode* LCTransliterationsArray[] = {
        Transliteration0, Transliteration1, Transliteration2, Transliteration3, Transliteration4,
    };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_lv_LV(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x70, 0x61, 0x74, 0x69, 0x65, 0x73, 0x73, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x61, 0x70, 0x6c, 0x61, 0x6d, 0x73, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x2e, 0x20, 0x63, 0x65, 0x74, 0x75, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x2e, 0x20, 0x63, 0x65, 0x74, 0x75, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x2e, 0x20, 0x63, 0x65, 0x74, 0x75, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x2e, 0x20, 0x63, 0x65, 0x74, 0x75, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x61, 0x75, 0x67, 0x73, 0x74, 0x101, 0x6b, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x7a, 0x65, 0x6d, 0x101, 0x6b, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x43, 0x31, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x43, 0x32, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x43, 0x33, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x43, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_lv_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_lv_LV(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_lv_LV(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_lv_LV(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_lv_LV(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
