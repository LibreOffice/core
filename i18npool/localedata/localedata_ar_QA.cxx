...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x51, 0x41, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x51, 0x61, 0x74, 0x61, 0x72, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ar_QA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ar_QA(sal_Int16& count)
    {
        return getLocaleItem_ar_SA(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x631, 0x2e, 0x642, 0x2e, 0x200f, 0x2d, 0x34, 0x30, 0x30, 0x31, 0x5d, 0x0 };
    ...
    getAllFormats0_ar_QA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    static const sal_Unicode currencyID0[] = { 0x51, 0x41, 0x52, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x631, 0x2e, 0x642, 0x2e, 0x200f, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x51, 0x41, 0x52, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x51, 0x41, 0x52, 0x0 };
    ...
    getContinuousNumberingLevels_ar_QA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_ar_SA(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ar_QA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
