...
extern "C"
{
    static const sal_Unicode langID[] = { 0x73, 0x6b, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x53, 0x6c, 0x6f, 0x76, 0x61, 0x6b, 0x0 };
    ...
    static const sal_Unicode countryDefaultName[]
        = { 0x53, 0x6c, 0x6f, 0x76, 0x61, 0x6b, 0x20, 0x52,
            0x65, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sk_SK(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sk_SK(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatDefaultName2[]
        = { 0x50, 0x6f, 0x64, 0x13e, 0x61, 0x20, 0x53, 0x54, 0x4e,
            0x20, 0x30, 0x31, 0x20,  0x36, 0x39, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode3[]
        = { 0x44, 0x44, 0x2e, 0x4d, 0x4d, 0x2e, 0x59, 0x59, 0x59, 0x59, 0x0 };
    static const sal_Unicode FormatDefaultName3[]
        = { 0x50, 0x6f, 0x64, 0x13e, 0x61, 0x20, 0x53, 0x54, 0x4e,
            0x20, 0x30, 0x31, 0x20,  0x36, 0x39, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatDefaultName7[]
        = { 0x50, 0x6f, 0x64, 0x13e, 0x61, 0x20, 0x53, 0x54, 0x4e,
            0x20, 0x30, 0x31, 0x20,  0x36, 0x39, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode8[]
        = { 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    static const sal_Unicode FormatDefaultName8[]
        = { 0x50, 0x6f, 0x64, 0x13e, 0x61, 0x20, 0x53, 0x54, 0x4e,
            0x20, 0x30, 0x31, 0x20,  0x36, 0x39, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatDefaultName14[]
        = { 0x50, 0x6f, 0x64, 0x13e, 0x61, 0x20, 0x53, 0x54, 0x4e,
            0x20, 0x30, 0x31, 0x20,  0x36, 0x39, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatDefaultName15[]
        = { 0x50, 0x6f, 0x64, 0x13e, 0x61, 0x20, 0x49, 0x53, 0x4f, 0x20, 0x38, 0x36, 0x30,
            0x31, 0x2c, 0x20, 0x45,  0x4e, 0x20, 0x32, 0x38, 0x36, 0x30, 0x2c, 0x20, 0x53,
            0x54, 0x4e, 0x20, 0x30,  0x31, 0x20, 0x36, 0x39, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode37[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x53, 0x6b, 0x2d,
            0x34, 0x31, 0x42, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30,
            0x20, 0x5b, 0x24, 0x53, 0x6b, 0x2d, 0x34, 0x31, 0x42, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode38[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x53, 0x6b,
            0x2d, 0x34, 0x31, 0x42, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c,
            0x30, 0x30, 0x20, 0x5b, 0x24, 0x53, 0x6b, 0x2d, 0x34, 0x31, 0x42, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode39[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x53, 0x6b, 0x2d, 0x34, 0x31,
            0x42, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0xa0, 0x23, 0x23,
            0x30, 0x20, 0x5b, 0x24, 0x53, 0x6b, 0x2d, 0x34, 0x31, 0x42, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode40[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24,
            0x53, 0x6b, 0x2d, 0x34, 0x31, 0x42, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
    ...
    getAllFormats0_sk_SK(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_sk_SK(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_sk_SK(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_sk_SK(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_sk_SK(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x20, 0xc4, 0x20,  0x42, 0x2d, 0x43, 0x20, 0x10c, 0x20,  0x44, 0x2d, 0x48,
            0x20, 0x7b, 0x43, 0x68,  0x7d, 0x20, 0x49, 0x2d, 0x4f,  0x20,  0xd4, 0x20, 0x50,
            0x2d, 0x53, 0x20, 0x160, 0x20, 0x54, 0x2d, 0x5a, 0x20,  0x17d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_sk_SK(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_sk_SK(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_sk_SK(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x4e, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x4e, 0x65, 0x64, 0x65, 0x13e, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x4e, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x50, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x50, 0x6f, 0x6e, 0x64, 0x65, 0x6c, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x50, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x55, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x55, 0x74, 0x6f, 0x72, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x55, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x53, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName03[] = { 0x53, 0x74, 0x72, 0x65, 0x64, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x53, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x160, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x160, 0x74, 0x76, 0x72, 0x74, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x160, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x50, 0x69, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x50, 0x69, 0x61, 0x74, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x50, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x53, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultFullName06[] = { 0x53, 0x6f, 0x62, 0x6f, 0x74, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x65, 0x63, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0xe1, 0x6a, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x6a, 0xfa, 0x6e, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x6a, 0xfa, 0x6c, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0xe1, 0x6a, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x6a, 0xfa, 0x6e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x6a, 0xfa, 0x6c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x6a, 0x61, 0x6e, 0x75, 0xe1, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x75, 0xe1, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0x61, 0x70, 0x72, 0xed, 0x6c, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0xe1, 0x6a, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x6a, 0xfa, 0x6e, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x6a, 0xfa, 0x6c, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0x61, 0x75, 0x67, 0x75, 0x73, 0x74, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0x6f, 0x6b, 0x74, 0xf3, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0x6e, 0x6f, 0x76, 0x65, 0x6d, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x70, 0x72, 0x65, 0x64, 0x20, 0x6e, 0x2e, 0x20, 0x6c, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x70, 0x72, 0x65, 0x64, 0x20, 0x6e, 0x61,  0x161, 0xed, 0x6d, 0x20,
            0x6c, 0x65, 0x74, 0x6f, 0x70, 0x6f, 0x10d, 0x74,  0x6f, 0x6d, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x6e, 0xe1, 0x161, 0x68, 0x6f,  0x20, 0x6c, 0x65,
            0x74, 0x6f, 0x70,  0x6f, 0x10d, 0x74, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_sk_SK(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID1[] = { 0x53, 0x4b, 0x4b, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x53, 0x6b, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x53, 0x4b, 0x4b, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x4b, 0x6f, 0x72, 0x75, 0x6e, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sk_SK(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sk_SK(sal_Int16& count)
    {
    ...
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x2e, 0x20, 0x161, 0x74, 0x76, 0x72, 0x165, 0x72, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x2e, 0x20, 0x161, 0x74, 0x76, 0x72, 0x165, 0x72, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x2e, 0x20, 0x161, 0x74, 0x76, 0x72, 0x165, 0x72, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x2e, 0x20, 0x161, 0x74, 0x76, 0x72, 0x165, 0x72, 0x6f, 0x6b, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sk_SK(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sk_SK(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sk_SK(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_sk_SK(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_sk_SK(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
