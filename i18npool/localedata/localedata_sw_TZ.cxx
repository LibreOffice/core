...
extern "C"
{
    static const sal_Unicode langID[] = { 0x73, 0x77, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x53, 0x77, 0x61, 0x68, 0x69, 0x6c, 0x69, 0x0 };
    static const sal_Unicode countryID[] = { 0x54, 0x5a, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x54, 0x61, 0x6e, 0x7a, 0x61, 0x6e, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sw_TZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x55, 0x4d, 0x0 };
    static const sal_Unicode timePM[] = { 0x4d, 0x55, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sw_TZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x54, 0x53, 0x68, 0x2d, 0x38, 0x30, 0x34, 0x31, 0x5d, 0x0 };
    ...
    getAllFormats0_sw_TZ(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_sw_TZ(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_sw_TZ(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_sw_TZ(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_sw_TZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[] = { 0x75, 0x6b, 0x2e, 0x0 };
    ...
    static const sal_Int16 nbOfPageWords = 1;

    static const sal_Unicode* FollowPageWordArray[] = { followPageWord0, NULL };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_sw_TZ(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_sw_TZ(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_sw_TZ(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x4a, 0x70, 0x6c, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x4a, 0x75, 0x6d, 0x61, 0x70, 0x69, 0x6c, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x4a, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x4a, 0x74, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4a, 0x75, 0x6d, 0x61, 0x74, 0x61, 0x74, 0x75, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x4a, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x4a, 0x6e, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x4a, 0x75, 0x6d, 0x61, 0x6e, 0x6e, 0x65, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x4a, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x4a, 0x74, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x4a, 0x75, 0x6d, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x4a, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x41, 0x6c, 0x68, 0x61, 0x6d, 0x69, 0x73, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x41, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x49, 0x6a, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x49, 0x6a, 0x75, 0x6d, 0x61, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x49, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x4a, 0x6d, 0x73, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x4a, 0x75, 0x6d, 0x61, 0x6d, 0x6f, 0x73, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x4a, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x46, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x4d, 0x61, 0x63, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x63, 0x68, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x70, 0x72, 0x69, 0x6c, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x41, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x69, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x65, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[] = { 0x41, 0x67, 0x6f, 0x73, 0x74, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x61, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x4d, 0x61, 0x63, 0x68, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x41, 0x70, 0x72, 0x69, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x65, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x41, 0x67, 0x6f, 0x73, 0x74, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x61, 0x63, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x65, 0x69, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x4b, 0x4b, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x4b, 0x61, 0x62, 0x6c, 0x61, 0x20, 0x79, 0x61,
            0x20, 0x4b, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x42, 0x4b, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x42, 0x61, 0x61, 0x64, 0x61, 0x20, 0x79, 0x61,
            0x20, 0x4b, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_sw_TZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x54, 0x5a, 0x53, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x54, 0x53, 0x68, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x54, 0x5a, 0x53, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x53, 0x68, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x69, 0x20, 0x79, 0x61,
            0x20, 0x54, 0x61, 0x6e, 0x7a, 0x61, 0x6e, 0x69, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sw_TZ(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sw_TZ(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x6b, 0x77, 0x65, 0x6c, 0x69, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x73, 0x69, 0x6b, 0x77, 0x65, 0x6c, 0x69, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x72, 0x6f, 0x62, 0x6f, 0x20, 0x79, 0x61, 0x20,
                                                 0x6b, 0x77, 0x61, 0x6e, 0x7a, 0x61, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x72, 0x6f, 0x62, 0x6f, 0x20, 0x79, 0x61, 0x20, 0x70, 0x69, 0x6c, 0x69, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x72, 0x6f, 0x62, 0x6f, 0x20, 0x79, 0x61, 0x20, 0x74, 0x61, 0x74, 0x75, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x72, 0x6f, 0x62, 0x6f, 0x20, 0x79, 0x61, 0x20, 0x6e, 0x6e, 0x65, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x6a, 0x75, 0x75, 0x20, 0x79, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[]
        = { 0x63, 0x68, 0x69, 0x6e, 0x69, 0x20, 0x79, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sw_TZ(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sw_TZ(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sw_TZ(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_sw_TZ(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_sw_TZ(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
