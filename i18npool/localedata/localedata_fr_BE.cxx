...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_fr_BE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_fr_BE(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x42, 0x2d,
            0x38, 0x30, 0x43, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30,
            0x20, 0x5b, 0x24, 0x46, 0x42, 0x2d, 0x38, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x42,
            0x2d, 0x38, 0x30, 0x43, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c,
            0x30, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x42, 0x2d, 0x38, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x42, 0x2d, 0x38, 0x30,
            0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23,
            0x30, 0x20, 0x5b, 0x24, 0x46, 0x42, 0x2d, 0x38, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24,
            0x46, 0x42, 0x2d, 0x38, 0x30, 0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
    ...
    static const sal_Unicode FormatCode17[] = { 0x4a, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x0 };
    ...
    getAllFormats0_fr_BE(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_fr_BE(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName1[]
        = { 0x66, 0x72, 0x61, 0x6e, 0x63, 0x20, 0x62, 0x65, 0x6c, 0x67, 0x65, 0x0 };
    ...
    getContinuousNumberingLevels_fr_BE(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_fr_BE(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
