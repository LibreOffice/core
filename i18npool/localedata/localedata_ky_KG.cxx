...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6b, 0x79, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4b, 0x69, 0x72, 0x67, 0x68, 0x69, 0x7a, 0x0 };
    static const sal_Unicode countryID[] = { 0x4b, 0x47, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4b, 0x79, 0x72, 0x67, 0x79, 0x7a, 0x73, 0x74, 0x61, 0x6e, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ky_KG(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateYearSeparator[] = { 0x20, 0x436, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ky_KG(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0xa0, 0x23,  0x23,  0x30,  0x5b, 0x24, 0x441, 0x43e, 0x43c, 0x2d,
            0x34, 0x34, 0x30,  0x5d,  0x3b,  0x2d, 0x23, 0xa0,  0x23,  0x23,  0x30,
            0x5b, 0x24, 0x441, 0x43e, 0x43c, 0x2d, 0x34, 0x34,  0x30,  0x5d,  0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30,  0x2c,  0x30,  0x30, 0x5b, 0x24, 0x441, 0x43e, 0x43c,
            0x2d, 0x34, 0x34, 0x30, 0x5d,  0x3b,  0x2d,  0x23, 0xa0, 0x23, 0x23,  0x30,  0x2c,
            0x30, 0x30, 0x5b, 0x24, 0x441, 0x43e, 0x43c, 0x2d, 0x34, 0x34, 0x30,  0x5d,  0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0xa0, 0x23, 0x23,  0x30,  0x5b,  0x24, 0x441, 0x43e, 0x43c, 0x2d, 0x34, 0x34,
            0x30, 0x5d, 0x3b, 0x5b,  0x52,  0x45,  0x44, 0x5d,  0x2d,  0x23,  0xa0, 0x23, 0x23,
            0x30, 0x5b, 0x24, 0x441, 0x43e, 0x43c, 0x2d, 0x34,  0x34,  0x30,  0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23,  0xa0,  0x23,  0x23,  0x30,  0x2c, 0x30, 0x30, 0x5b, 0x24, 0x441,
            0x43e, 0x43c, 0x2d,  0x34,  0x34,  0x30, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23,  0xa0,  0x23,  0x23,  0x30,  0x2c, 0x2d, 0x2d, 0x5b, 0x24, 0x441,
            0x43e, 0x43c, 0x2d,  0x34,  0x34,  0x30, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
    ...
    getAllFormats0_ky_KG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ky_KG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ky_KG(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ky_KG(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ky_KG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ky_KG(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ky_KG(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ky_KG(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x416, 0x435, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x436, 0x435, 0x43a, 0x448, 0x435, 0x43c, 0x431, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x436, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x434, 0x4af, 0x439, 0x448, 0x4e9, 0x43c, 0x431, 0x4af, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x434, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x428, 0x435, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x448, 0x435, 0x439, 0x448, 0x435, 0x43c, 0x431, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x448, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x428, 0x430, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x448, 0x430, 0x440, 0x448, 0x435, 0x43c, 0x431, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x448, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x411, 0x435, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x431, 0x435, 0x439, 0x448, 0x435, 0x43c, 0x431, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x431, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x416, 0x443, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x436, 0x443, 0x43c, 0x430, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x436, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x418, 0x448, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x438, 0x448, 0x435, 0x43c, 0x431, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x438, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x431, 0x2e, 0x437, 0x20, 0x447, 0x435, 0x439, 0x438, 0x43d, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x431, 0x2e, 0x437, 0x20, 0x447, 0x435, 0x439, 0x438, 0x43d, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x431, 0x2e, 0x437, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x431, 0x2e, 0x437, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ky_KG(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x4b, 0x47, 0x53, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x441, 0x43e, 0x43c, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x4b, 0x47, 0x53, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x41a, 0x44b, 0x440, 0x433, 0x44b, 0x437, 0x20, 0x441, 0x43e, 0x43c, 0x443, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ky_KG(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ky_KG(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x447, 0x44b, 0x43d, 0x434, 0x44b, 0x43a, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x436, 0x430, 0x43b, 0x433, 0x430, 0x43d, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x2d, 0x43a, 0x432, 0x430, 0x440, 0x442, 0x430, 0x43b, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x2d, 0x43a, 0x432, 0x430, 0x440, 0x442, 0x430, 0x43b, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x2d, 0x43a, 0x432, 0x430, 0x440, 0x442, 0x430, 0x43b, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x2d, 0x43a, 0x432, 0x430, 0x440, 0x442, 0x430, 0x43b, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x436, 0x43e, 0x433, 0x43e, 0x440, 0x443, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x442, 0x4e9, 0x43c, 0x4e9, 0x43d, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x31, 0x2d, 0x43a, 0x432, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x32, 0x2d, 0x43a, 0x432, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x33, 0x2d, 0x43a, 0x432, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x34, 0x2d, 0x43a, 0x432, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ky_KG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ky_KG(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ky_KG(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ky_KG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ky_KG(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
