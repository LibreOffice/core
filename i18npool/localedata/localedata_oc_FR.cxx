...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6f, 0x63, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x65, 0x64, 0x6f, 0x63, 0x69, 0x65, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_oc_FR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_oc_FR(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x34, 0x38, 0x32, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x4d,
            0x22, 0x20, 0x64, 0x65, 0x20, 0x22, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode21[] = { 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x22, 0x20,
                                                0x64, 0x65, 0x20, 0x22, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x22, 0x20, 0x64,
            0x65, 0x20, 0x22, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x22, 0x20,
            0x64, 0x65, 0x20, 0x22, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode25[] = { 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x22,
                                                0x20, 0x64, 0x65, 0x20, 0x22, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d,
            0x22, 0x20, 0x64, 0x65, 0x20, 0x22, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x22,
            0x20, 0x64, 0x65, 0x20, 0x22, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode29[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x4d,
            0x22, 0x20, 0x64, 0x65, 0x20, 0x22, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_oc_FR(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_oc_FR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_oc_FR(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_oc_FR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_oc_FR(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[] = { 0x70, 0x2e, 0x73, 0x67, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x70, 0x2e, 0x73, 0x67, 0x73, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_oc_FR(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_oc_FR(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_oc_FR(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x64, 0x69, 0x6c, 0x75, 0x6e, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x64, 0x69, 0x6d, 0x61, 0x72, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x64, 0x69, 0x6a, 0xf2, 0x75, 0x73, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x64, 0x69, 0x6a, 0xf2, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName05[]
        = { 0x64, 0x69, 0x76, 0x65, 0x6e, 0x64, 0x72, 0x65, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName06[]
        = { 0x64, 0x69, 0x73, 0x61, 0x62, 0x74, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName00[]
        = { 0x67, 0x65, 0x6e, 0x69, 0xe8, 0x72, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x67, 0x65, 0x6e, 0x69, 0xe8, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x69, 0xe8, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x61, 0x62, 0x72, 0x69, 0x6c, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x67, 0x6f, 0x73, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x61, 0x67, 0x6f, 0x73, 0x74, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName09[]
        = { 0x6f, 0x63, 0x74, 0xf2, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName011[]
        = { 0x64, 0x65, 0x63, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x61, 0x76, 0x2e, 0x20, 0x4a, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x61, 0x76, 0x61, 0x6e, 0x74, 0x20, 0x4a, 0xe8, 0x73, 0x75,
            0x73, 0x2d, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[]
        = { 0x61, 0x70, 0x72, 0x2e, 0x20, 0x4a, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x61, 0x70, 0x72, 0xe8, 0x70, 0x20, 0x4a, 0xe8, 0x73, 0x75,
            0x73, 0x2d, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_oc_FR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_oc_FR(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_oc_FR(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x76, 0x65, 0x72, 0x61, 0x69, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0xe8, 0x72, 0x20, 0x74, 0x72, 0x69, 0x6d, 0xe8, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x6e, 0x64, 0x20, 0x74, 0x72, 0x69, 0x6d, 0xe8, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x65, 0x6e, 0x20, 0x74, 0x72, 0x69, 0x6d, 0xe8, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x65, 0x6e, 0x20, 0x74, 0x72, 0x69, 0x6d, 0xe8, 0x73, 0x74, 0x72, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_oc_FR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_oc_FR(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_oc_FR(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_oc_FR(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_oc_FR(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
