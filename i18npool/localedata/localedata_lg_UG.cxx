...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x67, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x47, 0x61, 0x6e, 0x64, 0x61, 0x0 };
    static const sal_Unicode countryID[] = { 0x55, 0x47, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x55, 0x67, 0x61, 0x6e, 0x64, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_lg_UG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_lg_UG(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x55, 0x53, 0x68, 0x2d, 0x36, 0x33, 0x42, 0x5d, 0x0 };
    ...
    getAllFormats0_lg_UG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_lg_UG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_lg_UG(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_lg_UG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_lg_UG(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[] = { 0x6c, 0x75, 0x70, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x65, 0x6d, 0x70, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_lg_UG(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_lg_UG(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_lg_UG(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x77, 0x61, 0x6c, 0x69, 0x79, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x77, 0x61, 0x6c, 0x69, 0x79, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x41, 0x70, 0x75, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x70, 0x75, 0x6c, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x41, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x4d, 0x61, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x4a, 0x75, 0x75, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x4a, 0x75, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x4a, 0x75, 0x6c, 0x61, 0x61, 0x79, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x41, 0x67, 0x75, 0x73, 0x69, 0x74, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x53, 0x65, 0x62, 0x75, 0x74, 0x74, 0x65, 0x6d, 0x62, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x53, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x4f, 0x6b, 0x69, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x4f, 0x6b, 0x69, 0x74, 0x6f, 0x62, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x41, 0x70, 0x75, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x41, 0x70, 0x75, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x61, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x4a, 0x75, 0x75, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x4a, 0x75, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x4f, 0x6b, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x41, 0x70, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x61, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x4a, 0x75, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x4f, 0x6b, 0x69, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x4b, 0x75, 0x6c, 0x69, 0x73, 0x69, 0x74, 0x6f, 0x20, 0x6e, 0x67, 0x61, 0x20,
            0x74, 0x61, 0x6e, 0x6e, 0x61, 0x7a, 0x61, 0x6c, 0x69, 0x62, 0x77, 0x61, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x42, 0x75, 0x6b, 0x79, 0x61, 0x20, 0x4b, 0x75, 0x6c, 0x69, 0x73, 0x69, 0x74,
            0x6f, 0x20, 0x41, 0x7a, 0x61, 0x61, 0x6c, 0x69, 0x62, 0x77, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_lg_UG(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x55, 0x47, 0x58, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x55, 0x53, 0x68, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x55, 0x47, 0x58, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x53, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x69, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_lg_UG(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_lg_UG(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x4b, 0x69, 0x74, 0x75, 0x75, 0x66, 0x75, 0x0 };
    static const sal_Unicode ReservedWord1[]
        = { 0x53, 0x73, 0x69, 0x20, 0x4b, 0x69, 0x74, 0x75, 0x75, 0x66, 0x75, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x4b, 0x79, 0x61, 0x6b, 0x75, 0x6e, 0x61, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x4b, 0x79, 0x61, 0x6b, 0x75, 0x6e, 0x61, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x4b, 0x79, 0x61, 0x6b, 0x75, 0x6e, 0x61, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x4b, 0x79, 0x61, 0x6b, 0x75, 0x6e, 0x61, 0x20, 0x34, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x57, 0x61, 0x67, 0x67, 0x75, 0x6c, 0x75, 0x0 };
    static const sal_Unicode ReservedWord7[]
        = { 0x57, 0x61, 0x6d, 0x6d, 0x61, 0x6e, 0x67, 0x61, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x4b, 0x6e, 0x61, 0x31, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x4b, 0x6e, 0x61, 0x32, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x4b, 0x6e, 0x61, 0x33, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x4b, 0x6e, 0x61, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_lg_UG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_lg_UG(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_lg_UG(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_lg_UG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_lg_UG(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
