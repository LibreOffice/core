...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x6f, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4c, 0x61, 0x6f, 0x0 };
    static const sal_Unicode countryID[] = { 0x4c, 0x41, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x4c, 0x61, 0x6f, 0x73, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_lo_LA(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[]
        = { 0xe81, 0xec8, 0xead, 0xe99, 0xe97, 0xec8, 0xebd, 0xe87, 0x0 };
    static const sal_Unicode timePM[]
        = { 0xeab, 0xea5, 0xeb1, 0xe87, 0xe97, 0xec8, 0xebd, 0xe87, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_lo_LA(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ad, 0x2d, 0x34, 0x35, 0x34, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0x2c, 0x23, 0x23, 0x30, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45,
            ...
            0x44, 0x5d, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x5b, 0x43, 0x55,
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x22,  0xea7, 0xeb1, 0xe99, 0xe97, 0xeb5, 0x22, 0x20, 0x44, 0x20, 0x22,
            0xec0, 0xe94, 0xeb7, 0xead, 0xe99, 0x22,  0x20, 0x4d, 0x4d, 0x4d, 0x4d,
            0x20,  0x22,  0xe9b, 0xeb5, 0x22,  0x20,  0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode38[]
        = { 0x4e, 0x4e, 0x4e, 0x4e,  0x22,  0xea7, 0xeb1, 0xe99, 0xe97, 0xeb5, 0x22, 0x20, 0x44,
            0x44, 0x20, 0x22, 0xec0, 0xe94, 0xeb7, 0xead, 0xe99, 0x22,  0x20,  0x4d, 0x4d, 0x4d,
            0x4d, 0x20, 0x22, 0xe9b, 0xeb5, 0x22,  0x20,  0x59,  0x59,  0x59,  0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode39[]
        = { 0x48, 0x48, 0x22, 0xec2, 0xea1, 0xe87, 0x22,  0x3a, 0x4d,
            0x4d, 0x20, 0x22, 0xe99, 0xeb2, 0xe97, 0xeb5, 0x22, 0x0 };
    ...
    static const sal_Unicode FormatCode40[]
        = { 0x48,  0x48,  0x22,  0xec2, 0xea1, 0xe87, 0x22, 0x3a, 0x4d, 0x4d,
            0x22,  0xe99, 0xeb2, 0xe97, 0xeb5, 0x22,  0x3a, 0x53, 0x53, 0x22,
            0xea7, 0xeb4, 0xe99, 0xeb2, 0xe97, 0xeb5, 0x22, 0x0 };
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x44,  0x44,  0x2f,  0x4d,  0x4d, 0x2f,  0x59,  0x59,  0x20,  0x22,  0xea7, 0xeb1,
            0xe99, 0xe97, 0xeb5, 0x22,  0x20, 0x22,  0xec0, 0xe94, 0xeb7, 0xead, 0xe99, 0x22,
            0x20,  0x22,  0xe9b, 0xeb5, 0x22, 0x20,  0x48,  0x48,  0x22,  0xec2, 0xea1, 0xe87,
            0x22,  0x3a,  0x4d,  0x4d,  0x22, 0xe99, 0xeb2, 0xe97, 0xeb5, 0x22,  0x0 };
    ...
    static const sal_Unicode FormatCode48[]
        = { 0x44,  0x44,  0x2f,  0x4d,  0x4d,  0x2f,  0x59,  0x59,  0x59,  0x59,
            0x20,  0x22,  0xea7, 0xeb1, 0xe99, 0xe97, 0xeb5, 0x22,  0x20,  0x22,
            0xec0, 0xe94, 0xeb7, 0xead, 0xe99, 0x22,  0x20,  0x22,  0xe9b, 0xeb5,
            0x22,  0x20,  0x48,  0x48,  0x22,  0xec2, 0xea1, 0xe87, 0x22,  0x3a,
            0x4d,  0x4d,  0x22,  0xe99, 0xeb2, 0xe97, 0xeb5, 0x22,  0x0 };
    ...
    getAllFormats0_lo_LA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_lo_LA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_lo_LA(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_lo_LA(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_lo_LA(sal_Int16& count)
    {
    ...
    static const sal_Unicode unicodeScript0[] = { 0x32, 0x35, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_lo_LA(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_lo_LA(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_lo_LA(sal_Int16& count)
    {
        count = nbOfPageWords;
        return (sal_Unicode**)FollowPageWordArray;
    }
    static const sal_Unicode calendarID0[]
        = { 0x62, 0x75, 0x64, 0x64, 0x68, 0x69, 0x73, 0x74, 0x0 };
    static const sal_Unicode defaultCalendar0[] = { 0 };
    static const sal_Unicode dayID00[] = { 0x73, 0x75, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0xead, 0xeb2, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0xea7, 0xeb1, 0xe99, 0xead, 0xeb2, 0xe97, 0xeb4, 0xe94, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0xe88, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0xea7, 0xeb1, 0xe99, 0xe88, 0xeb1, 0xe99, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0xead, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0xea7, 0xeb1, 0xe99, 0xead, 0xeb1, 0xe87, 0xe84, 0xeb2, 0xe99, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0xea7, 0xeb1, 0xe99, 0xe9e, 0xeb8, 0xe94, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0xe9e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0xea7, 0xeb1, 0xe99, 0xe9e, 0xeb0, 0xeab, 0xeb1, 0xe94, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0xeaa, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0xea7, 0xeb1, 0xe99, 0xeaa, 0xeb8, 0xe81, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0xeaa, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0xea7, 0xeb1, 0xe99, 0xec0, 0xeaa, 0xebb, 0xeb2, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0xea7, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0xea1, 0x2e, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0xea1, 0xeb1, 0xe87, 0xe81, 0xead, 0xe99, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0xea1, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0xe81, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName01[] = { 0xe81, 0xeb8, 0xea1, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0xe81, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0xea1, 0xeb5, 0x2e, 0xe99, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0xea1, 0xeb5, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0xea1, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0xea1, 0x2e, 0xeaa, 0x2e, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0xec0, 0xea1, 0xeaa, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0xec0, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0xe9e, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName04[]
        = { 0xe9e, 0xeb6, 0xe94, 0xeaa, 0xeb0, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0xe9e, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0xea1, 0xeb4, 0x2e, 0xe96, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName05[]
        = { 0xea1, 0xeb4, 0xe96, 0xeb8, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0xea1, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0xe81, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0xe81, 0xecd, 0xea5, 0xeb0, 0xe81, 0xebb, 0xe94, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0xe81, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0xeaa, 0x2e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0xeaa, 0xeb4, 0xe87, 0xeab, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0xeaa, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0xe81, 0x2e, 0xe8d, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName08[] = { 0xe81, 0xeb1, 0xe99, 0xe8d, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0xe81, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0xe95, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName09[] = { 0xe95, 0xeb8, 0xea5, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0xe95, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0xe9e, 0x2e, 0xe88, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName010[] = { 0xe9e, 0xeb0, 0xe88, 0xeb4, 0xe81, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0xe9e, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0xe97, 0x2e, 0xea7, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName011[] = { 0xe97, 0xeb1, 0xe99, 0xea7, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0xe97, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0xea1, 0x2e, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0xea1, 0xeb1, 0xe87, 0xe81, 0xead, 0xe99, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0xea1, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0xe81, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0xe81, 0xeb8, 0xea1, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[]
        = { 0xea1, 0xeb5, 0x2e, 0xe99, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[] = { 0xea1, 0xeb5, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0xea1, 0x0 };
    static const sal_Unicode genitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[]
        = { 0xea1, 0x2e, 0xeaa, 0x2e, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[] = { 0xec0, 0xea1, 0xeaa, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0xec0, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0xe9e, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0xe9e, 0xeb6, 0xe94, 0xeaa, 0xeb0, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0xe9e, 0x0 };
    static const sal_Unicode genitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[]
        = { 0xea1, 0xeb4, 0x2e, 0xe96, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0xea1, 0xeb4, 0xe96, 0xeb8, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0xea1, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0xe81, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0xe81, 0xecd, 0xea5, 0xeb0, 0xe81, 0xebb, 0xe94, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0xeaa, 0x2e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0xeaa, 0xeb4, 0xe87, 0xeab, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0xeaa, 0x0 };
    static const sal_Unicode genitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0xe81, 0x2e, 0xe8d, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0xe81, 0xeb1, 0xe99, 0xe8d, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0xe95, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[] = { 0xe95, 0xeb8, 0xea5, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0xe95, 0x0 };
    static const sal_Unicode genitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0xe9e, 0x2e, 0xe88, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0xe9e, 0xeb0, 0xe88, 0xeb4, 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0xe9e, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0xe97, 0x2e, 0xea7, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0xe97, 0xeb1, 0xe99, 0xea7, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0xe97, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0xea1, 0x2e, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0xea1, 0xeb1, 0xe87, 0xe81, 0xead, 0xe99, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0xea1, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0xe81, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0xe81, 0xeb8, 0xea1, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0xe81, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0xea1, 0xeb5, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0xea1, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0xec0, 0xea1, 0xeaa, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0xec0, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0xe9e, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[]
        = { 0xe9e, 0xeb6, 0xe94, 0xeaa, 0xeb0, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0xe9e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0xea1, 0xeb4, 0xe96, 0xeb8, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0xea1, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0xe81, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0xe81, 0xecd, 0xea5, 0xeb0, 0xe81, 0xebb, 0xe94, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0xe81, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0xeaa, 0x2e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0xeaa, 0xeb4, 0xe87, 0xeab, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0xeaa, 0x0 };
    static const sal_Unicode partitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0xe81, 0x2e, 0xe8d, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0xe81, 0xeb1, 0xe99, 0xe8d, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0xe81, 0x0 };
    static const sal_Unicode partitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0xe95, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0xe95, 0xeb8, 0xea5, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0xe95, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[]
        = { 0xe9e, 0x2e, 0xe88, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0xe9e, 0xeb0, 0xe88, 0xeb4, 0xe81, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0xe9e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[]
        = { 0xe97, 0x2e, 0xea7, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0xe97, 0xeb1, 0xe99, 0xea7, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0xe97, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[] = { 0xe9e, 0x2e, 0xeaa, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0xe9b, 0xeb5, 0xe81, 0xec8, 0xead, 0xe99, 0xe9e, 0xeb8, 0xe94,
            0xeaa, 0xeb0, 0xe81, 0xeb2, 0xe99, 0xe97, 0xeb5, 0xec8, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x66, 0x74, 0x65, 0x72, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0xe9e, 0x2e, 0xeaa, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0xe9e, 0xeb8, 0xe94, 0xeaa, 0xeb0, 0xe81, 0xeb2, 0xe99, 0x0 };
    static const sal_Unicode startDayOfWeek0[] = { 0x73, 0x75, 0x6e, 0x0 };
    static const sal_Unicode minimalDaysInFirstWeek0[] = { 1 };
    static const sal_Unicode calendarID1[]
        = { 0x67, 0x72, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode defaultCalendar1[] = { 1 };
    static const sal_Unicode dayID10[] = { 0x73, 0x75, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName10[] = { 0xead, 0xeb2, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName10[]
        = { 0xea7, 0xeb1, 0xe99, 0xead, 0xeb2, 0xe97, 0xeb4, 0xe94, 0x0 };
    static const sal_Unicode dayDefaultNarrowName10[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID11[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName11[] = { 0xe88, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName11[]
        = { 0xea7, 0xeb1, 0xe99, 0xe88, 0xeb1, 0xe99, 0x0 };
    static const sal_Unicode dayDefaultNarrowName11[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID12[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName12[] = { 0xead, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName12[]
        = { 0xea7, 0xeb1, 0xe99, 0xead, 0xeb1, 0xe87, 0xe84, 0xeb2, 0xe99, 0x0 };
    static const sal_Unicode dayDefaultNarrowName12[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID13[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName13[] = { 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName13[]
        = { 0xea7, 0xeb1, 0xe99, 0xe9e, 0xeb8, 0xe94, 0x0 };
    static const sal_Unicode dayDefaultNarrowName13[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID14[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName14[] = { 0xe9e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName14[]
        = { 0xea7, 0xeb1, 0xe99, 0xe9e, 0xeb0, 0xeab, 0xeb1, 0xe94, 0x0 };
    static const sal_Unicode dayDefaultNarrowName14[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID15[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName15[] = { 0xeaa, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName15[]
        = { 0xea7, 0xeb1, 0xe99, 0xeaa, 0xeb8, 0xe81, 0x0 };
    static const sal_Unicode dayDefaultNarrowName15[] = { 0xea7, 0x0 };
    static const sal_Unicode dayID16[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName16[] = { 0xeaa, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName16[]
        = { 0xea7, 0xeb1, 0xe99, 0xec0, 0xeaa, 0xebb, 0xeb2, 0x0 };
    static const sal_Unicode dayDefaultNarrowName16[] = { 0xea7, 0x0 };
    static const sal_Unicode monthID10[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName10[] = { 0xea1, 0x2e, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName10[]
        = { 0xea1, 0xeb1, 0xe87, 0xe81, 0xead, 0xe99, 0x0 };
    static const sal_Unicode monthDefaultNarrowName10[] = { 0xea1, 0x0 };
    static const sal_Unicode monthID11[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName11[] = { 0xe81, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName11[] = { 0xe81, 0xeb8, 0xea1, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName11[] = { 0xe81, 0x0 };
    static const sal_Unicode monthID12[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName12[] = { 0xea1, 0xeb5, 0x2e, 0xe99, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName12[] = { 0xea1, 0xeb5, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName12[] = { 0xea1, 0x0 };
    static const sal_Unicode monthID13[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName13[] = { 0xea1, 0x2e, 0xeaa, 0x2e, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName13[] = { 0xec0, 0xea1, 0xeaa, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName13[] = { 0xec0, 0x0 };
    static const sal_Unicode monthID14[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName14[] = { 0xe9e, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName14[]
        = { 0xe9e, 0xeb6, 0xe94, 0xeaa, 0xeb0, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName14[] = { 0xe9e, 0x0 };
    static const sal_Unicode monthID15[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName15[] = { 0xea1, 0xeb4, 0x2e, 0xe96, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName15[]
        = { 0xea1, 0xeb4, 0xe96, 0xeb8, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName15[] = { 0xea1, 0x0 };
    static const sal_Unicode monthID16[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName16[] = { 0xe81, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName16[]
        = { 0xe81, 0xecd, 0xea5, 0xeb0, 0xe81, 0xebb, 0xe94, 0x0 };
    static const sal_Unicode monthDefaultNarrowName16[] = { 0xe81, 0x0 };
    static const sal_Unicode monthID17[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName17[] = { 0xeaa, 0x2e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName17[] = { 0xeaa, 0xeb4, 0xe87, 0xeab, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName17[] = { 0xeaa, 0x0 };
    static const sal_Unicode monthID18[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName18[] = { 0xe81, 0x2e, 0xe8d, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName18[] = { 0xe81, 0xeb1, 0xe99, 0xe8d, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName18[] = { 0xe81, 0x0 };
    static const sal_Unicode monthID19[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName19[] = { 0xe95, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName19[] = { 0xe95, 0xeb8, 0xea5, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName19[] = { 0xe95, 0x0 };
    static const sal_Unicode monthID110[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName110[] = { 0xe9e, 0x2e, 0xe88, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName110[] = { 0xe9e, 0xeb0, 0xe88, 0xeb4, 0xe81, 0x0 };
    static const sal_Unicode monthDefaultNarrowName110[] = { 0xe9e, 0x0 };
    static const sal_Unicode monthID111[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName111[] = { 0xe97, 0x2e, 0xea7, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName111[] = { 0xe97, 0xeb1, 0xe99, 0xea7, 0xeb2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName111[] = { 0xe97, 0x0 };
    static const sal_Unicode genitiveMonthID10[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName10[] = { 0xea1, 0x2e, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName10[]
        = { 0xea1, 0xeb1, 0xe87, 0xe81, 0xead, 0xe99, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName10[] = { 0xea1, 0x0 };
    static const sal_Unicode genitiveMonthID11[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName11[] = { 0xe81, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName11[]
        = { 0xe81, 0xeb8, 0xea1, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName11[] = { 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthID12[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName12[]
        = { 0xea1, 0xeb5, 0x2e, 0xe99, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName12[] = { 0xea1, 0xeb5, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName12[] = { 0xea1, 0x0 };
    static const sal_Unicode genitiveMonthID13[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName13[]
        = { 0xea1, 0x2e, 0xeaa, 0x2e, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName13[] = { 0xec0, 0xea1, 0xeaa, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName13[] = { 0xec0, 0x0 };
    static const sal_Unicode genitiveMonthID14[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName14[] = { 0xe9e, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName14[]
        = { 0xe9e, 0xeb6, 0xe94, 0xeaa, 0xeb0, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName14[] = { 0xe9e, 0x0 };
    static const sal_Unicode genitiveMonthID15[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName15[]
        = { 0xea1, 0xeb4, 0x2e, 0xe96, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName15[]
        = { 0xea1, 0xeb4, 0xe96, 0xeb8, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName15[] = { 0xea1, 0x0 };
    static const sal_Unicode genitiveMonthID16[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName16[] = { 0xe81, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName16[]
        = { 0xe81, 0xecd, 0xea5, 0xeb0, 0xe81, 0xebb, 0xe94, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName16[] = { 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthID17[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName17[] = { 0xeaa, 0x2e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName17[]
        = { 0xeaa, 0xeb4, 0xe87, 0xeab, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName17[] = { 0xeaa, 0x0 };
    static const sal_Unicode genitiveMonthID18[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName18[] = { 0xe81, 0x2e, 0xe8d, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName18[]
        = { 0xe81, 0xeb1, 0xe99, 0xe8d, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName18[] = { 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthID19[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName19[] = { 0xe95, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName19[] = { 0xe95, 0xeb8, 0xea5, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName19[] = { 0xe95, 0x0 };
    static const sal_Unicode genitiveMonthID110[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName110[] = { 0xe9e, 0x2e, 0xe88, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName110[]
        = { 0xe9e, 0xeb0, 0xe88, 0xeb4, 0xe81, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName110[] = { 0xe9e, 0x0 };
    static const sal_Unicode genitiveMonthID111[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName111[] = { 0xe97, 0x2e, 0xea7, 0x2e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName111[]
        = { 0xe97, 0xeb1, 0xe99, 0xea7, 0xeb2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName111[] = { 0xe97, 0x0 };
    static const sal_Unicode partitiveMonthID10[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName10[] = { 0xea1, 0x2e, 0xe81, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName10[]
        = { 0xea1, 0xeb1, 0xe87, 0xe81, 0xead, 0xe99, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName10[] = { 0xea1, 0x0 };
    static const sal_Unicode partitiveMonthID11[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName11[] = { 0xe81, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName11[]
        = { 0xe81, 0xeb8, 0xea1, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName11[] = { 0xe81, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName12[]
        = { 0xea1, 0xeb5, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName12[] = { 0xea1, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName13[]
        = { 0xec0, 0xea1, 0xeaa, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName13[] = { 0xec0, 0x0 };
    static const sal_Unicode partitiveMonthID14[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName14[] = { 0xe9e, 0x2e, 0xe9e, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName14[]
        = { 0xe9e, 0xeb6, 0xe94, 0xeaa, 0xeb0, 0xe9e, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName14[] = { 0xe9e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName15[]
        = { 0xea1, 0xeb4, 0xe96, 0xeb8, 0xe99, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName15[] = { 0xea1, 0x0 };
    static const sal_Unicode partitiveMonthID16[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName16[] = { 0xe81, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName16[]
        = { 0xe81, 0xecd, 0xea5, 0xeb0, 0xe81, 0xebb, 0xe94, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName16[] = { 0xe81, 0x0 };
    static const sal_Unicode partitiveMonthID17[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName17[] = { 0xeaa, 0x2e, 0xeab, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName17[]
        = { 0xeaa, 0xeb4, 0xe87, 0xeab, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName17[] = { 0xeaa, 0x0 };
    static const sal_Unicode partitiveMonthID18[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName18[] = { 0xe81, 0x2e, 0xe8d, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName18[]
        = { 0xe81, 0xeb1, 0xe99, 0xe8d, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName18[] = { 0xe81, 0x0 };
    static const sal_Unicode partitiveMonthID19[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName19[] = { 0xe95, 0x2e, 0xea5, 0x2e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName19[]
        = { 0xe95, 0xeb8, 0xea5, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName19[] = { 0xe95, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName110[]
        = { 0xe9e, 0xeb0, 0xe88, 0xeb4, 0xe81, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName110[] = { 0xe9e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName111[]
        = { 0xe97, 0xeb1, 0xe99, 0xea7, 0xeb2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName111[] = { 0xe97, 0x0 };
    static const sal_Unicode eraID10[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName10[]
        = { 0xe9b, 0xeb5, 0xe81, 0xec8, 0xead, 0xe99, 0xe84, 0xeb4, 0xe94,
            0xeaa, 0xeb0, 0xe81, 0xeb2, 0xe99, 0xe97, 0xeb5, 0xec8, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName11[] = { 0xe84, 0x2e, 0xeaa, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName11[]
        = { 0xe84, 0xeb4, 0xe94, 0xeaa, 0xeb0, 0xe81, 0xeb2, 0xe99, 0xe97, 0xeb5, 0xec8, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_lo_LA(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x4c, 0x41, 0x4b, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x20ad, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x4c, 0x41, 0x4b, 0x0 };
    static const sal_Unicode currencyName0[] = { 0xe81, 0xeb5, 0xe9a, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_lo_LA(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_lo_LA(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[]
        = { 0xec1, 0xea1, 0xec8, 0xe99, 0xec1, 0xea5, 0xec9, 0xea7, 0x0 };
    static const sal_Unicode ReservedWord1[]
        = { 0xe9a, 0xecd, 0xec8, 0xec1, 0xea1, 0xec8, 0xe99, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x51, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x51, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x51, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x51, 0x20, 0x34, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0xe97, 0xeb2, 0xe87, 0xec0, 0xe97, 0xeb5, 0xe87, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0xe97, 0xeb2, 0xe87, 0xea5, 0xeb9, 0xea1, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_lo_LA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_lo_LA(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_lo_LA(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_lo_LA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_lo_LA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
