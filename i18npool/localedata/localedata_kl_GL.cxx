...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6b, 0x6c, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4b, 0x61, 0x6c, 0x61, 0x61, 0x6c, 0x6c, 0x69, 0x73, 0x75, 0x74, 0x0 };
    static const sal_Unicode countryID[] = { 0x47, 0x4c, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4b, 0x61, 0x6c, 0x61, 0x61, 0x6c, 0x6c, 0x69, 0x74,
            0x20, 0x4e, 0x75, 0x6e, 0x61, 0x61, 0x74, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_kl_GL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_kl_GL(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x36, 0x46, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            ...
            0x43, 0x59, 0x5d, 0x20, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            ...
            0x59, 0x5d, 0x20, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            ...
            0x4e, 0x43, 0x59, 0x5d, 0x20, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    getAllFormats0_kl_GL(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_kl_GL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_kl_GL(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_kl_GL(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_kl_GL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_kl_GL(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_kl_GL(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_kl_GL(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x73, 0x61, 0x62, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x73, 0x61, 0x62, 0x61, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x73, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x61, 0x74, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName01[] = { 0x61, 0x74, 0x61, 0x61, 0x73,
                                                        0x69, 0x6e, 0x6e, 0x67, 0x6f,
                                                        0x72, 0x6e, 0x65, 0x71, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x6d, 0x61, 0x72, 0x6c, 0x75, 0x6e, 0x6e, 0x67, 0x6f, 0x72, 0x6e, 0x65, 0x71, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x70, 0x69, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x70, 0x69, 0x6e, 0x67, 0x61, 0x73, 0x75, 0x6e,
            0x6e, 0x67, 0x6f, 0x72, 0x6e, 0x65, 0x71, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x70, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x73, 0x69, 0x73, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x73, 0x69, 0x73, 0x61, 0x6d,
                                                        0x61, 0x6e, 0x6e, 0x67, 0x6f,
                                                        0x72, 0x6e, 0x65, 0x71, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x73, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x74, 0x61, 0x6c, 0x6c, 0x69, 0x6d, 0x61, 0x6e,
            0x6e, 0x67, 0x6f, 0x72, 0x6e, 0x65, 0x71, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x74, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x61, 0x72, 0x66, 0x0 };
    static const sal_Unicode dayDefaultFullName06[] = { 0x61, 0x72, 0x66, 0x69, 0x6e,
                                                        0x69, 0x6e, 0x6e, 0x67, 0x6f,
                                                        0x72, 0x6e, 0x65, 0x71, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x6a, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x74, 0x73, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x61, 0x70, 0x72, 0x69, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x61, 0x6a, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x61, 0x75, 0x67, 0x75, 0x73, 0x74, 0x75, 0x73, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x70, 0x74, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x6f, 0x6b, 0x74, 0x6f, 0x62, 0x65, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x6e, 0x6f, 0x76, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x63, 0x61, 0x6d, 0x62, 0x65, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x6d, 0x61, 0x72, 0x74, 0x73, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x61, 0x70, 0x72, 0x69, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x6a, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x6a, 0x69, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x4b, 0x72, 0x2e, 0x69, 0x6e, 0x2e, 0x73, 0x69, 0x2e, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName01[]
        = { 0x4b, 0x72, 0x2e, 0x69, 0x6e, 0x2e, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_kl_GL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_kl_GL(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_kl_GL(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[]
        = { 0x65, 0x71, 0x71, 0x6f, 0x72, 0x74, 0x6f, 0x71, 0x0 };
    static const sal_Unicode ReservedWord1[]
        = { 0x65, 0x71, 0x71, 0x75, 0x6e, 0x6e, 0x67, 0x69, 0x74, 0x73, 0x6f, 0x71, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x75, 0x6b, 0x69, 0x75, 0x70, 0x20, 0x73, 0x69, 0x73, 0x61, 0x6d,
            0x61, 0x72, 0x61, 0x72, 0x74, 0x65, 0x72, 0x75, 0x74, 0x61, 0x61,
            0x74, 0x61, 0x20, 0x73, 0x69, 0x75, 0x6c, 0x6c, 0x69, 0x61, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x75, 0x6b, 0x69, 0x75, 0x70, 0x20, 0x73, 0x69, 0x73, 0x61, 0x6d,
            0x61, 0x72, 0x61, 0x72, 0x74, 0x65, 0x72, 0x75, 0x74, 0x61, 0x61,
            0x74, 0x61, 0x20, 0x74, 0x75, 0x6c, 0x6c, 0x69, 0x61, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x75, 0x6b, 0x69, 0x75, 0x70, 0x20, 0x73, 0x69, 0x73, 0x61, 0x6d, 0x61,
            0x72, 0x61, 0x72, 0x74, 0x65, 0x72, 0x75, 0x74, 0x61, 0x61, 0x74, 0x61,
            0x20, 0x70, 0x69, 0x6e, 0x67, 0x61, 0x6a, 0x75, 0x61, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x75, 0x6b, 0x69, 0x75, 0x70, 0x20, 0x73, 0x69, 0x73, 0x61, 0x6d,
            0x61, 0x72, 0x61, 0x72, 0x74, 0x65, 0x72, 0x75, 0x74, 0x61, 0x61,
            0x74, 0x61, 0x20, 0x73, 0x69, 0x73, 0x61, 0x6d, 0x61, 0x61, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x71, 0x75, 0x6c, 0x6c, 0x65, 0x71, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x61, 0x6c, 0x6c, 0x65, 0x71, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_kl_GL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_kl_GL(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_kl_GL(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_kl_GL(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_kl_GL(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
