...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x46, 0x49, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x46, 0x69, 0x6e, 0x6c, 0x61, 0x6e, 0x64, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sv_FI(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sv_FI(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode0[] = { 0x59, 0x6c, 0x65, 0x69, 0x6e, 0x65, 0x6e, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x6d, 0x6b, 0x2d,
            0x38, 0x31, 0x44, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30,
            0x20, 0x5b, 0x24, 0x6d, 0x6b, 0x2d, 0x38, 0x31, 0x44, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x6d, 0x6b,
            0x2d, 0x38, 0x31, 0x44, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c,
            0x30, 0x30, 0x20, 0x5b, 0x24, 0x6d, 0x6b, 0x2d, 0x38, 0x31, 0x44, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x6d, 0x6b, 0x2d, 0x38, 0x31,
            0x44, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0xa0, 0x23, 0x23,
            0x30, 0x20, 0x5b, 0x24, 0x6d, 0x6b, 0x2d, 0x38, 0x31, 0x44, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24,
            0x6d, 0x6b, 0x2d, 0x38, 0x31, 0x44, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x20, 0x22, 0x64, 0x65, 0x6e, 0x22, 0x20, 0x44,
            0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x20, 0x22, 0x64, 0x65, 0x6e, 0x22, 0x20, 0x44, 0x2e,
    ...
    getAllFormats0_sv_FI(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_sv_FI(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_sv_FI(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_sv_FI(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_sv_FI(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_sv_SE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_sv_FI(sal_Int16& count)
    {
        return getIndexAlgorithm_sv_SE(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_sv_SE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_sv_FI(sal_Int16& count)
    {
        return getUnicodeScripts_sv_SE(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_sv_SE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_sv_FI(sal_Int16& count)
    {
        return getFollowPageWords_sv_SE(count);
    }
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_sv_FI(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x46, 0x49, 0x4d, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x6d, 0x6b, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x46, 0x49, 0x4d, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x46, 0x69, 0x6e, 0x73, 0x6b, 0x20, 0x6d, 0x61, 0x72, 0x6b, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sv_FI(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sv_FI(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getForbiddenCharacters_sv_SE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sv_FI(sal_Int16& count)
    {
        return getForbiddenCharacters_sv_SE(count);
    }
    extern sal_Unicode** SAL_CALL getBreakIteratorRules_sv_SE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sv_FI(sal_Int16& count)
    {
        return getBreakIteratorRules_sv_SE(count);
    }
    extern sal_Unicode** SAL_CALL getReservedWords_sv_SE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sv_FI(sal_Int16& count)
    {
        return getReservedWords_sv_SE(count);
    }
    // ---> ContinuousNumbering
    ...
    getContinuousNumberingLevels_sv_FI(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_sv_FI(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
