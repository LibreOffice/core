...
extern "C"
{
    static const sal_Unicode langID[] = { 0x64, 0x65, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x47, 0x65, 0x72, 0x6d, 0x61, 0x6e, 0x0 };
    static const sal_Unicode countryID[] = { 0x4c, 0x55, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4c, 0x75, 0x78, 0x65, 0x6d, 0x62, 0x6f, 0x75, 0x72, 0x67, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_de_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x76, 0x6f, 0x72, 0x6d, 0x2e, 0x0 };
    static const sal_Unicode timePM[] = { 0x6e, 0x61, 0x63, 0x68, 0x6d, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_de_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x2d, 0x31,
            0x30, 0x30, 0x37, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30,
            0x20, 0x5b, 0x24, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x2d,
            0x31, 0x30, 0x30, 0x37, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c,
            0x30, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x46, 0x2d, 0x31, 0x30, 0x30,
            0x37, 0x5d, 0x3b, 0x5b, 0x52, 0x4f, 0x54, 0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23,
            0x30, 0x20, 0x5b, 0x24, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24,
            0x46, 0x2d, 0x31, 0x30, 0x30, 0x37, 0x5d, 0x3b, 0x5b, 0x52, 0x4f,
            0x54, 0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30,
            0x20, 0x5b, 0x24, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x20, 0x5b, 0x24,
            0x46, 0x2d, 0x31, 0x30, 0x30, 0x37, 0x5d, 0x3b, 0x5b, 0x52, 0x4f,
            0x54, 0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d,
            0x20, 0x5b, 0x24, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode17[]
        = { 0x54, 0x54, 0x2e, 0x4d, 0x4d, 0x2e, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode18[] = { 0x4e, 0x4e, 0x4e, 0x4e, 0x54, 0x2e, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode20[]
        = { 0x54, 0x54, 0x2e, 0x4d, 0x4d, 0x2e, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x54, 0x2e, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x54, 0x2e, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode23[]
        = { 0x54, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x2e, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x54, 0x2e, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode25[]
        = { 0x54, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x2c, 0x54, 0x2e, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x54, 0x54, 0x2e, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode28[] = { 0x4e, 0x4e, 0x2c, 0x54, 0x2e, 0x4d, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode29[] = { 0x4e, 0x4e, 0x4e, 0x4e, 0x54, 0x2e, 0x4d, 0x4d,
                                                0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode30[] = { 0x4d, 0x4d, 0x2d, 0x54, 0x54, 0x0 };
    ...
    static const sal_Unicode FormatCode31[]
        = { 0x4a, 0x4a, 0x2d, 0x4d, 0x4d, 0x2d, 0x54, 0x54, 0x0 };
    ...
    static const sal_Unicode FormatCode32[]
        = { 0x4a, 0x4a, 0x4a, 0x4a, 0x2d, 0x4d, 0x4d, 0x2d, 0x54, 0x54, 0x0 };
    ...
    static const sal_Unicode FormatCode33[] = { 0x4d, 0x4d, 0x2e, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode34[] = { 0x54, 0x54, 0x2e, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    static const sal_Unicode FormatCode45[] = { 0x54, 0x54, 0x2e, 0x4d, 0x4d, 0x2e, 0x4a, 0x4a,
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x54, 0x54, 0x2e, 0x4d, 0x4d, 0x2e, 0x4a, 0x4a, 0x4a, 0x4a,
    ...
    static const sal_Unicode FormatCode47[]
        = { 0x54, 0x54, 0x2e, 0x4d, 0x4d, 0x2e, 0x4a, 0x4a, 0x4a,
            0x4a, 0x20, 0x48, 0x48, 0x3a, 0x4d, 0x4d, 0x0 };
    ...
    getAllFormats0_de_LU(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_de_LU(sal_Int16& count)
    {
        count = DateAcceptancePatternsCount;
        return (sal_Unicode**)DateAcceptancePatternsArray;
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_de_LU(sal_Int16& count)
    {
        return getCollatorImplementation_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_de_LU(sal_Int16& count)
    {
        return getCollationOptions_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_de_LU(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_de_LU(sal_Int16& count)
    {
        return getIndexAlgorithm_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_de_LU(sal_Int16& count)
    {
        return getUnicodeScripts_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_de_LU(sal_Int16& count)
    {
        return getFollowPageWords_de_DE(count);
    }
    ...
    static const sal_Unicode monthDefaultFullName00[] = { 0x4a, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x46, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x4d, 0x72, 0x7a, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0xe4, 0x72, 0x7a, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x61, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x4a, 0x75, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x4f, 0x6b, 0x74, 0x6f, 0x62, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x44, 0x65, 0x7a, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x72, 0x7a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[] = { 0x4d, 0xe4, 0x72, 0x7a, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x4a, 0x75, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x72, 0x7a, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[] = { 0x4d, 0xe4, 0x72, 0x7a, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x4a, 0x75, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x76, 0x2e, 0x20, 0x43, 0x68, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x76, 0x6f, 0x72, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[]
        = { 0x6e, 0x2e, 0x20, 0x43, 0x68, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x6e, 0x61, 0x63, 0x68, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_de_LU(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID1[] = { 0x4c, 0x55, 0x46, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x46, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x4c, 0x55, 0x46, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0x4c, 0x75, 0x78, 0x65, 0x6d, 0x62, 0x75, 0x72, 0x67, 0x69, 0x73,
            0x63, 0x68, 0x65, 0x72, 0x20, 0x46, 0x72, 0x61, 0x6e, 0x63, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_de_LU(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_de_LU(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getForbiddenCharacters_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_de_LU(sal_Int16& count)
    {
        return getForbiddenCharacters_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getBreakIteratorRules_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_de_LU(sal_Int16& count)
    {
        return getBreakIteratorRules_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getReservedWords_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_de_LU(sal_Int16& count)
    {
        return getReservedWords_de_DE(count);
    }
    // ---> ContinuousNumbering
    ...
    getContinuousNumberingLevels_de_LU(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_de_LU(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
