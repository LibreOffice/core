...
extern "C"
{
    static const sal_Unicode langID[] = { 0x65, 0x75, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x42, 0x61, 0x73, 0x71, 0x75, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_eu_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateYearSeparator[] = { 0x2e, 0x65, 0x6b, 0x6f, 0x20, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_eu_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20a7, 0x2d, 0x34, 0x32, 0x44, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode0[]
        = { 0x45, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x61, 0x72, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x59, 0x59, 0x59, 0x59, 0x22, 0x2e, 0x65, 0x6b, 0x6f,
            0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x22, 0x6b, 0x22, 0x20, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x59, 0x59, 0x22, 0x6b, 0x6f, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x59, 0x59, 0x59, 0x59, 0x22, 0x2e, 0x65, 0x6b, 0x6f,
            0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode23[]
        = { 0x59, 0x59, 0x59, 0x59, 0x2e, 0x4d, 0x4d, 0x4d, 0x2e, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x59, 0x59, 0x59, 0x59, 0x22, 0x2e, 0x65, 0x6b, 0x6f, 0x22, 0x20,
            0x4d, 0x4d, 0x4d, 0x4d, 0x22, 0x6b, 0x22, 0x20, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode25[]
        = { 0x44, 0x2c, 0x20, 0x59, 0x59, 0x59, 0x59, 0x22, 0x2e, 0x65,
            0x6b, 0x6f, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x59, 0x59, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode27[] = { 0x4e, 0x4e, 0x20, 0x59, 0x59, 0x59, 0x59, 0x2f,
                                                0x4d, 0x4d, 0x4d, 0x2f, 0x44, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x22, 0x6b,
            0x22, 0x20, 0x44, 0x2c, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode36[]
        = { 0x59, 0x59, 0x22, 0x6b, 0x6f, 0x22, 0x20, 0x51, 0x51, 0x0 };
    ...
    getAllFormats0_eu_ES(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_eu_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_eu_ES(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_eu_ES(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_eu_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[] = { 0x41, 0x2d, 0x5a, 0x20, 0xd1, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x20, 0x6f, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x20, 0x6f, 0x6f, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_eu_ES(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_eu_ES(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_eu_ES(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x69, 0x67, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x69, 0x67, 0x61, 0x6e, 0x64, 0x65, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x69, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x61, 0x6c, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x61, 0x73, 0x74, 0x65, 0x6c, 0x65, 0x68, 0x65, 0x6e, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x61, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x61, 0x72, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x61, 0x73, 0x74, 0x65, 0x61, 0x72, 0x74, 0x65, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x61, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x61, 0x7a, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x61, 0x73, 0x74, 0x65, 0x61, 0x7a, 0x6b, 0x65, 0x6e, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x61, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x6f, 0x67, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x6f, 0x73, 0x74, 0x65, 0x67, 0x75, 0x6e, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x6f, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x6f, 0x72, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x6f, 0x73, 0x74, 0x69, 0x72, 0x61, 0x6c, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x6f, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x6c, 0x72, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x6c, 0x61, 0x72, 0x75, 0x6e, 0x62, 0x61, 0x74, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x6c, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x75, 0x72, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x75, 0x72, 0x74, 0x61, 0x72, 0x72, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x75, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x6f, 0x74, 0x73, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x6f, 0x74, 0x73, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[]
        = { 0x6d, 0x61, 0x69, 0x61, 0x74, 0x7a, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x65, 0x6b, 0x61, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x65, 0x6b, 0x61, 0x69, 0x6e, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x65, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x75, 0x7a, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x75, 0x7a, 0x74, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x75, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x62, 0x75, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x61, 0x62, 0x75, 0x7a, 0x74, 0x75, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x61, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x69, 0x72, 0x61, 0x0 };
    static const sal_Unicode monthDefaultFullName08[] = { 0x69, 0x72, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x69, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x75, 0x72, 0x72, 0x0 };
    static const sal_Unicode monthDefaultFullName09[] = { 0x75, 0x72, 0x72, 0x69, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x75, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x61, 0x7a, 0x61, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x61, 0x7a, 0x61, 0x72, 0x6f, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x61, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x61, 0x62, 0x65, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x61, 0x62, 0x65, 0x6e, 0x64, 0x75, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x61, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x75, 0x72, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x75, 0x72, 0x74, 0x61, 0x72, 0x72, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x75, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x6f, 0x74, 0x73, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x6f, 0x74, 0x73, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x61, 0x70, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x65, 0x6b, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x65, 0x6b, 0x61, 0x69, 0x6e, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x65, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x75, 0x7a, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x75, 0x7a, 0x74, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x75, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x61, 0x62, 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x69, 0x72, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x69, 0x72, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x75, 0x72, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x75, 0x72, 0x72, 0x69, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0x75, 0x0 };
    static const sal_Unicode genitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x61, 0x7a, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x61, 0x7a, 0x61, 0x72, 0x6f, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0x61, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x61, 0x62, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x61, 0x62, 0x65, 0x6e, 0x64, 0x75, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0x61, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x75, 0x72, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x75, 0x72, 0x74, 0x61, 0x72, 0x72, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x75, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x6f, 0x74, 0x73, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x6f, 0x74, 0x73, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x6f, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x61, 0x70, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x65, 0x6b, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x65, 0x6b, 0x61, 0x69, 0x6e, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x65, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x75, 0x7a, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0x75, 0x7a, 0x74, 0x61, 0x69, 0x6c, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x75, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x61, 0x62, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x69, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x75, 0x72, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0x75, 0x72, 0x72, 0x69, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0x75, 0x0 };
    static const sal_Unicode partitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x61, 0x7a, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0x61, 0x7a, 0x61, 0x72, 0x6f, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0x61, 0x0 };
    static const sal_Unicode partitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x61, 0x62, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0x61, 0x62, 0x65, 0x6e, 0x64, 0x75, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0x61, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x4b, 0x2e, 0x41, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[] = { 0x4b, 0x2e, 0x41, 0x2e, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x4b, 0x2e, 0x4f, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x4b, 0x2e, 0x4f, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_eu_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_eu_ES(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_eu_ES(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[]
        = { 0x65, 0x67, 0x69, 0x61, 0x7a, 0x6b, 0x6f, 0x61, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x74, 0x73, 0x75, 0x61, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x31, 0x2e, 0x20, 0x68, 0x69, 0x72, 0x75, 0x68,
                                                 0x69, 0x6c, 0x65, 0x6b, 0x6f, 0x61, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x32, 0x2e, 0x20, 0x68, 0x69, 0x72, 0x75, 0x68,
                                                 0x69, 0x6c, 0x65, 0x6b, 0x6f, 0x61, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x33, 0x2e, 0x20, 0x68, 0x69, 0x72, 0x75, 0x68,
                                                 0x69, 0x6c, 0x65, 0x6b, 0x6f, 0x61, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x34, 0x2e, 0x20, 0x68, 0x69, 0x72, 0x75, 0x68,
                                                 0x69, 0x6c, 0x65, 0x6b, 0x6f, 0x61, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x67, 0x61, 0x69, 0x6e, 0x65, 0x61, 0x6e, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x61, 0x7a, 0x70, 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x48, 0x68, 0x31, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x48, 0x68, 0x32, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x48, 0x68, 0x33, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x48, 0x68, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_eu_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_eu_ES(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_eu_ES(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_eu_ES(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_eu_ES(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
