...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6e, 0x73, 0x6f, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4e, 0x6f, 0x72, 0x74, 0x68, 0x65, 0x72, 0x6e,
                                                   0x20, 0x53, 0x6f, 0x74, 0x68, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_nso_ZA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_nso_ZA(sal_Int16& count)
    {
        return getLocaleItem_en_ZA(count);
    }
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x52, 0x2d, 0x34, 0x36, 0x43, 0x5d, 0x0 };
    ...
    getAllFormats0_nso_ZA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_nso_ZA(sal_Int16& count)
    {
        return getDateAcceptancePatterns_en_ZA(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_nso_ZA(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_nso_ZA(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_nso_ZA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_nso_ZA(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_nso_ZA(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_nso_ZA(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x53, 0x6f, 0x6e, 0x74, 0x61, 0x67, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4d, 0x6f, 0x73, 0x75, 0x70, 0x61, 0x6c, 0x6f, 0x67, 0x6f, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x4c, 0x61, 0x62, 0x6f, 0x68, 0x6c, 0x61, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x4c, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x4d, 0x6f, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x4d, 0x6f, 0x6b, 0x69, 0x62, 0x65, 0x6c, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x61, 0x77, 0x61, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x65, 0x72, 0x77, 0x61, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x4a, 0x75, 0x6c, 0x61, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x41, 0x67, 0x6f, 0x73, 0x74, 0x6f, 0x73, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x53, 0x65, 0x74, 0x65, 0x6d, 0x65, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x4f, 0x6b, 0x74, 0x6f, 0x62, 0x6f, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x4e, 0x6f, 0x66, 0x65, 0x6d, 0x65, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x44, 0x69, 0x73, 0x65, 0x6d, 0x65, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x41, 0x70, 0x6f, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x41, 0x70, 0x6f, 0x0 };
    ...
    getContinuousNumberingLevels_nso_ZA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_nso_ZA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
