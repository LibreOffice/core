...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x4c, 0x49, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4c, 0x69, 0x65, 0x63, 0x68, 0x74, 0x65, 0x6e, 0x73, 0x74, 0x65, 0x69, 0x6e, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_de_LI(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_de_LI(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x37, 0x5d, 0x20,
            0x23, 0x27, 0x23, 0x23, 0x30, 0x3b, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d,
            0x31, 0x34, 0x30, 0x37, 0x5d, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x27,
            0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31,
            0x34, 0x30, 0x37, 0x5d, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x27,
            0x23, 0x23, 0x30, 0x3b, 0x5b, 0x52, 0x4f, 0x54, 0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46,
            0x2d, 0x31, 0x34, 0x30, 0x37, 0x5d, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x37, 0x5d, 0x20,
            0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b, 0x52, 0x4f,
            0x54, 0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x37,
            0x5d, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x37, 0x5d, 0x20,
            0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x3b, 0x5b, 0x52, 0x4f,
            0x54, 0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x34, 0x30, 0x37,
            0x5d, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x0 };
    ...
    getAllFormats0_de_LI(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_de_LI(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_de_LI(sal_Int16& count)
    {
        return getCollatorImplementation_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_de_LI(sal_Int16& count)
    {
        return getCollationOptions_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_de_LI(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_de_LI(sal_Int16& count)
    {
        return getIndexAlgorithm_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_de_LI(sal_Int16& count)
    {
        return getUnicodeScripts_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_de_LI(sal_Int16& count)
    {
        return getFollowPageWords_de_DE(count);
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_de_DE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_de_LI(sal_Int16& count)
    {
        return getAllCalendars_de_DE(count);
    }
    ...
    static const sal_Unicode currencyName0[]
        = { 0x53, 0x63, 0x68, 0x77, 0x65, 0x69, 0x7a, 0x65, 0x72,
            0x20, 0x46, 0x72, 0x61, 0x6e, 0x6b, 0x65, 0x6e, 0x0 };
    ...
    static const sal_Unicode currencySymbol1[] = { 0x53, 0x46, 0x72, 0x2e, 0x0 };
    ...
    getContinuousNumberingLevels_de_LI(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_de_LI(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
