...
extern "C"
{
    static const sal_Unicode langID[] = { 0x78, 0x6b, 0x75, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4b, 0x61, 0x61, 0x6d, 0x62, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_xku_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_xku_CG(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCType);
        return (sal_Unicode**)LCType;
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x43, 0x46, 0x41, 0x2d, 0x36, 0x37, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_xku_CG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_xku_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_xku_CG(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_xku_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_xku_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_xku_CG(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_xku_CG(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_xku_CG(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x4e, 0x7a, 0x61, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x4e, 0x7a, 0x61, 0x77, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[] = { 0x46, 0x65, 0x62, 0x69, 0x79, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x73, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x4d, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x41, 0x76, 0x65, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x76, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x61, 0x79, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x4d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x4e, 0x7a, 0x77, 0x69, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x4e, 0x7a, 0x77, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x4e, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x4e, 0x7a, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x4e, 0x7a, 0x77, 0x69, 0x79, 0x65, 0x74, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x4e, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x41, 0x77, 0x75, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x41, 0x77, 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x4e, 0x6f, 0x76, 0x61, 0x6d, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x69, 0x79, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[] = { 0x4d, 0x61, 0x73, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x41, 0x76, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[] = { 0x41, 0x76, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x79, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x4e, 0x7a, 0x77, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x4e, 0x7a, 0x77, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x4e, 0x7a, 0x74, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x41, 0x77, 0x75, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[] = { 0x41, 0x77, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x4e, 0x7a, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName02[] = { 0x4d, 0x61, 0x73, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x41, 0x76, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[] = { 0x41, 0x76, 0x65, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x79, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x4e, 0x7a, 0x77, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x4e, 0x7a, 0x77, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x4e, 0x7a, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x41, 0x77, 0x75, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[] = { 0x41, 0x77, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_xku_CG(sal_Int16& count)
    {
        count = calendarsCount;
        return (sal_Unicode**)calendars;
    }
    extern sal_Unicode** SAL_CALL getAllCurrencies_kng_CG(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_xku_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_xku_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_xku_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_xku_CG(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_xku_CG(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_xku_CG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_xku_CG(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
