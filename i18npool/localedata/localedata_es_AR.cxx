...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x41, 0x52, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x41, 0x72, 0x67, 0x65, 0x6e, 0x74, 0x69, 0x6e, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_es_AR(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateDaySeparator[] = { 0x20, 0x64, 0x65, 0x20, 0x0 };
    static const sal_Unicode LongDateMonthSeparator[] = { 0x20, 0x64, 0x65, 0x20, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_es_AR(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x24, 0x2d, 0x32, 0x43, 0x30, 0x41, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode0[]
        = { 0x45, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x23, 0x2e,
            0x23, 0x23, 0x30, 0x3b, 0x28, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e,
            0x43, 0x59, 0x5d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x29, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x23, 0x2e, 0x23, 0x23,
            0x30, 0x2c, 0x30, 0x30, 0x3b, 0x28, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43,
            0x59, 0x5d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x29, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x23, 0x2e, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x28, 0x5b, 0x43, 0x55, 0x52,
            0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x29, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x23, 0x2e,
            ...
            0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x29, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x23, 0x2e,
            ...
            0x28, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x23,
            0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x29, 0x0 };
    ...
    static const sal_Unicode FormatCode17[] = { 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d,
            0x4d, 0x4d, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode19[]
        = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode20[]
        = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d,
            0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20,
            0x22, 0x64, 0x65, 0x22, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode23[]
        = { 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x2e, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d,
            0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode25[]
        = { 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d,
            0x4d, 0x4d, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d,
            0x4d, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode31[]
        = { 0x41, 0x41, 0x2d, 0x4d, 0x4d, 0x2d, 0x44, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode32[]
        = { 0x41, 0x41, 0x41, 0x41, 0x2d, 0x4d, 0x4d, 0x2d, 0x44, 0x44, 0x0 };
    ...
    static const sal_Unicode FormatCode33[] = { 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode36[] = { 0x51, 0x51, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode45[] = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode47[]
        = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41,
            0x41, 0x20, 0x48, 0x48, 0x3a, 0x4d, 0x4d, 0x0 };
    ...
    getAllFormats0_es_AR(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_es_AR(sal_Int16& count)
    {
    ...
    static const sal_Unicode eraRefName0[] = { 0x65, 0x73, 0x5f, 0x45, 0x53, 0x5f, 0x67, 0x72,
                                               0x65, 0x67, 0x6f, 0x72, 0x69, 0x61, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_es_AR(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x41, 0x52, 0x53, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x24, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x41, 0x52, 0x53, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x50, 0x65, 0x73, 0x6f, 0x20, 0x41, 0x72, 0x67,
                                                 0x65, 0x6e, 0x74, 0x69, 0x6e, 0x6f, 0x0 };
    ...
    getContinuousNumberingLevels_es_AR(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_es_AR(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
