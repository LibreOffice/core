...
extern "C"
{
    static const sal_Unicode langID[] = { 0x70, 0x6c, 0x74, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4d, 0x61, 0x6c, 0x61, 0x67, 0x61, 0x73, 0x79, 0x2c,
            0x20, 0x50, 0x6c, 0x61, 0x74, 0x65, 0x61, 0x75, 0x0 };
    static const sal_Unicode countryID[] = { 0x4d, 0x47, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4d, 0x61, 0x64, 0x61, 0x67, 0x61, 0x73, 0x63, 0x61, 0x72, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_plt_MG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_plt_MG(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x41, 0x72, 0x2e, 0x2d, 0x36, 0x34, 0x46, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45,
            0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x2d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30,
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x43, 0x55, 0x52, 0x52,
            0x45, 0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x2d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c,
            0x30, 0x30, 0x20, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43,
            0x59, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x20, 0x23, 0x2e, 0x23, 0x23,
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x43, 0x55,
            ...
            0x5d, 0x2d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20,
            0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode15[]
        = { 0x43, 0x43, 0x43, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x20, 0x5b, 0x43, 0x55,
            0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x2d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x20,
            0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x0 };
    ...
    getAllFormats0_plt_MG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_plt_MG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_plt_MG(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_plt_MG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_plt_MG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_plt_MG(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_plt_MG(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_plt_MG(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x41, 0x6c, 0x61, 0x68, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x41, 0x6c, 0x61, 0x68, 0x61, 0x64, 0x79, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x41, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x41, 0x6c, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x41, 0x6c, 0x61, 0x74, 0x73, 0x69, 0x6e, 0x61, 0x69, 0x6e, 0x79, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x41, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x54, 0x61, 0x6c, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x54, 0x61, 0x6c, 0x61, 0x74, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x54, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x41, 0x6c, 0x61, 0x72, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x41, 0x6c, 0x61, 0x72, 0x6f, 0x62, 0x69, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x41, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x41, 0x6c, 0x61, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x41, 0x6c, 0x61, 0x6b, 0x61, 0x6d, 0x69, 0x73, 0x79, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x41, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x5a, 0x6f, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x5a, 0x6f, 0x6d, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x5a, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x41, 0x73, 0x61, 0x62, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x41, 0x73, 0x61, 0x62, 0x6f, 0x74, 0x73, 0x79, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x41, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x6f, 0x61, 0x72, 0x79, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0x6f, 0x61, 0x72, 0x79, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x72, 0x73, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x70, 0x72, 0x69, 0x6c, 0x79, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x4a, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x4a, 0x6f, 0x6e, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x4a, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x4a, 0x6f, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x4a, 0x6f, 0x6c, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x4a, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x41, 0x6f, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x41, 0x6f, 0x67, 0x6f, 0x73, 0x74, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x53, 0x65, 0x70, 0x74, 0x61, 0x6d, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x4f, 0x6b, 0x74, 0x6f, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x4e, 0x6f, 0x76, 0x61, 0x6d, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x44, 0x65, 0x73, 0x61, 0x6d, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x41, 0x70, 0x72, 0x69, 0x6c, 0x79, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x4a, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x4a, 0x6f, 0x6e, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x4a, 0x6f, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x4a, 0x6f, 0x6c, 0x61, 0x79, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x41, 0x6f, 0x67, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x4a, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x4a, 0x6f, 0x6e, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x4a, 0x6f, 0x6c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x41, 0x6f, 0x67, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_plt_MG(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x4d, 0x47, 0x41, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x41, 0x72, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x4d, 0x47, 0x41, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x41, 0x72, 0x69, 0x61, 0x72, 0x79, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_plt_MG(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_plt_MG(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x4d, 0x61, 0x72, 0x69, 0x6e, 0x61, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x44, 0x69, 0x73, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x51, 0x75, 0x61, 0x72, 0x74, 0x65, 0x72, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x51, 0x75, 0x61, 0x72, 0x74, 0x65, 0x72, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x51, 0x75, 0x61, 0x72, 0x74, 0x65, 0x72, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x51, 0x75, 0x61, 0x72, 0x74, 0x65, 0x72, 0x20, 0x34, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x41, 0x6d, 0x62, 0x6f, 0x6e, 0x79, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x41, 0x6d, 0x62, 0x61, 0x6e, 0x79, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_plt_MG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_plt_MG(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_plt_MG(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_plt_MG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_plt_MG(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
