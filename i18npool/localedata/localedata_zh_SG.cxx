...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x53, 0x47, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x53, 0x69, 0x6e, 0x67, 0x61, 0x70, 0x6f, 0x72, 0x65, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_zh_SG(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCInfoArray);
        return (sal_Unicode**)LCInfoArray;
    }
    extern sal_Unicode** SAL_CALL getLocaleItem_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_zh_SG(sal_Int16& count)
    {
        return getLocaleItem_zh_CN(count);
    }
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31, 0x30, 0x30, 0x34, 0x5d, 0x23,
            0x2c, 0x23, 0x23, 0x30, 0x3b, 0x2d, 0x5b, 0x24, 0x53, 0x24, 0x2d,
            0x31, 0x30, 0x30, 0x34, 0x5d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31, 0x30, 0x30, 0x34, 0x5d, 0x23, 0x2c, 0x23,
            0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x2d, 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31,
            0x30, 0x30, 0x34, 0x5d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31, 0x30, 0x30, 0x34, 0x5d, 0x23, 0x2c, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x53, 0x24,
            0x2d, 0x31, 0x30, 0x30, 0x34, 0x5d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31, 0x30, 0x30, 0x34, 0x5d, 0x23,
            ...
            0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31, 0x30, 0x30,
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31, 0x30, 0x30, 0x34, 0x5d, 0x23,
            ...
            0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x53, 0x24, 0x2d, 0x31, 0x30, 0x30,
            0x34, 0x5d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x59, 0x59,   0x22, 0x5e74, 0x22, 0x4d,   0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x59, 0x59, 0x59,   0x59, 0x22, 0x5e74, 0x22,   0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode29[]
        = { 0x59, 0x59, 0x59, 0x59,   0x22,   0x5e74, 0xff0c, 0x22, 0x4d, 0x22, 0x6708, 0xff0c,
            0x22, 0x44, 0x22, 0x65e5, 0xff0c, 0x22,   0x4e,   0x4e, 0x4e, 0x4e, 0x0 };
    ...
    static const sal_Unicode defaultFormatElement33[] = { 1 };
    ...
    static const sal_Unicode FormatCode34[]
        = { 0x4d, 0x22, 0x6708, 0xff0c, 0x22, 0x44, 0x22, 0x65e5, 0x22, 0x0 };
    ...
    static const sal_Unicode FormatCode36[] = { 0x59, 0x59, 0x22, 0x5e74, 0x22, 0x51, 0x51, 0x0 };
    ...
    static const sal_Unicode FormatCode37[] = { 0x7b2c, 0x57, 0x57, 0x5468, 0x0 };
    ...
    static const sal_Unicode FormatKey52[]
        = { 0x44, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x46, 0x6f,
            0x72, 0x6d, 0x61, 0x74, 0x73, 0x6b, 0x65, 0x79, 0x31, 0x0 };
    static const sal_Unicode defaultFormatElement52[] = { 1 };
    ...
    static const sal_Unicode FormatCode52[]
        = { 0x59, 0x59, 0x22, 0x5e74, 0x22,   0x4d, 0x22, 0x6708, 0x22, 0x44,   0x22, 0x65e5,
            0x22, 0x48, 0x48, 0x22,   0x65f6, 0x22, 0x4d, 0x4d,   0x22, 0x5206, 0x22, 0x0 };
    ...
    static const sal_Unicode FormatCode53[]
        = { 0x59, 0x59, 0x59,   0x59,   0x22, 0x5e74, 0x22, 0x4d,   0x4d,   0x22, 0x6708,
            0x22, 0x44, 0x22,   0x65e5, 0x22, 0x48,   0x48, 0x22,   0x65f6, 0x22, 0x4d,
    ...
    static const sal_Unicode FormatCode54[]
        = { 0x59,   0x59, 0x59, 0x59, 0x22, 0x5e74, 0x22, 0x4d, 0x22, 0x6708, 0x22,   0x44, 0x22,
            0x65e5, 0x22, 0x48, 0x48, 0x22, 0x65f6, 0x22, 0x4d, 0x4d, 0x22,   0x5206, 0x22, 0x0 };
    ...
    getAllFormats0_zh_SG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_zh_SG(sal_Int16& count)
    {
        count = DateAcceptancePatternsCount;
        return (sal_Unicode**)DateAcceptancePatternsArray;
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_zh_SG(sal_Int16& count)
    {
        return getCollatorImplementation_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_zh_SG(sal_Int16& count)
    {
        return getCollationOptions_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_zh_SG(sal_Int16& count)
    {
        return getSearchOptions_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_zh_SG(sal_Int16& count)
    {
        return getIndexAlgorithm_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_zh_SG(sal_Int16& count)
    {
        return getUnicodeScripts_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_zh_SG(sal_Int16& count)
    {
        return getFollowPageWords_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_zh_SG(sal_Int16& count)
    {
        return getAllCalendars_zh_CN(count);
    }
    ...
    static const sal_Unicode currencyID0[] = { 0x53, 0x47, 0x44, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x53, 0x24, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x53, 0x47, 0x44, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x53, 0x69, 0x6e, 0x67, 0x61, 0x70, 0x6f, 0x72, 0x65,
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_zh_SG(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_zh_SG(sal_Int16& count)
    {
        return getTransliterations_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getForbiddenCharacters_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_zh_SG(sal_Int16& count)
    {
        return getForbiddenCharacters_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getBreakIteratorRules_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_zh_SG(sal_Int16& count)
    {
        return getBreakIteratorRules_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getReservedWords_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_zh_SG(sal_Int16& count)
    {
        return getReservedWords_zh_CN(count);
    }
    // ---> ContinuousNumbering
    extern const sal_Unicode*** SAL_CALL getContinuousNumberingLevels_zh_CN(sal_Int16& nStyles,
                                                                            sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode*** SAL_CALL
    getContinuousNumberingLevels_zh_SG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
        return getContinuousNumberingLevels_zh_CN(nStyles, nAttributes);
    }
    // ---> OutlineNumbering
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_zh_CN(sal_Int16& nStyles,
                                                                          sal_Int16& nLevels,
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_zh_SG(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
        return getOutlineNumberingLevels_zh_CN(nStyles, nLevels, nAttributes);
    }
} // extern "C"
