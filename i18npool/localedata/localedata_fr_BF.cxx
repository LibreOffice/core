...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_fr_BF(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_fr_BF(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x46, 0x2d, 0x38, 0x30, 0x30, 0x43, 0x5d, 0x0 };
    ...
    getAllFormats0_fr_BF(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_fr_BF(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_fr_BF(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_fr_BF(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_fr_BF(sal_Int16& count)
    {
    ...
    static const sal_Unicode unicodeScript2[] = { 0x36, 0x0 };
    static const sal_Unicode followPageWord0[] = { 0x73, 0x71, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x73, 0x71, 0x71, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_fr_BF(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_fr_BF(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_fr_BF(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x6a, 0x65, 0x75, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x73, 0x61, 0x6d, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x66, 0xe9, 0x76, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x6f, 0xfb, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x64, 0xe9, 0x63, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x66, 0xe9, 0x76, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x61, 0x6f, 0xfb, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x64, 0xe9, 0x63, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x66, 0xe9, 0x76, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x61, 0x6f, 0xfb, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x64, 0xe9, 0x63, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x61, 0x76, 0x61, 0x6e, 0x74, 0x20, 0x4a, 0xe9, 0x73, 0x75,
    ...
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x61, 0x70, 0x72, 0xe8, 0x73, 0x20, 0x20, 0x4a, 0xe9, 0x73,
            0x75, 0x73, 0x2d, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_fr_BF(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[]
        = { 0x46, 0x72, 0x61, 0x6e, 0x63, 0x20, 0x43, 0x46, 0x41,
            0x20, 0x2d, 0x20, 0x42, 0x43, 0x45, 0x41, 0x4f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_fr_BF(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_fr_BF(sal_Int16& count)
    {
    ...
    static const sal_Unicode ReservedWord6[]
        = { 0x73, 0x75, 0x70, 0xe9, 0x72, 0x69, 0x65, 0x75, 0x72, 0x0 };
    static const sal_Unicode ReservedWord7[]
        = { 0x69, 0x6e, 0x66, 0xe9, 0x72, 0x69, 0x65, 0x75, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_fr_BF(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_fr_BF(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_fr_BF(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_fr_BF(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_fr_BF(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
