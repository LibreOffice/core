...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6d, 0x6c, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4d, 0x61, 0x6c, 0x61, 0x79, 0x61, 0x6c, 0x61, 0x6d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ml_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ml_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20b9, 0x2d, 0x34, 0x34, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode17[] = { 0x44, 0x2d, 0x4d, 0x2d, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode45[] = { 0x4d, 0x4d, 0x2d, 0x44, 0x44, 0x2d, 0x59, 0x59,
    ...
    getAllFormats0_ml_IN(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ml_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ml_IN(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ml_IN(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ml_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0xd02, 0xd03, 0xd05, 0xd06, 0xd07, 0xd08, 0xd09, 0xd0a, 0xd0b, 0xd0c, 0xd0e, 0xd0f,
            0xd10, 0xd12, 0xd13, 0xd14, 0xd15, 0xd16, 0xd17, 0xd18, 0xd19, 0xd1a, 0xd1b, 0xd1c,
            0xd1d, 0xd1e, 0xd1f, 0xd20, 0xd21, 0xd22, 0xd23, 0xd24, 0xd25, 0xd26, 0xd27, 0xd28,
            0xd2a, 0xd2b, 0xd2c, 0xd2d, 0xd2e, 0xd2f, 0xd30, 0xd31, 0xd32, 0xd33, 0xd34, 0xd35,
            0xd36, 0xd37, 0xd38, 0xd39, 0xd3e, 0xd3f, 0xd40, 0xd41, 0xd42, 0xd43, 0xd46, 0xd47,
            0xd48, 0xd4a, 0xd4b, 0xd4c, 0xd4d, 0xd57, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ml_IN(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ml_IN(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ml_IN(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[]
        = { 0xd1e, 0xd3e, 0xd2f, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0xd1e, 0xd3e, 0xd2f, 0xd31, 0xd3e, 0xd34, 0xd4d, 0xd1a, 0xd4d, 0xd1a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0xd1e, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[]
        = { 0xd24, 0xd3f, 0xd19, 0xd4d, 0xd15, 0xd33, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode dayDefaultFullName01[] = { 0xd24, 0xd3f, 0xd19, 0xd4d, 0xd15,
                                                        0xd33, 0xd3e, 0xd34, 0xd4d, 0xd1a,
                                                        0xd4d, 0xd1a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0xd24, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0xd1a, 0xd4a, 0xd35, 0xd4d, 0xd35, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0xd1a, 0xd4a, 0xd35, 0xd4d, 0xd35, 0xd3e, 0xd34, 0xd4d, 0xd1a, 0xd4d, 0xd1a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0xd1a, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[]
        = { 0xd2c, 0xd41, 0xd27, 0xd28, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0xd2c, 0xd41, 0xd27, 0xd28, 0xd3e, 0xd34, 0xd4d, 0xd1a, 0xd4d, 0xd1a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0xd2c, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[]
        = { 0xd35, 0xd4d, 0xd2f, 0xd3e, 0xd34, 0xd02, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0xd35, 0xd4d, 0xd2f, 0xd3e, 0xd34, 0xd3e, 0xd34, 0xd4d, 0xd1a, 0xd4d, 0xd1a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0xd35, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[]
        = { 0xd35, 0xd46, 0xd33, 0xd4d, 0xd33, 0xd3f, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0xd35, 0xd46, 0xd33, 0xd4d, 0xd33, 0xd3f, 0xd2f,
            0xd3e, 0xd34, 0xd4d, 0xd1a, 0xd4d, 0xd1a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0xd35, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0xd36, 0xd28, 0xd3f, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0xd36, 0xd28, 0xd3f, 0xd2f, 0xd3e, 0xd34, 0xd4d, 0xd1a, 0xd4d, 0xd1a, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0xd36, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0xd1c, 0xd28, 0xd41, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0xd1c, 0xd28, 0xd41, 0xd35, 0xd30, 0xd3f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0xd1c, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[]
        = { 0xd2b, 0xd46, 0xd2c, 0xd4d, 0xd30, 0xd41, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0xd2b, 0xd46, 0xd2c, 0xd4d, 0xd30, 0xd41, 0xd35, 0xd30, 0xd3f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0xd2b, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[]
        = { 0xd2e, 0xd3e, 0xd30, 0xd4d, 0x200d, 0xd1a, 0xd4d, 0xd1a, 0xd4d, 0x0 };
    static const sal_Unicode monthDefaultFullName02[]
        = { 0xd2e, 0xd3e, 0xd30, 0xd4d, 0x200d, 0xd1a, 0xd4d, 0xd1a, 0xd4d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0xd2e, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[]
        = { 0xd0f, 0xd2a, 0xd4d, 0xd30, 0xd3f, 0xd32, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultFullName03[]
        = { 0xd0f, 0xd2a, 0xd4d, 0xd30, 0xd3f, 0xd32, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0xd0f, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0xd2e, 0xd46, 0xd2f, 0xd4d, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0xd2e, 0xd46, 0xd2f, 0xd4d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0xd2e, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[]
        = { 0xd1c, 0xd42, 0xd23, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0xd1c, 0xd42, 0xd23, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0xd1c, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0xd1c, 0xd42, 0xd32, 0xd48, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0xd1c, 0xd42, 0xd32, 0xd48, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0xd1c, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[]
        = { 0xd06, 0xd17, 0xd38, 0xd4d, 0xd31, 0xd4d, 0xd31, 0xd4d, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0xd06, 0xd17, 0xd38, 0xd4d, 0xd31, 0xd4d, 0xd31, 0xd4d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0xd06, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[]
        = { 0xd38, 0xd46, 0xd2a, 0xd4d, 0xd31, 0xd4d, 0xd31, 0xd02, 0x0 };
    static const sal_Unicode monthDefaultFullName08[] = { 0xd38, 0xd46,  0xd2a, 0xd4d, 0xd31,
                                                          0xd4d, 0xd31,  0xd02, 0xd2c, 0xd30,
                                                          0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0xd38, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0xd12, 0xd15, 0xd4d, 0xd1f, 0xd4b, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0xd12, 0xd15, 0xd4d, 0xd1f, 0xd4b, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0xd12, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0xd28, 0xd35, 0xd02, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0xd28, 0xd35, 0xd02, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0xd28, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0xd21, 0xd3f, 0xd38, 0xd02, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0xd21, 0xd3f, 0xd38, 0xd02, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0xd21, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0xd1c, 0xd28, 0xd41, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0xd1c, 0xd28, 0xd41, 0xd35, 0xd30, 0xd3f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0xd1c, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0xd2b, 0xd46, 0xd2c, 0xd4d, 0xd30, 0xd41, 0xd35, 0xd30, 0xd3f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0xd2b, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0xd2e, 0xd3e, 0xd30, 0xd4d, 0x200d, 0xd1a, 0xd4d, 0xd1a, 0xd4d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0xd2e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0xd0f, 0xd2a, 0xd4d, 0xd30, 0xd3f, 0xd32, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0xd0f, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[]
        = { 0xd2e, 0xd46, 0xd2f, 0xd4d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0xd2e, 0xd46, 0xd2f, 0xd4d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0xd2e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0xd1c, 0xd42, 0xd23, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0xd1c, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[]
        = { 0xd1c, 0xd42, 0xd32, 0xd48, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0xd1c, 0xd42, 0xd32, 0xd48, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0xd1c, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0xd06, 0xd17, 0xd38, 0xd4d, 0xd31, 0xd4d, 0xd31, 0xd4d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0xd06, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName08[] = {
        0xd38, 0xd46, 0xd2a, 0xd4d, 0xd31, 0xd4d, 0xd31, 0xd02, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0
    };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0xd38, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[]
        = { 0xd12, 0xd15, 0xd4d, 0xd1f, 0xd4b, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0xd12, 0xd15, 0xd4d, 0xd1f, 0xd4b, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0xd12, 0x0 };
    static const sal_Unicode genitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0xd28, 0xd35, 0xd02, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0xd28, 0xd35, 0xd02, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0xd28, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[]
        = { 0xd21, 0xd3f, 0xd38, 0xd02, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0xd21, 0xd3f, 0xd38, 0xd02, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0xd21, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0xd1c, 0xd28, 0xd41, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0xd1c, 0xd28, 0xd41, 0xd35, 0xd30, 0xd3f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0xd1c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0xd2b, 0xd46, 0xd2c, 0xd4d, 0xd30, 0xd41, 0xd35, 0xd30, 0xd3f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0xd2b, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0xd2e, 0xd3e, 0xd30, 0xd4d, 0x200d, 0xd1a, 0xd4d, 0xd1a, 0xd4d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0xd2e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0xd0f, 0xd2a, 0xd4d, 0xd30, 0xd3f, 0xd32, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0xd0f, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[]
        = { 0xd2e, 0xd46, 0xd2f, 0xd4d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0xd2e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0xd1c, 0xd42, 0xd23, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0xd1c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0xd1c, 0xd42, 0xd32, 0xd48, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0xd1c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0xd06, 0xd17, 0xd38, 0xd4d, 0xd31, 0xd4d, 0xd31, 0xd4d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0xd06, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0xd38, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0xd12, 0xd15, 0xd4d, 0xd1f, 0xd4b, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0xd12, 0x0 };
    static const sal_Unicode partitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0xd28, 0xd35, 0xd02, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0xd28, 0xd35, 0xd02, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0xd28, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0xd21, 0xd3f, 0xd38, 0xd02, 0xd2c, 0xd30, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0xd21, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0xd15, 0xd4d, 0xd30, 0xd3f, 0x2e, 0x20, 0xd2e, 0xd41, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0xd15, 0xd4d, 0xd30, 0xd3f, 0xd38, 0xd4d, 0xd24, 0xd41, 0xd35, 0xd3f,
            0xd28, 0xd41, 0x20,  0xd2e, 0xd41, 0xd28, 0xd4d, 0xd2a, 0xd4d, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[]
        = { 0xd15, 0xd4d, 0xd30, 0xd3f, 0x2e, 0xd35, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0xd15, 0xd4d, 0xd30, 0xd3f,  0xd38, 0xd4d, 0xd24, 0xd41,
            0xd35, 0xd30, 0xd4d, 0x200d, 0xd37, 0xd02, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ml_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencySymbol1[] = { 0xd15, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ml_IN(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ml_IN(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0xd05, 0xd24, 0xd46, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0xd05, 0xd32, 0xd4d, 0xd32, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0xd06, 0xd26,  0xd4d, 0xd2f, 0x20,  0xd15, 0xd3e,  0xd32,
            0xd4d, 0x200d, 0xd2d, 0xd3e, 0xd17, 0xd02, 0x200d, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0xd30, 0xd23, 0xd4d,  0xd1f, 0xd3e, 0xd02, 0x20,  0xd15,  0xd3e,
            0xd32, 0xd4d, 0x200d, 0xd2d, 0xd3e, 0xd17, 0xd02, 0x200d, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0xd2e, 0xd42, 0xd28,  0xd4d, 0xd28, 0xd3e, 0xd02, 0x20,   0xd15, 0xd3e,
            0xd32, 0xd4d, 0x200d, 0xd2d, 0xd3e, 0xd17, 0xd02, 0x200d, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0xd28, 0xd3e,  0xd32, 0xd3e, 0xd02, 0x20,  0xd15,  0xd3e, 0xd32,
            0xd4d, 0x200d, 0xd2d, 0xd3e, 0xd17, 0xd02, 0x200d, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0xd2e, 0xd41, 0xd15, 0xd33, 0xd3f, 0xd32, 0xd4d, 0x200d, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0xd24, 0xd3e, 0xd34, 0xd46, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ml_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ml_IN(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ml_IN(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ml_IN(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ml_IN(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
