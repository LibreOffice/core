...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x41, 0x54, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x41, 0x75, 0x73, 0x74, 0x72, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_de_AT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_de_AT(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43, 0x30, 0x37, 0x5d, 0x20, 0x23,
            0x2e, 0x23, 0x23, 0x30, 0x3b, 0x2d, 0x5b, 0x24, 0xf6, 0x53, 0x2d,
            0x43, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            0x23, 0x30, 0x2c, 0x30, 0x30, 0x3b, 0x2d, 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43,
            0x30, 0x37, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x4f, 0x54, 0x5d, 0x2d, 0x5b, 0x24, 0xf6, 0x53,
            0x2d, 0x43, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43, 0x30, 0x37, 0x5d, 0x20, 0x23,
            0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x3b, 0x5b, 0x52, 0x4f,
            0x54, 0x5d, 0x2d, 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43, 0x30, 0x37,
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43, 0x30, 0x37, 0x5d, 0x20, 0x23,
            0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x3b, 0x5b, 0x52, 0x4f,
            0x54, 0x5d, 0x2d, 0x5b, 0x24, 0xf6, 0x53, 0x2d, 0x43, 0x30, 0x37,
    ...
    getAllFormats0_de_AT(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_de_AT(sal_Int16& count)
    {
    ...
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x4a, 0xe4, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x4a, 0xe4, 0x6e, 0x6e, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x4d, 0xe4, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x4a, 0xe4, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x4a, 0xe4, 0x6e, 0x6e, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x4d, 0xe4, 0x72, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x4a, 0xe4, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x4d, 0xe4, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_de_AT(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID1[] = { 0x41, 0x54, 0x53, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0xf6, 0x53, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x41, 0x54, 0x53, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0xd6, 0x73, 0x74, 0x65, 0x72, 0x72, 0x65, 0x69, 0x63, 0x68, 0x69, 0x73, 0x63, 0x68,
            0x65, 0x72, 0x20, 0x53, 0x63, 0x68, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x0 };
    ...
    getContinuousNumberingLevels_de_AT(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_de_AT(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
