...
extern "C"
{
    static const sal_Unicode langID[] = { 0x77, 0x61, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x57, 0x61, 0x6c, 0x6c, 0x6f, 0x6f, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_wa_BE(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateDaySeparator[] = { 0x20, 0x64, 0x69, 0x20, 0x0 };
    static const sal_Unicode LongDateMonthSeparator[] = { 0x20, 0x0 };
    static const sal_Unicode LongDateYearSeparator[] = { 0x20, 0x0 };
    static const sal_Unicode quotationStart[] = { 0xab, 0x0 };
    static const sal_Unicode quotationEnd[] = { 0xbb, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_wa_BE(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x46, 0x42, 0x2d, 0x36, 0x33, 0x33, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x5b, 0x43, 0x55,
            0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x44, 0x20, 0x22, 0x64, 0x69, 0x22,
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x44, 0x20, 0x22, 0x64, 0x69, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode22[] = { 0x44, 0x20, 0x22, 0x64, 0x69, 0x22, 0x20, 0x4d,
    ...
    static const sal_Unicode FormatCode23[] = { 0x44, 0x20, 0x22, 0x64, 0x69, 0x22, 0x20, 0x4d,
                                                0x4d, 0x4d, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x44, 0x20, 0x22, 0x64, 0x69, 0x22, 0x20, 0x4d, 0x4d,
            0x4d, 0x4d, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x44, 0x20, 0x22, 0x64, 0x69,
            0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x20, 0x22, 0x64, 0x69, 0x22,
            0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x20, 0x22, 0x64, 0x69, 0x22, 0x20,
    ...
    static const sal_Unicode FormatCode29[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x20, 0x22, 0x64, 0x69, 0x22, 0x20,
            0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_wa_BE(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_wa_BE(sal_Int16& count)
    {
        count = DateAcceptancePatternsCount;
        return (sal_Unicode**)DateAcceptancePatternsArray;
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_fr_BE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_wa_BE(sal_Int16& count)
    {
        return getCollatorImplementation_fr_BE(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_fr_BE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_wa_BE(sal_Int16& count)
    {
        return getCollationOptions_fr_BE(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_fr_BE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_wa_BE(sal_Int16& count)
    {
        return getSearchOptions_fr_BE(count);
    }
    ...
    static const sal_Unicode followPageWord0[] = { 0x73, 0x68, 0x75, 0x76, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x73, 0x68, 0x75, 0x76, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_wa_BE(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_wa_BE(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_wa_BE(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x64, 0x69, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x64, 0x69, 0x6d, 0x65, 0x67, 0x6e, 0x65, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x64, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x6c, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[] = { 0x6c, 0x6f, 0x6e, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x6c, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x6d, 0xe5, 0x72, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x6d, 0xe5, 0x72, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x6d, 0x69, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x6d, 0x69, 0x65, 0x72, 0x6b, 0x69, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x64, 0x6a, 0x75, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x64, 0x6a, 0x75, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x64, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x76, 0xe9, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x76, 0xe9, 0x6e, 0x72, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x76, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x73, 0x65, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName06[] = { 0x73, 0x65, 0x6d, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x73, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x64, 0x6a, 0x61, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x64, 0x6a, 0x61, 0x6e, 0x76, 0xee, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x64, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x66, 0x65, 0x76, 0x0 };
    static const sal_Unicode monthDefaultFullName01[] = { 0x66, 0x65, 0x76, 0x72, 0xee, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x66, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x6d, 0xe5, 0x73, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0xe5, 0x73, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x61, 0x76, 0x72, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x61, 0x76, 0x72, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x61, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x64, 0x6a, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x64, 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x64, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x64, 0x6a, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x64, 0x6a, 0x75, 0x6c, 0x65, 0x74, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x64, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x77, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x61, 0x77, 0x6f, 0x75, 0x73, 0x73, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x74, 0x69, 0x6d, 0x62, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x73, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName09[] = { 0x6f, 0x63, 0x74, 0xf4, 0x62, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x6f, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x6e, 0xf4, 0x76, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x6e, 0xf4, 0x76, 0x69, 0x6d, 0x62, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x63, 0x69, 0x6d, 0x62, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x64, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x64, 0x6a, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x64, 0x6a, 0x61, 0x6e, 0x76, 0xee, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x64, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x6d, 0xe5, 0x73, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[] = { 0x6d, 0xe5, 0x73, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x61, 0x76, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[] = { 0x61, 0x76, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x79, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x64, 0x6a, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x64, 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x64, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x64, 0x6a, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x64, 0x6a, 0x75, 0x6c, 0x65, 0x74, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x64, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x61, 0x77, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x6f, 0x63, 0x74, 0xf4, 0x62, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x6e, 0xf4, 0x76, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x64, 0x6a, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x64, 0x6a, 0x61, 0x6e, 0x76, 0xee, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x64, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x6d, 0xe5, 0x73, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[] = { 0x6d, 0xe5, 0x73, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x61, 0x76, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[] = { 0x61, 0x76, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x79, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x64, 0x6a, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x64, 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x64, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x64, 0x6a, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0x64, 0x6a, 0x75, 0x6c, 0x65, 0x74, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x64, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x61, 0x77, 0x6f, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x6f, 0x63, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x6e, 0xf4, 0x76, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x64, 0x69, 0x76, 0x2e, 0x20, 0x4a, 0x43, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x64, 0x69, 0x76, 0x61, 0x6e, 0x74, 0x20, 0x6e,
            0x6f, 0x73, 0x74, 0x20, 0x65, 0x72, 0x65, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[]
        = { 0x61, 0x70, 0x72, 0x2e, 0x20, 0x4a, 0x43, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x61, 0x70, 0x72, 0xe8, 0x73,
                                                        0x20, 0x6e, 0x6f, 0x73, 0x74,
                                                        0x20, 0x65, 0x72, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_wa_BE(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0x75, 0x72, 0x6f, 0x0 };
    ...
    static const sal_Unicode currencySymbol1[] = { 0x46, 0x42, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x42, 0x45, 0x46, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0x66, 0x72, 0x61, 0x6e, 0x63, 0x20, 0x62, 0x65, 0x64, 0x6a, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_wa_BE(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_fr_BE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_wa_BE(sal_Int16& count)
    {
        return getTransliterations_fr_BE(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x76, 0x72, 0x61, 0x69, 0x79, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0xe5, 0x73, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0xee, 0x20, 0x74, 0x72, 0x6f, 0x65, 0x73, 0x2d, 0x6d, 0x6f, 0x65, 0x73, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x69, 0x6e, 0x6d, 0x65, 0x20, 0x74, 0x72, 0x6f,
            0x65, 0x73, 0x2d, 0x6d, 0x6f, 0x65, 0x73, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x69, 0x6e, 0x6d, 0x65, 0x20, 0x74, 0x72, 0x6f,
            0x65, 0x73, 0x2d, 0x6d, 0x6f, 0x65, 0x73, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x69, 0x6e, 0x6d, 0x65, 0x20, 0x74, 0x72, 0x6f,
            0x65, 0x73, 0x2d, 0x6d, 0x6f, 0x65, 0x73, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x64, 0x69, 0x7a, 0x65, 0x75, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x64, 0x69, 0x7a, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_wa_BE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_wa_BE(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_wa_BE(sal_Int16& count)
    {
        count = 5;
        return (sal_Unicode**)LCBreakIteratorRulesArray;
    }
    // ---> ContinuousNumbering
    extern const sal_Unicode*** SAL_CALL getContinuousNumberingLevels_fr_BE(sal_Int16& nStyles,
                                                                            sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode*** SAL_CALL
    getContinuousNumberingLevels_wa_BE(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
        return getContinuousNumberingLevels_fr_BE(nStyles, nAttributes);
    }
    // ---> OutlineNumbering
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_fr_BE(sal_Int16& nStyles,
                                                                          sal_Int16& nLevels,
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_wa_BE(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
        return getOutlineNumberingLevels_fr_BE(nStyles, nLevels, nAttributes);
    }
} // extern "C"
