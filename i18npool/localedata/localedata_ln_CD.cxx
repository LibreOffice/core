...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x6e, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4c, 0x69, 0x6e, 0x67, 0x61, 0x6c, 0x61, 0x0 };
    static const sal_Unicode countryID[] = { 0x43, 0x44, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x44, 0x65, 0x6d, 0x6f, 0x63, 0x72, 0x61, 0x74, 0x69, 0x63, 0x20,
            0x52, 0x65, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x20, 0x6f, 0x66,
            0x20, 0x74, 0x68, 0x65, 0x20, 0x43, 0x6f, 0x6e, 0x67, 0x6f, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ln_CD(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ln_CD(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x46, 0x43, 0x2d, 0x36, 0x33, 0x39, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            0xa0, 0x23, 0x23, 0x30, 0x3b, 0x2d, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45,
    ...
    static const sal_Unicode FormatCode15[]
        = { 0x43, 0x43, 0x43, 0x20, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    getAllFormats0_ln_CD(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ln_CD(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ln_CD(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ln_CD(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ln_CD(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[] = { 0x41, 0x2d, 0x45,  0x20, 0x190, 0x20, 0x46, 0x2d,
                                             0x4f, 0x20, 0x186, 0x20, 0x50,  0x2d, 0x5a, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x6c, 0x6f, 0x6b, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x6e, 0x6b, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ln_CD(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ln_CD(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ln_CD(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x65, 0x79, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x65, 0x79, 0x65, 0x6e, 0x67, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x65, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x6d, 0x31, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x6d, 0x6f, 0x6b, 0x254, 0x6c, 0x254, 0x20, 0x79,  0x61,
            0x20, 0x6c, 0x69, 0x62,  0x6f, 0x73,  0x6f, 0x301, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x6d, 0x32, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x6d, 0x6f, 0x6b, 0x254, 0x6c, 0x254, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x62,  0x61, 0x6c,  0xe9, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x6d, 0x33, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x6d, 0x6f, 0x6b, 0x254, 0x6c, 0x254, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x73,  0xe1, 0x74,  0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x6d, 0x34, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x6d, 0x6f, 0x6b, 0x254, 0x6c, 0x254, 0x20, 0x79,
            0x61, 0x20, 0x6d, 0xed,  0x6e, 0x65,  0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x6d, 0x35, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x6d, 0x6f, 0x6b, 0x254, 0x6c, 0x254, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x74,  0xe1, 0x6e,  0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x6d, 0x70, 0x73, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x6d, 0x70, 0x254, 0x301, 0x73, 0x254, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x73, 0x31, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                          0x20, 0x79, 0x61, 0x20, 0x79,
                                                          0x61, 0x6d, 0x62, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x73, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x73, 0x32, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x62, 0x61, 0x6c, 0xe9, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x73, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x73, 0x33, 0x0 };
    static const sal_Unicode monthDefaultFullName02[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x73, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x73, 0x34, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                          0x20, 0x79, 0x61, 0x20, 0x6d,
                                                          0xed, 0x6e, 0xe9, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x73, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x73, 0x35, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x73, 0x36, 0x0 };
    static const sal_Unicode monthDefaultFullName05[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0x6f, 0x74, 0xf3, 0x62, 0xe1, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x73, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x73, 0x37, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6e, 0x73, 0x61, 0x6d, 0x62, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x73, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x73, 0x38, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0x77, 0x61, 0x6d, 0x62, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x73, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x73, 0x39, 0x0 };
    static const sal_Unicode monthDefaultFullName08[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                          0x20, 0x79, 0x61, 0x20, 0x6c,
                                                          0x69, 0x62, 0x77, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x73, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x73, 0x31, 0x30, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61, 0x20, 0x7a, 0xf3, 0x6d, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x73, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x73, 0x31, 0x31, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79,  0x61,  0x20, 0x7a,  0xf3,  0x6d,
            0x69, 0x20, 0x6e, 0x61, 0x20, 0x6d, 0x254, 0x30c, 0x6b, 0x254, 0x301, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x73, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x73, 0x31, 0x32, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61, 0x20, 0x7a, 0xf3, 0x6d,
            0x69, 0x20, 0x6e, 0x61, 0x20, 0x6d, 0xed, 0x62, 0x61, 0x6c, 0xe9, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x73, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x73, 0x31, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                                  0x20, 0x79, 0x61, 0x20, 0x79,
                                                                  0x61, 0x6d, 0x62, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x73, 0x32, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x62, 0x61, 0x6c, 0xe9, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x73, 0x0 };
    static const sal_Unicode genitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x73, 0x33, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74, 0x6f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0x73, 0x0 };
    static const sal_Unicode genitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x73, 0x34, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                                  0x20, 0x79, 0x61, 0x20, 0x6d,
                                                                  0xed, 0x6e, 0xe9, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0x73, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x73, 0x35, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x73, 0x36, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x73, 0x37, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x73, 0x38, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x73, 0x39, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                                  0x20, 0x79, 0x61, 0x20, 0x6c,
                                                                  0x69, 0x62, 0x77, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x73, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x73, 0x31, 0x31, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x73, 0x31, 0x32, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61, 0x20, 0x7a, 0xf3, 0x6d,
            0x69, 0x20, 0x6e, 0x61, 0x20, 0x6d, 0xed, 0x62, 0x61, 0x6c, 0xe9, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0x73, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x73, 0x31, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                                   0x20, 0x79, 0x61, 0x20, 0x79,
                                                                   0x61, 0x6d, 0x62, 0x6f, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x73, 0x32, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x62, 0x61, 0x6c, 0xe9, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x73, 0x0 };
    static const sal_Unicode partitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x73, 0x33, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61,
            0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74, 0x6f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0x73, 0x0 };
    static const sal_Unicode partitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x73, 0x34, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                                   0x20, 0x79, 0x61, 0x20, 0x6d,
                                                                   0xed, 0x6e, 0xe9, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0x73, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x73, 0x35, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x73, 0x36, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x73, 0x37, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x73, 0x38, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x73, 0x39, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[] = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1,
                                                                   0x20, 0x79, 0x61, 0x20, 0x6c,
                                                                   0x69, 0x62, 0x77, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x73, 0x31, 0x30, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x73, 0x31, 0x31, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x73, 0x31, 0x32, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x79, 0x61, 0x20, 0x7a, 0xf3, 0x6d,
            0x69, 0x20, 0x6e, 0x61, 0x20, 0x6d, 0xed, 0x62, 0x61, 0x6c, 0xe9, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0x73, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x6c, 0x69, 0x62, 0x6f, 0x73, 0xf3, 0x20, 0x79,
            0x61, 0x20, 0x59, 0x2e, 0x2d, 0x4b, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x6c, 0x69, 0x62, 0x6f, 0x73, 0xf3, 0x20, 0x79,
            0x61, 0x20, 0x59, 0x2e, 0x2d, 0x4b, 0x2e, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x6e, 0x73, 0x69, 0x6d, 0x61,
                                                         0x20, 0x79, 0x61, 0x20, 0x59,
                                                         0x2e, 0x2d, 0x4b, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x6e, 0x73, 0x69, 0x6d, 0x61,
                                                        0x20, 0x79, 0x61, 0x20, 0x59,
                                                        0x2e, 0x2d, 0x4b, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ln_CD(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x43, 0x44, 0x46, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x46, 0x43, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x43, 0x44, 0x46, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x66, 0x61, 0x6c, 0xe1, 0x6e, 0x67, 0x61, 0x20,
                                                 0x6b, 0x6f, 0x6e, 0x67, 0x6f, 0x6c, 0xe9, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ln_CD(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ln_CD(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x6d, 0x70, 0x65, 0x6e, 0x7a, 0x61, 0x301, 0x0 };
    static const sal_Unicode ReservedWord1[]
        = { 0x6d, 0x70, 0x65, 0x6e, 0x7a, 0x61, 0x301, 0x20, 0x74, 0x25b, 0x301, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74,
            0x6f, 0x20, 0x79, 0x61, 0x20, 0x79, 0x61, 0x6d, 0x62, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74, 0x6f,
            0x20, 0x79, 0x61, 0x20, 0x6d, 0xed, 0x62, 0x61, 0x6c, 0xe9, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74, 0x6f,
            0x20, 0x79, 0x61, 0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x73, 0xe1, 0x6e, 0x7a, 0xe1, 0x20, 0x6d, 0xed, 0x73, 0xe1, 0x74,
            0x6f, 0x20, 0x79, 0x61, 0x20, 0x6d, 0xed, 0x6e, 0x65, 0x69, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x6c, 0x69, 0x6b, 0x6f, 0x6c, 0xf3, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x6e, 0x73, 0xe9, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x53, 0x4d, 0x31, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x53, 0x4d, 0x32, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x53, 0x4d, 0x33, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x53, 0x4d, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ln_CD(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ln_CD(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ln_CD(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ln_CD(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ln_CD(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
