...
extern "C"
{
    static const sal_Unicode langID[] = { 0x61, 0x7a, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x41, 0x7a, 0x65, 0x72, 0x62, 0x61, 0x69, 0x6a, 0x61, 0x6e, 0x69, 0x0 };
    static const sal_Unicode countryID[] = { 0x41, 0x5a, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x41, 0x7a, 0x65, 0x72, 0x62, 0x61, 0x69, 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_az_AZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateYearSeparator[] = { 0x20, 0x69, 0x6c, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_az_AZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x5b, 0x24, 0x6d, 0x61, 0x6e, 0x2e, 0x2d,
            0x34, 0x32, 0x43, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x5b,
            0x24, 0x6d, 0x61, 0x6e, 0x2e, 0x2d, 0x34, 0x32, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x5b, 0x24, 0x6d, 0x61, 0x6e, 0x2e,
            0x2d, 0x34, 0x32, 0x43, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30,
            0x30, 0x5b, 0x24, 0x6d, 0x61, 0x6e, 0x2e, 0x2d, 0x34, 0x32, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x5b, 0x24, 0x6d, 0x61, 0x6e, 0x2e, 0x2d, 0x34, 0x32,
            0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30,
            0x5b, 0x24, 0x6d, 0x61, 0x6e, 0x2e, 0x2d, 0x34, 0x32, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x5b, 0x24, 0x6d, 0x61,
            0x6e, 0x2e, 0x2d, 0x34, 0x32, 0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x5b, 0x24,
            0x6d, 0x61, 0x6e, 0x2e, 0x2d, 0x34, 0x32, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x5b, 0x24, 0x6d, 0x61,
            0x6e, 0x2e, 0x2d, 0x34, 0x32, 0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x5b, 0x24,
            0x6d, 0x61, 0x6e, 0x2e, 0x2d, 0x34, 0x32, 0x43, 0x5d, 0x0 };
    ...
    getAllFormats0_az_AZ(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_az_AZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x42, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x62, 0x61, 0x7a, 0x61, 0x72, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x62, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x42, 0x2e, 0x65, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x62, 0x61, 0x7a, 0x61, 0x72, 0x20, 0x65, 0x72, 0x74, 0x259, 0x73, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x62, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0xc7, 0x2e, 0x61, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0xe7, 0x259, 0x72, 0x15f, 0x259, 0x6e, 0x62, 0x259,
            0x20, 0x61,  0x78, 0x15f, 0x61,  0x6d, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0xe7, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0xc7, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0xe7, 0x259, 0x72, 0x15f, 0x259, 0x6e, 0x62, 0x259, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0xe7, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x43, 0x2e, 0x61, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x63, 0xfc, 0x6d, 0x259, 0x20, 0x61, 0x78, 0x15f, 0x61, 0x6d, 0x131, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x63, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x43, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x63, 0xfc, 0x6d, 0x259, 0x20, 0x61, 0x78, 0x15f, 0x61, 0x6d, 0x131, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x63, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x15e, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName06[] = { 0x15f, 0x259, 0x6e, 0x62, 0x259, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x15f, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x79, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x69, 0x79, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x130, 0x79, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x130, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x69, 0x79, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x130, 0x79, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x130, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x76, 0x71, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x41, 0x76, 0x71, 0x75, 0x73, 0x74, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x53, 0x65, 0x6e, 0x74, 0x79, 0x61, 0x62, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x4f, 0x6b, 0x74, 0x79, 0x61, 0x62, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x79, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x69, 0x79, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x130, 0x79, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x130, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x69, 0x79, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x130, 0x79, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x130, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x61, 0x76, 0x71, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x41, 0x76, 0x71, 0x75, 0x73, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x79, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x69, 0x79, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x130, 0x79, 0x75, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x130, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x69, 0x79, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x130, 0x79, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x130, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x61, 0x76, 0x71, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x65, 0x2e, 0x259, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x65, 0x72, 0x61,  0x6d, 0x131, 0x7a,  0x64, 0x61,
            0x6e, 0x20, 0x259, 0x76, 0x76,  0x259, 0x6c, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x62, 0x2e, 0x65, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x62, 0x69, 0x7a,  0x69, 0x6d,  0x20, 0x65, 0x72,
            0x61, 0x6d, 0x131, 0x7a, 0x131, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_az_AZ(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x41, 0x5a, 0x4e, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x6d, 0x61, 0x6e, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x41, 0x5a, 0x4e, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x41, 0x5a, 0x4d, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x6d, 0x61, 0x6e, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x41, 0x5a, 0x4d, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0x4d, 0x61, 0x6e, 0x61, 0x74, 0x20, 0x28, 0x31, 0x39,
            0x39, 0x31, 0x2d, 0x32, 0x30, 0x30, 0x35, 0x29, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_az_AZ(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_az_AZ(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x64, 0xfc, 0x7a, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x79, 0x61, 0x6e, 0x6c, 0x131, 0x15f, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x2d, 0x63, 0x69, 0x20, 0x6b, 0x76, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x2d, 0x63, 0x69, 0x20, 0x6b, 0x76, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x2d, 0x63, 0xfc, 0x20, 0x6b, 0x76, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x2d, 0x63, 0xfc, 0x20, 0x6b, 0x76, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0x64, 0x61, 0x68, 0x61, 0x20, 0x79, 0x75, 0x78, 0x61, 0x72, 0x131, 0x0 };
    static const sal_Unicode ReservedWord7[]
        = { 0x64, 0x61, 0x68, 0x61, 0x20, 0x61, 0x15f, 0x61, 0x11f, 0x131, 0x0 };
    static const sal_Unicode ReservedWord8[]
        = { 0x31, 0x2d, 0x63, 0x69, 0x20, 0x6b, 0x76, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord9[]
        = { 0x32, 0x2d, 0x63, 0x69, 0x20, 0x6b, 0x76, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord10[]
        = { 0x33, 0x2d, 0x63, 0xfc, 0x20, 0x6b, 0x76, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord11[]
        = { 0x34, 0x2d, 0x63, 0xfc, 0x20, 0x6b, 0x76, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_az_AZ(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_az_AZ(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_az_AZ(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_az_AZ(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_az_AZ(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
