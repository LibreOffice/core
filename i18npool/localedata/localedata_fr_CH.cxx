...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x43, 0x48, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x53, 0x77, 0x69, 0x74, 0x7a, 0x65, 0x72, 0x6c, 0x61, 0x6e, 0x64, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_fr_CH(sal_Int16& count)
    {
    ...
    static const sal_Unicode thousandSeparator[] = { 0x27, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_fr_CH(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode3[] = { 0x23, 0x27, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode4[]
        = { 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode5[]
        = { 0x23, 0x27, 0x23, 0x23, 0x23, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43, 0x5d, 0x20, 0x23,
            0x27, 0x23, 0x23, 0x30, 0x3b, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30,
            0x30, 0x43, 0x5d, 0x20, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43, 0x5d,
            0x20, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b,
            0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43, 0x5d, 0x20,
            0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43, 0x5d, 0x20, 0x23, 0x27,
            0x23, 0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46,
            0x2d, 0x31, 0x30, 0x30, 0x43, 0x5d, 0x20, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43, 0x5d, 0x20,
            0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b, 0x52, 0x45,
            0x44, 0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43,
            0x5d, 0x20, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode15[]
        = { 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x20, 0x43, 0x43, 0x43, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43, 0x5d, 0x20,
            0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x3b, 0x5b, 0x52, 0x45,
            0x44, 0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x31, 0x30, 0x30, 0x43,
            0x5d, 0x20, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x0 };
    ...
    static const sal_Unicode FormatCode17[] = { 0x4a, 0x2e, 0x4d, 0x4d, 0x2e, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x4a, 0x4a, 0x2e, 0x20, 0x4d,
            0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode19[]
        = { 0x4a, 0x4a, 0x2e, 0x4d, 0x4d, 0x2e, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode20[]
        = { 0x4a, 0x4a, 0x2e, 0x4d, 0x4d, 0x2e, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x4a, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x4a, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x4a, 0x4a, 0x2e, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x4a, 0x2e, 0x20, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode29[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x4a, 0x2e, 0x20, 0x4d, 0x4d,
            0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode33[] = { 0x4d, 0x4d, 0x2e, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode34[] = { 0x4a, 0x4a, 0x2e, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    static const sal_Unicode FormatCode45[] = { 0x4a, 0x4a, 0x2e, 0x4d, 0x4d, 0x2e, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x4a, 0x4a, 0x2e, 0x4d, 0x4d, 0x2e, 0x41, 0x41, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode47[]
        = { 0x4a, 0x4a, 0x2e, 0x4d, 0x4d, 0x2e, 0x41, 0x41, 0x41,
    ...
    getAllFormats0_fr_CH(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    static const sal_Unicode DateAcceptancePattern2[] = { 0x44, 0x2e, 0x4d, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_fr_CH(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x43, 0x48, 0x46, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x43, 0x48, 0x46, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x43, 0x48, 0x46, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x66, 0x72, 0x61, 0x6e, 0x63, 0x20, 0x73, 0x75, 0x69, 0x73, 0x73, 0x65, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x43, 0x48, 0x46, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x73, 0x46, 0x72, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x43, 0x48, 0x46, 0x0 };
    ...
    static const sal_Unicode currencyID2[] = { 0x43, 0x48, 0x46, 0x0 };
    static const sal_Unicode currencySymbol2[] = { 0x53, 0x46, 0x72, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol2[] = { 0x43, 0x48, 0x46, 0x0 };
    ...
    getContinuousNumberingLevels_fr_CH(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_fr_CH(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
