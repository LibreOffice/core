...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x45, 0x43, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x45, 0x63, 0x75, 0x61, 0x64, 0x6f, 0x72, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_es_EC(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_es_EC(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x53, 0x2f, 0x2d, 0x33, 0x30, 0x30, 0x41, 0x5d, 0x23,
            0x2c, 0x23, 0x23, 0x30, 0x3b, 0x5b, 0x24, 0x53, 0x2f, 0x2d, 0x33,
            0x30, 0x30, 0x41, 0x5d, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x53, 0x2f, 0x2d, 0x33, 0x30, 0x30, 0x41, 0x5d, 0x23, 0x2c, 0x23,
            0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b, 0x24, 0x53, 0x2f, 0x2d, 0x33, 0x30,
            0x30, 0x41, 0x5d, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x53, 0x2f, 0x2d, 0x33, 0x30, 0x30, 0x41, 0x5d, 0x23, 0x2c, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x5b, 0x24, 0x53, 0x2f, 0x2d,
            0x33, 0x30, 0x30, 0x41, 0x5d, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x53, 0x2f, 0x2d, 0x33, 0x30, 0x30, 0x41, 0x5d, 0x23,
            ...
            0x44, 0x5d, 0x5b, 0x24, 0x53, 0x2f, 0x2d, 0x33, 0x30, 0x30, 0x41,
    ...
    getAllFormats0_es_EC(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_es_EC(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[]
        = { 0x64, 0xf3, 0x6c, 0x61, 0x72, 0x20, 0x65, 0x73, 0x74, 0x61, 0x64,
            0x6f, 0x75, 0x6e, 0x69, 0x64, 0x65, 0x6e, 0x73, 0x65, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x45, 0x43, 0x53, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x53, 0x2f, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x45, 0x43, 0x53, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0x73, 0x75, 0x63, 0x72, 0x65, 0x20, 0x65, 0x63, 0x75,
            0x61, 0x74, 0x6f, 0x72, 0x69, 0x61, 0x6e, 0x6f, 0x0 };
    ...
    getContinuousNumberingLevels_es_EC(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_es_EC(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
