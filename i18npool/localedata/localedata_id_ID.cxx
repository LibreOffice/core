...
extern "C"
{
    static const sal_Unicode langID[] = { 0x69, 0x64, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x49, 0x6e, 0x64, 0x6f, 0x6e, 0x65, 0x73, 0x69, 0x61, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_id_ID(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_id_ID(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x52, 0x70, 0x2d, 0x34, 0x32, 0x31, 0x5d, 0x0 };
    ...
    getAllFormats0_id_ID(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_id_ID(sal_Int16& count)
    {
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x4d, 0x69, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x4d, 0x69, 0x6e, 0x67, 0x67, 0x75, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x4d, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x53, 0x65, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[] = { 0x53, 0x65, 0x6e, 0x69, 0x6e, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName04[] = { 0x4b, 0x61, 0x6d, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[] = { 0x4a, 0x75, 0x6d, 0x61, 0x74, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_id_ID(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x49, 0x44, 0x52, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x52, 0x70, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x49, 0x44, 0x52, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x49, 0x44, 0x52, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_id_ID(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_id_ID(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x62, 0x65, 0x6e, 0x61, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_id_ID(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_id_ID(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_id_ID(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_id_ID(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_id_ID(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
