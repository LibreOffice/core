...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_de_CH(sal_Int16& count)
    {
    ...
    static const sal_Unicode quotationStart[] = { 0x2039, 0x0 };
    static const sal_Unicode quotationEnd[] = { 0x203a, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_de_CH(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30, 0x37, 0x5d, 0x20, 0x23,
            0x27, 0x23, 0x23, 0x30, 0x3b, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38,
            0x30, 0x37, 0x5d, 0x20, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x27, 0x23,
            0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30,
            0x37, 0x5d, 0x20, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30, 0x37, 0x5d, 0x20, 0x23, 0x27, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d,
            0x38, 0x30, 0x37, 0x5d, 0x20, 0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30, 0x37, 0x5d, 0x20, 0x23,
            0x27, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30, 0x37, 0x5d, 0x20,
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30, 0x37, 0x5d, 0x20, 0x23,
            0x27, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x5b, 0x24, 0x43, 0x48, 0x46, 0x2d, 0x38, 0x30, 0x37, 0x5d, 0x20,
            0x2d, 0x23, 0x27, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x0 };
    ...
    static const sal_Unicode FormatCode17[] = { 0x54, 0x2e, 0x4d, 0x4d, 0x2e, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x54, 0x54, 0x2e, 0x20, 0x4d,
            0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x54, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x54, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x54, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x54, 0x2e, 0x20, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode29[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x54, 0x2e, 0x20, 0x4d, 0x4d,
            0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x4a, 0x4a, 0x0 };
    ...
    getAllFormats0_de_CH(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_de_CH(sal_Int16& count)
    {
    ...
    getContinuousNumberingLevels_de_CH(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_de_CH(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
