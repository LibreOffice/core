...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x45, 0x47, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x45, 0x67, 0x79, 0x70, 0x74, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ar_EG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ar_EG(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x62c, 0x2e, 0x645, 0x2e, 0x200f, 0x2d, 0x43, 0x30, 0x31, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode3[] = { 0x23, 0x66c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode4[]
        = { 0x23, 0x66c, 0x23, 0x23, 0x30, 0x66b, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode5[]
        = { 0x23, 0x66c, 0x23, 0x23, 0x23, 0x66b, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b,  0x43, 0x55, 0x52, 0x52, 0x45,  0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            0x66c, 0x23, 0x23, 0x30, 0x3b, 0x5b,  0x43, 0x55, 0x52, 0x52, 0x45, 0x4e,
            0x43,  0x59, 0x5d, 0x20, 0x23, 0x66c, 0x23, 0x23, 0x30, 0x20, 0x2d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x43, 0x55,  0x52, 0x52,  0x45, 0x4e, 0x43, 0x59,  0x5d, 0x20, 0x23, 0x66c, 0x23,
            0x23, 0x30, 0x66b, 0x30, 0x30,  0x3b, 0x5b, 0x43, 0x55,  0x52, 0x52, 0x45, 0x4e,  0x43,
            0x59, 0x5d, 0x20,  0x23, 0x66c, 0x23, 0x23, 0x30, 0x66b, 0x30, 0x30, 0x20, 0x2d,  0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e,  0x43, 0x59, 0x5d, 0x20, 0x23, 0x66c, 0x23,
            ...
            0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x66c, 0x23, 0x23, 0x30, 0x20, 0x2d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b,  0x43,  0x55, 0x52, 0x52,  0x45,  0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            0x66c, 0x23,  0x23, 0x30, 0x66b, 0x30,  0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d,  0x5b,  0x43, 0x55, 0x52,  0x52,  0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20,
            0x23,  0x66c, 0x23, 0x23, 0x30,  0x66b, 0x30, 0x30, 0x20, 0x2d, 0x0 };
    ...
    static const sal_Unicode FormatCode15[]
        = { 0x23, 0x66c, 0x23, 0x23, 0x30, 0x66b, 0x30, 0x30, 0x20, 0x43, 0x43, 0x43, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b,  0x43,  0x55, 0x52, 0x52,  0x45,  0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            0x66c, 0x23,  0x23, 0x30, 0x66b, 0x2d,  0x2d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d,  0x5b,  0x43, 0x55, 0x52,  0x52,  0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20,
            0x23,  0x66c, 0x23, 0x23, 0x30,  0x66b, 0x2d, 0x2d, 0x20, 0x2d, 0x0 };
    ...
    getAllFormats0_ar_EG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ar_EG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ar_EG(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ar_EG(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ar_EG(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x627, 0x2d,  0x63a, 0x20,  0x641, 0x2d,  0x646, 0x20,  0x648, 0x2d,  0x64a,
            0x20,  0x679, 0x2d,  0x67b, 0x20,  0x67e, 0x2d,  0x680, 0x20,  0x683, 0x20,
            0x684, 0x20,  0x686, 0x2d,  0x688, 0x20,  0x68c, 0x2d,  0x68e, 0x20,  0x691,
            0x20,  0x698, 0x20,  0x6a4, 0x20,  0x6a6, 0x20,  0x6a9, 0x20,  0x6aa, 0x20,
            0x6ad, 0x20,  0x6af, 0x20,  0x6b1, 0x20,  0x6b3, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ar_EG(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ar_EG(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ar_EG(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ar_EG(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x45, 0x47, 0x50, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x62c, 0x2e, 0x645, 0x2e, 0x200f, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x45, 0x47, 0x50, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x45, 0x47, 0x50, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ar_EG(sal_Int16& count)
    {
        count = currencyCount;
    ...
    static const sal_Unicode Transliteration6[]
        = { 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x44, 0x69, 0x61, 0x63, 0x72,
            0x69, 0x74, 0x69, 0x63, 0x73, 0x5f, 0x43, 0x54, 0x4c, 0x0 };
    static const sal_Unicode Transliteration7[]
        = { 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x4b, 0x61, 0x73,
            0x68, 0x69, 0x64, 0x61, 0x5f, 0x43, 0x54, 0x4c, 0x0 };
    static const sal_Int16 nbOfTransliterations = 8;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ar_EG(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x635, 0x62d, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x62e, 0x637, 0x623, 0x0 };
    ...
    static const sal_Unicode ReservedWord6[] = { 0x623, 0x639, 0x644, 0x649, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x623, 0x633, 0x641, 0x644, 0x0 };
    static const sal_Unicode ReservedWord8[]
        = { 0x627, 0x644, 0x631, 0x628, 0x639, 0x20, 0x627, 0x644, 0x623, 0x648, 0x644, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x627, 0x644, 0x631, 0x628, 0x639, 0x20, 0x627,
                                                 0x644, 0x62b, 0x627, 0x646, 0x64a, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x627, 0x644, 0x631, 0x628, 0x639, 0x20, 0x627,
                                                  0x644, 0x62b, 0x627, 0x644, 0x62b, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x627, 0x644, 0x631, 0x628, 0x639, 0x20, 0x627,
                                                  0x644, 0x631, 0x627, 0x628, 0x639, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ar_EG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ar_EG(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ar_EG(sal_Int16& count)
    {
        count = 5;
    ...
    static const sal_Unicode continuousNumType2[] = { 0x33, 0x31, 0x0 };
    static const sal_Unicode continuousSuffix2[] = { 0x2d, 0x0 };
    static const sal_Unicode continuousTransliteration2[] = { 0x0 };
    static const sal_Unicode continuousNatNum2[] = { 0x0 };
    static const sal_Unicode continuousPrefix3[] = { 0x28, 0x0 };
    ...
    getContinuousNumberingLevels_ar_EG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    static const sal_Unicode outlineSuffix20[] = { 0x29, 0x0 };
    ...
    static const sal_Unicode outlineNumType23[] = { 0x34, 0x0 };
    static const sal_Unicode outlineSuffix23[] = { 0x29, 0x0 };
    ...
    static const sal_Unicode outlineNumType24[] = { 0x33, 0x31, 0x0 };
    ...
    static const sal_Unicode outlineNumType31[] = { 0x33, 0x31, 0x0 };
    ...
    static const sal_Unicode outlineParentNumbering31[] = { 0x31, 0x0 };
    ...
    static const sal_Unicode outlineParentNumbering32[] = { 0x32, 0x0 };
    ...
    static const sal_Unicode outlineNumType33[] = { 0x33, 0x31, 0x0 };
    ...
    static const sal_Unicode outlineParentNumbering33[] = { 0x33, 0x0 };
    ...
    static const sal_Unicode outlineParentNumbering34[] = { 0x34, 0x0 };
    ...
    static const sal_Unicode outlineNumType60[] = { 0x31, 0x32, 0x0 };
    ...
    static const sal_Unicode outlineNumType61[] = { 0x31, 0x32, 0x0 };
    ...
    static const sal_Unicode outlineNumType62[] = { 0x31, 0x32, 0x0 };
    ...
    static const sal_Unicode outlineNumType63[] = { 0x31, 0x32, 0x0 };
    ...
    static const sal_Unicode outlineNumType64[] = { 0x31, 0x32, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ar_EG(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
