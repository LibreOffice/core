...
extern "C"
{
    static const sal_Unicode langID[] = { 0x67, 0x61, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x49, 0x72, 0x69, 0x73, 0x68, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ga_IE(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCInfoArray);
        return (sal_Unicode**)LCInfoArray;
    }
    extern sal_Unicode** SAL_CALL getLocaleItem_en_IE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ga_IE(sal_Int16& count)
    {
        return getLocaleItem_en_IE(count);
    }
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0xa3, 0x2d, 0x38, 0x33, 0x43, 0x5d, 0x0 };
    extern sal_Unicode const* const* SAL_CALL getAllFormats0_en_IE(sal_Int16& count,
                                                                   const sal_Unicode*& from,
                                                                   const sal_Unicode*& to);
    SAL_DLLPUBLIC_EXPORT sal_Unicode const* const* SAL_CALL
    getAllFormats0_ga_IE(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
        const sal_Unicode* tmp;
        return getAllFormats0_en_IE(count, from, tmp);
    }
    extern sal_Unicode** SAL_CALL getDateAcceptancePatterns_en_IE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ga_IE(sal_Int16& count)
    {
        return getDateAcceptancePatterns_en_IE(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_en_IE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ga_IE(sal_Int16& count)
    {
        return getCollatorImplementation_en_IE(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_IE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ga_IE(sal_Int16& count)
    {
        return getCollationOptions_en_IE(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_IE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ga_IE(sal_Int16& count)
    {
        return getSearchOptions_en_IE(count);
    }
    ...
    static const sal_Unicode followPageWord0[] = { 0x6c, 0x63, 0x68, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x6c, 0x67, 0x68, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ga_IE(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ga_IE(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ga_IE(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x41, 0x69, 0x62, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x42, 0x65, 0x61, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0x42, 0x65, 0x61, 0x6c, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0x42, 0x0 };
    static const sal_Unicode genitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[]
        = { 0x4d, 0x65, 0x69, 0x74, 0x68, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x49, 0xfa, 0x69, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x49, 0xfa, 0x69, 0x6c, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x4c, 0xfa, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x4c, 0xfa, 0x6e, 0x61, 0x73, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x4e, 0x6f, 0x6c, 0x6c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x45, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x41, 0x69, 0x62, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x42, 0x65, 0x61, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[]
        = { 0x42, 0x65, 0x61, 0x6c, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0x42, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x49, 0xfa, 0x69, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x49, 0xfa, 0x69, 0x6c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x4c, 0xfa, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0x4c, 0xfa, 0x6e, 0x61, 0x73, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0x4c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x4e, 0x6f, 0x6c, 0x6c, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName00[] = { 0x52, 0x43, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ga_IE(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName1[] = { 0x50, 0x75, 0x6e, 0x74, 0x20, 0xc9, 0x69, 0x72,
                                                 0x65, 0x61, 0x6e, 0x6e, 0x61, 0x63, 0x68, 0x0 };
    ...
    static const sal_Unicode currencyName2[] = { 0x50, 0x75, 0x6e, 0x74, 0x20, 0x53, 0x74, 0x65,
                                                 0x69, 0x72, 0x6c, 0x69, 0x6e, 0x67, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ga_IE(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_IE(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ga_IE(sal_Int16& count)
    {
        return getTransliterations_en_IE(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x66, 0xed, 0x6f, 0x72, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x61, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0xfa, 0x20, 0x72, 0xe1, 0x69, 0x74, 0x68, 0x65, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0xfa, 0x20, 0x72, 0xe1, 0x69, 0x74, 0x68, 0x65, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0xfa, 0x20, 0x72, 0xe1, 0x69, 0x74, 0x68, 0x65, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0xfa, 0x20, 0x72, 0xe1, 0x69, 0x74, 0x68, 0x65, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x74, 0x68, 0x75, 0x61, 0x73, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x74, 0x68, 0xed, 0x6f, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ga_IE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ga_IE(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ga_IE(sal_Int16& count)
    {
        count = 5;
        return (sal_Unicode**)LCBreakIteratorRulesArray;
    }
    // ---> ContinuousNumbering
    extern const sal_Unicode*** SAL_CALL getContinuousNumberingLevels_en_IE(sal_Int16& nStyles,
                                                                            sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode*** SAL_CALL
    getContinuousNumberingLevels_ga_IE(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
        return getContinuousNumberingLevels_en_IE(nStyles, nAttributes);
    }
    // ---> OutlineNumbering
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_IE(sal_Int16& nStyles,
                                                                          sal_Int16& nLevels,
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ga_IE(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
        return getOutlineNumberingLevels_en_IE(nStyles, nLevels, nAttributes);
    }
} // extern "C"
