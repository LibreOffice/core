...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x47, 0x54, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x47, 0x75, 0x61, 0x74, 0x65, 0x6d, 0x61, 0x6c, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_es_GT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_es_GT(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x51, 0x2d, 0x31, 0x30, 0x30, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_es_GT(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_es_GT(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x47, 0x54, 0x51, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x51, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x47, 0x54, 0x51, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x51, 0x75, 0x65, 0x74, 0x7a, 0x61, 0x6c, 0x0 };
    ...
    getContinuousNumberingLevels_es_GT(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_es_GT(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
