...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6d, 0x69, 0x6e, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4d, 0x69, 0x6e, 0x61, 0x6e, 0x67, 0x6b, 0x61, 0x62, 0x61, 0x75, 0x0 };
    static const sal_Unicode countryID[] = { 0x49, 0x44, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x49, 0x6e, 0x64, 0x6f, 0x6e, 0x65, 0x73, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_min_ID(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCInfoArray);
        return (sal_Unicode**)LCInfoArray;
    }
    extern sal_Unicode** SAL_CALL getLocaleItem_id_ID(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_min_ID(sal_Int16& count)
    {
        return getLocaleItem_id_ID(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x52, 0x70, 0x2d, 0x36, 0x41, 0x37, 0x5d, 0x0 };
    extern sal_Unicode const* const* SAL_CALL getAllFormats0_id_ID(sal_Int16& count,
                                                                   const sal_Unicode*& from,
                                                                   const sal_Unicode*& to);
    SAL_DLLPUBLIC_EXPORT sal_Unicode const* const* SAL_CALL
    getAllFormats0_min_ID(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
        const sal_Unicode* tmp;
        return getAllFormats0_id_ID(count, from, tmp);
    }
    extern sal_Unicode** SAL_CALL getDateAcceptancePatterns_id_ID(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_min_ID(sal_Int16& count)
    {
        return getDateAcceptancePatterns_id_ID(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_min_ID(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_min_ID(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_min_ID(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_min_ID(sal_Int16& count)
    {
        return getIndexAlgorithm_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_min_ID(sal_Int16& count)
    {
        return getUnicodeScripts_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_min_ID(sal_Int16& count)
    {
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x41, 0x6b, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x41, 0x6b, 0x61, 0x69, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x41, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x53, 0x69, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x53, 0x69, 0x6e, 0x61, 0x79, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName02[] = { 0x53, 0x61, 0x6c, 0x61, 0x73, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x53, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x52, 0x61, 0x62, 0x0 };
    static const sal_Unicode dayDefaultFullName03[] = { 0x52, 0x61, 0x62, 0x61, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x52, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x4b, 0x61, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x4b, 0x61, 0x6d, 0x69, 0x68, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[] = { 0x4a, 0x75, 0x6d, 0x61, 0x69, 0x6b, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[] = { 0x53, 0x61, 0x74, 0x75, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x53, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x59, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x59, 0x75, 0x6e, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x50, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x72, 0x65, 0x74, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x41, 0x67, 0x75, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x59, 0x75, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_min_ID(sal_Int16& count)
    {
        count = calendarsCount;
        return (sal_Unicode**)calendars;
    }
    extern sal_Unicode** SAL_CALL getAllCurrencies_id_ID(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_min_ID(sal_Int16& count)
    {
        return getAllCurrencies_id_ID(count);
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_min_ID(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x62, 0x61, 0x6e, 0x61, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x73, 0x61, 0x6c, 0x61, 0x68, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x6b, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x20,
                                                 0x70, 0x61, 0x72, 0x74, 0x61, 0x6d, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x6b, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x20, 0x6b, 0x61, 0x64, 0x75, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x6b, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x20,
                                                 0x6b, 0x61, 0x74, 0x69, 0x67, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x6b, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x20,
                                                 0x6b, 0x61, 0x61, 0x6d, 0x70, 0x65, 0x6b, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0x6c, 0x61, 0x62, 0x69, 0x61, 0x68, 0x20, 0x64, 0x61, 0x72, 0x69, 0x0 };
    static const sal_Unicode ReservedWord7[]
        = { 0x6b, 0x75, 0x72, 0x61, 0x6e, 0x67, 0x20, 0x64, 0x61, 0x72, 0x69, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_min_ID(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_min_ID(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_min_ID(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_min_ID(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_min_ID(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
