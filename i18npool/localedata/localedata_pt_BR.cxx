...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x42, 0x52, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x42, 0x72, 0x61, 0x7a, 0x69, 0x6c, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_pt_BR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_pt_BR(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode2[] = { 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode28[] = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode37[]
        = { 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34, 0x31, 0x36, 0x5d, 0x20, 0x23,
            0x2e, 0x23, 0x23, 0x30, 0x3b, 0x2d, 0x5b, 0x24, 0x52, 0x24, 0x2d,
            0x34, 0x31, 0x36, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode38[]
        = { 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34, 0x31, 0x36, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            0x23, 0x30, 0x2c, 0x30, 0x30, 0x3b, 0x2d, 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34,
            0x31, 0x36, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode39[]
        = { 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34, 0x31, 0x36, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x52, 0x24,
            0x2d, 0x34, 0x31, 0x36, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode40[]
        = { 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34, 0x31, 0x36, 0x5d, 0x20, 0x23,
            ...
            0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34, 0x31, 0x36,
            0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode42[]
        = { 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34, 0x31, 0x36, 0x5d, 0x20, 0x23,
            ...
            0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x52, 0x24, 0x2d, 0x34, 0x31, 0x36,
            0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x0 };
    ...
    getAllFormats0_pt_BR(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_pt_BR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_pt_BR(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_pt_BR(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_pt_BR(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_pt_BR(sal_Int16& count)
    {
        return getIndexAlgorithm_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_pt_BR(sal_Int16& count)
    {
        return getUnicodeScripts_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_pt_BR(sal_Int16& count)
    {
        return getFollowPageWords_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_pt_PT(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_pt_BR(sal_Int16& count)
    {
        return getAllCalendars_pt_PT(count);
    }
    ...
    static const sal_Unicode currencyID0[] = { 0x42, 0x52, 0x4c, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x52, 0x24, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x42, 0x52, 0x4c, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x42, 0x72, 0x61, 0x7a, 0x69, 0x6c, 0x69, 0x61,
                                                 0x6e, 0x20, 0x52, 0x65, 0x61, 0x6c, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_pt_BR(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_pt_BR(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getForbiddenCharacters_pt_PT(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_pt_BR(sal_Int16& count)
    {
        return getForbiddenCharacters_pt_PT(count);
    }
    extern sal_Unicode** SAL_CALL getBreakIteratorRules_pt_PT(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_pt_BR(sal_Int16& count)
    {
        return getBreakIteratorRules_pt_PT(count);
    }
    extern sal_Unicode** SAL_CALL getReservedWords_pt_PT(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_pt_BR(sal_Int16& count)
    {
        return getReservedWords_pt_PT(count);
    }
    // ---> ContinuousNumbering
    ...
    getContinuousNumberingLevels_pt_BR(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_pt_BR(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
