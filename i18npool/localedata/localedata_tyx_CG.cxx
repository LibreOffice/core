...
extern "C"
{
    static const sal_Unicode langID[] = { 0x74, 0x79, 0x78, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x54, 0x65, 0x6b, 0x65, 0x2d, 0x54, 0x79, 0x65, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_tyx_CG(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x4e, 0x44, 0x0 };
    static const sal_Unicode timePM[] = { 0x4c, 0x4b, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_tyx_CG(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCType);
        return (sal_Unicode**)LCType;
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x43, 0x46, 0x41, 0x2d, 0x36, 0x36, 0x31, 0x5d, 0x0 };
    ...
    getAllFormats0_tyx_CG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_tyx_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_tyx_CG(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_tyx_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_tyx_CG(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41,   0x20, 0x42, 0x20, 0x44,  0x20, 0x45, 0x20, 0x46, 0x20, 0x47,
            0x20,   0x48, 0x20, 0x49, 0x20,  0x4b, 0x20, 0x4c, 0x20, 0x4d, 0x20,
            0x2c6e, 0x20, 0x4e, 0x20, 0x14a, 0x20, 0x4f, 0x20, 0x50, 0x20, 0x52,
            0x20,   0x53, 0x20, 0x54, 0x20,  0x55, 0x20, 0x57, 0x20, 0x59, 0x0 };
    ...
    static const sal_Unicode unicodeScript2[] = { 0x34, 0x0 };
    static const sal_Unicode unicodeScript3[] = { 0x36, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_tyx_CG(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_tyx_CG(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_tyx_CG(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_tyx_CG(sal_Int16& count)
    {
        count = calendarsCount;
        return (sal_Unicode**)calendars;
    }
    extern sal_Unicode** SAL_CALL getAllCurrencies_kng_CG(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_tyx_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_tyx_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_tyx_CG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_tyx_CG(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_tyx_CG(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_tyx_CG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_tyx_CG(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
