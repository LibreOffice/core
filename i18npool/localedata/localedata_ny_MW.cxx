...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6e, 0x79, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4e, 0x79, 0x61, 0x6e, 0x6a, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ny_MW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ny_MW(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x4b, 0x2d, 0x36, 0x39, 0x35, 0x5d, 0x0 };
    ...
    getAllFormats0_ny_MW(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ny_MW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ny_MW(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ny_MW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ny_MW(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord1[] = { 0x74, 0x74, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ny_MW(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ny_MW(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ny_MW(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x75, 0x77, 0x61, 0x6c, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x75, 0x6c, 0x75, 0x77, 0x61, 0x6c, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[]
        = { 0x4d, 0x61, 0x6c, 0x69, 0x63, 0x68, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x4d, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x45, 0x70, 0x75, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x45, 0x70, 0x75, 0x6c, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x4f, 0x67, 0x61, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x4f, 0x67, 0x61, 0x73, 0x69, 0x74, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x45, 0x70, 0x75, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x45, 0x70, 0x75, 0x6c, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x4f, 0x67, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x4f, 0x6b, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x45, 0x70, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x4f, 0x67, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x4f, 0x6b, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ny_MW(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0x4d, 0x61, 0x6c, 0x61, 0x77, 0x69, 0x61, 0x6e,
                                                 0x20, 0x4b, 0x77, 0x61, 0x63, 0x68, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ny_MW(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ny_MW(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x43, 0x68, 0x6f, 0x6f, 0x6e, 0x61, 0x0 };
    static const sal_Unicode ReservedWord1[]
        = { 0x43, 0x68, 0x61, 0x62, 0x6f, 0x64, 0x7a, 0x61, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x4b, 0x6f, 0x74, 0x61, 0x20, 0x79, 0x6f, 0x79, 0x61, 0x6d, 0x62, 0x61, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x4b, 0x6f, 0x74, 0x61, 0x20, 0x79, 0x61, 0x63,
                                                 0x68, 0x69, 0x77, 0x69, 0x72, 0x69, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x4b, 0x6f, 0x74, 0x61, 0x20, 0x79, 0x61, 0x63,
                                                 0x68, 0x69, 0x74, 0x61, 0x74, 0x75, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x4b, 0x6f, 0x74, 0x61, 0x20, 0x79, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x61, 0x69, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0x50, 0x61, 0x6d, 0x77, 0x61, 0x6d, 0x62, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x50, 0x61, 0x6e, 0x73, 0x69, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ny_MW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ny_MW(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ny_MW(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ny_MW(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ny_MW(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
