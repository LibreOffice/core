...
extern "C"
{
    ...
    static const sal_Unicode Variant[]
        = { 0x73, 0x72, 0x2d, 0x4c, 0x61, 0x74, 0x6e, 0x2d, 0x43, 0x53, 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sr_Latn_CS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sr_Latn_CS(sal_Int16& count)
    {
        return getLocaleItem_sr_Latn_RS(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x44, 0x69, 0x6e, 0x2d, 0x38, 0x31, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_sr_Latn_CS(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    getDateAcceptancePatterns_sr_Latn_CS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL
    getCollatorImplementation_sr_Latn_CS(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencySymbol0[] = { 0x44, 0x69, 0x6e, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x43, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x53, 0x72, 0x70, 0x73, 0x6b, 0x69, 0x20, 0x44, 0x69, 0x6e, 0x61, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sr_Latn_CS(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_sr_Latn_RS(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sr_Latn_CS(sal_Int16& count)
    {
        return getTransliterations_sr_Latn_RS(count);
    }
    extern sal_Unicode** SAL_CALL getForbiddenCharacters_sr_Latn_RS(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sr_Latn_CS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sr_Latn_CS(sal_Int16& count)
    {
        return getBreakIteratorRules_sr_Latn_RS(count);
    }
    extern sal_Unicode** SAL_CALL getReservedWords_sr_Latn_RS(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sr_Latn_CS(sal_Int16& count)
    {
    ...
    getContinuousNumberingLevels_sr_Latn_CS(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_sr_Latn_CS(
        sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
