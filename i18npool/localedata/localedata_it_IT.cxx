...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_it_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_it_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x20a4, 0x2d, 0x34, 0x31, 0x30, 0x5d,   0x20, 0x23, 0x2e,
            0x23, 0x23, 0x30,   0x3b, 0x2d, 0x5b, 0x24, 0x20a4, 0x2d, 0x34, 0x31,
            0x30, 0x5d, 0x20,   0x23, 0x2e, 0x23, 0x23, 0x30,   0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x20a4, 0x2d, 0x34, 0x31, 0x30, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            0x23, 0x30, 0x3b,   0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x20a4,
            0x2d, 0x34, 0x31,   0x30, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode17[]
        = { 0x47, 0x47, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x47, 0x47, 0x20, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode20[]
        = { 0x47, 0x47, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x47, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x47, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x47, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x20, 0x47, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x47, 0x47, 0x2f, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode28[] = { 0x4e, 0x4e, 0x20, 0x47, 0x20, 0x4d, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode29[] = { 0x4e, 0x4e, 0x4e, 0x4e, 0x47, 0x20, 0x4d, 0x4d,
                                                0x4d, 0x4d, 0x20, 0x41, 0x41, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode34[] = { 0x47, 0x47, 0x2f, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    static const sal_Unicode FormatCode45[] = { 0x47, 0x47, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x47, 0x47, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41, 0x41,
    ...
    static const sal_Unicode FormatCode47[]
        = { 0x47, 0x47, 0x2f, 0x4d, 0x4d, 0x2f, 0x41, 0x41, 0x41,
    ...
    getAllFormats0_it_IT(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_it_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_it_IT(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_it_IT(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_it_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[] = { 0x20, 0x65, 0x20, 0x73, 0x65, 0x67, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[]
        = { 0x20, 0x65, 0x20, 0x73, 0x65, 0x67, 0x67, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_it_IT(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_it_IT(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_it_IT(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x64, 0x6f, 0x6d, 0x65, 0x6e, 0x69, 0x63, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[] = { 0x6c, 0x75, 0x6e, 0x65, 0x64, 0xec, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x6d, 0x61, 0x72, 0x74, 0x65, 0x64, 0xec, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x6d, 0x65, 0x72, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x6d, 0x65, 0x72, 0x63, 0x6f, 0x6c, 0x65, 0x64, 0xec, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x67, 0x69, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x67, 0x69, 0x6f, 0x76, 0x65, 0x64, 0xec, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x67, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x76, 0x65, 0x6e, 0x65, 0x72, 0x64, 0xec, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x67, 0x65, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x67, 0x65, 0x6e, 0x6e, 0x61, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x62, 0x72, 0x61, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x61, 0x70, 0x72, 0x69, 0x6c, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x61, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x61, 0x67, 0x67, 0x69, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x67, 0x69, 0x75, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x67, 0x69, 0x75, 0x67, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x67, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x6c, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x6c, 0x75, 0x67, 0x6c, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x64, 0x69, 0x63, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x69, 0x63, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x64, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x67, 0x65, 0x6e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x61, 0x70, 0x72, 0x69, 0x6c, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0x6d, 0x61, 0x67, 0x67, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x67, 0x69, 0x75, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x67, 0x69, 0x75, 0x67, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x67, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x6c, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x6c, 0x75, 0x67, 0x6c, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x6f, 0x74, 0x74, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x64, 0x69, 0x63, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x67, 0x65, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x67, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x67, 0x69, 0x75, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x67, 0x69, 0x75, 0x67, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x67, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x6c, 0x75, 0x67, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x6f, 0x74, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x64, 0x69, 0x63, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_it_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID1[] = { 0x49, 0x54, 0x4c, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x20a4, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x49, 0x54, 0x4c, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0x4c, 0x69, 0x72, 0x61, 0x20, 0x49, 0x74, 0x61, 0x6c, 0x69, 0x61, 0x6e, 0x61, 0x0 };
    ...
    static const sal_Unicode currencyID2[] = { 0x49, 0x54, 0x4c, 0x0 };
    static const sal_Unicode currencySymbol2[] = { 0x4c, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol2[] = { 0x49, 0x54, 0x4c, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_it_IT(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_it_IT(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x76, 0x65, 0x72, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x6f, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x6f, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x6f, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x6f, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x73, 0x6f, 0x70, 0x72, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x73, 0x6f, 0x74, 0x74, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_it_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_it_IT(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_it_IT(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_it_IT(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_it_IT(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
