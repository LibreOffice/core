...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x74, 0x67, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4c, 0x61, 0x74, 0x67, 0x61, 0x6c, 0x69, 0x61, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ltg_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ltg_LV(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x36, 0x34, 0x42, 0x5d, 0x20, 0x23,
            0xa0, 0x23, 0x23, 0x30, 0x3b, 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x36,
            0x34, 0x42, 0x5d, 0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x36, 0x34, 0x42, 0x5d, 0x20, 0x23, 0xa0, 0x23,
            0x23, 0x30, 0x2c, 0x30, 0x30, 0x3b, 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x36, 0x34,
            0x42, 0x5d, 0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x36, 0x34, 0x42, 0x5d, 0x20, 0x23, 0xa0, 0x23,
            ...
            0x36, 0x34, 0x42, 0x5d, 0x20, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x36, 0x34, 0x42, 0x5d, 0x20, 0x23,
            ...
            0x44, 0x5d, 0x5b, 0x24, 0x4c, 0x73, 0x2d, 0x36, 0x34, 0x42, 0x5d,
    ...
    getAllFormats0_ltg_LV(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ltg_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ltg_LV(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ltg_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ltg_LV(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[] = { 0x41, 0x2d, 0x17d, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x6c, 0x70, 0x70, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x6c, 0x70, 0x70, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ltg_LV(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ltg_LV(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ltg_LV(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x73, 0x76, 0x101, 0x74, 0x64, 0x12b, 0x6e, 0x65, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x70, 0x79, 0x72, 0x6d, 0x16b, 0x64, 0x12b, 0x6e, 0x65, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x70, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x16a, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x16b, 0x74, 0x61, 0x72, 0x64, 0x12b, 0x6e, 0x65, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x16b, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x74, 0x72, 0x65, 0x161, 0x64, 0x12b, 0x6e, 0x65, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x63, 0x61, 0x74, 0x16b, 0x72, 0x74, 0x64, 0x12b, 0x6e, 0x65, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x70, 0x12b, 0x6b, 0x74, 0x64, 0x12b, 0x6e, 0x65, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x73, 0x61, 0x73, 0x74, 0x64, 0x12b, 0x6e, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x6a, 0x61, 0x6e, 0x76, 0x61, 0x72, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x70, 0x65, 0x62, 0x72, 0x61, 0x13c, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x70, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x61, 0x70, 0x72, 0x65, 0x13c, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x61, 0x6a, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x4a, 0x75, 0x146, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x6a, 0x75, 0x146, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x6a, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x4a, 0x75, 0x13c, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x6a, 0x75, 0x13c, 0x73, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x53, 0x65, 0x146, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x146, 0x74, 0x65, 0x62, 0x72, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x70, 0x65, 0x62, 0x72, 0x61, 0x13c, 0x73, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x70, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x6a, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x4a, 0x75, 0x146, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x6a, 0x75, 0x146, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x4a, 0x75, 0x13c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x6a, 0x75, 0x13c, 0x73, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x53, 0x65, 0x146, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x4e, 0x6f, 0x6a, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x44, 0x65, 0x6b, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x70, 0x65, 0x62, 0x72, 0x61, 0x13c, 0x73, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x70, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x6a, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x4a, 0x75, 0x146, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x6a, 0x75, 0x146, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x4a, 0x75, 0x13c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x6a, 0x75, 0x13c, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x53, 0x65, 0x146, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x4e, 0x6f, 0x6a, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x44, 0x65, 0x6b, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x70, 0x2e, 0x6b, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x70, 0x79, 0x72, 0x6d, 0x73, 0x20, 0x4b, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x70, 0x65, 0x63, 0x20, 0x4b, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ltg_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ltg_LV(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ltg_LV(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x70, 0x61, 0x74, 0x12b, 0x73, 0x73, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x6f, 0x70, 0x6c, 0x6f, 0x6d, 0x73, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x2e, 0x20, 0x63, 0x61, 0x74, 0x16b, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x2e, 0x20, 0x63, 0x61, 0x74, 0x16b, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x2e, 0x20, 0x63, 0x61, 0x74, 0x16b, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x2e, 0x20, 0x63, 0x61, 0x74, 0x16b, 0x72, 0x6b, 0x73, 0x6e, 0x69, 0x73, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x76, 0x69, 0x65, 0x72, 0x73, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x7a, 0x61, 0x6d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ltg_LV(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ltg_LV(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ltg_LV(sal_Int16& count)
    {
        count = 5;
        return (sal_Unicode**)LCBreakIteratorRulesArray;
    }
    // ---> ContinuousNumbering
    extern const sal_Unicode*** SAL_CALL getContinuousNumberingLevels_lv_LV(sal_Int16& nStyles,
                                                                            sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode*** SAL_CALL
    getContinuousNumberingLevels_ltg_LV(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
        return getContinuousNumberingLevels_lv_LV(nStyles, nAttributes);
    }
    // ---> OutlineNumbering
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_lv_LV(sal_Int16& nStyles,
                                                                          sal_Int16& nLevels,
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ltg_LV(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
        return getOutlineNumberingLevels_lv_LV(nStyles, nLevels, nAttributes);
    }
} // extern "C"
