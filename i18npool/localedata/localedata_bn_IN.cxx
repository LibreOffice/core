...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_bn_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[]
        = { 0x9aa, 0x9c2, 0x9b0, 0x9cd, 0x9ac, 0x9be, 0x9b9, 0x9cd, 0x9a3, 0x0 };
    static const sal_Unicode timePM[] = { 0x985, 0x9aa, 0x9b0, 0x9be, 0x9b9, 0x9cd, 0x9a3, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_bn_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20b9, 0x2d, 0x34, 0x34, 0x35, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatDefaultName3[] = { 0x33, 0x0 };
    ...
    static const sal_Unicode FormatDefaultName28[] = { 0x32, 0x39, 0x0 };
    ...
    static const sal_Unicode FormatCode45[]
        = { 0x4d, 0x4d, 0x2d, 0x44, 0x44, 0x2d, 0x59, 0x59, 0x20, 0x48, 0x48,
    ...
    getAllFormats0_bn_IN(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_bn_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_bn_IN(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_bn_IN(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_bn_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_bn_IN(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_bn_IN(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_bn_IN(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName04[]
        = { 0x9ac, 0x9c3, 0x9b9, 0x9b8, 0x9cd, 0x9aa, 0x9a4, 0x9bf, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x99c, 0x9be, 0x9a8, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x9ab, 0x9c7, 0x9ac, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x98f, 0x9aa, 0x9cd, 0x9b0, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x99c, 0x9be, 0x9a8, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x9ab, 0x9c7, 0x9ac, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x9b8, 0x9c7, 0x9aa, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x9a1, 0x9bf, 0x9b8, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x99c, 0x9be, 0x9a8, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x9ab, 0x9c7, 0x9ac, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x9b8, 0x9c7, 0x9aa, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x9a1, 0x9bf, 0x9b8, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x996, 0x9c3, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x996, 0x9cd, 0x9b0, 0x9bf, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_bn_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencySymbol1[] = { 0x9f3, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_bn_IN(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_bn_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode ReservedWord2[] = { 0x51, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x51, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x51, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x51, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_bn_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_bn_IN(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_bn_IN(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_bn_IN(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_bn_IN(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
