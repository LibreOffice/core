...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x50, 0x59, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x50, 0x61, 0x72, 0x61, 0x67, 0x75, 0x61, 0x79, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_es_PY(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_es_PY(sal_Int16& count)
    {
        return getLocaleItem_es_AR(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20b2, 0x2d, 0x33, 0x43, 0x30, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_es_PY(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    static const sal_Unicode currencyID0[] = { 0x50, 0x59, 0x47, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x47, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x50, 0x59, 0x47, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x47, 0x75, 0x61, 0x72, 0x61, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x50, 0x59, 0x47, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x47, 0x73, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x50, 0x59, 0x47, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x47, 0x75, 0x61, 0x72, 0x61, 0x6e, 0x69, 0x0 };
    static const sal_Unicode currencyDecimalPlaces1[] = { 2 };

    static const sal_Unicode defaultCurrency2[] = { 1 };
    static const sal_Unicode defaultCurrencyUsedInCompatibleFormatCodes2[] = { 1 };
    static const sal_Unicode defaultCurrencyLegacyOnly2[] = { 0 };
    static const sal_Unicode currencyID2[] = { 0x50, 0x59, 0x47, 0x0 };
    static const sal_Unicode currencySymbol2[] = { 0x20b2, 0x0 };
    static const sal_Unicode bankSymbol2[] = { 0x50, 0x59, 0x47, 0x0 };
    static const sal_Unicode currencyName2[] = { 0x47, 0x75, 0x61, 0x72, 0x61, 0x6e, 0x69, 0x0 };
    ...
    getContinuousNumberingLevels_es_PY(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_es_PY(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
