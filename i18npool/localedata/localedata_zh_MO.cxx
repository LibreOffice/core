...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x4d, 0x4f, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4d, 0x61, 0x63, 0x61, 0x75, 0x2c, 0x20, 0x43, 0x68, 0x69, 0x6e, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_zh_MO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_zh_MO(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34, 0x30, 0x34, 0x5d, 0x23,
            0x2c, 0x23, 0x23, 0x30, 0x3b, 0x2d, 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d,
            0x31, 0x34, 0x30, 0x34, 0x5d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34, 0x30, 0x34,
            0x5d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x2d,
            0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34, 0x30, 0x34,
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34, 0x30, 0x34, 0x5d, 0x23, 0x2c,
            0x23, 0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x4d, 0x4f,
            0x50, 0x24, 0x2d, 0x31, 0x34, 0x30, 0x34, 0x5d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34, 0x30, 0x34, 0x5d,
            0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x5b, 0x52, 0x45,
            0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34,
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34, 0x30, 0x34, 0x5d,
            0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x3b, 0x5b, 0x52, 0x45,
            0x44, 0x5d, 0x2d, 0x5b, 0x24, 0x4d, 0x4f, 0x50, 0x24, 0x2d, 0x31, 0x34,
    ...
    static const sal_Unicode FormatCode19[] = { 0x44, 0x2f, 0x4d, 0x2f, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode21[] = { 0x59,   0x59, 0x22, 0x5e74, 0x22,   0x4d, 0x22,
    ...
    static const sal_Unicode FormatCode24[] = { 0x4d, 0x4d, 0x2d, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x59, 0x59, 0x20, 0x4e, 0x4e, 0x4e, 0x4e, 0x0 };
    ...
    static const sal_Unicode FormatCode28[] = { 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x59, 0x59,
                                                0x59, 0x59, 0x20, 0x4e, 0x4e, 0x4e, 0x4e, 0x0 };
    ...
    static const sal_Unicode FormatCode29[] = { 0x44, 0x44, 0x2d, 0x4d, 0x4d, 0x2d, 0x59, 0x59,
                                                0x59, 0x59, 0x20, 0x4e, 0x4e, 0x4e, 0x4e, 0x0 };
    ...
    static const sal_Unicode FormatUsage54[]
        = { 0x44, 0x41, 0x54, 0x45, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x0 };
    static const sal_Unicode Formatindex54[] = { 72 };
    ...
    static const sal_Unicode FormatUsage55[]
        = { 0x44, 0x41, 0x54, 0x45, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x0 };
    static const sal_Unicode Formatindex55[] = { 73 };
    ...
    static const sal_Unicode Formatindex56[] = { 74 };
    static const sal_Unicode FormatCode56[]
        = { 0x44, 0x2d, 0x4d, 0x2d, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_zh_MO(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_zh_MO(sal_Int16& count)
    {
        count = DateAcceptancePatternsCount;
        return (sal_Unicode**)DateAcceptancePatternsArray;
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_zh_HK(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_zh_MO(sal_Int16& count)
    {
        return getCollatorImplementation_zh_HK(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_zh_HK(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_zh_MO(sal_Int16& count)
    {
        return getCollationOptions_zh_HK(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_zh_CN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_zh_MO(sal_Int16& count)
    {
        return getSearchOptions_zh_CN(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_zh_TW(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_zh_MO(sal_Int16& count)
    {
        return getIndexAlgorithm_zh_TW(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_zh_TW(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_zh_MO(sal_Int16& count)
    {
        return getUnicodeScripts_zh_TW(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_zh_TW(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_zh_MO(sal_Int16& count)
    {
        return getFollowPageWords_zh_TW(count);
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_zh_HK(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_zh_MO(sal_Int16& count)
    {
        return getAllCalendars_zh_HK(count);
    }
    ...
    static const sal_Unicode currencyID0[] = { 0x4d, 0x4f, 0x50, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x4d, 0x4f, 0x50, 0x24, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x4d, 0x4f, 0x50, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x6fb3, 0x9580, 0x5143, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x50, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x50, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x50, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0x4d, 0x61, 0x63, 0x61, 0x75, 0x20, 0x50, 0x6f, 0x75, 0x6e, 0x64, 0x0 };
    ...
    getContinuousNumberingLevels_zh_MO(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_zh_TW(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_zh_MO(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
