...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_de_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_de_DE(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x44, 0x4d, 0x2d,
            0x34, 0x30, 0x37, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30,
            0x20, 0x5b, 0x24, 0x44, 0x4d, 0x2d, 0x34, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x44, 0x4d,
            0x2d, 0x34, 0x30, 0x37, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c,
            0x30, 0x30, 0x20, 0x5b, 0x24, 0x44, 0x4d, 0x2d, 0x34, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x44, 0x4d, 0x2d, 0x34, 0x30,
            0x37, 0x5d, 0x3b, 0x5b, 0x52, 0x4f, 0x54, 0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23,
            0x30, 0x20, 0x5b, 0x24, 0x44, 0x4d, 0x2d, 0x34, 0x30, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24,
            0x44, 0x4d, 0x2d, 0x34, 0x30, 0x37, 0x5d, 0x3b, 0x5b, 0x52, 0x4f,
    ...
    getAllFormats0_de_DE(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_de_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_de_DE(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_de_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_de_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_de_DE(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_de_DE(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_de_DE(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_de_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_de_DE(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_de_DE(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x77, 0x61, 0x68, 0x72, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x63, 0x68, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x2e, 0x20, 0x51, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x2e, 0x20, 0x51, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x2e, 0x20, 0x51, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x2e, 0x20, 0x51, 0x75, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x6f, 0x62, 0x65, 0x6e, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x75, 0x6e, 0x74, 0x65, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_de_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_de_DE(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_de_DE(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_de_DE(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_de_DE(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
