...
extern "C"
{
    ...
    static const sal_Unicode Variant[]
        = { 0x68, 0x61, 0x2d, 0x4c, 0x61, 0x74, 0x6e, 0x2d, 0x4e, 0x47, 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ha_Latn_NG(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateDaySeparator[] = { 0xa0, 0x0 };
    static const sal_Unicode LongDateMonthSeparator[] = { 0x2c, 0xa0, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ha_Latn_NG(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20a6, 0x2d, 0x34, 0x36, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x44, 0x44, 0xa0, 0x4d, 0x4d,
            0x4d, 0x4d, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x44, 0x20, 0x4d, 0x4d, 0x4d, 0x2c, 0xa0, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x44, 0x20, 0x4d, 0x4d, 0x4d, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode23[]
        = { 0x44, 0xa0, 0x4d, 0x4d, 0x4d, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x4d, 0x4d, 0x4d, 0x4d, 0x2c, 0xa0, 0x44, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x2c, 0xa0, 0x44, 0x20, 0x4d, 0x4d, 0x4d, 0x2c, 0xa0, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x2c, 0xa0, 0x44, 0x20, 0x4d, 0x4d, 0x4d,
            0x4d, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode34[] = { 0x44, 0x2f, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    getAllFormats0_ha_Latn_NG(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    getDateAcceptancePatterns_ha_Latn_NG(sal_Int16& count)
    {
        count = DateAcceptancePatternsCount;
        return (sal_Unicode**)DateAcceptancePatternsArray;
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL
    getCollatorImplementation_ha_Latn_NG(sal_Int16& count)
    {
        return getCollatorImplementation_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ha_Latn_NG(sal_Int16& count)
    {
        return getCollationOptions_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ha_Latn_NG(sal_Int16& count)
    {
        return getSearchOptions_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ha_Latn_NG(sal_Int16& count)
    {
        return getIndexAlgorithm_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ha_Latn_NG(sal_Int16& count)
    {
        return getUnicodeScripts_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ha_Latn_NG(sal_Int16& count)
    {
        return getFollowPageWords_ha_Latn_GH(count);
    }
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4c, 0x69, 0x74, 0x69, 0x6e, 0x69, 0x6e, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x61, 0x62, 0x75, 0x72, 0x61, 0x69, 0x72, 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x41, 0x66, 0x69, 0x0 };
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x41, 0x66, 0x69, 0x72, 0x69, 0x6c, 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x41, 0x66, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x41, 0x66, 0x69, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x4b, 0x48, 0x41, 0x49, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x4b, 0x61, 0x66, 0x69, 0x6e, 0x20, 0x68, 0x61, 0x69, 0x68, 0x75,
            0x77, 0x61, 0x72, 0x20, 0x61, 0x6e, 0x6e, 0x61, 0x62, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x42, 0x48, 0x41, 0x49, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x42, 0x61, 0x79, 0x61, 0x6e, 0x20, 0x68, 0x61, 0x69, 0x68, 0x75,
            0x77, 0x61, 0x72, 0x20, 0x61, 0x6e, 0x6e, 0x61, 0x62, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ha_Latn_NG(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ha_Latn_NG(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ha_Latn_NG(sal_Int16& count)
    {
        return getTransliterations_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getForbiddenCharacters_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ha_Latn_NG(sal_Int16& count)
    {
        return getForbiddenCharacters_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getBreakIteratorRules_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ha_Latn_NG(sal_Int16& count)
    {
        return getBreakIteratorRules_ha_Latn_GH(count);
    }
    extern sal_Unicode** SAL_CALL getReservedWords_ha_Latn_GH(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ha_Latn_NG(sal_Int16& count)
    {
        return getReservedWords_ha_Latn_GH(count);
    }
    // ---> ContinuousNumbering
    ...
    getContinuousNumberingLevels_ha_Latn_NG(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
        return getContinuousNumberingLevels_ha_Latn_GH(nStyles, nAttributes);
    }
    // ---> OutlineNumbering
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_ha_Latn_GH(
        sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_ha_Latn_NG(
        sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
        return getOutlineNumberingLevels_ha_Latn_GH(nStyles, nLevels, nAttributes);
    }
} // extern "C"
