...
extern "C"
{
    static const sal_Unicode langID[] = { 0x69, 0x73, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x49, 0x63, 0x65, 0x6c, 0x61, 0x6e, 0x64, 0x69, 0x63, 0x0 };
    static const sal_Unicode countryID[] = { 0x49, 0x53, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x49, 0x63, 0x65, 0x6c, 0x61, 0x6e, 0x64, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_is_IS(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x66, 0x2e, 0x68, 0x2e, 0x0 };
    static const sal_Unicode timePM[] = { 0x65, 0x2e, 0x68, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_is_IS(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d,
            0x34, 0x30, 0x46, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20,
            0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x30, 0x46, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x6b, 0x72, 0x2e,
            0x2d, 0x34, 0x30, 0x46, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30,
            0x30, 0x20, 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x30, 0x46, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x30,
            0x46, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30,
            0x20, 0x5b, 0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x30, 0x46, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x6b,
            0x72, 0x2e, 0x2d, 0x34, 0x30, 0x46, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b,
            0x24, 0x6b, 0x72, 0x2e, 0x2d, 0x34, 0x30, 0x46, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x20, 0x5b, 0x24, 0x6b,
            0x72, 0x2e, 0x2d, 0x34, 0x30, 0x46, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x2c, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d,
    ...
    getAllFormats0_is_IS(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    static const sal_Unicode DateAcceptancePattern4[] = { 0x44, 0x2f, 0x4d, 0x2f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_is_IS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_is_IS(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_is_IS(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_is_IS(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x2d, 0x57, 0x20, 0x59, 0x2d, 0x5a, 0x20, 0xc1, 0x20, 0xd0, 0x20, 0xc9, 0x20,
            0xcd, 0x20, 0xd3, 0x20, 0xda, 0x20, 0xdd, 0x20, 0xde, 0x20, 0xc6, 0x20, 0xd6, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_is_IS(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_is_IS(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_is_IS(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x6d, 0xe1, 0x6e, 0x75, 0x64, 0x61, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0xfe, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0xfe, 0x72, 0x69, 0xf0, 0x6a, 0x75, 0x64, 0x61, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0xfe, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x6d, 0x69, 0xf0, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x6d, 0x69, 0xf0, 0x76, 0x69, 0x6b, 0x75, 0x64, 0x61, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x66, 0x69, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x66, 0x69, 0x6d, 0x6d, 0x74, 0x75, 0x64, 0x61, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x66, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x66, 0xf6, 0x73, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x66, 0xf6, 0x73, 0x74, 0x75, 0x64, 0x61, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x66, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x6c, 0x61, 0x75, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x6c, 0x61, 0x75, 0x67, 0x61, 0x72, 0x64, 0x61, 0x67, 0x75, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[] = { 0x6a, 0x61, 0x6e, 0xfa, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0xfa, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x6d, 0x61, 0xed, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x61, 0xed, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x6a, 0xfa, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x6a, 0xfa, 0x6e, 0xed, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x6a, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x6a, 0xfa, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x6a, 0xfa, 0x6c, 0xed, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x6a, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0xe1, 0x67, 0xfa, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0xe1, 0x67, 0xfa, 0x73, 0x74, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0xe1, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x6e, 0xf3, 0x76, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x6e, 0xf3, 0x76, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x6a, 0x61, 0x6e, 0xfa, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0xed, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0xed, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x6a, 0xfa, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x6a, 0xfa, 0x6e, 0xed, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x6a, 0xfa, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x6a, 0xfa, 0x6c, 0xed, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0xe1, 0x67, 0xfa, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0xe1, 0x67, 0xfa, 0x73, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0xe1, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x6e, 0xf3, 0x76, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0xed, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0xed, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x6a, 0xfa, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x6a, 0xfa, 0x6e, 0xed, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x6a, 0xfa, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x6a, 0xfa, 0x6c, 0xed, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0xe1, 0x67, 0xfa, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0xe1, 0x67, 0xfa, 0x73, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0xe1, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x6e, 0xf3, 0x76, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x66, 0x79, 0x72, 0x69, 0x72, 0x20, 0x4b, 0x72, 0x69, 0x73, 0x74, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x65, 0x66, 0x74, 0x69, 0x72, 0x20, 0x4b, 0x72, 0x69, 0x73, 0x74, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_is_IS(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x49, 0x53, 0x4b, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x6b, 0x72, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x49, 0x53, 0x4b, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0xcd, 0x73, 0x6c, 0x65, 0x6e, 0x73, 0x6b, 0x20, 0x6b, 0x72, 0xf3, 0x6e, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_is_IS(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_is_IS(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x52, 0xe9, 0x74, 0x74, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x52, 0x61, 0x6e, 0x67, 0x74, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x66, 0x79, 0x72, 0x73, 0x74, 0x69, 0x20, 0x66, 0x6a,
            0xf3, 0x72, 0xf0, 0x75, 0x6e, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x61, 0x6e, 0x6e, 0x61, 0x72, 0x20, 0x66, 0x6a, 0xf3,
            0x72, 0xf0, 0x75, 0x6e, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0xfe, 0x72, 0x69, 0xf0, 0x6a, 0x69, 0x20, 0x66, 0x6a,
            0xf3, 0x72, 0xf0, 0x75, 0x6e, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x66, 0x6a, 0xf3, 0x72, 0xf0, 0x69, 0x20, 0x66, 0x6a,
            0xf3, 0x72, 0xf0, 0x75, 0x6e, 0x67, 0x75, 0x72, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x79, 0x66, 0x69, 0x72, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x75, 0x6e, 0x64, 0x69, 0x72, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x46, 0x31, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x46, 0x32, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x46, 0x33, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x46, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_is_IS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_is_IS(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_is_IS(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_is_IS(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_is_IS(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
