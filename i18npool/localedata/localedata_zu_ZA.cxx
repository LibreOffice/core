...
extern "C"
{
    static const sal_Unicode langID[] = { 0x7a, 0x75, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x5a, 0x75, 0x6c, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_zu_ZA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_zu_ZA(sal_Int16& count)
    {
        return getLocaleItem_en_ZA(count);
    }
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x52, 0x2d, 0x34, 0x33, 0x35, 0x5d, 0x0 };
    ...
    getAllFormats0_zu_ZA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4d, 0x73, 0x6f, 0x6d, 0x62, 0x75, 0x6c, 0x75, 0x6b, 0x6f, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x4c, 0x77, 0x65, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x75, 0x77, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x73, 0x68, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x70, 0x72, 0x65, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x41, 0x70, 0x72, 0x65, 0x6c, 0x69, 0x0 };
    ...
    getContinuousNumberingLevels_zu_ZA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_zu_ZA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
