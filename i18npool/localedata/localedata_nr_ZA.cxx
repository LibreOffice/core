...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6e, 0x72, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4e, 0x64, 0x65, 0x62, 0x65, 0x6c, 0x65, 0x2c,
                                                   0x20, 0x53, 0x6f, 0x75, 0x74, 0x68, 0x0 };
    static const sal_Unicode countryID[] = { 0x5a, 0x41, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x53, 0x6f, 0x75, 0x74, 0x68, 0x20, 0x41, 0x66, 0x72, 0x69, 0x63, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_nr_ZA(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCInfoArray);
        return (sal_Unicode**)LCInfoArray;
    }
    extern sal_Unicode** SAL_CALL getLocaleItem_en_ZA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_nr_ZA(sal_Int16& count)
    {
        return getLocaleItem_en_ZA(count);
    }
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x52, 0x2d, 0x36, 0x32, 0x43, 0x5d, 0x0 };
    extern sal_Unicode const* const* SAL_CALL getAllFormats0_en_ZA(sal_Int16& count,
                                                                   const sal_Unicode*& from,
                                                                   const sal_Unicode*& to);
    SAL_DLLPUBLIC_EXPORT sal_Unicode const* const* SAL_CALL
    getAllFormats0_nr_ZA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
        const sal_Unicode* tmp;
        return getAllFormats0_en_ZA(count, from, tmp);
    }
    extern sal_Unicode** SAL_CALL getDateAcceptancePatterns_en_ZA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_nr_ZA(sal_Int16& count)
    {
        return getDateAcceptancePatterns_en_ZA(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_nr_ZA(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_nr_ZA(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_nr_ZA(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_nr_ZA(sal_Int16& count)
    {
        return getIndexAlgorithm_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_nr_ZA(sal_Int16& count)
    {
        return getUnicodeScripts_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_nr_ZA(sal_Int16& count)
    {
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x53, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x75, 0x53, 0x6f, 0x6e, 0x74, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x75, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x4d, 0x76, 0x75, 0x0 };
    static const sal_Unicode dayDefaultFullName01[] = { 0x75, 0x4d, 0x76, 0x75, 0x6c, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x75, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x42, 0x69, 0x6c, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x75, 0x4c, 0x65, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x75, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x54, 0x68, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x4c, 0x65, 0x73, 0x69, 0x74, 0x68, 0x61, 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x4c, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x4e, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x75, 0x4c, 0x65, 0x73, 0x69, 0x6e, 0x65, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x75, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x48, 0x6c, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x6e, 0x67, 0x6f, 0x4c, 0x65, 0x73, 0x69, 0x68, 0x6c, 0x61, 0x6e, 0x75, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x6e, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x47, 0x71, 0x69, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x75, 0x6d, 0x47, 0x71, 0x69, 0x62, 0x65, 0x6c, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x61, 0x62, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x75, 0x46, 0x65, 0x62, 0x65, 0x72, 0x62, 0x61, 0x72, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x75, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x4d, 0x61, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName02[]
        = { 0x75, 0x4d, 0x61, 0x74, 0x6a, 0x68, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x75, 0x2d, 0x41, 0x70, 0x72, 0x65, 0x6c, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x75, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x79, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x65, 0x79, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x4a, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x4a, 0x75, 0x6c, 0x61, 0x79, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x4a, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x41, 0x72, 0x68, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x41, 0x72, 0x68, 0x6f, 0x73, 0x74, 0x6f, 0x73, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x53, 0x65, 0x70, 0x74, 0x65, 0x6d, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[] = { 0x4f, 0x6b, 0x74, 0x6f, 0x62, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x4f, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x55, 0x73, 0x69, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x55, 0x73, 0x69, 0x6e, 0x79, 0x69, 0x6b, 0x68, 0x61, 0x62, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x55, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x44, 0x69, 0x73, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x44, 0x69, 0x73, 0x65, 0x6d, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x75, 0x46, 0x65, 0x62, 0x65, 0x72, 0x62, 0x61, 0x72, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x75, 0x0 };
    static const sal_Unicode genitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x61, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x75, 0x4d, 0x61, 0x74, 0x6a, 0x68, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x75, 0x2d, 0x41, 0x70, 0x72, 0x65, 0x6c, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0x75, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x65, 0x79, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x4a, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x4a, 0x75, 0x6c, 0x61, 0x79, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x41, 0x72, 0x68, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x4f, 0x6b, 0x74, 0x6f, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x55, 0x73, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x55, 0x73, 0x69, 0x6e, 0x79, 0x69, 0x6b, 0x68, 0x61, 0x62, 0x61, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0x55, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x44, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x75, 0x46, 0x65, 0x62, 0x65, 0x72, 0x62, 0x61, 0x72, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x75, 0x0 };
    static const sal_Unicode partitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x61, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0x75, 0x4d, 0x61, 0x74, 0x6a, 0x68, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0x75, 0x2d, 0x41, 0x70, 0x72, 0x65, 0x6c, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0x75, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x65, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x65, 0x79, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x4a, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x41, 0x72, 0x68, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x55, 0x73, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0x55, 0x73, 0x69, 0x6e, 0x79, 0x69, 0x6b, 0x68, 0x61, 0x62, 0x61, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0x55, 0x0 };
    static const sal_Unicode partitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x44, 0x69, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_nr_ZA(sal_Int16& count)
    {
        count = calendarsCount;
        return (sal_Unicode**)calendars;
    }
    extern sal_Unicode** SAL_CALL getAllCurrencies_en_ZA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_nr_ZA(sal_Int16& count)
    {
        return getAllCurrencies_en_ZA(count);
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_nr_ZA(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x71, 0x69, 0x6e, 0x69, 0x73, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x6d, 0x61, 0x6d, 0x61, 0x6c, 0x61, 0x0 };
    ...
    static const sal_Unicode ReservedWord6[]
        = { 0x6e, 0x67, 0x61, 0x70, 0x68, 0x65, 0x7a, 0x75, 0x6c, 0x75, 0x0 };
    static const sal_Unicode ReservedWord7[]
        = { 0x6e, 0x67, 0x61, 0x70, 0x68, 0x61, 0x73, 0x69, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_nr_ZA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_nr_ZA(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_nr_ZA(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_nr_ZA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_nr_ZA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
