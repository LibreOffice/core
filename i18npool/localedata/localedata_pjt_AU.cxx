...
extern "C"
{
    static const sal_Unicode langID[] = { 0x70, 0x6a, 0x74, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x50, 0x69, 0x74, 0x6a, 0x61, 0x6e, 0x74, 0x6a,
                                                   0x61, 0x74, 0x6a, 0x61, 0x72, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_pjt_AU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_pjt_AU(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x24, 0x2d, 0x36, 0x36, 0x42, 0x5d, 0x0 };
    ...
    getAllFormats0_pjt_AU(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_pjt_AU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_pjt_AU(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_pjt_AU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_pjt_AU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_pjt_AU(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_pjt_AU(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_pjt_AU(sal_Int16& count)
    {
        count = nbOfPageWords;
        return (sal_Unicode**)FollowPageWordArray;
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_en_AU(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_pjt_AU(sal_Int16& count)
    {
        return getAllCalendars_en_AU(count);
    }
    ...
    static const sal_Unicode currencyName0[] = { 0x54, 0x61, 0x6c, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_pjt_AU(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_pjt_AU(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[]
        = { 0x74, 0x6a, 0x75, 0x6b, 0x61, 0x1e5f, 0x75, 0x72, 0x75, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x6e, 0x67, 0x75, 0x6e, 0x74, 0x69, 0x0 };
    ...
    static const sal_Unicode ReservedWord6[] = { 0x6b, 0x61, 0x74, 0x75, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x74, 0x6a, 0x61, 0x1e5f, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_pjt_AU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_pjt_AU(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_pjt_AU(sal_Int16& count)
    {
        count = 5;
        return (sal_Unicode**)LCBreakIteratorRulesArray;
    }
    // ---> ContinuousNumbering
    extern const sal_Unicode*** SAL_CALL getContinuousNumberingLevels_en_AU(sal_Int16& nStyles,
                                                                            sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode*** SAL_CALL
    getContinuousNumberingLevels_pjt_AU(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
        return getContinuousNumberingLevels_en_AU(nStyles, nAttributes);
    }
    // ---> OutlineNumbering
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_AU(sal_Int16& nStyles,
                                                                          sal_Int16& nLevels,
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_pjt_AU(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
        return getOutlineNumberingLevels_en_AU(nStyles, nLevels, nAttributes);
    }
} // extern "C"
