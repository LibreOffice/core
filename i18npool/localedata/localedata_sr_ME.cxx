...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sr_ME(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sr_ME(sal_Int16& count)
    {
        return getLocaleItem_sr_RS(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x43, 0x43, 0x31, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_sr_ME(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    getContinuousNumberingLevels_sr_ME(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_sr_RS(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_sr_ME(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
