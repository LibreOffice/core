...
extern "C"
{
    static const sal_Unicode langID[] = { 0x63, 0x61, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x43, 0x61, 0x74, 0x61, 0x6c, 0x61, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ca_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ca_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20a7, 0x2d, 0x34, 0x30, 0x33, 0x5d, 0x0 };
    ...
    getAllFormats0_ca_ES(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ca_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ca_ES(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ca_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ca_ES(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ca_ES(sal_Int16& count)
    {
        return getIndexAlgorithm_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ca_ES(sal_Int16& count)
    {
        return getUnicodeScripts_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ca_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x64, 0x73, 0x2e, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[] = { 0x67, 0x65, 0x6e, 0x65, 0x72, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x67, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x66, 0x65, 0x62, 0x72, 0x2e, 0x0 };
    static const sal_Unicode monthDefaultFullName01[] = { 0x66, 0x65, 0x62, 0x72, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x69, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x61, 0x69, 0x67, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x6a, 0x75, 0x6e, 0x79, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x6a, 0x75, 0x6c, 0x69, 0x6f, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x6a, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x67, 0x2e, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x73, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x69, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x69, 0x67, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x6a, 0x75, 0x6e, 0x79, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x6a, 0x75, 0x6c, 0x69, 0x6f, 0x6c, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x61, 0x67, 0x2e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x69, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0x61, 0x69, 0x67, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x6a, 0x75, 0x6e, 0x79, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x61, 0x67, 0x2e, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName00[] = { 0x41, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x64, 0x43, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x44, 0x2e, 0x43, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ca_ES(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName1[] = { 0x45, 0x53, 0x50, 0x0 };
    ...
    static const sal_Unicode currencyName2[] = { 0x45, 0x53, 0x50, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ca_ES(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ca_ES(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x76, 0x65, 0x72, 0x69, 0x74, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x72, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x6e, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x72, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x74, 0x20, 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x73, 0x6f, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x73, 0x6f, 0x74, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ca_ES(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ca_ES(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ca_ES(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ca_ES(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ca_ES(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
