...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_fr_CA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_fr_CA(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43,
            0x30, 0x43, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x20,
            0x5b, 0x24, 0x24, 0x2d, 0x43, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x24, 0x2d,
            0x43, 0x30, 0x43, 0x5d, 0x3b, 0x2d, 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30,
            0x30, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43, 0x30,
            0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0xa0, 0x23,
            0x23, 0x30, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43,
            0x30, 0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0xa0, 0x23, 0x23,
            0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43,
            0x30, 0x43, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0xa0, 0x23, 0x23,
            0x30, 0x2c, 0x2d, 0x2d, 0x20, 0x5b, 0x24, 0x24, 0x2d, 0x43, 0x30, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode17[] = { 0x41, 0x41, 0x2d, 0x4d, 0x2d, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x4a, 0x4a, 0x2d, 0x4d, 0x4d, 0x4d, 0x20, 0x41, 0x41, 0x0 };
    ...
    static const sal_Unicode FormatCode33[] = { 0x41, 0x41, 0x2d, 0x4d, 0x4d, 0x0 };
    ...
    static const sal_Unicode FormatCode34[] = { 0x4d, 0x4d, 0x4d, 0x20, 0x4a, 0x4a, 0x0 };
    ...
    static const sal_Unicode FormatCode45[]
        = { 0x41, 0x41, 0x41, 0x41, 0x2d, 0x4d, 0x4d, 0x2d, 0x4a,
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x41, 0x41, 0x41, 0x41, 0x2d, 0x4d, 0x4d, 0x2d, 0x4a, 0x4a,
    ...
    getAllFormats0_fr_CA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_fr_CA(sal_Int16& count)
    {
    ...
    static const sal_Unicode eraRefName0[] = { 0x66, 0x72, 0x5f, 0x46, 0x52, 0x5f, 0x67, 0x72,
                                               0x65, 0x67, 0x6f, 0x72, 0x69, 0x61, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_fr_CA(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0x64, 0x6f, 0x6c, 0x6c, 0x61, 0x72, 0x20, 0x63,
                                                 0x61, 0x6e, 0x61, 0x64, 0x69, 0x65, 0x6e, 0x0 };
    ...
    getContinuousNumberingLevels_fr_CA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_fr_CA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
