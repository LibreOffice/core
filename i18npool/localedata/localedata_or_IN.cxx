...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6f, 0x72, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4f, 0x64, 0x69, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_or_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[]
        = { 0xb2a, 0xb42, 0xb30, 0xb4d, 0xb2c, 0xb3e, 0xb39, 0xb4d, 0xb28, 0x0 };
    static const sal_Unicode timePM[] = { 0xb05, 0xb2a, 0xb30, 0xb3e, 0xb39, 0xb4d, 0xb28, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_or_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20b9, 0x2d, 0x34, 0x34, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode17[] = { 0x44, 0x2f, 0x4d, 0x2f, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_or_IN(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_or_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_or_IN(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_or_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_or_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[] = { 0xb15, 0x2d, 0xb39, 0x0 };
    static const sal_Unicode defaultIndex0[] = { 1 };
    static const sal_Unicode defaultPhonetic0[] = { 0 };

    static const sal_Unicode unicodeScript0[] = { 0x31, 0x38, 0x0 };
    static const sal_Unicode followPageWord0[] = { 0xb2a, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0xb2a, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_or_IN(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_or_IN(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_or_IN(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0xb30, 0xb2c, 0xb3f, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0xb15, 0xb2c, 0xb3f, 0xb2c, 0xb3e, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0xb15, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0xb38, 0xb4b, 0xb2e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0xb38, 0xb4b, 0xb2e, 0xb2c, 0xb3e, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0xb38, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0xb2e, 0xb02, 0xb17, 0xb33, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0xb2e, 0xb02, 0xb17, 0xb33, 0xb2c, 0xb3e, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0xb2e, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0xb2c, 0xb41, 0xb27, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0xb2c, 0xb41, 0xb27, 0xb2c, 0xb3e, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0xb2c, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0xb17, 0xb41, 0xb30, 0xb41, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0xb17, 0xb41, 0xb30, 0xb41, 0xb2c, 0xb3e, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0xb17, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0xb36, 0xb41, 0xb15, 0xb4d, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0xb36, 0xb41, 0xb15, 0xb4d, 0xb30, 0xb2c, 0xb3e, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0xb36, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0xb36, 0xb28, 0xb3f, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0xb36, 0xb28, 0xb3f, 0xb2c, 0xb3e, 0xb30, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0xb36, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0xb1c, 0xb3e, 0xb28, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0xb1c, 0xb3e, 0xb28, 0xb41, 0xb06, 0xb30, 0xb40, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0xb1c, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0xb2b, 0xb47, 0xb2c, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0xb2b, 0xb47, 0xb2c, 0xb43, 0xb5f, 0xb3e, 0xb30, 0xb40, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0xb2b, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[]
        = { 0xb2e, 0xb3e, 0xb30, 0xb4d, 0xb1a, 0xb4d, 0xb1a, 0x0 };
    static const sal_Unicode monthDefaultFullName02[]
        = { 0xb2e, 0xb3e, 0xb30, 0xb4d, 0xb1a, 0xb4d, 0xb1a, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0xb2e, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[]
        = { 0xb0f, 0xb2a, 0xb4d, 0xb30, 0xb3f, 0xb32, 0x0 };
    static const sal_Unicode monthDefaultFullName03[]
        = { 0xb0f, 0xb2a, 0xb4d, 0xb30, 0xb3f, 0xb32, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0xb0f, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0xb2e, 0xb07, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0xb2e, 0xb07, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0xb2e, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0xb1c, 0xb41, 0xb28, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0xb1c, 0xb41, 0xb28, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0xb1c, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0xb1c, 0xb41, 0xb32, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0xb1c, 0xb41, 0xb32, 0xb3e, 0xb07, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0xb1c, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0xb05, 0xb17, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0xb05, 0xb17, 0xb37, 0xb4d, 0xb1f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0xb05, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0xb38, 0xb47, 0xb2a, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0xb38, 0xb47, 0xb2a, 0xb4d, 0xb1f, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0xb38, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0xb05, 0xb15, 0xb4d, 0xb1f, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0xb05, 0xb15, 0xb4d, 0xb1f, 0xb4b, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0xb05, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0xb28, 0xb2d, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0xb28, 0xb2d, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0xb28, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0xb21, 0xb3f, 0xb38, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0xb21, 0xb3f, 0xb38, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0xb21, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0xb1c, 0xb3e, 0xb28, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0xb1c, 0xb3e, 0xb28, 0xb41, 0xb06, 0xb30, 0xb40, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0xb1c, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0xb2b, 0xb47, 0xb2c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0xb2b, 0xb47, 0xb2c, 0xb43, 0xb5f, 0xb3e, 0xb30, 0xb40, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0xb2b, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0xb2e, 0xb3e, 0xb30, 0xb4d, 0xb1a, 0xb4d, 0xb1a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0xb2e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0xb0f, 0xb2a, 0xb4d, 0xb30, 0xb3f, 0xb32, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0xb0f, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0xb2e, 0xb07, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0xb2e, 0xb07, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0xb2e, 0x0 };
    static const sal_Unicode genitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0xb1c, 0xb41, 0xb28, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0xb1c, 0xb41, 0xb28, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0xb1c, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0xb1c, 0xb41, 0xb32, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0xb1c, 0xb41, 0xb32, 0xb3e, 0xb07, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0xb1c, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0xb05, 0xb17, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0xb05, 0xb17, 0xb37, 0xb4d, 0xb1f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0xb05, 0x0 };
    static const sal_Unicode genitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0xb38, 0xb47, 0xb2a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0xb38, 0xb47, 0xb2a, 0xb4d, 0xb1f, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0xb38, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[]
        = { 0xb05, 0xb15, 0xb4d, 0xb1f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0xb05, 0xb15, 0xb4d, 0xb1f, 0xb4b, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0xb05, 0x0 };
    static const sal_Unicode genitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0xb28, 0xb2d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0xb28, 0xb2d, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0xb28, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0xb21, 0xb3f, 0xb38, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0xb21, 0xb3f, 0xb38, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0xb21, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0xb1c, 0xb3e, 0xb28, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0xb1c, 0xb3e, 0xb28, 0xb41, 0xb06, 0xb30, 0xb40, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0xb1c, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0xb2b, 0xb47, 0xb2c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0xb2b, 0xb47, 0xb2c, 0xb43, 0xb5f, 0xb3e, 0xb30, 0xb40, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0xb2b, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0xb2e, 0xb3e, 0xb30, 0xb4d, 0xb1a, 0xb4d, 0xb1a, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0xb2e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0xb0f, 0xb2a, 0xb4d, 0xb30, 0xb3f, 0xb32, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0xb0f, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0xb2e, 0xb07, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0xb2e, 0xb07, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0xb2e, 0x0 };
    static const sal_Unicode partitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0xb1c, 0xb41, 0xb28, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0xb1c, 0xb41, 0xb28, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0xb1c, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0xb1c, 0xb41, 0xb32, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0xb1c, 0xb41, 0xb32, 0xb3e, 0xb07, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0xb1c, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0xb05, 0xb17, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0xb05, 0xb17, 0xb37, 0xb4d, 0xb1f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0xb05, 0x0 };
    static const sal_Unicode partitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0xb38, 0xb47, 0xb2a, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0xb38, 0xb47, 0xb2a, 0xb4d, 0xb1f, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0xb38, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0xb05, 0xb15, 0xb4d, 0xb1f, 0xb4b, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0xb05, 0x0 };
    static const sal_Unicode partitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0xb28, 0xb2d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0xb28, 0xb2d, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0xb28, 0x0 };
    static const sal_Unicode partitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0xb21, 0xb3f, 0xb38, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0xb21, 0xb3f, 0xb38, 0xb47, 0xb2e, 0xb4d, 0xb2c, 0xb30, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0xb21, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0xb16, 0xb4d, 0xb30, 0xb40, 0xb37, 0xb4d, 0xb1f,
            0x20,  0xb2a, 0xb42, 0xb30, 0xb4d, 0xb2c, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName01[]
        = { 0xb16, 0xb4d, 0xb30, 0xb40, 0xb37, 0xb4d, 0xb1f, 0xb3e, 0xb2c, 0xb4d, 0xb26, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_or_IN(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencySymbol1[] = { 0xb1f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_or_IN(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_or_IN(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0xb38, 0xb24, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0xb2e, 0xb3f, 0xb1b, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0xb2a, 0xb4d, 0xb30, 0xb25, 0xb2e, 0x20,  0xb24, 0xb4d,
            0xb30, 0xb48, 0xb2e, 0xb3e, 0xb38, 0xb3f, 0xb15, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0xb26, 0xb4d, 0xb2c, 0xb3f, 0xb24, 0xb40, 0xb5f, 0x20,  0xb24,
            0xb4d, 0xb30, 0xb48, 0xb2e, 0xb3e, 0xb38, 0xb3f, 0xb15, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0xb24, 0xb43, 0xb24, 0xb40, 0xb5f, 0x20,  0xb24, 0xb4d,
            0xb30, 0xb48, 0xb2e, 0xb3e, 0xb38, 0xb3f, 0xb15, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0xb1a, 0xb24, 0xb41, 0xb30, 0xb4d, 0xb25, 0x20,  0xb24, 0xb4d,
            0xb30, 0xb48, 0xb2e, 0xb3e, 0xb38, 0xb3f, 0xb15, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0xb09, 0xb2a, 0xb30, 0xb47, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0xb24, 0xb33, 0xb47, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_or_IN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_or_IN(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_or_IN(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_or_IN(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_or_IN(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
