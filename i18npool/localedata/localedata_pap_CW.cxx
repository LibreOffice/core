...
extern "C"
{
    static const sal_Unicode langID[] = { 0x70, 0x61, 0x70, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x50, 0x61, 0x70, 0x69, 0x61, 0x6d, 0x65, 0x6e, 0x74, 0x6f, 0x0 };
    static const sal_Unicode countryID[] = { 0x43, 0x57, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x43, 0x75, 0x72, 0x61, 0xe7, 0x61, 0x6f, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_pap_CW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_pap_CW(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x4e, 0x41, 0x66, 0x2d, 0x38, 0x34, 0x37, 0x39, 0x5d, 0x0 };
    ...
    getAllFormats0_pap_CW(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_pap_CW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_pap_CW(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_pap_CW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_pap_CW(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x2d, 0x5a, 0xc1, 0xc0, 0xdc, 0xd1, 0xc8, 0xc9, 0xd2,
            0xd3, 0xd6, 0xc7, 0xcc, 0xcd, 0xef, 0xd9, 0xda, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x73, 0x6c, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x73, 0x6c, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_pap_CW(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_pap_CW(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_pap_CW(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x64, 0x75, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x64, 0x6a, 0x61, 0x64, 0x75, 0x6d, 0x69, 0x6e, 0x67, 0x75, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x64, 0x6a, 0x61, 0x6c, 0x75, 0x6e, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x64, 0x6a, 0x61, 0x73, 0x61, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0xfc, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0xfc, 0x61, 0x72, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x70, 0x72, 0x65, 0x6c, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x41, 0x75, 0x67, 0x75, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x41, 0x43, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x41, 0x6e, 0x74, 0x65, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x69, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_pap_CW(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x41, 0x4e, 0x47, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x4e, 0x41, 0x66, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x41, 0x4e, 0x47, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x66, 0x6c, 0x6f, 0x72, 0x69, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_pap_CW(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_pap_CW(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x42, 0x65, 0x72, 0x64, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord1[]
        = { 0x4e, 0x6f, 0x20, 0x42, 0x65, 0x72, 0x64, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x4b, 0x77, 0x61, 0x72, 0x74, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x4b, 0x77, 0x61, 0x72, 0x74, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x4b, 0x77, 0x61, 0x72, 0x74, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x4b, 0x77, 0x61, 0x72, 0x74, 0x20, 0x34, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x41, 0x72, 0x69, 0x62, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x41, 0x62, 0x6f, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_pap_CW(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_pap_CW(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_pap_CW(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_pap_CW(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_pap_CW(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
