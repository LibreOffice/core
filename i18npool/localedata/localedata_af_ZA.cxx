...
extern "C"
{
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_af_ZA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_af_ZA(sal_Int16& count)
    {
        return getLocaleItem_en_ZA(count);
    }
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x52, 0x2d, 0x34, 0x33, 0x36, 0x5d, 0x0 };
    ...
    getAllFormats0_af_ZA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_af_ZA(sal_Int16& count)
    {
        return getDateAcceptancePatterns_en_ZA(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_af_ZA(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_af_ZA(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_af_ZA(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[] = { 0x62, 0x6c, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x62, 0x6c, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_af_ZA(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_af_ZA(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_af_ZA(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[] = { 0x53, 0x6f, 0x6e, 0x64, 0x61, 0x67, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x53, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x4d, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4d, 0x61, 0x61, 0x6e, 0x64, 0x61, 0x67, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x44, 0x6f, 0x6e, 0x64, 0x65, 0x72, 0x64, 0x61, 0x67, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x44, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x56, 0x72, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x56, 0x72, 0x79, 0x64, 0x61, 0x67, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x53, 0x61, 0x74, 0x65, 0x72, 0x64, 0x61, 0x67, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x4a, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x46, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x4d, 0x72, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x61, 0x72, 0x74, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x4a, 0x75, 0x6e, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x4a, 0x75, 0x6c, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x72, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x4d, 0x61, 0x61, 0x72, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x4d, 0x72, 0x74, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x76, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x76, 0x6f, 0x6f, 0x72, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x6e, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x6e, 0x61, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x75, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_af_ZA(sal_Int16& count)
    {
        count = calendarsCount;
        return (sal_Unicode**)calendars;
    }
    extern sal_Unicode** SAL_CALL getAllCurrencies_en_ZA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_af_ZA(sal_Int16& count)
    {
        return getAllCurrencies_en_ZA(count);
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_af_ZA(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x77, 0x61, 0x61, 0x72, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x76, 0x61, 0x6c, 0x73, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x65, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x65, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x65, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x65, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x62, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_af_ZA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_af_ZA(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_af_ZA(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_af_ZA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_af_ZA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
