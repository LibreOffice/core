...
extern "C"
{
    static const sal_Unicode langID[] = { 0x73, 0x6c, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x53, 0x6c, 0x6f, 0x76, 0x65, 0x6e, 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode countryID[] = { 0x53, 0x49, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x53, 0x6c, 0x6f, 0x76, 0x65, 0x6e, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sl_SI(sal_Int16& count)
    {
    ...
    static const sal_Unicode doubleQuotationStart[] = { 0xbb, 0x0 };
    static const sal_Unicode doubleQuotationEnd[] = { 0xab, 0x0 };
    static const sal_Unicode timeAM[] = { 0x64, 0x6f, 0x70, 0x2e, 0x0 };
    static const sal_Unicode timePM[] = { 0x70, 0x6f, 0x70, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sl_SI(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x53, 0x49, 0x54, 0x2d, 0x34, 0x32, 0x34, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode20[]
        = { 0x44, 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x2e, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode26[] = { 0x4e, 0x4e, 0x2e, 0x2c, 0x20, 0x44, 0x2e, 0x20,
    ...
    static const sal_Unicode FormatCode27[] = { 0x4e, 0x4e, 0x2c, 0x20, 0x44, 0x44, 0x2e, 0x20,
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x2e, 0x2c, 0x20, 0x44, 0x2e, 0x20, 0x4d,
    ...
    static const sal_Unicode FormatCode34[] = { 0x44, 0x44, 0x2e, 0x20, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    getAllFormats0_sl_SI(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    static const sal_Unicode DateAcceptancePattern1[]
        = { 0x44, 0x2e, 0x20, 0x4d, 0x2e, 0x20, 0x59, 0x0 };
    static const sal_Unicode DateAcceptancePattern2[] = { 0x44, 0x2e, 0x4d, 0x2e, 0x0 };
    static const sal_Unicode DateAcceptancePattern3[] = { 0x44, 0x2e, 0x20, 0x4d, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_sl_SI(sal_Int16& count)
    {
    ...
    static const sal_Unicode CollatorRule0[]
        = { 0x26,  0x43, 0x3c, 0x10d, 0x3c,  0x3c, 0x3c, 0x10c, 0x3c,  0x107, 0x3c, 0x3c,  0x3c,
            0x106, 0x26, 0x44, 0x3c,  0x111, 0x3c, 0x3c, 0x3c,  0x110, 0x26,  0x53, 0x3c,  0x161,
            0x3c,  0x3c, 0x3c, 0x160, 0x26,  0x5a, 0x3c, 0x17e, 0x3c,  0x3c,  0x3c, 0x17d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_sl_SI(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_sl_SI(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_sl_SI(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x2d, 0x43, 0x20, 0x10c, 0x20, 0x106, 0x20, 0x44, 0x20, 0x110, 0x20,
            0x45, 0x2d, 0x53, 0x20, 0x160, 0x20, 0x54,  0x2d, 0x5a, 0x20, 0x17d, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x73, 0x74, 0x72, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x73, 0x74, 0x72, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_sl_SI(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_sl_SI(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_sl_SI(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x6e, 0x65, 0x64, 0x65, 0x6c, 0x6a, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x70, 0x6f, 0x6e, 0x65, 0x64, 0x65, 0x6c, 0x6a, 0x65, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x70, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x74, 0x6f, 0x72, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x74, 0x6f, 0x72, 0x65, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x74, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x73, 0x72, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName03[] = { 0x73, 0x72, 0x65, 0x64, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x10d, 0x65, 0x74, 0x72, 0x74, 0x65, 0x6b, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[] = { 0x70, 0x65, 0x74, 0x65, 0x6b, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x76, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x61, 0x76, 0x67, 0x75, 0x73, 0x74, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x61, 0x76, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x61, 0x76, 0x67, 0x75, 0x73, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x61, 0x76, 0x67, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x70, 0x72, 0x2e, 0x20, 0x6e, 0x2e, 0x20, 0x161, 0x74, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x70, 0x72,  0x65, 0x64, 0x20, 0x6e, 0x61, 0x161, 0x69, 0x6d,
            0x20, 0x161, 0x74, 0x65, 0x74, 0x6a, 0x65, 0x6d,  0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x6e, 0x2e, 0x20, 0x161, 0x74, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x6e, 0x61, 0x161, 0x65, 0x67, 0x61, 0x20, 0x161, 0x74, 0x65, 0x74, 0x6a, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_sl_SI(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0x65, 0x76, 0x72, 0x6f, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x53, 0x49, 0x54, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x53, 0x49, 0x54, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x53, 0x49, 0x54, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x53, 0x6c, 0x6f, 0x76, 0x65, 0x6e, 0x73, 0x6b,
                                                 0x69, 0x20, 0x74, 0x6f, 0x6c, 0x61, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sl_SI(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sl_SI(sal_Int16& count)
    {
    ...
    static const sal_Unicode ReservedWord2[] = { 0x50, 0x72, 0x76, 0x6f, 0x20, 0x10d, 0x65, 0x74,
                                                 0x72, 0x74, 0x6c, 0x65, 0x74, 0x6a,  0x65, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x44, 0x72, 0x75, 0x67, 0x6f, 0x20, 0x10d, 0x65, 0x74,
            0x72, 0x74, 0x6c, 0x65, 0x74, 0x6a, 0x65,  0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x54, 0x72, 0x65, 0x74, 0x6a, 0x65, 0x20, 0x10d, 0x65,
            0x74, 0x72, 0x74, 0x6c, 0x65, 0x74, 0x6a, 0x65,  0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x10c, 0x65, 0x74, 0x72, 0x74, 0x6f, 0x20, 0x10d, 0x65,
            0x74,  0x72, 0x74, 0x6c, 0x65, 0x74, 0x6a, 0x65,  0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sl_SI(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sl_SI(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sl_SI(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_sl_SI(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_sl_SI(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
