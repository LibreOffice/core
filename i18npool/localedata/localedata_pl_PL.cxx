...
extern "C"
{
    static const sal_Unicode langID[] = { 0x70, 0x6c, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x50, 0x6f, 0x6c, 0x69, 0x73, 0x68, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_pl_PL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_pl_PL(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x7a, 0x142, 0x2d, 0x34, 0x31, 0x35, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode19[] = { 0x44, 0x2e, 0x4d, 0x4d, 0x2e, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode25[]
        = { 0x44, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59,
            0x59, 0x59, 0x20, 0x22, 0x72, 0x2e, 0x22, 0x0 };
    ...
    getAllFormats0_pl_PL(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_pl_PL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_pl_PL(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_pl_PL(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_pl_PL(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41,  0x20, 0x104, 0x20, 0x42, 0x20, 0x43,  0x20, 0x106, 0x20, 0x44, 0x20,
            0x45,  0x20, 0x118, 0x20, 0x46, 0x2d, 0x4c,  0x20, 0x141, 0x20, 0x4d, 0x20,
            0x4e,  0x20, 0x143, 0x20, 0x4f, 0x20, 0xd3,  0x20, 0x50,  0x2d, 0x53, 0x20,
            0x15a, 0x20, 0x54,  0x2d, 0x5a, 0x20, 0x179, 0x20, 0x17b, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_pl_PL(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_pl_PL(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_pl_PL(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x6e, 0x69, 0x65, 0x64, 0x7a, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x6e, 0x69, 0x65, 0x64, 0x7a, 0x69, 0x65, 0x6c, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x6e, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x70, 0x6f, 0x6e, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x70, 0x6f, 0x6e, 0x69, 0x65, 0x64, 0x7a, 0x69, 0x61, 0x142, 0x65, 0x6b, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x15b, 0x72, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName03[] = { 0x15b, 0x72, 0x6f, 0x64, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x15b, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x63, 0x7a, 0x77, 0x2e, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x63, 0x7a, 0x77, 0x61, 0x72, 0x74, 0x65, 0x6b, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[] = { 0x70, 0x69, 0x105, 0x74, 0x65, 0x6b, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x73, 0x74, 0x79, 0x63, 0x7a, 0x65, 0x144, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x6b, 0x77, 0x69, 0x65, 0x63, 0x69, 0x65, 0x144, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[]
        = { 0x63, 0x7a, 0x65, 0x72, 0x77, 0x69, 0x65, 0x63, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x73, 0x69, 0x65, 0x72, 0x70, 0x69, 0x65, 0x144, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x77, 0x72, 0x7a, 0x65, 0x73, 0x69, 0x65, 0x144, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x67, 0x72, 0x75, 0x64, 0x7a, 0x69, 0x65, 0x144, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x63, 0x7a, 0x65, 0x72, 0x77, 0x63, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_pl_PL(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x50, 0x4c, 0x4e, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x7a, 0x142, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x50, 0x4c, 0x4e, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x7a, 0x142, 0x6f, 0x74, 0x79, 0x20, 0x70, 0x6f, 0x6c, 0x73, 0x6b, 0x69, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x50, 0x4c, 0x5a, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x50, 0x4c, 0x5a, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x50, 0x4c, 0x5a, 0x0 };
    static const sal_Unicode currencyName1[]
        = { 0x7a, 0x142, 0x6f, 0x74, 0x79, 0x20, 0x70, 0x6f, 0x6c, 0x73, 0x6b, 0x69, 0x20,
            0x28, 0x31,  0x39, 0x35, 0x30, 0x2d, 0x31, 0x39, 0x39, 0x35, 0x29, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_pl_PL(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_pl_PL(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x70, 0x72, 0x61, 0x77, 0x64, 0x61, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x142, 0x73, 0x7a, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x49, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x142, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x49, 0x49, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x142, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x49, 0x49, 0x49, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x142, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x49, 0x56, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x142, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x70, 0x6f, 0x77, 0x79, 0x17c, 0x65, 0x6a, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x70, 0x6f, 0x6e, 0x69, 0x17c, 0x65, 0x6a, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_pl_PL(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_pl_PL(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_pl_PL(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_pl_PL(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_pl_PL(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
