...
extern "C"
{
    ...
    static const sal_Unicode Variant[]
        = { 0x73, 0x72, 0x2d, 0x4c, 0x61, 0x74, 0x6e, 0x2d, 0x52, 0x53, 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sr_Latn_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x70, 0x72, 0x65, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sr_Latn_RS(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCType);
        return (sal_Unicode**)LCType;
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x52, 0x53, 0x44, 0x2d, 0x38, 0x38, 0x31, 0x41, 0x5d, 0x0 };
    ...
    getAllFormats0_sr_Latn_RS(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    getDateAcceptancePatterns_sr_Latn_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode CollatorRule0[]
        = { 0x26,  0x43,  0x3c,  0x10d, 0x3c, 0x3c,  0x3c,  0x10c, 0x3c, 0x107, 0x3c,  0x3c,
            0x3c,  0x106, 0x26,  0x44,  0x3c, 0x111, 0x3c,  0x3c,  0x3c, 0x110, 0x26,  0x110,
            0x3c,  0x64,  0x17e, 0x3c,  0x3c, 0x3c,  0x44,  0x17e, 0x3c, 0x3c,  0x3c,  0x44,
            0x17d, 0x26,  0x4c,  0x3c,  0x6c, 0x6a,  0x3c,  0x3c,  0x3c, 0x4c,  0x6a,  0x3c,
            0x3c,  0x3c,  0x4c,  0x4a,  0x26, 0x4e,  0x3c,  0x6e,  0x6a, 0x3c,  0x3c,  0x3c,
            0x4e,  0x6a,  0x3c,  0x3c,  0x3c, 0x4e,  0x4a,  0x26,  0x53, 0x3c,  0x161, 0x3c,
            0x3c,  0x3c,  0x160, 0x26,  0x5a, 0x3c,  0x17e, 0x3c,  0x3c, 0x3c,  0x17d, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL
    getCollatorImplementation_sr_Latn_RS(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_sr_Latn_RS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_sr_Latn_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41,  0x2d, 0x50,  0x20, 0x52,  0x2d, 0x56,  0x20, 0x5a,  0x20,
            0x106, 0x20, 0x10c, 0x20, 0x160, 0x20, 0x17d, 0x20, 0x110, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_sr_Latn_RS(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_sr_Latn_RS(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_sr_Latn_RS(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x70, 0x6f, 0x6e, 0x65, 0x64, 0x65, 0x6c, 0x6a, 0x61, 0x6b, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x74, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x70, 0x74, 0x65, 0x6d, 0x62, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x6f, 0x6b, 0x74, 0x6f, 0x62, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x6e, 0x6f, 0x76, 0x65, 0x6d, 0x62, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x63, 0x65, 0x6d, 0x62, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x74, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x70, 0x2e, 0x20, 0x6e, 0x2e, 0x20, 0x65, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x70, 0x72, 0x65, 0x20, 0x6e, 0x6f, 0x76, 0x65, 0x20, 0x65, 0x72, 0x65, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x6e, 0x2e, 0x20, 0x65, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x6e, 0x6f, 0x76, 0x65, 0x20, 0x65, 0x72, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_sr_Latn_RS(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencySymbol0[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x52, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x53, 0x72, 0x70, 0x73, 0x6b, 0x69, 0x20, 0x64, 0x69, 0x6e, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode currencySymbol1[] = { 0x64, 0x69, 0x6e, 0x2e, 0x0 };
    ...
    static const sal_Unicode currencySymbol2[] = { 0x43, 0x53, 0x44, 0x0 };
    ...
    static const sal_Unicode currencySymbol3[] = { 0x44, 0x69, 0x6e, 0x0 };
    ...
    static const sal_Unicode currencySymbol4[] = { 0x44, 0x69, 0x6e, 0x0 };
    static const sal_Unicode bankSymbol4[] = { 0x43, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencyName4[]
        = { 0x53, 0x72, 0x70, 0x73, 0x6b, 0x69, 0x20, 0x64, 0x69, 0x6e, 0x61, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sr_Latn_RS(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sr_Latn_RS(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x74, 0x61, 0x10d, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x6e, 0x65, 0x74, 0x61, 0x10d, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x50, 0x72, 0x76, 0x69, 0x20, 0x6b, 0x76, 0x61, 0x72, 0x74,
            0x61, 0x6c, 0x20, 0x67, 0x6f, 0x64, 0x69, 0x6e, 0x65, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x44, 0x72, 0x75, 0x67, 0x69, 0x20, 0x6b, 0x76, 0x61, 0x72, 0x74,
            0x61, 0x6c, 0x20, 0x67, 0x6f, 0x64, 0x69, 0x6e, 0x65, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x54, 0x72, 0x65, 0x107, 0x69, 0x20, 0x6b, 0x76, 0x61, 0x72, 0x74,
            0x61, 0x6c, 0x20, 0x67,  0x6f, 0x64, 0x69, 0x6e, 0x65, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x10c, 0x65, 0x74, 0x76, 0x72, 0x74, 0x69, 0x20, 0x6b, 0x76, 0x61, 0x72,
            0x74,  0x61, 0x6c, 0x20, 0x67, 0x6f, 0x64, 0x69, 0x6e, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sr_Latn_RS(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sr_Latn_RS(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sr_Latn_RS(sal_Int16& count)
    {
        count = 5;
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_sr_RS(sal_Int16& nStyles,
                                                                          sal_Int16& nLevels,
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_sr_Latn_RS(
