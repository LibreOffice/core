...
extern "C"
{
    static const sal_Unicode langID[] = { 0x69, 0x61, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6c, 0x69, 0x6e, 0x67, 0x75, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ia(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ia(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x36, 0x31, 0x32, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x4e, 0x4e, 0x20, 0x22, 0x6c, 0x65, 0x22, 0x20, 0x44, 0x20, 0x22,
            0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x4e, 0x4e, 0x20, 0x22, 0x6c, 0x65, 0x22, 0x20, 0x44, 0x20, 0x22, 0x64, 0x65,
            0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x22, 0x6c, 0x65, 0x22, 0x20, 0x44, 0x20, 0x22, 0x64,
            0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_ia(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ia(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ia(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ia(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ia(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ia(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ia(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ia(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x64, 0x6f, 0x6d, 0x69, 0x6e, 0x69, 0x63, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[] = { 0x6c, 0x75, 0x6e, 0x65, 0x64, 0x69, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x6d, 0x61, 0x72, 0x74, 0x65, 0x64, 0x69, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x69, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x6a, 0x6f, 0x76, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x6a, 0x6f, 0x76, 0x65, 0x64, 0x69, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x76, 0x65, 0x6e, 0x65, 0x72, 0x64, 0x69, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x73, 0x61, 0x62, 0x62, 0x61, 0x74, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x6a, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x74, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x61, 0x75, 0x67, 0x75, 0x73, 0x74, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x6d, 0x61, 0x72, 0x74, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x61, 0x2e, 0x43, 0x68, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x61, 0x6e, 0x74, 0x65, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x70, 0x2e, 0x43, 0x68, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x70, 0x6f, 0x73, 0x74, 0x20, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ia(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID1[] = { 0x55, 0x53, 0x44, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x24, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x55, 0x53, 0x44, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ia(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ia(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x76, 0x65, 0x72, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x65, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x31, 0x2d, 0x6d, 0x65, 0x20, 0x74, 0x72, 0x69,
                                                 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x32, 0x2d, 0x6e, 0x64, 0x65, 0x20, 0x74, 0x72,
                                                 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x33, 0x2d, 0x74, 0x69, 0x65, 0x20, 0x74, 0x72,
                                                 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x34, 0x2d, 0x74, 0x65, 0x20, 0x74, 0x72, 0x69,
                                                 0x6d, 0x65, 0x73, 0x74, 0x72, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ia(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ia(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ia(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ia(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ia(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
