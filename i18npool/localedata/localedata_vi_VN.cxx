...
extern "C"
{
    static const sal_Unicode langID[] = { 0x76, 0x69, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x56, 0x69, 0x65, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x65, 0x0 };
    static const sal_Unicode countryID[] = { 0x56, 0x4e, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x56, 0x69, 0x65, 0x74, 0x6e, 0x61, 0x6d, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_vi_VN(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x73, 0xe1, 0x6e, 0x67, 0x0 };
    static const sal_Unicode timePM[] = { 0x63, 0x68, 0x69, 0x1ec1, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_vi_VN(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ab, 0x2d, 0x34, 0x32, 0x41, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode26[] = { 0x4e, 0x4e, 0x4e, 0x2c, 0x20, 0x44, 0x20, 0x4d,
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x20, 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x2f, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x4e, 0x2c, 0x20, 0x44, 0x20, 0x4d, 0x4d,
            0x4d, 0x4d, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode34[] = { 0x44, 0x44, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x0 };
    ...
    getAllFormats0_vi_VN(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_vi_VN(sal_Int16& count)
    {
    ...
    static const sal_Unicode CollatorRule0[]
        = { 0x26, 0x300, 0x3c, 0x3c, 0x309, 0x3c, 0x3c,  0x303, 0x3c, 0x3c,  0x301, 0x3c,
            0x3c, 0x323, 0x20, 0x26, 0x61,  0x3c, 0x103, 0x3c,  0x3c, 0x3c,  0x102, 0x3c,
            0xe2, 0x3c,  0x3c, 0x3c, 0xc2,  0x20, 0x26,  0x64,  0x3c, 0x111, 0x3c,  0x3c,
            0x3c, 0x110, 0x20, 0x26, 0x65,  0x3c, 0xea,  0x3c,  0x3c, 0x3c,  0xca,  0x20,
            0x26, 0x6f,  0x3c, 0xf4, 0x3c,  0x3c, 0x3c,  0xd4,  0x3c, 0x1a1, 0x3c,  0x3c,
            0x3c, 0x1a0, 0x20, 0x26, 0x75,  0x3c, 0x1b0, 0x3c,  0x3c, 0x3c,  0x1af, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_vi_VN(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_vi_VN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_vi_VN(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[] = { 0x74, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x74, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_vi_VN(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_vi_VN(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_vi_VN(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[]
        = { 0x43, 0x68, 0x1ee7, 0x20, 0x4e, 0x68, 0x1ead, 0x74, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName01[]
        = { 0x54, 0x68, 0x1ee9, 0x20, 0x48, 0x61, 0x69, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x54, 0x68, 0x1ee9, 0x20, 0x48, 0x61, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x54, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[]
        = { 0x54, 0x68, 0x1ee9, 0x20, 0x42, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x54, 0x68, 0x1ee9, 0x20, 0x42, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName03[]
        = { 0x54, 0x68, 0x1ee9, 0x20, 0x54, 0x1b0, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName04[]
        = { 0x54, 0x68, 0x1ee9, 0x20, 0x4e, 0x103, 0x6d, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName010[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x31, 0x31, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName011[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x31, 0x32, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x31, 0x32, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x32, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x33, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x34, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x35, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x36, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x38, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x39, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x31, 0x32, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x32, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x33, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x34, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x35, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x36, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x38, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x30, 0x39, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0x54, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0x54, 0x68, 0xe1, 0x6e, 0x67, 0x20, 0x31, 0x32, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0x54, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x54, 0x43, 0x4e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x54, 0x72, 0x1b0, 0x1edb, 0x63, 0x20, 0x43, 0xf4, 0x6e,
            0x67, 0x20, 0x4e,  0x67,   0x75, 0x79, 0xea, 0x6e, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x53, 0x43, 0x4e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x53, 0x61, 0x75, 0x20, 0x43, 0xf4, 0x6e, 0x67,
            0x20, 0x4e, 0x67, 0x75, 0x79, 0xea, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_vi_VN(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x56, 0x4e, 0x44, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x20ab, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x56, 0x4e, 0x44, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x56, 0x69, 0x1ec7, 0x74,   0x20, 0x4e, 0x61,
                                                 0x6d, 0x20, 0x110,  0x1ed3, 0x6e, 0x67, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_vi_VN(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_vi_VN(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x111, 0xfa, 0x6e, 0x67, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x73, 0x61, 0x69, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x71, 0x75, 0xfd, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x71, 0x75, 0xfd, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x71, 0x75, 0xfd, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x71, 0x75, 0xfd, 0x20, 0x34, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x74, 0x72, 0xea, 0x6e, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x64, 0x1b0, 0x1edb, 0x69, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_vi_VN(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_vi_VN(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_vi_VN(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_vi_VN(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_vi_VN(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
