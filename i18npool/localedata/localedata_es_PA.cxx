...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x50, 0x41, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x50, 0x61, 0x6e, 0x61, 0x6d, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_es_PA(sal_Int16& count)
    {
        count = SAL_N_ELEMENTS(LCInfoArray);
        return (sal_Unicode**)LCInfoArray;
    }
    extern sal_Unicode** SAL_CALL getLocaleItem_es_GT(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_es_PA(sal_Int16& count)
    {
        return getLocaleItem_es_GT(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x42, 0x2f, 0x2e, 0x2d, 0x31, 0x38, 0x30, 0x41, 0x5d, 0x0 };
    extern sal_Unicode const* const* SAL_CALL getAllFormats0_es_GT(sal_Int16& count,
                                                                   const sal_Unicode*& from,
                                                                   const sal_Unicode*& to);
    SAL_DLLPUBLIC_EXPORT sal_Unicode const* const* SAL_CALL
    getAllFormats0_es_PA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
        const sal_Unicode* tmp;
        return getAllFormats0_es_GT(count, from, tmp);
    }
    extern sal_Unicode** SAL_CALL getDateAcceptancePatterns_es_GT(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_es_PA(sal_Int16& count)
    {
        return getDateAcceptancePatterns_es_GT(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_es_PA(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_es_PA(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_es_PA(sal_Int16& count)
    {
        return getSearchOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_es_ES(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_es_PA(sal_Int16& count)
    {
        return getIndexAlgorithm_es_ES(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_es_ES(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_es_PA(sal_Int16& count)
    {
        return getUnicodeScripts_es_ES(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_es_ES(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_es_PA(sal_Int16& count)
    {
        return getFollowPageWords_es_ES(count);
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_es_AR(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_es_PA(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x50, 0x41, 0x42, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x42, 0x2f, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x50, 0x41, 0x42, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x42, 0x61, 0x6c, 0x62, 0x6f, 0x61, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x50, 0x41, 0x42, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x42, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x50, 0x41, 0x42, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x42, 0x61, 0x6c, 0x62, 0x6f, 0x61, 0x0 };
    ...
    getContinuousNumberingLevels_es_PA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_es_PA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
