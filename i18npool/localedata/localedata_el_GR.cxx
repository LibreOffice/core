...
extern "C"
{
    static const sal_Unicode langID[] = { 0x65, 0x6c, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x47, 0x72, 0x65, 0x65, 0x6b, 0x0 };
    static const sal_Unicode countryID[] = { 0x47, 0x52, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x47, 0x72, 0x65, 0x65, 0x63, 0x65, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_el_GR(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x3a0, 0x39c, 0x0 };
    static const sal_Unicode timePM[] = { 0x39c, 0x39c, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_el_GR(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0x2e, 0x23,  0x23,  0x30,  0x20, 0x5b, 0x24, 0x394, 0x3c1, 0x3c7, 0x2d,
            0x34, 0x30, 0x38,  0x5d,  0x3b,  0x2d, 0x23, 0x2e, 0x23,  0x23,  0x30,  0x20,
            0x5b, 0x24, 0x394, 0x3c1, 0x3c7, 0x2d, 0x34, 0x30, 0x38,  0x5d,  0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23,  0x2e,  0x23,  0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24,
            0x394, 0x3c1, 0x3c7, 0x2d, 0x34, 0x30, 0x38, 0x5d, 0x3b, 0x2d, 0x23,
            0x2e,  0x23,  0x23,  0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x394,
            0x3c1, 0x3c7, 0x2d,  0x34, 0x30, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23,  0x2e,  0x23,  0x23,  0x30, 0x20, 0x5b, 0x24, 0x394, 0x3c1,
            0x3c7, 0x2d,  0x34,  0x30,  0x38, 0x5d, 0x3b, 0x5b, 0x52,  0x45,
            0x44,  0x5d,  0x2d,  0x23,  0x2e, 0x23, 0x23, 0x30, 0x20,  0x5b,
            0x24,  0x394, 0x3c1, 0x3c7, 0x2d, 0x34, 0x30, 0x38, 0x5d,  0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23,  0x2e,  0x23,  0x23,  0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x394,
            0x3c1, 0x3c7, 0x2d,  0x34,  0x30, 0x38, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23,  0x2e,  0x23,  0x23,  0x30, 0x2c, 0x2d, 0x2d, 0x20, 0x5b, 0x24, 0x394,
            0x3c1, 0x3c7, 0x2d,  0x34,  0x30, 0x38, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
    ...
    getAllFormats0_el_GR(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_el_GR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_el_GR(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_el_GR(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_el_GR(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[] = { 0x3b1, 0x2d, 0x3c9, 0x0 };
    static const sal_Unicode defaultIndex0[] = { 1 };
    static const sal_Unicode defaultPhonetic0[] = { 0 };

    static const sal_Unicode unicodeScript0[] = { 0x37, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_el_GR(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_el_GR(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_el_GR(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x39a, 0x3c5, 0x3c1, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x39a, 0x3c5, 0x3c1, 0x3b9, 0x3b1, 0x3ba, 0x3ae, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x39a, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x394, 0x3b5, 0x3c5, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x394, 0x3b5, 0x3c5, 0x3c4, 0x3ad, 0x3c1, 0x3b1, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x394, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x3a4, 0x3c1, 0x3b9, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x3a4, 0x3c1, 0x3af, 0x3c4, 0x3b7, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x3a4, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x3a4, 0x3b5, 0x3c4, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x3a4, 0x3b5, 0x3c4, 0x3ac, 0x3c1, 0x3c4, 0x3b7, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x3a4, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x3a0, 0x3b5, 0x3bc, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x3a0, 0x3ad, 0x3bc, 0x3c0, 0x3c4, 0x3b7, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x3a0, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x3a0, 0x3b1, 0x3c1, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x3a0, 0x3b1, 0x3c1, 0x3b1, 0x3c3, 0x3ba, 0x3b5, 0x3c5, 0x3ae, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x3a0, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x3a3, 0x3b1, 0x3b2, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x3a3, 0x3ac, 0x3b2, 0x3b2, 0x3b1, 0x3c4, 0x3bf, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x3a3, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x399, 0x3b1, 0x3bd, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x399, 0x3b1, 0x3bd, 0x3bf, 0x3c5, 0x3b1, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x399, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x3a6, 0x3b5, 0x3b2, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x3a6, 0x3b5, 0x3b2, 0x3c1, 0x3bf, 0x3c5, 0x3b1, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x3a6, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x39c, 0x3b1, 0x3c1, 0x0 };
    static const sal_Unicode monthDefaultFullName02[]
        = { 0x39c, 0x3b1, 0x3c1, 0x3c4, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x39c, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x391, 0x3c0, 0x3c1, 0x0 };
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x391, 0x3c0, 0x3c1, 0x3b9, 0x3bb, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x391, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x39c, 0x3b1, 0x3ca, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x39c, 0x3b1, 0x390, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x39c, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x399, 0x3bf, 0x3c5, 0x3bd, 0x0 };
    static const sal_Unicode monthDefaultFullName05[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bd, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x399, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x399, 0x3bf, 0x3c5, 0x3bb, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bb, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x399, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x391, 0x3c5, 0x3b3, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x391, 0x3c5, 0x3b3, 0x3bf, 0x3cd, 0x3c3, 0x3c4, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x391, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x3a3, 0x3b5, 0x3c0, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x3a3, 0x3b5, 0x3c0, 0x3c4, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x3a3, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x39f, 0x3ba, 0x3c4, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x39f, 0x3ba, 0x3c4, 0x3c9, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x39f, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x39d, 0x3bf, 0x3b5, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x39d, 0x3bf, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x39d, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x394, 0x3b5, 0x3ba, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x394, 0x3b5, 0x3ba, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x394, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x399, 0x3b1, 0x3bd, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x399, 0x3b1, 0x3bd, 0x3bf, 0x3c5, 0x3b1, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x399, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x3a6, 0x3b5, 0x3b2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x3a6, 0x3b5, 0x3b2, 0x3c1, 0x3bf, 0x3c5, 0x3b1, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x3a6, 0x0 };
    static const sal_Unicode genitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x39c, 0x3b1, 0x3c1, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x39c, 0x3b1, 0x3c1, 0x3c4, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0x39c, 0x0 };
    static const sal_Unicode genitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x391, 0x3c0, 0x3c1, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x391, 0x3c0, 0x3c1, 0x3b9, 0x3bb, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0x391, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x39c, 0x3b1, 0x3ca, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0x39c, 0x3b1, 0x390, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0x39c, 0x0 };
    static const sal_Unicode genitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bd, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bd, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x399, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bb, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bb, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x399, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x391, 0x3c5, 0x3b3, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x391, 0x3c5, 0x3b3, 0x3bf, 0x3cd, 0x3c3, 0x3c4, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0x391, 0x0 };
    static const sal_Unicode genitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x3a3, 0x3b5, 0x3c0, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x3a3, 0x3b5, 0x3c0, 0x3c4, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0x3a3, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x39f, 0x3ba, 0x3c4, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x39f, 0x3ba, 0x3c4, 0x3c9, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0x39f, 0x0 };
    static const sal_Unicode genitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x39d, 0x3bf, 0x3b5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x39d, 0x3bf, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0x39d, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x394, 0x3b5, 0x3ba, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x394, 0x3b5, 0x3ba, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0x394, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x399, 0x3b1, 0x3bd, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x399, 0x3b1, 0x3bd, 0x3bf, 0x3c5, 0x3b1, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x399, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x3a6, 0x3b5, 0x3b2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x3a6, 0x3b5, 0x3b2, 0x3c1, 0x3bf, 0x3c5, 0x3b1, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x3a6, 0x0 };
    static const sal_Unicode partitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x39c, 0x3b1, 0x3c1, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0x39c, 0x3b1, 0x3c1, 0x3c4, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0x39c, 0x0 };
    static const sal_Unicode partitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x391, 0x3c0, 0x3c1, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0x391, 0x3c0, 0x3c1, 0x3b9, 0x3bb, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0x391, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x39c, 0x3b1, 0x3ca, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[]
        = { 0x39c, 0x3b1, 0x390, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0x39c, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bd, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x399, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0x399, 0x3bf, 0x3c5, 0x3bb, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x399, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x391, 0x3c5, 0x3b3, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0x391, 0x3c5, 0x3b3, 0x3bf, 0x3cd, 0x3c3, 0x3c4, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0x391, 0x0 };
    static const sal_Unicode partitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x3a3, 0x3b5, 0x3c0, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0x3a3, 0x3b5, 0x3c0, 0x3c4, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0x3a3, 0x0 };
    static const sal_Unicode partitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x39f, 0x3ba, 0x3c4, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0x39f, 0x3ba, 0x3c4, 0x3c9, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0x39f, 0x0 };
    static const sal_Unicode partitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x39d, 0x3bf, 0x3b5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0x39d, 0x3bf, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0x39d, 0x0 };
    static const sal_Unicode partitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x394, 0x3b5, 0x3ba, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0x394, 0x3b5, 0x3ba, 0x3b5, 0x3bc, 0x3b2, 0x3c1, 0x3af, 0x3bf, 0x3c5, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0x394, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x3c0, 0x2e, 0x3a7, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[] = { 0x42, 0x43, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x3bc, 0x2e, 0x3a7, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_el_GR(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0x395, 0x3c5, 0x3c1, 0x3ce, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x47, 0x52, 0x44, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x394, 0x3c1, 0x3c7, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x47, 0x52, 0x44, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x394, 0x3c1, 0x3c7, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_el_GR(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_el_GR(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x3c3, 0x3c9, 0x3c3, 0x3c4, 0x3cc, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x3bb, 0x3ac, 0x3b8, 0x3bf, 0x3c2, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x31, 0x3bf, 0x20, 0x3c4, 0x3c1, 0x3af, 0x3bc, 0x3b7, 0x3bd, 0x3bf, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x32, 0x3bf, 0x20, 0x3c4, 0x3c1, 0x3af, 0x3bc, 0x3b7, 0x3bd, 0x3bf, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x33, 0x3bf, 0x20, 0x3c4, 0x3c1, 0x3af, 0x3bc, 0x3b7, 0x3bd, 0x3bf, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x34, 0x3bf, 0x20, 0x3c4, 0x3c1, 0x3af, 0x3bc, 0x3b7, 0x3bd, 0x3bf, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x3b5, 0x3c0, 0x3ac, 0x3bd, 0x3c9, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x3ba, 0x3ac, 0x3c4, 0x3c9, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_el_GR(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_el_GR(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_el_GR(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_el_GR(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_el_GR(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
