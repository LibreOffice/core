...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6d, 0x79, 0x76, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x45, 0x72, 0x7a, 0x79, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_myv_RU(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x432, 0x2e, 0x43c, 0x2e, 0x0 };
    static const sal_Unicode timePM[] = { 0x447, 0x2e, 0x43b, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_myv_RU(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20bd, 0x2d, 0x36, 0x36, 0x43, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0x2c, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45,
            0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x20,
            0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x20, 0x5b, 0x43, 0x55, 0x52, 0x52,
            0x45, 0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30,
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0x2c, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43,
            0x59, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30,
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x20, 0x5b, 0x43, 0x55,
            0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x20, 0x5b,
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x20, 0x5b, 0x43, 0x55,
            0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x2d, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x20, 0x5b,
            0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x0 };
    ...
    getAllFormats0_myv_RU(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_myv_RU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_myv_RU(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_myv_RU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_myv_RU(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[] = { 0x410, 0x2d, 0x42f, 0x20, 0x401, 0x20, 0x4a4, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x43b, 0x43b, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x43b, 0x43b, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_myv_RU(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_myv_RU(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_myv_RU(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x442, 0x430, 0x440, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x442, 0x430, 0x440, 0x433, 0x43e, 0x447, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x442, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x430, 0x442, 0x44f, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x430, 0x442, 0x44f, 0x43d, 0x44c, 0x447, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x430, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x432, 0x430, 0x441, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x432, 0x430, 0x441, 0x442, 0x430, 0x43d, 0x44c, 0x447, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x432, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x43a, 0x443, 0x43d, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x43a, 0x443, 0x43d, 0x448, 0x43a, 0x430, 0x447, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x43a, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x43a, 0x430, 0x43b, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x43a, 0x430, 0x43b, 0x447, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x43a, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x441, 0x44e, 0x43a, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x441, 0x44e, 0x43a, 0x43e, 0x43d, 0x44c, 0x447, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x441, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x448, 0x43b, 0x44f, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x448, 0x43b, 0x44f, 0x43c, 0x43e, 0x43d, 0x44c, 0x447, 0x438, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x448, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x44f, 0x43a, 0x448, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x44f, 0x43a, 0x448, 0x430, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x44f, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x434, 0x430, 0x432, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x434, 0x430, 0x432, 0x43e, 0x43b, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x434, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x44d, 0x439, 0x437, 0x0 };
    static const sal_Unicode monthDefaultFullName02[]
        = { 0x44d, 0x439, 0x437, 0x44e, 0x440, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x44d, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x447, 0x430, 0x434, 0x0 };
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x447, 0x430, 0x434, 0x44b, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x447, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x43f, 0x430, 0x43d, 0x0 };
    static const sal_Unicode monthDefaultFullName04[]
        = { 0x43f, 0x430, 0x43d, 0x436, 0x438, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x43f, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x430, 0x448, 0x442, 0x0 };
    static const sal_Unicode monthDefaultFullName05[]
        = { 0x430, 0x448, 0x442, 0x435, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x430, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x43c, 0x435, 0x434, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x43c, 0x435, 0x434, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x43c, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x443, 0x43c, 0x430, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x443, 0x43c, 0x430, 0x440, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x443, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x442, 0x430, 0x448, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x442, 0x430, 0x448, 0x442, 0x430, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x442, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x43e, 0x436, 0x43e, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x43e, 0x436, 0x43e, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x43e, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x441, 0x443, 0x43d, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x441, 0x443, 0x43d, 0x434, 0x435, 0x440, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x441, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x430, 0x446, 0x430, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x430, 0x446, 0x430, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x430, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x44f, 0x43a, 0x448, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x434, 0x430, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x434, 0x430, 0x432, 0x43e, 0x43b, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x434, 0x0 };
    static const sal_Unicode genitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x44d, 0x439, 0x437, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x44d, 0x439, 0x437, 0x44e, 0x440, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0x44d, 0x0 };
    static const sal_Unicode genitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x447, 0x430, 0x434, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x447, 0x430, 0x434, 0x44b, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0x447, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x43f, 0x430, 0x43d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0x43f, 0x430, 0x43d, 0x436, 0x438, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0x43f, 0x0 };
    static const sal_Unicode genitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x430, 0x448, 0x442, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x430, 0x448, 0x442, 0x435, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x430, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x43c, 0x435, 0x434, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x43c, 0x435, 0x434, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x43c, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x443, 0x43c, 0x430, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x443, 0x43c, 0x430, 0x440, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0x443, 0x0 };
    static const sal_Unicode genitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x442, 0x430, 0x448, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x442, 0x430, 0x448, 0x442, 0x430, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0x442, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x43e, 0x436, 0x43e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x441, 0x443, 0x43d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x441, 0x443, 0x43d, 0x434, 0x435, 0x440, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0x441, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x430, 0x446, 0x430, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x430, 0x446, 0x430, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0x430, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x44f, 0x43a, 0x448, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x434, 0x430, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x434, 0x430, 0x432, 0x43e, 0x43b, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x434, 0x0 };
    static const sal_Unicode partitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x44d, 0x439, 0x437, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0x44d, 0x439, 0x437, 0x44e, 0x440, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0x44d, 0x0 };
    static const sal_Unicode partitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x447, 0x430, 0x434, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0x447, 0x430, 0x434, 0x44b, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0x447, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x43f, 0x430, 0x43d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[]
        = { 0x43f, 0x430, 0x43d, 0x436, 0x438, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0x43f, 0x0 };
    static const sal_Unicode partitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x430, 0x448, 0x442, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x430, 0x448, 0x442, 0x435, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x430, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x43c, 0x435, 0x434, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0x43c, 0x435, 0x434, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x43c, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x443, 0x43c, 0x430, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0x443, 0x43c, 0x430, 0x440, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0x443, 0x0 };
    static const sal_Unicode partitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x442, 0x430, 0x448, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0x442, 0x430, 0x448, 0x442, 0x430, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0x442, 0x0 };
    static const sal_Unicode partitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x43e, 0x436, 0x43e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x441, 0x443, 0x43d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0x441, 0x443, 0x43d, 0x434, 0x435, 0x440, 0x44c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0x441, 0x0 };
    static const sal_Unicode partitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x430, 0x446, 0x430, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0x430, 0x446, 0x430, 0x43c, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0x430, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x43c, 0x2e, 0x43f, 0x2e, 0x438, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x41c, 0x438, 0x43d, 0x435, 0x43a, 0x20,  0x43f, 0x438, 0x43d, 0x433, 0x435,
            0x434, 0x435, 0x20,  0x438, 0x43a, 0x435, 0x43b, 0x435, 0x43d, 0x44c, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x43c, 0x2e, 0x43f, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x41c, 0x438, 0x43d, 0x435, 0x43a, 0x20,  0x43f,
            0x438, 0x43d, 0x433, 0x435, 0x43d, 0x44c, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_myv_RU(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[]
        = { 0x426, 0x435, 0x43b, 0x44c, 0x43a, 0x43e, 0x432, 0x43e, 0x439, 0x0 };
    ...
    static const sal_Unicode currencySymbol1[] = { 0x446, 0x435, 0x43b, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_myv_RU(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_myv_RU(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x412, 0x438, 0x434, 0x435, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x410, 0x432, 0x438, 0x434, 0x435, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x412, 0x430, 0x441, 0x435, 0x43d, 0x446, 0x435, 0x20, 0x43a,
            0x43e, 0x43b, 0x43c, 0x43e, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x41e, 0x43c, 0x431, 0x43e, 0x446, 0x435, 0x20,  0x43a,
            0x43e, 0x43b, 0x43c, 0x43e, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x41a, 0x43e, 0x43b, 0x43c, 0x43e, 0x446, 0x435, 0x20, 0x43a,
            0x43e, 0x43b, 0x43c, 0x43e, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x41d, 0x438, 0x43b, 0x435, 0x446, 0x435, 0x20,  0x43a,
            0x43e, 0x43b, 0x43c, 0x43e, 0x43a, 0x43e, 0x432, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x412, 0x435, 0x440, 0x435, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x410, 0x43b, 0x43e, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x31, 0x43a, 0x43a, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x32, 0x43a, 0x43a, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x33, 0x43a, 0x43a, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x34, 0x43a, 0x43a, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_myv_RU(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_myv_RU(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_myv_RU(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_myv_RU(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_myv_RU(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
