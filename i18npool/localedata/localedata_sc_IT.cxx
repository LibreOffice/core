...
extern "C"
{
    static const sal_Unicode langID[] = { 0x73, 0x63, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x53, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode countryID[] = { 0x49, 0x54, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x49, 0x74, 0x61, 0x6c, 0x79, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_sc_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_sc_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x36, 0x32, 0x37, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            0x2c, 0x23, 0x23, 0x30, 0x3b, 0x2d, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45,
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2c, 0x23,
            0x23, 0x30, 0x2e, 0x30, 0x30, 0x3b, 0x2d, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e,
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2c, 0x23,
            0x23, 0x30, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x5b, 0x43, 0x55, 0x52, 0x52,
            0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode15[]
        = { 0x43, 0x43, 0x43, 0x20, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            ...
            0x5d, 0x2d, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d,
            0x20, 0x23, 0x2c, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d, 0x0 };
    ...
    getAllFormats0_sc_IT(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_sc_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_sc_IT(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_sc_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_sc_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode followPageWord0[] = { 0x73, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x73, 0x73, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_sc_IT(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_sc_IT(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_sc_IT(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x44, 0x6f, 0x6d, 0xec, 0x6e, 0x69, 0x67, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[] = { 0x4c, 0x75, 0x6e, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName02[] = { 0x4d, 0x61, 0x72, 0x74, 0x69, 0x73, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x4d, 0xe8, 0x72, 0x63, 0x75, 0x72, 0x69, 0x73, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x4d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x47, 0x69, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x47, 0x69, 0xf2, 0x76, 0x69, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x47, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x43, 0x68, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x43, 0x68, 0x65, 0x6e, 0xe0, 0x62, 0x75, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[] = { 0x53, 0xe0, 0x62, 0x61, 0x64, 0x75, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x53, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x47, 0x68, 0x65, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x47, 0x68, 0x65, 0x6e, 0x6e, 0xe0, 0x72, 0x67, 0x69, 0x75, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x47, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x46, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x72, 0x65, 0xe0, 0x72, 0x67, 0x69, 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x72, 0x74, 0x7a, 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x62, 0x72, 0x69, 0x6c, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x41, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x4d, 0x61, 0x6a, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x61, 0x6a, 0x75, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x4d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x4c, 0xe0, 0x6d, 0x0 };
    static const sal_Unicode monthDefaultFullName05[]
        = { 0x4c, 0xe0, 0x6d, 0x70, 0x61, 0x64, 0x61, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x4c, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x54, 0x72, 0xec, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x54, 0x72, 0xec, 0x75, 0x6c, 0x61, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x54, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x41, 0x75, 0x73, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x41, 0x75, 0x73, 0x74, 0x75, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x41, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x43, 0x61, 0x62, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x43, 0x61, 0x62, 0x75, 0x64, 0x61, 0x6e, 0x6e, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x43, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x53, 0x67, 0x61, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x53, 0x61, 0x6e, 0x74, 0x75, 0x67, 0x61, 0x69, 0x6e, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x53, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x53, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x53, 0x61, 0x6e, 0x74, 0x61, 0x6e, 0x64, 0x72, 0x69, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x53, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x4e, 0x61, 0x64, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x4e, 0x61, 0x64, 0x61, 0x6c, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x4e, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x47, 0x68, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x47, 0x68, 0x65, 0x6e, 0x6e, 0xe0, 0x72, 0x67, 0x69, 0x75, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x47, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x46, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x4d, 0x61, 0x72, 0x74, 0x7a, 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x41, 0x62, 0x72, 0x69, 0x6c, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x61, 0x6a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x6a, 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x4c, 0xe0, 0x6d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x4c, 0xe0, 0x6d, 0x70, 0x61, 0x64, 0x61, 0x73, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x4c, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x54, 0x72, 0xec, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x41, 0x75, 0x73, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x41, 0x75, 0x73, 0x74, 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x43, 0x61, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x43, 0x61, 0x62, 0x75, 0x64, 0x61, 0x6e, 0x6e, 0x69, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0x43, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x53, 0x67, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x53, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x4e, 0x61, 0x64, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x47, 0x68, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x47, 0x68, 0x65, 0x6e, 0x6e, 0xe0, 0x72, 0x67, 0x69, 0x75, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x47, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x46, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x4d, 0x61, 0x6a, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x6a, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x4c, 0xe0, 0x6d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x4c, 0xe0, 0x6d, 0x70, 0x61, 0x64, 0x61, 0x73, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x4c, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x54, 0x72, 0xec, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x41, 0x75, 0x73, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x43, 0x61, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0x43, 0x61, 0x62, 0x75, 0x64, 0x61, 0x6e, 0x6e, 0x69, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0x43, 0x0 };
    static const sal_Unicode partitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x53, 0x67, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x53, 0x61, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x4e, 0x61, 0x64, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x61, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x69, 0x6e, 0x20, 0x61, 0x6e, 0x74, 0x69, 0x73, 0x20, 0x64,
            0x65, 0x20, 0x43, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x73, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x70, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x61, 0x20, 0x70, 0x75, 0x73, 0x74, 0x69, 0x73, 0x20, 0x64,
            0x65, 0x20, 0x43, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x73, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_sc_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0xe8, 0x75, 0x72, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_sc_IT(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_sc_IT(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x42, 0x65, 0x72, 0x75, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x46, 0x61, 0x72, 0x73, 0x75, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x43, 0x75, 0x61, 0x72, 0x74, 0x75, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x43, 0x75, 0x61, 0x72, 0x74, 0x75, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x43, 0x75, 0x61, 0x72, 0x74, 0x75, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x43, 0x75, 0x61, 0x72, 0x74, 0x75, 0x20, 0x34, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x53, 0x75, 0x62, 0x72, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x53, 0x75, 0x74, 0x61, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x43, 0x2e, 0x74, 0x75, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x43, 0x2e, 0x74, 0x75, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x43, 0x2e, 0x74, 0x75, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x43, 0x2e, 0x74, 0x75, 0x20, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_sc_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_sc_IT(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_sc_IT(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_sc_IT(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_sc_IT(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
