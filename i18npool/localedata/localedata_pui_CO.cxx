...
extern "C"
{
    static const sal_Unicode langID[] = { 0x70, 0x75, 0x69, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x50, 0x75, 0x69, 0x6e, 0x61, 0x76, 0x65, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_pui_CO(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[] = { 0x70, 0x63, 0x0 };
    static const sal_Unicode timePM[] = { 0x63, 0x70, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_pui_CO(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x24, 0x2d, 0x36, 0x38, 0x45, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x2c, 0x20, 0x44, 0x44, 0x2d, 0x4d, 0x4d, 0x4d, 0x2d, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode40[]
        = { 0x48, 0x48, 0x3a, 0x4d, 0x4d, 0x20, 0x70, 0x63, 0x2f, 0x63, 0x70, 0x0 };
    ...
    static const sal_Unicode FormatCode41[] = { 0x48, 0x48, 0x3a, 0x4d, 0x4d, 0x3a, 0x53, 0x53,
                                                0x20, 0x70, 0x63, 0x2f, 0x63, 0x70, 0x0 };
    ...
    static const sal_Unicode FormatCode46[]
        = { 0x44, 0x44, 0x2d, 0x4d, 0x4d, 0x2d, 0x59, 0x59, 0x59, 0x59, 0x20, 0x48, 0x48,
            0x3a, 0x4d, 0x4d, 0x3a, 0x53, 0x53, 0x20, 0x70, 0x63, 0x2f, 0x63, 0x70, 0x0 };
    ...
    getAllFormats0_pui_CO(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_pui_CO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_pui_CO(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_pui_CO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_pui_CO(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0xc1, 0xc3, 0xc0,  0x42, 0x43, 0x44,  0x45,  0xc9, 0xc8,  0x46, 0x47,
            0x48, 0x49, 0xcd, 0x128, 0xcc, 0x4a, 0x4b,  0x4c,  0x4d, 0x4e,  0xd1, 0x4f,
            0xd3, 0xd5, 0xd2, 0x50,  0x51, 0x52, 0x154, 0x212, 0x52, 0x300, 0x53, 0x54,
            0x55, 0xda, 0xd9, 0xdc,  0x56, 0x57, 0x58,  0x59,  0x5a, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_pui_CO(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_pui_CO(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_pui_CO(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x44, 0x6f, 0x6d, 0x69, 0x6e, 0x67, 0x6f, 0x2d, 0x64, 0x6f, 0x75, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4c, 0x75, 0x6e, 0x65, 0x2d, 0x64, 0x6f, 0x75, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x4c, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x4d, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x4d, 0x61, 0x74, 0x74, 0x65, 0x2d, 0x64, 0x6f, 0x75, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x53, 0x61, 0x62, 0x61, 0x64, 0x6f, 0x2d, 0x64, 0x6f, 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x46, 0x65, 0x62, 0x72, 0x65, 0x72, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x72, 0x7a, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x4a, 0x75, 0x6e, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x4a, 0x75, 0x6c, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x4f, 0x63, 0x74, 0x75, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x4e, 0x6f, 0x76, 0x69, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x4e, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x44, 0x69, 0x63, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x44, 0x69, 0x63, 0x69, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x44, 0x69, 0x63, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x44, 0x69, 0x63, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x43, 0x2e, 0x6a, 0x0 };
    static const sal_Unicode eraDefaultFullName00[] = { 0x43, 0x72, 0x69, 0x73, 0x74,
                                                        0x6f, 0x20, 0x6a, 0x75, 0x70,
                                                        0x72, 0x74, 0x2d, 0x75, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x43, 0x2e, 0x70, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x43, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x20, 0x70, 0x72, 0x6e, 0x61, 0x74, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_pui_CO(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyName0[] = { 0x70, 0x65, 0x73, 0x6f, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_pui_CO(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_pui_CO(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x213, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0xfc, 0x69, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x77, 0x69, 0x67, 0x20, 0x62, 0x69, 0x67, 0x73, 0x75, 0x64, 0x65, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0xfc, 0x74, 0x2d, 0x79, 0x72, 0x67, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0xfc, 0x74, 0x2d, 0x79, 0x72, 0x67, 0x20, 0x6a, 0xe1, 0x6d, 0x61, 0x69, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0xfc, 0x74, 0x20, 0x64, 0x75, 0x67, 0x20, 0x62, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0x6a, 0x61, 0x6a, 0x75, 0x73, 0x65, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x6a, 0x61, 0x6e, 0x6f, 0x6d, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x77, 0x69, 0x67, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0xfc, 0x74, 0x2d, 0x79, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0xfc, 0x74, 0x2d, 0x6a, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0xfc, 0x74, 0x2d, 0x64, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_pui_CO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_pui_CO(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_pui_CO(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_pui_CO(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_pui_CO(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
