...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x67, 0x72, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x4c, 0x65, 0x6e, 0x67, 0x6f, 0x0 };
    static const sal_Unicode countryID[] = { 0x53, 0x42, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x53, 0x6f, 0x6c, 0x6f, 0x6d, 0x6f, 0x6e, 0x20,
            0x49, 0x73, 0x6c, 0x61, 0x6e, 0x64, 0x73, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_lgr_SB(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_lgr_SB(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[] = { 0x5b, 0x24, 0x24, 0x2d, 0x36, 0x39, 0x32, 0x5d, 0x0 };
    ...
    getAllFormats0_lgr_SB(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_lgr_SB(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_lgr_SB(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_lgr_SB(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_lgr_SB(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_lgr_SB(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_lgr_SB(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_lgr_SB(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName06[] = { 0x53, 0x75, 0x6e, 0x64, 0x61, 0x79, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_lgr_SB(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x53, 0x42, 0x44, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x24, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x53, 0x42, 0x44, 0x0 };
    static const sal_Unicode currencyName0[]
        = { 0x53, 0x6f, 0x6c, 0x6f, 0x6d, 0x6f, 0x6e, 0x20, 0x49, 0x73, 0x6c, 0x61,
            0x6e, 0x64, 0x73, 0x20, 0x44, 0x6f, 0x6c, 0x6c, 0x61, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_lgr_SB(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_lgr_SB(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x55, 0x74, 0x68, 0x75, 0x69, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x54, 0x65, 0x69, 0x67, 0x68, 0x61, 0x0 };
    ...
    static const sal_Unicode ReservedWord6[] = { 0x54, 0x65, 0x67, 0x68, 0x65, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x52, 0x75, 0x67, 0x68, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_lgr_SB(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_lgr_SB(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_lgr_SB(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_lgr_SB(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_lgr_SB(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
