...
extern "C"
{
    static const sal_Unicode langID[] = { 0x68, 0x79, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x41, 0x72, 0x6d, 0x65, 0x6e, 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode countryID[] = { 0x41, 0x4d, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x41, 0x72, 0x6d, 0x65, 0x6e, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_hy_AM(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateMonthSeparator[] = { 0x2c, 0x20, 0x0 };
    static const sal_Unicode LongDateYearSeparator[] = { 0x569, 0x2e, 0x20, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_hy_AM(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode4[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode5[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x23, 0x2e, 0x30, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x23, 0xa0, 0x23,  0x23,  0x30, 0x5b, 0x24, 0x564, 0x580, 0x2e, 0x2d,
            0x34, 0x32, 0x42,  0x5d,  0x3b, 0x2d, 0x23, 0xa0,  0x23,  0x23, 0x30,
            0x5b, 0x24, 0x564, 0x580, 0x2e, 0x2d, 0x34, 0x32,  0x42,  0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode12[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30,  0x2e,  0x30, 0x30, 0x5b, 0x24, 0x564, 0x580, 0x2e,
            0x2d, 0x34, 0x32, 0x42, 0x5d,  0x3b,  0x2d, 0x23, 0xa0, 0x23, 0x23,  0x30,  0x2e,
            0x30, 0x30, 0x5b, 0x24, 0x564, 0x580, 0x2e, 0x2d, 0x34, 0x32, 0x42,  0x5d,  0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x23, 0xa0, 0x23, 0x23,  0x30,  0x5b, 0x24, 0x564, 0x580, 0x2e, 0x2d, 0x34, 0x32,
            0x42, 0x5d, 0x3b, 0x5b,  0x52,  0x45, 0x44, 0x5d,  0x2d,  0x23, 0xa0, 0x23, 0x23,
            0x30, 0x5b, 0x24, 0x564, 0x580, 0x2e, 0x2d, 0x34,  0x32,  0x42, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode14[]
        = { 0x23,  0xa0, 0x23,  0x23,  0x30, 0x2e, 0x30, 0x30, 0x5b, 0x24, 0x564,
            0x580, 0x2e, 0x2d,  0x34,  0x32, 0x42, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
            0x44,  0x5d, 0x2d,  0x23,  0xa0, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30,
            0x5b,  0x24, 0x564, 0x580, 0x2e, 0x2d, 0x34, 0x32, 0x42, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode15[]
        = { 0x23, 0xa0, 0x23, 0x23, 0x30, 0x2e, 0x30, 0x30, 0x20, 0x43, 0x43, 0x43, 0x0 };
    ...
    static const sal_Unicode FormatCode16[]
        = { 0x23,  0xa0, 0x23,  0x23,  0x30, 0x2e, 0x2d, 0x2d, 0x5b, 0x24, 0x564,
            0x580, 0x2e, 0x2d,  0x34,  0x32, 0x42, 0x5d, 0x3b, 0x5b, 0x52, 0x45,
            0x44,  0x5d, 0x2d,  0x23,  0xa0, 0x23, 0x23, 0x30, 0x2e, 0x2d, 0x2d,
            0x5b,  0x24, 0x564, 0x580, 0x2e, 0x2d, 0x34, 0x32, 0x42, 0x5d, 0x0 };
    ...
    getAllFormats0_hy_AM(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_hy_AM(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_hy_AM(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_hy_AM(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_hy_AM(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x531, 0x20,  0x532, 0x20, 0x533, 0x20, 0x534, 0x20,  0x535, 0x20,  0x536, 0x20,
            0x537, 0x20,  0x538, 0x20, 0x539, 0x20, 0x53a, 0x20,  0x53b, 0x20,  0x53c, 0x20,
            0x53d, 0x20,  0x53e, 0x20, 0x53f, 0x20, 0x540, 0x20,  0x541, 0x20,  0x542, 0x20,
            0x543, 0x20,  0x544, 0x20, 0x545, 0x20, 0x546, 0x20,  0x547, 0x20,  0x548, 0x20,
            0x549, 0x20,  0x54a, 0x20, 0x54b, 0x20, 0x54c, 0x20,  0x54d, 0x20,  0x54e, 0x20,
            0x54f, 0x20,  0x550, 0x20, 0x551, 0x20, 0x548, 0x53b, 0x20,  0x553, 0x20,  0x554,
            0x20,  0x535, 0x54e, 0x20, 0x555, 0x20, 0x556, 0x0 };
    static const sal_Unicode defaultIndex0[] = { 1 };
    static const sal_Unicode defaultPhonetic0[] = { 0 };

    static const sal_Unicode unicodeScript0[] = { 0x39, 0x0 };
    static const sal_Unicode followPageWord0[] = { 0x537, 0x57b, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x537, 0x57b, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_hy_AM(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_hy_AM(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_hy_AM(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x53f, 0x56b, 0x580, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x56f, 0x56b, 0x580, 0x561, 0x56f, 0x56b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x56f, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x535, 0x580, 0x56f, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x565, 0x580, 0x56f, 0x578, 0x582, 0x577, 0x561, 0x562, 0x569, 0x56b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x565, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x535, 0x580, 0x584, 0x0 };
    static const sal_Unicode dayDefaultFullName02[]
        = { 0x565, 0x580, 0x565, 0x584, 0x577, 0x561, 0x562, 0x569, 0x56b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x565, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x549, 0x580, 0x584, 0x0 };
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x579, 0x578, 0x580, 0x565, 0x584, 0x577, 0x561, 0x562, 0x569, 0x56b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x579, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x540, 0x576, 0x563, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x570, 0x56b, 0x576, 0x563, 0x577, 0x561, 0x562, 0x569, 0x56b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x570, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x548, 0x582, 0x580, 0x562, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x578, 0x582, 0x580, 0x562, 0x561, 0x569, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x578, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x547, 0x562, 0x569, 0x0 };
    static const sal_Unicode dayDefaultFullName06[] = { 0x577, 0x561, 0x562, 0x561, 0x569, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x577, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x540, 0x576, 0x57e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x570, 0x578, 0x582, 0x576, 0x57e, 0x561, 0x580, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x570, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x553, 0x57f, 0x580, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x583, 0x565, 0x57f, 0x580, 0x57e, 0x561, 0x580, 0x0 };
    static const sal_Unicode monthDefaultNarrowName01[] = { 0x583, 0x0 };
    static const sal_Unicode monthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x544, 0x580, 0x57f, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0x574, 0x561, 0x580, 0x57f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x574, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x531, 0x57a, 0x580, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x561, 0x57a, 0x580, 0x56b, 0x56c, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x561, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x544, 0x575, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x574, 0x561, 0x575, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x574, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x540, 0x576, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultFullName05[]
        = { 0x570, 0x578, 0x582, 0x576, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x570, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x540, 0x56c, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultFullName06[]
        = { 0x570, 0x578, 0x582, 0x56c, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x570, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x555, 0x563, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultFullName07[]
        = { 0x585, 0x563, 0x578, 0x57d, 0x57f, 0x578, 0x57d, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x585, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x54d, 0x57a, 0x57f, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x57d, 0x565, 0x57a, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x57d, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0x540, 0x56f, 0x57f, 0x0 };
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x570, 0x578, 0x56f, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0x570, 0x0 };
    static const sal_Unicode monthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x546, 0x575, 0x574, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x576, 0x578, 0x575, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode monthDefaultNarrowName010[] = { 0x576, 0x0 };
    static const sal_Unicode monthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x534, 0x56f, 0x57f, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x564, 0x565, 0x56f, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x564, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x540, 0x576, 0x57e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x570, 0x578, 0x582, 0x576, 0x57e, 0x561, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x570, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x553, 0x57f, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x583, 0x565, 0x57f, 0x580, 0x57e, 0x561, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName01[] = { 0x583, 0x0 };
    static const sal_Unicode genitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x544, 0x580, 0x57f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[] = { 0x574, 0x561, 0x580, 0x57f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName02[] = { 0x574, 0x0 };
    static const sal_Unicode genitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x531, 0x57a, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x561, 0x57a, 0x580, 0x56b, 0x56c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName03[] = { 0x561, 0x0 };
    static const sal_Unicode genitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x544, 0x575, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0x574, 0x561, 0x575, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName04[] = { 0x574, 0x0 };
    static const sal_Unicode genitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x540, 0x576, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x570, 0x578, 0x582, 0x576, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x570, 0x0 };
    static const sal_Unicode genitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x540, 0x56c, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x570, 0x578, 0x582, 0x56c, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x570, 0x0 };
    static const sal_Unicode genitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x555, 0x563, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x585, 0x563, 0x578, 0x57d, 0x57f, 0x578, 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName07[] = { 0x585, 0x0 };
    static const sal_Unicode genitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x54d, 0x57a, 0x57f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x57d, 0x565, 0x57a, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName08[] = { 0x57d, 0x0 };
    static const sal_Unicode genitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0x540, 0x56f, 0x57f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x570, 0x578, 0x56f, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0x570, 0x0 };
    static const sal_Unicode genitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x546, 0x575, 0x574, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x576, 0x578, 0x575, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName010[] = { 0x576, 0x0 };
    static const sal_Unicode genitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x534, 0x56f, 0x57f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x564, 0x565, 0x56f, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName011[] = { 0x564, 0x0 };
    static const sal_Unicode partitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x540, 0x576, 0x57e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x570, 0x578, 0x582, 0x576, 0x57e, 0x561, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x570, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x553, 0x57f, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName01[]
        = { 0x583, 0x565, 0x57f, 0x580, 0x57e, 0x561, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName01[] = { 0x583, 0x0 };
    static const sal_Unicode partitiveMonthID02[] = { 0x6d, 0x61, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x544, 0x580, 0x57f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName02[]
        = { 0x574, 0x561, 0x580, 0x57f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName02[] = { 0x574, 0x0 };
    static const sal_Unicode partitiveMonthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x531, 0x57a, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[]
        = { 0x561, 0x57a, 0x580, 0x56b, 0x56c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName03[] = { 0x561, 0x0 };
    static const sal_Unicode partitiveMonthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x544, 0x575, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[]
        = { 0x574, 0x561, 0x575, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName04[] = { 0x574, 0x0 };
    static const sal_Unicode partitiveMonthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x540, 0x576, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x570, 0x578, 0x582, 0x576, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x570, 0x0 };
    static const sal_Unicode partitiveMonthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x540, 0x56c, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0x570, 0x578, 0x582, 0x56c, 0x56b, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x570, 0x0 };
    static const sal_Unicode partitiveMonthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x555, 0x563, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName07[]
        = { 0x585, 0x563, 0x578, 0x57d, 0x57f, 0x578, 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName07[] = { 0x585, 0x0 };
    static const sal_Unicode partitiveMonthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x54d, 0x57a, 0x57f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName08[]
        = { 0x57d, 0x565, 0x57a, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName08[] = { 0x57d, 0x0 };
    static const sal_Unicode partitiveMonthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0x540, 0x56f, 0x57f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0x570, 0x578, 0x56f, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0x570, 0x0 };
    static const sal_Unicode partitiveMonthID010[] = { 0x6e, 0x6f, 0x76, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x546, 0x575, 0x574, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName010[]
        = { 0x576, 0x578, 0x575, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName010[] = { 0x576, 0x0 };
    static const sal_Unicode partitiveMonthID011[] = { 0x64, 0x65, 0x63, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x534, 0x56f, 0x57f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName011[]
        = { 0x564, 0x565, 0x56f, 0x57f, 0x565, 0x574, 0x562, 0x565, 0x580, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName011[] = { 0x564, 0x0 };
    static const sal_Unicode eraID00[] = { 0x62, 0x63, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x574, 0x2e, 0x569, 0x2e, 0x561, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x574, 0x565, 0x580, 0x20,  0x569, 0x57e, 0x561, 0x580, 0x56f, 0x578, 0x582, 0x569,
            0x575, 0x578, 0x582, 0x576, 0x56b, 0x581, 0x20,  0x561, 0x57c, 0x561, 0x57b, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x574, 0x2e, 0x569, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x574, 0x565, 0x580, 0x20,  0x569, 0x57e, 0x561, 0x580, 0x56f,
            0x578, 0x582, 0x569, 0x575, 0x578, 0x582, 0x576, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_hy_AM(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x41, 0x4d, 0x44, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x564, 0x580, 0x2e, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x41, 0x4d, 0x44, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x540, 0x561, 0x575, 0x56f, 0x561, 0x56f, 0x561,
                                                 0x576, 0x20,  0x534, 0x580, 0x561, 0x574, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_hy_AM(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_hy_AM(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[]
        = { 0x573, 0x577, 0x574, 0x561, 0x580, 0x56b, 0x57f, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x56f, 0x565, 0x572, 0x56e, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x31,  0x2d,  0x56b, 0x576, 0x20,  0x56f, 0x56b,
                                                 0x57d, 0x561, 0x574, 0x575, 0x561, 0x56f, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x32,  0x2d,  0x580, 0x564, 0x20,  0x56f, 0x56b,
                                                 0x57d, 0x561, 0x574, 0x575, 0x561, 0x56f, 0x0 };
    static const sal_Unicode ReservedWord4[] = { 0x33,  0x2d,  0x580, 0x564, 0x20,  0x56f, 0x56b,
                                                 0x57d, 0x561, 0x574, 0x575, 0x561, 0x56f, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x34,  0x2d,  0x580, 0x564, 0x20,  0x56f, 0x56b,
                                                 0x57d, 0x561, 0x574, 0x575, 0x561, 0x56f, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x57e, 0x565, 0x580, 0x587, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x576, 0x565, 0x580, 0x584, 0x587, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x49, 0x20, 0x56f, 0x57d, 0x574, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x49, 0x49, 0x20, 0x56f, 0x57d, 0x574, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord10[]
        = { 0x49, 0x49, 0x49, 0x20, 0x56f, 0x57d, 0x574, 0x2e, 0x0 };
    static const sal_Unicode ReservedWord11[]
        = { 0x49, 0x56, 0x20, 0x56f, 0x57d, 0x574, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_hy_AM(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_hy_AM(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_hy_AM(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_hy_AM(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_hy_AM(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
