...
extern "C"
{
    static const sal_Unicode langID[] = { 0x6c, 0x69, 0x6a, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x4c, 0x69, 0x67, 0x75, 0x72, 0x69, 0x61, 0x6e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_lij_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode LongDateDayOfWeekSeparator[] = { 0x20, 0x61, 0x2d, 0x69, 0x20, 0x0 };
    static const sal_Unicode LongDateDaySeparator[] = { 0x20, 0x64, 0x65, 0x20, 0x0 };
    static const sal_Unicode LongDateMonthSeparator[] = { 0x20, 0x64, 0x6f, 0x20, 0x0 };
    static const sal_Unicode LongDateYearSeparator[] = { 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_lij_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x36, 0x41, 0x36, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode11[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23,
            0x2e, 0x23, 0x23, 0x30, 0x3b, 0x2d, 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45,
            0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode13[]
        = { 0x5b, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2e, 0x23,
            ...
            0x45, 0x4e, 0x43, 0x59, 0x5d, 0x20, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x20, 0x22, 0x61, 0x2d, 0x69, 0x22, 0x20,
            0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d,
            0x20, 0x22, 0x64, 0x6f, 0x22, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d,
            0x20, 0x22, 0x64, 0x6f, 0x22, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x44, 0x20, 0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20,
            0x22, 0x64, 0x6f, 0x22, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x20, 0x22, 0x61, 0x2d, 0x69, 0x22, 0x20, 0x44, 0x20, 0x22, 0x64, 0x65,
            0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x20, 0x22, 0x64, 0x6f, 0x22, 0x20, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x20, 0x22, 0x61, 0x2d, 0x69, 0x22, 0x20, 0x44, 0x20,
            0x22, 0x64, 0x65, 0x22, 0x20, 0x4d, 0x4d, 0x4d, 0x4d, 0x20, 0x22,
            0x64, 0x6f, 0x22, 0x20, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_lij_IT(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_lij_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_lij_IT(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_lij_IT(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_lij_IT(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x20, 0xc0, 0x20, 0xc2, 0x20, 0xc4, 0x20, 0xc6, 0x20, 0x42, 0x2d, 0x43, 0x20,
            0xc7, 0x20, 0x44, 0x2d, 0x45, 0x20, 0xc9, 0x20, 0xc8, 0x20, 0xca, 0x20, 0xcb, 0x20,
            0x46, 0x2d, 0x49, 0x20, 0xcc, 0x20, 0xce, 0x20, 0xcf, 0x20, 0x4a, 0x2d, 0x4e, 0x20,
            0xd1, 0x20, 0x4f, 0x20, 0xd3, 0x20, 0xd2, 0x20, 0xd4, 0x20, 0xd6, 0x20, 0x50, 0x2d,
            0x55, 0x20, 0xd9, 0x20, 0xdb, 0x20, 0xdc, 0x20, 0x56, 0x2d, 0x5a, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_lij_IT(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_lij_IT(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_lij_IT(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x64, 0x6f, 0x6d, 0x65, 0x6e, 0x65, 0x67, 0x61, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x76, 0x65, 0x6e, 0x61, 0x72, 0x64, 0xec, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName06[] = { 0x73, 0x61, 0x62, 0x62, 0x6f, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x73, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x7a, 0x65, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[] = { 0x7a, 0x65, 0x6e, 0x6e, 0xe2, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x7a, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x66, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultFullName01[] = { 0x66, 0x72, 0x65, 0x76, 0xe2, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x73, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x61, 0x72, 0x76, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x61, 0x72, 0x76, 0xee, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x61, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x7a, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x61, 0x7a, 0x7a, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName04[] = { 0x6d, 0x0 };
    static const sal_Unicode monthID05[] = { 0x6a, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x7a, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x7a, 0x75, 0x67, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x7a, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x6c, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x6c, 0x75, 0x67, 0x67, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x74, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName08[] = { 0x73, 0x0 };
    static const sal_Unicode monthID09[] = { 0x6f, 0x63, 0x74, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName09[] = { 0xf6, 0x74, 0x6f, 0x0 };
    static const sal_Unicode monthDefaultFullName09[] = { 0xf6, 0x74, 0x6f, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName09[] = { 0xf6, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName011[] = { 0x64, 0x65, 0x78, 0x0 };
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x78, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x64, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x7a, 0x65, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x7a, 0x65, 0x6e, 0x6e, 0xe2, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x7a, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x66, 0x72, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x66, 0x72, 0x65, 0x76, 0xe2, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x61, 0x72, 0x76, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[] = { 0x61, 0x72, 0x76, 0xee, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x7a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[]
        = { 0x6d, 0x61, 0x7a, 0x7a, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x7a, 0x75, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x7a, 0x75, 0x67, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName05[] = { 0x7a, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x6c, 0x75, 0x67, 0x67, 0x69, 0x6f, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName09[] = { 0xf6, 0x74, 0x6f, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0xf6, 0x74, 0x6f, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName09[] = { 0xf6, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName011[] = { 0x64, 0x65, 0x78, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x7a, 0x65, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x7a, 0x65, 0x6e, 0x6e, 0xe2, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x7a, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x66, 0x72, 0x65, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x61, 0x72, 0x76, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName03[] = { 0x61, 0x72, 0x76, 0xee, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x61, 0x7a, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x7a, 0x75, 0x67, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName05[]
        = { 0x7a, 0x75, 0x67, 0x6e, 0x6f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName05[] = { 0x7a, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName09[] = { 0xf6, 0x74, 0x6f, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName09[]
        = { 0xf6, 0x74, 0x6f, 0x62, 0x72, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName09[] = { 0xf6, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName011[] = { 0x64, 0x65, 0x78, 0x0 };
    ...
    static const sal_Unicode eraDefaultFullName00[] = { 0x61, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x64, 0x2e, 0x43, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x64, 0x2e, 0x43, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_lij_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_lij_IT(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_lij_IT(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[] = { 0x76, 0x65, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0xe4, 0x73, 0x6f, 0x0 };
    ...
    static const sal_Unicode ReservedWord6[] = { 0x73, 0x6f, 0x72, 0x76, 0x65, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x73, 0x6f, 0x74, 0x74, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_lij_IT(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_lij_IT(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_lij_IT(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_lij_IT(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_lij_IT(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
