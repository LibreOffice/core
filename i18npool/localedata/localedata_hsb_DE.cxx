...
extern "C"
{
    static const sal_Unicode langID[] = { 0x68, 0x73, 0x62, 0x0 };
    static const sal_Unicode langDefaultName[] = { 0x53, 0x6f, 0x72, 0x62, 0x69, 0x61, 0x6e, 0x2c,
                                                   0x20, 0x55, 0x70, 0x70, 0x65, 0x72, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_hsb_DE(sal_Int16& count)
    {
    ...
    static const sal_Unicode timeAM[]
        = { 0x64, 0x6f, 0x70, 0x6f, 0x142, 0x64, 0x6e, 0x6a, 0x61, 0x0 };
    static const sal_Unicode timePM[]
        = { 0x70, 0x6f, 0x70, 0x6f, 0x142, 0x64, 0x6e, 0x6a, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_hsb_DE(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20ac, 0x2d, 0x34, 0x32, 0x45, 0x5d, 0x0 };
    ...
    getAllFormats0_hsb_DE(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_hsb_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_hsb_DE(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_hsb_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_hsb_DE(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41,  0x2d,  0x43, 0x20, 0x10c, 0x20, 0x106, 0x20,  0x44,  0x20, 0x7b,  0x44,
            0x17a, 0x7d,  0x20, 0x45, 0x20,  0x46, 0x2d,  0x48,  0x20,  0x7b, 0x43,  0x68,
            0x7d,  0x20,  0x49, 0x2d, 0x4b,  0x20, 0x141, 0x20,  0x4c,  0x2d, 0x4e,  0x20,
            0x143, 0x20,  0x4f, 0x20, 0xd3,  0x20, 0x50,  0x20,  0x7b,  0x50, 0x159, 0x7d,
            0x20,  0x51,  0x20, 0x52, 0x20,  0x53, 0x20,  0x160, 0x20,  0x54, 0x20,  0x7b,
            0x54,  0x159, 0x7d, 0x20, 0x55,  0x2d, 0x5a,  0x20,  0x17d, 0x0 };
    ...
    static const sal_Unicode followPageWord0[] = { 0x73, 0x107, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x73, 0x107, 0x2e, 0x73, 0x107, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_hsb_DE(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_hsb_DE(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_hsb_DE(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x6e, 0x6a, 0x65, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x6e, 0x6a, 0x65, 0x64, 0x17a, 0x65, 0x6c, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x6e, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x70, 0xf3, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x70, 0xf3, 0x6e, 0x64, 0x17a, 0x65, 0x6c, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x70, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x77, 0x75, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x77, 0x75, 0x74, 0x6f, 0x72, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName02[] = { 0x77, 0x0 };
    static const sal_Unicode dayID03[] = { 0x77, 0x65, 0x64, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x73, 0x72, 0x6a, 0x0 };
    static const sal_Unicode dayDefaultFullName03[] = { 0x73, 0x72, 0x6a, 0x65, 0x64, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x73, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x161, 0x74, 0x77, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x161, 0x74, 0x77, 0xf3, 0x72, 0x74, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x161, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x70, 0x6a, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x70, 0x6a, 0x61, 0x74, 0x6b, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x70, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x73, 0x6f, 0x62, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName02[] = { 0x6d, 0x11b, 0x72, 0x0 };
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0x11b, 0x72, 0x63, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[] = { 0x61, 0x70, 0x72, 0x79, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultNarrowName03[] = { 0x61, 0x0 };
    static const sal_Unicode monthID04[] = { 0x6d, 0x61, 0x79, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName04[] = { 0x6d, 0x65, 0x6a, 0x0 };
    static const sal_Unicode monthDefaultFullName04[] = { 0x6d, 0x65, 0x6a, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x6a, 0x75, 0x6e, 0x69, 0x6a, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x6a, 0x75, 0x6c, 0x69, 0x6a, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x6a, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x61, 0x77, 0x67, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x61, 0x77, 0x67, 0x75, 0x73, 0x74, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x6e, 0x6f, 0x77, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x6e, 0x6f, 0x77, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x6a, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName02[] = { 0x6d, 0x11b, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x6d, 0x11b, 0x72, 0x63, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x61, 0x70, 0x72, 0x79, 0x6c, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x65, 0x6a, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x6d, 0x65, 0x6a, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x6a, 0x75, 0x6e, 0x69, 0x6a, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x6a, 0x75, 0x6c, 0x69, 0x6a, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x61, 0x77, 0x67, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x61, 0x77, 0x67, 0x75, 0x73, 0x74, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName08[]
        = { 0x73, 0x65, 0x70, 0x74, 0x65, 0x6d, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName09[]
        = { 0x6f, 0x6b, 0x74, 0x6f, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x6e, 0x6f, 0x77, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName010[]
        = { 0x6e, 0x6f, 0x77, 0x65, 0x6d, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName011[]
        = { 0x64, 0x65, 0x63, 0x65, 0x6d, 0x62, 0x72, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName02[] = { 0x6d, 0x11b, 0x72, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName04[] = { 0x6d, 0x65, 0x6a, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x6d, 0x65, 0x6a, 0x61, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x61, 0x77, 0x67, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x6e, 0x6f, 0x77, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[]
        = { 0x70, 0x159, 0x2e, 0x20, 0x43, 0x68, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[]
        = { 0x70, 0x159, 0x65, 0x64, 0x20, 0x43, 0x68, 0x72,
            0x79, 0x73,  0x74, 0x75, 0x73, 0x6f, 0x6d, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[]
        = { 0x70, 0x6f, 0x20, 0x43, 0x68, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[]
        = { 0x70, 0x6f, 0x20, 0x43, 0x68, 0x72, 0x79, 0x73, 0x74, 0x75, 0x73, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_hsb_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_hsb_DE(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_hsb_DE(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x70, 0x72, 0x61, 0x77, 0x6a, 0x65, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x77, 0x6f, 0x70, 0x61, 0x6b, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x70, 0x72, 0x11b, 0x6e, 0x69, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x64, 0x72, 0x75, 0x68, 0x69, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x74, 0x159, 0x65, 0x107, 0x69, 0x20, 0x6b, 0x77, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x161, 0x74, 0x77, 0xf3, 0x72, 0x74, 0x79, 0x20,
                                                 0x6b,  0x77, 0x61, 0x72, 0x74, 0x61, 0x6c, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x68, 0x6f, 0x72, 0x6a, 0x65, 0x6b, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x64, 0x65, 0x6c, 0x65, 0x6b, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_hsb_DE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_hsb_DE(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_hsb_DE(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_hsb_DE(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_hsb_DE(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
