...
extern "C"
{
    ...
    static const sal_Unicode langDefaultName[] = { 0x48, 0x61, 0x75, 0x73, 0x61, 0x0 };
    ...
    static const sal_Unicode Variant[]
        = { 0x68, 0x61, 0x2d, 0x4c, 0x61, 0x74, 0x6e, 0x2d, 0x47, 0x48, 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ha_Latn_GH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ha_Latn_GH(sal_Int16& count)
    {
    ...
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x20b5, 0x2d, 0x38, 0x30, 0x36, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode18[]
        = { 0x4e, 0x4e, 0x4e, 0x4e, 0x4d, 0x4d, 0x4d, 0x4d, 0xa0,
            0x44, 0x44, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode21[]
        = { 0x4d, 0x4d, 0x4d, 0xa0, 0x44, 0x2c, 0xa0, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode22[]
        = { 0x4d, 0x4d, 0x4d, 0xa0, 0x44, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode24[]
        = { 0x4d, 0x4d, 0x4d, 0x4d, 0xa0, 0x44, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode26[]
        = { 0x4e, 0x4e, 0x2c, 0xa0, 0x44, 0x44, 0x2f, 0x4d, 0x4d, 0x4d, 0x2f, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode27[]
        = { 0x4e, 0x4e, 0x2c, 0xa0, 0x4d, 0x4d, 0x4d, 0xa0, 0x44, 0x2c, 0xa0, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode28[]
        = { 0x4e, 0x4e, 0x2c, 0xa0, 0x4d, 0x4d, 0x4d, 0x4d, 0xa0,
            0x44, 0x2c, 0xa0, 0x59, 0x59, 0x59, 0x59, 0x0 };
    ...
    getAllFormats0_ha_Latn_GH(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    getDateAcceptancePatterns_ha_Latn_GH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL
    getCollatorImplementation_ha_Latn_GH(sal_Int16& count)
    {
        count = nbOfCollations;
        return (sal_Unicode**)LCCollatorArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ha_Latn_GH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ha_Latn_GH(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x2bc, 0x20,  0x41, 0x20, 0x100, 0x20,  0x42, 0x20,  0x181, 0x20, 0x43,  0x20, 0x44,
            0x20,  0x18a, 0x20, 0x45, 0x20,  0x46,  0x20, 0x7b,  0x46,  0x59, 0x7d,  0x20, 0x47,
            0x20,  0x7b,  0x47, 0x57, 0x7d,  0x20,  0x7b, 0x47,  0x59,  0x7d, 0x20,  0x48, 0x2d,
            0x4b,  0x20,  0x7b, 0x4b, 0x57,  0x7d,  0x20, 0x198, 0x20,  0x7b, 0x198, 0x59, 0x7d,
            0x20,  0x4c,  0x2d, 0x4f, 0x20,  0x52,  0x20, 0x52,  0x303, 0x20, 0x53,  0x20, 0x7b,
            0x53,  0x48,  0x7d, 0x20, 0x54,  0x20,  0x7b, 0x54,  0x53,  0x7d, 0x20,  0x55, 0x20,
            0x57,  0x20,  0x59, 0x20, 0x7b,  0x2bc, 0x59, 0x7d,  0x20,  0x5a, 0x0 };
    ...
    static const sal_Unicode unicodeScript4[] = { 0x34, 0x0 };
    static const sal_Unicode unicodeScript5[] = { 0x36, 0x0 };
    static const sal_Unicode followPageWord0[] = { 0x73, 0x2e, 0x0 };
    static const sal_Unicode followPageWord1[] = { 0x77, 0x2e, 0x0 };
    ...
    static const sal_Int16 nbOfUnicodeScripts = 6;

    static const sal_Unicode* UnicodeScriptArray[] = { unicodeScript0,
                                                       unicodeScript1,
                                                       unicodeScript2,
                                                       unicodeScript3,
                                                       unicodeScript4,
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ha_Latn_GH(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ha_Latn_GH(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ha_Latn_GH(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x4c, 0x61, 0x68, 0x0 };
    static const sal_Unicode dayDefaultFullName00[] = { 0x4c, 0x61, 0x68, 0x61, 0x64, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x4c, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x4c, 0x69, 0x74, 0x0 };
    static const sal_Unicode dayDefaultFullName01[]
        = { 0x4c, 0x69, 0x74, 0x74, 0x69, 0x6e, 0x69, 0x6e, 0x0 };
    ...
    static const sal_Unicode dayDefaultAbbrvName03[] = { 0x4c, 0x61, 0x72, 0x0 };
    static const sal_Unicode dayDefaultFullName03[] = { 0x4c, 0x61, 0x72, 0x61, 0x62, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x4c, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x41, 0x6c, 0x68, 0x0 };
    static const sal_Unicode dayDefaultFullName04[]
        = { 0x41, 0x6c, 0x68, 0x61, 0x6d, 0x69, 0x73, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x41, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x4a, 0x75, 0x6d, 0x0 };
    static const sal_Unicode dayDefaultFullName05[]
        = { 0x4a, 0x75, 0x6d, 0x6d, 0x61, 0x27, 0x61, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x4a, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x41, 0x73, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName06[] = { 0x41, 0x73, 0x61, 0x62, 0x61, 0x72, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x4d, 0x61, 0x72, 0x69, 0x73, 0x0 };
    static const sal_Unicode monthDefaultNarrowName02[] = { 0x4d, 0x0 };
    static const sal_Unicode monthID03[] = { 0x61, 0x70, 0x72, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName03[] = { 0x41, 0x66, 0x72, 0x0 };
    static const sal_Unicode monthDefaultFullName03[] = { 0x41, 0x66, 0x72, 0x69, 0x6c, 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName04[] = { 0x4d, 0x61, 0x79, 0x75, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName05[] = { 0x59, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName06[] = { 0x59, 0x75, 0x6c, 0x69, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x59, 0x0 };
    static const sal_Unicode monthID07[] = { 0x61, 0x75, 0x67, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName07[] = { 0x41, 0x67, 0x75, 0x0 };
    static const sal_Unicode monthDefaultFullName07[] = { 0x41, 0x67, 0x75, 0x73, 0x74, 0x61, 0x0 };
    static const sal_Unicode monthDefaultNarrowName07[] = { 0x41, 0x0 };
    static const sal_Unicode monthID08[] = { 0x73, 0x65, 0x70, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x53, 0x61, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x53, 0x61, 0x74, 0x75, 0x6d, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName010[] = { 0x4e, 0x75, 0x77, 0x0 };
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x4e, 0x75, 0x77, 0x61, 0x6d, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x44, 0x69, 0x73, 0x61, 0x6d, 0x62, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x46, 0x61, 0x62, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName03[] = { 0x41, 0x66, 0x72, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName03[]
        = { 0x41, 0x66, 0x72, 0x69, 0x6c, 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x79, 0x75, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName05[] = { 0x59, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName06[] = { 0x59, 0x75, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName07[] = { 0x41, 0x67, 0x75, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName07[]
        = { 0x41, 0x67, 0x75, 0x73, 0x74, 0x61, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x53, 0x61, 0x74, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName010[] = { 0x4e, 0x75, 0x77, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x46, 0x61, 0x62, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName03[] = { 0x41, 0x66, 0x72, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName04[] = { 0x4d, 0x61, 0x79, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName05[] = { 0x59, 0x75, 0x6e, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultFullName06[] = { 0x59, 0x75, 0x6c, 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName07[] = { 0x41, 0x67, 0x75, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x53, 0x61, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName010[] = { 0x4e, 0x75, 0x77, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0x47, 0x4d, 0x0 };
    static const sal_Unicode eraDefaultFullName00[] = { 0x47, 0x61, 0x62, 0x61, 0x6e,
                                                        0x69, 0x6e, 0x20, 0x4d, 0x69,
                                                        0x6c, 0x61, 0x64, 0x69, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x4d, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x4d, 0x69, 0x6c, 0x61, 0x64, 0x69, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ha_Latn_GH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ha_Latn_GH(sal_Int16& count)
    {
        count = currencyCount;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ha_Latn_GH(sal_Int16& count)
    {
        count = nbOfTransliterations;
        return (sal_Unicode**)LCTransliterationsArray;
    }
    static const sal_Unicode ReservedWord0[] = { 0x47, 0x61, 0x73, 0x6b, 0x69, 0x79, 0x61, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x4b, 0x61, 0x72, 0x79, 0x61, 0x0 };
    static const sal_Unicode ReservedWord2[] = { 0x52, 0x75, 0x62, 0x75, 0x27, 0x69, 0x20, 0x4e,
                                                 0x61, 0x20, 0x46, 0x61, 0x72, 0x6b, 0x6f, 0x0 };
    static const sal_Unicode ReservedWord3[] = { 0x52, 0x75, 0x62, 0x75, 0x27, 0x69, 0x20, 0x4e,
                                                 0x61, 0x20, 0x42, 0x69, 0x79, 0x75, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x52, 0x75, 0x62, 0x75, 0x27, 0x69, 0x20, 0x4e, 0x61, 0x20, 0x55, 0x6b, 0x75, 0x0 };
    static const sal_Unicode ReservedWord5[] = { 0x52, 0x75, 0x62, 0x75, 0x27, 0x69, 0x20, 0x4e,
                                                 0x61, 0x20, 0x48, 0x75, 0x64, 0x75, 0x0 };
    static const sal_Unicode ReservedWord6[] = { 0x53, 0x61, 0x6d, 0x61, 0x0 };
    static const sal_Unicode ReservedWord7[] = { 0x4b, 0x61, 0x73, 0x61, 0x0 };
    static const sal_Unicode ReservedWord8[] = { 0x52, 0x31, 0x0 };
    static const sal_Unicode ReservedWord9[] = { 0x52, 0x32, 0x0 };
    static const sal_Unicode ReservedWord10[] = { 0x52, 0x33, 0x0 };
    static const sal_Unicode ReservedWord11[] = { 0x52, 0x34, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ha_Latn_GH(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ha_Latn_GH(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ha_Latn_GH(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ha_Latn_GH(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_ha_Latn_GH(
