...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x4d, 0x41, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x4d, 0x6f, 0x72, 0x6f, 0x63, 0x63, 0x6f, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ar_MA(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ar_MA(sal_Int16& count)
    {
        return getLocaleItem_ar_SA(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x62f, 0x2e, 0x645, 0x2e, 0x200f, 0x2d, 0x31, 0x38, 0x30, 0x31, 0x5d, 0x0 };
    ...
    getAllFormats0_ar_MA(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ar_MA(sal_Int16& count)
    {
        return getDateAcceptancePatterns_ar_SA(count);
    }
    extern sal_Unicode** SAL_CALL getCollatorImplementation_ar_SA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ar_MA(sal_Int16& count)
    {
        return getCollatorImplementation_ar_SA(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_ar_SA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ar_MA(sal_Int16& count)
    {
        return getCollationOptions_ar_SA(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_ar_SA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ar_MA(sal_Int16& count)
    {
        return getSearchOptions_ar_SA(count);
    }
    extern sal_Unicode** SAL_CALL getIndexAlgorithm_ar_SA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ar_MA(sal_Int16& count)
    {
        return getIndexAlgorithm_ar_SA(count);
    }
    extern sal_Unicode** SAL_CALL getUnicodeScripts_ar_SA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ar_MA(sal_Int16& count)
    {
        return getUnicodeScripts_ar_SA(count);
    }
    extern sal_Unicode** SAL_CALL getFollowPageWords_ar_SA(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ar_MA(sal_Int16& count)
    {
        return getFollowPageWords_ar_SA(count);
    }
    extern sal_Unicode** SAL_CALL getAllCalendars_ar_TN(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ar_MA(sal_Int16& count)
    {
        return getAllCalendars_ar_TN(count);
    }
    ...
    static const sal_Unicode currencyID0[] = { 0x4d, 0x41, 0x44, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x62f, 0x2e, 0x645, 0x2e, 0x200f, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x4d, 0x41, 0x44, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x4d, 0x41, 0x44, 0x0 };
    ...
    getContinuousNumberingLevels_ar_MA(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_ar_SA(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ar_MA(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
