...
extern "C"
{
    ...
    static const sal_Unicode countryID[] = { 0x4e, 0x45, 0x0 };
    static const sal_Unicode countryDefaultName[] = { 0x4e, 0x69, 0x67, 0x65, 0x72, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_fr_NE(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_fr_NE(sal_Int16& count)
    {
        return getLocaleItem_fr_BF(count);
    }
    static const sal_Unicode replaceTo0[]
        = { 0x5b, 0x24, 0x46, 0x2d, 0x38, 0x38, 0x30, 0x43, 0x5d, 0x0 };
    ...
    getAllFormats0_fr_NE(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
        to = replaceTo0;
    ...
    getContinuousNumberingLevels_fr_NE(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_fr_BF(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_fr_NE(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
