...
extern "C"
{
    static const sal_Unicode langID[] = { 0x72, 0x6f, 0x0 };
    static const sal_Unicode langDefaultName[]
        = { 0x52, 0x6f, 0x6d, 0x61, 0x6e, 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode countryID[] = { 0x52, 0x4f, 0x0 };
    static const sal_Unicode countryDefaultName[]
        = { 0x52, 0x6f, 0x6d, 0x61, 0x6e, 0x69, 0x61, 0x0 };
    static const sal_Unicode Variant[] = { 0x0 };

    static const sal_Unicode* LCInfoArray[]
        = { langID, langDefaultName, countryID, countryDefaultName, Variant };

    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLCInfo_ro_RO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getLocaleItem_ro_RO(sal_Int16& count)
    {
    ...
    static const sal_Unicode FormatCode1[] = { 0x4e, 0x4e, 0x20, 0x44, 0x44, 0x2e, 0x4d, 0x4d,
    ...
    static const sal_Unicode FormatCode5[] = { 0x51, 0x51, 0x2f, 0x59, 0x59, 0x0 };
    ...
    static const sal_Unicode FormatCode37[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x6c, 0x65, 0x69, 0x2d,
            0x34, 0x31, 0x38, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20,
            0x5b, 0x24, 0x6c, 0x65, 0x69, 0x2d, 0x34, 0x31, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode38[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x6c, 0x65, 0x69,
            0x2d, 0x34, 0x31, 0x38, 0x5d, 0x3b, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30,
            0x30, 0x20, 0x5b, 0x24, 0x6c, 0x65, 0x69, 0x2d, 0x34, 0x31, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode39[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x20, 0x5b, 0x24, 0x6c, 0x65, 0x69, 0x2d, 0x34, 0x31,
            0x38, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44, 0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30,
            0x20, 0x5b, 0x24, 0x6c, 0x65, 0x69, 0x2d, 0x34, 0x31, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode40[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b, 0x24, 0x6c,
            0x65, 0x69, 0x2d, 0x34, 0x31, 0x38, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
            0x5d, 0x2d, 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x30, 0x30, 0x20, 0x5b,
            0x24, 0x6c, 0x65, 0x69, 0x2d, 0x34, 0x31, 0x38, 0x5d, 0x0 };
    ...
    static const sal_Unicode FormatCode42[]
        = { 0x23, 0x2e, 0x23, 0x23, 0x30, 0x2c, 0x2d, 0x2d, 0x20, 0x5b, 0x24, 0x6c,
            0x65, 0x69, 0x2d, 0x34, 0x31, 0x38, 0x5d, 0x3b, 0x5b, 0x52, 0x45, 0x44,
    ...
    getAllFormats0_ro_RO(sal_Int16& count, const sal_Unicode*& from, const sal_Unicode*& to)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getDateAcceptancePatterns_ro_RO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollatorImplementation_ro_RO(sal_Int16& count)
    {
        return getCollatorImplementation_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getCollationOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getCollationOptions_ro_RO(sal_Int16& count)
    {
        return getCollationOptions_en_US(count);
    }
    extern sal_Unicode** SAL_CALL getSearchOptions_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getSearchOptions_ro_RO(sal_Int16& count)
    {
    ...
    static const sal_Unicode IndexKey0[]
        = { 0x41, 0x20, 0x102, 0x20, 0xc2,  0x20, 0x42,  0x2d, 0x49,  0x20,
            0xce, 0x20, 0x4a,  0x2d, 0x53,  0x20, 0x218, 0x20, 0x15e, 0x20,
            0x54, 0x20, 0x21a, 0x20, 0x162, 0x20, 0x55,  0x2d, 0x5a,  0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getIndexAlgorithm_ro_RO(sal_Int16& count)
    {
        count = nbOfIndexs;
        return (sal_Unicode**)IndexArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getUnicodeScripts_ro_RO(sal_Int16& count)
    {
        count = nbOfUnicodeScripts;
        return (sal_Unicode**)UnicodeScriptArray;
    }
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getFollowPageWords_ro_RO(sal_Int16& count)
    {
        count = nbOfPageWords;
    ...
    static const sal_Unicode dayDefaultAbbrvName00[] = { 0x44, 0x0 };
    static const sal_Unicode dayDefaultFullName00[]
        = { 0x64, 0x75, 0x6d, 0x69, 0x6e, 0x69, 0x63, 0x103, 0x0 };
    static const sal_Unicode dayDefaultNarrowName00[] = { 0x64, 0x0 };
    static const sal_Unicode dayID01[] = { 0x6d, 0x6f, 0x6e, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName01[] = { 0x4c, 0x0 };
    static const sal_Unicode dayDefaultFullName01[] = { 0x6c, 0x75, 0x6e, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName01[] = { 0x6c, 0x0 };
    static const sal_Unicode dayID02[] = { 0x74, 0x75, 0x65, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName02[] = { 0x4d, 0x61, 0x0 };
    static const sal_Unicode dayDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x163, 0x69, 0x0 };
    ...
    static const sal_Unicode dayDefaultFullName03[]
        = { 0x6d, 0x69, 0x65, 0x72, 0x63, 0x75, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName03[] = { 0x6d, 0x0 };
    static const sal_Unicode dayID04[] = { 0x74, 0x68, 0x75, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName04[] = { 0x4a, 0x0 };
    static const sal_Unicode dayDefaultFullName04[] = { 0x6a, 0x6f, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName04[] = { 0x6a, 0x0 };
    static const sal_Unicode dayID05[] = { 0x66, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName05[] = { 0x56, 0x0 };
    static const sal_Unicode dayDefaultFullName05[] = { 0x76, 0x69, 0x6e, 0x65, 0x72, 0x69, 0x0 };
    static const sal_Unicode dayDefaultNarrowName05[] = { 0x76, 0x0 };
    static const sal_Unicode dayID06[] = { 0x73, 0x61, 0x74, 0x0 };
    static const sal_Unicode dayDefaultAbbrvName06[] = { 0x53, 0x0 };
    static const sal_Unicode dayDefaultFullName06[]
        = { 0x73, 0xe2, 0x6d, 0x62, 0x103, 0x74, 0x103, 0x0 };
    static const sal_Unicode dayDefaultNarrowName06[] = { 0x73, 0x0 };
    static const sal_Unicode monthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName00[] = { 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName00[]
        = { 0x69, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName00[] = { 0x69, 0x0 };
    static const sal_Unicode monthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName01[] = { 0x66, 0x65, 0x62, 0x72, 0x0 };
    static const sal_Unicode monthDefaultFullName01[]
        = { 0x66, 0x65, 0x62, 0x72, 0x75, 0x61, 0x72, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName02[] = { 0x6d, 0x61, 0x72, 0x74, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName03[]
        = { 0x61, 0x70, 0x72, 0x69, 0x6c, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName05[] = { 0x69, 0x75, 0x6e, 0x0 };
    static const sal_Unicode monthDefaultFullName05[] = { 0x69, 0x75, 0x6e, 0x69, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName05[] = { 0x69, 0x0 };
    static const sal_Unicode monthID06[] = { 0x6a, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultAbbrvName06[] = { 0x69, 0x75, 0x6c, 0x0 };
    static const sal_Unicode monthDefaultFullName06[] = { 0x69, 0x75, 0x6c, 0x69, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName06[] = { 0x69, 0x0 };
    ...
    static const sal_Unicode monthDefaultAbbrvName08[] = { 0x73, 0x65, 0x70, 0x74, 0x0 };
    static const sal_Unicode monthDefaultFullName08[]
        = { 0x73, 0x65, 0x70, 0x74, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName09[]
        = { 0x6f, 0x63, 0x74, 0x6f, 0x6d, 0x62, 0x72, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName010[]
        = { 0x6e, 0x6f, 0x69, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode monthDefaultFullName011[]
        = { 0x64, 0x65, 0x63, 0x65, 0x6d, 0x62, 0x72, 0x69, 0x65, 0x0 };
    static const sal_Unicode monthDefaultNarrowName011[] = { 0x64, 0x0 };
    static const sal_Unicode genitiveMonthID00[] = { 0x6a, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName00[] = { 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName00[]
        = { 0x69, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName00[] = { 0x69, 0x0 };
    static const sal_Unicode genitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode genitiveMonthDefaultAbbrvName01[] = { 0x66, 0x65, 0x62, 0x72, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultFullName02[]
        = { 0x6d, 0x61, 0x72, 0x74, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName05[] = { 0x69, 0x75, 0x6e, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName05[]
        = { 0x69, 0x75, 0x6e, 0x69, 0x65, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName06[] = { 0x69, 0x75, 0x6c, 0x0 };
    static const sal_Unicode genitiveMonthDefaultFullName06[]
        = { 0x69, 0x75, 0x6c, 0x69, 0x65, 0x0 };
    static const sal_Unicode genitiveMonthDefaultNarrowName06[] = { 0x69, 0x0 };
    ...
    static const sal_Unicode genitiveMonthDefaultAbbrvName08[] = { 0x73, 0x65, 0x70, 0x74, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName00[] = { 0x69, 0x61, 0x6e, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName00[]
        = { 0x69, 0x61, 0x6e, 0x75, 0x61, 0x72, 0x69, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName00[] = { 0x69, 0x0 };
    static const sal_Unicode partitiveMonthID01[] = { 0x66, 0x65, 0x62, 0x0 };
    static const sal_Unicode partitiveMonthDefaultAbbrvName01[] = { 0x66, 0x65, 0x62, 0x72, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName05[] = { 0x69, 0x75, 0x6e, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName06[] = { 0x69, 0x75, 0x6c, 0x0 };
    static const sal_Unicode partitiveMonthDefaultFullName06[]
        = { 0x69, 0x75, 0x6c, 0x69, 0x65, 0x0 };
    static const sal_Unicode partitiveMonthDefaultNarrowName06[] = { 0x69, 0x0 };
    ...
    static const sal_Unicode partitiveMonthDefaultAbbrvName08[] = { 0x73, 0x65, 0x70, 0x74, 0x0 };
    ...
    static const sal_Unicode eraDefaultAbbrvName00[] = { 0xee, 0x2e, 0x48, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName00[] = { 0xee, 0x2e, 0x48, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraID01[] = { 0x61, 0x64, 0x0 };

    static const sal_Unicode eraDefaultAbbrvName01[] = { 0x64, 0x2e, 0x48, 0x72, 0x2e, 0x0 };
    static const sal_Unicode eraDefaultFullName01[] = { 0x64, 0x2e, 0x48, 0x72, 0x2e, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCalendars_ro_RO(sal_Int16& count)
    {
    ...
    static const sal_Unicode currencyID0[] = { 0x52, 0x4f, 0x4e, 0x0 };
    static const sal_Unicode currencySymbol0[] = { 0x6c, 0x65, 0x69, 0x0 };
    static const sal_Unicode bankSymbol0[] = { 0x52, 0x4f, 0x4e, 0x0 };
    static const sal_Unicode currencyName0[] = { 0x4c, 0x65, 0x75, 0x0 };
    ...
    static const sal_Unicode currencyID1[] = { 0x52, 0x4f, 0x4c, 0x0 };
    static const sal_Unicode currencySymbol1[] = { 0x6c, 0x65, 0x69, 0x0 };
    static const sal_Unicode bankSymbol1[] = { 0x52, 0x4f, 0x4c, 0x0 };
    static const sal_Unicode currencyName1[] = { 0x4c, 0x65, 0x75, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getAllCurrencies_ro_RO(sal_Int16& count)
    {
        count = currencyCount;
        return (sal_Unicode**)currencies;
    }
    extern sal_Unicode** SAL_CALL getTransliterations_en_US(sal_Int16& count);
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getTransliterations_ro_RO(sal_Int16& count)
    {
        return getTransliterations_en_US(count);
    }
    static const sal_Unicode ReservedWord0[]
        = { 0x61, 0x64, 0x65, 0x76, 0x103, 0x72, 0x61, 0x74, 0x0 };
    static const sal_Unicode ReservedWord1[] = { 0x66, 0x61, 0x6c, 0x73, 0x0 };
    static const sal_Unicode ReservedWord2[]
        = { 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x75, 0x6c, 0x20, 0x31, 0x0 };
    static const sal_Unicode ReservedWord3[]
        = { 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x75, 0x6c, 0x20, 0x32, 0x0 };
    static const sal_Unicode ReservedWord4[]
        = { 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x75, 0x6c, 0x20, 0x33, 0x0 };
    static const sal_Unicode ReservedWord5[]
        = { 0x74, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x72, 0x75, 0x6c, 0x20, 0x34, 0x0 };
    static const sal_Unicode ReservedWord6[]
        = { 0x64, 0x65, 0x61, 0x73, 0x75, 0x70, 0x72, 0x61, 0x0 };
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getReservedWords_ro_RO(sal_Int16& count)
    {
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getForbiddenCharacters_ro_RO(sal_Int16& count)
    {
        count = 3;
    ...
    SAL_DLLPUBLIC_EXPORT sal_Unicode** SAL_CALL getBreakIteratorRules_ro_RO(sal_Int16& count)
    {
        count = 5;
    ...
    getContinuousNumberingLevels_ro_RO(sal_Int16& nStyles, sal_Int16& nAttributes)
    {
    ...
    extern const sal_Unicode**** SAL_CALL getOutlineNumberingLevels_en_US(sal_Int16& nStyles,
                                                                          ...
                                                                          sal_Int16& nAttributes);
    SAL_DLLPUBLIC_EXPORT const sal_Unicode**** SAL_CALL
    getOutlineNumberingLevels_ro_RO(sal_Int16& nStyles, sal_Int16& nLevels, sal_Int16& nAttributes)
    {
