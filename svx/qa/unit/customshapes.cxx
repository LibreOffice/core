...
{
    // tdf#145004 In case of ScaleX=true in property TextPath, SDRTEXTVERTADJUST is
    ...
    // The tested positions depend on dpi. Therefore a large tolerance is used.
    {
        ...
        CPPUNIT_ASSERT_DOUBLES_EQUAL(tools::Long(2916), aBoundRect.Top(), 50);
    }
    {
        ...
        tools::Rectangle aBoundRect(rSdrCustomShape.GetCurrentBoundRect());
        CPPUNIT_ASSERT_DOUBLES_EQUAL(tools::Long(9519), aBoundRect.Top(), 50);
    }
}
