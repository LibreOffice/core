...
CPPUNIT_TEST_FIXTURE(CustomshapesTest, testTdf128413_tbrlOnOff)
{
    ...
    OUString sError;
    if (aOrigFrameRect.Width != aChangeFrameRect.Width
        || aOrigFrameRect.Height != aChangeFrameRect.Height
        || aOrigFrameRect.X != aChangeFrameRect.X || aOrigFrameRect.Y != aChangeFrameRect.Y)
    {
