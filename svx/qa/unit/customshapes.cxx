...
CPPUNIT_TEST_FIXTURE(CustomshapesTest, testTdf103474_commandT_CaseZeroHeight)
{
    ...
    // bs-edit: following two lines changed to please Jenkins - see:
    // https://ci.libreoffice.org/job/gerrit_linux_clang_dbgutil/61359/consoleFull#-1883841888baec2b5c-2b20-4190-a3fa-ceac4be9cf93
    // bs-edit: original was:     const OUString sFileName("tdf103474_commandT_CaseZeroHeight.odp");
    // bs-edit: original was:     OUString sURL = m_directories.getURLFromSrc(sDataDirectory) + sFileName;
    // bs-edit: next line test:
    OUString sURL = m_directories.getURLFromSrc(sDataDirectory) + "tdf103474_commandT_CaseZeroHeight.odp";
