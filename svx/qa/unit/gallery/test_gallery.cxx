...
void GalleryObjTest::TestCreateTheme()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Could not create temporary directory",
                           helperObj.dirExists(aGalleryURL));
    ...
    CPPUNIT_ASSERT_MESSAGE("Could not find .thm file inside it",
                           helperObj.fileExists(aGalleryURL + "/" + myThemeName + ".thm"));
    CPPUNIT_ASSERT_MESSAGE("Could not find .sdv file inside it",
                           helperObj.fileExists(aGalleryURL + "/" + myThemeName + ".sdv"));
}
...
void GalleryObjTest::TestDeleteTheme()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Found .sdg file inside it after deletion",
                           !helperObj.fileExists(aGalleryURL + "/" + myThemeName + ".sdg"));
    CPPUNIT_ASSERT_MESSAGE("Found .str file inside it after deletion",
                           !helperObj.fileExists(aGalleryURL + "/" + myThemeName + ".str"));
}
