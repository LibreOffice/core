...
void GalleryObjTest::TestInsertGalleryObject()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Object count inconsistent", static_cast<sal_uInt32>(0),
...
void GalleryObjTest::TestRemoveGalleryObject()
{
    ...
    sal_uInt32 nSize = sizeof(imageList) / sizeof(imageList[0]);
