...
private:
    ...
    std::unique_ptr<weld::ToolbarUnoDispatcher> m_xFontStyleDispatch;

    std::unique_ptr<weld::Toolbar> m_xStyle;
    std::unique_ptr<weld::ToolbarUnoDispatcher> m_xStyleDispatch;

    std::unique_ptr<weld::Toolbar> m_xStyleNew;
    std::unique_ptr<weld::ToolbarUnoDispatcher> m_xStyleNewDispatch;
