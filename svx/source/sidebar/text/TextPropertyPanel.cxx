    ...
    const bool bIsEnabled)
{
    switch(nSID)
    {
        case SID_ATTR_CHAR_FONT:
        {
            ...
            if(eState >= SFX_ITEM_DEFAULT && dynamic_cast< const SvxFontItem* >(pState))
            {
                mpFontNameBox->SetText( static_cast< const SvxFontItem* >(pState)->GetFamilyName() );
            }
            else
            {
        ...
        case SID_ATTR_CHAR_FONTHEIGHT:
        {
            ...
            if(eState >= SFX_ITEM_DEFAULT && dynamic_cast< const SvxFontHeightItem* >(pState))
            {
                const SvxFontHeightItem* pTempItem = static_cast< const SvxFontHeightItem* >(pState);
                mpHeightItem = const_cast< SvxFontHeightItem* >(pTempItem);
                SfxMapUnit eUnit = maFontSizeControl.GetCoreMetric();
        ...
        case SID_ATTR_CHAR_WEIGHT:
        {
            ...
            if(eState >= SFX_ITEM_DEFAULT && dynamic_cast< const SvxWeightItem* >(pState))
            {
                meWeight = (FontWeight)static_cast< const SvxWeightItem* >(pState)->GetValue();
            }
            else
            {
                meWeight = WEIGHT_NORMAL;
        ...
        case SID_ATTR_CHAR_POSTURE:
            ...
            if(eState >= SFX_ITEM_DEFAULT && dynamic_cast< const SvxPostureItem* >(pState))
            {
                meItalic = (FontItalic)static_cast< const SvxPostureItem* >(pState)->GetValue();
            }
            else
            {
                meItalic = ITALIC_NONE;
        ...
        case SID_ATTR_CHAR_UNDERLINE:
            ...
            {
                const SvxUnderlineItem* pItem = dynamic_cast< const SvxUnderlineItem* >(pState);
        ...
        case SID_ATTR_CHAR_SHADOWED:
            if(eState >= SFX_ITEM_DEFAULT && dynamic_cast< const SvxShadowedItem* >(pState))
            {
                mbShadow = static_cast< const SvxShadowedItem* >(pState)->GetValue();
            }
            else
            {
                mbShadow = false;
        ...
        case SID_ATTR_CHAR_STRIKEOUT:
            if(eState >= SFX_ITEM_DEFAULT && dynamic_cast< const SvxCrossedOutItem* >(pState))
            {
                meStrike = (FontStrikeout)static_cast< const SvxCrossedOutItem* >(pState)->GetValue();
            }
            else
            {
                meStrike = STRIKEOUT_NONE;
        ...
        case SID_ATTR_CHAR_ESCAPEMENT:
        {
            ...
            {
                const SvxEscapementItem* pItem = dynamic_cast< const SvxEscapementItem* >(pState);
        ...
        case SID_SET_SUB_SCRIPT:
            ...
            {
                mbSub = static_cast< const SfxBoolItem* >(pState)->GetValue();
            }
            else
            {
                mbSub = false;
        ...
        case SID_SET_SUPER_SCRIPT:
            if(eState >= SFX_ITEM_DEFAULT && dynamic_cast< const SfxBoolItem* >(pState))
            {
                mbSuper = static_cast< const SfxBoolItem* >(pState)->GetValue();
            }
            else
            {
                mbSuper = false;
        ...
        case SID_ATTR_CHAR_KERNING:
            ...
            {
                mbKernLBAvailable = true;
                const SvxKerningItem* pKerningItem = dynamic_cast< const SvxKerningItem* >(pState);
