...
#include <svx/SignSignatureLineDialog.hxx>
...
SignSignatureLineDialog::SignSignatureLineDialog(weld::Widget* pParent, Reference<XModel> xModel)
    : GenericDialogController(pParent, "svx/ui/signsignatureline.ui", "SignSignatureLineDialog")
    , m_xEditName(m_xBuilder->weld_entry("edit_name"))
    , m_xComment(m_xBuilder->weld_text_view("edit_comment"))
    , m_xModel(xModel)
{
    m_xComment->set_size_request(m_xEditInstructions->get_approximate_digit_width() * 48,
