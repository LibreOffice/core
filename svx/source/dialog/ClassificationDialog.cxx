...
std::vector<ClassificationResult> ClassificationDialog::getResult()
{
    ...
    for (editeng::Section const & rSection : aSections)
    {
        while (nCurrentParagraph < rSection.mnParagraph)
        {
            ...
            aClassificationResults.push_back({ ClassificationType::PARAGRAPH, sWeightProperty });
        }
        ...
        {
            aClassificationResults.push_back({ pClassificationField->meType , sString });
        }
        else
        {
            aClassificationResults.push_back({ ClassificationType::TEXT, sString });
        }
    }
