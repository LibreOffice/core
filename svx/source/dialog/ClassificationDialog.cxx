...
ClassificationDialog::ClassificationDialog(weld::Window* pParent, const bool bPerParagraph, std::function<void()>  rParagraphSignHandler)
    ...
    , m_aParagraphSignHandler(std::move(rParagraphSignHandler))
