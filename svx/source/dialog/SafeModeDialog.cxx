    ...
    maBackupFileHelper()
{
    ...
    // Set URL for feedback button
    OUString module = "safemode";
    OUString sURL("http://hub.libreoffice.org/send-feedback/?LOversion=" + utl::ConfigManager::getAboutBoxProductVersion() +
        "&LOlocale=" + utl::ConfigManager::getLocale() + "&LOmodule=" + module);
...
void SafeModeDialog::openWebBrowser(const OUString & sURL, const OUString &sTitle) const
{
