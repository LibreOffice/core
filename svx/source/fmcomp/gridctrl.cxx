...
sal_uInt16 DbGridControl::SetOptions(sal_uInt16 nOpt)
{
    ...
    {
        // feststellen welche Updatemˆglichkeiten bestehen
...
void DbGridControl::RecalcRows(long nNewTopRow, sal_uInt16 nLinesOnScreen, sal_Bool bUpdateCursor)
{
    ...
    // Im folgenden werden die Positionierungen so vorgenommen, daﬂ sichergestellt ist
    // daﬂ ausreichend Zeilen im DatenCache vorhanden sind
...
sal_Bool DbGridControl::SeekCursor(long nRow, sal_Bool bAbsolute)
{
        ...
        nRow >= m_nCurrentPos)
    {
        ...
        {
            // auf die aktuelle Zeile bewegt, dann muﬂ kein abgleich gemacht werden, wenn
...
/*  Application::EnterWait();
    ...
    /*
    // muﬂ der Cache wiederhergestellt werden?
    if (nCacheSize)
    {
