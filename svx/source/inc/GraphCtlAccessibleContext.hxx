...
class SvxGraphCtrlAccessibleContext : public SvxGraphCtrlAccessibleContext_Base, ::comphelper::OBaseMutex, SfxListener
{
public:
...
public:
    ...
    */
    ...
    virtual void SAL_CALL addEventListener( const ::com::sun::star::uno::Reference< ::com::sun::star::document::XEventListener >& xListener ) throw (::com::sun::star::uno::RuntimeException);
    virtual void SAL_CALL removeEventListener( const ::com::sun::star::uno::Reference< ::com::sun::star::document::XEventListener >& xListener ) throw (::com::sun::star::uno::RuntimeException);
...
private:
    ...
    ::com::sun::star::uno::Reference< ::drafts::com::sun::star::accessibility::XAccessible > SAL_CALL getAccessible( SdrObject* pObj );
    ...
    */
    ...
    typedef ::std::map< SdrObject*, ::drafts::com::sun::star::accessibility::XAccessible*, SdrObjectCompareLess >
        ShapesMapType;
