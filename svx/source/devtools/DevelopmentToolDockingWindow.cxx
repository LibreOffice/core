...
private:
    ...
    DevelopmentToolDockingWindow* mpDockingWindow;
...
void DevelopmentToolDockingWindow::inspectSpreadsheet()
{
    ...
    uno::Reference<sheet::XSpreadsheets> xSheets(xSheetDoc->getSheets(), uno::UNO_QUERY);
...
void DevelopmentToolDockingWindow::introspect(uno::Reference<uno::XInterface> const& xInterface)
{
    ...
    auto xProperties = xIntrospectionAccess->getProperties(beans::PropertyConcept::ALL
                                                           - beans::PropertyConcept::DANGEROUS);
