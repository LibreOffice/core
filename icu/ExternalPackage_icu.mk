...
$(eval $(call gb_ExternalPackage_add_files,icu,lib,\
	source/lib/libicudata.so.$(ICU_MAJOR).$(ICU_MINOR).$(ICU_MICRO) \
	source/lib/libicudata.so.$(ICU_MAJOR) \
	source/lib/libicudata.so \
	source/lib/libicuuc.so.$(ICU_MAJOR).$(ICU_MINOR).$(ICU_MICRO) \
	source/lib/libicuuc.so.$(ICU_MAJOR) \
	source/lib/libicuuc.so \
	source/lib/libicui18n.so.$(ICU_MAJOR).$(ICU_MINOR).$(ICU_MICRO) \
	source/lib/libicui18n.so.$(ICU_MAJOR) \
	source/lib/libicui18n.so \
	source/lib/libicule.so.$(ICU_MAJOR).$(ICU_MINOR).$(ICU_MICRO) \
	source/lib/libicule.so.$(ICU_MAJOR) \
	source/lib/libicule.so \
	source/lib/libicutu.so.$(ICU_MAJOR).$(ICU_MINOR).$(ICU_MICRO) \
	source/lib/libicutu.so.$(ICU_MAJOR) \
	source/lib/libicutu.so \
))
$(eval $(call gb_ExternalPackage_add_files,icu,bin,\
	source/bin/genccode \
	source/bin/genbrk \
