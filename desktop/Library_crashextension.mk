...
$(eval $(call gb_Library_set_componentfile,crashextension,desktop/test/deployment/crashextension/crashextension,crashextension_platform))

$(eval $(call gb_Library_set_external_code,crashextension))

$(eval $(call gb_Library_use_externals,crashextension, \
    boost_headers \
))
