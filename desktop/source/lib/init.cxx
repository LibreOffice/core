...
OUString desktop::extractParameter(OUString& rOptions, const OUString& rName)
{
    ...
    else if ((nIndex = rOptions.indexOf(aCommaNameEquals)) >= 0)
    {
        ...
        if (nComma >= 0)
        {
            ...
            rOptions = OUString::Concat(u"") + rOptions.subView(0, nIndex) + rOptions.subView(nComma);
        }
        else
        {
...
static int doc_saveAs(LibreOfficeKitDocument* pThis, const char* sUrl, const char* pFormat, const char* pFilterOptions)
{
    ...
    try
    {
        ...
        if ((aIndex = aFilterOptions.indexOf(",Watermark=")) >= 0)
        {
            ...
            aFilterOptions = OUString::Concat(u"") + aFilterOptions.subView(0, aIndex) + aFilterOptions.subView(bIndex+12);
        }
        ...
        if ((aIndex = aFilterOptions.indexOf(",FullSheetPreview=")) >= 0)
        {
            ...
            aFilterOptions = OUString::Concat(u"") + aFilterOptions.subView(0, aIndex) + aFilterOptions.subView(bIndex+16);
        }
