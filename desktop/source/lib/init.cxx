...
static void doc_postKeyEvent(LibreOfficeKitDocument* pThis,
                             ...
                             int nCharCode,
                             int nKeyCode);
static void doc_setFreemiumSession(bool isFreemium, const char* freemiumBlacklist);
...
static void doc_setFreemiumSession(bool isFreemium, const char* freemiumBlacklist)
{
    comphelper::LibreOfficeKit::setFreemiumBlackList(freemiumBlacklist);

    SfxLokHelper::setFreemiumView(isFreemium);
}
