...
static LibreOfficeKitDocument* lo_documentLoadWithOptions(LibreOfficeKit* pThis, const char* pURL, const char* pOptions)
{
    ...
    try
    {
        ...
        const OUString aDisableMacrosExecution = extractParameter(aOptions, "DisableMacrosExecution");
        sal_Int16 nMacroExecMode = aDisableMacrosExecution == "false" ? document::MacroExecMode::USE_CONFIG :
