...
const char copyright_text_1[] = "Copyright © 2005 Sun Microsystems, Inc., All rights reserved.";
...
const char copyright_text_21[] = "Copyright © 2005 Sun Microsystems, Tous droits réservés.";
...
const char copyright_text_25[] = "Cette distribution peut comprendre des composants dÃ©veloppÃ©s par des tierces parties.";
const char copyright_text_26[] = "Sun, Sun Microsystems, le logo Sun, Java, Solaris et StarOffice sont des marques de fabrique ou des marques dÃ©posÃ©es de Sun Microsystems, Inc. aux Etats-Unis et dans d'autres pay";
const char copyright_text_27[] = "Toutes les marques SPARC sont utilisÃ©es sous licence et sont des marques de fabrique ou des marques dÃ©posÃ©es de SPARC International, Inc. aux Etats-Unis et dans d'autres pay";
const char copyright_text_28[] = "UNIX est une marque dÃ©posÃ©e aux Etats-Unis et dans d'autres pays et licenciÃ©e exlusivement par X/Open Company, Ltd.";
