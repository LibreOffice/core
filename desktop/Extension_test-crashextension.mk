...
$(eval $(call gb_Extension_add_file,test-crashextension,platform.components,$(call gb_Rdb_get_target,crashextension_platform)))
...
$(eval $(call gb_Extension_add_files,test-crashextension,, \
    ...
    $(SRCDIR)/desktop/test/deployment/crashextension/ToolbarMerge.xcu \
