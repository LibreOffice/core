...
void DesktopLOKTest::testRenderSearchResult()
{
    ...
    CPPUNIT_ASSERT_EQUAL(size_t(66768), nByteSize);
    CPPUNIT_ASSERT_EQUAL(642, nWidth);
    CPPUNIT_ASSERT_EQUAL(26, nHeight);

    const sal_uInt8* pD = reinterpret_cast<const sal_uInt8*>(pBuffer);
    BitmapEx aBitmap = vcl::bitmap::CreateFromData(pD, nWidth, nHeight, nWidth * 4, vcl::PixelFormat::N32_BPP, true);
    ...
    CPPUNIT_ASSERT_EQUAL(tools::Long(26), aBitmap.GetSizePixel().Height());
