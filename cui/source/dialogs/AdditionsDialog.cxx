...
AdditionsDialog::AdditionsDialog(weld::Window* pParent)
    ...
    , m_xButtonSettings(m_xBuilder->weld_button("buttonSettings"))
...
void AdditionsDialog::fillGrid()
{
    ...
    for (const auto& additionInfo : additionInfos)
    {
        ...
        aCurrentItem.m_xButtonInstall->set_label("Install");
        OUString sLicenseString = "License: " + additionInfo.sLicense;
        aCurrentItem.m_xLabelLicense->set_label(sLicenseString);
        OUString sVersionString = "Required version: >= " + additionInfo.sVersion;
