    ...
    , m_sDownloadURL("")
{
    ...
    sal_Int32 maxExtensionNameLength = 27;

    if (additionInfo.sName.getLength() >= maxExtensionNameLength)
    {
        OUString sShortName = additionInfo.sName.copy(0, maxExtensionNameLength);
        sExtensionName = sShortName + OUString::createFromAscii("...");
    }
    else
    {
