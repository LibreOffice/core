...
IMPL_LINK_NOARG(AdditionsItem, InstallHdl, weld::Button&, void)
{
    ...
    catch (const ucb::CommandFailedException& e)
    {
        SAL_WARN("cui.dialogs",
                 "Additions: addExtension CommandFailedException occured. " << e.what());
        m_xButtonInstall->set_label("Install");
        m_xButtonInstall->set_sensitive(true);
    }
    catch (const ucb::CommandAbortedException& e)
    {
        SAL_WARN("cui.dialogs",
                 "Additions: addExtension CommandAbortedException occured. " << e.what());
        m_xButtonInstall->set_label("Install");
        m_xButtonInstall->set_sensitive(true);
    }
    ...
    {
        SAL_WARN("cui.dialogs",
                 "Additions: addExtension DeploymentException occured. " << e.what());
        m_xButtonInstall->set_label("Install");
        m_xButtonInstall->set_sensitive(true);
    }
    catch (const lang::IllegalArgumentException& e)
    {
        SAL_WARN("cui.dialogs",
                 "Additions: addExtension IllegalArgumentException occured. " << e.what());
        m_xButtonInstall->set_label("Install");
        m_xButtonInstall->set_sensitive(true);
    }
    catch (const css::uno::Exception& e)
    {
        SAL_WARN("cui.dialogs", "Additions: addExtension Exception occured. " << e.what());
        m_xButtonInstall->set_label("Install");
        m_xButtonInstall->set_sensitive(true);
    }
}
