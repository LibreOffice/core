    ...
    , m_xSpinBorder(m_xBuilder->weld_spin_button("edit_border"))
{
    ...
    m_xEdittext->set_text(aQrCode.Text);
...
{
    css::drawing::QrCode aQrCode;
    aQrCode.Text = m_xEdittext->get_text();
    aQrCode.ECC = m_aECCSelect;
    aQrCode.Border = m_xSpinBorder->get_value();

    // Read svg and replace placeholder texts
    OUString aSvgImage = GenerateQrCode(aQrCode.Text, aQrCode.ECC, aQrCode.Border);
