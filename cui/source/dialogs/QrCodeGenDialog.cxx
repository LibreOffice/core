    ...
    , m_xSpinBorder(m_xBuilder->weld_spin_button("edit_border"))
{
    ...
    xProps->getPropertyValue("QrCodeShape") >>= aQrCode;
...
void QrCodeGenDialog::Apply()
{
    ...
    xShapeProps->setPropertyValue("QrCodeShape", Any(aQrCode));
...
void QrCodeGenDialog::SelectErrorCorrection(weld::ToggleButton& rButton)
{
    ...
    if (nPos != -1 && nPos != maBox.GetCurrentButtonPos())
    {
        ...
        m_aECCSelect
            = static_cast<css::drawing::QRCodeErrorCorrection>(maBox.GetCurrentButtonPos());
    }
}
...
void QrCodeGenDialog::GetErrorCorrection(css::drawing::QRCodeErrorCorrection ErrorCorrection)
{
    switch (ErrorCorrection)
    {
        case MEDIUM:
        {
            ...
            m_aECCSelect = css::drawing::QRCodeErrorCorrection::MEDIUM;
            break;
        }
        case QUARTILE:
        {
            m_xRadioQuartile->set_active(true);
            m_aECCSelect = css::drawing::QRCodeErrorCorrection::QUARTILE;
            break;
        }
        case HIGH:
        {
            m_xRadioHigh->set_active(true);
            m_aECCSelect = css::drawing::QRCodeErrorCorrection::HIGH;
            break;
        }
        default:
        {
