...
void QrCodeGenDialog::GenerateQRCode(OUString aQRText, tools::Long aQRECC, int aQRBorder, SvMemoryStream &aStream)
{
#if ENABLE_ZXING
    ...
    SvMemoryStream *aPngStream=&aStream;
    stbi_write_png_to_func(WritePNGtoStream, aPngStream, bitmap.height(), bitmap.width(), 0, bitmap.data(), 1);
#else
    (void)aQRText;
    (void)aQRECC;
    (void)aQRBorder;
