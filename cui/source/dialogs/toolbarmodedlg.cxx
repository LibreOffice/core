...
const OUString ModeNames[9] = {"Default","Single","Sidebar",
    "notebookbar.ui","notebookbar_compact.ui","notebookbar_groupedbar_compact.ui",
    "notebookbar_groupedbar_full.ui","notebookbar_single.ui","notebookbar_groups.ui"};
const OUString ImageNames[9] = {"default.png","single.png","sidebar.png","notebookbar.png",
    "notebookbar_compact.png","notebookbar_groupedbar_compact.png","notebookbar_groupedbar_full.png",
    "notebookbar_single.png","notebookbar_groups.png"};
...
ToolbarmodeDialog::ToolbarmodeDialog(weld::Window* pParent)
    ...
    , m_pRadioButtons{
        (m_xBuilder->weld_radio_button("rbButton1")),
...
IMPL_LINK_NOARG(ToolbarmodeDialog, OnApplyClick, weld::Button&, void)
{
    ...
    comphelper::dispatchCommand(".uno:Notebookbar?File:string="+aCmd, {});
    Scheduler::ProcessEventsToIdle();
    comphelper::dispatchCommand(".uno:ToolbarMode?Mode:string="+aCmd, {});
    Scheduler::ProcessEventsToIdle();
}