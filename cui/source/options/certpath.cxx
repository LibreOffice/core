    ...
    , m_xManualLabel(m_xBuilder->weld_label("manual"))
{
    ...
    catch (const uno::Exception &)
    {
        ...
        SAL_WARN("cui.options", "CertPathDialog::CertPathDialog(): " << exceptionToString(ex));
    }
...
IMPL_LINK_NOARG(CertPathDialog, OKHdl_Impl, weld::Button&, void)
{
    ...
    {
        css::uno::Any ex( cppu::getCaughtException() );
        SAL_WARN("cui.options", "CertPathDialog::OKHdl_Impl(): " << exceptionToString(ex));
    }
...
IMPL_LINK_NOARG(CertPathDialog, AddHdl_Impl, weld::Button&, void)
{
    ...
    {
        css::uno::Any ex( cppu::getCaughtException() );
        SAL_WARN("cui.options", exceptionToString(ex));
    }
}
