...
static bool getPreviewFile( const PersonaInfo& aPersonaInfo, OUString& pPreviewFile )
{
...
static void parseResponse(const std::string& rResponse, std::vector<PersonaInfo> & aPersonas)
{
