...
IMPL_LINK_TYPED( SelectPersonaDialog, SearchPersonas, Button*, pButton, void )
{
    ...
    if( searchTerm.startsWith( "https://" ) )
        rSearchURL = "https://services.addons.mozilla.org/en-US/firefox/api/1.5/" + searchTerm;
    else
        rSearchURL = "https://services.addons.mozilla.org/en-US/firefox/api/1.5/search/" + searchTerm + "/9/9";
