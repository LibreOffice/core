...
std::vector< OUString > commaStringToSequence( const OUString& rCommaSepString )
{
    ...
    return tempVector;//comphelper::containerToSequence( tempVector );
}
        ...
        if( bOpenDialog )
        {
            ...
            if( ret == RET_OK )
            {
                ...
                if ( sPropertyType == OUString("short"))
                {
                    ...
                    {
                        uno::Sequence< sal_Int16 > seqShort=
                    ...
                    else if( sPropertType == OUString("[]hyper") )
                    {
                        uno::Sequence< sal_Int64 > seqHyper=
                        comphelper::containerToSequence(
                                commaStringToSequence( sNewValue ) );
