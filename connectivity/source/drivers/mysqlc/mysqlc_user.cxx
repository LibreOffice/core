...
User::User(css::uno::Reference<css::sdbc::XConnection> rConnection)
    : OUser(true) // Case Sensitive
    , m_xConnection(std::move(rConnection))
{
}

User::User(css::uno::Reference<css::sdbc::XConnection> rConnection, const OUString& rName)
    : OUser(rName,
            true) // Case Sensitive
    , m_xConnection(std::move(rConnection))
{
