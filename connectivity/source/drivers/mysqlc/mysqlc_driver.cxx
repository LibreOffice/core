...
Reference<XConnection> SAL_CALL MysqlCDriver::connect(const rtl::OUString& url,
...
MysqlCDriver::getPropertyInfo(const rtl::OUString& url, const Sequence<PropertyValue>& /* info */)
{
    if (acceptsURL(url))
    {
        ...
        aDriverInfo.push_back(
            DriverPropertyInfo(rtl::OUString("Hostname"), rtl::OUString("Name of host"), true,
                               rtl::OUString("localhost"), Sequence<rtl::OUString>()));
        aDriverInfo.push_back(DriverPropertyInfo(rtl::OUString("Port"), rtl::OUString("Port"), true,
                                                 rtl::OUString("3306"), Sequence<rtl::OUString>()));
