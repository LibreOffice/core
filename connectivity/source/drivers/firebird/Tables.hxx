...
namespace connectivity::firebird
    {
        ...
        public:
            Tables(css::uno::Reference< css::sdbc::XDatabaseMetaData >  rMetaData,
                   ::cppu::OWeakObject& rParent,
                   ::osl::Mutex& rMutex,
                   ::std::vector< OUString> const & rNames) : sdbcx::OCollection(rParent, true, rMutex, rNames), m_xMetaData(std::move(rMetaData)) {}
