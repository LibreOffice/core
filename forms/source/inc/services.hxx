 ...
 *  $Revision: 1.7 $
 *
 *  last change: $Author: kz $ $Date: 2003-12-11 12:31:53 $
 *
...
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_BINDDB_CHECKBOX       );
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_BINDDB_COMBOBOX       );
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_BINDDB_FORMATTEDFIELD );
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_BINDDB_LISTBOX        );
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_BINDDB_NUMERICFIELD   );
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_BINDDB_RADIOBUTTON    );
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_BINDDB_TEXTFIELD      );
