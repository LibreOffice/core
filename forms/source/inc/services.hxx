 ...
 *  $Revision: 1.8 $
 *
 *  last change: $Author: rt $ $Date: 2004-04-02 10:58:28 $
 *
...
DECLARE_CONSTASCII_USTRING( VCL_CONTROLMODEL_SCROLLBAR );
DECLARE_CONSTASCII_USTRING( VCL_CONTROL_SCROLLBAR );
DECLARE_CONSTASCII_USTRING( VCL_CONTROLMODEL_SPINBUTTON );
DECLARE_CONSTASCII_USTRING( VCL_CONTROL_SPINBUTTON );
...
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_SCROLLBAR      );
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_SPINBUTTON     );
...
DECLARE_CONSTASCII_USTRING( FRM_SUN_COMPONENT_DATABASE_FORMATTEDFIELD );
...
DECLARE_CONSTASCII_USTRING( BINDABLE_DATABASE_CHECK_BOX       );
DECLARE_CONSTASCII_USTRING( BINDABLE_DATABASE_COMBO_BOX       );
DECLARE_CONSTASCII_USTRING( BINDABLE_DATABASE_FORMATTED_FIELD );
DECLARE_CONSTASCII_USTRING( BINDABLE_DATABASE_LIST_BOX        );
DECLARE_CONSTASCII_USTRING( BINDABLE_DATABASE_NUMERIC_FIELD   );
DECLARE_CONSTASCII_USTRING( BINDABLE_DATABASE_RADIO_BUTTON    );
DECLARE_CONSTASCII_USTRING( BINDABLE_DATABASE_TEXT_FIELD      );

DECLARE_CONSTASCII_USTRING( BINDABLE_CONTROL_MODEL              );
DECLARE_CONSTASCII_USTRING( BINDABLE_DATA_AWARE_CONTROL_MODEL   );
DECLARE_CONSTASCII_USTRING( DATA_AWARE_CONTROL_MODEL            );
DECLARE_CONSTASCII_USTRING( VALIDATABLE_CONTROL_MODEL           );
DECLARE_CONSTASCII_USTRING( VALIDATABLE_BINDABLE_CONTROL_MODEL  );
