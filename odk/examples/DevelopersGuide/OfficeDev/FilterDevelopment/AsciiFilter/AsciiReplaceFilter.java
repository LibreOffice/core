 ...
 *  $Revision: 1.2 $
 *
 *  last change: $Author: vg $ $Date: 2003-06-10 10:33:20 $
 *
...
public class AsciiReplaceFilter extends     WeakBase
                                            ...
                                            com.sun.star.document.XFilter
{
    ...
    // const
    public static final String SERVICENAME_IMPORTFILTER = "com.sun.star.document.ImportFilter";
    public static final String SERVICENAME_EXPORTFILTER = "com.sun.star.document.ExportFilter";
    ...
    /**
        ...
        * @param xSMGR
        *  the creator of us
        *  We save it to be able to create own services if neccessary.
        */
    public AsciiReplaceFilter( com.sun.star.lang.XMultiServiceFactory xSMGR )
    {
    ...
    /**
     * It's not allowe for us - neither very easy to change our internal
    ...
    public boolean filter( com.sun.star.beans.PropertyValue[] lDescriptor )
    {
        ...
        synchronized(this)
        {
            aOptions = new FilterOptions(m_xSMGR, m_bImport, lDescriptor);
            bImport  = m_bImport;
            xText    = m_xDocument;
        }
    ...
    /**
     * Makes the filter process breakable. To do so the outside code may must use threads.
    ...
    public String[] getSupportedServiceNames()
    {
        ...
        lNames[0] = SERVICENAME_IMPORTFILTER;
        lNames[1] = SERVICENAME_EXPORTFILTER;
        return lNames;
    }
    ...
    {
        return (
                sService.equals( SERVICENAME_IMPORTFILTER ) ||
                sService.equals( SERVICENAME_EXPORTFILTER )
                );
    }
    ...
    {
        return AsciiReplaceFilter.class.getName();
    }
}
