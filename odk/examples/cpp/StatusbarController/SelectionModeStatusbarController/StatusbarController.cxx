...
StatusbarController::StatusbarController()
    ...
    , m_bOwnerDraw( false )
{
    OSL_TRACE( "sbctlselmode::StatusbarController::StatusbarController" );
}
...
{
    OSL_TRACE( "sbctlselmode::StatusbarController::dispose" );
...
{
    OSL_TRACE( "sbctlselmode::StatusbarController::initialize" );
...
{
    OSL_TRACE( "sbctlselmode::StatusbarController::BindListeners" );
...
{
    OSL_TRACE( "sbctlselmode::StatusbarController::UnbindListeners" );
...
{
    OSL_TRACE( "sbctlselmode::StatusbarController::IsBound" );
...
{
    OSL_TRACE( "sbctlselmode::StatusbarController::Execute" );
...
{
    OSL_TRACE( "sbctlselmode::StatusbarController::UpdateStatus" );
    Reference< XStatusListener > xStatusListener;
    Reference< XDispatch > xDispatch;
    URL aURL;
...
throw ( RuntimeException )
{
    OSL_TRACE( "sbctlselmode::StatusbarController::statusChanged" );
    osl::ClearableMutexGuard aGuard( m_aMutex );
...
throw ( RuntimeException )
{
    OSL_TRACE( "sbctlselmode::StatusbarController::disposing" );
    osl::MutexGuard aGuard( m_aMutex );
...
throw ( RuntimeException )
{
    OSL_TRACE( "sbctlselmode::StatusbarController::update" );
    osl::ClearableMutexGuard aGuard( m_aMutex );
    ThrowIfDisposed();
    aGuard.clear();
...
throw ( RuntimeException )
{
    OSL_TRACE( "sbctlselmode::StatusbarController::doubleClick" );
    osl::ClearableMutexGuard aGuard( m_aMutex );
    if ( rBHelper.bDisposed || rBHelper.bInDispose )
        return;
    aGuard.clear();
