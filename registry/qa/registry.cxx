...
static typereg::Reader getStructReader(Registry* registry, sal_uInt32& nSize)
{
...
static typereg::Reader getEnumReader(Registry* registry, sal_uInt32& nSize)
{
...
static typereg::Reader getInterfaceReader(Registry* registry, sal_uInt32& nSize)
{
...
static typereg::Reader getExceptionReader(Registry* registry, sal_uInt32& nSize)
{
...
static typereg::Reader getServiceReader(Registry* registry, sal_uInt32& nSize)
{
...
static typereg::Reader getConstantsGroupReader(Registry* registry, sal_uInt32& nSize)
{
    RegistryKey key = createKey(registry, "ServiceA");
