...
$(eval $(call gb_StaticLibrary_use_unpacked,jpeglib,wps))

$(eval $(call gb_StaticLibrary_use_package,jpeglib,libwps_inc))

$(eval $(call gb_StaticLibrary_use_externals,jpeglib,\
	wpd \
))

#$(eval $(call gb_StaticLibrary_set_generated_cxx_suffix,jpeglib,cpp))
