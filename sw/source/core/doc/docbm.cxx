...
namespace
{
    ...
    static const int BEFORE_NODE = 0;          
    static const int BEFORE_SAME_NODE = 1;     
    static const int SAME_POSITION = 2;        
    static const int BEHIND_SAME_NODE = 3;     
    static const int BEHIND_NODE = 4;          
