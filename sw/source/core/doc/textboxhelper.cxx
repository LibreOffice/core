...
void SwTextBoxHelper::create(SwFrameFormat* pShape, bool bCopyText)
{
    ...
    for (auto aSavedShapeInfoPair : ::PropertyCollector::Get().GetSavedProperties())
    {
        if (aSavedShapeInfoPair.first == pShape)
        {
            for (auto aSavedWIdInfoPair : aSavedShapeInfoPair.second)
            {
                for (auto aSavedMemberIdInfoPair : aSavedWIdInfoPair.second)
