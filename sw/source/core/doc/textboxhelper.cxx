...
bool SwTextBoxHelper::isTextBox(const SwFrameFormat* pFormat, sal_uInt16 nType, SdrObject* pObject)
{
    ...
    if (!pTextBox)
        return false;
    else if (nType == RES_DRAWFRMFMT && (pObject || pFormat->FindRealSdrObject()))
        return pTextBox->GetTextBox(pObject ? pObject : pFormat->FindRealSdrObject());
    else if (nType == RES_FLYFRMFMT)
...
SwTextBoxNode::SwTextBoxNode(SwFrameFormat* pOwnerShape)
{
    ...
    //pOwnerShape->SetOtherTextBoxFormat(this);
}
