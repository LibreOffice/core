    ...
    if (isTextBoxShapeHasValidTextFrame(pShape, pObj))
    {
        if (auto pFormat = getOtherTextBoxFormat(pShape, RES_DRAWFRMFMT, pObj))
        {
            ...
            if (auto xFrame = SwXTextFrame::CreateXTextFrame(*pFormat->GetDoc(), pFormat))
                ...
                SAL_WARN("sw.core", "SwTextBoxHelper::setWrapThrough: No XTextFrame!" << sErrMsg);
        }
        else
            SAL_WARN("sw.core",
                     "SwTextBoxHelper::setWrapThrough: No Other TextBox Format!" << sErrMsg);
    }
    else
        SAL_WARN("sw.core",
                 "SwTextBoxHelper::setWrapThrough: Not a Valid TextBox object!" << sErrMsg);
