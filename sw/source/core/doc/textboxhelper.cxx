...
const bool SwTextBoxHelper::HasSwTextFrame(const SdrObject* pObj)
{
    return GetSwTextFrame(pObj) ? true : false;
}

SwFrameFormat* SwTextBoxHelper::GetSwTextFrame(const SdrObject* pObj)
{
    if (!pObj)
        return nullptr;
...
void SwTextBoxHelper::UpdateTxBxMargin(SdrObject* pObj)
{
    if (!pObj)
        return;
