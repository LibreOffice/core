                                   ...
                                   const css::uno::Any& rValue, SdrObject* pObj)
{
    ...
    if (bAdjustX || bAdjustY || bAdjustSize)
    {
        ...
        if (!aRect.IsEmpty())
        {
            ...
            {
                awt::Size aSize(convertTwipToMm100(aRect.getHalfOpenWidth()),
                                convertTwipToMm100(aRect.getHalfOpenHeight()));
                aValue <<= aSize;
            }
        }
    }
    ...
    do
    {
        switch (pItem->Which())
        {
            case RES_VERT_ORIENT:
            {
                ...
                if (!aRect.IsEmpty())
                {
                    aSize.SetHeight(aRect.getHalfOpenHeight());
            ...
            case RES_FRM_SIZE:
            {
                ...
                if (!aRect.IsEmpty())
                {
                    ...
                    aSize.SetWidth(aRect.getHalfOpenWidth());
                    aSize.SetHeight(aRect.getHalfOpenHeight());
                    aTextBoxSet.Put(aSize);
                }
            }
