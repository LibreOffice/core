...
#define COMMON_CRSR_PARA_PROPERTIES_WITHOUT_FN \
        ...
        { SW_PROP_NAME(UNO_NAME_CHAR_KERNING            ),  RES_CHRATR_KERNING    , &::getCppuType((const sal_Int16*)0)  ,          PropertyAttribute::MAYBEVOID,   CONVERT_TWIPS},                                                           \
...
//                  { SW_PROP_NAME(UNO_NAME_REGISTER_MODE_ACTIVE),  SID_SWREGISTER_MODE,    &::getBooleanCppuType(),            PROPERTY_NONE , 0 },
            ...
            case PROPERTY_MAP_TEXT_DEFAULT :
            {
                ...
                SfxItemPropertyMap * pMap = &aTextDefaultMap_Impl[0];
                while ( pMap->pName )
                {
