...
void SwFrame::dumpInfosAsXml( xmlTextWriterPtr writer ) const
{
    ...
    xmlTextWriterWriteFormatAttribute( writer, BAD_CAST( "left" ), "%ld", geFrameArea().Left() );
    xmlTextWriterWriteFormatAttribute( writer, BAD_CAST( "top" ), "%ld", geFrameArea().Top() );
    xmlTextWriterWriteFormatAttribute( writer, BAD_CAST( "width" ), "%ld", geFrameArea().Width() );
    xmlTextWriterWriteFormatAttribute( writer, BAD_CAST( "height" ), "%ld", geFrameArea().Height() );
