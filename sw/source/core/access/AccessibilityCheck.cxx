...
void AccessibilityCheck::checkObject(SdrObject* pObject)
{
    ...
    // Checking if there is floating text object and if so, throwing a warning.
    // (Floating objects with text create problems with reading order)
    if (pObject->HasText()
