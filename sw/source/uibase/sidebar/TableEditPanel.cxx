...
TableEditPanel::TableEditPanel(vcl::Window* pParent,
    ...
    , m_xInsertDispatch(new weld::ToolbarUnoDispatcher(*m_xInsert, rxFrame))
    , m_xSelect(m_xBuilder->weld_toolbar("select"))
    , m_xSelectDispatch(new weld::ToolbarUnoDispatcher(*m_xSelect, rxFrame))
    , m_xRowSizing(m_xBuilder->weld_toolbar("rowsizing"))
    , m_xRowSizingDispatch(new weld::ToolbarUnoDispatcher(*m_xRowSizing, rxFrame))
    , m_xColumnSizing(m_xBuilder->weld_toolbar("columnsizing"))
    , m_xColumnSizingDispatch(new weld::ToolbarUnoDispatcher(*m_xColumnSizing, rxFrame))
    , m_xDelete(m_xBuilder->weld_toolbar("delete"))
    , m_xDeleteDispatch(new weld::ToolbarUnoDispatcher(*m_xDelete, rxFrame))
    , m_xSplitMerge(m_xBuilder->weld_toolbar("split_merge"))
    , m_xSplitMergeDispatch(new weld::ToolbarUnoDispatcher(*m_xSplitMerge, rxFrame))
    , m_xMisc(m_xBuilder->weld_toolbar("misc"))
    , m_xMiscDispatch(new weld::ToolbarUnoDispatcher(*m_xMisc, rxFrame))
