...
{
    sw::annotation::SwAnnotationWin* xCommentUIObject = dynamic_cast<sw::annotation::SwAnnotationWin*>(pWindow);
    assert(xCommentUIObject);
    return std::unique_ptr<UIObject>(new CommentUIObject(xCommentUIObject));
}
