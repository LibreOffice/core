...
public:
    SwBreakDashedLine(SwEditWin* pEditWin, const SwFrame *pFrame, SwPageBreakWin* pWin = nullptr);

    virtual ~SwBreakDashedLine() override { disposeOnce(); }
    virtual void dispose() override { m_pWin.clear(); m_pEditWin.clear(); SwDashedLine::dispose(); }
