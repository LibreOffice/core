 ...
 * \param nSize size of the long triangle size
 * \param Color arrow color
 * \param bCollapsed if the arrow should display the collapsed state
 */
void ImplDrawArrow(vcl::RenderContext& rRenderContext, long nX, long nY, unsigned int nSize,
...
void SwCommentRuler::DrawCommentControl(vcl::RenderContext& rRenderContext)
{
    ...
    const unsigned int nTriangleSize = maVirDev->GetTextHeight() / 2 + 1;
    const unsigned int nTrianglePad = maVirDev->GetTextHeight() / 4;
