...
FloatingTableButton::~FloatingTableButton()
{
    disposeOnce();
}
...
void FloatingTableButton::MouseButtonDown( const MouseEvent& /*rMEvt*/ )
{
    ...
    pTableNode->getIDocumentContentOperations().MoveNodeRange(aRange, aInsertPos, SwMoveFlags::DEFAULT);
...
void FloatingTableButton::Paint(vcl::RenderContext& rRenderContext, const tools::Rectangle&)
{
    ...
    drawinglayer::attribute::FontAttribute aFontAttr = drawinglayer::primitive2d::getFontAttributeFromVclFont(aFontSize, rRenderContext.GetFont(), false, false);
    ...
    basegfx::B2DHomMatrix aTextMatrix(basegfx::utils::createScaleTranslateB2DHomMatrix(
                                            ...
                                            static_cast<double>(aTextPos.X()), static_cast<double>(aTextPos.Y())));
...
void FloatingTableButton::ShowAll( bool bShow )
{
    Show(bShow);
}
...
void FloatingTableButton::SetReadonly( bool bReadonly )
{
    ShowAll( !bReadonly );
}
