...
SwOutlineContentVisibilityWin::~SwOutlineContentVisibilityWin() { disposeOnce(); }
...
void SwOutlineContentVisibilityWin::SetReadonly(bool bReadonly) { ShowAll(!bReadonly); }
