...
void DocxSdrExport::startDMLAnchorInline(const SwFrmFmt* pFrmFmt, const Size& rSize)
{
    ...
    **/
    ...
    m_pImpl->m_pSerializer->singleElementNS(XML_wp, XML_extent,
                                            ...
                                            XML_cx, ( aWidth.toInt64() > 0 ? ( aWidth.toInt64() > MAX_INTEGER_VALUE ? I64S(MAX_INTEGER_VALUE) : aWidth.getStr() ): "0"),
                                            XML_cy, ( aHeight.toInt64() > 0 ? ( aHeight.toInt64() > MAX_INTEGER_VALUE ? I64S(MAX_INTEGER_VALUE) : aHeight.getStr() ): "0"),
                                            FSEND);
