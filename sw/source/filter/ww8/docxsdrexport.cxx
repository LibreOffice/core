                                   ...
                                   const bool bIsWord2007Image)
{
    ...
    double fHalfWidth = rObj.GetLogicRect().getHalfOpenWidth() / 2.0;
    double fHalfHeight = rObj.GetLogicRect().getHalfOpenHeight() / 2.0;
...
tools::Polygon lcl_CreateContourPolygon(SdrObject* pSdrObj)
{
    ...
    switch (pSdrObj->GetObjIdentifier())
    {
        case SdrObjKind::CustomShape:
        {
            ...
            const double fWidth(pSdrObj->GetLogicRect().getHalfOpenWidth());
            double fScaleX = fWidth == 0.0 ? 1.0 : 21600.0 / fWidth;
            const double fHeight(pSdrObj->GetLogicRect().getHalfOpenHeight());
                                    ...
                                    int nAnchorId)
{
    ...
    Size aSize(pSdrObject->GetLogicRect().getHalfOpenWidth(),
               pSdrObject->GetLogicRect().getHalfOpenHeight());
                                 ...
                                 int nDiagramId)
{
    ...
    Size aSize(sdrObject->GetSnapRect().getHalfOpenWidth(),
               sdrObject->GetSnapRect().getHalfOpenHeight());
