...
void DocxSdrExport::startDMLAnchorInline(const SwFrameFormat* pFrameFormat, const Size& rSize)
{
    ...
    **/
    ...
    sal_uInt64 cx = std::max(std::min(TwipsToEMU(rSize.Width()), MAX_INTEGER_VALUE), sal_Int64(0));
    OString aWidth(OString::number(cx));
    sal_uInt64 cy = std::max(std::min(TwipsToEMU(rSize.Height()), MAX_INTEGER_VALUE), sal_Int64(0));
