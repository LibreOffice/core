...
void DocxSdrExport::startDMLAnchorInline(const SwFrameFormat* pFrameFormat, const Size& rSize)
{
    ...
    **/
    ...
    sal_uInt64 cx = std::clamp(TwipsToEMU(rSize.Width()), sal_Int64(0), MAX_INTEGER_VALUE);
    OString aWidth(OString::number(cx));
    sal_uInt64 cy = std::clamp(TwipsToEMU(rSize.Height()), sal_Int64(0), MAX_INTEGER_VALUE);
