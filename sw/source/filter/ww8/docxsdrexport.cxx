...
bool lcl_IsRotateAngleValid(const SdrObject& rObj)
{
    ...
    // be added if needed, but I think they do currently not appear here.
...
void lcl_calculateMSOBaseRectangle(const SdrObject& rObj, double& rfMSOLeft, double& rfMSORight, double& rfMSOTop, double& rfMSOBottom)
{
...
void lcl_calculateRawEffectExtent(sal_Int32& rLeft, sal_Int32& rRight, sal_Int32& rTop,
                                      sal_Int32& rBottom, const SdrObject& rObj, const bool bUseBoundRect)
{
