...
public:
    ...
    */
    ...
    UINT16 copts_fNoTabForInd : 1;          //    when 1, don・ｽt add automatic tab stops for hanging indent
    UINT16 copts_fNoSpaceRaiseLower : 1;        //    when 1, don・ｽt add extra space for raised or lowered characters
    ...
    UINT16 copts_fNoColumnBalance : 1;      //    when 1, don・ｽt balance columns for Continuous Section starts
    ...
    UINT16 copts_fTransparentMetafiles : 1; //    when 1, don・ｽt blank area between metafile pictures
    ...
    UINT16 rncEdn : 2;          //      restart endnote number code: 0 don・ｽt restart endnote numbering, 1 section, 2 page
