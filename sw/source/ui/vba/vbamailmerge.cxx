...
css::uno::Reference<SwVbaMailMerge>
    SAL_CALL SwVbaMailMerge::get(const css::uno::Reference<ooo::vba::XHelperInterface>& xParent,
                                 const css::uno::Reference<css::uno::XComponentContext>& xContext)
{
    static css::uno::Reference<SwVbaMailMerge> xInstance(new SwVbaMailMerge(xParent, xContext));
