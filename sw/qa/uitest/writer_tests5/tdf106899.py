...
class tdf106899(UITestCase):
    ...
    def test_tdf106899_alphabetical_index_utf8(self):
        ...
        with self.ui_test.load_file(get_url_for_data_file("tdf106899.odt")) as document:
            ...
            # TODO Bug Report - Refresh of the index does only work with .uno:UpdateAllIndexes
            ...
            # TODO Bug Report - Retrieving the text of the updated index only work with the cursor
