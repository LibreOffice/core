...
class tdf142847(UITestCase):
    def test_tdf142847(self):
        ...
        with self.ui_test.load_file(get_url_for_data_file("tdf142847.odt")):
            ...
            # the textbox fallen apart.
            self.assertLess(frame.getPropertyValue("HoriOrientPosition"), shape.getPropertyValue("HoriOrientPosition"))
