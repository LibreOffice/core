...
#        time.sleep(60)
        ...
        self.assertEqual(1, listenerCount)
        ...
        global keymouseEventsIntercepted
        # TODO expected 2 interceptions
        #self.assertEqual(2, keymouseEventsIntercepted)
        self.assertEqual(0, keymouseEventsIntercepted)

        global mouseEventsIntercepted
        # TODO expected 3 interceptions
