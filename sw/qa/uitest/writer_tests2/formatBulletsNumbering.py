   ...
   def test_bullets_and_numbering_selection(self):
        with self.ui_test.create_doc_in_start_center("writer"):
            ...
            with self.ui_test.execute_dialog_through_command(".uno:BulletsAndNumberingDialog") as xDialog:
                ...
                self.assertEqual(get_state_as_dict(xselector)["SelectEntryText"], "Uppercase letter A) B) C)")
                ...
                self.assertEqual(get_state_as_dict(xselector)["SelectEntryText"], "Lowercase Roman number i. ii. iii.")
                ...
                self.assertEqual(get_state_as_dict(xselector)["VisibleCount"], "92")
                ...
                self.assertEqual(get_state_as_dict(xselector)["SelectEntryText"], "Bullet15-Arrow-Blue")
