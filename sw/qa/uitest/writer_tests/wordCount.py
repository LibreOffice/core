...
class writerWordCount(UITestCase):
    ...
    def test_tdf51816(self):
        ...
        sleep(2)  #need to wait, because Word count dialog is already open and it takes time to refresh the counter
        ...
        sleep(1)  #need to wait, because Word count dialog is already open and it takes time to refresh the counter
