...
class compareDocuments(UITestCase):
    ...
    def test_tdf130960(self):
        ...
        self.assertEqual(11, len(changesList.getChildren()))
        for i in range(11):
            self.assertTrue(get_state_as_dict(changesList.getChild(str(i)))["Text"].startswith(text))

        # tdf#109376 - it would crash here
