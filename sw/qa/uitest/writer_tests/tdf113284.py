...
class tdf113284(UITestCase):
   ...
   def test_tdf113284(self):
    ...
    xPageText.executeAction("TYPE", mkPropertyValues({"TEXT":"70"})) # goto last page
    xOkBtn = xDialog.getChild("ok")
    self.ui_test.close_dialog_through_button(xOkBtn)

    self.assertEqual(get_state_as_dict(xWriterEdit)["CurrentPage"], "70")
    ...
    self.ui_test.close_dialog_through_button(xOkBtn)   # close dialog with OK
