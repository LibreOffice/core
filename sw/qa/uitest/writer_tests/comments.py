...
class Comments(UITestCase):
    ...
    def test_comments_features(self):
        ...
        self.assertEqual(len(xMainWindow.getChildren()), (number_of_items-1) )
    ...
    def test_multi_comments(self):
        ...
        # then we check that the current number of objects is decreased by 3 which means that the comments were deleted
        self.assertEqual(len(xMainWindow.getChildren()), (number_of_items-3) )
