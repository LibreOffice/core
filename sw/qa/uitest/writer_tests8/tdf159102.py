...
class tdf159102(UITestCase):
    ...
    def set_custom_hyphenation(self):
        with self.ui_test.execute_dialog_through_command(".uno:OptionsTreeDialog") as xDialog:
            ...
            # add hyphenation "cur=sus" to the custom dictionary to solve the non-accessible
    ...
    def test_tdf159102_smart_justify_with_automatic_hyphenation(self):
        ...
        with self.ui_test.load_file(get_url_for_data_file("tdf159102.fodt")) as writer_doc:
            ...
            # so extend user dictionary temporarily with the hyphenation cur=sus
            ...
            # This was "stas.", i.e. too much shrinking (accept also " cursus egestas." in the
