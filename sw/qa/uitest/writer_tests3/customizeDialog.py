...
class ConfigureDialog(UITestCase):
    ...
    def test_gear_button_menu(self):
        ...
        self.ui_test.execute_blocking_action( action=show_dialog0, close_button="cancel")
        ...
        self.ui_test.execute_blocking_action( action=show_dialog2, close_button="cancel")
