...
DECLARE_ODFEXPORT_TEST(testTableStyles2, "table_styles_2.odt")
{
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int16(1), nInt16);
#if !defined(WNT)
    // After xml roundtrip expected charset is RTL_TEXTENCODING_UTF8.
    // However on MS Windows actual charset is RTL_TEXTENCODING_MS_1252
    xCell1Style->getPropertyValue("CharFontCharSet") >>= nInt16;
    // 1 is RTL_TEXTENCODING_MS_1252, 76 is RTL_TEXTENCODING_UTF8
    CPPUNIT_ASSERT_EQUAL(sal_Int16(76), nInt16);
    xCell1Style->getPropertyValue("CharFontCharSetAsian") >>= nInt16;
    CPPUNIT_ASSERT_EQUAL(sal_Int16(76), nInt16);
    xCell1Style->getPropertyValue("CharFontCharSetComplex") >>= nInt16;
    CPPUNIT_ASSERT_EQUAL(sal_Int16(76), nInt16);
#endif
