...
DECLARE_ODFEXPORT_TEST(tdf135942, "nestedTables.odt")
{
    ...
    assertXPath(pXmlDoc, "/office:document-content/office:automatic-styles/style:style[@style:family='table']", 11);
}
