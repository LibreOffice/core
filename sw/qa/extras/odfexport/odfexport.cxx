...
DECLARE_ODFEXPORT_TEST(testReferenceLanguage, "referencelanguage.odt")
{
    ...
    static const OUString fieldTexts[] = { OUString("A 2"), OUString("Az 50-esek"),
        ...
        OUString(OUStringLiteral("Az ")) + OUString(OUStringLiteral1(0x201E)) + OUString(OUStringLiteral1(0x150)) +
        OUString(OUStringLiteral("seinket...")) + OUString(OUStringLiteral1(0x201D)), OUString("a 2"),
