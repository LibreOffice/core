...
protected:
    ...
    {
        const char* aAllowlist[] = { "page-graphic-background.odt", "zoom.docx", "empty.odt",
                                     "fdo38244.docx", "comments-nested.odt" };
...
CPPUNIT_TEST_FIXTURE(Test, testCustomProperties)
{
    ...
    assertXPathContent(pXmlDoc, "/extended-properties:Properties/extended-properties:Characters",
                       "22");
    assertXPathContent(
        pXmlDoc, "/extended-properties:Properties/extended-properties:CharactersWithSpaces", "24");
    assertXPathContent(pXmlDoc, "/extended-properties:Properties/extended-properties:Company",
                       "hhhhkompany");
    assertXPathContent(pXmlDoc, "/extended-properties:Properties/extended-properties:Manager",
                       "ffffmenadzer;iiiiisecondmanager");
    assertXPathContent(pXmlDoc, "/extended-properties:Properties/extended-properties:HyperlinkBase",
                       "gggghiperlink");
    //assertXPathContent(pXmlDoc, "/extended-properties:Properties/extended-properties:DocSecurity", "2");
    assertXPathContent(pXmlDoc, "/extended-properties:Properties/extended-properties:AppVersion",
                       "15.0000");
    ...
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[1]", "name",
                "testDateProperty");
    assertXPathContent(pCustomXml,
                       "/custom-properties:Properties/custom-properties:property[1]/vt:filetime",
                       "1982-04-19T10:00:00Z");
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[3]", "name",
                "testNegativeNumberProperty");
    assertXPathContent(pCustomXml,
                       "/custom-properties:Properties/custom-properties:property[3]/vt:r8", "-100");
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[4]", "name",
                "testNumberProperty");
    //assertXPathContent(pCustomXml, "/custom-properties:Properties/custom-properties:property[4]/vt:i4",
    //                   "256");
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[5]", "name",
                "testRealNumberProperty");
    assertXPathContent(
        pCustomXml, "/custom-properties:Properties/custom-properties:property[5]/vt:r8", "-128.1");
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[6]", "name",
                "testScientificNumber");
    assertXPathContent(pCustomXml,
                       "/custom-properties:Properties/custom-properties:property[6]/vt:r8",
                       "1.23456789E+023");
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[7]", "name",
                "testTextProperty");
    assertXPathContent(pCustomXml,
                       "/custom-properties:Properties/custom-properties:property[7]/vt:lpwstr",
                       "testPropertyValue");
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[8]", "name",
                "testYesNoProperty");
    assertXPathContent(pCustomXml,
                       "/custom-properties:Properties/custom-properties:property[8]/vt:bool", "1");
    ...
    assertXPath(pCustomXml, "/custom-properties:Properties/custom-properties:property[9]", "name",
                "_MarkAsFinal");
    assertXPathContent(pCustomXml,
                       "/custom-properties:Properties/custom-properties:property[9]/vt:bool", "1");
...
{
    CPPUNIT_ASSERT_EQUAL(expected.replaceAll(" ", "").replaceAll(u"\u2212", "-"),
...
DECLARE_OOXMLEXPORT_TEST(testTextFrameBorders, "textframe-borders.docx")
{
    ...
    else
    {
        ...
        CPPUNIT_ASSERT_EQUAL(Color(0xD99594),
                             Color(ColorTransparency, getProperty<sal_Int32>(xShape, "FillColor")));

        CPPUNIT_ASSERT_EQUAL(Color(0xC0504D),
                             Color(ColorTransparency, getProperty<sal_Int32>(xShape, "LineColor")));
        ...
        CPPUNIT_ASSERT_EQUAL(Color(0x622423), Color(ColorTransparency,
                                                    getProperty<sal_Int32>(xShape, "ShadowColor")));
    }
}
...
DECLARE_OOXMLEXPORT_TEST(testFdo56679, "fdo56679.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL(
        Color(0xFF0000),
        Color(ColorTransparency, getProperty<sal_Int32>(xText, "CharUnderlineColor")));
}
...
DECLARE_OOXMLEXPORT_TEST(testFdo65400, "fdo65400.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0x0026), Color(ColorTransparency,
                                              getProperty<sal_Int32>(shaded, "CharShadingValue")));
    CPPUNIT_ASSERT_EQUAL(Color(0xd8d8d8),
                         Color(ColorTransparency, getProperty<sal_Int32>(shaded, "CharBackColor")));
}
...
DECLARE_OOXMLEXPORT_TEST(testFdo60990, "fdo60990.odt")
{
    ...
    uno::Reference<beans::XPropertySet> xShape(getShape(1), uno::UNO_QUERY);
    CPPUNIT_ASSERT_EQUAL(Color(ColorTransparency, 0x00CFE7F5),
                         Color(ColorTransparency, getProperty<sal_Int32>(xShape, "FillColor")));
    ...
    CPPUNIT_ASSERT_EQUAL(
        Color(0x00FF00),
        Color(ColorTransparency, getProperty<sal_Int32>(getRun(xParagraph, 1), "CharColor")));
}
