...
DECLARE_OOXMLEXPORT_EXPORTONLY_TEST(testCustomProperties, "custom-properties.docx")
{
    ...
    assertXPathContent(pXmlDoc, "/extended-properties:Properties/extended-properties:AppVersion", "16.0000");
    ...
    // TODO Currently negative number is exported as vt:i4 (4-byte signed integer) and must be exported as vt:r8 (8-byte real number)
    // otherwise MS Office do not importing it correctly
    ...
    // TODO Real time number are not exported correctly (-128 instead of -128.1)
