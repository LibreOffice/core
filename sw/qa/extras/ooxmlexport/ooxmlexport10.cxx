...
DECLARE_OOXMLEXPORT_TEST(testBnc875718, "bnc875718.docx")
{
    ...
    // The sample bugdoc has 3 footer.xml and has a textframe in each. The no 1 has
    // no text in its anchored text range: it is anchored to body text. Ignoring...
    for( int i = 1;
    ...
    CPPUNIT_ASSERT(text); //Do not crash on emty content
