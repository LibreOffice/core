...
DECLARE_OOXMLEXPORT_TEST(testfdo79540, "fdo79540.docx")
{
    ...
    // fdo#79541 : Floating tables won't be exported within a frame
    // Instead they will be exported as a floating table only
    assertXPath ( pXmlDoc, "//w:tbl/w:tr[1]/w:tc[1]/w:p[1]/w:r[1]/mc:AlternateContent",1);
    assertXPath ( pXmlDoc, "//w:p[6]/w:r[1]/mc:AlternateContent/mc:Choice/w:drawing/wp:anchor/a:graphic/a:graphicData/wps:wsp/wps:txbx/w:txbxContent",1);
}
