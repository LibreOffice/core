...
void Test::testFdo66543()
{
    ...
    /*
    uno::Reference<text::XTextDocument> xTextDocument(mxComponent, uno::UNO_QUERY);
    uno::Reference< beans::XPropertySet > xRangeProperties = uno::Reference< beans::XPropertySet >( xTextDocument->getText()->getStart(), uno::UNO_QUERY_THROW );
    sal_Int32 nValue = 0;
    xRangeProperties->getPropertyValue( "ParaLineNumberStartValue" ) >>= nValue;
