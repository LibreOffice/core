...
DECLARE_OOXMLEXPORT_TEST(testParagraphMark2, "paragraph-mark2.docx")
{
    ...
    // This was 12, set by Char Style FontStyle11 presumably.
    // When run interactively, this is 10. Also shows 10 in MRI. But unit test says 12...
    //CPPUNIT_ASSERT_EQUAL(10.f, getProperty<float>(getParagraph(1), "CharHeight"));
}
