...
protected:
    ...
    /**
     * Function overloaded by unit test. See DECLARE_OOXML_TEST macro
     */
    virtual void verify() = 0;
};

/**
 * Macro to declare a new test.
 * In order to add a new test, one only needs to use this macro
 * and then specify the test content, like this:
 *
 * DECLARE_OOXML_TEST(MyTest, "myfilename.docx")
 * {
...
DECLARE_OOXML_TEST(testFdo66929, "fdo66929.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL( sal_Int32( 24 ), getProperty< sal_Int32 >( xFrame, "TopBorderDistance" ) );
