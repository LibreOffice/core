...
CPPUNIT_TEST_FIXTURE(Test, testShapeThemePreservation)
{
    ...
    Color sFillColor = Color(ColorTransparency, getXPath(pXmlDocument,
            ...
            "val").toInt32(16));
    CPPUNIT_ASSERT_EQUAL(Color(0x00b050), sFillColor);
    Color nLineColor = Color(ColorTransparency, getXPath(pXmlDocument,
            ...
            "val").toInt32(16));
    CPPUNIT_ASSERT_EQUAL(Color(0xff0000), nLineColor);
