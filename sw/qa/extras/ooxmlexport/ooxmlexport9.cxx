...
{
    // Import as VML.
    // tdf#41466: check whether VML DOCX custom shape with text box is imported as custom
    // shape with a text frame (text box). These kind of shapes were imported only as text
    // frames previously, losing the preset custom shape geometry, in this case "wedgeRectCallout".
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
