...
DECLARE_OOXMLEXPORT_TEST(testTdf78657, "tdf78657_picture_hyperlink.docx")
{
    ...
    assertXPath(pXmlRels, "/rels:Relationships/rels:Relationship[3]", "Target", "http://www.google.com");
    assertXPath(pXmlRels, "/rels:Relationships/rels:Relationship[3]", "TargetMode", "External");
}
