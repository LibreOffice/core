...
DECLARE_OOXMLEXPORT_TEST(testTdf99602_charStyleSubscript, "tdf99602_charStyleSubscript.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL( DFLT_ESC_AUTO_SUB, getProperty<int>(getRun(xPara, 2, "Subscript"), "CharEscapement") );
    CPPUNIT_ASSERT_EQUAL( DFLT_ESC_PROP, getProperty<int>(getRun(xPara, 2), "CharEscapementHeight") );
}
