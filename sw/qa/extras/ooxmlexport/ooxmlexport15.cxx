...
DECLARE_OOXMLEXPORT_EXPORTONLY_TEST(testTdf135663, "tdf135663.odt")
{
    ...
    CPPUNIT_ASSERT_EQUAL(-1L, sStyle2.indexOf("mso-wrap-distance-left"));
    CPPUNIT_ASSERT_EQUAL(-1L, sStyle2.indexOf("mso-wrap-distance-right"));
    CPPUNIT_ASSERT_EQUAL(-1L, sStyle2.indexOf("mso-wrap-distance-top"));
    CPPUNIT_ASSERT_EQUAL(-1L, sStyle2.indexOf("mso-wrap-distance-bottom"));
}
