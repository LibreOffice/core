...
DECLARE_OOXMLEXPORT_EXPORTONLY_TEST(testTdf135663, "tdf135663.odt")
{
    ...
    CPPUNIT_ASSERT_EQUAL(sStyle2.indexOf("mso-wrap-distance-left"), -1);
    CPPUNIT_ASSERT_EQUAL(sStyle2.indexOf("mso-wrap-distance-right"), -1);
    CPPUNIT_ASSERT_EQUAL(sStyle2.indexOf("mso-wrap-distance-top"), -1);
    CPPUNIT_ASSERT_EQUAL(sStyle2.indexOf("mso-wrap-distance-bottom"), -1);
}
