...
DECLARE_OOXMLEXPORT_EXPORTONLY_TEST(testTdf139549, "tdf139549.docx")
{
    ...
    CPPUNIT_ASSERT(aStyleCommandName == "position");
    CPPUNIT_ASSERT(aStyleCommandValue == "absolute");
    ...
    CPPUNIT_ASSERT(aStyleCommandName == "margin-left");
    ...
    aStyleCommandName = aStyleCommand.getToken(0, ':');
    aStyleCommandValue = aStyleCommand.getToken(1, ':');
    CPPUNIT_ASSERT(aStyleCommandName == "margin-top");
