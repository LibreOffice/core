...
{
    loadAndSave("TextEffects_Glow_Shadow_Reflection.docx");
...
{
    loadAndSave("TextEffects_TextOutline.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("TextEffects_TextFill.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("TextEffects_Props3d_Ligatures_NumForm_NumSpacing.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("TextEffects_StylisticSets_CntxtAlts.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("TextEffects_Groupshapes.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("TextEffects_InStyle.docx");
...
{
    loadAndSave("tdf112103_tablebgnofill.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
