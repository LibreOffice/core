...
DECLARE_OOXMLEXPORT_TEST(testLanguageInGroupShape, "tdf131922_LanguageInGroupShape.docx")
{
    ...
    if (!pXml)
        return;
    assertXPath(pXml, "/w:document/w:body/w:p[2]/w:r/mc:AlternateContent/mc:Choice/w:drawing/wp:anchor/a:graphic/a:graphicData"
        "wps:wsp/wps:txbx/w:txbxContent/w:p/w:r/w:rPr/w:lang", "val", "de-DE");
}
