...
#define DECLARE_LINKS_EXPORTONLY_TEST(TestName, FileName, bAbsolute, bUseTempDir)                      \
...
DECLARE_LINKS_EXPORTONLY_TEST(testRelativeToRelativeExport, "relative-link.docx", USE_RELATIVE,
                          USE_TEMP_DIR)
{
...
DECLARE_LINKS_EXPORTONLY_TEST(testRelativeToAbsoluteExport, "relative-link.docx", USE_ABSOLUTE,
                          DONT_MODIFY_LINK)
{
    xmlDocPtr pXmlDoc = parseExport("word/_rels/document.xml.rels");
...
DECLARE_LINKS_EXPORTONLY_TEST(testAbsoluteToRelativeExport, "absolute-link.docx", USE_RELATIVE,
                          USE_TEMP_DIR)
{
    xmlDocPtr pXmlDoc = parseExport("word/_rels/document.xml.rels");
...
DECLARE_LINKS_EXPORTONLY_TEST(testAbsoluteToAbsoluteExport, "absolute-link.docx", USE_ABSOLUTE,
                          DONT_MODIFY_LINK)
{
    xmlDocPtr pXmlDoc = parseExport("word/_rels/document.xml.rels");
    OUString sTarget = getXPath(pXmlDoc, "/rels:Relationships/rels:Relationship[2]", "Target");
...
DECLARE_LINKS_EXPORTONLY_TEST(testTdf123627_export, "tdf123627.docx", USE_RELATIVE, USE_TEMP_DIR)
{
    xmlDocPtr pXmlDoc = parseExport("word/_rels/document.xml.rels");
    assertXPath(pXmlDoc, "/rels:Relationships/rels:Relationship[@TargetMode='External']", "Target",
                "test.docx");
...
DECLARE_LINKS_EXPORTONLY_TEST(testTdf126590_export, "tdf126590.docx", USE_ABSOLUTE, DONT_MODIFY_LINK)
{
    xmlDocPtr pXmlDoc = parseExport("word/_rels/document.xml.rels");
...
DECLARE_LINKS_EXPORTONLY_TEST(testTdf126768_export, "tdf126768.docx", USE_ABSOLUTE, DONT_MODIFY_LINK)
{
    xmlDocPtr pXmlDoc = parseExport("word/_rels/document.xml.rels");
...
DECLARE_LINKS_EXPORTONLY_TEST(testNon_ascii_link_export, "non_ascii_link.docx", USE_ABSOLUTE,
                          DONT_MODIFY_LINK)
{
    xmlDocPtr pXmlDoc = parseExport("word/_rels/document.xml.rels");
