...
{
    loadAndSave("preserve_Z_field_TOC.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("PreserveWfieldTOC.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("PreserveXfieldTOC.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("testTOCFlag_u.docx");
...
{
    loadAndSave("fdo73596_RunInStyle.docx");
...
{
    loadAndSave("fdo73596_AlphaSeparator.docx");
...
{
    loadAndSave("EquationAsScientificNumbering.docx");
...
{
    loadAndSave("EquationWithAboveAndBelowCaption.docx");
...
{
    loadAndSave("FigureAsLabelPicture.docx");
    // fdo#72563 : There was a problem that in case of TOC,PAGEREF field tag was not preserved during Roundtrip
    // This test case is to verify that PAGEREF tag is coming with proper values inside <hyperlink> tag.
    xmlDocUniquePtr pXmlDoc = parseExport();
...
{
    loadAndSave("TableWithAboveCaptions.docx");
    // fdo#72563 : There was a problem that in case of TOC,PAGEREF field tag was not preserved during Roundtrip
    // This test case is to verify that PAGEREF tag is coming with proper values inside <hyperlink> tag.
    xmlDocUniquePtr pXmlDoc = parseExport();
...
{
    loadAndSave("footer-contain-hyperlink.docx");
...
{
    loadAndSave("alphabeticalIndex_MultipleColumns.docx");
    // Bug :: fdo#73596
    /*
...
{
    loadAndSave("alphabeticalIndex_AutoColumn.docx");
    // Bug :: fdo#73596
    /*
...
{
    loadAndSave("IndexFieldFlagF.docx");
...
{
    loadAndSave("Unsupportedtextfields.docx");
...
{
    loadAndSave("sdt-citation-run.docx");
...
{
    loadAndSave("paragraph-sdt.docx");
...
{
    loadAndSave("table-start-2-sdt.docx");
    xmlDocUniquePtr pXmlDoc = parseExport();
...
{
    loadAndSave("fly_fieldmark.fodt");
...
{
    loadAndSave("sdt-before-field.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("sdt-company-multipara.docx");
    xmlDocUniquePtr pXmlDoc = parseExport("word/document.xml");
...
{
    loadAndSave("conditional-text.fodt");
