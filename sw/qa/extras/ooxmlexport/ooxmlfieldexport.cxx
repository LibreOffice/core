...
CPPUNIT_TEST_FIXTURE(Test, testBnc834035)
{
    ...
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[10]/w:hyperlink"_ostr, "anchor"_ostr, u"_Toc363553908"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFdo69649)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[21]/w:hyperlink/w:r[5]/w:t"_ostr, u"15"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFieldFlagO)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[1]/w:r[2]/w:instrText"_ostr, u" TOC \\z \\f \\o \"1-3\" \\u \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testTOCFlag_f)
{
    ...
    // FIXME "p[2]" will have to be "p[1]", once the TOC import code is fixed
    // not to insert an empty paragraph before TOC.
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[1]/w:r[2]/w:instrText"_ostr, u" TOC \\z \\o \"1-3\" \\u \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testPreserveZfield)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[1]/w:r[2]/w:instrText"_ostr, u" TOC \\z \\f \\o \"1-3\" \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testPreserveWfieldTOC)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p/w:r[2]/w:instrText"_ostr, u" TOC \\z \\w \\f \\o \"1-3\" \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFieldFlagB)
{
    ...
    // FIXME "p[2]" will have to be "p[1]", once the TOC import code is fixed
    // not to insert an empty paragraph before TOC.
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[1]/w:r[2]/w:instrText"_ostr, u" TOC \\b \"bookmark111\" \\o \"1-9\" \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testPreserveXfieldTOC)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p/w:r[2]/w:instrText"_ostr, u" TOC \\x \\f \\o \"1-3\" \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFDO77715)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[3]/w:r[2]/w:instrText[1]"_ostr, u" TOC \\c \\h \\t \"Block Header\" "_ustr);
...
CPPUNIT_TEST_FIXTURE(Test, testTOCFlag_u)
{
    ...
    // FIXME "p[2]" will have to be "p[1]", once the TOC import code is fixed
    // not to insert an empty paragraph before TOC.
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p/w:r[2]/w:instrText"_ostr, u" TOC \\z \\o \"1-9\" \\u \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testfdo73596_RunInStyle)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[2]/w:r[2]/w:instrText[1]"_ostr, u" INDEX \\e \""_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testfdo73596_AlphaSeparator)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[2]/w:r[2]/w:instrText[1]"_ostr, u" INDEX \\h \"A\" \\e \""_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testCaption1)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p/w:r[3]/w:instrText"_ostr, u" SEQ scientific \\* ROMAN "_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testCaption2)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[5]/w:r[3]/w:instrText"_ostr, u" SEQ Equation \\* ARABIC "_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testCaption3)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[2]/w:r[3]/w:instrText"_ostr, u" SEQ picture \\* ARABIC "_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testCaption4)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[3]/w:instrText"_ostr, u" SEQ Table \\* ARABIC "_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFooterContainHyperlink)
{
    ...
    assertXPath(pXmlRels,"/rels:Relationships/rels:Relationship"_ostr,"Target"_ostr,u"http://www.google.com/"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testAlphabeticalIndex_MultipleColumns)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[3]/w:r[2]/w:instrText"_ostr, u" INDEX \\c \"4\"\\e \""_ustr);

    // check for section breaks after and before the Index Section
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[2]/w:pPr/w:sectPr/w:type"_ostr,"val"_ostr,u"continuous"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[8]/w:pPr/w:sectPr/w:type"_ostr,"val"_ostr,u"continuous"_ustr);
    // check for "w:space" attribute for the columns in Section Properties
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[8]/w:pPr/w:sectPr/w:cols"_ostr,"space"_ostr,u"720"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testPageref)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[2]/w:hyperlink/w:r[3]/w:instrText"_ostr, u"PAGEREF _Toc355095261 \\h"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testAlphabeticalIndex_AutoColumn)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[2]/w:r[2]/w:instrText"_ostr, u" INDEX \\e \""_ustr);
...
CPPUNIT_TEST_FIXTURE(Test, testIndexFieldFlagF)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document[1]/w:body[1]/w:p[4]/w:r[2]/w:instrText[1]"_ostr, u" INDEX \\c \"2\"\\f \"Syn\"\\e \""_ustr);
    // XE entries lost their \f "Syn" before
    assertXPathContent(pXmlDoc, "/w:document[1]/w:body[1]/w:p[17]/w:r[21]/w:instrText[1]"_ostr, u" XE \"formatting\" \\f \"Syn\" "_ustr);
    assertXPathContent(pXmlDoc, "/w:document[1]/w:body[1]/w:p[17]/w:r[29]/w:instrText[1]"_ostr, u" XE \"choosing:aaaa\" \\f \"Syn\" "_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testBibliography)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p/w:r[2]/w:instrText"_ostr, u" BIBLIOGRAPHY "_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtPr/w:docPartObj/w:docPartGallery"_ostr, "val"_ostr, u"Bibliographies"_ustr);
...
CPPUNIT_TEST_FIXTURE(Test, testCitation)
{
    ...
    xmlDocUniquePtr pXmlDoc = parseExport(u"word/document.xml"_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[1]/w:sdt/w:sdtContent/w:r[2]/w:instrText"_ostr, u" CITATION Kra06 \\l 1033 "_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[1]/w:sdt/w:sdtContent/w:r[4]/w:t"_ostr, u"(Kramer & Chen, 2006)"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFDO76163 )
{
    ...
    assertXPath ( pXmlDoc, "/w:document/w:body/w:p[2]/w:hyperlink/w:r[10]/w:fldChar"_ostr, "fldCharType"_ostr, u"end"_ustr );
}
...
CPPUNIT_TEST_FIXTURE(Test, testFDO78654 )
{
    ...
    assertXPath ( pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[2]/w:hyperlink[3]/w:r[5]/w:fldChar"_ostr, "fldCharType"_ostr, u"end"_ustr );
}
...
CPPUNIT_TEST_FIXTURE(Test, testfdo78599)
{
    ...
    xmlDocUniquePtr pXmlDoc = parseExport(u"word/document.xml"_ustr);
    //docx file after RT is getting corrupted.
    assertXPath ( pXmlDoc, "/w:document/w:body/w:p[1]/w:hyperlink/w:r[6]/w:fldChar"_ostr, "fldCharType"_ostr, u"end"_ustr );
...
CPPUNIT_TEST_FIXTURE(Test, testFdo78910)
{
    ...
    assertXPath ( pXmlDoc, "//w:hyperlink[2]/w:r[1]/w:fldChar"_ostr, "fldCharType"_ostr, u"begin"_ustr );
    assertXPath ( pXmlDoc, "//w:hyperlink[2]/w:r[5]/w:fldChar"_ostr, "fldCharType"_ostr, u"end"_ustr );
}
...
CPPUNIT_TEST_FIXTURE(Test, testSdtCitationRun)
{
    ...
    xmlDocUniquePtr pXmlDoc = parseExport(u"word/document.xml"_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p/w:r[1]/w:t"_ostr, u"Before sdt."_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p/w:sdt/w:sdtContent/w:r/w:instrText"_ostr, u" CITATION BBC11 \\l 1033 "_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p/w:r[2]/w:t"_ostr, u"After sdt."_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testSdt2Run)
{
    ...
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[1]/w:r/w:t"_ostr, u"first"_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:sdt/w:sdtContent/w:p[2]/w:r/w:t"_ostr, u"second"_ustr);
    // Make sure the third paragraph is still outside <w:sdt>.
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p/w:r/w:t"_ostr, u"third"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFdo81492)
{
    ...
    xmlDocUniquePtr pXmlDoc = parseExport(u"word/document.xml"_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[6]/w:instrText"_ostr, u"ADDIN EN.CITE.DATA"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testEditTime)
{
    ...
    assertXPath(pXmlDoc, "/w:document/w:body/w:p/w:r[1]/w:fldChar"_ostr, "fldCharType"_ostr, u"begin"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p/w:r[3]/w:fldChar"_ostr, "fldCharType"_ostr, u"separate"_ustr);
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p/w:r[4]/w:t"_ostr, u"00:05"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p/w:r[5]/w:fldChar"_ostr, "fldCharType"_ostr, u"end"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testFlyFieldmark)
{
    ...
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[2]/w:fldChar"_ostr, "fldCharType"_ostr, u"begin"_ustr);
    // run 3 contains the field instruction text
    assertXPathContent(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[3]/w:instrText"_ostr, u" FORMTEXT "_ustr);
}
...
DECLARE_OOXMLEXPORT_TEST(testFixedDateFields, "fixed-date-field.docx")
{
    ...
    if (isExported())
    {
        ...
        assertXPath(pXmlDoc, "/w:document/w:body/w:p/w:r[1]/w:fldChar"_ostr, "fldLock"_ostr, u"true"_ustr);
    }
}
...
CPPUNIT_TEST_FIXTURE(Test, testOO34469)
{
    ...
    CPPUNIT_ASSERT_EQUAL(1, getPages());
    xmlDocUniquePtr pXmlDoc = parseExport(u"word/document.xml"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:hyperlink[1]"_ostr, "anchor"_ostr, u"2.9.2.Creating_New_files|outline"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testOO39845)
{
    ...
    CPPUNIT_ASSERT_EQUAL(1, getPages());
    xmlDocUniquePtr pXmlDoc = parseExport(u"word/document.xml"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:hyperlink[1]"_ostr, "anchor"_ostr, u"Figure4|graphic"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testTdf66401)
{
    ...
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[3]/w:rPr/w:rFonts"_ostr, "ascii"_ostr, u"Arial Black"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[3]/w:rPr/w:sz"_ostr, "val"_ostr, u"24"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[9]/w:rPr/w:rFonts"_ostr, 1);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[9]/w:rPr/w:rFonts"_ostr, "ascii"_ostr, u"Arial Black"_ustr);
    assertXPath(pXmlDoc, "/w:document/w:body/w:p[1]/w:r[9]/w:rPr/w:sz"_ostr, "val"_ostr, u"24"_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testTdf132185)
{
    ...
    assertXPathContent(pXmlDoc, "/w:ftr/w:p/w:r[2]/w:instrText"_ostr, u" PAGE \\* roman "_ustr);
}
...
CPPUNIT_TEST_FIXTURE(Test, testTdf104823)
{
    ...
    assertXPathContent(pXmlCustomPropsDoc, "//*/*[local-name()='name']"_ostr, u"New Custom XML Value"_ustr);
    ...
    assertXPathContent(pXmlAppPropsDoc, "//*/*[local-name()='Company']"_ostr, u"True Extended Property Value"_ustr);
    ...
    assertXPathContent(pXmlCorePropsDoc, "/cp:coreProperties/dc:creator"_ostr, u"True Core Property Value"_ustr);
}
