...
DECLARE_WW8EXPORT_TEST(testTdf41554, "tdf41554.doc")
{
    // In libreoffice 3.3.0, file could not be imported, altough it was read perfectly fine in word 2003.
    CPPUNIT_ASSERT_EQUAL(1,getPages()); //here to just check if the document loaded, if passed, then test sucessful.
}
