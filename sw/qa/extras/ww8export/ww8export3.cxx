...
DECLARE_WW8EXPORT_TEST(testTdf73056_cellMargins, "tdf73056_cellMargins.doc")
{
    ...
    uno::Reference< table::XCell > xCell = xTable1->getCellByName( "A3" );

    // only the first cell with specific margins was processed, leaving the rest at table defaults. Was 450.
    uno::Reference< beans::XPropertySet > xPropSet( xCell, uno::UNO_QUERY_THROW );
    CPPUNIT_ASSERT_EQUAL_MESSAGE( "bottom cell spacing to contents",
        sal_Int32(150), getProperty<sal_Int32>(xPropSet, "BottomBorderDistance" ) );
}
