...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testCp1000115)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf90003)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf88453)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf98987)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf99004)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf104440)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf104425)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf35021_tabOverMarginDemo)
{
#if HAVE_MORE_FONTS
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf106701_tabOverMarginAutotab)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf104492)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf107025)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf107362)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf106736)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf114306)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf129655)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf108524)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testLinesInSectionInTable)
{
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTableInSection)
{
#if HAVE_MORE_FONTS
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTableInNestedSection)
{
#if HAVE_MORE_FONTS
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf112741)
{
#if HAVE_MORE_FONTS
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf113287)
{
#if HAVE_MORE_FONTS
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testSectionInTableInTable2)
{
#if HAVE_MORE_FONTS
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf112448)
{
