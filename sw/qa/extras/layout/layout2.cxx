...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf146272)
{
    ...
    uno::Reference<beans::XPropertySet> xFrame1(xDrawing1->getPropertyValue("TextBoxContent"),
                                                uno::UNO_QUERY);
    ...
    const sal_uInt64 nPicture1Zorder = xPicture1->getPropertyValue("ZOrder").get<sal_uInt64>();
    const sal_uInt64 nDrawing1Zorder = xDrawing1->getPropertyValue("ZOrder").get<sal_uInt64>();
    const sal_uInt64 nFrame1Zorder = xFrame1->getPropertyValue("ZOrder").get<sal_uInt64>();
    ...
    uno::Reference<beans::XPropertySet> xFrame2(xDrawing2->getPropertyValue("TextBoxContent"),
                                                uno::UNO_QUERY);
    ...
    const sal_uInt64 nPicture2Zorder = xPicture2->getPropertyValue("ZOrder").get<sal_uInt64>();
    const sal_uInt64 nDrawing2Zorder = xDrawing2->getPropertyValue("ZOrder").get<sal_uInt64>();
    const sal_uInt64 nFrame2Zorder = xFrame2->getPropertyValue("ZOrder").get<sal_uInt64>();
