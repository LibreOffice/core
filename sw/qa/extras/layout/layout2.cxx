...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter2, testTdf121509)
{
    ...
    CPPUNIT_ASSERT(sw::XTextRangeToSwPaM(TxBxCur, xTextCntSt));
    ...
    uno::Reference<lang::XComponent> xComp
        = loadFromDesktop(aTmp.GetURL(), "com.sun.star.text.TextDocument");
    uno::Reference<text::XTextDocument> xTextDoc(xComp, uno::UNO_QUERY);
