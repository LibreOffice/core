...
{
    struct MSCompatibleFramesAutowidth
        : public comphelper::ConfigurationProperty<MSCompatibleFramesAutowidth, bool>
    {
        static OUString path()
        {
            return "/org.openoffice.Office.Compatibility/View/MSCompatibleFramesAutowidth";
        }
