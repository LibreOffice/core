...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter, TestTdf137025)
{
    ...
    assertXPath(pXmlDoc, "/root/page/body/txt/anchored/SwAnchoredDrawObject/SdrObject"
        "/DefaultProperties/SfxItemSet/SfxInt32Item[3]", "value", "567");
    assertXPath(pXmlDoc, "/root/page/body/txt/anchored/SwAnchoredDrawObject/SdrObject"
        "/DefaultProperties/SfxItemSet/SfxInt32Item[4]", "value", "1134");
    assertXPath(pXmlDoc, "/root/page/body/txt/anchored/SwAnchoredDrawObject/SdrObject"
        "/DefaultProperties/SfxItemSet/SfxInt32Item[5]", "value", "1701");
    assertXPath(pXmlDoc, "/root/page/body/txt/anchored/SwAnchoredDrawObject/SdrObject"
        "/DefaultProperties/SfxItemSet/SfxInt32Item[6]", "value", "2268");
    ...
    const long nFrameBottomPaddng = xFrameProps->getPropertyValue("BottomBorderDistance").get<long>();
