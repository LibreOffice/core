...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter, testTdf126244)
{
    ...
    sal_Int32 nRotation = getXPath(pXmlDoc, "/metafile/push[1]/push[1]/push[1]/push[4]/push[1]/font[5]", "orientation").toInt32();
    ...
    nRotation = getXPath(pXmlDoc, "/metafile/push[1]/push[1]/push[1]/push[4]/push[1]/font[7]", "orientation").toInt32();
    CPPUNIT_ASSERT(nRotation >= 899 && nRotation <= 900);
}
...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter, testTdf127304)
{
    ...
    sal_Int32 nRotation = getXPath(pXmlDoc, "/metafile/push[1]/push[1]/push[1]/push[3]/push[1]/font[1]", "orientation").toInt32();
    CPPUNIT_ASSERT(nRotation >= 899 && nRotation <= 900);
