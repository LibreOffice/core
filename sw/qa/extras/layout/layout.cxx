...
CPPUNIT_TEST_FIXTURE(SwLayoutWriter, testTdf115630)
{
    ...
    // Test end point position of the chart.
    sal_Int32 nX = getXPath(pXmlDoc, "/metafile/push[1]/push[1]/push[1]/push[4]/push[1]/push[3]/polyline[1]/point[1]", "x").toInt32();
    CPPUNIT_ASSERT_EQUAL(sal_Int32(6525), nX);
}
