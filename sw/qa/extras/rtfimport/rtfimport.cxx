...
DECLARE_RTFIMPORT_TEST(testImportHeaderFooter, "tdf108055.rtf")
{
    ...
    OUString aActual = xFooterText->getString();
    ...
    uno::Reference<text::XText> xFooterTextLeft = getProperty< uno::Reference<text::XText> >(getStyles("PageStyles")->getByName("Default Style"), "FooterTextRight");
    aActual = xFooterTextLeft->getString();
