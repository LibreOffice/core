        ...
        uno::Reference<lang::XComponent> const& xComponent) -> void
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE(rTestName.toUtf8().getStr(), OUString(
        OUStringLiteral1(CH_TXT_ATR_FIELDSTART) + u" QUOTE  \"foo " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u" bar " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"baz\" " + OUStringLiteral1(CH_TXT_ATR_FIELDSEP) + u"foo " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u" bar " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"baz" + OUStringLiteral1(CH_TXT_ATR_FIELDEND)), innerString);
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE(rTestName.toUtf8().getStr(), OUString(
        OUStringLiteral1(CH_TXT_ATR_FIELDSTART) + u" QUOTE  \"foo " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u" " + OUStringLiteral1(CH_TXT_ATR_FIELDSTART) + u" QUOTE  \"foo " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u" bar " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"baz\" " + OUStringLiteral1(CH_TXT_ATR_FIELDSEP) + u"foo " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u" bar " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"baz" + OUStringLiteral1(CH_TXT_ATR_FIELDEND) + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"bar " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"baz\" " + OUStringLiteral1(CH_TXT_ATR_FIELDSEP) + u"foo " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u" foo " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u" bar " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"baz" + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"bar " + OUStringLiteral1(CH_TXTATR_NEWLINE)
        + u"baz" + OUStringLiteral1(CH_TXT_ATR_FIELDEND)), outerString);

    // must return innermost mark
    CPPUNIT_ASSERT(rIDMA.getFieldmarkFor(innerPos) == pInner);
}
