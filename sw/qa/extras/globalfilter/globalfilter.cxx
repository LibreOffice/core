...
void Test::testBulletAsImage()
{
    ...
    for (OUString const & rFilterName : aFilterNames)
    {
        ...
        // Check if import was successful
        {
            ...
            CPPUNIT_ASSERT_EQUAL_MESSAGE(sFailedMessage.getStr(), 15L, aGraphic.GetSizePixel().Width());
            CPPUNIT_ASSERT_EQUAL_MESSAGE(sFailedMessage.getStr(), 15L, aGraphic.GetSizePixel().Height());

            // Graphic Size
            CPPUNIT_ASSERT_EQUAL_MESSAGE(sFailedMessage.getStr(), sal_Int32(395), aSize.Width);
            CPPUNIT_ASSERT_EQUAL_MESSAGE(sFailedMessage.getStr(), sal_Int32(395), aSize.Height);
        }
