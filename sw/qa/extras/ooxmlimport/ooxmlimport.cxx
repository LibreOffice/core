...
DECLARE_OOXMLIMPORT_TEST(testN758883, "n758883.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int32(220), aHeight.toInt32()); 
...
DECLARE_OOXMLIMPORT_TEST(testN780645, "n780645.docx")
{
    ...
    uno::Reference<text::XTextTable> xTextTable(xTables->getByIndex(0), uno::UNO_QUERY);
    uno::Reference<table::XTableRows> xTableRows(xTextTable->getRows(), uno::UNO_QUERY);
    CPPUNIT_ASSERT_EQUAL(sal_Int16(2135), getProperty< uno::Sequence<text::TableColumnSeparator> >(xTableRows->getByIndex(1), "TableColumnSeparators")[0].Position); 
}
...
{
    sal_Int32 nTextPortion = parseDump("/root/page/body/txt/Text[1]", "nWidth").toInt32(); 
    sal_Int32 nTabPortion = parseDump("/root/page/body/txt/Text[2]", "nWidth").toInt32(); 
    sal_Int32 nParagraph = parseDump("/root/page/body/txt/infos/bounds", "width").toInt32(); 
...
DECLARE_OOXMLIMPORT_TEST(testFdo53985, "fdo53985.docx")
{
    ...
    uno::Reference<text::XTextTablesSupplier> xTablesSupplier(mxComponent, uno::UNO_QUERY);
    uno::Reference<container::XIndexAccess> xTables(xTablesSupplier->getTextTables( ), uno::UNO_QUERY);
    CPPUNIT_ASSERT_EQUAL(sal_Int32(5), xTables->getCount()); 
}
...
DECLARE_OOXMLIMPORT_TEST(testSmartart, "smartart.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int32(4), xGroup->getCount()); 
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int32(0x4f81bd), nValue); 
