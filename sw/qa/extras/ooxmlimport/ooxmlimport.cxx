...
void Test::testIndentation()
{
    ...
    CPPUNIT_ASSERT_EQUAL(text::WritingMode2::LR_TB, sal_Int16(getProperty<sal_Int32>( xParaLTRTitle, "WritingMode" )));
    CPPUNIT_ASSERT_EQUAL(text::WritingMode2::LR_TB, sal_Int16(getProperty<sal_Int32>( xParaLTRNormal, "WritingMode" )));
}
