...
DECLARE_OOXMLIMPORT_TEST(testFdo79738, "fdo79738.docx")
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Error in importing header",xPropertySetHeader->getPropertyValue("ParaLineNumberCount") == false);
    uno::Reference<beans::XPropertySet> xPropertySetFooter( xStyles->getByName("Footer"), uno::UNO_QUERY );
    CPPUNIT_ASSERT_MESSAGE("Error in importing footer",xPropertySetFooter->getPropertyValue("ParaLineNumberCount") == false);
}
