...
DECLARE_OOXMLIMPORT_TEST(testTdf120547, "tdf120547.docx")
{
    ...
    uno::Reference<drawing::XShape> xShape1
        = uno::Reference<drawing::XShape>(xGroup->getByIndex(0), uno::UNO_QUERY_THROW);
    ...
    uno::Reference<drawing::XShape> xShape2
        = uno::Reference<drawing::XShape>(xGroup->getByIndex(1), uno::UNO_QUERY_THROW);
    ...
    uno::Reference<drawing::XShape> xShape3
        = uno::Reference<drawing::XShape>(xGroup->getByIndex(2), uno::UNO_QUERY_THROW);
