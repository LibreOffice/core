...
CPPUNIT_TEST_FIXTURE(Test, testTdf121493)
{
    ...
    createSwDoc("tdf121493.rtf");
    {
        ...
        assertXPath(pLayout, "//tab[1]['pass 1']/infos/prtBounds", "left", u"1000"_ustr);
        assertXPath(pLayout, "//tab[1]['pass 1']/row/cell[1]/infos/bounds", "width", u"7000"_ustr);
        assertXPath(pLayout, "//tab[1]['pass 1']/row/cell[2]/infos/bounds", "width", u"1000"_ustr);
        // 2nd table, having \trleft1000\cellx8000\cellx9000
        assertXPath(pLayout, "//tab[2]['pass 1']/infos/prtBounds", "left", u"1000"_ustr);
        assertXPath(pLayout, "//tab[2]['pass 1']/row/cell[1]/infos/bounds", "width", u"7000"_ustr);
        assertXPath(pLayout, "//tab[2]['pass 1']/row/cell[2]/infos/bounds", "width", u"1000"_ustr);
        // 3rd table, having \trleft0\cellx8000\cellx9000
        assertXPath(pLayout, "//tab[3]['pass 1']/infos/prtBounds", "left", u"0"_ustr);
        assertXPath(pLayout, "//tab[3]['pass 1']/row/cell[1]/infos/bounds", "width", u"8000"_ustr);
        assertXPath(pLayout, "//tab[3]['pass 1']/row/cell[2]/infos/bounds", "width", u"1000"_ustr);
    }
    // Check export, too
    saveAndReload(mpFilter);
    {
        ...
        // 1st table
        assertXPath(pLayout, "//tab[1]['pass 2']/infos/prtBounds", "left", u"1000"_ustr);
        ...
        // 2nd table
        assertXPath(pLayout, "//tab[2]['pass 2']/infos/prtBounds", "left", u"1000"_ustr);
        ...
        CPPUNIT_ASSERT_DOUBLES_EQUAL(1000, width.toInt32(), 1);
        // 3rd table
        assertXPath(pLayout, "//tab[3]['pass 2']/infos/prtBounds", "left", u"0"_ustr);
...
CPPUNIT_TEST_FIXTURE(Test, testTdf167169)
{
    ...
    createSwDoc("tdf167169.rtf");
    {
        ...
        assertXPath(pLayout, "//tab[1]['pass 1']/infos/prtBounds", "left", u"1000"_ustr);
        assertXPath(pLayout, "//tab[1]['pass 1']/row/cell[1]/infos/bounds", "width", u"8000"_ustr);
        assertXPath(pLayout, "//tab[1]['pass 1']/row/cell[2]/infos/bounds", "width", u"1000"_ustr);
        // 2nd table, having \trleft500\tblind1000\tblindtype3\cellx8000\cellx9000
        assertXPath(pLayout, "//tab[2]['pass 1']/infos/prtBounds", "left", u"1000"_ustr);
        assertXPath(pLayout, "//tab[2]['pass 1']/row/cell[1]/infos/bounds", "width", u"7500"_ustr);
        assertXPath(pLayout, "//tab[2]['pass 1']/row/cell[2]/infos/bounds", "width", u"1000"_ustr);
        // 3rd table, having \trleft1000\tblind1000\tblindtype3\cellx8000\cellx9000
        assertXPath(pLayout, "//tab[3]['pass 1']/infos/prtBounds", "left", u"1000"_ustr);
        assertXPath(pLayout, "//tab[3]['pass 1']/row/cell[1]/infos/bounds", "width", u"7000"_ustr);
        assertXPath(pLayout, "//tab[3]['pass 1']/row/cell[2]/infos/bounds", "width", u"1000"_ustr);
        // 4th table, having \trleft1500\tblind1000\tblindtype3\cellx8000\cellx9000
        assertXPath(pLayout, "//tab[4]['pass 1']/infos/prtBounds", "left", u"1000"_ustr);
        assertXPath(pLayout, "//tab[4]['pass 1']/row/cell[1]/infos/bounds", "width", u"6500"_ustr);
        assertXPath(pLayout, "//tab[4]['pass 1']/row/cell[2]/infos/bounds", "width", u"1000"_ustr);
    }
    // Check export, too
    saveAndReload(mpFilter);
    {
        ...
        CPPUNIT_ASSERT_DOUBLES_EQUAL(1000, width.toInt32(), 1);
        // 3rd table
        assertXPath(pLayout, "//tab[3]['pass 2']/infos/prtBounds", "left", u"1000"_ustr);
        width = getXPath(pLayout, "//tab[3]['pass 2']/row/cell[1]/infos/bounds", "width");
        CPPUNIT_ASSERT_DOUBLES_EQUAL(7000, width.toInt32(), 1);
        width = getXPath(pLayout, "//tab[3]['pass 2']/row/cell[2]/infos/bounds", "width");
        CPPUNIT_ASSERT_DOUBLES_EQUAL(1000, width.toInt32(), 1);
        // 4th table
        assertXPath(pLayout, "//tab[4]['pass 2']/infos/prtBounds", "left", u"1000"_ustr);
...
CPPUNIT_TEST_FIXTURE(Test, testTdf167185)
{
    ...
    createSwDoc("tdf167185.rtf");
    {
        ...
        assertXPath(pLayout, "//tab['pass 1']/row[1]/cell[1]/infos/bounds", "width", u"3119"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[1]/cell[2]/infos/bounds", "width", u"1517"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[2]/cell", 2);
        assertXPath(pLayout, "//tab['pass 1']/row[2]/cell[1]/infos/bounds", "width", u"3119"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[2]/cell[2]/infos/bounds", "width", u"1517"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[3]/cell", 2);
        assertXPath(pLayout, "//tab['pass 1']/row[3]/cell[1]/infos/bounds", "width", u"3119"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[3]/cell[2]/infos/bounds", "width", u"1517"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[4]/cell", 2);
        assertXPath(pLayout, "//tab['pass 1']/row[4]/cell[1]/infos/bounds", "width", u"3119"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[4]/cell[2]/infos/bounds", "width", u"1517"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[5]/cell", 2);
        assertXPath(pLayout, "//tab['pass 1']/row[5]/cell[1]/infos/bounds", "width", u"3119"_ustr);
        assertXPath(pLayout, "//tab['pass 1']/row[5]/cell[2]/infos/bounds", "width", u"1517"_ustr);
    }
    // Check export, too
    saveAndReload(mpFilter);
    {
