...
DECLARE_RTFEXPORT_TEST(testTdf112520, "tdf112520.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0xffff00), getProperty<sal_Int32>(getShape(2), "FillColor"));
    CPPUNIT_ASSERT_EQUAL(text::TextContentAnchorType_AT_CHARACTER,
                         getProperty<text::TextContentAnchorType>(getShape(2), "AnchorType"));
    CPPUNIT_ASSERT_EQUAL(Color(0xffffff), getProperty<sal_Int32>(getShape(3), "FillColor"));
    // Without the accompanying fix in place, this test would have failed with
    // 'expected: 4, actual: 2'.
