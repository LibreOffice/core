...
DECLARE_RTFEXPORT_TEST(testTdf107413, "tdf107413.rtf")
{
    ...
    CPPUNIT_ASSERT_EQUAL(1004.0, nLeftFooter);
    CPPUNIT_ASSERT_EQUAL(11469.0, nRightFooter);
    CPPUNIT_ASSERT_EQUAL(17121.0, nBottomFooter);
    CPPUNIT_ASSERT_EQUAL(13522.0, nTopFooter);
    */
    ...
    CPPUNIT_ASSERT_EQUAL(1004.0, nLeftFly);
    CPPUNIT_ASSERT_EQUAL(11469.0, nRightFly);
    CPPUNIT_ASSERT_EQUAL(17121.0, nBottomFly);
    CPPUNIT_ASSERT_EQUAL(14578.0, nTopFly);
}
