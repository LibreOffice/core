...
DECLARE_RTFEXPORT_TEST(testNestedTable, "rhbz1065629.rtf")
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0xCC0000), Color(ColorTransparency, getProperty<sal_Int32>(xCell, "BackColor")));
    xCell.set(xTable->getCellByName("A2"), uno::UNO_QUERY);
    CPPUNIT_ASSERT(xCell.is());
...
DECLARE_RTFEXPORT_TEST(testShpzDhgt, "shpz-dhgt.rtf")
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0xff0000), Color(ColorTransparency, getProperty<sal_Int32>(getShape(1), "FillColor")));
    // Second (front) should be green.
    CPPUNIT_ASSERT_EQUAL(Color(0x00ff00), Color(ColorTransparency, getProperty<sal_Int32>(getShape(2), "FillColor")));
}
...
DECLARE_RTFEXPORT_TEST(testCharColor, "char-color.rtf")
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0x365F91), Color(ColorTransparency, getProperty<sal_Int32>(getParagraph(1), "CharColor")));
}
