...
void emulateTyping(SwXTextDocument& rXTextDocument, const std::wstring& rStr)
{
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testRedlineAutoCorrect)
{
    ...
    emulateTyping(*pXTextDocument, L" ");
    ...
    emulateTyping(*pXTextDocument, L"et ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testRedlineAutoCorrect2)
{
    ...
    // Continue it:
    emulateTyping(*pXTextDocument, L"Lorem,... ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testEmojiAutoCorrect)
{
    ...
    emulateTyping(*pXTextDocument, L":snowman:");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf108423)
{
    ...
    emulateTyping(*pXTextDocument, L"i'");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf106164)
{
    ...
    emulateTyping(*pXTextDocument, L"we're ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf38394)
{
    ...
    emulateTyping(*pXTextDocument, L"l'\"");
    OUString sReplaced(u"l\u2019« ");
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // tdf#132301 autocorrect of qu'«
    emulateTyping(*pXTextDocument, L" qu'\"");
    sReplaced += u" qu\u2019« ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
}
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf59666)
{
    ...
    emulateTyping(*pXTextDocument, L"π ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf133524)
{
    ...
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // <<
    emulateTyping(*pXTextDocument, L"word<<");
    sReplaced += u"word«";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    ...
    emulateTyping(*pXTextDocument, L"Sentence and \"");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf133524_Romanian)
{
    ...
    emulateTyping(*pXTextDocument, L"Alternative.“ \"");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf123786)
{
    ...
    // Set the system locale to Russian
    ...
    aOptions.SetLocaleConfigString("ru-RU");
    aOptions.Commit();
    ...
    CPPUNIT_ASSERT(pXTextDocument);
    // Second level ending quote: „word' -> „word“
    emulateTyping(*pXTextDocument, L"„слово'");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf133589)
{
    ...
    emulateTyping(*pXTextDocument, L"székely ");
    OUString sReplaced(u"𐳥𐳋𐳓𐳉𐳗 ");
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // disambiguate consonants: asszony -> asz|szony
    emulateTyping(*pXTextDocument, L"asszony ");
    sReplaced += u"𐳀𐳥𐳥𐳛𐳚 ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    ...
    emulateTyping(*pXTextDocument, L"kos\u200Bszarv ");
    sReplaced += u"𐳓𐳛𐳤𐳥𐳀𐳢𐳮 ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // transliterate numbers to Old Hungarian
    emulateTyping(*pXTextDocument, L"2020 ");
    sReplaced += u"𐳺𐳺𐳿𐳼𐳼 ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    ...
    // question mark
    emulateTyping(*pXTextDocument, L"Kérdőjel?");
    ...
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // comma
    emulateTyping(*pXTextDocument, L"Vessző,");
    sReplaced += u"𐲮𐳉𐳥𐳥𐳟";
    ...
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // semicolon
    emulateTyping(*pXTextDocument, L"pontosvessző;");
    ...
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // quotation marks
    emulateTyping(*pXTextDocument, L"„idézőjel” ");
