...
void lcl_insertString(SwXTextDocument& rXTextDocument, const std::wstring& rStr)
{
    for (const wchar_t c : rStr)
    {
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testRedlineAutoCorrect)
{
    ...
    lcl_insertString(*pXTextDocument, L"et ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testRedlineAutoCorrect2)
{
    ...
    // Continue it:
    lcl_insertString(*pXTextDocument, L"Lorem,... ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testEmojiAutoCorrect)
{
    ...
    lcl_insertString(*pXTextDocument, L":snowman:");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf108423)
{
    ...
    lcl_insertString(*pXTextDocument, L"i'");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf106164)
{
    ...
    lcl_insertString(*pXTextDocument, L"we're ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf38394)
{
    ...
    lcl_insertString(*pXTextDocument, L"l'\"");
    OUString sReplaced(u"l\u2019« ");
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // tdf#132301 autocorrect of qu'«
    lcl_insertString(*pXTextDocument, L" qu'\"");
    sReplaced += u" qu\u2019« ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
}
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf59666)
{
    ...
    lcl_insertString(*pXTextDocument, L"π ");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf133524)
{
    ...
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // <<
    lcl_insertString(*pXTextDocument, L"word<<");
    sReplaced += u"word«";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    ...
    lcl_insertString(*pXTextDocument, L"Sentence and \"");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf133524_Romanian)
{
    ...
    lcl_insertString(*pXTextDocument, L"Alternative.“ \"");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf123786)
{
    ...
    CPPUNIT_ASSERT(pXTextDocument);
    // Second level ending quote: „word' -> „word“
    lcl_insertString(*pXTextDocument, L"„слово'");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf133589)
{
    ...
    lcl_insertString(*pXTextDocument, L"székely ");
    OUString sReplaced(u"𐳥𐳋𐳓𐳉𐳗 ");
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // disambiguate consonants: asszony -> asz|szony
    lcl_insertString(*pXTextDocument, L"asszony ");
    sReplaced += u"𐳀𐳥𐳥𐳛𐳚 ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    ...
    lcl_insertString(*pXTextDocument, L"kos\u200Bszarv ");
    sReplaced += u"𐳓𐳛𐳤𐳥𐳀𐳢𐳮 ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // transliterate numbers to Old Hungarian
    lcl_insertString(*pXTextDocument, L"2020 ");
    sReplaced += u"𐳺𐳺𐳿𐳼𐳼 ";
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    ...
    // question mark
    lcl_insertString(*pXTextDocument, L"Kérdőjel?");
    ...
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // comma
    lcl_insertString(*pXTextDocument, L"Vessző,");
    sReplaced += u"𐲮𐳉𐳥𐳥𐳟";
    ...
    CPPUNIT_ASSERT_EQUAL(sReplaced, getParagraph(1)->getString());
    // semicolon
    lcl_insertString(*pXTextDocument, L"pontosvessző;");
