    ...
    for (auto nFly = 1; nFly < 8; ++nFly)
    {
        const auto nFlyLeft
            = getXPath(pLayoutXML1,
                       OString("/root/page/body/txt[2]/anchored/fly[")
                           + OString(OString::number(nFly)) + OString("]/infos/bounds"),
                       "left")
                  .toInt64();
        const auto nFlyRight
            = getXPath(pLayoutXML1,
                       OString("/root/page/body/txt[2]/anchored/fly[")
                           + OString(OString::number(nFly)) + OString("]/infos/bounds"),
                       "width")
        ...
        const auto sDrawRect
            = getXPath(pLayoutXML1,
                       OString("/root/page/body/txt[2]/anchored/SwAnchoredDrawObject/SdrObjGroup/"
                               "SdrObjList/SdrObject[")
                           + OString(OString::number(nFly)) + OString("]"),
                       "aOutRect");
    ...
    for (auto nFly = 1; nFly < 8; ++nFly)
    {
        const auto nFlyLeft
            = getXPath(pLayoutXML2,
                       OString("/root/page/body/txt[6]/anchored/fly[")
                           + OString(OString::number(nFly)) + OString("]/infos/bounds"),
                       "left")
                  .toInt64();
        const auto nFlyRight
        ...
        const auto sDrawRect
            = getXPath(pLayoutXML2,
                       OString("/root/page/body/txt[6]/anchored/SwAnchoredDrawObject/SdrObjGroup/"
                               "SdrObjList/SdrObject[")
                           + OString(OString::number(nFly)) + OString("]"),
                       "aOutRect");
