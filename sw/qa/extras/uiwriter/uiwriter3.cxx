...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest3, testTdf143574)
{
    ...
    uno::Reference<frame::XFrame> xFrame(mxComponent, uno::UNO_QUERY);
    CPPUNIT_ASSERT(xFrame);
    uno::Reference<frame::XController> xController(xFrame, uno::UNO_QUERY);
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Bool(true), xSelection->select(xGroup->getByIndex(0)));
