...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest3, testTdf143574)
{
    ...
    uno::Any aCurrentSelection = xSelection->getSelection();
    CPPUNIT_ASSERT(aCurrentSelection.hasValue());
    uno::Reference<beans::XPropertySet> xShapeProps(aCurrentSelection, uno::UNO_QUERY);
