...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest2, testTdf115026_tableAutoFormat_lostPageBreak)
{
    ...
    SwTableAutoFormat* pStyle = pDoc->MakeTableStyle("Default Style"); //PageBreak TableStyle");
    ...
    aTableAFT.AddAutoFormat(*pStyle);
    ...
    uno::Reference<table::XAutoFormattable> xAutoFormat(xTextTable, uno::UNO_QUERY);
    xAutoFormat->autoFormat("Default Style"); //PageBreak TableStylexxxxxxxxxx");
    xAutoFormat->autoFormat("PageBreak TableStyle");
