...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest2, testTdf137245)
{
    ...
    SvxSwAutoFormatFlags flags(*pWrtShell->GetAutoFormatFlags());
    comphelper::ScopeGuard const g([=]() { pWrtShell->SetAutoFormatFlags(&flags); });
    flags.bSetBorder = true;
    pWrtShell->SetAutoFormatFlags(&flags);
