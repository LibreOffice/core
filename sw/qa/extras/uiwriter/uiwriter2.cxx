...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest2, testTdf54819_keep_numbering_with_Undo)
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Not a bulleted list item", !sNumName.equals("Outline"));
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Outline style on bulleted list item",
        !getProperty<OUString>(getParagraph(2), "NumberingStyleName").equals("Outline"));
