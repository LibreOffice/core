...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest2, testTdf47471_paraStyleBackground)
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(14729933), getProperty<Color>(getParagraph(2), "FillColor"));
    ...
    CPPUNIT_ASSERT_EQUAL(Color(14605542), getProperty<Color>(getParagraph(2), "FillColor"));
