...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest2, testTdf137737_FindReplace)
{
    ...
    // Replace staight quotes with opening quotes
    uno::Sequence<beans::PropertyValue> aArgs(comphelper::InitPropertySequence({
        { "SearchItem.SearchString", uno::makeAny(OUString("^\"")) },
        { "SearchItem.ReplaceString", uno::makeAny(OUString(sal_Unicode(0x201C))) },
    ...
    // Replace staight quotes with closing quotes
    aArgs[0].Value <<= OUString("\"$");
    aArgs[1].Value <<= OUString(sal_Unicode(0x201D));
    dispatchCommand(mxComponent, ".uno:ExecuteSearch", aArgs);
    dispatchCommand(mxComponent, ".uno:ExecuteSearch", aArgs);
