...
void SwUiWriterTest2::testDropDownFormFieldInsertion()
{
    ...
    CPPUNIT_ASSERT(operator==(pListEntries, pParameters->end())); // explicit operator is a workaround for loplugin:cppunitassertequals
    auto pResult = pParameters->find(ODF_FORMDROPDOWN_RESULT);
    CPPUNIT_ASSERT(operator==(pResult, pParameters->end())); // explicit operator is a workaround for loplugin:cppunitassertequals
