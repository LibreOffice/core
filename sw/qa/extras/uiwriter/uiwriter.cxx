...
void SwUiWriterTest::testTdf63553()
{
    ...
    //inserting first sequence field
    SwSetExpFieldType pSeqType = SwSetExpFieldType(pDoc, OUString(""), nsSwGetSetExpType::GSE_EXPR);
    SwSetExpField aSetField1(&pSeqType, OUString(""), sal_uLong(0));
    ...
    //inserting second sequence field
    SwSetExpField aSetField2(&pSeqType, OUString(""), sal_uLong(0));
    ...
    //inserting third sequence field
    SwSetExpField aSetField3(&pSeqType, OUString(""), sal_uLong(0));
    ...
    pClpDoc->SetClipBoard(true);
    pClpDoc->getIDocumentFieldsAccess().LockExpFields();
    //selecting reference field 2 and 3 and sequence filed 1 and 2
    ...
    //deleting selection mark after copy
    pCursor->DeleteMark();
    //checking that the sequence reference fields have same values after copy operation
    uno::Any aAny;
    sal_uInt16 aFormat;
    ...
    aFormat = pSeq1->GetSeqNumber();
    CPPUNIT_ASSERT_EQUAL(sal_uInt16(65535), aFormat);
    ...
    aFormat = pNewSeq1->GetSeqNumber();
    CPPUNIT_ASSERT_EQUAL(sal_uInt16(0), aFormat);
    ...
    aFormat = pNewSeq11->GetSeqNumber();
    CPPUNIT_ASSERT_EQUAL(sal_uInt16(1), aFormat);
    ...
    aFormat = pOldSeq11->GetSeqNumber();
    CPPUNIT_ASSERT_EQUAL(sal_uInt16(65535), aFormat);
    ...
    aFormat = pOldSeq12->GetSeqNumber();
    CPPUNIT_ASSERT_EQUAL(sal_uInt16(65535), aFormat);
    ...
    aFormat = pOldSeq13->GetSeqNumber();
    CPPUNIT_ASSERT_EQUAL(sal_uInt16(65535), aFormat);
    ...
    aFormat = pOldSeq14->GetSeqNumber();
    CPPUNIT_ASSERT_EQUAL(sal_uInt16(0), aFormat);
