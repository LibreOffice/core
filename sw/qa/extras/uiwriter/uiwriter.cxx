...
void SwUiWriterTest::testTableStyleUndo()
{
    ...
    SvxBrushItem rBackground(Color(0xFF00FF), RES_BACKGROUND );
    pStyle->GetBoxFormat(0).SetBackground(rBackground);
    ...
    CPPUNIT_ASSERT(pStyle->GetBoxFormat(0).GetBackground() == rBackground);
