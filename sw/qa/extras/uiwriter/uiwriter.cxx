...
enum class PortionItemType : sal_Int32
{
    TEXT, SPECIAL, LINE_BREAK, SKIP, FINISH
};

struct PortionItem
{
    PortionItem(PortionItemType nItemType, sal_Int32 nLength = 0,
                sal_uInt16 nTextType = 0, OUString sText = OUString(""))
        : mnItemType(nItemType)
        , mnLength(nLength)
        , mnTextType(nTextType)
        , msText(sText)
    {}

    PortionItemType mnItemType;
    sal_Int32 mnLength;
...
class PortionHandler : public SwPortionHandler
{
  public:
    ...
    {
        mPortionItems.push_back(PortionItem(PortionItemType::TEXT, nLength, nType));
    }
    ...
    {
        mPortionItems.push_back(PortionItem(PortionItemType::SPECIAL, nLength, nType, rText));
    }

    virtual void LineBreak(sal_Int32 /*nWidth*/) override
    {
        mPortionItems.push_back(PortionItem(PortionItemType::LINE_BREAK));
    }

    virtual void Skip(sal_Int32 nLength) override
    {
        mPortionItems.push_back(PortionItem(PortionItemType::SKIP, nLength));
    }

    virtual void Finish() override
    {
        mPortionItems.push_back(PortionItem(PortionItemType::FINISH));
    }
};
...
void SwUiWriterTest::testTdf77014()
{
...

    {
        ...
        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::TEXT), int(aHandler.mPortionItems[0].mnItemType));
        CPPUNIT_ASSERT_EQUAL(25,                         aHandler.mPortionItems[0].mnLength);
        CPPUNIT_ASSERT_EQUAL(sal_uInt16(POR_INPUTFLD),   aHandler.mPortionItems[0].mnTextType);

        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::LINE_BREAK), int(aHandler.mPortionItems[1].mnItemType));

        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::FINISH), int(aHandler.mPortionItems[2].mnItemType));
    }
...

    {
        ...
        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::TEXT), int(aHandler.mPortionItems[0].mnItemType));
        CPPUNIT_ASSERT_EQUAL(18,                         aHandler.mPortionItems[0].mnLength);
        CPPUNIT_ASSERT_EQUAL(sal_uInt16(POR_INPUTFLD),   aHandler.mPortionItems[0].mnTextType);
...

    {
        ...
        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::TEXT), int(rPortionItem.mnItemType));
        CPPUNIT_ASSERT_EQUAL(91,                         rPortionItem.mnLength);
        CPPUNIT_ASSERT_EQUAL(sal_uInt16(POR_TXT),        rPortionItem.mnTextType);

        // NEW LINE
        rPortionItem = aHandler.mPortionItems[1];
        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::LINE_BREAK), int(rPortionItem.mnItemType));
        ...
        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::FINISH), int(rPortionItem.mnItemType));
    ...
    pTextFrame->VisitPortions(aHandler);
    {
        ...
        rPortionItem = aHandler.mPortionItems[1];
        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::TEXT), int(rPortionItem.mnItemType));
        CPPUNIT_ASSERT_EQUAL(8,                          rPortionItem.mnLength);
        CPPUNIT_ASSERT_EQUAL(sal_uInt16(POR_INPUTFLD),   rPortionItem.mnTextType);
        ...
        rPortionItem = aHandler.mPortionItems[4];
        CPPUNIT_ASSERT_EQUAL(int(PortionItemType::TEXT), int(rPortionItem.mnItemType));
        CPPUNIT_ASSERT_EQUAL(16,                         rPortionItem.mnLength);
        CPPUNIT_ASSERT_EQUAL(sal_uInt16(POR_INPUTFLD),   rPortionItem.mnTextType);
