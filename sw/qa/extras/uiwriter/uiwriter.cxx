...
void SwUiWriterTest::testWatermarkDOCX()
{
    ...
    CPPUNIT_ASSERT_EQUAL((short)45, pWatermark->GetAngle());
    CPPUNIT_ASSERT_EQUAL((unsigned int)0x548dd4, pWatermark->GetColor());
    CPPUNIT_ASSERT_EQUAL((short)50, pWatermark->GetTransparency());
}
