...
void SwUiWriterTest::testTdf90808()
{
    ...
    xText->insertTextContent(xCrsr, type1bookmark1, false);
    //creating bookmark 2
    ...
    CPPUNIT_ASSERT_THROW(xText->insertTextContent(xCrsr, type1bookmark2, false), com::sun::star::lang::IllegalArgumentException);
