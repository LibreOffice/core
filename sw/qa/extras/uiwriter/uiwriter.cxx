...
void SwUiWriterTest::testMsWordCompOpt()
{
    ...
    SwDoc* pDoc = createDoc( "MsWordCompOpt1.odt" );
    ...
    CPPUNIT_ASSERT( OUString( "" ) != parseDump( "/root/page/body/txt[2]/Text[4]", "nWidth" ) );
    CPPUNIT_ASSERT( OUString( "" ) != parseDump( "/root/page/body/txt[2]/Text[5]", "nWidth" ) );
    CPPUNIT_ASSERT( OUString( "" ) != parseDump( "/root/page/body/txt[3]/Text[4]", "nWidth" ) );
    CPPUNIT_ASSERT( OUString( "" ) != parseDump( "/root/page/body/txt[3]/Text[5]", "nWidth" ) );
