...
void SwUiWriterTest::testTdf112025()
{
    ...
    int numberOfParagraphs = getParagraphs();
    CPPUNIT_ASSERT_GREATER(0, numberOfParagraphs);
    ...
    OUString insertFileid = m_directories.getURLFromSrc(DATA_DIRECTORY) + OUString::createFromAscii("fdo112025-insert.docx");
