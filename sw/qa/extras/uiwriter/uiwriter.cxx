...
class IdleTask
{
    ...
    bool GetFlag();
    IdleTask();
    DECL_LINK_TYPED( FlipFlag, Timer *, void );
    ~IdleTask() {}
    private:
    bool flag;
    Idle maIdle;
...
IMPL_LINK_TYPED(IdleTask, FlipFlag, Timer*, , void)
{
...
//    CPPUNIT_ASSERT_EQUAL(OUString("Calibri"), getProperty<OUString>(xRun3, "CharFontName"));
...
//    CPPUNIT_ASSERT_EQUAL(OUString("Calibri Light"), getProperty<OUString>(xRun4, "CharFontName"));
...
void SwUiWriterTest::testInconsistentBookmark()
{
    // create test document with text and bookmark
    {
        ...
        aPaM.SetMark();
        aPaM.MovePara(GetfnParaCurr(), GetfnParaStart());
        aPaM.MovePara(GetfnParaCurr(), GetfnParaEnd());
        rIDMA.makeMark(aPaM, "Mark", IDocumentMarkAccess::MarkType::BOOKMARK);
        aPaM.Exchange();
        aPaM.DeleteMark();
    }
