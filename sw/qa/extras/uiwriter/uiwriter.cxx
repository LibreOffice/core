...
void SwUiWriterTest::testTdf79236()
{
    ...
    const SvxAdjustItem AdjustItem = attrSet.GetAdjust(true);
    ...
    SvxAdjustItem& aAdjustItem(const_cast<SvxAdjustItem&>(AdjustItem));
    aAdjustItem.SetAdjust(SVX_ADJUST_RIGHT);
    //Checking whether the change is made or not
    SvxAdjust modifiedAdjust = aAdjustItem.GetAdjust();
    CPPUNIT_ASSERT_EQUAL(SVX_ADJUST_RIGHT, modifiedAdjust);
    //Modifying the itemset, putting *one* item
    SfxPoolItem* pPoolItem = aAdjustItem.Clone();
    itemSet->Put(*pPoolItem);
    ...
    //The adjust should be default which is LEFT
