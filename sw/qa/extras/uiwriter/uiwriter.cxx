...
void SwUiWriterTest::testFdo87448()
{
    ...
    sal_Int32 nFirstEnd = getXPath(pXmlDoc, "/metafile/push[1]/polyline[1]/point[last()-1]", "x").toInt32();
    ...
    sal_Int32 nSecondEnd = getXPath(pXmlDoc, "/metafile/push[2]/polyline[1]/point[last()]", "x").toInt32();
