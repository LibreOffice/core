...
void SwUiWriterTest4::testNestedGroupTextBox()
{
    ...
    CPPUNIT_ASSERT(xShape1->getShapeType() == OUString("com.sun.star.drawing.CustomShape"));
    auto xShape2 = getShape(2);
    CPPUNIT_ASSERT(xShape2->getShapeType() == OUString("com.sun.star.drawing.GroupShape"));
    // and select them
    ...
    CPPUNIT_ASSERT(xShape3->getShapeType() == OUString("com.sun.star.drawing.GroupShape"));
    ...
    CPPUNIT_ASSERT(xShape4->getShapeType() == OUString("com.sun.star.drawing.GroupShape"));
    ...
    for (int i = 1; i < 5; ++i)
    {
        ...
        if (xShapeProps->getPropertySetInfo()->hasPropertyByName("TextBox"))
        {
            ...
            CPPUNIT_ASSERT_EQUAL_MESSAGE("This must be a textbox! (" + sName + ")", true,
