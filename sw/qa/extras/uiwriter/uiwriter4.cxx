...
void SwUiWriterTest4::testNestedGroupTextBox()
{
    ...
    pWrtShell->SelectObj(Point(), 0x000, SdrObject::getSdrObjectFromXShape(getShape(1)));
    ...
    pWrtShell->SelectObj(Point(), 0x000, SdrObject::getSdrObjectFromXShape(getShape(2)));
