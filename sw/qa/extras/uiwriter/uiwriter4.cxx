...
void SwUiWriterTest4::testTdf49033()
{
    ...
    /* Move cursor between the ' ' and the 'm' before 'met' */
    for (int i = 0; i < 11; i++)
    ...
    // This test does not work due to tdf#49187
    //  CPPUNIT_ASSERT_EQUAL(OUString("Mary Jones met Joe smith. Time passed."), lcl_translitTest(*pDoc, *pCursor, TF::SENTENCE_CASE));
    CPPUNIT_ASSERT_EQUAL(OUString("Mary Jones met Joe Smith. Time Passed."),
                         lcl_translitTest(*pDoc, *pCursor, TF::TITLE_CASE));
    CPPUNIT_ASSERT_EQUAL(OUString("Mary Jones met JOE SMITH. TIME PASSED."),
                         lcl_translitTest(*pDoc, *pCursor, TF::LOWERCASE_UPPERCASE));
