...
{
    SwDoc* pDoc = createSwDoc("tdf139127.fodt");
...
{
    SwDoc* pDoc = createSwDoc("tdf115815.odt");
...
{
    SwDoc* pDoc = createSwDoc("tdf126206.docx");
...
{
    SwDoc* pDoc = createSwDoc("tdf50447.fodt");
...
{
    SwDoc* const pDoc = createSwDoc("tdf147723.docx");
...
{
    SwDoc* const pDoc = createSwDoc("tdf147006.rtf");
...
{
    SwDoc* pDoc = createSwDoc("tdf118699.docx");
...
{
    SwDoc* pDoc = createSwDoc("tdf125916.docx");
...
{
    SwDoc* pDoc = createSwDoc("tdf125310.fodt");
...
{
    SwDoc* pDoc = createSwDoc("tdf125310b.fodt");
    SwWrtShell* pWrtShell = pDoc->GetDocShell()->GetWrtShell();
...
{
    SwDoc* pDoc = createSwDoc("tdf120336.docx");
...
{
    SwDoc* pDoc = createSwDoc("tdf106843.docx");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testImageCommentAtChar)
{
    ...
    SwDoc* pDoc = createSwDoc("image-comment-at-char.odt");
    SwView* pView = pDoc->GetDocShell()->GetView();
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testShapePageMove)
{
    ...
    SwDoc* pDoc = createSwDoc("shape-page-move.odt");
    SwView* pView = pDoc->GetDocShell()->GetView();
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testOleSaveWhileEdit)
{
    ...
    SwDoc* pDoc = createSwDoc("ole-save-while-edit.odt");
    SwWrtShell* pWrtShell = pDoc->GetDocShell()->GetWrtShell();
...
{
    SwDoc* pDoc = createSwDoc("tdf105330.odt");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testRedlineTableRowDeletion)
{
    ...
    SwDoc* pDoc = createSwDoc("tdf118311.fodt");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testTdf150976)
{
    ...
    SwDoc* pDoc = createSwDoc("select-row.fodt");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testTdf47979_row)
{
    ...
    SwDoc* pDoc = createSwDoc("select-column.fodt");
    CPPUNIT_ASSERT(pDoc);
    SwWrtShell* pWrtShell = pDoc->GetDocShell()->GetWrtShell();
    CPPUNIT_ASSERT(pWrtShell);
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testRedlineDOCXTableInsertion)
{
    ...
    SwDoc* pDoc = createSwDoc("TC-table-converttotable.docx");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testRedlineDOCXTableMoveToFrame)
{
    ...
    SwDoc* pDoc = createSwDoc("TC-table-DnD-move.docx");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testTdf143215)
{
    ...
    SwDoc* pDoc = createSwDoc("TC-table-rowadd.docx");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testTdf144748)
{
    ...
    SwDoc* pDoc = createSwDoc("tdf144748.fodt");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testTdf128335)
{
    ...
    SwDoc* pDoc = createSwDoc("tdf128335.odt");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testTdf145091)
{
    ...
    SwDoc* pDoc = createSwDoc("tdf145091.docx");
...
{
    // Load the bugdoc, which has 3 textboxes.
    SwDoc* pDoc = createSwDoc("tdf128603.odt");
...
{
    SwDoc* pDoc = createSwDoc("tdf143904.odt");
...
{
    SwDoc* pDoc = createSwDoc("tdf90069.docx");
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest5, testTdf109266)
{
    ...
    SwDoc* pDoc = createSwDoc("lorem.fodt");
    SwWrtShell* pWrtShell = pDoc->GetDocShell()->GetWrtShell();
    CPPUNIT_ASSERT(pWrtShell);
