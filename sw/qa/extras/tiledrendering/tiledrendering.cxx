...
void SwTiledRenderingTest::testDocumentRepair()
{
    ...
    CPPUNIT_ASSERT(pView1 != pView2);
    {
        ...
        SfxPoolItem* pItem1 = dynamic_cast< const SfxBoolItem* >(pItem1.get());
        SfxPoolItem* pItem2 = dynamic_cast< const SfxBoolItem* >(pItem2.get());
    ...
    Scheduler::ProcessEventsToIdle();
    {
        ...
        pView1->GetViewFrame()->GetBindings().QueryState(SID_DOC_REPAIR, xItem1);
        pView2->GetViewFrame()->GetBindings().QueryState(SID_DOC_REPAIR, xItem2);
        SfxPoolItem* pItem1 = dynamic_cast<const SfxBoolItem*>(xItem1.get());
        SfxPoolItem* pItem2 = dynamic_cast<const SfxBoolItem*>(xItem2.get());
        CPPUNIT_ASSERT(pItem1);
        CPPUNIT_ASSERT(pItem2);
