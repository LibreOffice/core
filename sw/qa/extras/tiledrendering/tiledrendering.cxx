...
void SwTiledRenderingTest::testPageHeader()
{
    ...
    // Insert Page Header
    {
        ...
        pViewShell->GetDispatcher()->ExecuteList(FN_INSERT_PAGEHEADER, SfxCallMode::SYNCHRON, {&aStyle, &aItem});
    }
    // Check Page Header State
...
void SwTiledRenderingTest::testPageFooter()
{
    ...
    // Insert Page Footer
    {
        ...
        SfxBoolItem aItem(FN_PARAM_1, true);
        pViewShell->GetDispatcher()->ExecuteList(FN_INSERT_PAGEFOOTER, SfxCallMode::SYNCHRON, {&aPageStyle, &aItem});
    }
    // Check Page Footer State
