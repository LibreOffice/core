...
public:
    ...
    void testTdf43244_SpacesOnMargin();
    void testClipText();
    ...
    CPPUNIT_TEST(testTdf43244_SpacesOnMargin);
...
void SwTiledRenderingTest::testTdf43244_SpacesOnMargin()
{
    // Load a document where the top left tile contains
    // paragraph and line break symbols with redlining.
    SwXTextDocument* pXTextDocument = createDoc("tdf43244_SpacesOnMargin.fodt");
