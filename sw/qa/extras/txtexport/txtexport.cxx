...
DECLARE_TXTEXPORT_TEST(testBullets, "bullets.odt")
{
    ...
    OString aExpected =
        OString("Paragraph") + SAL_NEWLINE_STRING +
        "" + SAL_NEWLINE_STRING +
        "    • First bullet" + SAL_NEWLINE_STRING +
        "    • Second bullet" + SAL_NEWLINE_STRING +
        "        ◦ Sub-second bullet" + SAL_NEWLINE_STRING +
        "      Third bullet, but deleted" + SAL_NEWLINE_STRING +
        "    • Fourth bullet" + SAL_NEWLINE_STRING +
        "" + SAL_NEWLINE_STRING +
