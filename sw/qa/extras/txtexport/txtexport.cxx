...
DECLARE_TXTEXPORT_TEST(testTdf120574_utf8, "UTF8BOMCRLF.txt")
{
    ...
    OUString aData
        = OStringToOUString(OString(pData + 3, aMemoryStream.GetSize() - 3), RTL_TEXTENCODING_UTF8);

    OUString aExpected(u"フー\r\nバー\r\n");
...
DECLARE_TXTEXPORT_TEST(testTdf120574_utf16le, "UTF16LECRLF.txt")
{
    ...
    OUString aData(static_cast<const char16_t*>(pData + 1),
                   aMemoryStream.GetSize() / sizeof(char16_t) - 1);
