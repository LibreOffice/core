...
CPPUNIT_TEST_FIXTURE(Test, testTdf89802)
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color(0x3f004586), Color(ColorTransparency, nValue));
}
...
CPPUNIT_TEST_FIXTURE(Test, fdo81223)
{
    ...
    sal_Int32 nValue(0);
    xFrame->getPropertyValue("BackColor") >>= nValue;
    CPPUNIT_ASSERT_EQUAL(Color(0xffffffff), Color(ColorTransparency, nValue));
}
...
CPPUNIT_TEST_FIXTURE(Test, fdo90130_1)
{
    ...
    sal_Int32 nValue(0);
    xFrame->getPropertyValue("BackColor") >>= nValue;
    CPPUNIT_ASSERT_EQUAL(Color(0x00ff3333), Color(ColorTransparency, nValue));
}
