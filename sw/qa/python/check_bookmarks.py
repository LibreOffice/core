...
class CheckBookmarks(unittest.TestCase):
    ...
    def reloadFrom(self, tempdir, sFilter, sExtension):
        ...
        sFileUrl = uno.systemPathToFileUrl(sFileUrl)
        self.xDoc.storeToURL(sFileUrl,
                    (PropertyValue("Override", 0, True, 0),
                     PropertyValue("FilterName", 0, sFilter, 0)))
        desktop = self.__class__._desktop
        return desktop.loadComponentFromURL(sFileUrl, "_default", 0,
