...
class XSortable(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._uno.setUp()
        # Initialize xDoc and xTextTable once instead of in every test
        cls.xDoc = cls._uno.openEmptyWriterDoc()
        cls.xTextTable = cls.xDoc.createInstance("com.sun.star.text.TextTable")
        cls.xTextTable.initialize(6, 1)
        cls.xTextCursor = cls.xDoc.Text.createTextCursor()
        cls.xDoc.Text.insertTextContent(cls.xTextCursor, cls.xTextTable, False)
    ...
    def test_createSortDescriptor(self):
        ...
        xSortDescriptor = self.xTextTable.createSortDescriptor()
    ...
    def test_sort(self):
        self.prepareToSortXTextTable(self.xTextTable)
        self.checkSortXTextTable(self.xTextTable)
        self.prepareToSortXTextCursor(self.xDoc, self.xTextCursor)
        self.checkSortXTextCursor(self.xDoc, self.xTextCursor)
