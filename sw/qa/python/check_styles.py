...
class CheckStyle(unittest.TestCase):
    ...
    def test_StyleFamilies(self):
        ...
        self.assertRegex(
            str(xStyleFamilies.ElementType), "com\.sun\.star\.container\.XNameContainer"
        )
    ...
    def __test_StyleFamilyInsert(
        self, xDoc, xFamily, vExpectedNames, sRightStyle, sWrongStyle
    ):
    ...
    def test_tableStyleIsInUse(self):
        ...
        xDefaultTableStyle = xDoc.StyleFamilies.getByName("TableStyles").getByName(
            "Default Style"
        )
        xDefaultCellStyle = xDoc.StyleFamilies.getByName("CellStyles").getByName(
            "Default Style.1"
        )
        ...
        xDoc.StyleFamilies.getByName("TableStyles").insertByName(
            "Test Table Style", xTableStyle
        )
        self.assertFalse(xTableStyle.isInUse())
    ...
    def test_CellFamily(self):
        ...
        self.assertEqual(
            ...
            xDoc.StyleFamilies.getByName("TableStyles")
            .getByName("Test Table Style")
            .getByName("first-row"),
        )
        # replaceByName
        with self.assertRaises(NoSuchElementException):
        ...
        self.assertEqual(
            xTableStyle.getByName("first-row"), xTableStyle2.getByName("first-row")
        )
        xDoc.StyleFamilies.getByName("CellStyles").insertByName(
            "Test Cell Style", xCellStyle
        )
        xTableStyle.replaceByName("first-row", xCellStyle)
        self.assertEqual(xTableStyle.getByName("first-row"), xCellStyle)
        xDoc.dispose()
