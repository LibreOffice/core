...
void SwDocTest::testTableAutoFormats()
{
    ...
    //Set m_aTLBR
    editeng::SvxBorderLine aTLBRBLine;
    aTLBRBLine.SetColor(0xFF11FF);
    //aBoxAF.m_aTLBR.SetLine( &aTLBRBLine );
    ...
    //::boost::optional<sal_uInt16> aNOffset = sal_uInt16( 3 );
    //aPDesc.SetNumOffset( aNOffset );
    ...
    //Set m_bHidden
    bool aHidden = true;
    aTableAF.m_bHidden = aHidden;
    //Set m_bUserDefined
    bool aUDefined = false;
    aTableAF.m_bUserDefined = aUDefined;
    //Set bInclFont
    bool aIFont = false;
    ...
    //Get m_bHidden
    //CPPUNIT_ASSERT( bool( pLoadAF->m_bHidden == aHidden ) );
    //Get m_bUserDefined
    CPPUNIT_ASSERT( bool( pLoadAF->m_bUserDefined == aUDefined ) );
    //Get bInclFont
