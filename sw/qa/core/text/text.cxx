...
CPPUNIT_TEST_FIXTURE(SwCoreTextTest, testChineseAutoFirstLineIndent)
{
    ...
    sal_Int32 nFirstLineWidth = getXPath(pXmlDoc,
        "//SwParaPortion/SwLineLayout[1]/SwLinePortion[1]", "width").toInt32();
    // Get the line width of the second line.
    sal_Int32 nSecondLineWidth = getXPath(pXmlDoc,
        "//SwParaPortion/SwLineLayout[2]/SwLinePortion[1]", "width").toInt32();
    ...
    sal_Int32 nSecondLineCharLength = getXPath(pXmlDoc,
        "//SwParaPortion/SwLineLayout[2]/SwLinePortion[1]", "length").toInt32();
    ...
    // indent.
    CPPUNIT_ASSERT_EQUAL(2, nFirstLineIndentChars);
}
