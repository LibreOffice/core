...
public:
    ...
    uno::Reference<text::XTextContent> getTextContent();
...
uno::Reference<text::XTextRange> SwXTextFrame::getTextRange() { return mxTextRange; }

uno::Reference<text::XTextContent> SwXTextFrame::getTextContent() { return mxTextContent; }
