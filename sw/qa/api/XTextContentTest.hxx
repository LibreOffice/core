...
public:
    ...
    void testAttach()
    {
        css::uno::Reference<css::text::XTextContent> xTextContent(init(), css::uno::UNO_QUERY_THROW);
        auto xTextCursor = getTextDocument()->getText()->createTextCursor();
        xTextCursor->gotoEnd(false);
        css::uno::Reference<css::lang::XMultiServiceFactory> xMSF(getTextDocument(), css::uno::UNO_QUERY_THROW);
        css::uno::Reference<css::text::XDocumentIndex> xDocumentIndex(xMSF->createInstance("com.sun.star.text.DocumentIndex"), css::uno::UNO_QUERY_THROW);
