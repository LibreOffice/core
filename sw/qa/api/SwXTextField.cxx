...
Reference<XInterface> SwXTextField::init()
{
    ...
    Reference<XPropertySet> xFieldMaster(xMSF->createInstance("com.sun.star.text.FieldMaster.Database"), UNO_QUERY_THROW);
    ...
    Reference<text::XDependentTextField> xField(xMSF->createInstance("com.sun.star.text.TextField.Database"), UNO_QUERY_THROW);
