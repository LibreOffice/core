...
void SwXTextTable::triggerDesktopTerminate()
{
    mxDesktop->terminate();
}
...
Reference<XInterface> SwXTextTable::init()
{
    ...
    Reference<text::XTextTable> xTable(xMSF->createInstance("com.sun.star.text.TextTable"), UNO_QUERY_THROW);
