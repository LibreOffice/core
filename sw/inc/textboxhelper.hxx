...
public:
    ...
    /// The following actions are implementend for groupshapes with textboxes too.
    ...
    /// - eActionType: The action what the function suppose to do.
    /// WARN: This function will run recursivelly! ALL textboxes of the group will be handled by
    /// the desired action!
    static void handleTextBoxGroup(SwFrameFormat* pGroupShapeFormat, SdrObject* pGroupObject,
