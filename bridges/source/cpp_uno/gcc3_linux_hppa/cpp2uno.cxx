...
sal_Int64 cpp_vtable_call( sal_uInt32 in0, sal_uInt32 in1, sal_uInt32 in2, sal_uInt32 in3, sal_uInt32 firstonstack )
{
    ...
    double dpreg[hppa::MAX_SSE_REGS]; 
...
#   define R11(v)  (((unsigned long)(v) & 0x7FF) << 1) 
        ...
        sal_Int32 vtableOffset, bool bHasHiddenParam)
    {
        ...
        *(unsigned long*)&p[0]  = 0xeaa00000; 
        *(unsigned long*)&p[4]  = 0xd6a01c1e; 
        *(unsigned long*)&p[8]  = 0x4aa10040; 

        *(unsigned long*)&p[12] = 0x22A00000 | L21(functionIndex); 
        *(unsigned long*)&p[16] = 0x36B50000 | R11(functionIndex); 

        *(unsigned long*)&p[20] = 0x22C00000 | L21(vtableOffset); 
        *(unsigned long*)&p[24] = 0x36D60000 | R11(vtableOffset); 

        *(unsigned long*)&p[28] = 0x0c201094; 
        *(unsigned long*)&p[32] = 0xea80c000; 
        *(unsigned long*)&p[36] = 0x0c281093; 
