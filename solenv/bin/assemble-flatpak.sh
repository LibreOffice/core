...
## icons/hicolor/*/apps/com.collabora.CollaboraOffice-*:
...
do
 ...
 cp -a "$i" \
  "$(dirname /app/share/icons/hicolor/"${i#"${PREFIXDIR?}"/share/icons/hicolor/}")"/com.collabora.CollaboraOffice."${i##*/apps/collaboraoffice-}"
done
