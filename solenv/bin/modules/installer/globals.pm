...
#   $Revision: 1.60 $
#
#   last change: $Author: vg $ $Date: 2006-11-01 13:48:27 $
#
...
BEGIN
{
    ...
    @noMSLocaleLangs = ( "br", "dz", "ga", "km", "nr", "ns", "rw", "ss", "st", "tg", "ts", "tn", "ve", "xh", "zu" , "ne" , "bn", "bn-BD", "bn-IN", "lo", "cy" , "ku" , "as-IN" , "te-IN" , "ml-IN" , "mr-IN", "ur-IN", "ta-IN", "or-IN" , "ti-ER"  );
