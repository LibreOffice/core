...
gb_SrsPartMergeTarget_TRANSEXCOMMAND := LD_LIBRARY_PATH=$(INSTDIR)/ure/lib $(call gb_Executable_get_command,transex3)
...
gb_ResTarget_RSCCOMMAND := SOLARBINDIR=$(OUTDIR_FOR_BUILD)/bin LD_LIBRARY_PATH=$(INSTDIR)/ure/lib $(call gb_Executable_get_command,rsc)
