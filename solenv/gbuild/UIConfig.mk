...
gb_UIConfig_LXML_PATH := PYTHONPATH=$(call gb_UnpackedTarball_get_dir,lxml)/install
...
ifeq ($(SYSTEM_PYTHON),)
gb_UIConfig_PYTHON := $(call gb_UnpackedTarball_get_dir,python3)/python
else
gb_UIConfig_PYTHON := $(PYTHON_FOR_BUILD)
endif

gb_UIConfig_gla11y_SCRIPT := $(SRCDIR)/bin/gla11y
gb_UIConfig_gla11y_COMMAND := $(gb_UIConfig_LXML_PATH) $(gb_UIConfig_PYTHON) $(gb_UIConfig_gla11y_SCRIPT)
...
$(call gb_UIConfig_get_a11yerrors_target,%) : $(gb_UIConfig_LXML_DEPS) $(gb_UIConfig_a11yerrors_SCRIPT)
