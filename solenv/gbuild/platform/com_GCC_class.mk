...
# $(call gb_PrecompiledHeader__command,pchfile,pchtarget,source,cxxflags,linktargetmakefilename,compiler)
define gb_PrecompiledHeader__command
$(call gb_Output_announce,$(2),$(true),PCH,1)
	$(call gb_Trace_StartRange,$(2),PCH)
$(call gb_Helper_abbreviate_dirs,\
	mkdir -p $(dir $(1)) $(dir $(call gb_PrecompiledHeader_get_dep_target,$(2),$(5))) && \
	cd $(BUILDDIR)/ && \
	CCACHE_DISABLE=1 $(gb_COMPILER_SETUP) \
	$(if $(6),$(6),$(gb_CXX)) \
		-x c++-header $(gb_PrecompiledHeader_emit_pch) \
		$(if $(6), $(call gb_CObject__filter_out_clang_cflags,$(4)),$(4)) \
		$(if $(WARNINGS_DISABLED),$(gb_CXXFLAGS_DISABLE_WARNINGS)) \
		$(gb_COMPILERDEPFLAGS) \
		$(if $(VISIBILITY),,$(gb_VISIBILITY_FLAGS)) \
		$(if $(EXTERNAL_CODE),$(gb_CXXFLAGS_Wundef),$(gb_DEFS_INTERNAL)) \
		...
		$(call gb_cxx_dep_generation_options,$(1),$(call gb_PrecompiledHeader_get_dep_target_tmp,$(2),$(5))) \
		-c $(patsubst %.cxx,%.hxx,$(3)) \
		-o$(1) \
		$(call gb_cxx_dep_copy,$(call gb_PrecompiledHeader_get_dep_target_tmp,$(2),$(5))) \
		)
