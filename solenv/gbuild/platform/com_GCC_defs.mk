...
# Combine functions which have the same code generated, strips
# out duplicate code generated by gcc's IPA-SRA optimisation pass
ifeq ($(USE_LD),gold)
gb_LinkTarget_LDFLAGS += -Wl,--icf=safe
endif
