...
#UPDMINOREXT=
#.ENDIF
SOLARRESDIR=$(SOLARVERSION)/gc$(INPATH)/res$(UPDMINOREXT)
SOLARRESXDIR=$(SOLARVERSION)/gc$(INPATH)/res$(UPDMINOREXT)
SOLARLIBDIR=$(SOLARVERSION)/gc$(INPATH)/lib$(UPDMINOREXT)
SOLARJAVADIR=$(SOLARVERSION)/gc$(INPATH)/java$(UPDMINOREXT)
SOLARINCDIR=$(SOLARVERSION)/gc$(INPATH)/inc$(UPDMINOREXT)
SOLARINCXDIR=$(SOLARVERSION)/gc$(INPATH)/inc$(UPDMINOREXT)
.IF "$(SOLARLANG)"!="deut"
.IF "$(SOLARLANG)" != ""
