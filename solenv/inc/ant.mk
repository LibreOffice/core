...
.IF "$(ANT_CLASSPATH)"==""
ANT_CLASSPATH:=$(SOLARBINDIR)$/xerces.jar$(PATH_SEPERATOR)$/$(SOLARBINDIR)$/jaxp.jar$(PATH_SEPERATOR)$/$(SOLARBINDIR)$/ant.jar$(PATH_SEPERATOR)$(ANT_OPTIONAL)$(PATH_SEPERATOR)$/$(SOLARBINDIR)$/junit.jar$(PATH_SEPERATOR)$(CLASSDIR)$/ant.jar
.IF "$(ANTPRJ_BOOTSTRAP)"==""
