...
struct StringViewHash
{
    ...
    size_t operator()(std::u16string_view s) const
    {
        return rtl_ustr_hashCode_WithLength(s.data(), s.size());
    }
};

OString GetOOXMLPresetGeometry( const OUString& rShapeType )
{
    typedef std::unordered_map<std::u16string_view, OString, StringViewHash> CustomShapeTypeTranslationHashMap;
...
{
    typedef std::unordered_map<std::string_view, MSO_SPT, StringViewHash> DMLToVMLTranslationHashMap;
