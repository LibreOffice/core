...
struct TIFFLZWCTreeNode
{
    ...
    TIFFLZWCTreeNode*       pBrother;       
    TIFFLZWCTreeNode*       pFirstChild;    
    sal_uInt16              nCode;          
    sal_uInt16              nValue;         
};
...
private:
    ...
    sal_uInt16              mnTagCount;                 
    sal_uInt32              mnCurrentTagCountPos;       
                                                        

    sal_uInt32              mnXResPos;                  
    sal_uInt32              mnYResPos;                  
    sal_uInt32              mnPalPos;                   
...
sal_Bool TIFFWriter::WriteTIFF( const Graphic& rGraphic, FilterConfigItem* pFilterConfigItem)
{
    ...
    m_rOStm.WriteUInt32( (sal_uInt32)0x4d4d002a );      
...
sal_Bool TIFFWriter::ImplWriteHeader( sal_Bool bMultiPage )
{
    ...
    if ( mnWidth && mnHeight && mnBitsPerPixel && mbStatus )
    {
        ...
        m_rOStm.WriteUInt16( (sal_uInt16)0 );               
        ...
        if ( mnBitsPerPixel != 1 )
            ImplWriteTag( PlanarConfiguration, 3, 1, 1 );   
        ImplWriteTag( ResolutionUnit, 3, 1, 2);             
...
void TIFFWriter::ImplWritePalette()
{
    ...
    m_rOStm.Seek( mnPalPos + 8 );           
    m_rOStm.WriteUInt32( static_cast<sal_uInt32>(nCurrentPos - mnStreamOfs) );  
    m_rOStm.Seek( nCurrentPos );
...
sal_Bool TIFFWriter::ImplWriteBody()
{
    ...
    m_rOStm.Seek( mnBitmapPos + 8 );        
    m_rOStm.WriteUInt32( static_cast<sal_uInt32>(nGfxBegin - mnStreamOfs) );        
    ...
    if ( mnStripByteCountPos && mbStatus )
    {
        ...
        m_rOStm.WriteUInt32( static_cast<sal_uInt32>( nGfxEnd - nGfxBegin ) );      
