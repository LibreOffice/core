...
$(call gb_ExternalProject_get_state_target,apache_commons_lang,build) :
	$(call gb_Helper_print_on_error,cd "$(call gb_UnpackedTarball_get_dir,apache_commons_lang)" && \
	...
	$(ICECREAM_RUN) "$(ANT)" \
		...
		jar && \
	touch $@,$(call gb_UnpackedTarball_get_dir,apache_commons_lang)/build.log)
