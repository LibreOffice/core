...
{
public:
    void testShouldCreateMemoryStream();
    void testShouldCreateStream();
    void testShouldWriteAndReadByte();

    CPPUNIT_TEST_SUITE(StoreTest);
    CPPUNIT_TEST(testShouldCreateMemoryStream);
    CPPUNIT_TEST(testShouldCreateStream);
    CPPUNIT_TEST(testShouldWriteAndReadByte);
    CPPUNIT_TEST_SUITE_END();
};

void StoreTest::testShouldCreateMemoryStream()
{
    store::OStoreFile aFile;
    CPPUNIT_ASSERT_EQUAL(store_E_None, aFile.createInMemory());
}

void StoreTest::testShouldCreateStream()
{
    store::OStoreFile aFile;
    CPPUNIT_ASSERT_EQUAL(store_E_None, aFile.createInMemory());
...
void StoreTest::testShouldWriteAndReadByte()
{
    store::OStoreFile aFile;
    CPPUNIT_ASSERT_EQUAL(store_E_None, aFile.createInMemory());
