...
struct IsciiDevanagariToUnicode
{
    ...
    size_t convert(char const* pSrcBuf, sal_Size nSrcBytes,
...
struct UnicodeToIsciiDevanagari
{
    ...
    size_t convert(sal_Unicode const* pSrcBuf, sal_Size nSrcChars,
...
size_t UnicodeToIsciiDevanagari::convert(sal_Unicode const* pSrcBuf, sal_Size nSrcChars,
    char* pDestBuf, size_t nDestBytes, sal_uInt32 nFlags,
    sal_uInt32 * pInfo, size_t* pSrcCvtChars)
{
