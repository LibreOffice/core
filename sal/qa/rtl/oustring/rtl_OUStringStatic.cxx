 ...
 */
#define DECL_STATIC_OUSTRING(name, value)                                                          \
...
#define DECL_CLASS_STATIC_OUSTRING(clazz, name, value)                                             \
    static const StaticHelper<SAL_N_ELEMENTS(value)> clazz##name##magic{                           \
        0x40000000, SAL_N_ELEMENTS(value) - 1, value                                               \
    };                                                                                             \
    OUString const clazz::name(                                                                    \
        const_cast<rtl_uString*>(reinterpret_cast<rtl_uString const*>(&(clazz##name##magic))),     \
        SAL_NO_ACQUIRE);
...
struct Test2
{
    static const OUString b;
};

DECL_CLASS_STATIC_OUSTRING(Test2, b, u"abc");
...
public:
    ...
    void test2()
    {
        // do some operations on the field to be sure it's real and working
        OUString c = Test2::b;
        CPPUNIT_ASSERT_EQUAL(c, Test2::b);
        CPPUNIT_ASSERT_EQUAL(OUString("abc"), Test2::b);
        CPPUNIT_ASSERT(Test2::b.startsWith("a"));
        CPPUNIT_ASSERT(Test2::b.endsWith("c"));
    }
