...
void sal_detail_logFormat(
    ...
    char const * format, ...)
{
    const sal_detail_LogAction eAction = sal_detail_log_report(level, area);
...
sal_detail_LogAction sal_detail_log_report(sal_detail_LogLevel level, char const * area)
{
    if (level == SAL_DETAIL_LOG_LEVEL_DEBUG) {
