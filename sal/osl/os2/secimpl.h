...
#define DIRECTORY_BUFFER_SIZE 260
#define DOMAIN_BUFFER_SIZE 260
...
typedef struct _oslSecurityImpl {
    HANDLE m_hToken;
    sal_Char   m_User[USER_BUFFER_SIZE];
    sal_Char   m_Domain[DOMAIN_BUFFER_SIZE];
    sal_Char   m_Directory[DIRECTORY_BUFFER_SIZE];
    sal_uInt16 nLogon;
} oslSecurityImpl;
