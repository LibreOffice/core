...
public:
    void testEnum()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(0, t->nDefaultEnumValue);
        CPPUNIT_ASSERT_EQUAL(0, t->nEnumValues);
        ...
        CPPUNIT_ASSERT_EQUAL(0, t->nDefaultEnumValue);
        CPPUNIT_ASSERT_EQUAL(3, t->nEnumValues);
        CPPUNIT_ASSERT(t->ppEnumNames != nullptr);
        ...
        CPPUNIT_ASSERT(t->pEnumValues != nullptr);
        CPPUNIT_ASSERT_EQUAL(0, t->pEnumValues[0]);
        CPPUNIT_ASSERT_EQUAL(1, t->pEnumValues[1]);
        CPPUNIT_ASSERT_EQUAL(2, t->pEnumValues[2]);
    ...
    void testStruct()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(3, t->aBase.nMembers);
    ...
    void testPolyStruct()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(2, t->aBase.nMembers);
        auto const offsets = t->aBase.pMemberOffsets;
        CPPUNIT_ASSERT(offsets != nullptr);
        auto const typerefs = t->aBase.ppTypeRefs;
        CPPUNIT_ASSERT(typerefs != nullptr);
    ...
    void testInterface()
    {
        ...
        CPPUNIT_ASSERT(css::uno::TypeDescription(&t->pBaseTypeDescription->aBase).equals(t0));
        CPPUNIT_ASSERT_EQUAL(2, t->nMembers);
        CPPUNIT_ASSERT(t->ppMembers != nullptr);
        CPPUNIT_ASSERT_EQUAL(5, t->nAllMembers);
        CPPUNIT_ASSERT(t->ppAllMembers != nullptr);
        CPPUNIT_ASSERT(t->pMapMemberIndexToFunctionIndex != nullptr);
        CPPUNIT_ASSERT_EQUAL(5, t->nMapFunctionIndexToMemberIndex);
        CPPUNIT_ASSERT(t->pMapFunctionIndexToMemberIndex != nullptr);
        CPPUNIT_ASSERT_EQUAL(1, t->nBaseTypes);
    ...
    void testMultiInterface()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(0, t->nMapFunctionIndexToMemberIndex);
        CPPUNIT_ASSERT(t->pMapFunctionIndexToMemberIndex == nullptr);
        CPPUNIT_ASSERT_EQUAL(2, t->nBaseTypes);
        auto const basetypes = t->ppBaseTypes;
        CPPUNIT_ASSERT(basetypes != nullptr);
        ...
        CPPUNIT_ASSERT_EQUAL(0, t->nMembers);
        CPPUNIT_ASSERT(t->ppMembers == nullptr);
        CPPUNIT_ASSERT_EQUAL(14, t->nAllMembers);
        CPPUNIT_ASSERT(t->ppAllMembers != nullptr);
        CPPUNIT_ASSERT(t->pMapMemberIndexToFunctionIndex != nullptr);
        CPPUNIT_ASSERT_EQUAL(14, t->nMapFunctionIndexToMemberIndex);
        CPPUNIT_ASSERT(t->pMapFunctionIndexToMemberIndex != nullptr);
        CPPUNIT_ASSERT_EQUAL(2, t->nBaseTypes);
        CPPUNIT_ASSERT(t->ppBaseTypes != nullptr);
