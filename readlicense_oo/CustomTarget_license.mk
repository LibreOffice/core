...
$(call gb_CustomTarget_get_target,readlicense_oo/license) : \
	$(readlicense_oo_DIR)/license.txt

$(readlicense_oo_DIR)/license.txt : $(SRCDIR)/readlicense_oo/txt/license.txt \
		| $(readlicense_oo_DIR)/.dir
	$(call gb_Output_announce,$(subst $(WORKDIR)/,,$@),$(true),LCS,1)
