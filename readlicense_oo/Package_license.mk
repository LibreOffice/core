...
ifneq ($(OS),MACOSX)
#$(eval $(call gb_Package_add_file,readlicense_oo_license,LICENSE.fodt,license.fodt))
$(eval $(call gb_Package_add_file,readlicense_oo_license,LICENSE.html,license.html))
else
#$(eval $(call gb_Package_add_file,readlicense_oo_license,Resources/LICENSE.fodt,license.fodt))
