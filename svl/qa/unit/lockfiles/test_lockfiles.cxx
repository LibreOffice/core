...
void LockfileTest::testLOLockFileURL()
{
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/"
                                  "data/.~lock.testLOLockFileURL.odt%23"),
                         aLockFile.GetURL());
}
...
void LockfileTest::testWordLockFileURL()
{
    ...
    // Eight character file name (cuts two characters)
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$345678.docx"),
            aLockFile.GetURL());
    }
    ...
    // Seven character file name (cuts one character)
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$234567.docx"),
            aLockFile.GetURL());
    }
    ...
    // Six character file name (cuts no character)
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$123456.docx"),
            aLockFile.GetURL());
    }
    ...
    // One character file name
    {
        ...
        svt::MSODocumentLockFile aLockFile(aTestFile);
        CPPUNIT_ASSERT_EQUAL(
            OUString("file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$1.docx"),
            aLockFile.GetURL());
    }
    ...
    // Test for ODT format
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$345678.odt"),
            aLockFile.GetURL());
    }
    ...
    // Test for DOC format
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$345678.doc"),
            aLockFile.GetURL());
    }
    ...
    // Test for RTF format
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$345678.rtf"),
            aLockFile.GetURL());
    }
}
...
void LockfileTest::testExcelLockFileURL()
{
    // Test the generated file name for Excel lock files
    {
        ...
        svt::MSODocumentLockFile aLockFile(aTestFile);
        CPPUNIT_ASSERT_EQUAL(OUString("file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/"
                                      "data/~$testExcelLockFileURL.xlsx"),
                             aLockFile.GetURL());
    }
    ...
    // Eight character file name
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$12345678.xlsx"),
            aLockFile.GetURL());
    }
    ...
    // One character file name
    {
        ...
        svt::MSODocumentLockFile aLockFile(aTestFile);
        CPPUNIT_ASSERT_EQUAL(
            OUString("file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$1.xlsx"),
            aLockFile.GetURL());
    }
    ...
    // Test for ODS format
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$12345678.ods"),
            aLockFile.GetURL());
    }
}
...
void LockfileTest::testPowerPointLockFileURL()
{
    // Test the generated file name for PowerPoint lock files
    {
        ...
        svt::MSODocumentLockFile aLockFile(aTestFile);
        CPPUNIT_ASSERT_EQUAL(OUString("file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/"
                                      "data/~$testPowerPointLockFileURL.pptx"),
                             aLockFile.GetURL());
    }
    ...
    // Eight character file name
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$12345678.pptx"),
            aLockFile.GetURL());
    }
    ...
    // One character file name
    {
        ...
        svt::MSODocumentLockFile aLockFile(aTestFile);
        CPPUNIT_ASSERT_EQUAL(
            OUString("file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$1.pptx"),
            aLockFile.GetURL());
    }
    ...
    // Test for PPT format
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$12345678.ppt"),
            aLockFile.GetURL());
    }
    ...
    // Test for ODP format
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            OUString(
                "file:///home/zolnai/libreoffice/core//svl/qa/unit/lockfiles/data/~$12345678.odp"),
            aLockFile.GetURL());
    }
}
...
void LockfileTest::testWordLockFileContent()
{
    ...
    CPPUNIT_ASSERT_EQUAL(MSO_WORD_LOCKFILE_SIZE, sLockFileContent.getLength());
}
...
void LockfileTest::testExcelLockFileContent()
{
    ...
    // We have a fixed size lock file
    CPPUNIT_ASSERT_EQUAL(MSO_EXCEL_AND_POWERPOINT_LOCKFILE_SIZE, sLockFileContent.getLength());
}
...
{
    OUString aTestODT
        = m_directories.getURLFromSrc("/svl/qa/unit/lockfiles/data/testMSOLockFileOverwrite.odt");
