...
static const sal_uInt16 nInitCount = 10; 
#if OSL_DEBUG_LEVEL > 1
static sal_uLong nRangesCopyCount = 0;   
#endif
...

{
    ...
    if ( reinterpret_cast< SfxPoolItem* >( -1 ) == pOld )   
        pOld = NULL;
    if ( !pOld )
    {
