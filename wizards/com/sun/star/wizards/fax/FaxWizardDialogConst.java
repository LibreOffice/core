...
public interface FaxWizardDialogConst {
  ...
  public final String IMAGECONTROL3_HID = "HID:" + (HID + 9);
  public final String CHKUSELOGO_HID = "HID:" + (HID + 10);
  public final String CHKUSEDATE_HID = "HID:" + (HID + 11);
  public final String CHKUSECOMMUNICATIONTYPE_HID = "HID:" + (HID + 12);
  public final String LSTCOMMUNICATIONTYPE_HID = "HID:" + (HID + 13);
  public final String CHKUSESUBJECT_HID = "HID:" + (HID + 14);
  public final String CHKUSESALUTATION_HID = "HID:" + (HID + 15);
  public final String LSTSALUTATION_HID = "HID:" + (HID + 16);
  public final String CHKUSEGREETING_HID = "HID:" + (HID + 17);
  public final String LSTGREETING_HID = "HID:" + (HID + 18);
  public final String CHKUSEFOOTER_HID = "HID:" + (HID + 19);
  public final String OPTSENDERPLACEHOLDER_HID = "HID:" + (HID + 21);
  public final String OPTSENDERDEFINE_HID = "HID:" + (HID + 22);
  public final String TXTSENDERNAME_HID = "HID:" + (HID + 23);
  public final String TXTSENDERSTREET_HID = "HID:" + (HID + 24);
  public final String TXTSENDERPOSTCODE_HID = "HID:" + (HID + 25);
  public final String TXTSENDERSTATE_HID = "HID:" + (HID + 26);
  public final String TXTSENDERCITY_HID = "HID:" + (HID + 27);
  public final String TXTSENDERFAX_HID = "HID:" + (HID + 28);
  public final String OPTRECEIVERPLACEHOLDER_HID = "HID:" + (HID + 29);
  public final String OPTRECEIVERDATABASE_HID = "HID:" + (HID + 30);
  public final String TXTFOOTER_HID = "HID:" + (HID + 39);
  public final String CHKFOOTERNEXTPAGES_HID = "HID:" + (HID + 40);
  public final String CHKFOOTERPAGENUMBERS_HID = "HID:" + (HID + 41);
  public final String TXTTEMPLATENAME_HID = "HID:" + (HID + 44);
  public final String FILETEMPLATEPATH_HID = "HID:" + (HID + 45);
  public final String OPTCREATEFAX_HID = "HID:" + (HID + 46);
  public final String OPTMAKECHANGES_HID = "HID:" + (HID + 47);
  public final String IMAGECONTROL2_HID = "HID:" + (HID + 51);
