...
// postMessage) for Calc. See the Writer spec for the rationale: the in-document markings
// are core-rendered and covered by C++ tests, and a real apply needs a provisioned SPIF
// policy, so this feeds the enriched .uno:SecurityLabel statechanged message that wsd
// broadcasts on apply/change/remove through the real client parser.

describe(['tagdesktop'], 'Calc security-label banner', function() {
	beforeEach(function() {
