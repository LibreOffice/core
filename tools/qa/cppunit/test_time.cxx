...
public:
    ...
    {
        {
            ...
            sal_Int32 nExpectedMillisecond = 999 + 59000 + 3540000 + 8280000;
...

        {
            ...
            sal_uInt16 nExpectedSecond = 59;
            CPPUNIT_ASSERT_EQUAL(nExpectedSecond, aTime.GetSec());
            sal_Int32 nExpectedMillisecond = 59000 + 3540000 + 8280000;
            CPPUNIT_ASSERT_EQUAL(nExpectedMillisecond, aTime.GetMSFromTime());
...

        {
            ...
            CPPUNIT_ASSERT_EQUAL(nExpectedSecond, aTime.GetSec());
            sal_Int32 nExpectedMillisecond = 3540000 + 8280000;
            CPPUNIT_ASSERT_EQUAL(nExpectedMillisecond, aTime.GetMSFromTime());
            sal_uInt32 nExpectedNanoSecond = 0;
            CPPUNIT_ASSERT_EQUAL(nExpectedNanoSecond, aTime.GetNanoSec());
        }
    ...
    {
        Time aExpectedTime(3, 17, 59, 999000000);
        sal_Int32 nExpectedMilliseconds = 11879999;
