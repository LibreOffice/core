...
{
    {
        ...
        CPPUNIT_ASSERT_EQUAL(tools::Long(0), aRect.getHalfOpenWidth());
        CPPUNIT_ASSERT_EQUAL(tools::Long(0), aRect.getHalfOpenHeight());
    }

    {
        ...
        // getHalfOpenWidth and getHalfOpenHeight return the size that excludes one of the bounds,
