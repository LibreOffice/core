...
void CpuInstructionSetSupport::testCpuInstructionSetSupport()
{
    ...
    CPPUNIT_ASSERT_EQUAL(cpuid::hasSSE2(),  cpuid::isCpuInstructionSetSupported(cpuid::InstructionSetFlags::SSE2));
    #endif

    #ifdef LO_SSSE3_AVAILABLE
    CPPUNIT_ASSERT_EQUAL(cpuid::hasSSSE3(), cpuid::isCpuInstructionSetSupported(cpuid::InstructionSetFlags::SSE2));
    #endif

    #ifdef LO_AVX2_AVAILABLE
    CPPUNIT_ASSERT_EQUAL(cpuid::hasAVX2(), cpuid::isCpuInstructionSetSupported(cpuid::InstructionSetFlags::AVX2));
    #endif
}
