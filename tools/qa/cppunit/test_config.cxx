...
public:
    ...
    {
        OUString aConfigFileBackup(maConfigFile + ".bak");
        osl::File::copy(maConfigFile, aConfigFileBackup);
        ...
        osl::File::copy(aConfigFileBackup, maConfigFile);
        ...
        osl::File::move(aConfigFileBackup, maConfigFile);
    }
    ...
    {
        OUString aConfigFileBackup(maConfigFile + OUString(".bak"));
        osl::File::copy(maConfigFile, aConfigFileBackup);
