...
public:
    ...
    virtual void setUp() override
    {
        ...
        maConfigFileBackup = maConfigFile + ".bak";

        osl::File::copy(maConfigFile, maConfigFileBackup);
    }

    virtual void tearDown() override { osl::File::move(maConfigFileBackup, maConfigFile); }
    ...
    void testDeleteGroup()
    {
        ...
        osl::File::copy(maConfigFileBackup, maConfigFile);
        ...
        osl::File::move(maConfigFileBackup, maConfigFile);
    }
