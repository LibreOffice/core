...
void Test::testVariables()
{
    ...
    CPPUNIT_ASSERT_EQUAL(int(0x004488AA), int(aColor.mnColor));

    aColor.mnColor = 0xAABBCCDD;
    ...
    aColor.A = 0x11;
    CPPUNIT_ASSERT_EQUAL(int(0x11BBCCDD), int(aColor.mnColor));

    aColor.R = 0x22;
    CPPUNIT_ASSERT_EQUAL(int(0x1122CCDD), int(aColor.mnColor));

    aColor.G = 0x33;
    CPPUNIT_ASSERT_EQUAL(int(0x112233DD), int(aColor.mnColor));

    aColor.B = 0x44;
    CPPUNIT_ASSERT_EQUAL(int(0x11223344), int(aColor.mnColor));

    aColor.SetTransparency(0x77);
    CPPUNIT_ASSERT_EQUAL(int(0x77223344), int(aColor.mnColor));

    aColor.SetRed(0x88);
    CPPUNIT_ASSERT_EQUAL(int(0x77883344), int(aColor.mnColor));

    aColor.SetGreen(0x99);
    CPPUNIT_ASSERT_EQUAL(int(0x77889944), int(aColor.mnColor));

    aColor.SetBlue(0xAA);
    CPPUNIT_ASSERT_EQUAL(int(0x778899AA), int(aColor.mnColor));

    aColor = Color::RGBA(0x11, 0x22, 0x33, 0x44);
    CPPUNIT_ASSERT_EQUAL(int(0x44112233), int(aColor.mnColor));
}
...
{
    CPPUNIT_ASSERT_EQUAL(sal_uInt8(0), Color::RGB(0xAA, 0xBB, 0xCC).GetColorError(Color::RGB(0xAA, 0xBB, 0xCC)));

    CPPUNIT_ASSERT_EQUAL(sal_uInt8(0), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA1, 0xB0, 0xC0)));
    CPPUNIT_ASSERT_EQUAL(sal_uInt8(0), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA0, 0xB1, 0xC0)));
    CPPUNIT_ASSERT_EQUAL(sal_uInt8(0), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA0, 0xB0, 0xC1)));

    CPPUNIT_ASSERT_EQUAL(sal_uInt8(1), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA1, 0xB1, 0xC0)));
    CPPUNIT_ASSERT_EQUAL(sal_uInt8(1), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA0, 0xB1, 0xC1)));
    CPPUNIT_ASSERT_EQUAL(sal_uInt8(1), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA1, 0xB0, 0xC1)));

    CPPUNIT_ASSERT_EQUAL(sal_uInt8(1), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA1, 0xB1, 0xC1)));
    CPPUNIT_ASSERT_EQUAL(sal_uInt8(1), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA1, 0xB1, 0xC1)));
    CPPUNIT_ASSERT_EQUAL(sal_uInt8(1), Color::RGB(0xA0, 0xB0, 0xC0).GetColorError(Color::RGB(0xA1, 0xB1, 0xC1)));
}
...
{
    Color aColor = Color::RGB(0xFF, 0x00, 0x88);
    aColor.Invert();
    CPPUNIT_ASSERT_EQUAL(Color::RGB(0x00, 0xFF, 0x77).AsRGBHexString(), aColor.AsRGBHexString());

    // Alpha should be unaffected
    aColor = Color::RGBA(0xFF, 0x00, 0x88, 0x22);
    aColor.Invert();
    CPPUNIT_ASSERT_EQUAL(Color::RGBA(0x00, 0xFF, 0x77, 0x22).AsRGBHexString(), aColor.AsRGBHexString());
}
...
void Test::testBColor()
{
    ...
    CPPUNIT_ASSERT_EQUAL(Color::RGB(0x00, 0x00, 0x00).AsRGBHexString(), aColor.AsRGBHexString());
    ...
    CPPUNIT_ASSERT_EQUAL(Color::RGB(0xFF, 0xFF, 0xFF).AsRGBHexString(), aColor.AsRGBHexString());
    ...
    CPPUNIT_ASSERT_EQUAL(Color::RGB(0x80, 0x40, 0x20).AsRGBHexString(), aColor.AsRGBHexString());
