...
void HsqlBinaryImportTest::testBinaryImport()
{
    ...
    // TODO
    CPPUNIT_ASSERT_EQUAL(sal_uInt16{ 16 }, date.Day);
    CPPUNIT_ASSERT_EQUAL(sal_uInt16{ 1 }, date.Month);
    CPPUNIT_ASSERT_EQUAL(sal_Int16{ 2 }, date.Year);
    ...
    CPPUNIT_ASSERT_EQUAL(sal_uInt16{ 16 }, date.Day);
    CPPUNIT_ASSERT_EQUAL(sal_uInt16{ 1 }, date.Month);
    CPPUNIT_ASSERT_EQUAL(sal_Int16{ 54 }, date.Year);
}
