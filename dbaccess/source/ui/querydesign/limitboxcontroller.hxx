...
class LimitBox: public ComboBox
{
    ...
    private:
        ...
        const NativeNumberWrapper m_aNatNumWrapper;
        const ::com::sun::star::lang::Locale m_aLocale;
        const bool m_bUseNativeNumbers;


        void LoadDefaultLimits();

        OUString AsciiToNatNum(const OUString& rAsciiNum) const;
        OUString NatNumToAscii(const OUString& NatNum) const;
        bool CheckAndConvertData(OUString& io_rData) const;
};
