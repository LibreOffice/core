    ...
    for (size_t i = 0; i < rPrimitive2DSequence.size(); i++)
    {
        ...
        switch (nId)
        {
            ...
            case PRIMITIVE2D_ID_POLYGONSTROKEARROWPRIMITIVE2D:
            {
                ...
                rWriter.startElement("polygon");
                rWriter.content(
                    basegfx::utils::exportToSvgPoints(rPolygonStrokeArrowPrimitive2D.getB2DPolygon()));
                rWriter.endElement();
                ...
                if (rPolygonStrokeArrowPrimitive2D.getStart().getB2DPolyPolygon().count())
                {
                    ...
                    rWriter.attribute("centered", rPolygonStrokeArrowPrimitive2D.getStart().isCentered());
                    writePolyPolygon(rWriter, rPolygonStrokeArrowPrimitive2D.getStart().getB2DPolyPolygon());
                    rWriter.endElement();
                }
                ...
                if (rPolygonStrokeArrowPrimitive2D.getEnd().getB2DPolyPolygon().count())
                {
                    ...
                    rWriter.attribute("centered", rPolygonStrokeArrowPrimitive2D.getEnd().isCentered());
                    writePolyPolygon(rWriter, rPolygonStrokeArrowPrimitive2D.getEnd().getB2DPolyPolygon());
                    rWriter.endElement();
                }
