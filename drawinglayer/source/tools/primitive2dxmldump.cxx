    ...
    for (size_t i = 0; i < rPrimitive2DSequence.size(); i++)
    {
        ...
        switch (nId)
        {
            ...
            case PRIMITIVE2D_ID_SVGLINEARGRADIENTPRIMITIVE2D:
            {
                ...
                rWriter.attribute("spreadmethod", rSvgLinearGradientPrimitive2D.getSpreadMethod());
                rWriter.attribute("opacity", rSvgLinearGradientPrimitive2D.getGradientEntries().front().getOpacity());
                ...
                rWriter.startElement("polygon");
                rWriter.content(basegfx::utils::exportToSvgPoints(rSvgLinearGradientPrimitive2D.getPolyPolygon().getB2DPolygon()));
                rWriter.endElement();
