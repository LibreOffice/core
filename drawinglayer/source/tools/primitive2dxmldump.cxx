                           ...
                           const drawinglayer::attribute::SdrFillAttribute& rFillAttribute)
{
    ...
    if (!rHatch.isDefault())
    {
        ...
        rWriter.attribute("isFillBackground", rHatch.isFillBackground());
        rWriter.endElement();
    }
            ...
            switch (nId)
            {
                case PRIMITIVE3D_ID_SDREXTRUDEPRIMITIVE3D:
                {
                    ...
                    rWriter.startElement("object3Dattributes");
                    {
                        ...
                        rWriter.attribute("normalsInvert", r3DObjectAttributes.getNormalsInvert());
                        rWriter.attribute("doubleSided", r3DObjectAttributes.getDoubleSided());
                        rWriter.attribute("shadow3D", r3DObjectAttributes.getShadow3D());
                        rWriter.attribute("textureFilter", r3DObjectAttributes.getTextureFilter());
                        rWriter.attribute("reducedGeometry",
                                          r3DObjectAttributes.getReducedLineGeometry());
                    }
                    rWriter.endElement();
                    ...
                    rWriter.attribute("smoothNormals", pExtrudePrimitive3D->getSmoothNormals());
                    rWriter.attribute("smoothLids", pExtrudePrimitive3D->getSmoothLids());
                    rWriter.attribute("characterMode", pExtrudePrimitive3D->getCharacterMode());
                    rWriter.attribute("closeFront", pExtrudePrimitive3D->getCloseFront());
                    rWriter.attribute("closeBack", pExtrudePrimitive3D->getCloseBack());
    ...
    for (size_t i = 0; i < rPrimitive2DSequence.size(); i++)
    {
        ...
        switch (nId)
        {
            ...
            case PRIMITIVE2D_ID_SCENEPRIMITIVE2D:
            {
                ...
                rWriter.attribute("isTwoSidedLighting", rSceneAttribute.getTwoSidedLighting());
                ...
                for (auto const& rLight : rLightingAttribute.getLightVector())
                {
                    ...
                    rWriter.attribute("specular", rLight.getSpecular());
                    rWriter.endElement();
                }
                rWriter.endElement();
