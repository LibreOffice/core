...
These are the current minimal operation system and compiler versions to
compile LibreOffice:

* Cygwin + Visual Studio 2015 Update 3 + Windows SDK 8.1A (WinXP)
* MacOS 10.6
* Redhat 6 / CentOS 6 + gcc 4.8 or clang
