    ...
    >
{
    ...
    o3tl::lru_map< OUString, ProofreadingResult > mCachedResults;
    ...
    void parseHttpJSONResponse(ProofreadingResult& rResult, std::string_view aJSONBody);
    const std::string makeHttpRequest(const OUString& aText, long& nStatusCode);
