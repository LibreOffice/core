...
SVXCORE_DLLPUBLIC void storeLabelPart(const cpo::uno::Reference<css::frame::XModel>& xModel,
...
SVXCORE_DLLPUBLIC void removeLabelPart(const cpo::uno::Reference<css::frame::XModel>& xModel);
...
SVXCORE_DLLPUBLIC bool readLabel(const cpo::uno::Reference<css::frame::XModel>& xModel,
                                 StanagLabel& rLabel);
...
SVXCORE_DLLPUBLIC OUString readMarking(const cpo::uno::Reference<css::frame::XModel>& xModel);
...
SVXCORE_DLLPUBLIC bool modelSupportsLabel(const cpo::uno::Reference<css::frame::XModel>& xModel);
