...
void SdSecurityLabelTarget::notify(const OUString& rMarking)
{
    if (!comphelper::COKit::isActive())
        return;

    // Same shape as SdXImpressDocument::getCommandValues(".uno:SecurityLabel"): the
    // browser banner reads state.marking (empty => hide the banner).
