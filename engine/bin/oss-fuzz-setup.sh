...
curl --no-progress-meter -S \
    -C - -O https://gerrit.collaboraoffice.com/src/$FONT_LIBERATION_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/extern/$OPENSYMBOL_TTF \
    -C - -O https://gerrit.collaboraoffice.com/src/$RASQAL_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$CLUCENE_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$HYPHEN_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$RAPTOR_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$MYTHES_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$REDLAND_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$BOOST_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$EXPAT_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$FAST_FLOAT_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBJPEG_TURBO_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LCMS2_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBEXTTEXTCAT_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$CPPUNIT_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$CAIRO_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$CURL_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$XMLSEC_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBLANGTAG_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ABW_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$CDR_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBCMIS_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$EBOOK_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ETONYEK_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$FREEHAND_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$MD4C_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$MSPUB_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$MWAW_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ODFGEN_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ORCUS_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$PAGEMAKER_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBPNG_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$REVENGE_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$STAROFFICE_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$VISIO_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$WPD_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$WPG_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$WPS_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ZMF_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$PIXMAN_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ZLIB_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ZSTD_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$MDDS_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$OPENSSL_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LANGTAGREG_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$GRAPHITE_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$HARFBUZZ_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$GLM_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ICU_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$ICU_DATA_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBXML_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBXSLT_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$HUNSPELL_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$FREETYPE_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$FONTCONFIG_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$EPUBGEN_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBNUMBERTEXT_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$QXP_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBWEBP_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$LIBTIFF_TARBALL \
    -C - -O https://gerrit.collaboraoffice.com/src/$DRAGONBOX_TARBALL
