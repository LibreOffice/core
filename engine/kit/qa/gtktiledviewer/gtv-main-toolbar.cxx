...
static void populatePartSelector(GtvMainToolbar* toolbar)
{
    ...
    int nParts = kit_doc_view_get_parts(KIT_DOC_VIEW(window->kitdocview));
    ...
    gtk_combo_box_set_active(GTK_COMBO_BOX(priv->m_pPartSelector), kit_doc_view_get_part(KIT_DOC_VIEW(window->kitdocview)));
...
gtv_main_toolbar_doc_loaded(GtvMainToolbar* toolbar, COKitDocumentType eDocType, bool bEditMode)
{
    ...
    else if (eDocType == COKitDocumentType::PRESENTATION)
    {
