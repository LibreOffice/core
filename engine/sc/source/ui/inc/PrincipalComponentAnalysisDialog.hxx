...
private:
    ...
    static cpo::uno::Reference<css::chart2::XTitle> MakeChartTitle(const OUString& rText);

    /** Paints the wall of rDiagram white. */
    static void WhitenChartWall(const cpo::uno::Reference<css::chart2::XDiagram>& rDiagram);
