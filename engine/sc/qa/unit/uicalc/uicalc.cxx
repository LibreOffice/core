...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf154174_repeat_empty)
{
    ...
    ScModelObj* pModelObj = comphelper::getFromUnoTunnel<ScModelObj>(mxComponent);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_MOD1 | KEY_SHIFT | awt::Key::Y);
    pModelObj->postKeyEvent(COKitKeyEventType::UP, 0, KEY_MOD1 | KEY_SHIFT | awt::Key::Y);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf132026)
{
    ...
    for (auto aChar = aChars.begin(); aChar != aChars.end(); ++aChar)
    {
        for (size_t i = 0; i < aDirections.size(); ++i)
        {
            ...
            pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, nDir);
            pModelObj->postKeyEvent(COKitKeyEventType::UP, 0, nDir);
            Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf146795)
{
    ...
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_SHIFT | KEY_DOWN);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_SHIFT | KEY_DOWN);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_SHIFT | KEY_DOWN);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf156462)
{
    ...
    ScModelObj* pModelObj = comphelper::getFromUnoTunnel<ScModelObj>(mxComponent);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_MOD1 | KEY_LEFT);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf132057)
{
    ...
    ScModelObj* pModelObj = comphelper::getFromUnoTunnel<ScModelObj>(mxComponent);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_RETURN);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf122232)
{
    ...
    ScModelObj* pModelObj = comphelper::getFromUnoTunnel<ScModelObj>(mxComponent);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_TAB);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_TAB);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf123052)
{
    ...
    {
        pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_SHIFT | awt::Key::TAB);
        pModelObj->postKeyEvent(COKitKeyEventType::UP, 0, KEY_SHIFT | awt::Key::TAB);
        Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf102525)
{
    ...
    ScModelObj* pModelObj = comphelper::getFromUnoTunnel<ScModelObj>(mxComponent);
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_F4);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testKeyboardMergeRef)
{
    ...
    pModelObj->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_UP | KEY_SHIFT);
    pModelObj->postKeyEvent(COKitKeyEventType::UP, 0, KEY_UP | KEY_SHIFT);
    Scheduler::ProcessEventsToIdle();
    CPPUNIT_ASSERT(pViewShell->IsRefInputMode());
    {
        const OUString* pInput = pViewShell->GetEditString();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testMouseMergeRef)
{
    ...
    pModelObj->postMouseEvent(COKitMouseEventType::BUTTONDOWN, aA1.X() + 5, aA1.Y() + 5, 1,
                              MOUSE_LEFT, 0);
    pModelObj->postMouseEvent(COKitMouseEventType::MOVE, aA6.X() + 5, aA6.Y() + 5, 1, MOUSE_LEFT,
                              0);
    pModelObj->postMouseEvent(COKitMouseEventType::BUTTONUP, aA7.X() + 5, aA7.Y() + 5, 1,
                              MOUSE_LEFT, 0);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testFillHandleDnD)
{
    ...
    ScModelObj* pModelObj = comphelper::getFromUnoTunnel<ScModelObj>(mxComponent);
    pModelObj->postMouseEvent(COKitMouseEventType::BUTTONDOWN, aB2.X() - 1, aB2.Y() - 1, 1,
                              MOUSE_LEFT, 0);
    pModelObj->postMouseEvent(COKitMouseEventType::MOVE, aA7.X(), aA7.Y(), 1, MOUSE_LEFT, 0);
    pModelObj->postMouseEvent(COKitMouseEventType::BUTTONUP, aA7.X(), aA7.Y(), 1, MOUSE_LEFT, 0);
    Scheduler::ProcessEventsToIdle();
