...
$(IOSGEN)/native-code.h: $(BUILDDIR)/config_host.mk \
	...
	if test -d $(INSTDIR)/share/dictionaries/dict-de; then \
		cp $(INSTDIR)/share/dictionaries/dict-de/de_CH_frami.aff $(IOSRES)/share/spell/de_CH.aff; \
		cp $(INSTDIR)/share/dictionaries/dict-de/de_CH_frami.dic $(IOSRES)/share/spell/de_CH.dic; \
		cp $(INSTDIR)/share/dictionaries/dict-de/de_CH_frami.aff $(IOSRES)/share/spell/de_LI.aff; \
		cp $(INSTDIR)/share/dictionaries/dict-de/de_CH_frami.dic $(IOSRES)/share/spell/de_LI.dic; \
		cp $(INSTDIR)/share/dictionaries/*/th_*_v2.* $(IOSRES)/share/thes; \
		cp $(INSTDIR)/share/dictionaries/dict-en/th_en_US_v2.dat $(IOSRES)/share/thes/th_en_GB_v2.dat; \
		cp $(INSTDIR)/share/dictionaries/dict-en/th_en_US_v2.idx $(IOSRES)/share/thes/th_en_GB_v2.idx; \
	fi
