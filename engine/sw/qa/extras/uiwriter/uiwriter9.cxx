...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest9, testTdf159049)
{
    ...
    pTextDoc->postKeyEvent(COKitKeyEventType::UP, 0, KEY_ESCAPE);
    Scheduler::ProcessEventsToIdle();
    // ... and deselect shape.
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_ESCAPE);
    pTextDoc->postKeyEvent(COKitKeyEventType::UP, 0, KEY_ESCAPE);
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest9, testTdf163949)
{
    ...
    for (const OUString& rFrameText : texts)
    {
        ...
        xFrame.queryThrow<beans::XPropertySet>()->setPropertyValue(
            u"AnchorType"_ustr, cpo::uno::Any(text::TextContentAnchorType_AT_PARAGRAPH));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest9, testTdf151710)
{
    ...
    dispatchCommand(mxComponent, u".uno:SelectAll"_ustr, {});
    SwXTextDocument* pTextDoc = getSwTextDoc();
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, '(', 0);
    Scheduler::ProcessEventsToIdle();
    CPPUNIT_ASSERT_EQUAL(u"(abcd)"_ustr, xTextDocument->getText()->getString());
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest9, testTdf158375_dde_disable)
{
    ...
    cpo::uno::Sequence<OUString> aNames{ u"DDECommandFile"_ustr, u"DDECommandType"_ustr,
                                         u"DDECommandElement"_ustr, u"IsAutomaticUpdate"_ustr,
                                         u"IsProtected"_ustr };
    cpo::uno::Sequence<cpo::uno::Any> aValues{ cpo::uno::Any(u"soffice"_ustr),
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest9, testTdf164949)
{
    ...
    cpo::uno::Sequence aArgs{ comphelper::makePropertyValue(u"PersistentCopy"_ustr,
                                                            cpo::uno::Any(false)) };
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest9, testAutocorrectSingleQuoteUndo)
{
    ...
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 'e', 0);
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, '\'', 0);
    Scheduler::ProcessEventsToIdle();
    ...
    // quote in between.
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, '\'', 0);
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 'u', 0);
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 'n', 0);
    Scheduler::ProcessEventsToIdle();
