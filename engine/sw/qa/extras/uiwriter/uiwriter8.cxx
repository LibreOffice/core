...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf135014)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aArgs2(comphelper::InitPropertySequence(
        { { u"Param"_ustr, cpo::uno::Any(u"NewNumberingStyle"_ustr) },
          { u"Family"_ustr, cpo::uno::Any(static_cast<sal_Int16>(SfxStyleFamily::Pseudo)) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf145584)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aFilterData(
        comphelper::InitPropertySequence({ { u"Selection"_ustr, cpo::uno::Any(true) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf131728)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aFilterData(comphelper::InitPropertySequence(
        { { u"ExportBookmarksToPDFDestination"_ustr, cpo::uno::Any(true) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf152575)
{
    ...
    // Save as PDF.
    cpo::uno::Sequence<beans::PropertyValue> aFilterData(
        comphelper::InitPropertySequence({ { u"ExportNotesInMargin"_ustr, cpo::uno::Any(true) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf140731)
{
    ...
    SwXTextDocument* pTextDoc = getSwTextDoc();
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_F3);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf116315)
{
    ...
    {
        pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_SHIFT | KEY_F3);
        Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf161741)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aPropertyValues(comphelper::InitPropertySequence({
        { u"Undo"_ustr, cpo::uno::Any(sal_Int32(4)) },
    }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf121031)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aArgs(
        comphelper::InitPropertySequence({ { u"Rows"_ustr, cpo::uno::Any(sal_Int32(3)) },
                                           { u"Columns"_ustr, cpo::uno::Any(sal_Int32(3)) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf146356)
{
    ...
    SwXTextDocument* pTextDoc = getSwTextDoc();
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_MOD2 | awt::Key::RETURN);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf139566)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aArgs(
        comphelper::InitPropertySequence({ { u"Rows"_ustr, cpo::uno::Any(sal_Int32(1)) },
                                           { u"Columns"_ustr, cpo::uno::Any(sal_Int32(1)) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf117601)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aArgs(
        comphelper::InitPropertySequence({ { u"Rows"_ustr, cpo::uno::Any(sal_Int32(5)) },
                                           { u"Columns"_ustr, cpo::uno::Any(sal_Int32(3)) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf133477)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aDescriptor(
        comphelper::InitPropertySequence({ { u"OutputStream"_ustr, cpo::uno::Any(xOutputStream) },
                                           { u"FilterName"_ustr, cpo::uno::Any(u"BMP"_ustr) } }));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf137964)
{
    ...
    SwXTextDocument* pTextDoc = getSwTextDoc();
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_SHIFT | KEY_UP);
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_SHIFT | KEY_LEFT);
    Scheduler::ProcessEventsToIdle();
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf128106)
{
    ...
    const auto aPropertyValues = comphelper::InitPropertySequence(
        { { u"FileName"_ustr, cpo::uno::Any(maTempFile.GetURL()) } });
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf97899)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aNumbering;
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf62032ApplyStyle)
{
    ...
    cpo::uno::Sequence<beans::PropertyValue> aPropertyValues = comphelper::InitPropertySequence({
        { u"Style"_ustr, cpo::uno::Any(u"A 2"_ustr) },
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testTdf156560)
{
    ...
    SwXTextDocument* pTextDoc = getSwTextDoc();
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_MOD1 | KEY_PAGEUP);
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest8, testCopyPasteParaFormatting)
{
...

    {
        ...
        aPaM.GetPointNode().GetTextNode()->SetAttr(
            SvxAdjustItem(SvxAdjust::Block, RES_PARATR_ADJUST));
        ...
        aPaM.GetPointNode().GetTextNode()->SetAttr(
            SvxAdjustItem(SvxAdjust::Left, RES_PARATR_ADJUST));
    }
    ...
    // Walk forward from start of body to find the three paragraphs
    SwNodeIndex aNodeIdx(pDoc->GetNodes().GetEndOfExtras());
    SwContentNode* pSttNode = SwNodes::GoNext(&aNodeIdx);
    ++aNodeIdx;
    SwContentNode* pEndNode = aNodeIdx.GetNode().GetContentNode();
    ++aNodeIdx;
    SwContentNode* pDestNode = aNodeIdx.GetNode().GetContentNode();
    CPPUNIT_ASSERT_EQUAL(u"Hello"_ustr, pSttNode->GetTextNode()->GetText());
    CPPUNIT_ASSERT_EQUAL(u"World"_ustr, pEndNode->GetTextNode()->GetText());

    {
        SwPaM aCopyPaM(*pSttNode, 0, *pEndNode, pEndNode->GetTextNode()->GetText().getLength());
        SwPosition aDestPos(*pDestNode, 0);
    ...
    // Undo and verify we're back to the original state
    SwWrtShell* pWrtShell = getSwDocShell()->GetWrtShell();
    pWrtShell->Undo();
    CPPUNIT_ASSERT_EQUAL(3, getParagraphs());
    CPPUNIT_ASSERT_EQUAL(u"\n"_ustr, getParagraph(3)->getString());
    ...
    // Redo and verify formatting is restored
    pWrtShell->Redo();
    xLastPara = getParagraph(getParagraphs());
    CPPUNIT_ASSERT_EQUAL(u"World\n"_ustr, xLastPara->getString());
    CPPUNIT_ASSERT_EQUAL(
        style::ParagraphAdjust_RIGHT,
        static_cast<style::ParagraphAdjust>(getProperty<sal_Int16>(xLastPara, u"ParaAdjust"_ustr)));
