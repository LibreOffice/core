...
void lcl_AddPropertiesToVector(std::vector<Property>& rOutProperties)
{
    rOutProperties.emplace_back(
        u"Dimension"_ustr, PROP_CLUSTEREDCOLUMN_TEMPLATE_DIMENSION, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
    rOutProperties.emplace_back(u"Geometry3D"_ustr, PROP_CLUSTEREDCOLUMN_TEMPLATE_GEOMETRY3D,
                                cppu::UnoType<sal_Int32>::get(),
                                beans::PropertyAttribute::BOUND
                                    | beans::PropertyAttribute::MAYBEDEFAULT);
    rOutProperties.emplace_back(
        u"GapwidthSequence"_ustr, PROP_CLUSTEREDCOLUMN_TEMPLATE_GAPWIDTH_SEQUENCE,
...
void ClusteredColumnChartTypeTemplate::GetDefaultValue(sal_Int32 nHandle, cpo::uno::Any& rAny) const
{
