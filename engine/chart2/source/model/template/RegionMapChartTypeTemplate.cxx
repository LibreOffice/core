...
void lcl_AddPropertiesToVector(std::vector<Property>& rOutProperties)
{
    rOutProperties.emplace_back(
        u"Dimension"_ustr, PROP_REGIONMAP_TEMPLATE_DIMENSION, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
    rOutProperties.emplace_back(
        u"Geometry3D"_ustr, PROP_REGIONMAP_TEMPLATE_GEOMETRY3D, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
}
...
void RegionMapChartTypeTemplate::GetDefaultValue(sal_Int32 nHandle, cpo::uno::Any& rAny) const
{
