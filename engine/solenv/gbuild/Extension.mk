...
$(call gb_Extension_get_target,%) : \
	...
	$(call gb_Helper_abbreviate_dirs,\
		...
		cat $$RESPONSEFILE | $(call gb_Helper_wsl_path,$(WSL) $(gb_Extension_ZIPCOMMAND) -rX -b . --filesync --must-match \
...
$(call gb_Extension_get_rootdir,$(1))/help/$(2).done : \
	...
	$$(call gb_Helper_abbreviate_dirs, \
        ...
        (cd $(gb_Extension_workdir)/$(1)/help/$(2) && \
            $$(call gb_Helper_wsl_path,$(WSL) $$(gb_Extension_ZIPCOMMAND) -r -b . $$(basename $$@)/help.jar \
            $$(HELPFILES))) && \
