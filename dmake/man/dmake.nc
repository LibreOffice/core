...
SYNOPSIS
       ...
       [macro[[!][*][+][:]]=value  ...]   [-v{cdfimrtw}]  [-ABcdeEghiknpqrsSt-
       TuVxX] [target ...]
...
OPTIONS
       -A     Enable AUGMAKE special inference rule transformations  (see  the
              "PERCENT(%) RULES" section), these are set to off by default.
...
DMAKE(1)                                                              DMAKE(1)
       ...
       -v[cdfimrtw]
              ...
              to be given (ie. -v is equivalent to -vdfimt).  The meanings  of
...
DMAKE(1)                                                              DMAKE(1)
       ...
       TMD             Stands  for  "To  Make  Dir",  and is the path from the
                       ...
                       that  dmake  was  started  up in (value of $(MAKEDIR)).
                       This macro is modified when .SETDIR attributes are pro-
                       cessed.
...
DMAKE(1)                                                              DMAKE(1)
       ...
       AUGMAKE         If set to "yes" value will enable the transformation of
                       ...
                       ences (See the COMPATIBILITY section).
