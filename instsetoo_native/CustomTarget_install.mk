...
$(call gb_CustomTarget_get_workdir,instsetoo_native/install)/install.phony: $(SOLARENV)/bin/make_installer.pl
...
&& $(PERL) -w $< \
	...
	$(if $(filter WNT,$(OS)), \
		...
		-msilanguage $(SRCDIR)/instsetoo_native/inc_openoffice/windows/msi_languages \
	) \
	$(4) \
	-format $(pkgformat) \
