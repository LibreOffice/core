...
$(eval $(call gb_Package_add_file,xmlscript_inc,bin/libraries.dtd,dtd/libraries.dtd))
$(eval $(call gb_Package_add_file,xmlscript_inc,bin/library.dtd,dtd/library.dtd))
