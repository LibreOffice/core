...
class B2IRangeTest : public CppUnit::TestFixture
{
    void testCreation()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(1, aRange.getMinX());
        CPPUNIT_ASSERT_EQUAL(3, aRange.getMaxX());
        CPPUNIT_ASSERT_EQUAL(2, aRange.getMinY());
        CPPUNIT_ASSERT_EQUAL(4, aRange.getMaxY());

        CPPUNIT_ASSERT_EQUAL(2, aRange.getWidth());
        CPPUNIT_ASSERT_EQUAL(2, aRange.getHeight());
    }
