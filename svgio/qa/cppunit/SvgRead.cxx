...
void TestParsing::testSimpleRectangle()
{
    ...
    CPPUNIT_ASSERT_EQUAL(0xff0000, sal_Int32(Color(*pDrawRect->mpStrokeColor)));
    CPPUNIT_ASSERT(bool(pDrawRect->mpFillColor));
    CPPUNIT_ASSERT_EQUAL(0x00cc00, sal_Int32(Color(*pDrawRect->mpFillColor)));
}
...
void TestParsing::testPath()
{
    ...
    CPPUNIT_ASSERT_EQUAL(0xffffff, sal_Int32(Color(*pDrawPath->mpStrokeColor)));
    CPPUNIT_ASSERT(bool(pDrawPath->mpFillColor));
    CPPUNIT_ASSERT_EQUAL(0x007aff, sal_Int32(Color(*pDrawPath->mpFillColor)));
}
