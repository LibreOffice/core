...
QrCodeGenContext::QrCodeGenContext(SvXMLImport& rImport, sal_uInt16 nPrfx,
    ...
    : SvXMLImportContext(rImport, nPrfx, rLocalName)
{
    ...
    xPropSet->setPropertyValue("IsQrCode", Any(true));

    xPropSet->setPropertyValue("QrCodeId", Any(xAttrList->getValueByName("loext:id")));
    xPropSet->setPropertyValue("QrCodeText",
                               Any(xAttrList->getValueByName("loext:suggested-signer-name")));
    xPropSet->setPropertyValue("QrCodeECC",
                               Any(xAttrList->getValueByName("loext:suggested-signer-title")));
    xPropSet->setPropertyValue("QrCodeBorder",
