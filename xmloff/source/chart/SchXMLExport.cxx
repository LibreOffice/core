...
(::com::sun::star::uno::Reference< ::com::sun::star::chart2::data::XDataSequence >)0,
(::com::sun::star::uno::Reference< ::com::sun::star::chart2::data::XDataSequence >)0 ));
...
(::com::sun::star::uno::Reference< ::com::sun::star::chart2::data::XDataSequence >)0, xValues ));
                                }
                            ...
                            if( xYValuesForBubbleChart.is() )
                                m_aDataSequencesToExport.push_back( tLabelValuesDataPair(
(::com::sun::star::uno::Reference< ::com::sun::star::chart2::data::XDataSequence >)0, xYValuesForBubbleChart ));
                        }
                    }
        ...
        if( nErrorBarStyle != chart::ErrorBarStyle::NONE && (bNegative || bPositive))
        {
            if( bExportContent && nErrorBarStyle == chart::ErrorBarStyle::FROM_DATA )
            {
                         ...
                         aErrorBarSequences.begin()); aIt != aErrorBarSequences.end(); ++aIt )
                {
                    ...
                    m_aDataSequencesToExport.push_back( tLabelValuesDataPair(
(::com::sun::star::uno::Reference< ::com::sun::star::chart2::data::XDataSequence >)0, *aIt ));
                }
            }
