            ...
            )
        {
            try
            {
                ...
                else
                {
                    ...
                    for (   PropertyDescriptionList::iterator prop = descriptions.begin();
                            prop != descriptions.end();
                            ++prop
                        )
                    {
                        // TODO: XMultiPropertySet?
                        const Any propValue = m_xProps->getPropertyValue( (*prop)->propertyName );
                        aValues[ (*prop)->propertyId ] = propValue;
                    }
