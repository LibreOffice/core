...
//      OASIS_XLINK_ACTIONS ), /* generated entry */
    ...
    ENTRY0( TEXT, CREATION_DATE, OASIS_DATETIME_ACTIONS ),
    ENTRY0( TEXT, TIME, OASIS_DATETIME_ACTIONS ),
    ENTRY0( TEXT, CREATION_TIME, OASIS_DATETIME_ACTIONS ),
    ENTRY0( TEXT, PRINT_TIME, OASIS_DATETIME_ACTIONS ),
    ENTRY0( TEXT, MODIFICATION_TIME, OASIS_DATETIME_ACTIONS ),
    ENTRY0( TEXT, EDITING_DURATION, OASIS_DATETIME_ACTIONS ),
    ENTRY0( FORM, TIME, OASIS_DATETIME_ACTIONS ),
