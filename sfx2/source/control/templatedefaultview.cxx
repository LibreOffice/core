...
{
    SfxTemplateLocalView::reload();
    // Set preferred width
//TODO    set_width_request(gnTextHeight + mnItemMaxSize + 2*gnItemPadding);
}
#endif
...
void TemplateDefaultView::createContextMenu()
{
    ...
    pItemMenu->SetSelectHdl(LINK(this, SfxTemplateLocalView, ContextMenuSelectHdl));
