...
IMPL_LINK(ClassificationCategoriesController, SelectHdl, ListBox&, rCategory, void)
{
    ...
    OUString aType = m_pClassification->getCategoryType();
...
void ClassificationCategoriesController::statusChanged(const frame::FeatureStateEvent& /*rEvent*/)
{
    ...
    const OUString& rCategoryName = aHelper.GetBACName(m_pClassification->getPolicyType());
...
SfxClassificationPolicyType ClassificationControl::getPolicyType()
{
...
OUString ClassificationControl::getCategoryType()
{
