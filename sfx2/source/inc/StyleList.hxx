...
public:
    ...
    const SfxStyleFamilyItem& GetFamilyItemByIndex(size_t i) { return m_xStyleFamilies->at(i); }
    const SfxObjectShell* GetObjectShell() { return m_pCurObjShell; }
    const bool IsHierarchical() { return m_bHierarchical; }
