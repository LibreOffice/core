...
public:
    ...
    // Dialog and StyleList have their own copies of variable m_bupDateFamily.
    // It is used in Dialog's SetFamily and SetFamilyState
    // When the value of bUpdateFamily is updated there while setting a family, the
    //corresponding value gets updated here too.
    void SetUpdateFamily(bool updatefamily) { m_bUpdateFamily = updatefamily; }
    ...
    // When the value of m_bNewbyExampleDisabled is updated there while cresting a new style by example,
    //the corresponding value gets updated here too.
    void DisableExample(bool newByExampleDisabled);
    // m_nActFamily is : Id in the ToolBox = Position - 1
    // Dialog and StyleList have their own copies of m_nActFamily
    // When this value gets updated in Dialog's FamilySelect and SetFamily,
    //the corresponding value gets updated here too.
    void SetStyleFamily(sal_uInt16 ActFam) { m_nActFamily = ActFam; }
