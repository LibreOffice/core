...
public:
    ...
    weld::TreeView* ReturnVisibleTreeview()
    {
        return m_xTreeBox->get_visible() ? m_xTreeBox.get() : m_xFmtLb.get();
    }
    ...
    bool bCanNewGetter_updateFamImpl()
    {
    ...
    void connect_selected(const Link<StyleList&, void>& rLink) { m_aSelectHdl = rLink; }

    void ExecuteAction();

    void Initialize();

    void SetWantHierarchical(bool WantHierarchical)
    {
        m_bWantHierarchical = WantHierarchical;
    }
...
private:
    ...
    void FilterSelect(sal_uInt16 nEntry, bool bForce);
    ...
    void Selected_Hdl() { m_aSelectHdl.Call(*this); }
    ...
    bool m_bUpdateByExampleDisabled : 1;
    ...
    Link<StyleList&, void> m_aSelectHdl;
