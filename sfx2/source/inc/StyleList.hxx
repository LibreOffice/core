...
public:
    ...
    std::unique_ptr<SfxTemplateItem>* NthElem(sal_uInt16 idx) { return &m_pFamilyState[idx]; }
    ...
    static bool bTreeDragSetter_updateFam_Impl() { return true; }
    ...
    void nActFamilySetter(sal_uInt16 m_ActFam) { m_nActFamily = m_ActFam; }
    ...
    void SetBCanDel(bool candel) { m_bCanDel = candel; }
    void SetBCanhide(bool canhide) { m_bCanHide = canhide; }
    void SetBCanshow(bool canshow) { m_bCanShow = canshow; }
    void SetBCannew(bool cannew) { m_bCanNew = cannew; }
    void SetBCanedit(bool canedit) { m_bCanEdit = canedit; }
