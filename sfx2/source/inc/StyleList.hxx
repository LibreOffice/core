...
public:
    ...
    */
    ...
    void Update_Styles(StyleFlags nFlags);
    ...
    void TimeOut();
    void Notify(SfxHintId nId);

    void FilterSelect(sal_uInt16 m_nActFilter);
    ...
    void EnableDelete();
    void EnableTreeDrag(bool m_bEnable);
    ...
    void connect_selected(const Link<StyleFlags, void>& rLink) { m_aUpdateStyles = rLink; }
