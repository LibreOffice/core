...
OUString GetInfoBarIconName(InfobarType ibType)
{
    ...
    switch (ibType)
    {
    case InfobarType_Info:
       aRet = "vcl/res/infobox.svg";
       break;
    case InfobarType_Success:
        aRet = "vcl/res/successbox.svg";
        break;
    case InfobarType_Warning:
        aRet = "vcl/res/warningbox.svg";
        break;
    case InfobarType_Danger:
...
public:
    explicit SfxCloseButton(vcl::Window* pParent) : PushButton(pParent, 0)
    {
        ...
        GetInfoBarColors(InfobarType_Warning,m_aBackgroundColor,m_aForegroundColor,aMessageColor);
    }
