...
IMPL_LINK(SfxInfoBarWindow, SizeAllocHdl, const Size&, rSize, void) { m_aMessageSize = rSize; }
...
void SfxInfoBarWindow::Layout()
{
    ...
    if (m_aSize != aGivenSize)
    {
        ...
        m_aMessageSize = m_xSecondaryMessage->get_preferred_size();
        m_aSize = aSizeForWidth;
    }

    if (m_aSize != aGivenSize)
        SetSizePixel(m_aSize);
