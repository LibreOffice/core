...
IMPL_LINK_NOARG_TYPED(SfxApplicationStartupDialog, OkButtonClick, Button*, void)
{
...
IMPL_LINK_NOARG_TYPED(SfxApplicationStartupDialog, LinkClick, FixedHyperlink&, void)
{
    try
    {
...
IMPL_LINK_NOARG_TYPED(SfxApplicationStartupDialog, LinkButton1Click, FixedHyperlink&, void)
{
    try
    {
        Reference<XSystemShellExecute> xSystemShellExecute(SystemShellExecute::create(comphelper::getProcessComponentContext()));
...
IMPL_LINK_NOARG_TYPED(SfxApplicationStartupDialog, LinkButton2Click, FixedHyperlink&, void)
{
    try
    {
        Reference<XSystemShellExecute> xSystemShellExecute(SystemShellExecute::create(comphelper::getProcessComponentContext()));
