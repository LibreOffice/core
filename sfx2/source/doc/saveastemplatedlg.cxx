...
SfxSaveAsTemplateDialog::SfxSaveAsTemplateDialog( vcl::Window* pParent):
        ModalDialog(pParent, "SaveAsTemplateDialog", "sfx/ui/templatesaveasdlg.ui"),
...
bool SfxSaveAsTemplateDialog::IsTemplateNameUnique()
{
    ...
    auto nPos = std::distance(msCategories.begin(), it);

    sal_uInt16 nEntries = mpDocTemplates->GetCount(nPos);
    for(sal_uInt16 i = 0; i < nEntries; i++)
    {
        OUString aName = mpDocTemplates->GetName(nPos, i);
...
void SfxSaveAsTemplateDialog::SaveTemplate()
{
    //TODO
}
