    ...
    , mViewMode(TemplateViewMode::eThumbnailView)
{
    ...
    mxLocalView->connect_focus_rect(LINK(this, SfxTemplateManagerDlg, FocusRectHdl));
...
IMPL_LINK_NOARG(SfxTemplateManagerDlg, FocusRectHdl, weld::Widget&, tools::Rectangle)
{
