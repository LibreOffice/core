                                                 ...
                                                 const OUString& rFilterUIName)
{
    ...
    m_xAbort = uno::Reference<task::XInteractionAbort>(new comphelper::OInteractionAbort);
    m_xApprove = uno::Reference<task::XInteractionApprove>(new comphelper::OInteractionApprove);
