...
protected:
    ...
    SfxDocumentMetaData& operator =(SfxDocumentMetaData &); 
...
const char* s_nsXLink   = "http:
const char* s_nsDC      = "http:
...
SfxDocumentMetaData::createDOM() const 
{
...
void SAL_CALL
SfxDocumentMetaData::checkInit() const 
{
    if (!m_isInitialized) {
