...
$(eval $(call gb_StaticLibrary_StaticLibrary,rdf))

$(eval $(call gb_StaticLibrary_use_unpacked,rdf,redland))

$(eval $(call gb_StaticLibrary_set_warnings_not_errors,rdf))

$(eval $(call gb_StaticLibrary_use_externals,rdf,\
	openssl \
	raptor_headers \
	rasqal_headers \
))

$(eval $(call gb_StaticLibrary_add_ldflags,rdf,\
	/DEF:$(SRCDIR)/redland/redland/rdf.def \
))

$(eval $(call gb_StaticLibrary_add_defs,rdf,\
	-DLIBRDF_INTERNAL \
	-DWIN32 \
	-DNDEBUG \
	-D_WINDOWS \
...
$(eval $(call gb_StaticLibrary_add_generated_cobjects,rdf,\
