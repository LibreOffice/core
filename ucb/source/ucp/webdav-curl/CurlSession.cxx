...
struct CurlProcessor
{
    static auto ProcessRequest(
        CurlSession& rSession, OUString const& rInPath, DAVRequestEnvironment const& rEnv,
#if 0
...
auto CurlProcessor::ProcessRequest(
    ...
    -> void
{
    for (auto const& rHeader : rEnv.m_aRequestHeaders)
    {
...
#endif
    if (!rSession.m_isAuthenticatedProxy && !rSession.m_Proxy.aName.isEmpty())
    {
