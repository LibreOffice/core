...
auto CurlSession::NonInteractive_LOCK(::std::u16string_view const rInPath,
                                      sal_Int32& o_rLastChanceToSendRefreshRequest) -> bool
{
    (void)this;
}

auto CurlSession::NonInteractive_UNLOCK(::std::u16string_view const rInPath) -> void { (void)this; }
