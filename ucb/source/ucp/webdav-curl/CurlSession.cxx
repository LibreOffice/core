...
struct CurlProcessor
{
    static auto ProcessRequest(
        CurlSession& rSession, ::std::u16string_view const rInPath,
    ...
    static auto MoveOrCopy(CurlSession& rSession, ::std::u16string_view const rInPathSource,
                           ::std::u16string_view rInPathDestination,
                           DAVRequestEnvironment const& rEnv, bool isOverwrite, char const* pMethod)
        -> void;

    static auto
    Lock(CurlSession& rSession, OUString const& rInPath, DAVRequestEnvironment const* pEnv,
         ::std::unique_ptr<curl_slist, deleter_from_fn<curl_slist_free_all>> pRequestHeaderList,
         css::uno::Reference<css::io::XInputStream> const* pxInStream)
...
auto CurlProcessor::MoveOrCopy(CurlSession& rSession, ::std::u16string_view const rInPathSource,
                       ...
                       DAVRequestEnvironment const& rEnv) -> void
{
    ...
    auto const acquiredLocks
        = CurlProcessor::Lock(*this, rInPath, &rEnv, ::std::move(pList), &xRequestInStream);
                                      ...
                                      sal_Int32& o_rLastChanceToSendRefreshRequest) -> bool
{
    ...
    {
        auto const acquiredLocks
            = CurlProcessor::Lock(*this, rInPath, nullptr, ::std::move(pList), nullptr);
