...
inline constexpr OUString DROPBOX_CONTENT_SERVICE_NAME = u"com.sun.star.ucb.DropboxContent"_ustr;

// Using DropboxFileInfo from gdrive_json.hxx
                ...
                public css::ucb::XContentCreator
{
    ...
    std::shared_ptr<DropboxApiClient> m_pApiClient;
    ContentProvider*  m_pProvider; // No need for a ref, base class holds object
    DropboxFileInfo    m_aFileInfo; // Cached file information
...
public:
    ...
    const DropboxFileInfo& getFileInfo() const { return m_aFileInfo; }
    void setFileInfo( const DropboxFileInfo& rInfo );
