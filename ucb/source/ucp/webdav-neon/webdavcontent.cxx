                ...
                if ( !aHeaderNames.empty() )
                {
                    ...
                    catch ( DAVException const & e )
                    {
                        ...
                        if ( bError )
                        {
                            ...
                            std::shared_ptr<DavURIObject> xURL = std::make_shared<DavURIObject>( DavURIObject( aTargetURL ) );
    ...
    throw ( css::uno::Exception, std::exception )
{
    ...
    {
        std::shared_ptr<DavURIObject> xTargetURL = std::make_shared<DavURIObject>( DavURIObject( aTargetURL ) );
        try
        {
