...
constexpr OUStringLiteral WEBDAV_CONTENT_PROVIDER_SERVICE_NAME =u"com.sun.star.ucb.WebDAVContentProvider";
...
constexpr OUStringLiteral HTTP_URL_SCHEME = u"http";
constexpr OUStringLiteral HTTPS_URL_SCHEME = u"https";
