...
#ifndef INCLUDED_UCB_SOURCE_UCP_WEBDAV_NEON_DAVURIOBJECT_HXX
#define INCLUDED_UCB_SOURCE_UCP_WEBDAV_NEON_DAVURIOBJECT_HXX
...
namespace webdav_ucp
{
    ...
    class DavURIObject : public INetURLObject
    {

    public:
        DavURIObject();
        explicit DavURIObject( const OUString& TheAbsRef );
        virtual ~DavURIObject();
    ...
    inline OUString DavURIObject::GetPathQueryFragment( DecodeMechanism eMechanism ) const
    {
    ...
    inline OUString DavURIObject::GetPathBaseName() const
    {
    ...
    inline OUString DavURIObject::GetPercDecodedPathBaseName() const
    {
    ...
    inline void DavURIObject::verifyURL() const
        throw ( DAVException )
    {
        if ( HasError() )
