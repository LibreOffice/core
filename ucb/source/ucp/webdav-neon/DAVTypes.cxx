...
DAVOptions::DAVOptions( const DAVOptions & rOther ) :
    ...
    m_rURL( std::make_shared<DavURIObject>( *rOther.m_rURL ) ),
...
DAVOptions & DAVOptions::operator=( const DAVOptions& rOpts )
{
    ...
    m_rURL = std::make_shared<DavURIObject>( *rOpts.m_rURL );
...
bool DAVOptionsCache::getDAVOptions( const OUString & rURL, DAVOptions & rDAVOptions )
{
    ...
    DavURIObject aDavURIObject( rURL );
    aDavURIObject.removeFinalSlash();
    OUString aEncodedUrl( aDavURIObject.GetMainURL() );
