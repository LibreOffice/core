...
namespace
{
    ...
    public:
        ...
        void DAVTypesCheckInit( const DAVOptions& aDavType );
        void DAVTypesTest();
    ...
    void webdav_opts_test::DAVTypesCheckInit( const DAVOptions & aDavType )
    {
    ...
    void webdav_opts_test::DAVTypesTest()
    {
        ...
        std::shared_ptr<DavURIObject> xURL =
            std::make_shared<DavURIObject>(
                DavURIObject( "http://my.server.org/a%20fake%20url/to%20test") );
        aDavOpt.setURL( xURL );
        CPPUNIT_ASSERT_EQUAL( false, aDavOpt.isClass1() );
        CPPUNIT_ASSERT_EQUAL( false, aDavOpt.isClass2() );
        CPPUNIT_ASSERT_EQUAL( false, aDavOpt.isClass3() );
    ...
    void webdav_opts_test::DAVOptsCacheTests()
    {
        ...
        std::shared_ptr<DavURIObject> xURL =
            std::make_shared<DavURIObject>(
                DavURIObject( "http://my.server.org/a fake url/to test/another-url/" ) );
