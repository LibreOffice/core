...
if (defined $ENV{NOCONFIGURE}) {
    ...
    # When running a shell script from Perl on WSL, weirdly named environment variables like the
    # "ProgramFiles(x86)" one don't seem to get exported. So export it as PROGRAMFILESX86 instead.
