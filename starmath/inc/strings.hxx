...
#define RID_REPEATX         "repeat <?> "
#define RID_REPEAT_FROMX    "repeat from{<?>} <?> "
#define RID_REPEAT_TOX      "repeat to{<?>} <?> "
#define RID_REPEAT_FROMTOX  "repeat from{<?>} to{<?>} <?> "
#define RID_LIMX            "lim <?> "
...
#define RID_MATHBBX         "font mathbb {<?>}"
#define RID_SCRIPTX         "font script {<?>}"
...
#define RID_ICOMPLEX        "icomplex "
#define RID_EULERCTE        "eulercte "
