...
0x21D0, 0x21D4, 0xf613, 0xf612, 0x2218, 0xffff, 0xffff, 0xffff, 0x003A, 0x003B,
...
0x00AF, 0x0362, 0x02D9, 0x00A8, 0x20DB, 0x02DA, 0x2227, 0x2228, 0x220D, 0x2205,
...
0x2373, 0xffff, 0xffff, 0x22A4, 0x2112, 0x2130, 0x2131, 0xffff, 0xffff, 0x002F,
...
0x03C7, 0x03C8, 0x03C9, 0x03B5, 0x03D1, 0x03D6, 0x03F1, 0x03DB, 0x2118, 0x2202,
...
void MathType::HandleMath(SmNode *pNode,int nLevel)
{
    ...
    for(int i=0;i<pTemp->GetText().Len();i++)
    {
        ...
        sal_Unicode nArse = aMathTypeTable[pTemp->GetText().GetChar(i)&0x00FF];
