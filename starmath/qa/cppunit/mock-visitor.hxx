...
public:
    ...
    void Visit(SmTableNode* pNode) override
    {
        ...
        CPPUNIT_ASSERT_MESSAGE(
            "The type of SmTableNode's token should be either TEND, TBINOM, or TSTACK",
    ...
    void Visit(SmMatrixNode* pNode) override
    {
        ...
        CPPUNIT_ASSERT_EQUAL_MESSAGE("SmMatrixNode's token should be of type TMATRIX", TMATRIX,
    ...
    {
        CPPUNIT_ASSERT_MESSAGE(
            "SmMathSymbolNode should have type SmNodeType::Math or SmNodeType::MathIdent",
    ...
    void Visit(SmVerticalBraceNode* pNode) override
    {
        CPPUNIT_ASSERT_EQUAL_MESSAGE(
            "SmVerticalBraceNode should have type SmNodeType::VerticalBrace",
