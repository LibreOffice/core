...
errorMessages.sessionexpiry = _('Your session will end in {time}. Refresh the page to continue.');
errorMessages.sessionexpired = _('Your session has ended. Further changes to the document might not be saved. Refresh the page to continue.');
