...
app.CSections.RenderGeometry =		{ name: 'render geometry', zIndex: 5 };
...
app.CSections.CellRangeMarker =      { name: 'cell range marker', zIndex: 5 };
app.CSections.CellFillMarker = 		{ name: 'auto fill marker'	, zIndex: 6 };
app.CSections.CellRangeHandle = 	{ name: 'cell range handle'	, zIndex: 6 };
...
app.CSections.RenderGeometry.processingOrder =		69; // Impress & Draw. Bound to tiles.
app.CSections.CompareChangesLabel.processingOrder =	61; // Writer.
app.CSections.FocusCell.processingOrder =     		61; // Calc.
app.CSections.CellRangeMarker.processingOrder =	61; // Calc.
...
app.CSections.CellRangeHandle.processingOrder =		65; // Calc.
...
app.CSections.RenderGeometry.drawingOrder =		70; // Impress & Draw. Before the overlay.
...
app.CSections.CellRangeMarker.drawingOrder =		91; // Calc.
app.CSections.OtherViewCellCursor.drawingOrder =      92; // Calc.
app.CSections.CellCursor.drawingOrder =				93; // Calc.
app.CSections.CellRangeHandle.drawingOrder =		94; // Calc.
