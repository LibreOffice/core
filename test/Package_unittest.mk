...
$(eval $(call gb_Package_add_file,test_unittest,unittest/user/config/soffice.cfg/modules/scalc/popupmenu/graphic.xml,user/config/soffice.cfg/modules/scalc/popupmenu/graphic.xml))
