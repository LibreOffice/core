...
void XSimpleText::testCreateTextCursor()
{
    ...
    CPPUNIT_ASSERT(xSimpleText->createTextCursor() != nullptr);
}
...
void XSimpleText::testCreateTextCursorByRange()
{
    ...
    CPPUNIT_ASSERT(xSimpleText->createTextCursorByRange(xCursor) != nullptr);
}
...
void XSimpleText::testInsertString()
{
    ...
    CPPUNIT_ASSERT(!gString.isEmpty() && gString.indexOf(sString) >= 0);
}
...
void XSimpleText::testInsertControlCharacter()
{
    ...
    CPPUNIT_ASSERT(bOK && gString.indexOf("\n") > -1);
}
}
