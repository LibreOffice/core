...
namespace
{
    struct TestEventListener final : ::cppu::WeakImplHelper<lang::XEventListener>
    {
        ...
        TestEventListener() : m_hasDisposingCalled(false) {}
        virtual ~TestEventListener() {}
        virtual void disposing(const lang::EventObject& ) override { m_hasDisposingCalled = true; }
    };
...
namespace apitest
{
    void XComponent::testAddEventListener()
    {
        ...
        xComponent->dispose();
        CPPUNIT_ASSERT_EQUAL(pListenerAdded->m_hasDisposingCalled, true);
    }
    ...
    void XComponent::testRemoveEventListener()
    {
        ...
        xComponent->dispose();
        CPPUNIT_ASSERT_EQUAL(pListenerAddedAndRemoved->m_hasDisposingCalled, false);
    }
