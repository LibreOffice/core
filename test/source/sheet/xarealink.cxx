...
void XAreaLink::testSetDestArea()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Couldn't set new DestArea (StartCol)", 3, aDestArea.StartColumn);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Couldn't set new DestArea (StartRow)", 4, aDestArea.StartRow);
}
