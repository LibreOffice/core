...
void XSheetAnnotationAnchor::testGetAnnotation()
{
    ...
    uno::Reference<text::XSimpleText> xText(xAnnotation, UNO_QUERY_THROW);
    xText->setString("XSheetAnnotation");
    CPPUNIT_ASSERT_MESSAGE("Unable to get XSheetAnnotation", xAnnotation.is());

    table::CellAddress aCellAddress(0, 2, 3);
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Unable to check: getPosition", aCellAddress,
