...
{
    OUString const aExpected( "Sheet1.B2:B3" );
    uno::Reference<sheet::XCellRangesQuery> xCellRangesQuery(init(),UNO_QUERY_THROW);
...
{
    OUString const aExpected( "Sheet1.C2" );
    uno::Reference<sheet::XCellRangesQuery> xCellRangesQuery(init(),UNO_QUERY_THROW);
...
{
    OUString const aExpected( "Sheet1.D4:D5" );
    uno::Reference<sheet::XCellRangesQuery> xCellRangesQuery(init(),UNO_QUERY_THROW);
...
{
    OUString const aExpected( "Sheet1.A2:A4,Sheet1.C2:D4" );
    uno::Reference<sheet::XCellRangesQuery> xCellRangesQuery(init(),UNO_QUERY_THROW);
...
{
    OUString const aExpected( "Sheet1.A1:D5" );
    uno::Reference<sheet::XCellRangesQuery> xCellRangesQuery(init(),UNO_QUERY_THROW);
