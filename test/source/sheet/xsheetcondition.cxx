...
{
    uno::Reference< sheet::XSheetCondition > xSheetCondition(init(), UNO_QUERY_THROW);
    table::CellAddress aSourcePosition;
    CPPUNIT_ASSERT_NO_THROW_MESSAGE("Unable to get SourcePosition",
                                    aSourcePosition = xSheetCondition->getSourcePosition());
    //table::CellAddress aSourcePosition = xSheetCondition->getSourcePosition();
    //CPPUNIT_ASSERT_MESSAGE("Unable to get SourcePosition", aSourcePosition == table::CellAddress);
