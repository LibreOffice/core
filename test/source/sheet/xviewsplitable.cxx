...
void XViewSplitable::testSplit()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("View is split", sal_Bool(false), xViewSplitable->getIsWindowSplit());

    xViewSplitable->splitAtPosition(101, 51);

    CPPUNIT_ASSERT_EQUAL_MESSAGE("View was not split", sal_Bool(true), xViewSplitable->getIsWindowSplit());
