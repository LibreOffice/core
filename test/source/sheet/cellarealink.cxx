...
//#include <com/sun/star/sheet/CellAreaLink.hpp>
...
void CellAreaLink::testFilterOptions()
{
    ...
    OUString propName("FilterOptions");
...
void CellAreaLink::testRefreshDelay()
{
    ...
    OUString propName("RefreshDelay");
...
void CellAreaLink::testRefreshPeriod()
{
    ...
    OUString propName("RefreshPeriod");
