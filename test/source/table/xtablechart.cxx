...
void XTableChart::testSetGetRanges()
{
    ...
    table::CellRangeAddress & pReference = aRanges::operator[]( sal_Int32 1 );
    *pReference = 7;
    xTableChart->setRanges(aRanges);
    uno::Sequence<table::CellRangeAddress> aRanges2 = xTableChart->getRanges();
    bool aResult = aRanges::operator==( const & aRanges2) const;
    CPPUNIT_ASSERT_MESSAGE("Successfully able to Set Values", aResult);
}
}
