...
void XCell::testGetFormula()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Successfully able to get Formula", (aFormula == aFormula2));
}
...
void XCell::testGetType()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Successfully able to get Type",
                           (typeid(aType).name() == typeid(aType2).name()));
}

void XCell::testGetValue()
{
    uno::Reference<table::XCell> xCell(init(), UNO_QUERY_THROW);
    CPPUNIT_ASSERT_MESSAGE("Successfully able to get Value", xCell->getValue());
}
...
void XCell::testSetFormula()
{
    ...
    OUString aFormula2 = xCell->getFormula();
    CPPUNIT_ASSERT_MESSAGE("Successfully able to set Formula", (aFormula == aFormula2));
}
...
void XCell::testSetValue()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Successfully able to set Value", (nInValue == nCellValue));
}
}
