...
{
    uno::Reference<table::XCellCursor> xCellCursor(init(), UNO_QUERY_THROW);
    uno::Reference<table::XCellRange> xSheet(getXSpreadsheet(), UNO_QUERY_THROW);
    table::XCellRange testRange = xSheet->getCellRangeByName("$A$1:$g$7");
    uno::Reference<sheet::XSheetCellRange> xSheetRange(xCellCursor, UNO_QUERY_THROW);
    sheet::XSheetCellCursor aCellCursor = xSheet->createCursorByRange(xSheetRange);
    uno::Reference<sheet::XCellRangeAddressable> xCellRangeAddressable(xCellCursor,
                                                                       UNO_QUERY_THROW);
