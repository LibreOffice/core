...
void CaptionShape::testCaptionShapeProperties()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Able to set PropertyValue CornerRadius", nCornerRadiusGet + 5,
                                 nCornerRadiusSet);
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Able to set the PropertyValue of CaptionType", FIVE,
                                 captionTypeSet);
