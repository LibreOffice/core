...
void CaptionShape::testCaptionShapeProperties()
{
    ...
    aNewValue <<= (sal_Int16)(captionTypeGet);
    xCaptionShape->setPropertyValue(propName, aNewValue);
