                        ...
                        sal_uLong nFillCount, FillDir eFillDir, ScProgress* pProgress )
{
    ...
    SCCOLROW nCol = 0;
    SCCOLROW nRow = 0;
    SCCOLROW& rInner = bVertical ? nRow : nCol;        
...
OUString ScTable::GetAutoFillPreview( const ScRange& rSource, SCCOL nEndX, SCROW nEndY )
{
    ...
    if ( nEndX == nCol2 && nEndY == nRow2 )     
        bOk = false;
    else if ( nEndX == nCol2 )                  
    {
        nEndX = nCol2 = nCol1;                  
        nSrcCount = nRow2 - nRow1 + 1;
        nIndex = ((long)nEndY) - nRow1;         
        if ( nEndY >= nRow1 )
    ...
    if ( bOk )
    {
        ...
        else if ( eFillCmd == FILL_SIMPLE )         
        {
            ...
            if (!aCell.isEmpty())
            {
                ...
                if (nIndex >= 0)
                    ...
                    nDelta = ( nIndex - nSrcCount + 1 ) / nSrcCount;    
        ...
        else if ( eFillCmd == FILL_LINEAR || eFillCmd == FILL_DATE )        
        {
            bool bValueOk;
            double nStart;
            sal_Int32 nVal = 0;
