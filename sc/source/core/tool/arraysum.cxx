...
namespace sc::op
{
#if defined(LO_AVX_AVAILABLE) || defined(LO_AVX512F_AVAILABLE)
...
const __m512d ANNULATE_SIGN_BIT_512
    = _mm512_castsi512_pd(_mm512_set1_epi64x(0x7FFF'FFFF'FFFF'FFFF));
...
static inline void sumAVX512(__m512d& sum, __m512d& err, const __m512d& value)
{
    ...
    __m256d asum = _mm521_and_pd(sum, ANNULATE_SIGN_BIT_512);
    // Absolute value of the value to add
    __m256d avalue = _mm521_and_pd(value, ANNULATE_SIGN_BIT_512);
...
const bool hasAVX512 = cpuid::hasAVX512();
