                                                           ...
                                                           const double* pCurrent)
{
    ...
    if (nSize > i + 7)
    {
        ...
        KahanSum::sumNeumaierNormal(sums[2], errs[2], sums[3]);
        KahanSum::sumNeumaierNormal(sums[0], errs[0], errs[1]);
        KahanSum::sumNeumaierNormal(sums[2], errs[2], errs[3]);

        // 0+2 -> 0
        KahanSum::sumNeumaierNormal(sums[0], errs[0], sums[2]);
        KahanSum::sumNeumaierNormal(sums[0], errs[0], errs[2]);
