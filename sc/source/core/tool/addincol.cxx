                                ...
                                if (!bSkip)
                                {
                                    ...
                                    if (bValid)
                                    {
                                        ...
                                        ppFuncData[nFuncPos+nOld] = new ScUnoAddInFuncData(
                                            aFuncNameBuffer.makeStringAndClear(), aLocalName, aDescription,
                                            nCategory, sHelpId,
                                            xFunc, aObject,
                                            nVisibleCount, pVisibleArgs, nCallerPos );
            ...
            if (xAcc.is())
            {
                ...
                for (long nFuncPos=0; nFuncPos<nMethodCount; nFuncPos++)
                {
                    ...
                    if (xFunc.is())
                    {
                        ...
                        ScUnoAddInFuncData* pOldData = const_cast<ScUnoAddInFuncData*>( GetFuncData( aFuncNameBuffer.makeStringAndClear() ) );
                        if ( pOldData )
                        {
