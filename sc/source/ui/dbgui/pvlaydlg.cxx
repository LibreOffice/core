    ...
    mbRefInputMode( false )
{
    ...
    //mpBtnMore->AddWindow( &mpFtInArea );
    //mpBtnMore->AddWindow( &mpEdInPos );
    //mpBtnMore.AddWindow( &mpRbInPos );
    //mpBtnMore.AddWindow( &mpFtOutArea );
    //mpBtnMore.AddWindow( &mpLbOutPos );
    //mpBtnMore.AddWindow( &mpEdOutPos );
    //mpBtnMore.AddWindow( &mpRbOutPos );
    //mpBtnMore.AddWindow( &mpBtnIgnEmptyRows );
    //mpBtnMore.AddWindow( &mpBtnDetectCat );
    //mpBtnMore.AddWindow( &mpBtnTotalCol );
    //mpBtnMore.AddWindow( &mpBtnTotalRow );
    //mpBtnMore.AddWindow( &mpBtnFilter );
    //mpBtnMore.AddWindow( &mpBtnDrillDown );
    //mpBtnMore.SetClickHdl( LINK( this, ScPivotLayoutDlg, MoreClickHdl ) );
...
{
    mbRefInputMode = mpBtnMore->GetState();
    if (!mpBtnMore->GetState())
        return;
