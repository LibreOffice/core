...
void SearchResultsDlg::FillResults( ScDocument* pDoc, const ScRangeList &rMatchedRanges, bool bCellNotes )
{
    ...
    if (nMatchMax > aList.mnMaximum)
        nMatchMax = aList.mnMaximum;
    ...
    if (aList.mnCount > aList.mnMaximum)
        aSearchResults += " " + ScGlobal::ReplaceOrAppend( aSkipped, "%1", OUString::number( aList.mnMaximum ) );
