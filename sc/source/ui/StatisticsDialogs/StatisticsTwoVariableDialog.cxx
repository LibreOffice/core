...
void ScStatisticsTwoVariableDialog::GetRangeFromSelection()
{
    ...
    if (aCurrentRange.aEnd.Col() - aCurrentRange.aStart.Col() == 1)
    {
        ...
        aCurrentString = mVariable1Range.Format(SCA_RANGE_ABS_3D, mDocument, mAddressDetails);
        ...
        aCurrentString = mVariable2Range.Format(SCA_RANGE_ABS_3D, mDocument, mAddressDetails);
...
void ScStatisticsTwoVariableDialog::SetReference( const ScRange& rReferenceRange, ScDocument* pDocument )
{
    if ( mpActiveEdit != nullptr )
    {
        ...
        if ( mpActiveEdit == mpVariable1RangeEdit )
        {
            ...
            aReferenceString = mVariable1Range.Format(SCA_RANGE_ABS_3D, pDocument, mAddressDetails);
        ...
        else if ( mpActiveEdit == mpVariable2RangeEdit )
        {
            ...
            aReferenceString = mVariable2Range.Format(SCA_RANGE_ABS_3D, pDocument, mAddressDetails);
