...
void ScStatisticsInputOutputDialog::GetRangeFromSelection()
{
    ...
    OUString aCurrentString(mInputRange.Format(SCA_RANGE_ABS_3D, mDocument, mAddressDetails));
...
void ScStatisticsInputOutputDialog::SetReference( const ScRange& rReferenceRange, ScDocument* pDocument )
{
    if ( mpActiveEdit )
    {
        ...
        if ( mpActiveEdit == mpInputRangeEdit )
        {
            ...
            aReferenceString = mInputRange.Format(SCA_RANGE_ABS_3D, pDocument, mAddressDetails);
        ...
        else if ( mpActiveEdit == mpOutputRangeEdit )
        {
            ...
            sal_uInt16 nFormat = ( mOutputAddress.Tab() == mCurrentAddress.Tab() ) ? SCA_ADDR_ABS : SCA_ADDR_ABS_3D;
