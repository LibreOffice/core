...
void DataProviderDlg::StartImport()
{
    ...
    ExternalDataSource* pDataSource = ExternalDataSource(rURL, "org.libreoffice.calc.csv");
    ScDBData* pDbData = ScDBData("foo", aRange.aStart.Tab(), aRange.aStart.Col(), aRange.aStart.Row(),
        aRange.aStart.Col(), aRange.aStart.Row());

    pDataSource->SetDBData(pDbData);
    //DataProvider::MakeToolbarVisible();
}

void DataProviderDlg::StopImport()
{
}
