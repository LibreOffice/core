...
private:
    ...
    sal_Int32 mnOldMaxColumns;
    OUString maOldSeparator;
...
ScDataProviderDlg::ScDataProviderDlg(vcl::Window* pParent, std::shared_ptr<ScDocument> pDoc):
    ModalDialog(pParent, "dataproviderdlg", "modules/scalc/ui/dataproviderdlg2.ui"),
    mpDoc(pDoc),
...
void ScDataProviderDlg::InitMenu()
{
    ...
    {
        pPopup->InsertItem(itrStartData.nMenuID, itrStartData.aMenuName);
    }
 ...
 {
        pColumnMenu->InsertItem(itrColumnData.nMenuID, itrColumnData.aMenuName);
    }
