...
ScRange DataStreamDlg::GetStartRange()
{
    ...
    if ((nRes & static_cast<sal_uInt16>(ScAddr::VALID)) != static_cast<sal_uInt16>(ScAddr::VALID) || !aRange.IsValid())
    {
        // Invalid range.
        aRange.SetInvalid();
        return aRange;
...
void DataStreamDlg::Init( const DataStream& rStrm )
{
    ...
    OUString aStr = aTopRange.Format(static_cast<sal_uInt16>(ScAddr::RANGE_ABS_3D), &rDoc, rDoc.GetAddressConvention());
