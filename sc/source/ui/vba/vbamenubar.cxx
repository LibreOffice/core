...
ScVbaMenuBar::ScVbaMenuBar( const uno::Reference< ov::XHelperInterface >& rParent, const uno::Reference< uno::XComponentContext >& rContext, uno::Reference< XCommandBar >  rCommandBar ) : MenuBar_BASE(rParent, rContext), m_xCommandBar(std::move(rCommandBar))
{
}
