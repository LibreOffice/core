...
ScVbaMenuItem::ScVbaMenuItem( const uno::Reference< ov::XHelperInterface >& rParent, const uno::Reference< uno::XComponentContext >& rContext, uno::Reference< XCommandBarControl >  rCommandBarControl ) : MenuItem_BASE( rParent, rContext ), m_xCommandBarControl(std::move( rCommandBarControl ))
{
}
