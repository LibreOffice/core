...
public:
    ...
    explicit ScCheckListMenuControl(ScCheckListMenuWindow* pParent, vcl::Window* pContainer, ScDocument* pDoc, int nWidth = -1);
...
private:
    ...
    void endSubMenu(ScCheckListMenuControl* pSubMenu);
