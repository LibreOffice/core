...
public:
    ...
    ScCheckListMenuControl(weld::Widget* pParent, ScDocShell* pDocShell,
    ...
    ScDocShell& GetDocShell() const { return *mpDocShell; }
...
public:
    ...
    ScDocShell& GetDocShell() const { return mrParentControl.GetDocShell(); }
