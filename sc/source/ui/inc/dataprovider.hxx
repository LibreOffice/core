...
class SC_DLLPUBLIC ExternalDataMapper
{
    ...
    std::unique_ptr<ScDBDataManager> mpDBDataManager;
...
public:
    CSVFetchThread(ScDocument& rDoc, ScDBDataManager* mpDBDataManager, const OUString&, size_t);
...
public:
    ...
    bool Resize();
    bool RequiresResize(sal_uInt32, sal_uInt32);
