...
bool ScNameDefDlg::IsNameValid()
{
    ...
    else if (ScRangeData::IsNameValid( aName, mpDoc ) == ScRangeData::NAME_INVALID_BAD_STRING)
    {
    ...
    else if(ScRangeData::IsNameValid( aName, mpDoc ) == ScRangeData::NAME_INVALID_CELL_REF)
    {
        m_pFtInfo->SetControlBackground(GetSettings().GetStyleSettings().GetHighlightColor());
