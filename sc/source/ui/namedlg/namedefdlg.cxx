    ...
    maRangeMap( aRangeMap )
{
    ...
    OUString aAreaStr(aRange.Format(static_cast<sal_uInt16>(ScAddr::RANGE_ABS_3D), mpDoc,
...
void ScNameDefDlg::SetReference( const ScRange& rRef, ScDocument* pDocP )
{
    if ( m_pEdRange->IsEnabled() )
    {
        ...
        OUString aRefStr(rRef.Format(static_cast<sal_uInt16>(ScAddr::RANGE_ABS_3D), pDocP,
