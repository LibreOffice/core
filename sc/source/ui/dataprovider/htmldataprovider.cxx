...
public:
    ...
    virtual ~HTMLFetchThread() override;
...
OString toString(xmlChar* pStr)
{
    return OString((char*)pStr, xmlStrlen(pStr));
}
...
void HTMLFetchThread::handleRow(xmlNodePtr pRowNode, SCROW nRow)
{
    ...
    for (xmlNodePtr cur_node = pRowNode->children; cur_node; cur_node = cur_node->next)
    {
        ...
        {
            OString aNodeName((char*)cur_node->name, xmlStrlen(cur_node->name));
