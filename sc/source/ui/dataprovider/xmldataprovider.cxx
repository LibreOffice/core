...
public:
    XMLFetchThread(ScDocument& rDoc, const OUString&, const OUString& rTreePath, const ScOrcusImportXMLParam& rParam,
...
XMLFetchThread::XMLFetchThread(ScDocument& rDoc, const OUString& rURL, const OUString& rTreePath, const ScOrcusImportXMLParam& rParam,
        const OUString& rID, std::function<void()> aImportFinishedHdl,
        const std::vector<std::shared_ptr<sc::DataTransformation>>& rTransformations):
