...
ExternalDataSource::ExternalDataSource(OUString  rURL,
        OUString  rProvider, ScDocument* pDoc)
    : maURL(std::move(rURL))
...
ScDBDataManager::ScDBDataManager(OUString  rDBName, ScDocument* pDoc):
    maDBName(std::move(rDBName)),
    mpDoc(pDoc)
{
}
