...
void ScXMLSourceDlg::HandleGetFocus(Control const * pCtrl)
{
...
public:
    ...
    void operator() (SvTreeListEntry const * p)
    {
 ...
 */
SvTreeListEntry* getReferenceEntry(SvTreeListBox const & rTree, SvTreeListEntry* pCurEntry)
{
