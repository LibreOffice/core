...
enum ScXMLDataPilotFieldAttrTokens
{
    ...
    XML_TOK_DATA_PILOT_FIELD_ATTR_IS_GROUP_FIELD,
    XML_TOK_DATA_PILOT_FIELD_ATTR_GROUP_SOURCE_FIELD_NAME,
    XML_TOK_DATA_PILOT_FIELD_ATTR_DATE_START,
    XML_TOK_DATA_PILOT_FIELD_ATTR_DATE_END,
    XML_TOK_DATA_PILOT_FIELD_ATTR_START,
    XML_TOK_DATA_PILOT_FIELD_ATTR_END,
    XML_TOK_DATA_PILOT_FIELD_ATTR_STEP,
    XML_TOK_DATA_PILOT_FIELD_ATTR_GROUP_PART
};
