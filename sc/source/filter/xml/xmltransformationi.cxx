    ...
    : ScXMLImportContext(rImport)
{
    ...
    if (!aType.isEmpty())
    {
        if (aType.equals(OUString("lowercase")))
            maType = sc::TEXT_TRANSFORM_TYPE::TO_LOWER;
        else if (aType.equals(OUString("uppercase")))
            maType = sc::TEXT_TRANSFORM_TYPE::TO_UPPER;
        else if (aType.equals(OUString("capitalize")))
            maType = sc::TEXT_TRANSFORM_TYPE::CAPITALIZE;
        else if (aType.equals(OUString("trim")))
    ...
    : ScXMLImportContext(rImport)
{
    ...
    if (!aType.isEmpty())
    {
        if (aType.equals(OUString("sum")))
            maType = sc::AGGREGATE_FUNCTION::SUM;
        else if (aType.equals(OUString("average")))
            maType = sc::AGGREGATE_FUNCTION::AVERAGE;
        else if (aType.equals(OUString("min")))
            maType = sc::AGGREGATE_FUNCTION::MIN;
        else if (aType.equals(OUString("max")))
    ...
    : ScXMLImportContext(rImport)
{
    ...
    if (!aType.isEmpty())
    {
        if (aType.equals(OUString("round")))
            maType = sc::NUMBER_TRANSFORM_TYPE::ROUND;
        else if (aType.equals(OUString("round-up")))
            maType = sc::NUMBER_TRANSFORM_TYPE::ROUND_UP;
        else if (aType.equals(OUString("round-down")))
            maType = sc::NUMBER_TRANSFORM_TYPE::ROUND_DOWN;
        else if (aType.equals(OUString("abs")))
            maType = sc::NUMBER_TRANSFORM_TYPE::ABSOLUTE;
        else if (aType.equals(OUString("log")))
            maType = sc::NUMBER_TRANSFORM_TYPE::LOG_E;
        else if (aType.equals(OUString("log-base-10")))
            maType = sc::NUMBER_TRANSFORM_TYPE::LOG_10;
        else if (aType.equals(OUString("cube")))
            maType = sc::NUMBER_TRANSFORM_TYPE::CUBE;
        else if (aType.equals(OUString("number-square")))
            maType = sc::NUMBER_TRANSFORM_TYPE::SQUARE;
        else if (aType.equals(OUString("square-root")))
            maType = sc::NUMBER_TRANSFORM_TYPE::SQUARE_ROOT;
        else if (aType.equals(OUString("exponential")))
            maType = sc::NUMBER_TRANSFORM_TYPE::EXPONENT;
        else if (aType.equals(OUString("even")))
            maType = sc::NUMBER_TRANSFORM_TYPE::IS_EVEN;
        else if (aType.equals(OUString("odd")))
            maType = sc::NUMBER_TRANSFORM_TYPE::IS_ODD;
        else if (aType.equals(OUString("sign")))
