    ...
    : ScXMLImportContext(rImport)
{
    ...
    if (!aType.isEmpty())
    {
        if (aType == OUString("lowercase"))
            maType = sc::TEXT_TRANSFORM_TYPE::TO_LOWER;
        else if (aType == OUString("uppercase"))
            maType = sc::TEXT_TRANSFORM_TYPE::TO_UPPER;
        else if (aType == OUString("capitalize"))
            maType = sc::TEXT_TRANSFORM_TYPE::CAPITALIZE;
        else if (aType == OUString("trim"))
    ...
    : ScXMLImportContext(rImport)
{
    ...
    if (!aType.isEmpty())
    {
        if (aType == OUString("sum"))
            maType = sc::AGGREGATE_FUNCTION::SUM;
        else if (aType == OUString("average"))
            maType = sc::AGGREGATE_FUNCTION::AVERAGE;
        else if (aType == OUString("min"))
            maType = sc::AGGREGATE_FUNCTION::MIN;
        else if (aType == OUString("max"))
