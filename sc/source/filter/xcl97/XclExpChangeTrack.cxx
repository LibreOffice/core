 ...
 *  $Revision: 1.1 $
 *
 *  last change: $Author: dr $ $Date: 2000-11-29 11:19:15 $
 *
...
XclExpChangeTrack::XclExpChangeTrack( RootData* pRootData ) :
    ExcRoot( pRootData )
{
    DBG_ASSERT( pRootData, "XclExpChangeTrack::XclExpChangeTrack - no root data" );
}
...
void XclExpChangeTrack::Write()
{
    ...
    for( ExcRecord* pRec = aRecList.First(); pRec; pRec = aRecList.Next() )
        pRec->Save( *pStrm );
    delete pStrm;
}
