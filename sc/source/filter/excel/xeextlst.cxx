...
XclExpExtCfRule::XclExpExtCfRule( const XclExpRoot& rRoot, const ScFormatEntry& rFormat, const ScAddress& rPos, OString  rId, sal_Int32 nPriority ):
    XclExpRoot(rRoot),
    maId(std::move(rId)),
    pType(nullptr),
...
XclExpExtConditionalFormatting::XclExpExtConditionalFormatting( const XclExpRoot& rRoot,
        std::vector<XclExpExtCondFormatData>& rData, ScRangeList  rRange):
    XclExpRoot(rRoot),
    maRange(std::move(rRange))
{
