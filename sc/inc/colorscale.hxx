...
public:
    ...
    void UpdateReference( sc::RefUpdateContext const & rCxt );
    void UpdateInsertTab( sc::RefUpdateInsertTabContext& rCxt );
    void UpdateDeleteTab( sc::RefUpdateDeleteTabContext& rCxt );
    void UpdateMoveTab( sc::RefUpdateMoveTabContext const & rCxt );
...
private:
    ...
    double CalcValue(double nMin, double nMax, ScColorScaleEntries::const_iterator const & rItr) const;
public:
...
private:
    ...
    double GetMinValue() const;
    double GetMaxValue() const;
    double CalcValue(double nMin, double nMax, ScIconSetFormat::const_iterator const & itr) const;
