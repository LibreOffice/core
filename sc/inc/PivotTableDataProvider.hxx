...
private:
    ...
    css::uno::Reference<css::chart2::data::XDataSource>
        createCategoriesDataSource(OUString const & aRangeRepresentation, bool bOrientCol);
    ...
    void setLabeledDataSequenceValues(css::uno::Reference<css::chart2::data::XLabeledDataSequence> & xResult,
                                      ...
                                      std::vector<PivotTableItem> const & rValues);
    ...
    void setLabeledDataSequence(css::uno::Reference<css::chart2::data::XLabeledDataSequence> & xResult,
                                ...
                                std::vector<PivotTableItem> const & rLabel);
    ...
    std::vector<std::vector<PivotTableItem>> m_aCategoriesColumnOrientation;
    std::vector<std::vector<PivotTableItem>> m_aCategoriesRowOrientation;
    std::vector<std::vector<PivotTableItem>> m_aLabels;
    std::vector<std::vector<PivotTableItem>> m_aDataRowVector;
