...
$(eval $(call gb_CustomTarget_CustomTarget,scalc_tooltip/tooltip_properties))

tooltip_DIR := $(call gb_CustomTarget_get_workdir,tooltip/tooltip_properties)

define tooltip_Properties_Properties
$(call tooltip_Properties__Properties_impl,$(tooltip_DIR)/scalc_$(1).properties,$(SRCDIR)/sc/uiconfig/scalc_en_US.properties,$(gb_POLOCATION)/$(2)/sc/scalc_tooltip.po,$(2))
...
$(call gb_CustomTarget_get_target,scalc_tooltip/tooltip_properties) : $(1)
$(1) : $(2) \
	$(wildcard $(3))
