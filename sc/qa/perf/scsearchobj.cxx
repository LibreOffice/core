...
public:
    ...
    virtual void PERF_INSTRUMENTATION_START() SAL_OVERRIDE;
    virtual void PERF_INSTRUMENTATION_END(const char* message) SAL_OVERRIDE;
...
uno::Reference< uno::XInterface > ScSearchObj::init()
{
    ...
    PERF_INSTRUMENTATION_END("Load big file");
...
void ScSearchObj::PERF_INSTRUMENTATION_START()
{
  PerfInstrumentation::PERF_INSTRUMENTATION_START();
}

void ScSearchObj::PERF_INSTRUMENTATION_END(const char* message)
{
  PerfInstrumentation::PERF_INSTRUMENTATION_END(message);
}
