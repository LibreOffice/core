...
class CalcTextToColumns(UITestCase):
    ...
    def test_text_to_columns_comma(self):
        ...
        self.ui_test.execute_blocking_action(xOK.executeAction, args=('CLICK', ()), close_button="yes")
    ...
    def test_text_to_columns_semicolon(self):
        ...
        with self.ui_test.execute_blocking_action(xOK.executeAction, args=('CLICK', ()),
