...
class cellBackgroundColorSelector(UITestCase):
    ...
    def test_color_selector(self):
        ...
        xpaletteselector.executeAction("SELECT", mkPropertyValues({"POS": "1"}))
        ...
        xpaletteselector.executeAction("SELECT", mkPropertyValues({"POS": "2"}))
        ...
        # For html colors
        xpaletteselector.executeAction("SELECT", mkPropertyValues({"POS": "3"}))
        ...
        # For freecolor-hlc colors
        xpaletteselector.executeAction("SELECT", mkPropertyValues({"POS": "4"}))
        ...
        # For tonal colors
        xpaletteselector.executeAction("SELECT", mkPropertyValues({"POS": "5"}))
        ...
        # For material colors
        xpaletteselector.executeAction("SELECT", mkPropertyValues({"POS": "6"}))
        ...
        # For standard colors
        xpaletteselector.executeAction("SELECT", mkPropertyValues({"POS": "8"}))
    ...
    def test_recent_color_selector(self):
        ...
        # we will select color for cell A1 to be able to predict the latest color in
