...
dialogs = [
    ...
    # {"command": ".uno:HyperlinkDialog", "closeButton": "ok"}, #dialog opens but is not recognised by execute_dialog_through_command
    ...
    # {"command": ".uno:ConditionalFormatMenu", "closeButton": "cancel"}, #dialog does not open
    # {"command": ".uno:AutoFormat", "closeButton": "cancel"}, #dialog does not open
    # {"command": ".uno:ChooseDesign", "closeButton": "cancel"}, #dialog opens but is not recognised by execute_dialog_through_command
    ...
    # {"command": ".uno:InsertExternalDataSource", "closeButton": "cancel"}, #dialog opens and closes, but is not recognized as closed by close_dialog_through_button
    ...
    # {"command": ".uno:SheetInsertName", "closeButton": "close"}, #dialog does not open
    {"command": ".uno:CreateNames", "closeButton": "cancel", "skipTestOK": True},  # OK button triggers a new dialog
    ...
    {"command": ".uno:DataFilterAutoFilter", "closeButton": "ok", "skipTestOK": True},  # don't test OK button twice
    ...
    # {"command": ".uno:InsertPivotTable", "closeButton": "cancel"}, #dialog does not open
    ...
    # {"command": ".uno:SpellDialog", "closeButton": "close"}, #an extra dialog appears
    {"command": ".uno:Hyphenate", "closeButton": "cancel"},
    # {"command": ".uno:ChineseConversion", "closeButton": "cancel"}, tdf#125985
    # {"command": ".uno:HangulHanjaConversion", "closeButton": "cancel"}, tdf#125982
    {"command": ".uno:AutoCorrectDlg", "closeButton": "cancel"},
    {"command": ".uno:GoalSeekDialog", "closeButton": "cancel", "skipTestOK": True},  # OK button triggers a new dialog
    {"command": ".uno:SolverDialog", "closeButton": "close", "skipTestOK": True},  # OK button triggers a new dialog
