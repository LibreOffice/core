...
class chartLegend(UITestCase):
   def test_chart_display_legend_dialog(self):
    with self.ui_test.load_file2(get_url_for_data_file("tdf98390.ods")) as calc_doc:
   ...
   def test_legends_move_with_arrows_keys(self):
    ...
    with self.ui_test.load_file2(get_url_for_data_file("dataLabels.ods")) as calc_doc:
      xCalcDoc = self.xUITest.getTopFocusWindow()
      gridwin = xCalcDoc.getChild("grid_window")
