...
#        xfunctions.executeAction("SELECT", actionPropsF)
        ...
        self.assertEqual(round(get_cell_by_position(document, 0, 1, 15).getValue(),2), 238.89)
        self.assertEqual(round(get_cell_by_position(document, 0, 1, 16).getValue(),2), 238.89)
