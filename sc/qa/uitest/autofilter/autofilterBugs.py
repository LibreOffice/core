...
#tdf74857
   ...
   def test_tdf55712(self):
        ...
        #tdf63416
#   def test_tdf63416(self):#TODO
#        calc_doc = self.ui_test.load_file(get_url_for_data_file("tdf63416.ods"))
#        document = self.ui_test.get_component()
#        calcDoc = self.xUITest.getTopFocusWindow()
#        xGridWindow = calcDoc.getChild("grid_window")
#        #autofilter sort / using autofilter's menu
#        xGridWindow.executeAction("LAUNCH", mkPropertyValues({"AUTOFILTER": "", "COL": "1", "ROW": "1"}))
#        xFloatWindow = self.xUITest.getFloatWindow()
#        print(xFloatWindow.getChildren())
#('cancel', 'check_list_box', 'check_list_menu', 'ok', 'search_edit', 'select_current', 'toggle_all', 'unselect_current')


        #check if header not changed
#        self.assertEqual(get_cell_by_position(document, 0, 1, 1).getString(), "row1")
#        self.assertEqual(get_cell_by_position(document, 0, 2, 1).getString(), "")
#        self.assertEqual(get_cell_by_position(document, 0, 3, 1).getString(), "row3")
        self.ui_test.close_doc()

#TODO fdo#81084 fdo#81696 fdo#80874 fdo#81010 : sort causes crash
#TODO tdf#58013
