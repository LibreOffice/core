...
dialogs = [
    ...
    {"command": ".uno:InsertSignatureLine", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/signatureLine/insertSignatureLine.py
    # {"command": ".uno:FormatCellDialog", "closeButton": "cancel"},
        # tested in sc/qa/uitest/calc_tests/formatCells.py
    {"command": ".uno:RowHeight", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests/rows.py
    {"command": ".uno:SetOptimalRowHeight", "closeButton": "cancel"},
    {"command": ".uno:ColumnWidth", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests/columns.py
    {"command": ".uno:SetOptimalColumnWidth", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests4/tdf89907.py
    {"command": ".uno:PageFormatDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/pageFormat/tdf123508.py
    {"command": ".uno:EditPrintArea", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests/printRange.py
    ...
    {"command": ".uno:Delete", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests3/clearCells.py
    {"command": ".uno:RandomNumberGeneratorDialog", "closeButton": "close", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests/fillRandomNumber.py
    ...
    {"command": ".uno:RenameTable", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests/sheetRename.py
    {"command": ".uno:Move", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests6/moveCopySheet.py
    ...
    {"command": ".uno:DataFilterSpecialFilter", "closeButton": "cancel", "skipTestOK": True},
        # OK button triggers a new dialog
    {"command": ".uno:DefineDBName", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/range_name/tdf119954.py
    {"command": ".uno:SelectDB", "closeButton": "cancel"},
    # {"command": ".uno:InsertPivotTable", "closeButton": "cancel"},
        # dialog does not open
    {"command": ".uno:Validation", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/validity/validity.py
    {"command": ".uno:DataSubTotals", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests2/subtotals.py
    {"command": ".uno:DataForm", "closeButton": "close"},
    {"command": ".uno:DataConsolidate", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/calc_tests2/consolidate.py
    {"command": ".uno:Group", "closeButton": "cancel"},
    {"command": ".uno:SamplingDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/sampling.py
    {"command": ".uno:DescriptiveStatisticsDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/descriptiveStatistics.py
    {"command": ".uno:AnalysisOfVarianceDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/anova.py
    {"command": ".uno:CorrelationDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/correlation.py
    {"command": ".uno:CovarianceDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/covariance.py
    {"command": ".uno:ExponentialSmoothingDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/exponentialSmoothing.py
    {"command": ".uno:MovingAverageDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/movingAverage.py
    {"command": ".uno:RegressionDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/regression.py
    {"command": ".uno:TTestDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/tTest.py
    {"command": ".uno:FTestDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/fTest.py
    {"command": ".uno:ZTestDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/statistics/zTest.py
    {"command": ".uno:ChiSquareTestDialog", "closeButton": "cancel", "skipTestOK": True},
        # OK sc/qa/uitest/statistics/chiSquare.py:53
    ...
    {"command": ".uno:Protect", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/protect/protectSheet.py
    {"command": ".uno:ToolProtectionDocument", "closeButton": "cancel", "skipTestOK": True},
        # OK button tested in sc/qa/uitest/protect/protectSpreadsheet.py
