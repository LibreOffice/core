...
void Test::testColumnFindEditCells()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("There should be no edit cells.", -1, nResRow);
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("There is an edit cell here.", 0, nResRow);

    aRange.aStart.SetRow(1);
    aRange.aEnd.SetRow(1);
    nResRow = m_pDoc->GetFirstEditTextRow(aRange);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("There shouldn't be an edit cell in specified range.", -1, nResRow);
    ...
    nResRow = m_pDoc->GetFirstEditTextRow(aRange);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("There should be an edit cell in specified range.", 0, nResRow);
