...
void ScExportTest2::testTdf75263()
{
    ...
    {
        ScDocument& rDoc = xDocSh->GetDocument();
        auto pCell = new ScFormulaCell(rDoc, ScAddress(0, 0, 0), OUString("=TEST_FUNCTION()"));
        rDoc.SetFormulaCell(ScAddress(0, 0, 0), pCell);
        ...
        CPPUNIT_ASSERT_EQUAL(OUString("=TEST_FUNCTION()"), aFormula);
