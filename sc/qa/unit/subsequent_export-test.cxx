...
/*
(16:15:27) kohei: but make it a little more mean, like, insert an empty cell in between etc.
(16:15:46) kohei: a number cell followed by a string cell followed by a formula cell etc
(16:16:17) kohei: test with integers, test with fractions etc..
*/
    ...
    // check string
    CPPUNIT_ASSERT_EQUAL( OUString("a simple line"), pDoc->GetString(0,2,0) );

    // check for an empty cell
    CPPUNIT_ASSERT_EQUAL( OUString(""), pDoc->GetString(0,3,0) );
    CPPUNIT_ASSERT_EQUAL( 0.0, pDoc->GetValue(0,3,0) );

    // check a digit string
    CPPUNIT_ASSERT_EQUAL( OUString("12"), pDoc->GetString(0,4,0) );
    CPPUNIT_ASSERT_EQUAL( 0.0, pDoc->GetValue(0,4,0) );
