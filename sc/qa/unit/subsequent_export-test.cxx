...
void ScExportTest::testHeaderFontStyleXLSX()
{
    ...
    bool bHasBoldItalic = std::any_of(rLst.begin(), rLst.end(), [](const EECharAttrib& rAttrib) {
        return rAttrib.pAttr->Which() == EE_CHAR_WEIGHT && EE_CHAR_ITALIC &&
            static_cast<const SvxPostureItem&>(*rAttrib.pAttr).GetPosture() == WEIGHT_BOLD && ITALIC_NORMAL; });
    CPPUNIT_ASSERT_MESSAGE("Second line should be bold italic.", bHasBoldItalic);
