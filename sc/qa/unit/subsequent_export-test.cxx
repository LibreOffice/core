...
void ScExportTest::testAutofilterColorsODF()
{
    ...
    assertXPath(pDoc, "//table:filter-and/table:filter-condition[1]", "value", "#e8f2a1");
    assertXPath(pDoc, "//table:filter-and/table:filter-condition[1]", "loext:data-type", "background-color");
    assertXPath(pDoc, "//table:filter-and/table:filter-condition[2]", "value", "#3465a4");
    assertXPath(pDoc, "//table:filter-and/table:filter-condition[2]", "loext:data-type", "text-color");
}
