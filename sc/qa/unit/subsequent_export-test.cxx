...
public:
    ...
    CPPUNIT_TEST(testTdf_handle_upright);
...
void ScExportTest::testTdf_handle_upright()
{
    ...
    ScDocShellRef xShell = loadDoc("tdf106197_export_upright.", FORMAT_XLSX);
    CPPUNIT_ASSERT(xShell.is());
