...
public:
    ...
    CPPUNIT_TEST(testCommentTextAlign);
...
void ScExportTest::registerNamespaces(xmlXPathContextPtr& pXmlXPathCtx)
{
    static const struct { xmlChar* pPrefix; xmlChar* pURI; } aNamespaces[] =
    {
        ...
        { BAD_CAST("x"), BAD_CAST("urn:schemas-microsoft-com:office:excel") },
...
void ScExportTest::testCommentTextAlign()
{
    // Testing the text alignment in comment boxes.
    ScDocShellRef xShell = loadDoc("CommentTAlign.", FORMAT_ODS);
    CPPUNIT_ASSERT(xShell.is());
    ...
    assertXPathContent(pVmlDrawing, "/xml/v:shape/x:ClientData/x:TextHAlign", "Center");
    assertXPathContent(pVmlDrawing, "/xml/v:shape/x:ClientData/x:TextVAlign", "Center");
}
