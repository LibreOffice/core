...
void ScExportTest::testColumnWidthResaveXLSX()
{
    ...
    // The last column is not existing in Excel sheet, and it is added by LibreOffice
    // It's column width is default and it is depended on operating system
    assertXPath(pSheet, "/x:worksheet/x:cols/x:col[5]", "customWidth", "false");
