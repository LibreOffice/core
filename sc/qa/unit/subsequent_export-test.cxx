...
void ScExportTest::testTdf91634XLSX()
{
    ...
    xmlDocPtr pDoc2 = XPathHelper::parseExport2(*this, *xDocSh, m_xSFactory, "xl/drawings/_rels/drawing1.xml.rels", FORMAT_XLSX);
    CPPUNIT_ASSERT(pDoc2);
    assertXPath(pDoc2, "/r:Relationships/r:Relationship[@Id='rId1']", "Target", "https://www.google.com/");
    assertXPath(pDoc2, "/r:Relationships/r:Relationship[@Id='rId1']", "TargetMode", "External");
}
