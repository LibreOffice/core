...
{
    // testTdf108673("'Sheet 5'.B1:B5", "'Sheet 5'!$B$1:$B$5");
    testTdf108673("'Sheet 5'.B1:B5", "#REF!");
}

void ScExportTest::testTdf108673_MissingWorksheet_Offset()
{
    testTdf108673("OFFSET(sheet5.a1,5,0,10,1)", "#REF!");
}
...
void ScExportTest::testTdf108673_Resave()
{
    ...
    assertXPathContent(pDoc, "/x:worksheet/x:dataValidations/x:dataValidation/x:formula1", "sheet5!a1:a3");
...
void ScExportTest::testTdf108673_Offset()
{
    ...
    assertXPathContent(pDoc, "/x:worksheet/x:dataValidations/x:dataValidation/x:formula1", "OFFSET(sheet2!a1,5,0,10,1)");
