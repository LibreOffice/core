...
void Test::testInsertColumnsWithFormulaCells()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Columns 2, 4 and 6 should contain formula cells.", aExpected, aCols);
    ...
    aExpected = { 4, 6, 8 };
    aCols = m_pDoc->QueryColumnsWithFormulaCells(0);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Columns 4, 6 and 8 should contain formula cells.", aExpected, aCols);
