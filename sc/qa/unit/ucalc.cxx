...
void Test::checkCopyPasteSpecialMultiRangeCol(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), aString);
    // col 8, numbers
    fValue = m_pDoc->GetValue(8, 0, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    fValue = m_pDoc->GetValue(8, 1, destSheet);
    ASSERT_DOUBLES_EQUAL(121, fValue);
    fValue = m_pDoc->GetValue(8, 2, destSheet);
    ASSERT_DOUBLES_EQUAL(122, fValue);
    fValue = m_pDoc->GetValue(8, 3, destSheet);
    ASSERT_DOUBLES_EQUAL(123, fValue);
    fValue = m_pDoc->GetValue(8, 4, destSheet);
    ASSERT_DOUBLES_EQUAL(124, fValue);
    fValue = m_pDoc->GetValue(8, 5, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
...
void Test::checkCopyPasteSpecialMultiRangeColFilteredTranspose(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), aString);
    // row 6, numbers
    fValue = m_pDoc->GetValue(2, 6, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    fValue = m_pDoc->GetValue(3, 6, destSheet);
    ASSERT_DOUBLES_EQUAL(121, fValue);
    fValue = m_pDoc->GetValue(4, 6, destSheet);
    ASSERT_DOUBLES_EQUAL(123, fValue);
    fValue = m_pDoc->GetValue(5, 6, destSheet);
    ASSERT_DOUBLES_EQUAL(124, fValue);
    fValue = m_pDoc->GetValue(6, 6, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    // row 7, not copied
    fValue = m_pDoc->GetValue(2, 7, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    fValue = m_pDoc->GetValue(3, 7, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    fValue = m_pDoc->GetValue(4, 7, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    fValue = m_pDoc->GetValue(5, 7, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    fValue = m_pDoc->GetValue(6, 7, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    fValue = m_pDoc->GetValue(7, 7, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
    // row 8, not copied
    fValue = m_pDoc->GetValue(2, 7, destSheet);
    ASSERT_DOUBLES_EQUAL(1000, fValue);
