...
void Test::testSortImages()
{
    ...
    // Move to cell B2
    std::vector<SdrObject*> pObjects = { pObj };
    m_pDoc->FetchTable(0)->FetchColumn(1)->UpdateDrawObjectsForRow(pObjects, 1, 1);

    ScAddress aCellPos1(1, 1, 0);
    pObjects = pDrawLayer->GetObjectsAnchoredToCell(aCellPos1);
