...
void ScExportTest::testProtectionKeyODS_UTF16LErtlSHA1()
{
    ...
    assertXPath(pXmlDoc, "//office:spreadsheet[@table:structure-protected='true' and "
                         "@table:protection-key='vbnhxyBKtPHCA1wB21zG1Oha8ZA=' and "
                         "@table:protection-key-digest-algorithm='http://www.w3.org/2000/09/"
                         "xmldsig#sha1']");
...
void ScExportTest::testProtectionKeyODS_XL_SHA1()
{
    ...
    assertXPath(pXmlDoc, "//office:spreadsheet[@table:structure-protected='true' and "
                         ...
                         "@table:protection-key-digest-algorithm='http://docs.oasis-open.org/"
                         "office/ns/table/legacy-hash-excel' and "
                         "@loext:protection-key-digest-algorithm-2='http://www.w3.org/2000/09/"
                         "xmldsig#sha1']");
    assertXPath(pXmlDoc, "//table:table[@table:protected='true' and "
                         "@table:protection-key='OX3WkEe79fv1PE+FUmfOLdwVoqI=' and "
                         "@table:protection-key-digest-algorithm='http://docs.oasis-open.org/"
...
void ScExportTest::testCustomXml()
{
    ...
    assertXPath(pRelsDoc, "/r:Relationships/r:Relationship[@Id='rId1']", "Target",
                "itemProps1.xml");
