...
void Test::testSharedFormulasRefUpdate()
{
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,0,0), "A10"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,1,0), "A11"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,2,0), "A12"));
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,0,0), "A10"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,1,0), "C11"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,2,0), "A12"));
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,0,0), "A10"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,1,0), "A13"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,2,0), "A14"));
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,0,0), "A10"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,1,0), "C11"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,2,0), "C12"));
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,0,0), "C10"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,1,0), "C11"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,2,0), "C12"));
...
void Test::testSharedFormulasRefUpdateRange()
{
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,2,0), "SUM($A$3:$A$5)"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,3,0), "SUM($A$3:$A$5)"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,4,0), "SUM($A$3:$A$5)"));
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,4,0), "SUM($A$5:$A$7)"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,5,0), "SUM($A$5:$A$7)"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,6,0), "SUM($A$5:$A$7)"));
...
void Test::testSharedFormulasRefUpdateExternal()
{
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,6,0), "'file:///extdata.fake'#$Data.A1"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,7,0), "'file:///extdata.fake'#$Data.A2"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,8,0), "'file:///extdata.fake'#$Data.A3"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,9,0), "COUNTA('file:///extdata.fake'#$Data.A1:A3)"));
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,4,0), "'file:///extdata.fake'#$Data.A1"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,5,0), "'file:///extdata.fake'#$Data.A2"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,6,0), "'file:///extdata.fake'#$Data.A3"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,7,0), "COUNTA('file:///extdata.fake'#$Data.A1:A3)"));
...
void Test::testSharedFormulasRefUpdateMoveSheets()
{
    ...
    for (SCROW i = 0; i <= 7; ++i)
    {
        ...
        CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,i,1), "Sheet2!RC"));
    }
    ...
    for (SCROW i = 0; i <= 7; ++i)
    {
        ...
        CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,i,2), "Sheet2!RC"));
    }
...
void Test::testSharedFormulasRefUpdateCopySheets()
{
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,0,0), "$Sheet2.A1"));

    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,1,0), "$Sheet2.A2"));
...
void Test::testSharedFormulasRefUpdateDeleteSheets()
{
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,0,0), "Sheet2.B2"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,1,0), "Sheet2.B3"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,2,0), "Sheet2.B4"));

    // Delete Sheet2.
    ScDocFunc& rFunc = getDocShell().GetDocFunc();
    rFunc.DeleteTable(1, true, true);

    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,0,0), "#REF!.B2"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,1,0), "#REF!.B3"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(0,2,0), "#REF!.B4"));
...
void Test::testSharedFormulaInsertColumn()
{
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(8,1,0), "H3*B3"));

    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(8,2,0), "H4*B4"));
...
void Test::testSharedFormulaUpdateOnNamedRangeChange()
{
    ...
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,0,0), "SUM(MyRange)"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,1,0), "SUM(MyRange)"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,2,0), "SUM(MyRange)"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,4,0), "ROW()"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,6,0), "ROW()"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(1,7,0), "ROW()"));
    CPPUNIT_ASSERT(checkFormula(*m_pDoc, ScAddress(2,0,0), "AVERAGE(MyRange)"));
