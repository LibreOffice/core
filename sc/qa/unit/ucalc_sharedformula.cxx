...
void Test::testSharedFormulaUnshareAreaListeners()
{
    ...
    for (int nRun = 0; nRun < 7; ++nRun)
    {
        ...
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Shared top row.", static_cast<SCROW>(aOrgPos.Row()), pFC->GetSharedTopRow());
        ...
        CPPUNIT_ASSERT(pFC);
        CPPUNIT_ASSERT_MESSAGE("A2", pFC->IsSharedTop());
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Shared top row.", static_cast<SCROW>(aPos.Row()), pFC->GetSharedTopRow());
