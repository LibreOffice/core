...
void Test::testSharedFormulaCutCopyMoveWithinRun()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE( "Number of checks mismatch.", aData.size(), SAL_N_ELEMENTS(fVec0));
    aPos = aFormulaPos;
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE( "Number of checks mismatch.", aData.size(), SAL_N_ELEMENTS(fVec1));
    aPos = aFormulaPos;
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE( "Number of checks mismatch.", aData.size(), SAL_N_ELEMENTS(fVec2));
    aPos = aFormulaPos;
