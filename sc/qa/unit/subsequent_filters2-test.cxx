...
class ScFilters2Test : public test::FiltersTest, public ScBootstrapFixture
{
public:
    ScFilters2Test();
    ...
    CPPUNIT_TEST_SUITE(ScFilters2Test);
...
ScFilters2Test::ScFilters2Test()
    : ScBootstrapFixture("sc/qa/unit/data")
{
}

void ScFilters2Test::setUp()
{
...
void ScFilters2Test::tearDown()
{
    uno::Reference<lang::XComponent>(m_xCalcComponent, UNO_QUERY_THROW)->dispose();
    test::BootstrapFixture::tearDown();
}

bool ScFilters2Test::load(const OUString& rFilter, const OUString& rURL, const OUString& rUserData,
                          SfxFilterFlags nFilterFlags, SotClipboardFormatId nClipboardID,
...
void ScFilters2Test::testMiscRowHeights()
{
...
void ScFilters2Test::testOptimalHeightReset()
{
    // FIXME: the DPI check should be removed when either (1) the test is fixed to work with
    // non-default DPI; or (2) unit tests on Windows are made to use svp VCL plugin.
    if (!IsDefaultDPI())
...
void ScFilters2Test::testCustomNumFormatHybridCellODS()
{
...
void ScFilters2Test::testTdf121040()
{
...
void ScFilters2Test::testTdf118086()
{
...
void ScFilters2Test::testTdf118624()
{
...
void ScFilters2Test::testTdf124454()
{
...
void ScFilters2Test::testPrintRangeODS()
{
...
void ScFilters2Test::testOutlineODS()
{
...
void ScFilters2Test::testColumnStyleXLSX()
{
...
void ScFilters2Test::testColumnStyleAutoFilterXLSX()
{
...
void ScFilters2Test::testSharedFormulaHorizontalXLS()
{
...
void ScFilters2Test::testSharedFormulaWrappedRefsXLS()
{
...
void ScFilters2Test::testSharedFormulaBIFF5()
{
...
void ScFilters2Test::testSharedFormulaXLSB()
{
...
void ScFilters2Test::testSharedFormulaXLS()
{
    {
        // fdo#80091
...
void ScFilters2Test::testSharedFormulaColumnLabelsODS()
{
...
void ScFilters2Test::testSharedFormulaColumnRowLabelsODS()
{
...
void ScFilters2Test::testExternalRefCacheXLSX()
{
...
void ScFilters2Test::testExternalRefCacheODS()
{
...
void ScFilters2Test::testHybridSharedStringODS()
{
...
void ScFilters2Test::testCopyMergedNumberFormats()
{
...
void ScFilters2Test::testVBAUserFunctionXLSM()
{
...
void ScFilters2Test::testEmbeddedImageXLS()
{
...
void ScFilters2Test::testErrorOnExternalReferences()
{
...
void ScFilters2Test::testTdf84762()
{
    ScDocShellRef xDocSh = loadDoc(u"blank.", FORMAT_ODS);
    CPPUNIT_ASSERT_MESSAGE("Failed to open empty doc", xDocSh.is());
...
void ScFilters2Test::testTdf44076()
{
    ScDocShellRef xDocSh = loadDoc(u"blank.", FORMAT_ODS);
    CPPUNIT_ASSERT_MESSAGE("Failed to open empty doc", xDocSh.is());
...
void ScFilters2Test::testEditEngStrikeThroughXLSX()
{
...
void ScFilters2Test::testRefStringXLSX()
{
...
void ScFilters2Test::testTdf130132()
{
...
void ScFilters2Test::testTdf133327()
{
...
void ScFilters2Test::testColumnStyle2XLSX()
{
...
void ScFilters2Test::testTdf110440XLSX()
{
...
void ScFilters2Test::testBnc762542()
{
...
void ScFilters2Test::testHiddenSheetsXLSX()
{
...
void ScFilters2Test::testAutofilterXLSX()
{
...
void ScFilters2Test::testRelFormulaValidationXLS()
{
...
void ScFilters2Test::testTdf136364()
{
...
void ScFilters2Test::testTdf103734()
{
...
void ScFilters2Test::testTdf126116()
{
...
void ScFilters2Test::testTdf98844()
{
...
void ScFilters2Test::testTdf100458()
{
...
void ScFilters2Test::testTdf118561()
{
...
void ScFilters2Test::testTdf125099()
{
...
void ScFilters2Test::testTdf134455()
{
...
void ScFilters2Test::testTdf119533()
{
...
void ScFilters2Test::testTdf127982()
{
...
void ScFilters2Test::testTdf109409()
{
...
void ScFilters2Test::testTdf132105()
{
...
void ScFilters2Test::testTdf131424()
{
...
void ScFilters2Test::testTdf100709XLSX()
{
...
void ScFilters2Test::testTdf97598XLSX()
{
...
void ScFilters2Test::testTdf83672XLSX()
{
...
#ifdef UNX
void ScFilters2Test::testUnicodeFileNameGnumeric()
{
...
void ScFilters2Test::testMergedCellsXLSXML()
{
...
void ScFilters2Test::testBackgroundColorStandardXLSXML()
{
...
void ScFilters2Test::testTdf131536()
{
...
void ScFilters2Test::testTdf130583()
{
...
void ScFilters2Test::testTdf85617()
{
...
void ScFilters2Test::testTdf134234()
{
...
void ScFilters2Test::testTdf42481()
{
...
void ScFilters2Test::testNamedExpressionsXLSXML()
{
    {
...
void ScFilters2Test::testEmptyRowsXLSXML()
{
...
void ScFilters2Test::testBorderDirectionsXLSXML()
{
...
void ScFilters2Test::testBorderColorsXLSXML()
{
...
void ScFilters2Test::testHiddenRowsColumnsXLSXML()
{
...
void ScFilters2Test::testColumnWidthRowHeightXLSXML()
{
...
void ScFilters2Test::testCharacterSetXLSXML()
{
...
void ScFilters2Test::testCondFormatXLSB()
{
...
void ScFilters2Test::testPageScalingXLSX()
{
...
void ScFilters2Test::testActiveXCheckboxXLSX()
{
...
void ScFilters2Test::testtdf120301_xmlSpaceParsingXLSX()
{
...
void ScFilters2Test::testCondFormatFormulaListenerXLSX()
{
...
void ScFilters2Test::testTdf137091()
{
...
void ScFilters2Test::testTdf62268()
{
...
void ScFilters2Test::testTdf137453()
{
...
void ScFilters2Test::testTdf112780()
{
...
void ScFilters2Test::testTdf72470()
{
...
void ScFilters2Test::testTdf35636()
{
...
void ScFilters2Test::testTdf98481()
{
...
void ScFilters2Test::testTdf115022()
{
...
void ScFilters2Test::testVBAMacroFunctionODS()
{
...
void ScFilters2Test::testAutoheight2Rows()
{
...
void ScFilters2Test::testXLSDefColWidth()
{
...
void ScFilters2Test::testPreviewMissingObjLink()
{
...
void ScFilters2Test::testShapeRotationImport()
{
    if (!IsDefaultDPI())
        return;
...
void ScFilters2Test::testShapeDisplacementOnRotationImport()
{
...
void ScFilters2Test::testTextBoxBodyUpright()
{
...
void ScFilters2Test::testTextBoxBodyRotateAngle()
{
...
void ScFilters2Test::testTextLengthDataValidityXLSX()
{
...
void ScFilters2Test::testDeleteCircles()
{
...
void ScFilters2Test::testDrawCircleInMergeCells()
{
...
void ScFilters2Test::testDeleteCirclesInRowAndCol()
{
...
void ScFilters2Test::testTdf129940()
{
...
void ScFilters2Test::testTdf139763ShapeAnchor()
{
...
void ScFilters2Test::testAutofilterNamedRangesXLSX()
{
...
CPPUNIT_TEST_SUITE_REGISTRATION(ScFilters2Test);
