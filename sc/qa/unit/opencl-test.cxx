...
private:
    ...
    void init(const OUString fileName, sal_Int32 nFormat, bool bReadWrite, ScDocument& rDoc, ScDocument &rDocRes);
};

void ScOpenCLTest::init(
                        const OUString fileName, sal_Int32 nFormat, bool bReadWrite, ScDocument& rDoc, ScDocument &rDocRes)
{
