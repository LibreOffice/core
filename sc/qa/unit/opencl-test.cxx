...
void ScOpenCLTest::closeTestEnv()
{
    xDocSh->DoClose();
    xDocShRes->DoClose();
}
...
{
    if(!initTestEnv("opencl/compiler/horizontal.", ODS, false))return;
...
{
    if(!initTestEnv("opencl/compiler/nested.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/compiler/string.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/compiler/ineq.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("stock-history.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
...
{
    if(!initTestEnv("ground-water-daily.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    xDocSh->DoHardRecalc(true);
...
{
    if(!initTestEnv("sum_ex.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/cos.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sinh.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    xDocSh->DoHardRecalc(true);
...
{
    if(!initTestEnv("opencl/math/pi.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/random.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/general.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Correl.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Fisher.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/FisherInv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Gamma.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Fvschedule.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/Abs.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/SYD.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/IRR.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/GammaLn.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Gauss.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/GeoMean.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/HarMean.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/SLN.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/MIRR.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Coupdaybs.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Dollarde.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Coupdays.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Coupdaysnc.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/RATE.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Accrintm.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Coupnum.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Negbinomdist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sin.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sumsq.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/tan.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/tanh.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sqrt.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Price.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Dollarfr.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/PriceDisc.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Oddlprice.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Oddlyield.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/DISC.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/PV.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/INTRATE.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Standard.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Weibull.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Var.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Skew.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Skewp.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Pearson.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Rsq.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/trunc.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/cosh.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Covar.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Kurt.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/cot.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/DevSq.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/csc.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/coth.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/XNPV.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Intercept.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Amordegrc.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/ISPMT.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Median.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Normdist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Normsdist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Permut.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Permutation.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Phi.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/csch.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/LogInv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/NPER.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Forecast.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Amorlinc.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/ddb.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/PriceMat.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Received.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Cumipmt.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Cumprinc.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/RRI.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/EFFECT_ADD.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Nominal.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/TBILLEQ.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/TBILLPRICE.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/TBILLYIELD.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/YIELD.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/YIELDDISC.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/YIELDMAT.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/PMT.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Duration.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/LogNormDist.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcCos.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/power.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/PPMT.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/NPV.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Duration_ADD.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Norminv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Normsinv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcCosHyp.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/MDuration.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcCot.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/FV.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/db.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Couppcd.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sumifs.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    xDocSh->DoHardRecalc(true);
...
{
    if(!initTestEnv("opencl/math/ArcCotHyp.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcSin.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/VDB.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/IPMT.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/XIRR.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/CHISQDIST.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Confidence.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Fdist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Coupncd.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/Accrint.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/CritBinom.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcSinHyp.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcTan.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcTanHyp.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/NPER1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ArcTan2.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/CHISQINV.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/BitAnd.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Poisson.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Expondist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/BitOr.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/odd.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/LN.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/mod.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/ROUND.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/GammaDist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/GammaInv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/FInv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/FTest.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/B.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/BetaDist.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/even.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/exp.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/ChiDist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/BitLshift.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/BitRshift.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/floor.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/log.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/spreadsheet/VLookup.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/ChiInv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/convert.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/countifs.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    xDocSh->DoHardRecalc(true);
...
{
    if(!initTestEnv("opencl/math/BitXor.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/averageifs.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
...
{
    if(!initTestEnv("opencl/math/log10.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/combina.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/Ceil.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sqrtpi.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/VarP.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/StDev.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/StDevP.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Slope.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/STEYX.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/ZTest.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/TTest.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/TDist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/TInv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/BinomDist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/product.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/Kombin.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/array/SUMX2MY2.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/HypGeomDist.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/array/SUMX2PY2.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Betainv.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Mina.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/array/SUMXMY2.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/counta.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Maxa.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sumproduct_mixSliding.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/averageif.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/AverageA.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/logical/and.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/VarA.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/VarPA.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
    // Check the results of formula cells in the shared formula range.
...
{
    if(!initTestEnv("opencl/statistical/StDevA.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/StDevPA.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/financial/MDuration1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sumproductTest.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/parallel_count_bug_243.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/logical/or.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/logical/not.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/logical/xor.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dcount.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dcountA.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dmax.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dmin.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dproduct.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/daverage.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dstdev.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dstdevp.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dsum.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dvar.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/database/dvarp.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/roundup.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/rounddown.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/int.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/radians.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/degrees.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/iseven.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/countif.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/isodd.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/fact.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sec.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sech.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/MROUND.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/Quotient.", ODS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/seriessum.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/sumif.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/addin/besselj.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Avedev.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/NegSub.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/math/averageif_mix.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/Kurt1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/HarMean1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/VarA1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/VarPA1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/StDevA1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
...
{
    if(!initTestEnv("opencl/statistical/StDevPA1.", XLS, false))return;
    ScDocument& rDoc = xDocSh->GetDocument();
    ScDocument& rDocRes = xDocShRes->GetDocument();
    rDoc.CalcAll();
