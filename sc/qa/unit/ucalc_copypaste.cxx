...
private:
    ...
    void executeReferencedCutRangesCol(const bool bTransposed, const SCTAB nSrcTab,
                                       ...
                                       std::unique_ptr<ScUndoCut>& pUndoCut,
                                       std::unique_ptr<ScUndoPaste>& pUndoPaste);
    void checkReferencedCutRangesColIntitial(const SCTAB nSrcTab, const OUString& rDesc);
...
{
    executeCopyPasteSpecial(false, true, false, false, false, true, true);
    checkCopyPasteSpecial(true, true);
}

void TestCopyPaste::testCutPasteSpecialSkipEmptyTranspose()
{
    executeCopyPasteSpecial(false, true, false, true, false, true, true);
...
void TestCopyPaste::checkReferencedCutRangesColIntitial(const SCTAB nSrcTab, const OUString& rDesc)
{
                                                  ...
                                                  std::unique_ptr<ScUndoPaste>& pUndoPaste)
{
    ...
    // Check precondition
    checkReferencedCutRangesColIntitial(nSrcTab, "Initial");
...
void TestCopyPaste::testReferencedCutRangesCol()
{
    ...
    pUndoPaste->Undo();
    pUndoCut->Undo();
    checkReferencedCutRangesColIntitial(nSrcTab, "After undo");
