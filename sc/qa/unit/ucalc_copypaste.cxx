                                            ...
                                            InsertDeleteFlags aFlags)
{
    ...
    */
    ...
    if (bApplyFilter)
    {
        ...
        SCROW nRow1, nRow2;
        SCROW nFilteredRow1, nFilteredRow2;
        bool bHidden = m_pDoc->RowHidden(3, srcSheet, &nRow1, &nRow2);
        CPPUNIT_ASSERT_MESSAGE("row 3 should be hidden", bHidden);
        CPPUNIT_ASSERT_EQUAL_MESSAGE("row 3 should be hidden", 3, nRow1);
        CPPUNIT_ASSERT_EQUAL_MESSAGE("row 3 should be hidden", 3, nRow2);
        bool bFiltered = m_pDoc->RowFiltered(3, srcSheet, &nFilteredRow1, &nFilteredRow2);
        CPPUNIT_ASSERT_MESSAGE("row 3 should be filtered", bFiltered);
        CPPUNIT_ASSERT_EQUAL_MESSAGE("row 3 should be filtered", 3, nFilteredRow1);
        CPPUNIT_ASSERT_EQUAL_MESSAGE("row 3 should be filtered", 3, nFilteredRow2);
    }
