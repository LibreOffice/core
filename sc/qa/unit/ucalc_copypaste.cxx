...
void TestCopyPaste::testCopyPaste()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        ...
        m_pDoc->GetNote(0, 0, 0)->GetText(),
        m_pDoc->GetNote(0, 1, 1)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        "Note content on Sheet1.B1 not copied to Sheet2.B2, formula cell content",
        m_pDoc->GetNote(1, 0, 0)->GetText(),
        m_pDoc->GetNote(1, 1, 1)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        "Note content on Sheet1.C1 not copied to Sheet2.C2, string cell content",
        m_pDoc->GetNote(2, 0, 0)->GetText(),
        m_pDoc->GetNote(2, 1, 1)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialInitial(const SCTAB srcSheet)
{
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("Note A1"), m_pDoc->GetNote(1, 2, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A2"), m_pDoc->GetNote(1, 3, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A3"), m_pDoc->GetNote(1, 4, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B1"), m_pDoc->GetNote(2, 2, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B3"), m_pDoc->GetNote(2, 4, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C2"), m_pDoc->GetNote(3, 3, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C3"), m_pDoc->GetNote(3, 4, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D1"), m_pDoc->GetNote(4, 2, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D2"), m_pDoc->GetNote(4, 3, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D3"), m_pDoc->GetNote(4, 4, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(5, 4, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E4"), m_pDoc->GetNote(5, 5, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F2"), m_pDoc->GetNote(6, 3, srcSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F4"), m_pDoc->GetNote(6, 5, srcSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecial(bool bSkipEmpty, bool bCut)
{
    ...
    */
    ...
    // check values of notes
    CPPUNIT_ASSERT_EQUAL(OUString("Note A1"), m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A2"), m_pDoc->GetNote(3, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A3"), m_pDoc->GetNote(3, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B1"), m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B3"), m_pDoc->GetNote(4, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C2"), m_pDoc->GetNote(5, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C3"), m_pDoc->GetNote(5, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D1"), m_pDoc->GetNote(6, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D2"), m_pDoc->GetNote(6, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D3"), m_pDoc->GetNote(6, 3, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(7, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E4"), m_pDoc->GetNote(7, 4, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note F2"), m_pDoc->GetNote(8, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F4"), m_pDoc->GetNote(8, 4, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialFiltered(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(7, 0, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("=D2+D4+60"), getFormula(7, 1, destSheet));
    CPPUNIT_ASSERT_EQUAL(65.0, m_pDoc->GetValue(7, 1, destSheet)); // formula is not adjusted due to filter row
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(EMPTY_OUSTRING, m_pDoc->GetString(7, 2, destSheet));
    else
        CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 2, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL(1061.0, m_pDoc->GetValue(7, 4, destSheet)); // formula is not adjusted due to filter row
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(7, 5, destSheet));
    // col 8, formulas
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(8, 0, destSheet));
    ...
    // check values of notes
    CPPUNIT_ASSERT_EQUAL(OUString("Note A1"), m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A3"), m_pDoc->GetNote(3, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B1"), m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B3"), m_pDoc->GetNote(4, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C3"), m_pDoc->GetNote(5, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D1"), m_pDoc->GetNote(6, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D3"), m_pDoc->GetNote(6, 2, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(7, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E4"), m_pDoc->GetNote(7, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F4"), m_pDoc->GetNote(8, 3, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialTranspose(bool bSkipEmpty, bool bCut)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D3 should point on D2", OUString("=D2+10"), getFormula(3, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D3", 11.0, m_pDoc->GetValue(3, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed E3 should point on E2", OUString("=E2+20"), getFormula(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed E3", 22.0, m_pDoc->GetValue(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F3 should point on F2", OUString("=F5+30"), getFormula(5, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F3", 35.0, m_pDoc->GetValue(5, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed G3 should point on E2", OUString("=E2+40"), getFormula(6, 2, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D4 should contain: a", OUString("a"), m_pDoc->GetString(3, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4 should contain: b", OUString("b"), m_pDoc->GetString(4, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4 should contain: c", OUString("c"), m_pDoc->GetString(5, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G4 should contain: d", OUString("d"), m_pDoc->GetString(6, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 3, destSheet));
    ...
    // check values of notes
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D2", OUString("Note A1"), m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E2", OUString("Note A2"),
                                 m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F2", OUString("Note A3"),
                                 m_pDoc->GetNote(5, 1, destSheet)->GetText());
    // G2 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D3", OUString("Note B1"),
                                 m_pDoc->GetNote(3, 2, destSheet)->GetText());
    // E3 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F3", OUString("Note B3"),
                                 m_pDoc->GetNote(5, 2, destSheet)->GetText());
    // D4 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4", OUString("Note C2"),
                                 m_pDoc->GetNote(4, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4", OUString("Note C3"),
                                 m_pDoc->GetNote(5, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on D5", OUString("Note D1"),
                                 m_pDoc->GetNote(3, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on E5", OUString("Note D2"),
                                 m_pDoc->GetNote(4, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on F5", OUString("Note D3"),
                                 m_pDoc->GetNote(5, 4, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(5, 5, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on G6", OUString("Note E4"),
                                 m_pDoc->GetNote(6, 5, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on E7", OUString("Note F2"),
                                     m_pDoc->GetNote(4, 6, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on G7", OUString("Note F4"),
                                 m_pDoc->GetNote(6, 6, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialFilteredTranspose(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed cell G2 (repetition of D2)", 1.0, m_pDoc->GetValue(6, 1, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 1, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D3", 11.0, m_pDoc->GetValue(3, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D3 should point on D2", OUString("=D2+10"), getFormula(3, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed E3 should point on E2", OUString("=E5+30"), getFormula(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed E3", 35.0, m_pDoc->GetValue(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F3 should point on F2", OUString("=D2+40"), getFormula(5, 2, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed G3 should point on G2 (repetition of D3)", OUString("=G2+10"), getFormula(6, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(7, 2, destSheet));
    // row 3, strings
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(2, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(2, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D4 should contain: a", OUString("a"), m_pDoc->GetString(3, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4 should contain: c", OUString("c"), m_pDoc->GetString(4, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4 should contain: d", OUString("d"), m_pDoc->GetString(5, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G4 should contain: a (repetition of D4)", OUString("a"), m_pDoc->GetString(6, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(7, 3, destSheet));
    // row 4, rich text
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(2, 4, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D6", 65.0, m_pDoc->GetValue( ScAddress(3, 5, destSheet)));
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E6", EMPTY_OUSTRING, m_pDoc->GetString(4, 5, destSheet));
    else
        CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(4, 5, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F6", 1073.0, m_pDoc->GetValue( ScAddress(5, 5, destSheet)));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed G6 (repetition of D6)", OUString("=G2+I2+60"), getFormula(6, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed G6 (repetition of D6)", 1061.0, m_pDoc->GetValue(6, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(7, 5, destSheet));
    // row 6, formulas
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(2, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(2, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D7", OUString("=SUMIF(D2:G2;\"<4\")"), getFormula(3, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D7", 5.0, m_pDoc->GetValue(3, 6, destSheet));
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E6", EMPTY_OUSTRING, m_pDoc->GetString(4, 6, destSheet));
    else
        CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(4, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F7", OUString("=B$3+$B$5+80"), getFormula(5, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F6", 2080.0, m_pDoc->GetValue(5, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed G7 (repetition of D7)", OUString("=SUMIF(G2:J2;\"<4\")"), getFormula(6, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed G7 (repetition of D7)", 1061.0, m_pDoc->GetValue(6, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(7, 6, destSheet));
    ...
    // check values of notes
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D2", OUString("Note A1"),
                                 m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E2", OUString("Note A3"),
                                 m_pDoc->GetNote(4, 1, destSheet)->GetText());
    // F2 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G2", OUString("Note A1"),
                                 m_pDoc->GetNote(6, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D3", OUString("Note B1"),
                                 m_pDoc->GetNote(3, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E3", OUString("Note B3"),
                                 m_pDoc->GetNote(4, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F3", OUString("Note B4"),
                                 m_pDoc->GetNote(5, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G3", OUString("Note B1"),
                                 m_pDoc->GetNote(6, 2, destSheet)->GetText());
    // D4 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4", OUString("Note C3"),
                                 m_pDoc->GetNote(4, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4", OUString("Note C4"),
                                 m_pDoc->GetNote(5, 3, destSheet)->GetText());
    // G4 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on D5", OUString("Note D1"),
                                 m_pDoc->GetNote(3, 4, destSheet)->GetText());
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on G5", OUString("Note D1"),
                                 m_pDoc->GetNote(6, 4, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(4, 5, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on F6", OUString("Note E4"),
                                 m_pDoc->GetNote(5, 5, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on F7", OUString("Note F4"),
                                 m_pDoc->GetNote(5, 6, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeCol(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL(22.0, m_pDoc->GetValue(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("=G4+30"), getFormula(4, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL(bSkipEmpty ? 1030.0 : 30.0, m_pDoc->GetValue(4, 3, destSheet)); // It was 35
    CPPUNIT_ASSERT_EQUAL(OUString("=D3+40"), getFormula(4, 4, destSheet));
    CPPUNIT_ASSERT_EQUAL(42.0, m_pDoc->GetValue(4, 4, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(4, 5, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("Note B1"), m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B3"), m_pDoc->GetNote(4, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D1"), m_pDoc->GetNote(5, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D2"), m_pDoc->GetNote(5, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D3"), m_pDoc->GetNote(5, 3, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(6, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E4"), m_pDoc->GetNote(6, 4, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note F2"), m_pDoc->GetNote(7, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F4"), m_pDoc->GetNote(7, 4, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeColFiltered(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("=G3+30"), getFormula(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL(bSkipEmpty ? 1030.0 : 30.0, m_pDoc->GetValue(4, 2, destSheet)); // It was 35
    CPPUNIT_ASSERT_EQUAL(OUString("=D2+40"), getFormula(4, 3, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("Note B3"), m_pDoc->GetNote(4, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D1"), m_pDoc->GetNote(5, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D3"), m_pDoc->GetNote(5, 2, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(6, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E4"), m_pDoc->GetNote(6, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F4"), m_pDoc->GetNote(7, 3, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeColTranspose(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL(bSkipEmpty ? 1030.0 : 30.0, m_pDoc->GetValue(5, 2, destSheet)); // It was 35
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("Note A1"), m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A2"), m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A3"), m_pDoc->GetNote(5, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B1"), m_pDoc->GetNote(3, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B3"), m_pDoc->GetNote(5, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D1"), m_pDoc->GetNote(3, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D2"), m_pDoc->GetNote(4, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D3"), m_pDoc->GetNote(5, 3, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(5, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E4"), m_pDoc->GetNote(6, 4, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note F2"), m_pDoc->GetNote(4, 5, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F4"), m_pDoc->GetNote(6, 5, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeColFilteredTranspose(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL(41.0, m_pDoc->GetValue(5, 2, destSheet)); // was originally 42, not adjusted by filtering
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(6, 2, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL(OUString("Note A1"), m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note A3"), m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B1"), m_pDoc->GetNote(3, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note B3"), m_pDoc->GetNote(4, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D1"), m_pDoc->GetNote(3, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note D3"), m_pDoc->GetNote(4, 3, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(4, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note E4"), m_pDoc->GetNote(5, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note F4"), m_pDoc->GetNote(5, 5, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeRow(bool bSkipEmpty)
{
    ...
    */
    ...
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note F2"), m_pDoc->GetNote(8, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C5"), m_pDoc->GetNote(5, 4, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeRowFiltered(bool bSkipEmpty)
{
    ...
    */
    ...
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(7, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C5"), m_pDoc->GetNote(5, 3, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeRowTranspose(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F3", 35.0, m_pDoc->GetValue(5, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed F3 should point on F2", OUString("=F5+30"), getFormula(5, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G4 should contain: q", OUString("q"), m_pDoc->GetString(6, 2, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4 should contain: b", OUString("b"), m_pDoc->GetString(4, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4 should contain: c", OUString("c"), m_pDoc->GetString(5, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G4 should contain: r", OUString("r"), m_pDoc->GetString(6, 3, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Edit cell value wrong E5.", OUString("R2"), pEditObj->GetText(0));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed cell F5", 5.0, m_pDoc->GetValue(5, 4, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G5 should contain: s", OUString("s"), m_pDoc->GetString(6, 4, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G6 should contain: t", OUString("t"), m_pDoc->GetString(6, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL(-15.0, m_pDoc->GetValue(7, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(8, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL(OUString("1000"), m_pDoc->GetString(8, 5, destSheet));
    // row 6, formulas
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell G7 should contain: u", OUString("u"), m_pDoc->GetString(6, 6, destSheet));
    ...
    // check values of notes
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D2", OUString("Note A1"), m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E2", OUString("Note A2"), m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F2", OUString("Note A3"), m_pDoc->GetNote(5, 1, destSheet)->GetText());
    // G2 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D3", OUString("Note B1"), m_pDoc->GetNote(3, 2, destSheet)->GetText());
    // E3 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F3", OUString("Note B3"), m_pDoc->GetNote(5, 2, destSheet)->GetText());
    // D4 has no note
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4", OUString("Note C2"), m_pDoc->GetNote(4, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4", OUString("Note C3"), m_pDoc->GetNote(5, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on D5", OUString("Note D1"), m_pDoc->GetNote(3, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on E5", OUString("Note D2"), m_pDoc->GetNote(4, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on F5", OUString("Note D3"), m_pDoc->GetNote(5, 4, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(5, 5, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on E7", OUString("Note F2"), m_pDoc->GetNote(4, 6, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C5"), m_pDoc->GetNote(6, 3, destSheet)->GetText());
...
void TestCopyPaste::checkCopyPasteSpecialMultiRangeRowFilteredTranspose(bool bSkipEmpty)
{
    ...
    */
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed D3 should point on D2", OUString("=D2+10"), getFormula(3, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed E3", 35.0, m_pDoc->GetValue(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed E3 should point on F2", OUString("=E5+30"), getFormula(4, 2, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4 should contain: q", OUString("q"), m_pDoc->GetString(5, 2, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D4 should contain: a", OUString("a"), m_pDoc->GetString(3, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4 should contain: c", OUString("c"), m_pDoc->GetString(4, 3, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F4 should contain: r", OUString("r"), m_pDoc->GetString(5, 3, destSheet));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Edit cell value wrong in D5 ", OUString("R1"),
                                 pEditObj->GetText(0));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("transposed cell E5", 5.0, m_pDoc->GetValue(4, 4, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F5 should contain: s", OUString("s"), m_pDoc->GetString(5, 4, destSheet));
    CPPUNIT_ASSERT_EQUAL(-14.0, m_pDoc->GetValue(6, 4, destSheet));
    CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(7, 4, destSheet));
    pEditObj = m_pDoc->GetEditText(ScAddress(7, 4, destSheet));
    CPPUNIT_ASSERT_MESSAGE("There should be no edit cell in H5.", pEditObj == nullptr);
    ...
    if (!bSkipEmpty)
    {
        ...
        CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(4, 5, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F6 should contain: t", OUString("t"), m_pDoc->GetString(5, 5, destSheet));
    ...
    if (!bSkipEmpty)
        ...
        CPPUNIT_ASSERT_EQUAL(1000.0, m_pDoc->GetValue(4, 6, destSheet));
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell F7 should contain: u", OUString("u"), m_pDoc->GetString(5, 6, destSheet));
    ...
    // check values of notes
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D2", OUString("Note A1"), m_pDoc->GetNote(3, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E2", OUString("Note A3"), m_pDoc->GetNote(4, 1, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell D3", OUString("Note B1"), m_pDoc->GetNote(3, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E3", OUString("Note B3"), m_pDoc->GetNote(4, 2, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Cell E4", OUString("Note C3"), m_pDoc->GetNote(4, 3, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on D5", OUString("Note D1"), m_pDoc->GetNote(3, 4, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL_MESSAGE("Content of cell note on E5", OUString("Note D3"), m_pDoc->GetNote(4, 4, destSheet)->GetText());
    if (!bSkipEmpty)
        CPPUNIT_ASSERT_EQUAL(OUString("Note E2"), m_pDoc->GetNote(4, 5, destSheet)->GetText());
    CPPUNIT_ASSERT_EQUAL(OUString("Note C5"), m_pDoc->GetNote(5, 3, destSheet)->GetText());
