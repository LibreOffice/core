...
private:
    ...
    void executeReferencedCutRangesCol(const bool bTransposed, const SCTAB nSrcTab,
                                       ...
                                       std::unique_ptr<ScUndoCut>& pUndoCut,
                                       std::unique_ptr<ScUndoPaste>& pUndoPaste);
    void checkReferencedCutRangesColIntitial(const SCTAB nSrcTab,  const SCTAB nDestTab, const OUString& rDesc);
...
void TestCopyPaste::checkReferencedCutRangesColIntitial(const SCTAB nSrcTab,  const SCTAB nDestTab, const OUString& rDesc)
{
