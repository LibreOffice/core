...
{
    OUString aFilterName = OUString::fromUtf8(aFileFormats[nFormat].pFilterName);
    OUString aFilterType = OUString::fromUtf8(aFileFormats[nFormat].pTypeName);
    ...
    return load(bReadWrite, rURL, aFilterName, OUString(), aFilterType, nFormatType, nClipboardId,
                static_cast<sal_uIntPtr>(nFormatType));
}
