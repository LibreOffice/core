...
ScDocShellRef ScBootstrapFixture::load( bool bReadWrite,
    ...
    sal_uInt32 nFilterVersion, const OUString* pPassword )
{
    ...
    std::u16string_view rFileName, sal_Int32 nFormat, bool bReadWrite )
{
    ...
    return load(bReadWrite, aFileName, aFilterName, OUString(), aFilterType, nFormatType, nClipboardId, static_cast<sal_uInt32>(nFormatType));
}
