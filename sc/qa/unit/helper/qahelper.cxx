...
ScUndoCut* cutToClip(ScDocShell& rDocSh, const ScRange& rRange, const ScDocumentRef& pClipDoc, bool bCreateUndo)
{
...
void copyToClip(ScDocument* pSrcDoc, const ScRange& rRange, const ScDocumentRef& pClipDoc)
{
...
void pasteFromClip(ScDocument* pDestDoc, const ScRange& rDestRange, const ScDocumentRef& pClipDoc)
{
...
void pasteOneCellFromClip(ScDocument* pDestDoc, const ScRange& rDestRange, const ScDocumentRef& pClipDoc, InsertDeleteFlags eFlags)
{
    ScMarkData aMark(pDestDoc->GetSheetLimits());
    aMark.SetMarkArea(rDestRange);
