...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testTdf144308)
{
    ...
    sal_Bool bOldValue = xGlobalSheetSettings->getDoAutoComplete();

    xGlobalSheetSettings->setDoAutoComplete(static_cast<sal_Bool>(true));
    ...
    xGlobalSheetSettings->setDoAutoComplete(static_cast<sal_Bool>(false));
