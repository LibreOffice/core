...
CPPUNIT_TEST_FIXTURE(ScUiCalcTest, testExternalReferences)
{
    ...
    {
        // tdf#115162
        OUString aFormula = "=SUMIFS('" + aTempFile.GetURL() + "'#$Sheet1.C2:C4,'"
                            + aTempFile.GetURL() + "'#$Sheet1.B2:B4,1,'" + aTempFile.GetURL()
                            + "'#$Sheet1.A2:A4,2015)";
    ...
    {
        // tdf#114820
        OUString aFormula = "=VLOOKUP('" + aTempFile.GetURL() + "'#$Sheet1.A2;'"
                            + aTempFile.GetURL() + "'#$Sheet1.A2:B4,2,0)";
        insertStringToCell(*pModelObj, "A1", aFormula.toUtf8().getStr());
    ...
    {
        // tdf#116149
        OUString aFormula = "=VAR('" + aTempFile.GetURL() + "'#$Sheet1.C2;'" + aTempFile.GetURL()
                            + "'#$Sheet1.C3)";
        insertStringToCell(*pModelObj, "A1", aFormula.toUtf8().getStr());
    ...
    {
        //tdf#36387
        OUString aAndFormula = "=AND('" + aTempFile.GetURL() + "'#$Sheet1.A2:C2)";
        insertStringToCell(*pModelObj, "A1", aAndFormula.toUtf8().getStr());

        OUString aOrFormula = "=OR('" + aTempFile.GetURL() + "'#$Sheet1.A2:C2)";
