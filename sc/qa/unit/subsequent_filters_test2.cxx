...
void ScFiltersTest2::testTdf147014()
{
    ...
    uno::Reference<drawing::XDrawPageSupplier> xDrawPageSupplier(xIA->getByIndex(0),
                                                                 uno::UNO_QUERY_THROW);
    xIA.set(xDrawPageSupplier->getDrawPage(), uno::UNO_QUERY_THROW);
    // The sheet ha a single shape, without the fix it was not imported, except in 32-bit builds
    CPPUNIT_ASSERT_MESSAGE("Shape not imported", xIA->getCount() == static_cast<sal_Int32>(1));
