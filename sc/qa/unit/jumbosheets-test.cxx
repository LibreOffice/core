...
void ScJumboSheetsTest::testTdf134553()
{
    ...
    CPPUNIT_ASSERT_EQUAL(tools::Long(12741), pOleObj->GetLogicRect().getHalfOpenWidth());
    CPPUNIT_ASSERT_EQUAL(tools::Long(7620), pOleObj->GetLogicRect().getHalfOpenHeight());
