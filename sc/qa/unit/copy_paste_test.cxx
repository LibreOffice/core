...
void ScCopyPasteTest::testTdf40993_fillMergedCells()
{
    ...
    CPPUNIT_ASSERT_EQUAL(lcl_getMergeFlagOfCell(rDoc, 7, 21, 0), lcl_getMergeFlagOfCell(rDoc, 7, 10, 0));
    ...
    CPPUNIT_ASSERT_EQUAL(lcl_getMergeSizeOfCell(rDoc, 8, 21, 0), lcl_getMergeSizeOfCell(rDoc, 8, 10, 0));
