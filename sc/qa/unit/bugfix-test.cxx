...
void ScFiltersTest::testTdf129789()
{
    ...
    {
        // Fill: None
        ScAddress aPosB2(1, 1, 0);
        ScPostIt *pNoteB2 = rDoc.GetNote(aPosB2);

        CPPUNIT_ASSERT(pNoteB2);
        CPPUNIT_ASSERT(pNoteB2->IsCaptionShown());

        SdrCaptionObj *const pCaptionB2 = pNoteB2->GetCaption();
        CPPUNIT_ASSERT(pCaptionB2);
        ...
        ScAddress aPosB9(1, 8, 0);
        ScPostIt *pNoteB9 = rDoc.GetNote(aPosB9);

        CPPUNIT_ASSERT(pNoteB9);
        CPPUNIT_ASSERT(!pNoteB9->IsCaptionShown());

        pNoteB9->ShowCaption(aPosB9, true);

        SdrCaptionObj *const pCaptionB9 = pNoteB9->GetCaption();
        CPPUNIT_ASSERT(pCaptionB9);
    ...
    {
        // Fill: Solid
        ScAddress aPosE2(4, 1, 0);
        ScPostIt *pNoteE2 = rDoc.GetNote(aPosE2);

        CPPUNIT_ASSERT(pNoteE2);
        CPPUNIT_ASSERT(pNoteE2->IsCaptionShown());

        SdrCaptionObj *const pCaptionE2 = pNoteE2->GetCaption();
        CPPUNIT_ASSERT(pCaptionE2);
        ...
        ScAddress aPosE9(4, 8, 0);
        ScPostIt *pNoteE9 = rDoc.GetNote(aPosE9);

        CPPUNIT_ASSERT(pNoteE9);
        CPPUNIT_ASSERT(!pNoteE9->IsCaptionShown());

        pNoteE9->ShowCaption(aPosE9, true);

        SdrCaptionObj *const pCaptionE9 = pNoteE9->GetCaption();
        CPPUNIT_ASSERT(pCaptionE9);
    ...
    {
        // Fill: Gradient
        ScAddress aPosH2(7, 1, 0);
        ScPostIt *pNoteH2 = rDoc.GetNote(aPosH2);

        CPPUNIT_ASSERT(pNoteH2);
        CPPUNIT_ASSERT(pNoteH2->IsCaptionShown());

        SdrCaptionObj *const pCaptionH2 = pNoteH2->GetCaption();
        CPPUNIT_ASSERT(pCaptionH2);
        ...
        ScAddress aPosH9(7, 8, 0);
        ScPostIt *pNoteH9 = rDoc.GetNote(aPosH9);

        CPPUNIT_ASSERT(pNoteH9);
        CPPUNIT_ASSERT(!pNoteH9->IsCaptionShown());

        pNoteH9->ShowCaption(aPosH9, true);

        SdrCaptionObj *const pCaptionH9 = pNoteH9->GetCaption();
        CPPUNIT_ASSERT(pCaptionH9);
    ...
    {
        // Fill: Hatch
        ScAddress aPosK2(10, 1, 0);
        ScPostIt *pNoteK2 = rDoc.GetNote(aPosK2);

        CPPUNIT_ASSERT(pNoteK2);
        CPPUNIT_ASSERT(pNoteK2->IsCaptionShown());

        SdrCaptionObj *const pCaptionK2 = pNoteK2->GetCaption();
        CPPUNIT_ASSERT(pCaptionK2);
        ...
        ScAddress aPosK9(10, 8, 0);
        ScPostIt *pNoteK9 = rDoc.GetNote(aPosK9);

        CPPUNIT_ASSERT(pNoteK9);
        CPPUNIT_ASSERT(!pNoteK9->IsCaptionShown());

        pNoteK9->ShowCaption(aPosK9, true);

        SdrCaptionObj *const pCaptionK9 = pNoteK9->GetCaption();
        CPPUNIT_ASSERT(pCaptionK9);
    ...
    {
        // Fill: Bitmap
        ScAddress aPosN2(13, 1, 0);
        ScPostIt *pNoteN2 = rDoc.GetNote(aPosN2);

        CPPUNIT_ASSERT(pNoteN2);
        CPPUNIT_ASSERT(pNoteN2->IsCaptionShown());

        SdrCaptionObj *const pCaptionN2 = pNoteN2->GetCaption();
        CPPUNIT_ASSERT(pCaptionN2);
        ...
        ScAddress aPosN9(13, 8, 0);
        ScPostIt *pNoteN9 = rDoc.GetNote(aPosN9);

        CPPUNIT_ASSERT(pNoteN9);
        CPPUNIT_ASSERT(!pNoteN9->IsCaptionShown());

        pNoteN9->ShowCaption(aPosN9, true);

        SdrCaptionObj *const pCaptionN9 = pNoteN9->GetCaption();
        CPPUNIT_ASSERT(pCaptionN9);
