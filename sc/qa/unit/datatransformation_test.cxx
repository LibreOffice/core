...
void ScDataTransformationTest::testNumberRound()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double)2034.3425, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double)2342.2527, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double)57453.6513, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double)-453.2223, m_pDoc->GetValue(2, 3, 0));
}
...
void ScDataTransformationTest::testNumberRoundUp()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double)2035, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double)2343, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double)57454, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double)-453, m_pDoc->GetValue(2, 3, 0));
}
...
void ScDataTransformationTest::testNumberRoundDown()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double) 2034, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double) 2342, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double) 57453, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double) -454, m_pDoc->GetValue(2, 3, 0));
}
...
void ScDataTransformationTest::testNumberAbsolute()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double) 2034.34, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double) 2342.22, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double) 57453.65, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double) 453.22, m_pDoc->GetValue(2, 3, 0));
}
...
void ScDataTransformationTest::testNumberCube()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double) 8, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double) -8, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double) 512, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double) -512, m_pDoc->GetValue(2, 3, 0));
}
...
void ScDataTransformationTest::testNumberSquare()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double) 4, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double) 4, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double) 64, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double) 64, m_pDoc->GetValue(2, 3, 0));
}
...
void ScDataTransformationTest::testNumberEven()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double) 1, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double) 0, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double) 0, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double) 0, m_pDoc->GetValue(2, 3, 0));
}
...
void ScDataTransformationTest::testNumberOdd()
{
    ...
    CPPUNIT_ASSERT_EQUAL((double) 0, m_pDoc->GetValue(2, 0, 0));
    CPPUNIT_ASSERT_EQUAL((double) 1, m_pDoc->GetValue(2, 1, 0));
    CPPUNIT_ASSERT_EQUAL((double) 0, m_pDoc->GetValue(2, 2, 0));
    CPPUNIT_ASSERT_EQUAL((double) 1, m_pDoc->GetValue(2, 3, 0));
}
