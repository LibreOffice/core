...
void Test::testFormulaParseReference()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Should fail to parse.", (nRes & ScAddr::VALID) == 0);
    ...
    CPPUNIT_ASSERT_EQUAL(nRes & (ScAddr::COL_VALID | ScAddr::ROW_VALID | ScAddr::TAB_VALID |
                ScAddr::COL2_VALID | ScAddr::ROW2_VALID | ScAddr::TAB2_VALID),
            (ScAddr::COL_VALID | ScAddr::ROW_VALID | ScAddr::TAB_VALID |
             ScAddr::COL2_VALID | ScAddr::ROW2_VALID | ScAddr::TAB2_VALID));
    CPPUNIT_ASSERT_EQUAL(nRes & (ScAddr::COL_ABSOLUTE | ScAddr::COL2_ABSOLUTE), 0);
    CPPUNIT_ASSERT_EQUAL(nRes & (ScAddr::ROW_ABSOLUTE | ScAddr::ROW2_ABSOLUTE), (ScAddr::ROW_ABSOLUTE | ScAddr::ROW2_ABSOLUTE));
    ...
    CPPUNIT_ASSERT_EQUAL(nRes & (ScAddr::COL_VALID | ScAddr::ROW_VALID | ScAddr::TAB_VALID |
            ...
            (ScAddr::COL_VALID | ScAddr::ROW_VALID | ScAddr::TAB_VALID |
             ScAddr::COL2_VALID | ScAddr::ROW2_VALID | ScAddr::TAB2_VALID));
    CPPUNIT_ASSERT_EQUAL(nRes & (ScAddr::ROW_ABSOLUTE | ScAddr::ROW2_ABSOLUTE), 0);
    CPPUNIT_ASSERT_EQUAL(nRes & (ScAddr::COL_ABSOLUTE | ScAddr::COL2_ABSOLUTE), (ScAddr::COL_ABSOLUTE | ScAddr::COL2_ABSOLUTE));
