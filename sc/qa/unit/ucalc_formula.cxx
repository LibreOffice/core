...
void Test::testFormulaParseReference()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("Should fail to parse.", (nRes & static_cast<sal_uInt16>(ScAddr::VALID)) == 0);
    ...
    CPPUNIT_ASSERT_EQUAL(nRes & (static_cast<sal_uInt16>(ScAddr::COL_VALID) | static_cast<sal_uInt16>(ScAddr::ROW_VALID) | static_cast<sal_uInt16>(ScAddr::TAB_VALID) |
            ...
            (static_cast<sal_uInt16>(ScAddr::COL_VALID) | static_cast<sal_uInt16>(ScAddr::ROW_VALID) | static_cast<sal_uInt16>(ScAddr::TAB_VALID) |
             static_cast<sal_uInt16>(ScAddr::COL2_VALID) | static_cast<sal_uInt16>(ScAddr::ROW2_VALID) | static_cast<sal_uInt16>(ScAddr::TAB2_VALID)));
    CPPUNIT_ASSERT_EQUAL(nRes & (static_cast<sal_uInt16>(ScAddr::COL_ABSOLUTE) | static_cast<sal_uInt16>(ScAddr::COL2_ABSOLUTE)), 0);
    CPPUNIT_ASSERT_EQUAL(nRes & (static_cast<sal_uInt16>(ScAddr::ROW_ABSOLUTE) | static_cast<sal_uInt16>(ScAddr::ROW2_ABSOLUTE)), (static_cast<sal_uInt16>(ScAddr::ROW_ABSOLUTE) | static_cast<sal_uInt16>(ScAddr::ROW2_ABSOLUTE)));
    ...
    CPPUNIT_ASSERT_EQUAL(nRes & (static_cast<sal_uInt16>(ScAddr::COL_VALID) | static_cast<sal_uInt16>(ScAddr::ROW_VALID) | static_cast<sal_uInt16>(ScAddr::TAB_VALID) |
            ...
            (static_cast<sal_uInt16>(ScAddr::COL_VALID) | static_cast<sal_uInt16>(ScAddr::ROW_VALID) | static_cast<sal_uInt16>(ScAddr::TAB_VALID) |
             static_cast<sal_uInt16>(ScAddr::COL2_VALID) | static_cast<sal_uInt16>(ScAddr::ROW2_VALID) | static_cast<sal_uInt16>(ScAddr::TAB2_VALID)));
    CPPUNIT_ASSERT_EQUAL(nRes & (static_cast<sal_uInt16>(ScAddr::ROW_ABSOLUTE) | static_cast<sal_uInt16>(ScAddr::ROW2_ABSOLUTE)), 0);
    CPPUNIT_ASSERT_EQUAL(nRes & (static_cast<sal_uInt16>(ScAddr::COL_ABSOLUTE) | static_cast<sal_uInt16>(ScAddr::COL2_ABSOLUTE)), (static_cast<sal_uInt16>(ScAddr::COL_ABSOLUTE) | static_cast<sal_uInt16>(ScAddr::COL2_ABSOLUTE)));
...
void Test::testFuncTableRef()
{
    ...
    for (size_t i = 0, n = SAL_N_ELEMENTS(aNames); i < n; ++i)
    {
        ...
        OUString aPrefix( aPos.Format(static_cast<sal_uInt16>(ScAddr::VALID)) + " " + aFormula + " : ");
...
void Test::testFormulaErrorPropagation()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE( aPos.Format(static_cast<sal_uInt16>(ScAddr::VALID)).toUtf8().getStr(), aTRUE, m_pDoc->GetString(aPos));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE( aPos.Format(static_cast<sal_uInt16>(ScAddr::VALID)).toUtf8().getStr(), aFALSE, m_pDoc->GetString(aPos));
    CPPUNIT_ASSERT_EQUAL_MESSAGE( aPos2.Format(static_cast<sal_uInt16>(ScAddr::VALID)).toUtf8().getStr(), aFALSE, m_pDoc->GetString(aPos2));
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE( aPos.Format(static_cast<sal_uInt16>(ScAddr::VALID)).toUtf8().getStr(), aFALSE, m_pDoc->GetString(aPos));
    CPPUNIT_ASSERT_EQUAL_MESSAGE( aPos2.Format(static_cast<sal_uInt16>(ScAddr::VALID)).toUtf8().getStr(), aTRUE, m_pDoc->GetString(aPos2));
