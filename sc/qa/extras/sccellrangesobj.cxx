...
uno::Reference< uno::XInterface > ScCellRangesObj::init()
{
    ...
    xRanges->insertByName(OUString("Range1"), xCellRange);
    xCellRange <<= xSheet->getCellRangeByName("E2:F5");
    xRanges->insertByName(OUString("Range2"), xCellRange);
    xCellRange <<= xSheet->getCellRangeByName("G2:H3");
    xRanges->insertByName(OUString("Range3"), xCellRange);
    xCellRange <<= xSheet->getCellRangeByName("I7:J8");
    xRanges->insertByName(OUString("Range4"), xCellRange);
