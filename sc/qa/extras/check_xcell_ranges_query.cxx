...
public:
    ...
    bool _queryColumnDifferences(OUString expected);
    bool _queryRowDifferences(OUString expected);
    bool _queryEmptyCells(OUString expected);
...
private:
    ...
    static uno::Reference< sheet::XCellRangesQuery > m_xCell;
    static OUString sSheetName;
};

sal_Int32 CheckXCellRangesQuery::nTest = 0;
uno::Reference<lang::XComponent> CheckXCellRangesQuery::mxComponent;
uno::Reference< sheet::XCellRangesQuery > CheckXCellRangesQuery::m_xCell;
OUString CheckXCellRangesQuery::sSheetName= "";
...
uno::Reference< uno::XInterface > CheckXCellRangesQuery::init()
{
        ...
        uno::Reference< sheet::XCellRangesQuery > m_xCell(oObj, uno::UNO_QUERY_THROW);
   ...
   void CheckXCellRangesQuery::checkEmptyCell()
{
        ...
        CPPUNIT_ASSERT_MESSAGE("\tQuery column differences did not return the correct value", _queryColumnDifferences(sSheetName + ".C4"));
        // compare an empty cell with a cell with a value
        CPPUNIT_ASSERT_MESSAGE("\tQuery row differences did not return the correct value",_queryRowDifferences(sSheetName + ".C4"));
    }
    ...
    void CheckXCellRangesQuery::checkFilledCell()
{
        ...
        CPPUNIT_ASSERT_THROW(m_xSpreadSheet->getCellByPosition(2, 3)->setValue(15), IndexOutOfBoundsException);
        ...
        CPPUNIT_ASSERT_MESSAGE("\tQuery row differences did not return the correct value",_queryRowDifferences(sSheetName + ".C4"));
        // try to get nothing
        CPPUNIT_ASSERT_MESSAGE("\tQuery empty cells did not return the correct value.", _queryEmptyCells(""));
    }
    /**
     ...
     */
    bool CheckXCellRangesQuery::_queryColumnDifferences(OUString expected) {
     ...
     * @return True, if the result equals the expected result.
     */
    bool CheckXCellRangesQuery::_queryEmptyCells(OUString expected) {
        //Query empty cells
     ...
     * @return True, if the result equals the expected result.
     */
    bool CheckXCellRangesQuery::_queryRowDifferences(OUString expected) {
