...
CPPUNIT_TEST_FIXTURE(test::AccessibleTestBase, TestCalcMenu)
{
    ...
    // see maNullDate in svl/source/numbers/zforscan.hxx and its initialization in
    // ImpSvNumberformatScan::ImpSvNumberformatScan() in svl/source/numbers/zforscan.cxx
    const Date nullDate(30, 12, 1899);
