...
ScIndexEnumeration_TableConditionalEntryEnumeration::ScIndexEnumeration_TableConditionalEntryEnumeration()
...
uno::Reference<uno::XInterface> ScIndexEnumeration_TableConditionalEntryEnumeration::init()
{
    ...
    uno::Reference<sheet::XSheetConditionalEntries> xSCE(xPropertySet->getPropertyValue("ConditionalFormat"), uno::UNO_QUERY_THROW);
