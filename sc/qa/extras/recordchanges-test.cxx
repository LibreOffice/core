...
void ScRecordChangesTest::testSetRecordChanges()
{
    ...
    CPPUNIT_ASSERT(xDocSettingsPropSet->getPropertyValue("HasRecordChangesProtection") >>= protectionValue);
...
void ScRecordChangesTest::testCheckRecordChangesProtection()
{
    ...
    // this document should still record changes as protection set
