...
#include <test/sheet/sheetsortdescriptor.hxx>
...
{
class ScSortDescriptorBaseObj : public CalcUnoApiTest, public apitest::SheetSortDescriptor
{
public:
    ...
    // SheetSortDescriptor
    CPPUNIT_TEST(testSheetSortDescriptorProperties);
