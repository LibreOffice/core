...
public:
    ...
    CPPUNIT_TEST(testLeftText);
    CPPUNIT_TEST(testRightText);
    CPPUNIT_TEST(testCenterText);
...
uno::Reference< uno::XInterface > ScHeaderFooterContentObj::init()
{
    ...
    uno::Reference< sheet::XHeaderFooterContent > xHeaderFooterContent (xIndexAccess->getByIndex(0), uno::UNO_QUERY_THROW);
    return xHeaderFooterContent;
}
