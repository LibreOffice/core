...
CheckDataPilotField::CheckDataPilotField()
     : CalcUnoApiTest("/sc/qa/extras/testdocuments"),
       apitest::XNamed(OUString("DataPilotField"))
{
}
...
uno::Reference< uno::XInterface > CheckDataPilotField::init()
{
    ...
    {
        oSheet->getCellByPosition(i, 0)->setFormula(OUString("Row") + OUString::number(i));
    ...
    uno::Reference<uno::XInterface> mDataPilotFieldObject;
    uno::Any mAny = IA->getByIndex(0);
    CPPUNIT_ASSERT(mAny >>= mDataPilotFieldObject);

    return mDataPilotFieldObject;
}
