...
{
class ScCellsEnumerationObj : public CalcUnoApiTest, public apitest::XEnumeration
{
public:
    ScCellsEnumerationObj();

    virtual uno::Reference<uno::XInterface> init() override;
    virtual void setUp() override;
    virtual void tearDown() override;

    CPPUNIT_TEST_SUITE(ScCellsEnumerationObj);
...
ScCellsEnumerationObj::ScCellsEnumerationObj()
    : CalcUnoApiTest("/sc/qa/extras/testdocuments")
{
}

uno::Reference<uno::XInterface> ScCellsEnumerationObj::init()
{
...
void ScCellsEnumerationObj::setUp()
{
...
void ScCellsEnumerationObj::tearDown()
{
    closeDocument(m_xComponent);
    CalcUnoApiTest::tearDown();
}

CPPUNIT_TEST_SUITE_REGISTRATION(ScCellsEnumerationObj);
