...
void ScMacrosTest::testTdf90278()
{
    ...
    SfxObjectShell::CallXScript(
        xComponent, "vnd.sun.Star.script:VBAProject.Module1.BorderWeight?language=Basic&location=document",
        aParams, aRet, aOutParamIndex, aOutParam);

    // Check the border weight of the corresponding cell in the test
    sal_Int32 aReturnValue;
    aRet >>= aReturnValue;
