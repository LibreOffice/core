...
void ScMacrosTest::testTdf138646()
{
    ...
    // Without the fix in place, changing the specified grammar would cause an exception
    pDocSh->GetDocument().SetGrammar(formula::FormulaGrammar::Grammar::GRAM_NATIVE_XL_R1C1);
    SfxObjectShell::CallXScript(
        xComponent, "vnd.sun.Star.script:Standard.Module1.CellRangeByName?language=Basic&location=document",
        aParams, aRet, aOutParamIndex, aOutParam);
