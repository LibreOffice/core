...
public:
    ...
    CPPUNIT_TEST(testTdf131296);
    CPPUNIT_TEST(testTdf130476);
...
void ScMacrosTest::testTdf131296()
{
    ...
    OUString aFileName;
    createFileURL("tdf131296.ods", aFileName);
    auto xComponent = loadFromDesktop(aFileName, "com.sun.star.sheet.SpreadsheetDocument");
    CPPUNIT_ASSERT(xComponent);
...
void ScMacrosTest::testTdf130476()
{
    ...
    OUString aFileName;
    createFileURL("tdf130476.ods", aFileName);
    auto xComponent = loadFromDesktop(aFileName, "com.sun.star.sheet.SpreadsheetDocument");
    CPPUNIT_ASSERT(xComponent);
