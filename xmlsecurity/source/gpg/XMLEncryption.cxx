...
/* XServiceInfo */
OUString SAL_CALL XMLEncryption::getImplementationName()
    hrow( RuntimeException, std::exception )
{
    return impl_getImplementationName() ;
}

/* XServiceInfo */
sal_Bool SAL_CALL XMLEncryption::supportsService( const OUString& serviceName)
...
/* XServiceInfo */
Sequence< OUString > SAL_CALL XMLEncryption::getSupportedServiceNames()
    throw( RuntimeException, std::exception )
{
...
OUString XMLEncryption::impl_getImplementationName()
    throw( RuntimeException )
{
    return "com.sun.star.xml.security.XMLEncryption_Gpg";
}

//Helper for registry
Reference< XInterface > SAL_CALL XMLEncryption::impl_createInstance( const Reference< XMultiServiceFactory >&  )
    throw( RuntimeException )
{
