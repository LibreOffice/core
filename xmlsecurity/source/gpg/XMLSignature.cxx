...
/* XXMLSignature */
Reference< XXMLSignatureTemplate > SAL_CALL XMLSignature::generate(const Reference< XXMLSignatureTemplate >& /*aTemplate*/,
...
/* XXMLSignature */
Reference< XXMLSignatureTemplate > SAL_CALL XMLSignature::validate(const Reference< XXMLSignatureTemplate >& /*aTemplate*/,
...
/* XServiceInfo */
OUString SAL_CALL XMLSignature::getImplementationName()
...
/* XServiceInfo */
sal_Bool SAL_CALL XMLSignature::supportsService( const OUString& serviceName)
    throw( RuntimeException, std::exception )
{
...
OUString XMLSignature::impl_getImplementationName()
    throw( RuntimeException )
{
    return "com.sun.star.xml.security.XMLSignature_Gpg";
}

//Helper for registry
Reference< XInterface > SAL_CALL XMLSignature::impl_createInstance( const Reference< XMultiServiceFactory >& )
    throw( RuntimeException )
{
