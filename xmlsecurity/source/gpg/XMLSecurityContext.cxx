...
/* XServiceInfo */
OUString SAL_CALL XMLSecurityContext::getImplementationName() throw( RuntimeException, std::exception ) {
    return impl_getImplementationName() ;
}

/* XServiceInfo */
sal_Bool SAL_CALL XMLSecurityContext::supportsService( const OUString& serviceName) throw( RuntimeException, std::exception ) {
    return cppu::supportsService(this, serviceName);
}

/* XServiceInfo */
Sequence< OUString > SAL_CALL XMLSecurityContext::getSupportedServiceNames() throw( RuntimeException, std::exception ) {
...
OUString XMLSecurityContext::impl_getImplementationName() throw( RuntimeException ) {
    return OUString("com.sun.star.xml.security.XMLSecurityContext_Gpg") ;
}

//Helper for registry
Reference< XInterface > SAL_CALL XMLSecurityContext::impl_createInstance( const Reference< XMultiServiceFactory >& ) throw( RuntimeException ) {
