...
{
    m_xDocumentHandler->startElement("SignedInfo", nullptr);
...
void OOXMLSecExporter::Impl::writeSignedInfoReferences()
{
    ...
    for (const SignatureReferenceInformation& rReference : rReferences)
    {
        if (rReference.nType == SignatureReferenceType::SAMEDOCUMENT)
        {
            ...
            if (rReference.ouURI == "idSignedProperties")
            {
                m_xDocumentHandler->startElement("Transforms", nullptr);
            ...
            m_xDocumentHandler->startElement("DigestValue", nullptr);
...
{
    m_xDocumentHandler->startElement("SignatureValue", nullptr);
...
{
    m_xDocumentHandler->startElement("KeyInfo", nullptr);
    m_xDocumentHandler->startElement("X509Data", nullptr);
    m_xDocumentHandler->startElement("X509Certificate", nullptr);
...
{
    m_xDocumentHandler->startElement("Manifest", nullptr);
    const SignatureReferenceInformations& rReferences = m_rInformation.vSignatureReferenceInfors;
    for (const SignatureReferenceInformation& rReference : rReferences)
    {
        if (rReference.nType != SignatureReferenceType::SAMEDOCUMENT)
...
{
    m_xDocumentHandler->startElement("SignatureProperties", nullptr);
    {
        rtl::Reference<SvXMLAttributeList> pAttributeList(new SvXMLAttributeList());
    ...
    m_xDocumentHandler->startElement("mdssi:Format", nullptr);
    m_xDocumentHandler->characters("YYYY-MM-DDThh:mm:ssTZD");
    m_xDocumentHandler->endElement("mdssi:Format");

    m_xDocumentHandler->startElement("mdssi:Value", nullptr);
...
void OOXMLSecExporter::Impl::writeSignatureInfo()
{
    ...
    m_xDocumentHandler->startElement("SetupID", nullptr);
    m_xDocumentHandler->characters(m_rInformation.ouSignatureLineId);
    m_xDocumentHandler->endElement("SetupID");
    m_xDocumentHandler->startElement("SignatureText", nullptr);
    m_xDocumentHandler->endElement("SignatureText");
    m_xDocumentHandler->startElement("SignatureImage", nullptr);
    m_xDocumentHandler->endElement("SignatureImage");
    m_xDocumentHandler->startElement("SignatureComments", nullptr);
    ...
    m_xDocumentHandler->startElement("SignatureType", nullptr);
...
{
    m_xDocumentHandler->startElement("Object", nullptr);
    {
        rtl::Reference<SvXMLAttributeList> pAttributeList(new SvXMLAttributeList());
