...
//TODO    virtual void Resize() override;
...
private:
    ...
    std::unique_ptr<weld::MenuButton> m_xAddService_btn;
    ...
    std::unique_ptr<weld::Button> m_xListView_btn;
    std::unique_ptr<weld::Button> m_xIconView_btn;
    ...
    DECL_LINK ( AddServiceHdl, weld::Button&, void );
