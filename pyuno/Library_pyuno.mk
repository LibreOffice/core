...
$(eval $(call gb_Library_add_libs,pyuno,\
...
#$(eval $(call gb_Library_set_ldflags,pyuno,\
#    $$(filter-out -Wl$$(COMMA)-z$$(COMMA)defs,$$(T_LDFLAGS)) \
#))
...
#$(eval $(call gb_Library_add_cobjects,pyuno,\
