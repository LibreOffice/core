...
# (1) Be operating in a workspace where you have a NON_DEBUG build of LibreOffice, but WITH SYMBOLS enabled.
#     Otherwise the debug stuff will change the answer.
