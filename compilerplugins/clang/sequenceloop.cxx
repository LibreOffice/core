...
bool SequenceLoop::VisitCXXForRangeStmt(CXXForRangeStmt const* forStmt)
{
    ...
    // how else could I detect x-values?
    if (isa<ExprWithCleanups>(forStmt->getRangeInit()))
        return true;
    ...
    report(DiagnosticsEngine::Warning, "use std::as_const to avoid creating a copy of the Sequence",
