...
bool MoveParam::VisitCXXOperatorCallExpr(const CXXOperatorCallExpr* callExpr)
{
    ...
    if (!loplugin::TypeCheck(qt)
        ...
        && !loplugin::TypeCheck(qt).Class("deque").StdNamespace()
        && !loplugin::TypeCheck(qt).Class("list").StdNamespace()
        && !loplugin::TypeCheck(qt).Class("set").StdNamespace()
        && !loplugin::TypeCheck(qt).Class("map").StdNamespace()
        && !loplugin::TypeCheck(qt).Class("unordered_map").StdNamespace()
        && !loplugin::TypeCheck(qt).Class("unordered_set").StdNamespace())
        return true;
