...
struct S4 {
    ...
    static constexpr void f5() {}

    static constexpr inline void f6() {} // expected-error {{[loplugin:redundantinline]}}
};

constexpr void f5() {}

constexpr inline void f6() {} // expected-error {{[loplugin:redundantinline]}}
