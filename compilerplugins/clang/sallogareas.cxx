...
bool SalLogAreas::VisitCallExpr( const CallExpr* call )
    ...
    if( const FunctionDecl* func = call->getDirectCallee())
        ...
        if( func->getNumParams() == 4 && func->getIdentifier() != NULL
            ...
            if( tc.Function("sal_detail_log") || tc.Function("log").Namespace("detail").Namespace("sal") )
                {
                ...
                if( loplugin::DeclCheck(inFunction).Function("log").Namespace("detail").Namespace("sal") )
