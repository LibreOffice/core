...
# -std=c++14 is in line with the default value for COMPILER_PLUGINS_CXX in configure.ac:
CLANGTOOLDEFS += -DSTDOPTION=\"$(or $(filter -std=%,$(COMPILER_PLUGINS_CXX)),-std=c++14)\"
