...
CLANGTOOLLIBS = -lclangTooling -lclangAST -lclangFrontend -lclangBasic $(shell $(LLVMCONFIG) --ldflags --libs)
# Path to the clang system headers (no idea if there's a better way to get it).
CLANGTOOLDEFS = -DCLANGSYSINCLUDE=$(shell $(LLVMCONFIG) --libdir)/clang/$(shell $(LLVMCONFIG) --version)/include
