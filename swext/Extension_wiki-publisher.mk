...
$(eval $(call gb_Extension_add_file,wiki-publisher,commons-logging-$(APACHE_COMMONS_LOGGING_VERSION).jar,$(call gb_UnpackedTarball_get_dir,apache_commons_logging)/target/commons-logging-$(APACHE_COMMONS_LOGGING_VERSION).jar))
endif
