...
#define CREATE_RELATIONS_TYPE( ascii ) \
...
public:
    ...
    static ::rtl::OUString getFragmentPathFromTarget( const ::rtl::OUString& rParentFragment, const ::rtl::OUString& rTarget );
    /** Returns the full fragment path for the passed relation identifier. */
    ::rtl::OUString     getFragmentPathFromRelId( const ::rtl::OUString& rParentFragment, const ::rtl::OUString& rRelId ) const;
    /** Returns the full fragment path for the passed type. */
    ::rtl::OUString     getFragmentPathFromType( const ::rtl::OUString& rParentFragment, const ::rtl::OUString& rType ) const;
};
