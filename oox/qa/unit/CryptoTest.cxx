...
void CryptoTest::testAgileEncryptionVerifier()
{
    ...
    aEngine.setupEncryptionParameters(
        { 100000, 16, 128, 20, 16, "AES", "ChainingModeCBC", "SHA1" });
    ...
    aEngine.setupEncryptionParameters(
        { 100000, 16, 256, 64, 16, "AES", "ChainingModeCBC", "SHA512" });
...
void CryptoTest::testAgileEncrpytionInfoWritingAndParsing()
{
    ...
    { // Preset AES128 - SHA1
...

        {
            ...
            CPPUNIT_ASSERT_EQUAL(100000, rInfo.spinCount);
            CPPUNIT_ASSERT_EQUAL(16, rInfo.saltSize);
            CPPUNIT_ASSERT_EQUAL(128, rInfo.keyBits);
            CPPUNIT_ASSERT_EQUAL(20, rInfo.hashSize);
            CPPUNIT_ASSERT_EQUAL(16, rInfo.blockSize);
    ...
    { // Preset AES256 - SHA512
...

        {
            ...
            CPPUNIT_ASSERT_EQUAL(100000, rInfo.spinCount);
            CPPUNIT_ASSERT_EQUAL(16, rInfo.saltSize);
            CPPUNIT_ASSERT_EQUAL(256, rInfo.keyBits);
            CPPUNIT_ASSERT_EQUAL(64, rInfo.hashSize);
            CPPUNIT_ASSERT_EQUAL(16, rInfo.blockSize);
            CPPUNIT_ASSERT_EQUAL(OUString("AES"), rInfo.cipherAlgorithm);
            CPPUNIT_ASSERT_EQUAL(OUString("ChainingModeCBC"), rInfo.cipherChaining);
