...
CPPUNIT_TEST_FIXTURE(OoxDrawingmlTest, testPolyPolygonShapeExport)
{
    ...
    uno::Reference<drawing::XShapeDescriptor> xGroupShapeDescriptor(xGroupShape, uno::UNO_QUERY);
    CPPUNIT_ASSERT(xGroupShapeDescriptor.is());
    const OUString sShapeType(xGroupShapeDescriptor->getShapeType());
    ...
    uno::Reference<drawing::XShapeDescriptor> xChildShapeDescriptor1(xChildShape1, uno::UNO_QUERY);
    CPPUNIT_ASSERT(xChildShapeDescriptor1.is());
    const OUString sShapeType1(xChildShapeDescriptor1->getShapeType());
    ...
    CPPUNIT_ASSERT_EQUAL(xGroupShape->getPosition().Y, xChildShape1->getPosition().Y);
}
