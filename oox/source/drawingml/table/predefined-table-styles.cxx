 ...
 * of these variables to keep the code readeable and change
 * something easily when some styles change.
 */
...
std::unique_ptr<TableStyle> CreateTableStyle(const OUString& styleId)
{
    ...
    // Start of table border line properties definitions for table parts
    ...
    // End of table border line properties definitions for table parts
