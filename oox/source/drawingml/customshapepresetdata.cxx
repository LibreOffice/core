...
void lcl_parsePathCoordinateValues(std::vector<beans::PropertyValue>& rPath, const OString& rValue)
{
    ...
    aPropertyValue.Value = uno::makeAny(comphelper::toSequence(aPairs));
...
void lcl_parsePathSegmentValues(std::vector<beans::PropertyValue>& rPath, const OString& rValue)
{
    ...
    aPropertyValue.Value = uno::makeAny(comphelper::toSequence(aSegments));
    rPath.push_back(aPropertyValue);
}
...
void lcl_parsePathTextFrameValues(std::vector<beans::PropertyValue>& rPath, const OString& rValue)
{
    ...
    aPropertyValue.Value = uno::makeAny(comphelper::toSequence(aTextFrames));
    rPath.push_back(aPropertyValue);
}
...
void lcl_parsePathSubViewSizeValues(std::vector<beans::PropertyValue>& rPath, const OString& rValue)
{
    ...
    aPropertyValue.Value = uno::makeAny(comphelper::toSequence(aSizes));
    rPath.push_back(aPropertyValue);
}
        ...
        else
        {
            if (aLine == "AdjustmentValues")
            {
                ...
                if (aLine != "([]com.sun.star.drawing.EnhancedCustomShapeAdjustmentValue) {}")
                {
                    ...
                    aPropertyMap.setProperty(PROP_AdjustmentValues, comphelper::toSequence(aAdjustmentValues));
                }
                else
            ...
            else if (aLine == "Equations")
            {
                ...
                if (aLine != "([]string) {}")
                {
                    ...
                    aPropertyMap.setProperty(PROP_Equations, comphelper::toSequence(aEquations));
                }
                else
            ...
            else if (aLine == "Handles")
            {
                ...
                if (aLine != "([][]com.sun.star.beans.PropertyValue) {}")
                {
                    ...
                    aPropertyMap.setProperty(PROP_Handles, comphelper::toSequence(aHandles));
                }
                else
            ...
            else if (aLine == "Path")
            {
                ...
                aPropertyMap.setProperty(PROP_Path, comphelper::toSequence(aPathValue));
            }
            else if (aLine == "Type")
            {
