...
namespace oox::ppt
{
PPTHyperLinkContext::PPTHyperLinkContext(ContextHandler2Helper const& rParent,
                                                   const AttributeList&, PropertyMap& aProperties)
        ...
        case A_TOKEN(hlinkClick):
            ...
            if (!sAction.isEmpty())
            {
                ...
                if (sAction.matchIgnoreAsciiCase(sPPAction))
                {
                    ...
                    {
                        static const OUStringLiteral sShowJumpAction(u"ppaction://hlinkshowjump?jump=");
