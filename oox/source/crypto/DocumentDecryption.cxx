...
bool DocumentDecryption::readIRMEncryptionInfo()
{
    ...
    sal_uInt32 a = aBinaryStream.readuInt32();  // ReaderVersion
    sal_uInt32 b = aBinaryStream.readuInt32();  // UpdaterVersion
    sal_uInt32 c = aBinaryStream.readuInt32();  // WriterVersion

    // MS-OFFCRYPTO 2.2.5: ExtensibilityHeader
    sal_uInt32 d = aBinaryStream.readuInt32();  // ExtensibilityHeader

    mCryptoType = IRM; // Set encryption info format
