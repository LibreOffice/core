...
int strip_signature_block(const char* src, const char* dest)
{
    ...
    int64_t oldPos, sizeOfEntireMAR = 0, realSizeOfSrcMAR, numBytesToCopy, numChunks, i;
                           ...
                           uint32_t certCount, const char* src, const char* dest)
{
    uint32_t offsetToIndex, dstOffsetToIndex, indexLength,
        numSignatures = 0, leftOver, signatureAlgorithmID, signatureSectionLength = 0;
    uint32_t signatureLengths[MAX_SIGNATURES];
    int64_t oldPos, sizeOfEntireMAR = 0, realSizeOfSrcMAR, signaturePlaceholderOffset,
                    numBytesToCopy, numChunks, i;
    FILE *fpSrc = NULL, *fpDest = NULL;
    int rv = -1, hasSignatureBlock;
