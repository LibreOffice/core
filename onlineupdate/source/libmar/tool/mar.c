...
int main(int argc, char** argv)
{
    ...
    {
        if (argv[1][0] == '-'
            && (argv[1][1] == 'c' || argv[1][1] == 't' || argv[1][1] == 'x' || argv[1][1] == 'v'
                || argv[1][1] == 's' || argv[1][1] == 'i' || argv[1][1] == 'T' || argv[1][1] == 'r'
                || argv[1][1] == 'X' || argv[1][1] == 'I'))
        {
            break;
            /* -C workingdirectory */
        }
       ...
       with the import and export command line arguments. */
                     ...
                     || !strcmp(argv[2], "-X") || !strcmp(argv[2], "-I")))
        {
            ...
            if (strlen(argv[1]) > 2 && (!strcmp(argv[2], "-X") || !strcmp(argv[2], "-I"))
    ...
    switch (argv[1][1])
    {
        case 'c':
        {
            ...
            if (!productVersion)
            {
                fprintf(stderr, "ERROR: Version not specified (pass `-V <version>`).\n");
                return -1;
            }
            if (!MARChannelID)
            {
                fprintf(stderr, "ERROR: MAR channel ID not specified (pass `-H "
                                "<mar-channel-id>`).\n");
                return -1;
            }
        ...
        case 'T':
        {
            ...
            if (!get_mar_file_info(argv[2], &hasSignatureBlock, &numSignatures, &hasAdditionalBlock,
        ...
        case 'v':
            ...
            {
#if !defined(MAR_NSS)
                rv = mar_read_entire_file(DERFilePaths[k], MAR_MAX_CERT_SIZE, &certBuffers[k],
                                          &fileSizes[k]);
        ...
        case 's':
            ...
            return mar_repackage_and_sign(NSSConfigDir, certNames, certCount, argv[2], argv[3]);
