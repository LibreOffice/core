...
static int mar_insert_item(MarFile* mar, const char* name, uint32_t namelen, uint32_t offset,
...
static int mar_read_index(MarFile* mar)
{
    ...
    if (mar_read_buffer(mar, &offset_to_index, &mar_position, sizeof(uint32_t)) != 0)
    {
        return -1;
    }
    ...
    if (mar_read_buffer(mar, &size_of_index, &mar_position, sizeof(uint32_t)) != 0)
    {
        return -1;
    }
 ...
 */
int get_open_mar_file_info(MarFile* mar, size_t* mar_position, int* hasSignatureBlock,
                           uint32_t* numSignatures, int* hasAdditionalBlocks,
                           uint32_t* offsetAdditionalBlocks, uint32_t* numAdditionalBlocks)
{
    ...
    *mar_position = 0;
    ...
    if (mar_read_buffer(mar, &offsetToIndex, mar_position, sizeof(offsetToIndex)) != 0)
    {
        return -1;
    }
    ...
    if (numSignatures)
    {
        ...
        if (mar_read_buffer(mar, numSignatures, mar_position, sizeof(*numSignatures)) != 0)
        {
            return -1;
        }
    ...
    *mar_position = 0;
    ...
    if (mar_read_buffer(mar, &offsetToContent, mar_position, sizeof(offsetToContent)) != 0)
    {
        return -1;
    }
    ...
    *mar_position = 0;
    ...
    if (*mar_position <= (size_t)INT64_MAX && (int64_t)mar_position == (int64_t)offsetToContent)
    {
        ...
        if (numAdditionalBlocks)
        {
         ...
         and set the offset. */
            *hasAdditionalBlocks = 1;
            if (mar_read_buffer(mar, numAdditionalBlocks, mar_position, sizeof(uint32_t)) != 0)
            {
                return -1;
            }
...
{
    uint32_t offsetAdditionalBlocks, numAdditionalBlocks, additionalBlockSize, additionalBlockID;
    ...
    if (numAdditionalBlocks > 0)
    {
        ...
        if (mar_read_buffer(mar, &additionalBlockSize, &mar_position, sizeof(additionalBlockSize))
            != 0)
        {
            return -1;
        }
        additionalBlockSize
            = ntohl(additionalBlockSize) - sizeof(additionalBlockSize) - sizeof(additionalBlockID);
        ...
        if (mar_read_buffer(mar, &additionalBlockID, &mar_position, sizeof(additionalBlockID)) != 0)
        {
            return -1;
        }
                      ...
                      uint32_t* numAdditionalBlocks)
{
    ...
    rv = get_open_mar_file_info(mar, &mar_position, hasSignatureBlock, numSignatures,
                                hasAdditionalBlocks, offsetAdditionalBlocks, numAdditionalBlocks);
