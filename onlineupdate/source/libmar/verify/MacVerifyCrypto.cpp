                                         ...
                                         unsigned int aSignatureLen)
{
    ...
    SecTransformSetAttributePtr(verifier, kSecDigestTypeAttribute, kSecDigestSHA2, &error);
    if (error)
    {
        CFRelease(error);
        CFRelease(signatureData);
    ...
    SecTransformSetAttributePtr(verifier, kSecDigestLengthAttribute, dLen, &error);
    CFRelease(dLen);
    if (error)
    {
        CFRelease(error);
