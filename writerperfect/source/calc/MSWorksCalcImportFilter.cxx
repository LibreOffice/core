...
static uno::Reference<sdbc::XResultSet> getResultSet(const css::uno::Reference<css::ucb::XContent> &xContent);
...
{
    if (m_nameToPathMap.find(name)== m_nameToPathMap.end() || !m_xContent.is()) return 0;
...
throw (css::uno::RuntimeException, std::exception)
{
    ...
    try
    {
        ...
        if (input.seek(0, librevenge::RVNG_SEEK_SET)==0 && xContent.is() && INetURLObject(sUrl).getExtension().equalsIgnoreAsciiCaseAscii("WK3"))
        {
