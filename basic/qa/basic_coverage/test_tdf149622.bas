...
Sub verify_tdf149622()
    ...
    TestUtil.AssertEqual(oTransferable.getData(aId0), True, "oTransferable.getData(aId0)")
    ' Before the fix for tdf#149622, this returned the previous return value
    TestUtil.AssertEqual(oTransferable.getData(aId1), Empty, "oTransferable.getData(aId1)")
