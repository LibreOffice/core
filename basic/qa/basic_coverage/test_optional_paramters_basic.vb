...
' parameters are allowed, but without any default values. Missing parameters
...
Function verify_testOptionalsBasic() As String
    ...
    TestLog_ASSERT TestOptVariantByRefByVal() = IsMissingAB, "the return of TestOptVariantByRefByVal(Optional, Optional) is: " & TestOptVariantByRefByVal(), "TestOptVariantByRefByVal()"
    TestLog_ASSERT TestOptVariantByRefByVal(123) = 123, "the return of TestOptVariantByRefByVal(Variant, Optional) is: " & TestOptVariantByRefByVal(123), "TestOptVariantByRefByVal(123)"
    ' TODO - tdf#125180 for more details
    ...
    TestLog_ASSERT TestOptDouble() = IsMissingAB, "the return of TestOptDouble(Optional, Optional) is: " & TestOptDouble(), "TestOptDouble()"
    TestLog_ASSERT TestOptDouble(123.4) = 123.4, "the return of TestOptDouble(Double, Optional) is: " & TestOptDouble(123.4), "TestOptDouble(123.4)"
    ' TODO - tdf#125180 for more details
    ...
    TestLog_ASSERT TestOptDoubleByRefByVal() = IsMissingAB, "the return of TestOptDoubleByRefByVal(Optional, Optional) is: " & TestOptDoubleByRefByVal(), "TestOptDouble()"
    TestLog_ASSERT TestOptDoubleByRefByVal(123.4) = 123.4, "the return of TestOptDoubleByRefByVal(Double, Optional) is: " & TestOptDoubleByRefByVal(123.4), "TestOptDouble(123.4)"
    ' TODO - tdf#125180 for more details
    ...
    TestLog_ASSERT TestOptInteger() = IsMissingAB, "the return of TestOptInteger(Optional, Optional) is: " & TestOptInteger(), "TestOptInteger()"
    TestLog_ASSERT TestOptInteger(123) = 123, "the return of TestOptInteger(Integer, Optional) is: " & TestOptInteger(123), "TestOptInteger(123)"
    ' TODO - tdf#125180 for more details
    ...
    TestLog_ASSERT TestOptIntegerByRefByVal() = IsMissingAB, "the return of TestOptIntegerByRefByVal(Optional, Optional) is: " & TestOptIntegerByRefByVal(), "TestOptIntegerByRefByVal()"
    TestLog_ASSERT TestOptIntegerByRefByVal(123) = 123, "the return of TestOptIntegerByRefByVal(Integer, Optional) is: " & TestOptIntegerByRefByVal(123), "TestOptIntegerByRefByVal(123)"
    ' TODO - tdf#125180 for more details
    ...
    TestLog_ASSERT TestOptString() = IsMissingAB, "the return of TestOptString(Optional, Optional) is: " & TestOptString(), "TestOptString()"
    TestLog_ASSERT TestOptString("123") = "123", "the return of TestOptString(String, Optional) is: " & TestOptString("123"), "TestOptString(""123"")"
    ' TODO - tdf#125180 for more details
    ...
    TestLog_ASSERT TestOptStringByRefByVal() = IsMissingAB, "the return of TestOptStringByRefByVal(Optional, Optional) is: " & TestOptStringByRefByVal(), "TestOptStringByRefByVal()"
    TestLog_ASSERT TestOptStringByRefByVal("123") = "123", "the return of TestOptStringByRefByVal(String, Optional) is: " & TestOptStringByRefByVal("123"), "TestOptStringByRefByVal(""123"")"
    ' TODO - tdf#125180 for more details
