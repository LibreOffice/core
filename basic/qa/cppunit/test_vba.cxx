...
// not much point even trying to run except on windows
    ...
    sal_Char sBuf[1024*8];

    SQLGetInstalledDrivers( reinterpret_cast< LPTSTR >( sBuf ), sizeof( sBuf ), nullptr );

    const sal_Unicode *pODBCDriverName = reinterpret_cast< const sal_Unicode * >( sBuf );
    bool bFound = false;
