...
Function verify_testIsMissingCompatible() As String
    ...
    TestLog_ASSERT TestOptDouble() = IsMissingA, "the return of IsMissing in TestOptDouble(Optional, Optional with Default value) is: " & TestOptDouble(), "TestOptDouble()"
    ...
    TestLog_ASSERT TestOptInteger() = IsMissingA, "the return of IsMissing in TestOptInteger(Optional, Optional with Default value) is: " & TestOptInteger(), "TestOptInteger()"
    ...
    TestLog_ASSERT TestOptString() = IsMissingA, "the return of IsMissing in TestOptString(Optional, Optional with Default value) is: " & TestOptString(), "TestOptString()"
