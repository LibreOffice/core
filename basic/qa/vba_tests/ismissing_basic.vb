...
' tdf#36737 - Test isMissing function with different datatypes. In LO Basic, optional
...
Function verify_testIsMissingBasic() As String
    ...
    ' TODO - tdf#125180 for more details
    ' TestLog_ASSERT TestOptDouble(, 123.4) = IsMissingA, "the return of IsMissing in TestOptDouble(Optional, Double) is: " & TestOptDouble(, 123.4), "TestOptDouble(, 123.4)"
    ...
    ' TODO - tdf#125180 for more details
    ' TestLog_ASSERT TestOptInteger(, 123) = IsMissingA, "the return of IsMissing in TestOptInteger(Optional, Integer) is: " & TestOptInteger(, 123), "TestOptInteger(, 123)"
    ...
    ' TODO - tdf#125180 for more details
    ' TestLog_ASSERT TestOptString(, "123") = IsMissingA, "the return of IsMissing in TestOptString(Optional, String) is: " & TestOptString(, "123"), "TestOptString(, ""123"")"
