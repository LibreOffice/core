...
try: On Error Goto catch
    ...
    TestLog_ASSERT Err.Number = CurErrNo, "Err.Number reset", "Err.Number = " & Err.Number
    ...
    TestLog_ASSERT Erl = 743, "line# failure", "Erl = " & Erl ' WATCH OUT for HARDCODED LINE # HERE !
