...
try:
    ...
    Select Case Err.Number ' aka Err with VBA
      Case  1789: ' Let's validate Err Object properties
        TestLog_ASSERT Erl=37, "line#", "line#: " & Erl
...
line59: Resume Next ' Err object properties reset from here …
      Case -1793: ' Let's check Basic runtime values
      TestLog_ASSERT Erl=59 Or Erl=68, "line#", "line#: " & Erl
...
line65: Resume Next ' Basic runtime values are reset from here …
      Case Else:
