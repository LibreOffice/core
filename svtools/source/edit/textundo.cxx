...
sal_Bool __EXPORT TextUndoManager::Undo( sal_uInt16 nCount )
{
...
sal_Bool __EXPORT TextUndoManager::Redo( sal_uInt16 nCount )
{
...
TextUndo::TextUndo( sal_uInt16 nI, TextEngine* p )
{
    mnId = nI;
    mpTextEngine = p;
}
...
sal_uInt16 __EXPORT TextUndo::GetId() const
{
