 ...
 *  $Revision: 1.2 $
 *
 *  last change: $Author: obo $ $Date: 2005-04-18 09:04:10 $
 *
...
{
    char   *pFullPropName;      // full qualified name as used in configuration
    char   *pPropName;          // property name only (atom) of above
