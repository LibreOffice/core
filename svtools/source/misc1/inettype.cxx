 ...
 *  $Revision: 1.2 $
 *
 *  last change: $Author: obo $ $Date: 2005-04-13 11:27:37 $
 *
                                                          ...
                                                          pSystemFileType)
{
    ...
    {
        TypeIDMapEntry * pEntry = Registration::getEntry(eTypeID);
        if (pEntry)
        {
            if (rPresentation.Len() != 0)
                pEntry->m_aPresentation = rPresentation;
            if (pSystemFileType)
                pEntry->m_aSystemFileType = *pSystemFileType;
        }
        if (pExtension)
        {
