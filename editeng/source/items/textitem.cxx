    ...
    switch( nMemberId )
    {
        case 0:
        {
            ...
            if ( rVal >>= aFontHeight )
            {
                ...
                nHeight = (long)( fPoint * 20.0 + 0.5 );        
                if (!bConvert)
                    nHeight = TWIP_TO_MM100_UNSIGNED(nHeight);  
