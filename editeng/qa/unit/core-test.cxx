...
void Test::testLineSpacing()
{
    ...
    // Set initial text
    OUString aFirstPara = "This is multi-line paragraph";
    ...
    ESelection aSelection(0, 0, 2, aThirdPara.getLength());
    ...
    CPPUNIT_ASSERT_EQUAL((sal_uInt16)122, (sal_uInt16)aInfo.nFirstLineMaxAscent);
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<sal_uInt16>(1), pSet2->Count());
    ...
    CPPUNIT_ASSERT_EQUAL((sal_uInt16)269, (sal_uInt16)aInfo2.nFirstLineMaxAscent);
