...
void Test::testHoriAlignIgnoreTrailingWhitespace()
{
    ...
    // Test multiple paragraph case
    {
        ...
        // Check horizontal position
        ParaPortion* pParaPortion = aEditEngine.GetParaPortions()[0];
        CPPUNIT_ASSERT_DOUBLES_EQUAL(static_cast<long>(4527), pParaPortion->GetLines()[0].GetStartPosX(), 10);
        pParaPortion = aEditEngine.GetParaPortions()[1];
        CPPUNIT_ASSERT_DOUBLES_EQUAL(static_cast<long>(8815), pParaPortion->GetLines()[0].GetStartPosX(), 10);
    }
}
