...
void Test::testLineSpacing()
{
    ...
    // Check why test fails on MAC OS...
    CPPUNIT_ASSERT_EQUAL((sal_Int32)96, aEditEngine.GetRefDevice()->GetDPIY());
    CPPUNIT_ASSERT_EQUAL((float)1.0, aEditEngine.GetRefDevice()->GetDPIScaleFactor());
