...
void Test::testLineSpacing()
{
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<sal_uInt16>(2), pSet->Count());
...
#ifdef MACOSX
    CPPUNIT_ASSERT_EQUAL((sal_Int32)5, aEditEngine.GetLineCount(0));
#else
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<sal_uInt16>(2), pSet2->Count());
