...
void Test::testSectionAttributes()
{
...

    {
        ...
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnParagraph);
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnStart);
        CPPUNIT_ASSERT_EQUAL(3, pSecAttr->mnEnd);
        CPPUNIT_ASSERT_EQUAL(1, (sal_Int32)pSecAttr->maAttributes.size());
        ...
        pSecAttr = &aAttrs[1];
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnParagraph);
        CPPUNIT_ASSERT_EQUAL(3, pSecAttr->mnStart);
        CPPUNIT_ASSERT_EQUAL(6, pSecAttr->mnEnd);
        CPPUNIT_ASSERT_EQUAL(2, (sal_Int32)pSecAttr->maAttributes.size());
        ...
        pSecAttr = &aAttrs[2];
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnParagraph);
        CPPUNIT_ASSERT_EQUAL(6, pSecAttr->mnStart);
        CPPUNIT_ASSERT_EQUAL(9, pSecAttr->mnEnd);
        CPPUNIT_ASSERT_EQUAL(1, (sal_Int32)pSecAttr->maAttributes.size());
...

    {
        ...
        pSecAttr = &aAttrs[2];
        CPPUNIT_ASSERT_EQUAL(2, pSecAttr->mnParagraph);
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnStart);
        CPPUNIT_ASSERT_EQUAL(3, pSecAttr->mnEnd);
        CPPUNIT_ASSERT_EQUAL(1, (sal_Int32)pSecAttr->maAttributes.size());
        CPPUNIT_ASSERT_MESSAGE("This section must be bold.", hasBold(*pSecAttr));
        ...
        pSecAttr = &aAttrs[4];
        CPPUNIT_ASSERT_EQUAL(4, pSecAttr->mnParagraph);
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnStart);
        CPPUNIT_ASSERT_EQUAL(5, pSecAttr->mnEnd);
        CPPUNIT_ASSERT_EQUAL(1, (sal_Int32)pSecAttr->maAttributes.size());
        CPPUNIT_ASSERT_MESSAGE("This section must be bold.", hasBold(*pSecAttr));

        // The 2nd and 4th paragraphs should be empty.
        pSecAttr = &aAttrs[1];
        CPPUNIT_ASSERT_EQUAL(1, pSecAttr->mnParagraph);
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnStart);
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnEnd);
        CPPUNIT_ASSERT_MESSAGE("Attribute array should be empty.", pSecAttr->maAttributes.empty());

        pSecAttr = &aAttrs[3];
        CPPUNIT_ASSERT_EQUAL(3, pSecAttr->mnParagraph);
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnStart);
        CPPUNIT_ASSERT_EQUAL(0, pSecAttr->mnEnd);
        CPPUNIT_ASSERT_MESSAGE("Attribute array should be empty.", pSecAttr->maAttributes.empty());
    }
