...
'*
'* short description : Checks the export to all available Filters from odt-files
'*
'\***********************************************************************
...
sub main
    ...
    Call hStatusIn ( "writer", "w_exp_xml2.bas" )
    Call tExportListCompare
    Call tExportFile("odt")
    Call hStatusOut
