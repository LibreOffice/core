...
'*
'* $RCSfile: ww_updt.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: fredrikh $ $Date: 2008-06-18 08:16:46 $
'*
...
'*
'* short description : Ressource-Test WriterWeb Document
'*
'\******************************************************************
...
sub main
    ...
    Printlog "******* Ressource-Test Writer/Web *******"

    Call hStatusIn ( "writer", "ww_updt.bas","Writer/Web-Updatetest" )
