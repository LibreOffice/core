...
'*
'* $RCSfile: f_security_broken_signature.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:08:14 $
'*
...
sub main
    ...
    use "framework\optional\includes\security_broken_signature.inc"
    
    call hStatusIn( "framework" , "f_security_broken_signature.bas" )
    
    hSetMacroSecurityAPI( GC_MACRO_SECURITY_LEVEL_MEDIUM )

    call tBrokenSignature()
