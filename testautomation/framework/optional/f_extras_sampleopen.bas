...
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:02:56 $
'*
...
sub main
    ...
    call hStatusIn( "framework", "f_extras_sampleopen.bas" )   
   
   ' open samples and save/load them in the current fileformat
    call tModifyObjects( 1 , "SAMPLES" , "current" ) 
    call hStatusOut
