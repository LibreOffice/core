...
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:09:04 $
'*
...
sub main
    ...
    use "framework\optional\includes\security_macrosecurity.inc"

    call hStatusIn( "framework" , "f_security_macrosecurity.bas" )
    call tMacroSecurityLevelsControlModule()
    call hStatusOut()
