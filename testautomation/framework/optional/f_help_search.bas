...
'*
'* $RCSfile: f_help_search.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:06:25 $
'*
...
sub main
    ...
    use "framework\optional\includes\help_search.inc"

    call hStatusIn( "framework" , "f_help_search.bas" )
    call tHelpSearch()
    call hStatusOut()
