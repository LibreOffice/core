...
'*
'* $RCSfile: f_basic_package_export_import.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:00:44 $
'*
...
sub main
    ...
    use "framework\optional\includes\basic_package_export.inc"
    use "framework\optional\includes\basic_package_import.inc"

    call hStatusIn( "framework" , "f_basic_package_export_import.bas" )

    ' Note: Testcases depend on each other, do not change the sequence
    call tBasicPackageExport()
    call tBasicPackageImport()  
