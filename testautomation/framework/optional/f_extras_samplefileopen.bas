...
'*
'* $RCSfile: f_extras_samplefileopen.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:02:46 $
'*
...
sub main
    ...
    call hStatusIn( "framework", "f_extras_samplefileopen.bas" )
    call tOpenObjectsWithFileDialog( "SAMPLES" )
    call hStatusOut
