...
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 06:59:13 $
'*
...
sub main
    ...
    use "framework\optional\includes\basic_dialog_i18n_defaults.inc"
    use "framework\optional\includes\basic_dialog_i18n_copy_control.inc"
    
    call hStatusIn( "framework" , "f_basic_dialog_i18n.bas" )
    call tBasicDialogI18nDefaults()
    call tBasicDialogI18nCopyControl()
    call hStatusOut()
