...
'*
'* $RCSfile: f_toolbar_items.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:09:47 $
'*
...
sub main
    ...
    use "framework\optional\includes\standardbar2.inc"
   
    call hStatusIn( "framework", "f_toolbar_items.bas" )
    call tStandardbar_2()
    call hStatusOut()
