...
'*
'* $RCSfile: f_basic_shared_modules.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:01:02 $
'*
...
sub main
    ...
    use "framework\optional\includes\basic_shared_modules.inc"
    
    call hStatusIn( "framework" , "f_basic_shared_modules.bas" )
    call tBasicSharedModules()
    call hStatusOut()
