...
'*
'* $RCSfile: f_filedlg_forbidden_names_windows.bas,v $
'*
'* $Revision: 1.1 $
'*
'* last change: $Author: jsk $ $Date: 2008-06-20 07:04:35 $
'*
...
sub main
    ...
    use "framework\optional\includes\filedlg_forbidden_names_windows.inc"
    
    call hStatusIn( "framework", "f_filedlg_forbidden_names_windows.bas" )
