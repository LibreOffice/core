...
ifeq ($(OS),MACOSX)
$(eval $(call gb_ExternalPackage_add_file,libodfgen,$(LIBO_LIB_FOLDER)/libodfgen-$(ODFGEN_MAJOR).$(ODFGEN_MINOR).$(ODFGEN_MICRO).dylib,src/.libs/libodfgen-$(ODFGEN_MAJOR).$(ODFGEN_MINOR).$(ODFGEN_MICRO).dylib))
else ifeq ($(OS),WNT)
ifeq ($(COM),GCC)
