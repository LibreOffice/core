	...
	+$(call gb_ExternalProject_run,build,\
		...
		$(if $(filter MACOSX,$(OS)),\
			&& $(PERL) $(SRCDIR)/solenv/bin/macosx-change-install-names.pl shl OOO \
				Cbc/src/.libs/libCbc.3.8.8.dylib \
				Cbc/src/.libs/libCbcSolver.3.8.8.dylib \
				Cgl/src/.libs/libCgl.1.8.5.dylib \
				Clp/src/.libs/libClp.1.12.6.dylib \
				Clp/src/OsiClp/.libs/libOsiClp.1.12.6.dylib \
				CoinMP/src/.libs/libCoinMP.1.7.6.dylib \
				CoinUtils/src/.libs/libCoinUtils.3.9.11.dylib \
				Osi/src/Osi/.libs/libOsi.1.11.5.dylib \
		) \
	)
