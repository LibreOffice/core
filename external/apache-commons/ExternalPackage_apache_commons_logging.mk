...
$(eval $(call gb_ExternalPackage_add_file,apache_commons_logging,$(LIBO_SHARE_JAVA_FOLDER)/commons-logging-$(APACHE_COMMONS_LOGGING_VERSION).jar,target/commons-logging-$(APACHE_COMMONS_LOGGING_VERSION).jar))
