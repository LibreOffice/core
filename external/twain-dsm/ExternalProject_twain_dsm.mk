...
$(call gb_ExternalProject_get_state_target,twain_dsm,build) :
	$(call gb_ExternalProject_run,build,\
		MSBuild.exe TWAIN_DSM/visual_studio/TWAIN_DSM_VS2015.sln /t:Build \
			/p:Configuration=$(if $(MSVC_USE_DEBUG_RUNTIME),Debug,Release) \
			/p:Platform=$(if $(filter INTEL,$(CPUNAME)),Win32,x64) \
			$(if 0,/p:OutDir=d:/sources/twain-dsm/TWAIN_DSM/work/out/ /p:IntDir=d:/sources/twain-dsm/TWAIN_DSM/work/obj/) \
