...
$(call gb_ExternalProject_get_state_target,librevenge,build) :
	$(call gb_ExternalProject_run,build,\
		...
		&& ./configure \
			...
			--disable-generators \
			--without-docs \
			$(if $(VERBOSE)$(verbose),--disable-silent-rules) \
			CXXFLAGS="-DLIBREVENGE_BUILD $(if $(SYSTEM_BOOST),$(BOOST_CPPFLAGS),-I$(call gb_UnpackedTarball_get_dir,boost) -I$(BUILDDIR)/config_$(gb_Side))" \
