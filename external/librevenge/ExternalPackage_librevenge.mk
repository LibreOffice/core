...
ifeq ($(OS),MACOSX)
$(eval $(call gb_ExternalPackage_add_file,librevenge,$(LIBO_LIB_FOLDER)/librevenge-$(REVENGE_MAJOR).$(REVENGE_MINOR).$(REVENGE_MICRO).dylib,src/lib/.libs/librevenge-$(REVENGE_MAJOR).$(REVENGE_MINOR).dylib))
else ifeq ($(OS),WNT)
