...
$(eval $(call gb_UnpackedTarball_add_patches,nss,\
    ...
    external/nss/0001-Cleanup-directory-handling.patch.1 \
    external/nss/0002-Add-.-to-LIB_SUFFIX-and-DLL_SUFFIX.patch.1 \
    external/nss/0003-Use-SHARED_LIBRARY_NAME-and-drop-the-32-default.patch.1 \
    external/nss/0004-Handle-parallel-PROGRAM-S.patch.1 \
    external/nss/0005-Drop-Windows-XP-compatibility.patch.1 \
    external/nss/0006-Depend-PROGRAM-and-SHARED_LIBRARY-on-EXTRA_LIBS.patch.1 \
    external/nss/0007-Parallelize-part-of-the-NSS-build.patch.1 \
    $(if $(filter iOS,$(OS)), \
