...
$(eval $(call gb_UnpackedTarball_add_patches,nss,\
    ...
    external/nss/0001-Apply-merged-NSPR-HG-patches.patch.1 \
    external/nss/0002-Apply-merged-NSS-HG-patches-parallel.patch.1 \
    external/nss/0003-Apply-merged-NSS-HG-patches-cleanup.patch.1 \
    $(if $(filter iOS,$(OS)), \
