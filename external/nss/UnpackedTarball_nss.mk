...
$(eval $(call gb_UnpackedTarball_add_patches,nss,\
    ...
    external/nss/0001-Use-SHARED_LIBRARY_NAME-and-drop-the-32-default.patch.1 \
    external/nss/0002-Handle-parallel-PROGRAM-S.patch.1 \
    external/nss/0003-Drop-Windows-XP-compatibility.patch.1 \
    external/nss/0004-Add-dist-install-to-generating-targets.patch.1 \
    external/nss/0005-Parallelize-part-of-the-NSS-build.patch.1 \
    external/nss/0006-Drop-recursive-private_exports.patch.1 \
    external/nss/0007-Use-eval-templates-for-export-and-freebl.patch.1 \
    external/nss/0008-Drop-double-colon-usage-and-add-directory-depends.patch.1 \
    $(if $(filter iOS,$(OS)), \
