...
$(call gb_CustomTarget_get_workdir,external/mingw-dlls)/%: $(firstword $(wildcard $(foreach dir,$(POTENTIAL_MINGW_RUNTIME_BINDIRS), $(dir)/%)))
	$(if $<,,$(error Could not find $* in any of $(POTENTIAL_MINGW_RUNTIME_BINDIRS)))
