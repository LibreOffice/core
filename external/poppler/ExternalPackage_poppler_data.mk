...
$(eval $(call gb_ExternalPackage_ExternalPackage,poppler,poppler_data))
...
$(eval $(call gb_ExternalPackage_add_unpacked_files_with_dir,poppler,$(LIBO_SHARE_FOLDER)/xpdfimport/poppler_data,\
   $(poppler_DISTFILES)))
