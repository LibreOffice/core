...
# fixed upstream
#boost_patches += boost.concept_check.Wunused-local-typedefs.warnings.patch -> 1 out of 1 hunk FAILED -- saving rejects to file boost/concept/detail/general.hpp.rej
...
#boost_patches += boost.preprocessor.Wundef.warnings.patch -> 1 out of 1 hunk FAILED -- saving rejects to file boost/preprocessor/config/config.hpp.rej
