...
$(eval $(call gb_ExternalPackage_use_unpacked,poppler_data,poppler_data))
ifneq ($(SYSTEM_POPPLER),)
# Use system poppler data
else
# Use bundled poppler data

$(eval $(call gb_Package_add_empty_directory,poppler_data,$(LIBO_SHARE_FOLDER)/xpdfimport/poppler_data))
