...
$(eval $(call gb_UnpackedTarball_update_autoconf_configs,qrcodegen))

ifeq ($(COM),MSC)
$(eval $(call gb_UnpackedTarball_set_post_action,qrcodegen,\
	touch cpp/config.h \
))
endif
...
$(eval $(call gb_UnpackedTarball_add_patches,qrcodegen, \
	external/qrcodegen/dynamic-library.patch \
))
