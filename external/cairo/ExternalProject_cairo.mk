...
$(call gb_ExternalProject_get_state_target,cairo,build) :
	...
	./configure \
		...
		pixman_LIBS="$(call gb_UnpackedTarball_get_dir,pixman)/pixman/.libs/libpixman-1$(gb_Library_DLLEXT)" \
		COMPRESS=$(if $(SYSTEM_ZLIB),compress,z_compress) \
		ZLIB3RDLIB="$(if $(SYSTEM_ZLIB),,$(call gb_StaticLibrary_get_target,zlib)" \
