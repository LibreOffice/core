    ...
    struct TDocumentInfo
    {
        public:
            ...
            */
            ...
            OUString AppModule;      
            OUString FactoryService; 
            OUString RealFilter;     
            OUString DefaultFilter;  
            OUString Extension;      
            OUString Title;          
...
static const char CFG_ENTRY_AUTOSAVE_TIMEINTERVALL[] = "AutoSave/TimeIntervall"; 
...
static const char CMD_DO_AUTO_SAVE[] = "/doAutoSave";    
static const char CMD_DO_PREPARE_EMERGENCY_SAVE[] = "/doPrepareEmergencySave";    
static const char CMD_DO_EMERGENCY_SAVE[] = "/doEmergencySave";    
static const char CMD_DO_RECOVERY[] = "/doAutoRecovery";    
static const char CMD_DO_ENTRY_BACKUP[] = "/doEntryBackup";    
static const char CMD_DO_ENTRY_CLEANUP[] = "/doEntryCleanUp";    
static const char CMD_DO_SESSION_SAVE[] = "/doSessionSave";    
static const char CMD_DO_SESSION_QUIET_QUIT[] = "/doSessionQuietQuit";    
static const char CMD_DO_SESSION_RESTORE[] = "/doSessionRestore";    
static const char CMD_DO_DISABLE_RECOVERY[] = "/disableRecovery";    
static const char CMD_DO_SET_AUTOSAVE_STATE[] = "/setAutoSaveState";    
...
static const sal_Int32       MIN_DISCSPACE_DOCSAVE                  =   5; 
static const sal_Int32       MIN_DISCSPACE_CONFIGSAVE               =   1; 
static const sal_Int32       RETRY_STORE_ON_FULL_DISC_FOREVER       = 300; 
static const sal_Int32       RETRY_STORE_ON_MIGHT_FULL_DISC_USEFULL =   3; 
static const sal_Int32       GIVE_UP_RETRY                          =   1; 
...
#define MIN_TIME_FOR_USER_IDLE 10000 
    ...
    throw(css::uno::RuntimeException)
{
    ...
    */
    ...
    {
        implts_deregisterDocument(xDocument, sal_True); 
    }
}
    ...
    throw(css::uno::RuntimeException)
{
    ...
    if (xDocument.is())
    {
        implts_deregisterDocument(xDocument, sal_False); 
        return;
    }
...
void AutoRecovery::implts_updateTimer()
{
    ...
    {
        nMilliSeconds = (m_nAutoSaveTimeIntervall*60000); 
        #if OSL_DEBUG_LEVEL > 1
        if (m_dbg_bMakeItFaster)
            nMilliSeconds = m_nAutoSaveTimeIntervall;  
        #endif
    }
                                                   ...
                                                   sal_Bool                                   bStopListening)
{
    ...
    */
    ...
    implts_flushConfigItem(aInfo, sal_True); 
}
...
AutoRecovery::ETimerType AutoRecovery::implts_openDocs(const DispatchParams& aParams)
{
         ...
         ++pIt                       )
    {
        ...
        sal_Bool bBackupWasTried   = (
                                        ((rInfo.DocumentState & AutoRecovery::E_TRY_LOAD_BACKUP  ) == AutoRecovery::E_TRY_LOAD_BACKUP) || 
                                        ((rInfo.DocumentState & AutoRecovery::E_INCOMPLETE       ) == AutoRecovery::E_INCOMPLETE     )    
                                     );
...
void AutoRecovery::implts_doEmergencySave(const DispatchParams& aParams)
{
    ...
    sal_Bool                 bAllowUserIdleLoop = sal_False; 
