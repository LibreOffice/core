...
void ToolbarLayoutManager::implts_createCustomToolBars()
{
    ...
    if ( xFrame.is() )
    {
        ...
        if ( xDocCfgMgr.is() )
        {
            ...
            implts_createCustomToolBars( aTbxSeq ); 
        }
        if ( xModuleCfgMgr.is() )
        {
    ...
    if ( xDockWindow.is() && xWindow.is() )
    {
        ...
        if ( rElement.m_bFloating )
        {
            ...
            if ( bUndefPos )
            {
                ...
                rElement.m_aFloatingData.m_aPos = aPos; 
                bWriteData = true;
            }
...
void ToolbarLayoutManager::implts_sortUIElements()
{
    ...
    std::stable_sort( pIterStart, pIterEnd ); 
        ...
        if ( aUIElement.m_xUIElement.is() )
        {
            if ( aUIElement.m_bFloating )
            {
                ...
                if( xWindow2.is() )
                {
                    ...
                    awt::Size      aSize    = xWindow2->getOutputSize();   
