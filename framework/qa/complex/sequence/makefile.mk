...
#   $Revision: 1.3 $
#
#   last change: $Author: rt $ $Date: 2007-07-27 08:40:02 $
#
...
JARFILES = mysql.jar sandbox.jar ridl.jar unoil.jar jurt.jar juh.jar jut.jar java_uno.jar OOoRunner.jar CheckSequenceOfEnum.jar
