...
namespace framework
{
    class ToolbarsMenuController :  public PopupMenuControllerBase
    {
        ...
        private:
            ...
            void addCommand( com::sun::star::uno::Reference< com::sun::star::awt::XPopupMenu >& rPopupMenu, const rtl::OUString& rCommandURL, const rtl::OString& sHelpId, const rtl::OUString& aLabel );
