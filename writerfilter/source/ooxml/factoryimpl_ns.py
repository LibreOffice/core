...
def factoryChooseAction(actionNode):
    ...
    if actionNode.getAttribute("action") in ("handleXNotes", "handleHdrFtr", "handleComment", "handlePicture", "handleBreak", "handleBlockLevelBreak", "handleOLE", "handleFontRel", "handleHyperlinkURL"):
