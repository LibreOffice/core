...
#  $Revision: 1.9 $
#
#  last change: $Author: obo $ $Date: 2008-01-10 12:12:24 $
#
...
$(OOXMLGENHEADERS): $(OOXMLHXXOUTDIR)
...
$(OOXMLFASTRESOURCESCXX): $(OOXMLFASTRESOURCEHXXS) $(OOXMLFASTRESOURCESIMPLXSL) $(MODELPROCESSED) 
...
$(OOXMLVALUESCXX): $(OOXMLVALUESIMPLXSL) $(MODELPROCESSED) $(OOXMLFASTRESOURCESHXX)
...
$(SLO)$/OOXMLFastDocumentHandler.obj: $(OOXMLGENHEADERS)
$(SLO)$/OOXMLFastTokenHandler.obj: $(OOXMLGENHEADERS)
$(SLO)$/Handler.obj: $(OOXMLGENHEADERS)
