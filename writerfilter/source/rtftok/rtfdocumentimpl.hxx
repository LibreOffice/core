...
{
public:
    void Reset() { m_bAuto = true; m_nR = m_nG = m_nB = 0; }
    void SetRed(sal_uInt8 nRed) { m_bAuto = false; m_nR = nRed; }
    void SetGreen(sal_uInt8 nGreen) { m_bAuto = false; m_nG = nGreen; }
    void SetBlue(sal_uInt8 nBlue) { m_bAuto = false; m_nB = nBlue; }
