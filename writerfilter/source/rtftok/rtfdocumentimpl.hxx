...
struct TableRowBuffer : public virtual writerfilter::NotSoSimpleReferenceObject
{
    RTFBuffer_t buffer;
...
class RTFShape : public virtual writerfilter::NotSoSimpleReferenceObject
{
public:
    RTFShape();
...
class RTFPicture : public virtual writerfilter::NotSoSimpleReferenceObject
{
public:
    RTFPicture();
    sal_uInt16 nWidth = 0;
