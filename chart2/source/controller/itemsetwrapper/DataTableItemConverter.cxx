...
void DataTableItemConverter::FillSpecialItem(sal_uInt16 nWhichId, SfxItemSet& rOutItemSet) const {}

bool DataTableItemConverter::ApplySpecialItem(sal_uInt16 nWhichId, const SfxItemSet& rItemSet)
{
    return false;
}
