...
css::uno::Reference<css::chart2::XChartDocument> getChartDocument(const css::uno::Reference<css::frame::XModel>& xModel)
{
    css::uno::Reference<css::chart2::XChartDocument> xDoc;
    xDoc.set(getChartModel(xModel));
    return xDoc;
}
...
void ChartStylesPanel::dispose()
{
    ...
    css::uno::Reference<css::util::XModifyBroadcaster> xBroadcaster(m_xModel, css::uno::UNO_QUERY_THROW);
...
void ChartStylesPanel::createNewStyle(const OUString& sName)
{
    ...
    xNewStyle->updateChartStyle(getChartDocument(m_xModel));
...
void ChartStylesPanel::modelInvalid()
{
    mbModelValid = false;
}

void ChartStylesPanel::updateModel(
        css::uno::Reference<css::frame::XModel> xModel)
{
    ...
    css::uno::Reference<css::util::XModifyBroadcaster> xBroadcasterNew(m_xModel, css::uno::UNO_QUERY_THROW);
...
IMPL_LINK(ChartStylesPanel, SelHdl, ListBox&, rBox, void)
{
    ...
    else
    {
        ...
        getChartModel(m_xModel)->setChartStyle(xChartStyle);
    }
}
