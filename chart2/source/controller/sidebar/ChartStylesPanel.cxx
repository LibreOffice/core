...
void ChartStylesPanel::createNewStyle(const OUString& sName)
{
    ...
    css::uno::Reference<css::chart2::XChartStyle> xNewStyle = xCurrentStyle;
...
{
    if (pButton == aDefaultButton.get())
        updateDefaultStyle("new style");
    else if (pButton == aNewButton.get())
        createNewStyle("new style");
}
