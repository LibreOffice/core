...
enum
{
    PROP_WATERFALL_TEMPLATE_DIMENSION,
    PROP_WATERFALL_TEMPLATE_GEOMETRY3D
};

void lcl_AddPropertiesToVector(std::vector<Property>& rOutProperties)
{
    rOutProperties.emplace_back(
        "Dimension", PROP_WATERFALL_TEMPLATE_DIMENSION, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
    rOutProperties.emplace_back(
        "Geometry3D", PROP_WATERFALL_TEMPLATE_GEOMETRY3D, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
}

::cppu::OPropertyArrayHelper& StaticWaterfallChartTypeTemplateInfoHelper()
{
...
sal_Int32 WaterfallChartTypeTemplate::getDimension() const { return m_nDim; }

// ____ ChartTypeTemplate ____
bool WaterfallChartTypeTemplate::matchesTemplate2(const rtl::Reference<::chart::Diagram>& xDiagram,
...
rtl::Reference<ChartType>
    WaterfallChartTypeTemplate::getChartTypeForIndex(sal_Int32 /*nChartTypeIndex*/)
{
    return new WaterfallChartType();
}

rtl::Reference<ChartType> WaterfallChartTypeTemplate::getChartTypeForNewSeries2(
...
void WaterfallChartTypeTemplate::GetDefaultValue(sal_Int32 nHandle, uno::Any& rAny) const
{
    static ::chart::tPropertyValueMap aStaticDefaults = []() {
        ...
        ::chart::PropertyHelper::setPropertyValueDefault<sal_Int32>(
            aTmp, PROP_WATERFALL_TEMPLATE_DIMENSION, 2);
        ::chart::PropertyHelper::setPropertyValueDefault(aTmp, PROP_WATERFALL_TEMPLATE_GEOMETRY3D,
...
Reference<beans::XPropertySetInfo> SAL_CALL WaterfallChartTypeTemplate::getPropertySetInfo()
{
    static uno::Reference<beans::XPropertySetInfo> xPropertySetInfo(
        ::cppu::OPropertySetHelper::createPropertySetInfo(
            StaticWaterfallChartTypeTemplateInfoHelper()));
    return xPropertySetInfo;
}

void WaterfallChartTypeTemplate::applyStyle2(const rtl::Reference<DataSeries>& xSeries,
...
void WaterfallChartTypeTemplate::resetStyles2(const rtl::Reference<::chart::Diagram>& xDiagram)
{
...
IMPLEMENT_FORWARD_XINTERFACE2(WaterfallChartTypeTemplate, ChartTypeTemplate, OPropertySet)
IMPLEMENT_FORWARD_XTYPEPROVIDER2(WaterfallChartTypeTemplate, ChartTypeTemplate, OPropertySet)
