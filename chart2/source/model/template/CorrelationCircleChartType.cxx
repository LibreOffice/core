...
css::uno::Sequence<OUString> CorrelationCircleChartType::getSupportedMandatoryRoles()
{
    return { u"label"_ustr, u"values-feature"_ustr, u"values-x"_ustr, u"values-y"_ustr };
}

css::uno::Sequence<OUString> CorrelationCircleChartType::getSupportedPropertyRoles()
{
...
void CorrelationCircleChartType::GetDefaultValue(sal_Int32 nHandle, css::uno::Any& rAny) const
{
...
sal_Bool CorrelationCircleChartType::supportsService(const OUString& rServiceName)
{
    return cppu::supportsService(this, rServiceName);
}

css::uno::Sequence<OUString> CorrelationCircleChartType::getSupportedServiceNames()
{
