 ...
 *  $Revision: 1.2 $
 *
 *  last change: $Author: vg $ $Date: 2007-05-22 18:25:59 $
 *
...
#define SCHATTR_AXIS_END                 SCHATTR_AXIS_DUMMY3

#define SCHATTR_SYMBOL_BRUSH            (SCHATTR_AXIS_END + 1) //96->94
#define SCHATTR_STOCK_VOLUME            (SCHATTR_AXIS_END + 2) //97->95
#define SCHATTR_STOCK_UPDOWN            (SCHATTR_AXIS_END + 3) //98->96
#define SCHATTR_SYMBOL_SIZE             (SCHATTR_AXIS_END + 4) //99->97

// non persistent items (binary format)
#define SCHATTR_CHARTTYPE_START         (SCHATTR_SYMBOL_SIZE + 1)

// new from New Chart
#define SCHATTR_BAR_OVERLAP             (SCHATTR_CHARTTYPE_START )      //98
#define SCHATTR_BAR_GAPWIDTH            (SCHATTR_CHARTTYPE_START + 1)   //99
#define SCHATTR_BAR_CONNECT             (SCHATTR_CHARTTYPE_START + 2)   //100
#define SCHATTR_NUM_OF_LINES_FOR_BAR    (SCHATTR_CHARTTYPE_START + 3)   //101
#define SCHATTR_SPLINE_ORDER            (SCHATTR_CHARTTYPE_START + 4)   //102
#define SCHATTR_SPLINE_RESOLUTION       (SCHATTR_CHARTTYPE_START + 5)   //103
#define SCHATTR_DIAGRAM_STYLE           (SCHATTR_CHARTTYPE_START + 6)   //104
#define SCHATTR_TEXTBREAK               (SCHATTR_CHARTTYPE_START + 7)   //105

#define SCHATTR_END                      SCHATTR_TEXTBREAK
