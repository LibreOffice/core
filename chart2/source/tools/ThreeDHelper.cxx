...
drawing::CameraGeometry ThreeDHelper::getDefaultCameraGeometry( bool bPie )
{
    ...
    if( bPie )
    {
        vrp = drawing::Position3D( 0.0, 0.0, 87591.2408759124 );
    ...
    double& rfXAngleRad, double& rfYAngleRad, double& rfZAngleRad)
{
    ...
    double E = F_PI*nElevationDeg/180; 
    double R = F_PI*nRotationDeg/180; 
...
{
    rfMinimumDistance = 3.0/4.0*FIXED_SIZE_FOR_3D_CHART_VOLUME;
    rfMaximumDistance = 20.0*FIXED_SIZE_FOR_3D_CHART_VOLUME;
}
