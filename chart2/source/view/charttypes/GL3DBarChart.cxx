...
{
    std::vector<float>& aList = maBarHistory[nBarID];
...
void GL3DBarChart::updateClickEvent()
{
    ...
    {
        std::vector<float>& aList = maBarHistory[mnSelectBarId];
        sal_uInt32 nIdex = 0;
        ...
        for (std::vector<float>::iterator it = aList.begin();it != aList.end();++it)
        {
