...
uno::Reference<drawing::XShape> getShapeByName(const uno::Reference<drawing::XShapes>& rShapes, const OUString& rName, std::function<bool(const uno::Reference<drawing::XShape>&)> pCondition = nullptr)
{
