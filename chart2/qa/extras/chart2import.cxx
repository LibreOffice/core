...
void checkDataLabelProperties(Reference<chart2::XDataSeries> xDataSeries, sal_Int32 nDataPointIndex, bool bValueVisible)
{
    uno::Reference<beans::XPropertySet> xPropertySet(xDataSeries->getDataPointByIndex(nDataPointIndex), uno::UNO_QUERY_THROW);
    chart2::DataPointLabel aLabel;
    xPropertySet->getPropertyValue("Label") >>= aLabel;
    CPPUNIT_ASSERT_EQUAL(static_cast<sal_Bool>(bValueVisible), aLabel.ShowNumber);
    CPPUNIT_ASSERT_EQUAL(static_cast<sal_Bool>(sal_False), aLabel.ShowNumberInPercent);
}
