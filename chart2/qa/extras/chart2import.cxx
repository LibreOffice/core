...
public:
    ...
    void testXAxisTitlePositionDOCX();
    void testYAxisTitlePositionDOCX();
    ...
    CPPUNIT_TEST(testXAxisTitlePositionDOCX);
    CPPUNIT_TEST(testYAxisTitlePositionDOCX);
...
void Chart2ImportTest::testXAxisTitlePositionDOCX()
{
    load("/chart2/qa/extras/data/docx/", "testAxisTitlePosition.docx");
    uno::Reference< chart::XDiagram > mxDiagram;
    uno::Reference< drawing::XShape > xAxisTitle;
    uno::Reference< chart::XChartDocument > xChartDoc(getChartDocFromWriter(0), uno::UNO_QUERY);
    mxDiagram.set(xChartDoc->getDiagram());
    CPPUNIT_ASSERT(mxDiagram.is());
...
void Chart2ImportTest::testYAxisTitlePositionDOCX()
{
    load("/chart2/qa/extras/data/docx/", "testAxisTitlePosition.docx");
    uno::Reference< chart::XDiagram > mxDiagram;
    uno::Reference< drawing::XShape > xAxisTitle;
