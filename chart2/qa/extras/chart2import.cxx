...
void Chart2ImportTest::testTdf115107()
{
    ...
    CPPUNIT_ASSERT_EQUAL((sal_Int32)2, aFields.getLength());
    ...
    CPPUNIT_ASSERT_EQUAL((float)18, nFontSize);
    CPPUNIT_ASSERT_EQUAL((sal_Int64)0xed7d31, nFontColor);
    ...
    xPropertySet.set(xDataSeries->getDataPointByIndex(1), uno::UNO_QUERY_THROW);
    xPropertySet->getPropertyValue("CustomLabelFields") >>= aFields;
    CPPUNIT_ASSERT_EQUAL((sal_Int32)8, aFields.getLength());
    ...
    CPPUNIT_ASSERT_EQUAL((float)16, nFontSize);
    CPPUNIT_ASSERT_EQUAL((sal_Int64)0xed7d31, nFontColor);
    ...
    CPPUNIT_ASSERT_EQUAL((float)13, nFontSize);
    CPPUNIT_ASSERT_EQUAL((sal_Int64)0xbf9000, nFontColor);
    ...
    CPPUNIT_ASSERT_EQUAL((sal_Int64)0xa9d18e, nFontColor);
    CPPUNIT_ASSERT_EQUAL((sal_Int32)1, nCharUnderline);

    // 3
    xPropertySet.set(xDataSeries->getDataPointByIndex(2), uno::UNO_QUERY_THROW);
    xPropertySet->getPropertyValue("CustomLabelFields") >>= aFields;
    CPPUNIT_ASSERT_EQUAL((sal_Int32)1, aFields.getLength());
