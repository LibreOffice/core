...
void Chart2ImportTest::testXaxisValues()
{
    ...
    // test X values
    CPPUNIT_ASSERT_EQUAL(uno::Any(double(0.04)), xSequence[0]);
    CPPUNIT_ASSERT(rtl::math::isNan(*static_cast<const double*>(xSequence[1].getValue())));
    CPPUNIT_ASSERT_EQUAL(uno::Any(double(0.16)), xSequence[2]);
    CPPUNIT_ASSERT_EQUAL(uno::Any(double(0.11)), xSequence[3]);
