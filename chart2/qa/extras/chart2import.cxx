...
void Chart2ImportTest::testDataPointLabelCustomPos()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aRelativePosition.Primary, -0.14621409921671025, 1e-8);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aRelativePosition.Secondary, -5.2887961029923464E-2, 1e-8);

    chart2::RelativePosition aAbsolutePosition;
    xPropertySet->getPropertyValue("AbsolutePosition") >>= aAbsolutePosition;
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aAbsolutePosition.Primary, 0.470863462356444, 1e-8);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aAbsolutePosition.Secondary, 0.149834306454158, 1e-8);
