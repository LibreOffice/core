...
void Chart2ImportTest::testAutoChartAreaBorderPropXLSX()
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("'Automatic' chartarea border color should be loaded as gray.",
        sal_Int32(0x878787), nColor);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("'Automatic' chartarea border width should be loaded as 0,03 cm.",
        sal_Int32(26), nWidth);
}
