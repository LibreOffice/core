...
void Chart2ImportTest::testDataPointLabelCustomPos()
{
    ...
    xPropertySet->getPropertyValue("RelativePosition") >>= aRelativePosition;
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aRelativePosition.Primary, double(-0.14621409921671025), 1e-8);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aRelativePosition.Secondary, double(-5.2887961029923464E-2), 1e-8);

    chart2::RelativePosition aAbsolutePosition;
    xPropertySet->getPropertyValue("AbsolutePosition") >>= aAbsolutePosition;
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aAbsolutePosition.Primary, double(0.470863462356444), 1e-8);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(aAbsolutePosition.Secondary, double(0.149834306454158), 1e-8);
