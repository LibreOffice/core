...
void Chart2ExportTest::testChartMainWithSubTitle()
{
    ...
    assertXPathContent(pXmlDoc, "/c:chartSpace/c:chart/c:title/c:tx/c:rich/a:p/a:r/a:t", "It is a Maintitle" + OUString("\n") + "It is a Subtitle");
