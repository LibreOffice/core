...
void Chart2ExportTest::testuserShapesXLSX()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2952, aPosition.X, 300);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(9840, aPosition.Y, 300);
    // test custom shape size
    awt::Size aSize = xCustomShape->getSize();
    CPPUNIT_ASSERT_DOUBLES_EQUAL(13161, aSize.Width, 300);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1797, aSize.Height, 300);
