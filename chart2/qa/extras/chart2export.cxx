...
{
public:
    Chart2ExportTest() : ChartTest("/chart2/qa/extras/data/docx/", "Office Open XML Text") {}
    void test();
...
#if 1
#define DECLARE_CHART_OOXMLEXPORT_TEST(TestName, filename) DECLARE_SW_ROUNDTRIP_TEST(TestName, filename, Chart2ExportTest)
#endif
...
DECLARE_CHART_OOXMLEXPORT_TEST(testBarChart,"testBarChart.docx")
{
