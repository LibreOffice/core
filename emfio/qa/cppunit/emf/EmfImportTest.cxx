...
void Test::testPolyPolygon()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[1]/polypolygon", "path", "m0 0h19781v14852h-19781z");
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[2]/polypolygon", "path", "m2574 13194v-12065h15303v12065z");

    assertXPath(pDocument, aXPathPrefix + "mask/polygonstroke", 116);
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonstroke[1]/polygon", "2574,13194 2574,1129 17877,1129 17877,13194");
    assertXPath(pDocument, aXPathPrefix + "mask/polygonstroke[1]/line", "color", "#ffffff");

    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonstroke[10]/polygon", "8674,13194 8674,1129");
...
void Test::TestDrawStringAlign()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/transform[1]/textsimpleportion",
                "width", "12");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[1]/textsimpleportion",
                "height", "12");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[1]/textsimpleportion",
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/transform[2]/textsimpleportion",
                "width", "12");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[2]/textsimpleportion",
                "height", "12");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[2]/textsimpleportion",
    ...
    sal_Int32 nX = getXPath(pDocument, aXPathPrefix + "mask/transform[3]/textsimpleportion",
                "x").toInt32();
    CPPUNIT_ASSERT(nX >= 275);
    CPPUNIT_ASSERT(nX <= 276);
    assertXPath(pDocument, aXPathPrefix + "mask/transform[3]/textsimpleportion",
                "y", "22");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[3]/textsimpleportion",
                "text", "HRVT");

    assertXPath(pDocument, aXPathPrefix + "mask/transform[4]/textsimpleportion",
                "x", "12");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[4]/textsimpleportion",
                "y", "66");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[4]/textsimpleportion",
    ...
    nX = getXPath(pDocument, aXPathPrefix + "mask/transform[6]/textsimpleportion",
                "x").toInt32();
    CPPUNIT_ASSERT(nX >= 273);
    CPPUNIT_ASSERT(nX <= 274);
    assertXPath(pDocument, aXPathPrefix + "mask/transform[6]/textsimpleportion",
                "y", "66");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[6]/textsimpleportion",
                "text", "HRVC");
    ...
    nX = getXPath(pDocument, aXPathPrefix + "mask/transform[9]/textsimpleportion",
                "x").toInt32();
    CPPUNIT_ASSERT(nX >= 274);
    CPPUNIT_ASSERT(nX <= 275);
    assertXPath(pDocument, aXPathPrefix + "mask/transform[9]/textsimpleportion",
                "y", "110");
    assertXPath(pDocument, aXPathPrefix + "mask/transform[9]/textsimpleportion",
                "text", "HRVB");
#endif
...
void Test::TestDrawStringTransparent()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/transform/unifiedtransparence", "transparence", "50");
    assertXPath(pDocument, aXPathPrefix + "mask/transform/unifiedtransparence/textsimpleportion", "height", "24");
    assertXPath(pDocument, aXPathPrefix + "mask/transform/unifiedtransparence/textsimpleportion", "x", "66");
    assertXPath(pDocument, aXPathPrefix + "mask/transform/unifiedtransparence/textsimpleportion", "y", "74");
    assertXPath(pDocument, aXPathPrefix + "mask/transform/unifiedtransparence/textsimpleportion", "text", "Transparent Text");
    assertXPath(pDocument, aXPathPrefix + "mask/transform/unifiedtransparence/textsimpleportion", "fontcolor", "#0000ff");
    assertXPath(pDocument, aXPathPrefix + "mask/transform/unifiedtransparence/textsimpleportion", "familyname", "ARIAL");
#endif
}
...
void Test::TestDrawStringWithBrush()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "transform/textdecoratedportion", "text", "0123456789ABCDEF");
    assertXPath(pDocument, aXPathPrefix + "transform/textdecoratedportion", "fontcolor", "#a50021");
    assertXPath(pDocument, aXPathPrefix + "transform/textdecoratedportion", "familyname", "TIMES NEW ROMAN");
}
...
void Test::TestLinearGradient()
{
    ...
    assertXPath(pDocument, aXPathPrefix, "xy11", "1");
    assertXPath(pDocument, aXPathPrefix, "xy12", "0");
    assertXPath(pDocument, aXPathPrefix, "xy13", "0");
    assertXPath(pDocument, aXPathPrefix, "xy21", "0");
    assertXPath(pDocument, aXPathPrefix, "xy22", "1");
    assertXPath(pDocument, aXPathPrefix, "xy23", "0");
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/svglineargradient[1]", "opacity", "0.392156862745098");
    assertXPath(pDocument, aXPathPrefix + "mask/svglineargradient[1]/polypolygon", "path", "m0 0.216110019646294h7615.75822989746v7610.21611001965h-7615.75822989746z");
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/svglineargradient[2]/polypolygon", "path", "m7615.75822989746 0.216110019646294h7615.75822989746v7610.21611001965h-7615.75822989746z");
}
...
void Test::TestTextMapMode()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "polypolygoncolor[1]/polypolygon", "path", "m0 0h3542v4647h-3542z");
    ...
    assertXPathContent(pDocument, aXPathPrefix + "polygonstroke[20]/polygon", "2710,1113 2873,1330");
...
void Test::TestEnglishMapMode()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygon[1]", "path", "m0 0h29699v20999h-29699z");
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[1]/polypolygon", "path", "m-1-1h29700v21001h-29700z");
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[2]/polypolygon", "path", "m1058 7937v5293h3175v-1059h-2118v-4234z");
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[3]/polypolygon", "path", "m12699 1058h4234v1060h-1587v4231h-1059v-4231h-1588z");
    ...
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonhairline[1]/polygon", "-1,-1 29699,-1 29699,21000 -1,21000");
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonhairline[2]/polygon", "1058,7937 1058,13230 4233,13230 4233,12171 2115,12171 2115,7937");
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonhairline[3]/polygon", "12699,1058 16933,1058 16933,2118 15346,2118 15346,6349 14287,6349 14287,2118 12699,2118");
}
...
void Test::TestRectangleWithModifyWorldTransform()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "polypolygoncolor[1]", "color", "#ffffff");
    assertXPath(pDocument, aXPathPrefix + "polypolygoncolor[1]/polypolygon", "path", "m1042 417 918 529 353 610-918-528z");

    assertXPath(pDocument, aXPathPrefix + "polygonstroke", 1);
    assertXPathContent(pDocument, aXPathPrefix + "polygonstroke[1]/polygon", "1042,417 1960,946 2313,1556 1395,1028");
}
...
void Test::TestChordWithModifyWorldTransform()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "polypolygoncolor",
                "color", "#ffffff");
...
void Test::TestArcStartPointEqualEndPoint()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/group/mask/polygonhairline",
                "color", "#000000");
    assertXPathContent(pDocument, aXPathPrefix + "mask/group/mask/polygonhairline/polygon",
...
void Test::TestEllipseWithSelectClipPath()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "group/mask/polypolygoncolor[1]/polypolygon[1]", "path", "m353 353h2472v1057h-2472z");

    assertXPath(pDocument, aXPathPrefix + "group/mask/polygonstroke", 1);
    assertXPathContent(pDocument, aXPathPrefix + "group/mask/polygonstroke[1]/polygon", "353,353 2825,353 2825,1410 353,1410");
}
...
void Test::TestDrawPolyLine16WithClip()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[1]/polypolygon",
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/group[1]/mask/polypolygon", "path", "m2646 0v1322h1323v1322h-1323v1322h-1323v-1322h-1323v-1322h1323v-1322");
    assertXPathContent(pDocument, aXPathPrefix + "mask/group[1]/mask/polygonstroke/polygon", "0,793 3969,4230");
}
...
void Test::TestExtTextOutOpaqueAndClipTransform()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "textsimpleportion[1]",
                "text", "No_rect- DLP-");
    assertXPath(pDocument, aXPathPrefix + "textsimpleportion[1]",
                "fontcolor", "#000000");
    ...
    assertXPath(pDocument, aXPathPrefix + "polypolygoncolor[3]/polypolygon",
                "path", "m972 1326-476-275-148 257 476 276z");
    assertXPath(pDocument, aXPathPrefix + "polypolygoncolor[3]",
                "color", "#800080");

    assertXPath(pDocument, aXPathPrefix + "group", 3);
    assertXPath(pDocument, aXPathPrefix + "group[1]/polypolygoncolor",
                "color", "#ff0000");
    assertXPath(pDocument, aXPathPrefix + "group[1]/textsimpleportion",
                "text", "Opaque - DLP-");
    assertXPath(pDocument, aXPathPrefix + "group[1]/textsimpleportion",
                "fontcolor", "#000000");

    assertXPath(pDocument, aXPathPrefix + "group[2]/mask/group/polypolygoncolor",
                "color", "#00ff00");
    assertXPath(pDocument, aXPathPrefix + "group[2]/mask/polypolygon",
    ...
    assertXPath(pDocument, aXPathPrefix + "group[3]/mask/group/polypolygoncolor",
                "color", "#0080ff");
    assertXPath(pDocument, aXPathPrefix + "group[3]/mask/polypolygon",
                "path", "m251 713 623 361-148 257-623-361z");
...
void Test::TestBitBltStretchBltWMF()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "bitmap[1]",
                "xy11", "508");
    assertXPath(pDocument, aXPathPrefix + "bitmap[1]",
                "xy12", "0");
    assertXPath(pDocument, aXPathPrefix + "bitmap[1]",
...
#endif
    assertXPath(pDocument, aXPathPrefix + "bitmap[1]/data",
                10);
    assertXPath(pDocument, aXPathPrefix + "bitmap[1]/data[1]",
                "row", "000000,000000,000000,000000,000000,000000,000000,000000,000000,000000");
    assertXPath(pDocument, aXPathPrefix + "bitmap[1]/data[4]",
                "row", "000000,ffffff,000000,ffffff,000000,ffffff,000000,ffffff,000000,ffffff");
    assertXPath(pDocument, aXPathPrefix + "bitmap[1]/data[5]",
...
#endif
    assertXPath(pDocument, aXPathPrefix + "bitmap[2]/data",
                10);
    assertXPath(pDocument, aXPathPrefix + "bitmap[2]/data[1]",
                "row", "000000,00001c,000038,000055,000071,00008d,0000aa,0000c6,0000e2,0000ff");
    assertXPath(pDocument, aXPathPrefix + "bitmap[2]/data[5]",
...
void Test::TestExtTextOutOpaqueAndClipWMF()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[2]/polypolygon",
                "path", "m7219 5942h319v318h-319z");
    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[2]",
                "color", "#00ff00");

    assertXPath(pDocument, aXPathPrefix + "mask/polypolygoncolor[3]/polypolygon",
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/group[3]/mask/group/polypolygoncolor",
                "color", "#ff8000");
...
void Test::TestRestoreDCWMF()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "polygonhairline[3]",
                "color", "#000000");
}
...
void Test::TestRoundrectWMF()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "polygonstroke/line",
                "color", "#000000");
    assertXPath(pDocument, aXPathPrefix + "polygonstroke/line",
                "width", "143");
}
...
void Test::TestStretchDIBWMF()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/bitmap",
                "xy11", "12065");
    assertXPath(pDocument, aXPathPrefix + "mask/bitmap",
                "xy12", "0");
    assertXPath(pDocument, aXPathPrefix + "mask/bitmap",
...
#endif
    assertXPath(pDocument, aXPathPrefix + "mask/bitmap/data",
                10);
    assertXPath(pDocument, aXPathPrefix + "/mask/bitmap/data[1]",
                "row", "000000,00001c,000038,000055,000071,00008d,0000aa,0000c6,0000e2,0000ff");
    assertXPath(pDocument, aXPathPrefix + "/mask/bitmap/data[5]",
                "row", "720000,721c1c,723838,725555,727171,72728d,55728d,39728d,1d728d,00728d");
}
...
void Test::TestRoundRect()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "polygonstroke[1]/line",
                "color", "#ff0000");
    ...
    assertXPath(pDocument, aXPathPrefix + "polygonstroke[2]/line",
                "color", "#ff0000");
}
...
void Test::TestCreatePen()
{
    ...
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonstroke[1]/polygon", "27875,16523 27875,1453");
    ...
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonstroke[2]/polygon", "27975,16453 27875,16453");
    ...
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonstroke[3]/polygon", "27925,16078 27875,16078");
    ...
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonhairline[5]/polygon", "25850,2179 25844,1958");
    assertXPath(pDocument, aXPathPrefix + "mask/polygonhairline[10]", "color", "#000080");
    assertXPathContent(pDocument, aXPathPrefix + "mask/polygonhairline[10]/polygon", "2025,1642 2025,1501");
