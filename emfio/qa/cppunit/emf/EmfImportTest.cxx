...
void Test::testPolyPolygon()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[1]/line", "color",
                "#ffffff");

    assertXPathContent(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[10]/polygon",
                       "8674,13194 8674,1129");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[10]/line", "color",
                "#000000");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion", 28);
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[6]", "width",
                "459");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[6]", "x",
                "9908");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[6]", "text",
                "0.5");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[6]", "fontcolor",
                "#000000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/pointarray", 98);
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/pointarray[1]", "color",
                "#000000");
...
void Test::TestDrawString()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textsimpleportion", "height",
                "120");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textsimpleportion", "x",
                "817");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textsimpleportion", "y",
                "1137");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textsimpleportion", "text",
                "TEST");
...
void Test::TestDrawStringTransparent()
{
    ...
    assertXPath(
        pDocument,
        "/primitive2D/metafile/transform/mask/transform/unifiedtransparence/textsimpleportion", "x",
        "66");
    assertXPath(
        pDocument,
        "/primitive2D/metafile/transform/mask/transform/unifiedtransparence/textsimpleportion", "y",
        "74");
    assertXPath(
        pDocument,
        "/primitive2D/metafile/transform/mask/transform/unifiedtransparence/textsimpleportion",
...
void Test::TestDrawStringWithBrush()
{
    ...
    xmlDocUniquePtr pDocument
        = dumper.dumpAndParse(comphelper::sequenceToContainer<Primitive2DContainer>(aSequence));
    CPPUNIT_ASSERT(pDocument);
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textdecoratedportion", "xy11",
                "20");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textdecoratedportion", "xy13",
                "16");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textdecoratedportion", "xy22",
                "20");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textdecoratedportion", "xy33",
                "1");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textdecoratedportion", "text",
                "0123456789ABCDEF");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textdecoratedportion",
                "fontcolor", "#a50021");
    assertXPath(pDocument, "/primitive2D/metafile/transform/transform/textdecoratedportion",
...
void Test::TestDrawLine()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygonstroke/line", "color",
                "#000000");
...
void Test::TestLinearGradient()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[1]", "startx",
                "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[1]", "starty",
                "-1");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[1]", "endx",
                "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[1]", "endy",
                "-1");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[1]", "opacity",
                "0.392156862745098");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[1]/polypolygon",
                "path",
                "m0 0.216110019646294h7615.75822989746v7610.21611001965h-7615.75822989746z");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[2]", "startx",
                "-1");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[2]", "starty",
                "-1");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[2]", "endx",
                "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[2]", "endy",
                "-1");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[2]", "opacity",
                "1");
    assertXPath(
        pDocument, "/primitive2D/metafile/transform/mask/svglineargradient[2]/polypolygon", "path",
...
void Test::TestTextMapMode()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor[1]", "color",
                "#ffffff");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor[1]/polypolygon",
                "path", "m0 0h3542v4647h-3542z");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/textsimpleportion[1]", "fontcolor",
                "#4a70e3");
    ...
    assertXPathContent(pDocument, "/primitive2D/metafile/transform/polygonstroke[1]/polygon",
                       "2142,1638 2142,1489");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[1]/line", "color",
                "#4a70e3");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[1]/line", "width", "11");

    assertXPathContent(pDocument, "/primitive2D/metafile/transform/polygonstroke[10]/polygon",
                       "1967,1029 1869,952");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[10]/line", "color",
                "#4a70e3");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[10]/line", "width", "11");

    assertXPathContent(pDocument, "/primitive2D/metafile/transform/polygonstroke[20]/polygon",
                       "2710,1113 2873,1330");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[20]/line", "color",
                "#666666");
...
void Test::TestEnglishMapMode()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygon[1]", "path",
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[1]", "color",
                "#ffffad");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[1]/polypolygon",
                "path", "m-1-1h29700v21001h-29700z");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[2]/polypolygon",
                "path", "m1058 7937v5293h3175v-1059h-2118v-4234z");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[3]/polypolygon",
                "path", "m12699 1058h4234v1060h-1587v4231h-1059v-4231h-1588z");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion", 4);
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "text",
                "UL");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "fontcolor",
                "#000000");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "width",
                "424");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "height",
                "424");
    ...
    assertXPathContent(
        pDocument, "/primitive2D/metafile/transform/mask/polygonhairline[3]/polygon",
...
void Test::TestRectangleWithModifyWorldTransform()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor[1]", "color",
                "#ffffff");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor[1]/polypolygon",
                "path", "m1042 417 918 529 353 610-918-528z");
...
void Test::TestChordWithModifyWorldTransform()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor/polypolygon", "path",
...
void Test::TestArcStartPointEqualEndPoint()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group/mask/polygonhairline",
                "color", "#000000");
    assertXPathContent(
        pDocument, "/primitive2D/metafile/transform/mask/group/mask/polygonhairline/polygon",
...
void Test::TestArcInsideWronglyDefinedRectangle()
{
    ...
    assertXPathContent(
        pDocument, "/primitive2D/metafile/transform/polygonhairline/polygon",
...
void Test::TestEllipseWithSelectClipPath()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/group/mask/polypolygon[1]", "path",
                "m2790 "
    ...
    assertXPathContent(pDocument,
                       "/primitive2D/metafile/transform/group/mask/polygonstroke[1]/polygon",
...
void Test::TestEllipseXformIntersectClipRect()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group/mask/polypolygon", "path",
                "m370 152 1128-409 592 1623-1128 410z");
    assertXPath(
        pDocument, "/primitive2D/metafile/transform/mask/group/mask/polypolygoncolor/polypolygon",
        "path",
    ...
    assertXPathContent(
        pDocument, "/primitive2D/metafile/transform/mask/group/mask/polygonstroke/polygon",
...
void Test::TestDrawPolyLine16WithClip()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonhairline[1]", "color",
                "#000000");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group[1]/mask/polypolygon", "path",
...
void Test::TestPolylinetoCloseStroke()
{
    ...
    assertXPathContent(
        pDocument, "/primitive2D/metafile/transform/polygonhairline[1]/polygon",
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonhairline[1]", "color",
                "#000000");
    assertXPathContent(
        pDocument, "/primitive2D/metafile/transform/polygonhairline[2]/polygon",
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonhairline[2]", "color",
                "#000000");
}
...
void Test::TestExtTextOutOpaqueAndClipTransform()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/textsimpleportion[1]", "text",
                "No_rect- DLP-");
    assertXPath(pDocument, "/primitive2D/metafile/transform/textsimpleportion[1]", "fontcolor",
                "#000000");

    assertXPath(pDocument, "/primitive2D/metafile/transform/textsimpleportion[2]", "text",
                "OpaqueTranspa");
    assertXPath(pDocument, "/primitive2D/metafile/transform/textsimpleportion[2]", "fontcolor",
                "#000000");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor[2]", "color",
                "#0080ff");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor[3]", "color",
                "#800080");

    assertXPath(pDocument, "/primitive2D/metafile/transform/group", 3);
    assertXPath(pDocument, "/primitive2D/metafile/transform/group[1]/polypolygoncolor", "color",
                "#ff0000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/group[1]/textsimpleportion", "text",
                "Opaque - DLP-");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/group[2]/mask/group/polypolygoncolor",
                "color", "#00ff00");
    assertXPath(pDocument, "/primitive2D/metafile/transform/group[2]/mask/polypolygon", "path",
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/group[3]/mask/group/polypolygoncolor",
                "color", "#0080ff");
    assertXPath(pDocument, "/primitive2D/metafile/transform/group[3]/mask/polypolygon", "path",
...
void Test::TestBitBltStretchBltWMF()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "xy11", "508");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "xy12", "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "xy13", "711");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "xy21", "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "xy22", "508");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "xy23", "508");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "height", "10");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "width", "10");
#if !defined(MACOSX)                                                                               \
    && !defined(_WIN32) // TODO Bitmap display needs to be aligned for macOS and Windows
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]", "checksum",
                "747141214295528493");
#endif
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]/data", 10);
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]/data[1]", "row",
                "000000,000000,000000,000000,000000,000000,000000,000000,000000,000000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]/data[4]", "row",
                "000000,ffffff,000000,ffffff,000000,ffffff,000000,ffffff,000000,ffffff");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[1]/data[5]", "row",
                "ffffff,000000,ffffff,ffffff,000000,000000,000000,ffffff,ffffff,000000");

    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "xy11", "1524");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "xy12", "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "xy13", "1524");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "xy21", "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "xy22", "1016");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "xy23", "102");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "height", "10");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "width", "10");
#if !defined(MACOSX)                                                                               \
    && !defined(_WIN32) // TODO Bitmap display needs to be aligned for macOS and Windows
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]", "checksum",
                "3134789313661517563");
#endif
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]/data", 10);
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]/data[1]", "row",
                "000000,00001c,000038,000055,000071,00008d,0000aa,0000c6,0000e2,0000ff");
    assertXPath(pDocument, "/primitive2D/metafile/transform/bitmap[2]/data[5]", "row",
...
void Test::TestExtTextOutOpaqueAndClipWMF()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[2]", "color",
                "#00ff00");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[3]/polypolygon",
                "path", "m10149 5942h319v318h-319z");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[3]", "color",
                "#8080ff");
...
void Test::TestPaletteWMF()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[1]/line", "color",
                "#ff0000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[1]/line", "width",
                "132");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[2]/line", "color",
                "#ff0000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[2]/line", "width",
                "132");
}
...
void Test::TestRestoreDCWMF()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonhairline[3]", "color",
                "#000000");
}
...
void Test::TestRoundrectWMF()
{
    ...
    assertXPathContent(
        pDocument, "/primitive2D/metafile/transform/polygonstroke/polygon",
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke/line", "color",
                "#000000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke/line", "width", "143");
}
...
void Test::TestStretchDIBWMF()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "xy11", "12065");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "xy12", "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "xy13", "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "xy21", "0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "xy22", "12065");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "xy23", "0");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "height", "10");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "width", "10");
#if !defined(MACOSX) // TODO DIB display needs to be aligned for macOS
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap", "checksum",
                "14148300367030905133");
#endif
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/bitmap/data", 10);
    assertXPath(pDocument, "/primitive2D/metafile/transform//mask/bitmap/data[1]", "row",
                "000000,00001c,000038,000055,000071,00008d,0000aa,0000c6,0000e2,0000ff");
    assertXPath(pDocument, "/primitive2D/metafile/transform//mask/bitmap/data[5]", "row",
                "720000,721c1c,723838,725555,727171,72728d,55728d,39728d,1d728d,00728d");
}
...
void Test::TestPolyLineWidth()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor", "color", "#ffff00");

    assertXPathContent(pDocument, "/primitive2D/metafile/transform/polygonstroke/polygon",
                       "530,529 530,529 1766,353 1059,705");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke/line", "color",
                "#000000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke/line", "width", "71");
}
...
void Test::TestRestoreDC()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor", "color", "#ff0000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/polypolygoncolor/polypolygon", "path",
...
void Test::TestRoundRect()
{
    ...
    assertXPath(
        pDocument, "/primitive2D/metafile/transform/polypolygoncolor[2]/polypolygon", "path",
        "m4090 "
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[2]/line", "color",
                "#ff0000");
}
...
void Test::TestCreatePen()
{
    ...
    assertXPathContent(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[3]/polygon",
                       "27925,16078 27875,16078");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[3]/line", "color",
                "#ff0000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonstroke[3]/line", "width",
                "6");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonhairline", 10);
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonhairline[5]", "color",
                "#008000");
    assertXPathContent(pDocument, "/primitive2D/metafile/transform/mask/polygonhairline[5]/polygon",
                       "25850,2179 25844,1958");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polygonhairline[10]", "color",
                "#000080");
    assertXPathContent(pDocument,
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "width",
                "374");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "x",
                "28124");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "y",
                "16581");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "text",
                "0.0");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[1]", "fontcolor",
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[10]", "width",
                "266");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[10]", "x",
                "28000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[10]", "y",
                "428");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[10]", "text",
                "-6");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[10]",
                "fontcolor", "#000000");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/pointarray", 8);
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/pointarray[1]", "color",
                "#008000");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/pointarray[1]/point", "x",
                "25844");
