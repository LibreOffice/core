...
void Test::testPolyPolygon()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/textsimpleportion[6]", "y", "13653");
...
void Test::TestTextMapMode()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[1]/line", "width", "5");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[10]/line", "width", "5");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/polygonstroke[20]/line", "width", "5");
}
