...
void Test::TestEmfPlusDrawPathWithMiterLimit()
{
    ...
    Primitive2DSequence aSequence = parseEmf(u"emfio/qa/cppunit/emf/data/TestEmfPlusDrawPathWithMiterLimit.emf");
    CPPUNIT_ASSERT_EQUAL(1, static_cast<int>(aSequence.getLength()));
    drawinglayer::Primitive2dXmlDump dumper;
    xmlDocUniquePtr pDocument = dumper.dumpAndParse(Primitive2DContainer(aSequence));
    CPPUNIT_ASSERT(pDocument);
    ...
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[1]/polypolygonstroke/line", "color", "#6400c8");
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[1]/polypolygonstroke/line", "width", "1057");
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[1]/polypolygonstroke/line", "linejoin", "Miter");
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[1]/polypolygonstroke/line", "miterangle", "19");
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[2]", "transparence", "69");
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[2]/polypolygonstroke/line", "miterangle", "19");
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[3]", "transparence", "53");
    assertXPath(pDocument, aXPathPrefix + "unifiedtransparence[3]/polypolygonstroke/line", "miterangle", "19");
