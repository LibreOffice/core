...
void Test::TestExtTextOutOpaqueAndClipTransform()
{
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor", 2);
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[1]/polypolygon",
                "path", "m888 201-476-276-85 147 477 276z");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[1]",
                "color", "#ff0000");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[2]/polypolygon",
                "path", "m169 431 623 360-144 250-623-360z");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/polypolygoncolor[2]",
                "color", "#0080ff");

    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group", 3);
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group[2]/mask/group/polypolygoncolor",
                "color", "#00ff00");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group[2]/mask/polypolygon",
                "path", "m226 248 604 350-152 264-605-349z");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group[2]/mask/group/textsimpleportion",
                "text", "Clip  -  DLP-");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group[2]/mask/group/textsimpleportion",
                "fontcolor", "#000000");
    ...
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group[3]/mask/group/polypolygoncolor",
                "color", "#0080ff");
    assertXPath(pDocument, "/primitive2D/metafile/transform/mask/group[3]/mask/polypolygon",
                "path", "m169 431 623 360-144 250-623-360z");
