...
void Test::TestDrawLine()
{
    ...
    assertXPath(pDocument, aXPathPrefix + "mask/polygonstrokearrow/linestartattribute", "width",
                "115");
    assertXPath(pDocument, aXPathPrefix + "mask/polygonstrokearrow/linestartattribute", "centered",
                "1");
    assertXPath(pDocument, aXPathPrefix + "mask/polygonstrokearrow/lineendattribute", "width",
                "115");
    assertXPath(pDocument, aXPathPrefix + "mask/polygonstrokearrow/lineendattribute", "centered",
                "1");
}
