...
EXTENSIONNAME:=dict-hr
EXTENSION_ZIPNAME:=dict-hr
...
# just copy:
COMPONENT_FILES= \
    $(EXTENSIONDIR)$/hr_HR.aff \
    $(EXTENSIONDIR)$/hr_HR.dic \
    $(EXTENSIONDIR)$/hyph_hr_HR.dic \
    $(EXTENSIONDIR)$/README_hyph_hr_HR.txt
...
CUSTOM_LICENSE=README_hr_HR.txt
