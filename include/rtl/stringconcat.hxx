...
template< class Child, int nBufSize >
struct OStringNumberBase
{
    OStringNumberBase(sal_Int32 nLength) : length(nLength) {};
    ...
    const Child& toAsciiUpperCase() SAL_RETURNS_NONNULL
    {
    ...
    : public OStringNumberBase<OStringNumber<int>, RTL_STR_MAX_VALUEOFINT32>
{
    OStringNumber( int i, sal_Int16 radix )
        : OStringNumberBase(rtl_str_valueOfInt32(buf, i, radix))
    {}
};
    ...
    : public OStringNumberBase<OStringNumber<long long>, RTL_STR_MAX_VALUEOFINT64>
{
    OStringNumber( long long ll, sal_Int16 radix )
        : OStringNumberBase(rtl_str_valueOfInt64(buf, ll, radix))
    {}
};
    ...
    : public OStringNumberBase<OStringNumber<unsigned long long>, RTL_STR_MAX_VALUEOFUINT64>
{
    OStringNumber( unsigned long long ll, sal_Int16 radix )
        : OStringNumberBase(rtl_str_valueOfUInt64(buf, ll, radix))
    {}
};
    ...
    : public OStringNumberBase<OStringNumber<float>, RTL_STR_MAX_VALUEOFFLOAT>
{
    OStringNumber( float f )
        : OStringNumberBase(rtl_str_valueOfFloat(buf, f))
    {}
};
    ...
    : public OStringNumberBase<OStringNumber<double>, RTL_STR_MAX_VALUEOFDOUBLE>
{
    OStringNumber( double d )
        : OStringNumberBase(rtl_str_valueOfDouble(buf, d))
    {}
};
...
{
    OUStringNumberBase(sal_Int32 nLength) : length(nLength) {};
    const Child& toAsciiUpperCase() SAL_RETURNS_NONNULL
    {
        rtl_str_toAsciiUpperCase_WithLength(buf, length);
        return *static_cast<const Child*>(this);
...
struct OUStringNumber<int>
    : public OUStringNumberBase<OStringNumber<int>, RTL_USTR_MAX_VALUEOFINT32>
{
    OUStringNumber( int i, sal_Int16 radix )
        : OUStringNumberBase(rtl_ustr_valueOfInt32(buf, i, radix))
    {}
};

template<>
struct OUStringNumber<long long>
    : public OUStringNumberBase<OStringNumber<long long>, RTL_USTR_MAX_VALUEOFINT64>
{
    OUStringNumber( long long ll, sal_Int16 radix )
        : OUStringNumberBase(rtl_ustr_valueOfInt64(buf, ll, radix))
    {}
};

template<>
struct OUStringNumber<unsigned long long>
    : public OUStringNumberBase<OStringNumber<unsigned long long>, RTL_USTR_MAX_VALUEOFUINT64>
{
    OUStringNumber( unsigned long long ll, sal_Int16 radix )
        : OUStringNumberBase(rtl_ustr_valueOfUInt64(buf, ll, radix))
    {}
};

template<>
struct OUStringNumber<float>
    : public OUStringNumberBase<OStringNumber<float>, RTL_USTR_MAX_VALUEOFFLOAT>
{
    OUStringNumber( float f )
        : OUStringNumberBase(rtl_ustr_valueOfFloat(buf, f))
    {}
};

template<>
struct OUStringNumber<double>
    : public OUStringNumberBase<OStringNumber<double>, RTL_USTR_MAX_VALUEOFDOUBLE>
{
    OUStringNumber( double d )
        : OUStringNumberBase(rtl_ustr_valueOfDouble(buf, d))
    {}
};
