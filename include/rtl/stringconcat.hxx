...
// initFunc must take char* as its first argument, and return resulting string length
template <class Child, int nBufSize, auto initFunc> struct OStringNumberBase
{
    template <typename... Params>
    OStringNumberBase(Params... params)
        : length(initFunc(buf, params...)){};
...
struct OStringNumber< int >
    : public OStringNumberBase<OStringNumber<int>, RTL_STR_MAX_VALUEOFINT32, rtl_str_valueOfInt32>
{
...
struct OStringNumber< float >
    : public OStringNumberBase<OStringNumber<float>, RTL_STR_MAX_VALUEOFFLOAT, rtl_str_valueOfFloat>
{
...
// initFunc must take sal_Unicode* as its first argument, and return resulting string length
template <class Child, int nBufSize, auto initFunc> struct OUStringNumberBase
{
    template <typename... Params>
