...
COMPHELPER_DLLPUBLIC void setFreemiumSession(bool isFreemium, const char* freemiumBlacklist);
COMPHELPER_DLLPUBLIC bool isFreemiumSession();
COMPHELPER_DLLPUBLIC const std::vector<OUString>& getFreemiumBlackList();
