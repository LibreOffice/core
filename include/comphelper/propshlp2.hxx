...
/**
   ...
   This is a modified copy of cppu::OPropertyArrayHelper2 that does lookups
   using a hash map instead of binary search.
 */
class SAL_WARN_UNUSED COMPHELPER_DLLPUBLIC OPropertyArrayHelper2 final
...
public:
     ...
     */
    OPropertyArrayHelper2(std::vector<css::beans::Property> aProps);

    OPropertyArrayHelper2(const css::uno::Sequence<css::beans::Property>& aProps);
     ...
     */
    virtual sal_Bool SAL_CALL fillPropertyMembersByHandle(::rtl::OUString* pPropName,
    ...
    getPropertyByName(const ::rtl::OUString& rPropertyName) override;
    /**
       Return true if the property with the name rPropertyName exist, otherwise false.
       @param rPropertyName the name of the property.
     */
    virtual sal_Bool SAL_CALL hasPropertyByName(const ::rtl::OUString& rPropertyName) override;
    /**
       Return the handle of the property with the name rPropertyName.
       If the property does not exist -1 is returned.
       @param rPropertyName the name of the property.
     */
    virtual sal_Int32 SAL_CALL getHandleByName(const ::rtl::OUString& rPropertyName) override;
    /**
