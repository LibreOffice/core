...
namespace comphelper
{
    ...
    private:
        ...
        bool isPopPossible_file(const OUString& rSourceURL, const OUString& rTargetURL, const OUString& rName, const OUString& rExt);
        ...
        bool isPopPossible_extensionInfo(const OUString& rTargetURL);
