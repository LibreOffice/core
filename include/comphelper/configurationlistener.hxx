...
#define INCLUDED_COMPHELPER_CONFIGURATIONLISTERER_HXX
...
template< typename uno_type > class COMPHELPER_DLLPUBLIC ConfigurationListenerProperty : public ConfigurationListenerPropertyBase
{
    uno_type maValue;
protected:
...
public:
     ...
     */
    ConfigurationListenerProperty(const rtl::Reference< ConfigurationListener > &xListener,
...
#endif // INCLUDED_COMPHELPER_CONFIGURATIONLISTERER_HXX
