...
namespace gfx
{
/** Derived Range2DL class which wraps convertion to the Rectangle or B2DRange types.
 *
 * We need the unit type (typically twips or hmm) that will be used for conversion,
 * that will be used in toToolsRect or toB2DRange call.
 * The value as a tools::Rectangle is also stored as a variable, so it can be returned
 * as a const reference, which is needed sometimes.
 */
...
public:
    ...
    basegfx::B2DRange toB2DRange() const
    {
        if (isEmpty())
