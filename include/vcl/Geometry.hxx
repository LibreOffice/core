...
public:
    ...
    static double LogicToPixel(double n, tools::Long nDPI, tools::Long nMapNum,
                               tools::Long nMapDenom);
    ...
    DevicePoint LogicToDeviceFontCoordinate(Point const& rLogicPt) const;

    double LogicWidthToDeviceFontWidth(tools::Long nWidth) const;
