...
class TransportAsXWindow : public TransportAsXWindow_Base
{
private:
    osl::Mutex m_aHelperMtx;
    weld::Widget* m_pWeldWidget;
    weld::Window* m_pWeldTopLevel;
...
public:
    TransportAsXWindow(weld::Widget* pWeldWidget, weld::Window* pTopLevel)
        : TransportAsXWindow_Base(m_aHelperMtx)
        , m_pWeldWidget(pWeldWidget)
        , m_pWeldTopLevel(pTopLevel)
    ...
    weld::Window* getWindow() const { return m_pWeldTopLevel; }
    virtual void clear()
    {
        m_pWeldWidget = nullptr;
        m_pWeldTopLevel = nullptr;
    }
    ...
    void SAL_CALL setFocus() override { throw css::uno::RuntimeException("not implemented"); }
