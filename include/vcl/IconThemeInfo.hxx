...
public:
     ...
     */
    IconThemeInfo(const rtl::OUString& urlToFile);
    ...
    static bool
    UrlCanBeParsed(const rtl::OUString& url);
    ...
    FindIconThemeById(const std::vector<vcl::IconThemeInfo>& themes, const rtl::OUString& themeId);

    /** Check whether a theme with a specified id is in a vector of IconThemeInfo */
    static bool
    IconThemeIsInVector(const std::vector<vcl::IconThemeInfo>& themes, const rtl::OUString& themeId);
