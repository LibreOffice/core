...
class VCL_PLUGIN_PUBLIC GraphicsRenderTests
{
    ...
    std::vector<std::string> m_aPassed;
    std::vector<std::string> m_aQuirky;
    std::vector<std::string> m_aFailed;
    //For storing Skipped tests.
    std::vector<std::string> m_aSkipped;
    ...
    void testTdf124848();
    void testTdf136171();
    void updateResult(vcl::test::TestResult const result, std::string atestname);
    void RunALLTests();
