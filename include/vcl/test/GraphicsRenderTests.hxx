...
class VCL_PLUGIN_PUBLIC GraphicsRenderTests
{
    ...
    void testHalfEllipsePolyLine();
    void testHalfEllipsePolygon();
    ...
    void testDrawRectangleOnSize32WithRect();
    void testDrawRectangleOnSize64WithRect();
    void testDrawRectangleOnSize32WithPixel();
    void testDrawRectangleOnSize64WithPixel();
    void testDrawRectangleOnSize32WithLine();
    void testDrawRectangleOnSize64WithLine();
    void testDrawRectangleOnSize32WithPolygon();
    void testDrawRectangleOnSize64WithPolygon();
    void testDrawRectangleOnSize32WithPolyLine();
    void testDrawRectangleOnSize64WithPolyLine();
    void testDrawRectangleOnSize32WithPolyLineB2D();
    void testDrawRectangleOnSize64WithPolyLineB2D();
    void testDrawRectangleOnSize32WithPolyPolygon();
    void testDrawRectangleOnSize64WithPolyPolygon();
    void testDrawRectangleOnSize32WithPolyPolygonB2D();
    void testDrawRectangleOnSize64WithPolygonPolygonB2D();
