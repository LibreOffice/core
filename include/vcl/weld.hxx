...
namespace Weld
{
    ...
    {
    protected:
        Link<Widget&, void> m_aFocusOutEventHdl;

        void signal_focus_out_event()
        {
            m_aFocusOutEventHdl.Call(*this);
        }
    ...
    public:
        ...
        void connect_focus_out_event(const Link<Widget&, void>& rLink)
        {
            m_aFocusOutEventHdl = rLink;
        }
    ...
    public:
        ...
        virtual void get_increments(double& step, double& page) const = 0;
    ...
    protected:
        ...
        double ConvertValue(double nValue, FieldUnit eInUnit, FieldUnit eOutUnit) const;
        OUString format_number(double fValue) const;
    ...
    public:
        ...
        void set_value(double fValue, FieldUnit eValueUnit)
        {
            m_xSpinButton->set_value(ConvertValue(fValue, eValueUnit, m_eSrcUnit));
        }

        double get_value(FieldUnit eDestUnit) const
        {
            double fValue = m_xSpinButton->get_value();
            return ConvertValue(fValue, m_eSrcUnit, eDestUnit);
        }

        void set_range(double min, double max, FieldUnit eValueUnit)
        {
        ...
        void set_increments(double step, double page, FieldUnit eValueUnit)
        {
        ...
        void get_increments(double& step, double& page, FieldUnit eDestUnit) const
        {
    ...
    public:
        ...
        OString get_help_id(Widget& rWidget) const
        {
