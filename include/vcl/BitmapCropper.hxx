...
class VCL_DLLPUBLIC BitmapCropper : public BitmapFilter
{
public:
    BitmapCropper(const tools::Rectangle& rCropRect)
        : maCropRect(rCropRect)
    {
    }
...
private:
    const tools::Rectangle& maCropRect;
};
