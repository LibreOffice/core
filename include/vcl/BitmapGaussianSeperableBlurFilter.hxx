...
#ifndef INCLUDED_VCL_BITMAPGAUSSIANSEPERABLEBLURFILTER_HXX
#define INCLUDED_VCL_BITMAPGAUSSIANSEPERABLEBLURFILTER_HXX

#include <vcl/BitmapFilter.hxx>

class BitmapEx;

class VCL_DLLPUBLIC BitmapGaussianSeperableBlurFilter : public BitmapFilter
{
public:
    BitmapGaussianSeperableBlurFilter(double fRadius)
        : mfRadius(fRadius)
    {
    }
