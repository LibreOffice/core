...
public:
    ...
    void setThumbnailDimension(long itemMaxSize, long itemPadding);

    long getThumbnailWidth(){ return mThumbnailWidth;}
    long getThumbnailHeight() {return mThumbnailHeight;}
