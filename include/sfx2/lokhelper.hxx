...
public:
    ...
    static void notifyVisCursorInvalidation(OutlinerViewShell const* pThisView, const OString& rRectangle, bool bMisspelledWord = false, const OString& rHyperlink = "");
