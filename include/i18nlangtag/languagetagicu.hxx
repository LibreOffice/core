...
public:
    ...
    /** Obtain language tag as ICU icu::Locale, adding variant data.
        ...
        the icu:Locale, the variant field is copied from rVariant but is always empty for the moment.
        The 4th arg of icu::Locale "keywords" is now used for collation
