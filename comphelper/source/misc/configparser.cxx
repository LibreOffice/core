...
{
    std::auto_ptr< rtl::OUString > getExpandedFilePath(const rtl::OUString& filepath)
    {
        SAL_WNODEPRECATED_DECLARATIONS_PUSH
        std::auto_ptr< rtl::OUString > xExpandedPath;
        ...
        xExpandedPath.reset(new OUString(aFilename));
        return (xExpandedPath);
    }
}