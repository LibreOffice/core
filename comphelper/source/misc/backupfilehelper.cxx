...
namespace comphelper
{
    ...
    namespace {
                                  ...
                                  const OUString& rKey, const OUString& rValue)
        {
            ...
            {
                SAL_WARN("comphelper.backupfilehelper", "could not set value: " << e.Message);
            }
    ...
    void BackupFileHelper::tryDisableHWAcceleration()
    {
        ...
        SAL_WARN_IF(result != osl::FileBase::E_None, "comphelper.backupfileheler", "could not copy back modified Extension configuration file");
    }
    ...
    OUString BackupFileHelper::getUserProfileURL()
    {
