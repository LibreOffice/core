...
namespace comphelper
{
    rtl::OUString getExpandedFilePath(const rtl::OUString& filepath)
    {
        ...
        rtl:OUString aFilename = getExpandedFilePath(filepath,xContext);
        return aFilename;
    }

    rtl::OUString getExpandedFilePath(const rtl::OUString& filepath,::com::sun::star::uno::Reference<css::uno::XComponentContext> xContext)
    {
