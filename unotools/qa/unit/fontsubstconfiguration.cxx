...
{
    OUString sTestName("microsofttestfont");
    OUString rShortName;
    ...
    utl::FontSubstConfiguration aFontSubstConfig;
    utl::FontSubstConfiguration::getMapName(sTestName, rShortName, rFamilyName, eWeight, eWidth,
                                            eType);
...
void TestFontSubstConfiguration::testGetMapName_ShouldNotDetectWidth()
{
    // NOTE: you must initialize eWeight with WEIGHT_DONTKNOW or WEIGHT_NORMAL before
    // trying to detect the font weight in the name
    OUString sTestName(GetEnglishSearchFontName("Picnic For Two _ Cosy"));
    OUString rShortName;
    OUString rFamilyName;
    FontWeight eWeight = WEIGHT_DONTKNOW;
    FontWidth eWidth = WIDTH_DONTKNOW;
...
void TestFontSubstConfiguration::testGetMapName_ShouldNotDetectFamilyType()
{
    // NOTE: you must initialize eWeight with WEIGHT_DONTKNOW or WEIGHT_NORMAL before
    // trying to detect the font weight in the name
    OUString sTestName(GetEnglishSearchFontName("Sold Out"));
    OUString rShortName;
    OUString rFamilyName;
    FontWeight eWeight = WEIGHT_DONTKNOW;
    FontWidth eWidth = WIDTH_DONTKNOW;
