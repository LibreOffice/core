...
import org.libreoffice.storage.external.ExternalDocumentProviders.IExternalDocumentProvider;

import java.util.Set;

/**
 * Activity to select which diretory browser to use.
 * Android 5+ will use the DocumentTree intent to locate a browser.
 * Android 4+ & OTG will use the internal directory browser.
 */
public class DirectorySelectorActivity extends AppCompatActivity {
    ...
    private static final String LOGTAG = DirectorySelectorActivity.class.getSimpleName();
