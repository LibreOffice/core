...
import org.libreoffice.storage.external.ExternalFile;
 ...
 * for Android 5.0+. The documentFile class obfuscates the path of the files
 * it wraps, preventing usage of LOK's documentLoad method.
 *
 * A copy of the DocumentFile's contents file will be created in the app's cache,
 * so documentLoad can be used.
 *
