...
import org.libreoffice.storage.external.DirectoryBrowser.DirectoryBrowserActivity;
import org.libreoffice.storage.external.DirectorySelectorActivity;
...
public class DocumentProviderSettingsActivity extends Activity {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            extSDPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    startDocumentSelectorActivity(KEY_PREF_EXTERNAL_SD_PATH_URI,
                            DirectorySelectorActivity.MODE_EXT_SD);
                    return true;
                }
            });
            otgPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startDocumentSelectorActivity(KEY_PREF_OTG_PATH_URI,
                            DirectorySelectorActivity.MODE_OTG);
                    return true;
                }
            });
        ...
        private void startDocumentSelectorActivity(String prefKey, String mode) {
            Intent i = new Intent(getActivity(), DirectorySelectorActivity.class);
            i.putExtra(DirectorySelectorActivity.PREFERENCE_KEY_EXTRA, prefKey);
            i.putExtra(DirectorySelectorActivity.MODE_EXTRA, mode);
            startActivity(i);
        }
