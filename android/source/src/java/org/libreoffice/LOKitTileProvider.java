...
class LOKitTileProvider implements TileProvider {
    ...
    private void postLoad() {
        ...
        if (mDocument.getDocumentType() == Document.DOCTYPE_PRESENTATION) {
            ...
            mContext.getToolbarController().disableMenuItem(R.id.action_delete_slide, false);
        }
        if (mDocument.getDocumentType() == Document.DOCTYPE_SPREADSHEET) {
            ...
            mContext.getToolbarController().disableMenuItem(R.id.action_rename_worksheet, false);
            mContext.getToolbarController().disableMenuItem(R.id.action_delete_worksheet, false);
        }
